...
//Universal serial bus full-speed device      interface
    namespace UsbEp0r{    ///<endpoint 0 register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> ctrTx{}; 
        ///Endpoint kind
    ...
    namespace UsbCntr{    ///<control register
        using Addr = Register::Address<0x40005c40,0xffff0040,0x00000000,unsigned short>;
        ///Force USB Reset
    ...
    namespace UsbIstr{    ///<interrupt status register
        using Addr = Register::Address<0x40005c44,0xffff0060,0x00007f80,unsigned short>;
        ///Endpoint Identifier
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> l1req{}; 
        ///Expected start frame
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> esof{}; 
        ///start of frame
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,9),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> sof{}; 
        ///reset request
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> reset{}; 
        ///Suspend mode request
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> susp{}; 
        ///Wakeup
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,12),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> wkup{}; 
        ///Error
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> err{}; 
        ///Packet memory area over / underrun: 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::Access<Register::AccessType::readWrite,Register::ReadActionType::normal,Register::ModifiedWriteValueType::zeroToClear>,unsigned> pmaovr{}; 
        ///Correct transfer: This bit is set by the hardware to indicate that an endpoint has successfully completed a transaction; using DIR and EP_ID bits software can determine which endpoint requested the interrupt. This bit is read-only.
    ...
    namespace UsbFnr{    ///<frame number register
        using Addr = Register::Address<0x40005c48,0xffff0000,0x00000000,unsigned short>;
        ///Frame number
    ...
    namespace UsbDaddr{    ///<device address
        using Addr = Register::Address<0x40005c4c,0xffffff00,0x00000000,unsigned short>;
        ///Device address
    ...
    namespace UsbBtable{    ///<Buffer table address
        using Addr = Register::Address<0x40005c50,0xffff0007,0x00000000,unsigned short>;
        ///Buffer table
    ...
    namespace UsbLpmcsr{    ///<LPM control and status          register
        using Addr = Register::Address<0x40005c54,0xffffff04,0x00000000,unsigned short>;
        ///LPM support enable
    ...
    namespace UsbBcdr{    ///<Battery charging detector
        using Addr = Register::Address<0x40005c58,0xffff7f00,0x00000000,unsigned short>;
