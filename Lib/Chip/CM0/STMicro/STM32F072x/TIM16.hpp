...
//General-purpose-timers
    namespace Tim16Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014400,0xfffffc70,0x00000000,unsigned>;
        ///Clock division
    ...
    namespace Tim16Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001440c,0xffffbc1c,0x00000000,unsigned>;
    ...
    namespace Tim16Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40014444,0xffff0000,0x00000000,unsigned>;
        ///Main output enable
