...
//32-bit counter/timers CT32B0
    ...
    namespace Ct32b0Cr0{    ///<Capture Register 0. CR0 is loaded with the value of TC when there is an event on the CT32B0_CAP0 input.
    ...
    namespace Ct32b0Cr1{    ///<Capture Register 1. CR1 is loaded with the value of TC when there is an event on the CT32B0_CAP1 input.
