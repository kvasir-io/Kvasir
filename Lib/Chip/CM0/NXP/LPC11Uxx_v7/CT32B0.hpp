...
//32-bit counter/timers CT32B0
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace cisValC{
            constexpr MPL::Value<cisVal,cisVal::ct32b0Cap0> ct32b0Cap0{};
            constexpr MPL::Value<cisVal,cisVal::reserved> reserved{};
            constexpr MPL::Value<cisVal,cisVal::ct32b0Cap1> ct32b0Cap1{};
        }
        ...
        namespace selccValC{
            constexpr MPL::Value<selccVal,selccVal::risingEdgeOfCt32b> risingEdgeOfCt32b{};
            constexpr MPL::Value<selccVal,selccVal::fallingEdgeOfCt32> fallingEdgeOfCt32{};
    ...
    namespace Nonepwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT32Bn_MAT[3:0].
        ...
        namespace pwmen1ValC{
            constexpr MPL::Value<pwmen1Val,pwmen1Val::ct32bnMat01IsCont> ct32bnMat01IsCont{};
