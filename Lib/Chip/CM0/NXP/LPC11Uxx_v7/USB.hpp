...
//USB2.0 device controller 
    namespace Nonedevcmdstat{    ///<USB Device Command/Status register
        ...
        namespace intonnakAoValC{
            constexpr MPL::Value<intonnakAoVal,intonnakAoVal::acknow> acknow{};
            constexpr MPL::Value<intonnakAoVal,intonnakAoVal::acknowNak> acknowNak{};
        }
        ...
        namespace intonnakAiValC{
            constexpr MPL::Value<intonnakAiVal,intonnakAiVal::acknow> acknow{};
            constexpr MPL::Value<intonnakAiVal,intonnakAiVal::acknowNak> acknowNak{};
        }
        ...
        namespace intonnakCoValC{
            constexpr MPL::Value<intonnakCoVal,intonnakCoVal::acknow> acknow{};
            constexpr MPL::Value<intonnakCoVal,intonnakCoVal::acknowNak> acknowNak{};
        }
        ...
        namespace intonnakCiValC{
            constexpr MPL::Value<intonnakCiVal,intonnakCiVal::acknow> acknow{};
            constexpr MPL::Value<intonnakCiVal,intonnakCiVal::acknowNak> acknowNak{};
        }
