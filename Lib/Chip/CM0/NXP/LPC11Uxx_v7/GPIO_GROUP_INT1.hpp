...
//GPIO group interrupt
    ...
    namespace GpioGroupInt1PortPol0{    ///<GPIO grouped interrupt port 0 polarity register
    ...
    namespace GpioGroupInt1PortPol1{    ///<GPIO grouped interrupt port 0 polarity register
    ...
    namespace GpioGroupInt1PortEna0{    ///<GPIO grouped interrupt port 0/1 enable register
    ...
    namespace GpioGroupInt1PortEna1{    ///<GPIO grouped interrupt port 0/1 enable register
