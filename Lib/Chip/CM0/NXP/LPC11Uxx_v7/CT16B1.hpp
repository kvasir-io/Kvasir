...
namespace Kvasir {
    namespace Noneir{
        using Addr = Register::Address<0x40010000,0xffffffc0>;
    ...
    namespace Nonetcr{
        using Addr = Register::Address<0x40010004,0xfffffffc>;
    ...
    namespace Nonemcr{
        using Addr = Register::Address<0x40010014,0xfffff000>;
    ...
    namespace Nonemr2{
        using Addr = Register::Address<0x40010020,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MATCH; 
    }
    namespace Nonemr3{
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x40010028,0xffffffc0>;
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x40010030,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CAP; 
    }
    namespace Noneemr{
        using Addr = Register::Address<0x4001003c,0xfffff000>;
    ...
    namespace Nonepwmc{
        using Addr = Register::Address<0x40010074,0xfffffff0>;
