...
//16-bit counter/timer
    ...
    namespace Nonemcr{    ///<Match Control Register (MCR). The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
        ...
        namespace Mr0iValC{
            ...
            constexpr Register::FieldValue<decltype(mr0i),Mr0iVal::d> d{};
        }
    ...
    namespace Nonectcr{    ///<Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CtmValC{
            ...
            constexpr Register::FieldValue<decltype(ctm),CtmVal::falllingedge> falllingedge{};
            constexpr Register::FieldValue<decltype(ctm),CtmVal::risingfallingedge> risingfallingedge{};
        }
        ///Count Input Select. In counter mode (when bits 1:0 in this register are not 00), these bits select which CAP pin is sampled for clocking. 
						Note: If Counter mode is selected in the CTCR register, bits 2:0 in the Capture Control Register (CCR) must be programmed as 000.
        enum class CisVal {
    ...
    namespace Nonepwmc{    ///<PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT16B0_MAT[2:0].
        ...
        namespace Pwmen0ValC{
            ...
            constexpr Register::FieldValue<decltype(pwmen0),Pwmen0Val::pwmmode> pwmmode{};
        }
        ///PWM channel1 enable
        ...
        namespace Pwmen1ValC{
            ...
            constexpr Register::FieldValue<decltype(pwmen1),Pwmen1Val::pwmmode> pwmmode{};
        }
        ///PWM channel2 enable
        ...
        namespace Pwmen2ValC{
            ...
            constexpr Register::FieldValue<decltype(pwmen2),Pwmen2Val::pwmmode> pwmmode{};
        }
        ...
        namespace Pwmen3ValC{
            ...
            constexpr Register::FieldValue<decltype(pwmen3),Pwmen3Val::pwmmode> pwmmode{};
        }
    }
}
