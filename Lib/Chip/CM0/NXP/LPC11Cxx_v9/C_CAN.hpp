...
//C_CAN controller 
    namespace Nonecancntl{    ///<CAN control
        ...
        namespace DarValC{
            constexpr Register::FieldValue<decltype(dar),DarVal::automaticRetransmis> automaticRetransmis{};
            constexpr Register::FieldValue<decltype(dar),DarVal::automaticRetransmis> automaticRetransmis{};
        }
        ...
        namespace Enum_ValC{
            constexpr Register::FieldValue<decltype(enum_),Enum_Val::normalOperation> normalOperation{};
            constexpr Register::FieldValue<decltype(enum_),Enum_Val::testMode> testMode{};
        }
    }
    ...
    namespace Nonecanec{    ///<Error counter
        ...
        namespace RpValC{
            constexpr Register::FieldValue<decltype(rp),RpVal::theReceiveCounter> theReceiveCounter{};
            constexpr Register::FieldValue<decltype(rp),RpVal::theReceiveCounter> theReceiveCounter{};
        }
    }
