...
//10-bit ADC
    namespace Nonecr{    ///<A/D Control Register. The ADCR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace burstValC{
            constexpr MPL::Value<burstVal,burstVal::swmode> swmode{};
            constexpr MPL::Value<burstVal,burstVal::hwmode> hwmode{};
        }
        ...
        namespace clksValC{
            constexpr MPL::Value<clksVal,clksVal::v10bit> v10bit{};
            constexpr MPL::Value<clksVal,clksVal::v9bit> v9bit{};
            constexpr MPL::Value<clksVal,clksVal::v8bit> v8bit{};
            constexpr MPL::Value<clksVal,clksVal::v7bit> v7bit{};
            constexpr MPL::Value<clksVal,clksVal::v6bit> v6bit{};
            constexpr MPL::Value<clksVal,clksVal::v5bit> v5bit{};
            constexpr MPL::Value<clksVal,clksVal::v4bit> v4bit{};
            constexpr MPL::Value<clksVal,clksVal::v3bit> v3bit{};
        }
        ...
        namespace startValC{
            ...
            constexpr MPL::Value<startVal,startVal::edgepio02> edgepio02{};
            constexpr MPL::Value<startVal,startVal::edgepio15> edgepio15{};
            constexpr MPL::Value<startVal,startVal::edgect32b0Mat01> edgect32b0Mat01{};
            constexpr MPL::Value<startVal,startVal::edgect32b0Mat11> edgect32b0Mat11{};
            constexpr MPL::Value<startVal,startVal::edgect16b0Mat01> edgect16b0Mat01{};
            constexpr MPL::Value<startVal,startVal::edgect16b0Mat11> edgect16b0Mat11{};
        }
    ...
    namespace Noneinten{    ///<A/D Interrupt Enable Register. This register contains enable bits that allow the DONE flag of each A/D channel to be included or excluded from contributing to the generation of an A/D interrupt.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> adintenn{}; 
