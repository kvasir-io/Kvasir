...
//SPI0
    ...
    namespace Nonecr1{    ///<Control Register 1. Selects master/slave and other modes.
        ...
        namespace LbmValC{
            ...
            constexpr Register::FieldValue<decltype(lbm),LbmVal::loopback> loopback{};
        }
        ///SPI Enable.
        enum class SseVal {
        ...
        namespace SseValC{
            constexpr Register::FieldValue<decltype(sse),SseVal::disable> disable{};
            constexpr Register::FieldValue<decltype(sse),SseVal::enable> enable{};
        }
