...
//Windowed Watchdog Timer (WWDT)
    namespace Nonemod{    ///<Watchdog mode register. This register contains the basic mode and status of the Watchdog Timer.
        ...
        namespace WdenValC{
            constexpr Register::FieldValue<decltype(wden),WdenVal::stopped> stopped{};
            constexpr Register::FieldValue<decltype(wden),WdenVal::running> running{};
        }
        ...
        namespace WdprotectValC{
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::notLocked> notLocked{};
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::locked> locked{};
        }
    ...
    namespace Noneclksel{    ///<Watchdog clock select register.
        ...
        namespace ClkselValC{
            ...
            constexpr Register::FieldValue<decltype(clksel),ClkselVal::watchdogOscillator> watchdogOscillator{};
        }
