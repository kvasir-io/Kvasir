...
//I2C-bus controller
    ...
    namespace Nonemmctrl{    ///<Monitor mode control register.
        ...
        namespace EnasclValC{
            constexpr Register::FieldValue<decltype(enaScl),EnasclVal::high> high{};
            constexpr Register::FieldValue<decltype(enaScl),EnasclVal::normal> normal{};
        }
        ...
        namespace MatchallValC{
            constexpr Register::FieldValue<decltype(matchAll),MatchallVal::match> match{};
            constexpr Register::FieldValue<decltype(matchAll),MatchallVal::anyaddress> anyaddress{};
        }
    }
    ...
    namespace Nonemask0{    ///<I2C Slave address mask register. This mask register is associated with I2ADR0 to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace Nonemask1{    ///<I2C Slave address mask register. This mask register is associated with I2ADR0 to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace Nonemask2{    ///<I2C Slave address mask register. This mask register is associated with I2ADR0 to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace Nonemask3{    ///<I2C Slave address mask register. This mask register is associated with I2ADR0 to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
