...
//USART
    ...
    namespace UsartSyncctrl{    ///<Synchronous mode control register.
        ...
        ///Start/stop bits
        enum class SsdisVal {
            send=0x00000000,     ///<Send start and stop bits as in other modes.
            doNotSend=0x00000001,     ///<Do not send start/stop bits.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,SsdisVal> ssdis{}; 
        namespace SsdisValC{
            constexpr Register::FieldValue<decltype(ssdis)::Type,SsdisVal::send> send{};
            constexpr Register::FieldValue<decltype(ssdis)::Type,SsdisVal::doNotSend> doNotSend{};
        }
