...
namespace Kvasir {
//IOCON block
    namespace IoconResetPio00{    ///<I/O configuration register for pin RESET/PIO0_0
    ...
    namespace IoconPio01{    ///<I/O configuration register for pin PIO0_1/RXD/CLKOUT/ CT32B0_MAT2/SSEL0/ CLKIN
        ...
        enum class FuncVal {
            pio01=0x00000000,     ///<General purpose digital input/output pin. A LOW level on                                    this pin during reset starts the ISP command                                    handler.
    ...
    namespace IoconPio02{    ///<I/O configuration register for pin PIO0_2/SCL/ACMP_O/ TCK/SWCLK/ CT16B0_CAP0
        ...
        enum class FuncVal {
            pio02=0x00000000,     ///<General purpose digital input/output pin. High-current                                    sink (20 mA) or standard-current sink (4 mA) programmable; true                                    open-drain for all pin functions. Input glitch filter (50 ns)                                    capable.
    ...
    namespace IoconPio03{    ///<I/O configuration register for pin PIO0_3/SDA/ACMP_O/ SWDIO/CT16B1_CAP0
        ...
        enum class FuncVal {
            pio03=0x00000000,     ///<General purpose digital input/output pin. High-current                                    sink (20 mA) or standard-current sink (4 mA) programmable; true                                    open-drain for all pin functions. Input glitch filter (50 ns)                                    capable.
    ...
    namespace IoconPio04{    ///<I/O configuration register for pin PIO0_4/R/AOUT/ CT16B0_MAT1/MOSI0
        ...
        enum class FuncVal {
            pio04=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconTckSwclkPio05{    ///<I/O configuration register for pin TCK/SWCLK/PIO0_5/ R/CT16B0_MAT2/ SCK0 
        ...
        enum class FuncVal {
            tckSwclk=0x00000000,     ///<Test clock TCK for JTAG interface and primary (default)                                    Serial Wire Debug Clock. Input glitch filter (10 ns)                                    capable.
    ...
    namespace IoconTdiPio06{    ///<I/O configuration register for pin TDI/PIO0_6/AD0/ CT32B0_MAT3/MISO0
        ...
        enum class FuncVal {
            tdi=0x00000000,     ///<Test Data In for JTAG interface. Input glitch filter (10                                    ns) capable.
    ...
    namespace IoconTmsPio07{    ///<I/O configuration register for pin TMS/PIO0_7/AD1/ CT32B1_CAP0/ CT16B0_MAT0
        ...
        enum class FuncVal {
            tms=0x00000000,     ///<Test Mode Select for JTAG interface. Input glitch filter                                    (10 ns) capable.
    ...
    namespace IoconTdoPio08{    ///<I/O configuration register for pin TDO/PIO0_8/AD2/ CT32B1_MAT0/SCK1
    ...
    namespace IoconTrstPio09{    ///<I/O configuration register for pin TRST/PIO0_9/AD3/CT32B1_MAT1/CT16B0_MAT1/CTS
        ...
        enum class FuncVal {
            trst=0x00000000,     ///<Test Reset for JTAG interface. Input glitch filter (10                                    ns) capable.
    ...
    namespace IoconSwdioPio010{    ///<I/O configuration register for pin SWDIO/PIO0_10/AD4/ CT32B1_MAT2/ CT16B0_MAT2/RTS
        ...
        enum class FuncVal {
            swdio=0x00000000,     ///<Primary (default) Serial Wire Debug I/O for the LQFP48                                    and HVQFN33 packages. For the WLCSP20 package, use PIO0_3. Input                                    glitch filter (10 ns) capable.
    ...
    namespace IoconPio011{    ///<I/O configuration register for pin PIO0_11/SCLK/ AD5/CT32B1_MAT3/ CT32B0_CAP0
        ...
        enum class FuncVal {
            pio011=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio012{    ///<I/O configuration register for pin PIO0_12/RXD/ ACMP_O/ CT32B0_MAT0/SCL/ CLKIN
    ...
    namespace IoconPio013{    ///<I/O configuration register for pin PIO0_13/TXD/ ACMP_I2/ CT32B0_MAT1/SDA
        ...
        enum class FuncVal {
            pio013=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio014{    ///<I/O configuration register for pin PIO0_14/MISO1/AD6/CT32B0_CAP1/CT16B1_MAT1/VDDCMP
        ...
        enum class FuncVal {
            pio014=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio015{    ///<I/O configuration register for pin PIO0_15/TXD/AD7/ CT32B0_CAP2/SDA
        ...
        enum class FuncVal {
            pio015=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio016{    ///<I/O configuration register for pin PIO0_16/ ATRG0/ACMP_I3/ CT16B0_CAP1/SCL
        ...
        enum class FuncVal {
            pio016=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio017{    ///<I/O configuration register for pin PIO0_17/ ATRG1/ACMP_I4/ CT16B0_CAP2/ CT16B0_MAT0
        ...
        enum class FuncVal {
            pio017=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio018{    ///<I/O configuration register for pin PIO0_18/R/SSEL0/ CT16B0_CAP0/ CT16B1_CAP1
    ...
    namespace IoconPio019{    ///<I/O configuration register for pin PIO0_19/CLKIN/ CLKOUT/ MOSI0/CT16B1_MAT0
    ...
    namespace IoconPio020{    ///<I/O configuration register for pin PIO0_20/R/SCK0/ CT32B1_CAP0/ CT16B1_MAT2
    ...
    namespace IoconPio021{    ///<I/O configuration register for pin PIO0_21/CTS/ ACMP_O/ CT32B1_CAP1/SCLK
        ...
        enum class FuncVal {
            pio021=0x00000000,     ///<General purpose digital input/output pin. If configured                                    as output, this pin is a high-current source output driver (20                                    mA).
    ...
    namespace IoconPio022{    ///<I/O configuration register for pin PIO0_22/MISO0/ ACMP_I5/ CT32B1_MAT2/ CT32B1_CAP2
        ...
        enum class FuncVal {
            pio022=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio023{    ///<I/O configuration register for pin PIO0_23/RTS/ ACMP_O/ CT32B0_CAP0/SCLK
    ...
    namespace IoconPio024{    ///<I/O configuration register for pin PIO0_24/SCL/CLKIN/ CT16B1_CAP0
    ...
    namespace IoconPio025{    ///<I/O configuration register for pin PIO0_25/SDA/SSEL1/ CT16B1_MAT0
    ...
    namespace IoconPio026{    ///<I/O configuration register for pin PIO0_26/TXD/MISO1/ CT16B1_CAP1/ CT32B0_CAP2
    ...
    namespace IoconPio027{    ///<I/O configuration register for pin PIO0_27/MOSI1/ ACMP_I1/ CT32B1_MAT1/ CT16B1_CAP2
        ...
        enum class FuncVal {
            pio027=0x00000000,     ///<General purpose digital input/output pin. Input glitch                                    filter (10 ns) capable.
    ...
    namespace IoconPio028{    ///<I/O configuration register for pin PIO0_28/DTR/SSEL1/ CT32B0_CAP0
    ...
    namespace IoconPio029{    ///<I/O configuration register for pin PIO0_29/DSR/SCK1/ CT32B0_CAP1
    ...
    namespace IoconPio030{    ///<I/O configuration register for pin PIO0_30/RI/MOSI1/ CT32B0_MAT0/ CT16B0_CAP0
    ...
    namespace IoconPio031{    ///<I/O configuration register for pin PIO0_31/RI/MOSI1/ CT32B1_MAT0/ CT16B1_CAP1
    ...
    namespace IoconPio10{    ///<I/O configuration register for pin PIO1_0/DCD/SCK0/ CT32B1_MAT3/ CT16B0_MAT1
    ...
    namespace IoconPio11{    ///<I/O configuration register for pin PIO1_1/DTR/SSEL0/ CT32B1_MAT3/ CT16B1_MAT0
    ...
    namespace IoconPio12{    ///<I/O configuration register for pin PIO1_2/DSR/MISO0/ CT16B1_MAT2/ CT16B1_MAT1
    ...
    namespace IoconPio13{    ///<I/O configuration register for pin PIO1_3/RI/MOSI0/ CT16B1_CAP0
    ...
    namespace IoconPio14{    ///<I/O configuration register for pin PIO1_4/RXD/SSEL1/ CT32B0_MAT1/ CT32B1_CAP0/ CT16B0_CAP1
    ...
    namespace IoconPio15{    ///<I/O configuration register for pin PIO1_5/TXD/SCK1/ CT32B0_MAT2/ CT32B1_CAP1/ CT16B0_CAP2
    ...
    namespace IoconPio16{    ///<I/O configuration register for pin PIO1_6/RTS/MOSI1/ CT32B0_MAT3/ CT32B1_CAP2/ CT16B0_MAT0
    ...
    namespace IoconPio17{    ///<I/O configuration register for pin PIO1_7/CTS/MOSI0/ CT32B1_MAT1/ CT16B0_MAT2/ CT16B1_CAP2
    ...
    namespace IoconPio18{    ///<I/O configuration register for pin PIO1_8/RXD / MISO1/ CT32B1_MAT0/ CT16B1_MAT1
    ...
    namespace IoconPio19{    ///<I/O configuration register for pin PIO1_9/DCD/R/ CT32B1_MAT2 / CT16B1_MAT2
