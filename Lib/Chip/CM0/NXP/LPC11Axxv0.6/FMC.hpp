...
namespace Kvasir {
//Flash controller
    namespace FmcEemsstart{    ///<EEPROM BIST start address register
    ...
    namespace FmcEemsstop{    ///<EEPROM BIST stop address register
    ...
    namespace FmcEemssig{    ///<EEPROM 24-bit BIST signature register
    ...
    namespace FmcFlashcfg{    ///<Flash memory access time configuration register
