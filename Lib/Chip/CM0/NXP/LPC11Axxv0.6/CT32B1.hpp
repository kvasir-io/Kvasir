...
//32-bit counter/timers CT32B0/1
    ...
    namespace Ct32b1Cr0{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT32B_CAP0 input.
    ...
    namespace Ct32b1Cr1{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT32B_CAP0 input.
        using Addr = Register::Address<0x40018030,0x00000000,0x00000000,unsigned>;
        ///Timer counter capture value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
    namespace Ct32b1Cr2{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT32B_CAP0 input.
        using Addr = Register::Address<0x40018034,0x00000000,0x00000000,unsigned>;
        ///Timer counter capture value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
    namespace Ct32b1Cr3{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT32B_CAP0 input.
        using Addr = Register::Address<0x40018038,0x00000000,0x00000000,unsigned>;
        ///Timer counter capture value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
    namespace Ct32b1Mr0{    ///<Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR matches the TC.
