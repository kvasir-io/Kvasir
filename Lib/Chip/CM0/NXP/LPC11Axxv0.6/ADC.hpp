...
//ADC 
    namespace Nonecr{    ///<A/D Control Register. The CR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace ClksValC{
            ...
            constexpr Register::FieldValue<decltype(clks),ClksVal::v6Clock> v6Clock{};
        ...
        namespace SingleburstValC{
            constexpr Register::FieldValue<decltype(singleburst),SingleburstVal::continuousBurst> continuousBurst{};
            constexpr Register::FieldValue<decltype(singleburst),SingleburstVal::singleBurst> singleBurst{};
        }
        ...
        namespace StartValC{
            ...
            constexpr Register::FieldValue<decltype(start),StartVal::startConversionWhe> startConversionWhe{};
            constexpr Register::FieldValue<decltype(start),StartVal::startConversionWhe> startConversionWhe{};
            constexpr Register::FieldValue<decltype(start),StartVal::startConversionWhe> startConversionWhe{};
            constexpr Register::FieldValue<decltype(start),StartVal::startConversionWhe> startConversionWhe{};
            constexpr Register::FieldValue<decltype(start),StartVal::startConversionWhe> startConversionWhe{};
        ...
        namespace EdgeValC{
            constexpr Register::FieldValue<decltype(edge),EdgeVal::startConversionOn> startConversionOn{};
            constexpr Register::FieldValue<decltype(edge),EdgeVal::startConversionOn> startConversionOn{};
        }
    }
    ...
    namespace Nonesel{    ///<A/D Select Register. Selects between external pins and internal sources.
        ...
        namespace Ad5selValC{
            constexpr Register::FieldValue<decltype(ad5sel),Ad5selVal::ad5Pin> ad5Pin{};
            constexpr Register::FieldValue<decltype(ad5sel),Ad5selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr Register::FieldValue<decltype(ad5sel),Ad5selVal::coreVoltageRegulat> coreVoltageRegulat{};
            constexpr Register::FieldValue<decltype(ad5sel),Ad5selVal::reservedDoNotPro> reservedDoNotPro{};
        }
        ...
        namespace Ad6selValC{
            constexpr Register::FieldValue<decltype(ad6sel),Ad6selVal::ad6Pin> ad6Pin{};
            constexpr Register::FieldValue<decltype(ad6sel),Ad6selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr Register::FieldValue<decltype(ad6sel),Ad6selVal::internalVoltageRef> internalVoltageRef{};
            constexpr Register::FieldValue<decltype(ad6sel),Ad6selVal::reservedDoNotPro> reservedDoNotPro{};
        }
        ...
        namespace Ad7selValC{
            constexpr Register::FieldValue<decltype(ad7sel),Ad7selVal::ad7Pin> ad7Pin{};
            constexpr Register::FieldValue<decltype(ad7sel),Ad7selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr Register::FieldValue<decltype(ad7sel),Ad7selVal::temperatureSensor> temperatureSensor{};
            constexpr Register::FieldValue<decltype(ad7sel),Ad7selVal::reservedDoNotPro> reservedDoNotPro{};
        }
    }
