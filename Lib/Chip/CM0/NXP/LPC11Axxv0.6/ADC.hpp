...
//ADC 
    namespace Nonecr{    ///<A/D Control Register. The CR register must be written to select the operating mode before A/D conversion can occur.
        using Addr = Register::Address<0x4001c000,0xf0600000,0,unsigned>;
        ...
        namespace clksValC{
            ...
            constexpr MPL::Value<clksVal,clksVal::v6Clock> v6Clock{};
        ...
        namespace singleburstValC{
            constexpr MPL::Value<singleburstVal,singleburstVal::continuousBurst> continuousBurst{};
            constexpr MPL::Value<singleburstVal,singleburstVal::singleBurst> singleBurst{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,singleburstVal> singleburst{}; 
        ...
        namespace startValC{
            ...
            constexpr MPL::Value<startVal,startVal::startConversionWhe> startConversionWhe{};
            constexpr MPL::Value<startVal,startVal::startConversionWhe> startConversionWhe{};
            constexpr MPL::Value<startVal,startVal::startConversionWhe> startConversionWhe{};
            constexpr MPL::Value<startVal,startVal::startConversionWhe> startConversionWhe{};
            constexpr MPL::Value<startVal,startVal::startConversionWhe> startConversionWhe{};
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,23),Register::ReadWriteAccess,startVal> start{}; 
        ...
        namespace edgeValC{
            constexpr MPL::Value<edgeVal,edgeVal::startConversionOn> startConversionOn{};
            constexpr MPL::Value<edgeVal,edgeVal::startConversionOn> startConversionOn{};
        }
    ...
    namespace Nonesel{    ///<A/D Select Register. Selects between external pins and internal sources.
        using Addr = Register::Address<0x4001c008,0xffff03ff,0,unsigned>;
        ...
        namespace ad5selValC{
            constexpr MPL::Value<ad5selVal,ad5selVal::ad5Pin> ad5Pin{};
            constexpr MPL::Value<ad5selVal,ad5selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr MPL::Value<ad5selVal,ad5selVal::coreVoltageRegulat> coreVoltageRegulat{};
            constexpr MPL::Value<ad5selVal,ad5selVal::reservedDoNotPro> reservedDoNotPro{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,ad5selVal> ad5sel{}; 
        ...
        namespace ad6selValC{
            constexpr MPL::Value<ad6selVal,ad6selVal::ad6Pin> ad6Pin{};
            constexpr MPL::Value<ad6selVal,ad6selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr MPL::Value<ad6selVal,ad6selVal::internalVoltageRef> internalVoltageRef{};
            constexpr MPL::Value<ad6selVal,ad6selVal::reservedDoNotPro> reservedDoNotPro{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12),Register::ReadWriteAccess,ad6selVal> ad6sel{}; 
        ...
        namespace ad7selValC{
            constexpr MPL::Value<ad7selVal,ad7selVal::ad7Pin> ad7Pin{};
            constexpr MPL::Value<ad7selVal,ad7selVal::noConnectionOrLoa> noConnectionOrLoa{};
            constexpr MPL::Value<ad7selVal,ad7selVal::temperatureSensor> temperatureSensor{};
            constexpr MPL::Value<ad7selVal,ad7selVal::reservedDoNotPro> reservedDoNotPro{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,ad7selVal> ad7sel{}; 
    }
