...
//16-bit counter/timers CT16B0/1
    ...
    namespace Ct16b1Emr{    ///<External Match Register. The EMR controls the match function and the external match pins 
    ...
    namespace Ct16b1Cr0{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT16B0_CAP input.
    ...
    namespace Ct16b1Cr1{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT16B0_CAP input.
    ...
    namespace Ct16b1Cr2{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT16B0_CAP input.
    ...
    namespace Ct16b1Cr3{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CT16B0_CAP input.
