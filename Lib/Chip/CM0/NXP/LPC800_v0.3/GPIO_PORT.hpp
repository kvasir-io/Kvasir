...
//General Purpose I/O port (GPIO)
    ...
    namespace Nonedir0{    ///<Direction registers port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> dirp0{}; 
    }
    namespace Nonemask0{    ///<Mask register port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> maskp0{}; 
    }
    namespace Nonepin0{    ///<Port pin register port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> port0{}; 
    }
    namespace Nonempin0{    ///<Masked port register port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> mportp0{}; 
    }
    namespace Noneset0{    ///<Write: Set register for port 0 Read: output bits for port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> setp0{}; 
    }
    namespace Noneclr0{    ///<Clear port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> clrp0{}; 
    }
    namespace Nonenot0{    ///<Toggle port 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> notp0{}; 
    }
}
