...
//USART
    ...
    namespace Usart2Ctrl{    ///<USART Control register. USART control settings that are more likely to change during operation.
    ...
    namespace Usart2Stat{    ///<USART Status register. The complete status value can be read here. Writing 1s clears some bits in the register. Some bits can be cleared by writing a 1 to them.
        using Addr = Register::Address<0x4006c008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Intenset{    ///<Interrupt Enable read and Set register. Contains an individual interrupt enable bit for each potential USART interrupt. A complete value may be read from this register. Writing a 1 to any implemented bit position causes that bit to be set.
        using Addr = Register::Address<0x4006c00c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Rxdata{    ///<Receiver Data register. Contains the last character received.
    ...
    namespace Usart2Rxdatastat{    ///<Receiver Data with Status register. Combines the last character received with the current USART receive status. Allows software to recover incoming data and status together.
        using Addr = Register::Address<0x4006c018,0x00000000,0x00000000,unsigned>;
        ///The USART Receiver Data register contains the next received character. The number of bits that are relevant depends on the USART configuration settings.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rxdat{}; 
        ///Reserved, the value read from a reserved bit is not defined.
    ...
    namespace Usart2Txdata{    ///<Transmit Data register. Data to be transmitted is written here.
        using Addr = Register::Address<0x4006c01c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Brg{    ///<Baud Rate Generator register. 16-bit integer baud rate divisor value.
        using Addr = Register::Address<0x4006c020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Intstat{    ///<Interrupt status register. Reflects interrupts that are currently enabled.
        using Addr = Register::Address<0x4006c024,0x00000000,0x00000000,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Reserved. Read value is undefined, only zero should be written.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> reserved{}; 
