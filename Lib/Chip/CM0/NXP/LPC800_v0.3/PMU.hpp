...
//Power Management Unit (PMU)
    namespace Nonepcon{    ///<Power control register
        ...
        namespace SleepflagValC{
            constexpr Register::FieldValue<decltype(sleepflag),SleepflagVal::readNoPowerDown> readNoPowerDown{};
            constexpr Register::FieldValue<decltype(sleepflag),SleepflagVal::readSleepdeepSle> readSleepdeepSle{};
        }
        ...
        namespace DpdflagValC{
            constexpr Register::FieldValue<decltype(dpdflag),DpdflagVal::readDeepPowerDow> readDeepPowerDow{};
            constexpr Register::FieldValue<decltype(dpdflag),DpdflagVal::readDeepPowerDow> readDeepPowerDow{};
        }
    }
    ...
    namespace Nonedpdctrl{    ///<Deep power-down control register
        ...
        namespace WakeuphysValC{
            constexpr Register::FieldValue<decltype(wakeuphys),WakeuphysVal::disabledHysteresis> disabledHysteresis{};
            constexpr Register::FieldValue<decltype(wakeuphys),WakeuphysVal::enabledHysteresis> enabledHysteresis{};
        }
        ...
        namespace WakepaddisableValC{
            constexpr Register::FieldValue<decltype(wakepadDisable),WakepaddisableVal::enabledTheWakeUp> enabledTheWakeUp{};
            constexpr Register::FieldValue<decltype(wakepadDisable),WakepaddisableVal::disabledSettingTh> disabledSettingTh{};
        }
        ...
        namespace LposcenValC{
            constexpr Register::FieldValue<decltype(lposcen),LposcenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(lposcen),LposcenVal::enabled> enabled{};
        }
        ...
        namespace LposcdpdenValC{
            constexpr Register::FieldValue<decltype(lposcdpden),LposcdpdenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(lposcdpden),LposcdpdenVal::enabled> enabled{};
        }
    }
}
