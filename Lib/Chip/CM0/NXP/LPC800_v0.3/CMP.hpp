...
//Analog comparator
    namespace Nonectrl{    ///<Comparator control register
        ...
        namespace EdgeselValC{
            constexpr Register::FieldValue<decltype(edgesel),EdgeselVal::fallingEdges> fallingEdges{};
            constexpr Register::FieldValue<decltype(edgesel),EdgeselVal::risingEdges> risingEdges{};
            constexpr Register::FieldValue<decltype(edgesel),EdgeselVal::bothEdges> bothEdges{};
            constexpr Register::FieldValue<decltype(edgesel),EdgeselVal::bothEdges> bothEdges{};
        }
        ...
        namespace CompvpselValC{
            constexpr Register::FieldValue<decltype(compVpSel),CompvpselVal::voltageLadderOutpu> voltageLadderOutpu{};
            ...
            constexpr Register::FieldValue<decltype(compVpSel),CompvpselVal::internalReferenceV> internalReferenceV{};
        }
        ...
        namespace CompvmselValC{
            constexpr Register::FieldValue<decltype(compVmSel),CompvmselVal::voltageLadderOutpu> voltageLadderOutpu{};
            ...
            constexpr Register::FieldValue<decltype(compVmSel),CompvmselVal::internalReferenceV> internalReferenceV{};
        }
        ...
        namespace HysValC{
            constexpr Register::FieldValue<decltype(hys),HysVal::noneTheOutputWil> noneTheOutputWil{};
            constexpr Register::FieldValue<decltype(hys),HysVal::v5Mv> v5Mv{};
            constexpr Register::FieldValue<decltype(hys),HysVal::v10Mv> v10Mv{};
            constexpr Register::FieldValue<decltype(hys),HysVal::v20Mv> v20Mv{};
        }
    }
    namespace Nonelad{    ///<Voltage ladder register
        ...
        namespace LadrefValC{
            constexpr Register::FieldValue<decltype(ladref),LadrefVal::supplyPinVdd> supplyPinVdd{};
