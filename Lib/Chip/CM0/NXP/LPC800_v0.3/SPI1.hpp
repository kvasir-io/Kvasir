...
//SPI
    namespace Spi1Cfg{    ///<SPI Configuration register
        using Addr = Register::Address<0x4005c000,0x00000000,0x00000000,unsigned>;
        ///SPI enable.
    ...
    namespace Spi1Dly{    ///<SPI Delay register
        using Addr = Register::Address<0x4005c004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Stat{    ///<SPI Status. Some status flags can be cleared by writing a 1 to that bit position
        using Addr = Register::Address<0x4005c008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Intenset{    ///<SPI Interrupt Enable read and Set. A complete value may be read from this register. Writing a 1 to any implemented bit position causes that bit to be set.
        using Addr = Register::Address<0x4005c00c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Intenclr{    ///<SPI Interrupt Enable Clear. Writing a 1 to any implemented bit position causes the corresponding bit in INTENSET to be cleared.
        using Addr = Register::Address<0x4005c010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Rxdat{    ///<SPI Receive Data
        using Addr = Register::Address<0x4005c014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txdatctl{    ///<SPI Transmit Data with Control
        using Addr = Register::Address<0x4005c018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txdat{    ///<SPI Transmit Data
        using Addr = Register::Address<0x4005c01c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Txctl{    ///<SPI Transmit Control
        using Addr = Register::Address<0x4005c020,0x00000000,0x00000000,unsigned>;
        ///Reserved. Read value is undefined, only zero should be written.
    ...
    namespace Spi1Div{    ///<SPI clock Divider
        using Addr = Register::Address<0x4005c024,0x00000000,0x00000000,unsigned>;
    ...
    namespace Spi1Intstat{    ///<SPI Interrupt Status
        using Addr = Register::Address<0x4005c028,0x00000000,0x00000000,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
