...
//SPI
    namespace Nonecfg{    ///<SPI Configuration register
        ...
        namespace EnableValC{
            constexpr Register::FieldValue<decltype(enable),EnableVal::disabledTheSpiIs> disabledTheSpiIs{};
            constexpr Register::FieldValue<decltype(enable),EnableVal::enabledTheSpiIs> enabledTheSpiIs{};
        }
        ///Master mode select.
        ...
        namespace MasterValC{
            constexpr Register::FieldValue<decltype(master),MasterVal::slaveModeTheSpi> slaveModeTheSpi{};
            constexpr Register::FieldValue<decltype(master),MasterVal::masterModeTheSpi> masterModeTheSpi{};
        }
        ...
        namespace LsbfValC{
            constexpr Register::FieldValue<decltype(lsbf),LsbfVal::standardDataIsTr> standardDataIsTr{};
            constexpr Register::FieldValue<decltype(lsbf),LsbfVal::reverseDataIsTra> reverseDataIsTra{};
        }
        ///Clock Phase select. .
        enum class CphaVal {
        ...
        namespace CphaValC{
            constexpr Register::FieldValue<decltype(cpha),CphaVal::changeTheSpiCapt> changeTheSpiCapt{};
            constexpr Register::FieldValue<decltype(cpha),CphaVal::captureTheSpiCha> captureTheSpiCha{};
        }
        ...
        namespace CpolValC{
            constexpr Register::FieldValue<decltype(cpol),CpolVal::lowTheRestState> lowTheRestState{};
            constexpr Register::FieldValue<decltype(cpol),CpolVal::highTheRestState> highTheRestState{};
        }
        ...
        namespace SpolValC{
            constexpr Register::FieldValue<decltype(spol),SpolVal::lowTheSselPinIs> lowTheSselPinIs{};
            constexpr Register::FieldValue<decltype(spol),SpolVal::highTheSselPinI> highTheSselPinI{};
        }
    }
    ...
    namespace Nonetxdatctl{    ///<SPI Transmit Data with Control
        ...
        namespace TxsselnValC{
            constexpr Register::FieldValue<decltype(txsseln),TxsselnVal::sselAsserted> sselAsserted{};
            constexpr Register::FieldValue<decltype(txsseln),TxsselnVal::sselNotAsserted> sselNotAsserted{};
        }
        ...
        namespace EotValC{
            ...
            constexpr Register::FieldValue<decltype(eot),EotVal::sselDeassertedThi> sselDeassertedThi{};
        }
        ...
        namespace EofValC{
            constexpr Register::FieldValue<decltype(eof),EofVal::dataNotEofThisP> dataNotEofThisP{};
            constexpr Register::FieldValue<decltype(eof),EofVal::dataEofThisPiece> dataEofThisPiece{};
        }
