...
//Multi-Rate Timer (MRT)
    namespace Noneintval0{    ///<MRT0 Time interval value register. This value is loaded into the TIMER0 register.
        ...
        namespace LoadValC{
            constexpr Register::FieldValue<decltype(load),LoadVal::noForceLoadTheL> noForceLoadTheL{};
            constexpr Register::FieldValue<decltype(load),LoadVal::forceLoadTheIntv> forceLoadTheIntv{};
        }
    }
    ...
    namespace Nonectrl0{    ///<MRT0 Control register. This register controls the MRT0 modes.
        ...
        namespace ModeValC{
            ...
            constexpr Register::FieldValue<decltype(mode),ModeVal::oneShotBusStallM> oneShotBusStallM{};
        }
    }
    ...
    namespace Nonestat0{    ///<MRT0 Status register.
        ...
        namespace IntflagValC{
            ...
            constexpr Register::FieldValue<decltype(intflag),IntflagVal::pendingInterruptT> pendingInterruptT{};
        }
        ...
        namespace RunValC{
            constexpr Register::FieldValue<decltype(run),RunVal::idleStateTimernI> idleStateTimernI{};
            constexpr Register::FieldValue<decltype(run),RunVal::runningTimernIsR> runningTimernIsR{};
        }
    }
    ...
    namespace NoneirqFlag{    ///<Global interrupt flag register
        ...
        namespace Gflag0ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag0),Gflag0Val::pendingInterruptT> pendingInterruptT{};
        }
        ...
        namespace Gflag1ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag1),Gflag1Val::pendingInterruptT> pendingInterruptT{};
        }
        ...
        namespace Gflag2ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag2),Gflag2Val::pendingInterruptT> pendingInterruptT{};
        }
        ...
        namespace Gflag3ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag3),Gflag3Val::pendingInterruptT> pendingInterruptT{};
        }
    }
}
