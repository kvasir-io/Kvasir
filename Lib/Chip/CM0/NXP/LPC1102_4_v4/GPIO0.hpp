...
//General Purpose I/O (GPIO) 
    namespace Gpio0Data{    ///<Port n data address masking register locations for pins PIOn_0 to PIOn_11 (see  Section 9.4.1).
        using Addr = Register::Address<0x50003ff8,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio0Dir{    ///<Data direction register for port n
        using Addr = Register::Address<0x50008000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio0Iev{    ///<Interrupt event register for port n
        using Addr = Register::Address<0x5000800c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio0Ie{    ///<Interrupt mask register for port n
        using Addr = Register::Address<0x50008010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio0Ic{    ///<Interrupt clear register for port n
        using Addr = Register::Address<0x5000801c,0x00000000,0x00000000,unsigned>;
