...
//Product name title=UM10398 Chapter title=LPC1100XL series: 32-bit counter/timer CT32B0/1 Modification date=2/22/2012 Major revision=8 Minor revision=not available 
    namespace Ct32b0Ir{    ///<Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
        using Addr = Register::Address<0x40014000,0xffffffc0,0x00000000,unsigned>;
    ...
    namespace Ct32b0Tcr{    ///<Timer Control Register (TCR). The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
        using Addr = Register::Address<0x40014004,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Ct32b0Mcr{    ///<Match Control Register (MCR). The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
        using Addr = Register::Address<0x40014014,0xfffff000,0x00000000,unsigned>;
        ...
        namespace Mr0iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0i)::Type,Mr0iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0i)::Type,Mr0iVal::disabled> disabled{};
        }
        ...
        namespace Mr0rValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0r)::Type,Mr0rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0r)::Type,Mr0rVal::disabled> disabled{};
        }
        ...
        namespace Mr0sValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0s)::Type,Mr0sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr0s)::Type,Mr0sVal::disabled> disabled{};
        }
        ...
        namespace Mr1iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1i)::Type,Mr1iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1i)::Type,Mr1iVal::disabled> disabled{};
        }
        ...
        namespace Mr1rValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1r)::Type,Mr1rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1r)::Type,Mr1rVal::disabled> disabled{};
        }
        ...
        namespace Mr1sValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1s)::Type,Mr1sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr1s)::Type,Mr1sVal::disabled> disabled{};
        }
        ...
        namespace Mr2iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2i)::Type,Mr2iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2i)::Type,Mr2iVal::disabled> disabled{};
        }
        ...
        namespace Mr2rValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2r)::Type,Mr2rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2r)::Type,Mr2rVal::disabled> disabled{};
        }
        ...
        namespace Mr2sValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2s)::Type,Mr2sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr2s)::Type,Mr2sVal::disabled> disabled{};
        }
        ...
        namespace Mr3iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3i)::Type,Mr3iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3i)::Type,Mr3iVal::disabled> disabled{};
        }
        ...
        namespace Mr3rValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3r)::Type,Mr3rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3r)::Type,Mr3rVal::disabled> disabled{};
        }
        ...
        namespace Mr3sValC{
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3s)::Type,Mr3sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Mcr::mr3s)::Type,Mr3sVal::disabled> disabled{};
        }
    }
    namespace Ct32b0Mr0{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
    ...
    namespace Ct32b0Mr1{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x4001401c,0x00000000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct32b0Mr2{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x40014020,0x00000000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct32b0Mr3{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
    ...
    namespace Ct32b0Ccr{    ///<Capture Control Register (CCR). The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x40014028,0xffffffc0,0x00000000,unsigned>;
        ...
        namespace Cap0reValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0re)::Type,Cap0reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0re)::Type,Cap0reVal::disabled> disabled{};
        }
        ...
        namespace Cap0feValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0fe)::Type,Cap0feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0fe)::Type,Cap0feVal::disabled> disabled{};
        }
        ...
        namespace Cap0iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0i)::Type,Cap0iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap0i)::Type,Cap0iVal::disabled> disabled{};
        }
        ...
        namespace Cap1reValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1re)::Type,Cap1reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1re)::Type,Cap1reVal::disabled> disabled{};
        }
        ...
        namespace Cap1feValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1fe)::Type,Cap1feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1fe)::Type,Cap1feVal::disabled> disabled{};
        }
        ...
        namespace Cap1iValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1i)::Type,Cap1iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct32b0Ccr::cap1i)::Type,Cap1iVal::disabled> disabled{};
        }
    }
    namespace Ct32b0Cr0{    ///<Capture Register (CR). CR is loaded with the value of TC when there is an event on the CT16Bn_CAPm input.
    ...
    namespace Ct32b0Cr1{    ///<Capture Register (CR). CR is loaded with the value of TC when there is an event on the CT16Bn_CAPm input.
    ...
    namespace Ct32b0Emr{    ///<External Match Register (EMR). The EMR controls the match function and the external match pins CT32B0_MAT[3:0].
        using Addr = Register::Address<0x4001403c,0xfffff000,0x00000000,unsigned>;
        ...
        namespace Emc0ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc0)::Type,Emc0Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc0)::Type,Emc0Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc0)::Type,Emc0Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc0)::Type,Emc0Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc1ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc1)::Type,Emc1Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc1)::Type,Emc1Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc1)::Type,Emc1Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc1)::Type,Emc1Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc2ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc2)::Type,Emc2Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc2)::Type,Emc2Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc2)::Type,Emc2Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc2)::Type,Emc2Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc3ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc3)::Type,Emc3Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc3)::Type,Emc3Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc3)::Type,Emc3Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct32b0Emr::emc3)::Type,Emc3Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
    }
    namespace Ct32b0Ctcr{    ///<Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        using Addr = Register::Address<0x40014070,0xffffff00,0x00000000,unsigned>;
        ...
        namespace CtmValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::ctm)::Type,CtmVal::timerModeEveryRi> timerModeEveryRi{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs1> counterModeTcIs1{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs2> counterModeTcIs2{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs3> counterModeTcIs3{};
        }
        ...
        namespace CisValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::cis)::Type,CisVal::ct32bnCap0> ct32bnCap0{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::cis)::Type,CisVal::ct32bnCap1> ct32bnCap1{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::cis)::Type,CisVal::reservedNoteIfCo> reservedNoteIfCo{};
        }
        ...
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::selcc)::Type,SelccVal::risingEdgeOfCap0> risingEdgeOfCap0{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::selcc)::Type,SelccVal::fallingEdgeOfCap0> fallingEdgeOfCap0{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::selcc)::Type,SelccVal::risingEdgeOfCap1> risingEdgeOfCap1{};
            constexpr Register::FieldValue<decltype(Ct32b0Ctcr::selcc)::Type,SelccVal::fallingEdgeOfCap1> fallingEdgeOfCap1{};
        }
    }
    namespace Ct32b0Pwmc{    ///<PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT32B0_MAT[3:0].
        using Addr = Register::Address<0x40014074,0xfffffff0,0x00000000,unsigned>;
        ...
        namespace Pwmen0ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen0)::Type,Pwmen0Val::ct32bnMat0IsContr> ct32bnMat0IsContr{};
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen0)::Type,Pwmen0Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen1)::Type,Pwmen1Val::ct32bnMat1IsContr> ct32bnMat1IsContr{};
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen1)::Type,Pwmen1Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen2)::Type,Pwmen2Val::ct32bnMat2IsContr> ct32bnMat2IsContr{};
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen2)::Type,Pwmen2Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen3)::Type,Pwmen3Val::ct32bnMat3IsContr> ct32bnMat3IsContr{};
            constexpr Register::FieldValue<decltype(Ct32b0Pwmc::pwmen3)::Type,Pwmen3Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
    }
}
