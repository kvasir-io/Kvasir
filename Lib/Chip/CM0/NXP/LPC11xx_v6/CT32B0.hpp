...
//Product name title=UM10398 Chapter title=LPC1100XL series: 32-bit counter/timer CT32B0/1 Modification date=2/22/2012 Major revision=8 Minor revision=not available 
    ...
    namespace Nonepr{    ///<Prescale Register (PR). When the Prescale Counter (below) is equal to this value, the next clock increments the TC and clears the PC.
        ...
        ///Prescale value.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> pr{}; 
    }
...
interrupt every time MR matches the TC.
    ...
    namespace Nonectcr{    ///<Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace cisValC{
            ...
            constexpr MPL::Value<cisVal,cisVal::reservedNoteIfCo> reservedNoteIfCo{};
        }
        ...
        enum class selccVal {
            ...
            reserved=0x00000006,     ///<Reserved.
            reserved=0x00000007,     ///<Reserved.
        };
        namespace selccValC{
            constexpr MPL::Value<selccVal,selccVal::risingEdgeOfCap0> risingEdgeOfCap0{};
            constexpr MPL::Value<selccVal,selccVal::fallingEdgeOfCap0> fallingEdgeOfCap0{};
            constexpr MPL::Value<selccVal,selccVal::risingEdgeOfCap1> risingEdgeOfCap1{};
            constexpr MPL::Value<selccVal,selccVal::fallingEdgeOfCap1> fallingEdgeOfCap1{};
    ...
    namespace Nonepwmc{    ///<PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT32B0_MAT[3:0].
        ...
        namespace pwmen0ValC{
            constexpr MPL::Value<pwmen0Val,pwmen0Val::ct32bnMat0IsContr> ct32bnMat0IsContr{};
        ...
        namespace pwmen1ValC{
            constexpr MPL::Value<pwmen1Val,pwmen1Val::ct32bnMat1IsContr> ct32bnMat1IsContr{};
        ...
        namespace pwmen2ValC{
            constexpr MPL::Value<pwmen2Val,pwmen2Val::ct32bnMat2IsContr> ct32bnMat2IsContr{};
        ...
        namespace pwmen3ValC{
            constexpr MPL::Value<pwmen3Val,pwmen3Val::ct32bnMat3IsContr> ct32bnMat3IsContr{};
