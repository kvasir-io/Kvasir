...
//power management unit
    namespace PmuPcon{    ///<Power control register
        using Addr = Register::Address<0x40038000,0xfffff6fd,0x00000000,unsigned>;
        ...
        namespace DpdenValC{
            constexpr Register::FieldValue<decltype(PmuPcon::dpden)::Type,DpdenVal::sleepmode> sleepmode{};
            constexpr Register::FieldValue<decltype(PmuPcon::dpden)::Type,DpdenVal::deeppowerdown> deeppowerdown{};
        }
        ///Sleep mode flag
        ...
        namespace SleepflagValC{
            constexpr Register::FieldValue<decltype(PmuPcon::sleepflag)::Type,SleepflagVal::nopowerdown> nopowerdown{};
            constexpr Register::FieldValue<decltype(PmuPcon::sleepflag)::Type,SleepflagVal::powerdown> powerdown{};
        }
        ...
        namespace DpdflagValC{
            constexpr Register::FieldValue<decltype(PmuPcon::dpdflag)::Type,DpdflagVal::nodeeppowerdown> nodeeppowerdown{};
            constexpr Register::FieldValue<decltype(PmuPcon::dpdflag)::Type,DpdflagVal::deeppowerdown> deeppowerdown{};
        }
    }
    ...
    namespace PmuGpreg4{    ///<General purpose register 4
        using Addr = Register::Address<0x40038014,0x000003ff,0x00000000,unsigned>;
        ...
        namespace WakeuphysValC{
            constexpr Register::FieldValue<decltype(PmuGpreg4::wakeuphys)::Type,WakeuphysVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(PmuGpreg4::wakeuphys)::Type,WakeuphysVal::disabled> disabled{};
        }
        ///Data retained during Deep power-down mode.
