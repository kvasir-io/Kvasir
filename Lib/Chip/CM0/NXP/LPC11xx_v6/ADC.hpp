...
namespace Kvasir {
//10-bit ADC
    namespace AdcCr{    ///<A/D Control Register. The ADCR register must be written to select the operating mode before A/D conversion can occur.
        using Addr = Register::Address<0x4001c000,0xf0f00000,0x00000000,unsigned>;
        ...
        namespace BurstValC{
            constexpr Register::FieldValue<decltype(AdcCr::burst)::Type,BurstVal::swmode> swmode{};
            constexpr Register::FieldValue<decltype(AdcCr::burst)::Type,BurstVal::hwmode> hwmode{};
        }
        ...
        namespace ClksValC{
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v10bit> v10bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v9bit> v9bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v8bit> v8bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v7bit> v7bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v6bit> v6bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v5bit> v5bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v4bit> v4bit{};
            constexpr Register::FieldValue<decltype(AdcCr::clks)::Type,ClksVal::v3bit> v3bit{};
        }
        ...
        namespace StartValC{
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::stop> stop{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::start> start{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgepio02> edgepio02{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgepio15> edgepio15{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgect32b0Mat01> edgect32b0Mat01{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgect32b0Mat11> edgect32b0Mat11{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgect16b0Mat01> edgect16b0Mat01{};
            constexpr Register::FieldValue<decltype(AdcCr::start)::Type,StartVal::edgect16b0Mat11> edgect16b0Mat11{};
        }
        ...
        namespace EdgeValC{
            constexpr Register::FieldValue<decltype(AdcCr::edge)::Type,EdgeVal::rising> rising{};
            constexpr Register::FieldValue<decltype(AdcCr::edge)::Type,EdgeVal::falling> falling{};
        }
    }
    namespace AdcGdr{    ///<A/D Global Data Register. Contains the result of the most recent A/D conversion.
        using Addr = Register::Address<0x4001c004,0x38ff003f,0x00000000,unsigned>;
    ...
    namespace AdcStat{    ///<A/D Status Register. This register contains DONE and OVERRUN flags for all of the A/D channels, as well as the A/D interrupt flag.
        using Addr = Register::Address<0x4001c030,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace AdcInten{    ///<A/D Interrupt Enable Register. This register contains enable bits that allow the DONE flag of each A/D channel to be included or excluded from contributing to the generation of an A/D interrupt.
        using Addr = Register::Address<0x4001c00c,0xfffffe00,0x00000000,unsigned>;
    ...
    namespace AdcDr0{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c010,0x3fff003f,0x00000000,unsigned>;
    ...
    namespace AdcDr1{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c014,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr2{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c018,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr3{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c01c,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr4{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c020,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr5{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c024,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr6{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c028,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
    ...
    namespace AdcDr7{    ///<A/D Channel n Data Register. This register contains the result of the most recent conversion completed on channel n.
        using Addr = Register::Address<0x4001c02c,0x3fff003f,0x00000000,unsigned>;
        ///When DONE is 1, this field contains a binary fraction representing the voltage on the ADn pin, divided by the voltage on the VREF pin. Zero in the field indicates that the voltage on the ADn pin was less than, equal to, or close to that on VREF, while 0x3FF indicates that the voltage on AD input was close to, equal to, or greater than that on VREF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,6),Register::ReadWriteAccess,unsigned> vVref{}; 
        ///This bit is 1 in burst mode if the results of one or more conversions was (were) lost and overwritten before the conversion that produced the result in the V_VREF bits.This bit is cleared by reading this register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> overrun{}; 
