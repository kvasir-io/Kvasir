...
namespace Kvasir {
    namespace Gpio2Data{    ///<Port n data register for pins PIOn_0 to PIOn_11
        using Addr = Register::Address<0x50023ffc,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Dir{    ///<Data direction register for port n
        using Addr = Register::Address<0x50028000,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Is{    ///<Interrupt sense register for port n
        using Addr = Register::Address<0x50028004,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Ibe{    ///<Interrupt both edges register for port n
        using Addr = Register::Address<0x50028008,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Iev{    ///<Interrupt event register for port n
        using Addr = Register::Address<0x5002800c,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Ie{    ///<Interrupt mask register for port n
        using Addr = Register::Address<0x50028010,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Ris{    ///<Raw interrupt status register for port n
        using Addr = Register::Address<0x50028014,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Mis{    ///<Masked interrupt status register for port n
        using Addr = Register::Address<0x50028018,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio2Ic{    ///<Interrupt clear register for port n
        using Addr = Register::Address<0x5002801c,0xfffff000,0x00000000,unsigned>;
