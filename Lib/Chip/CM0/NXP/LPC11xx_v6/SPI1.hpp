...
namespace Kvasir {
    namespace Spi1Cr0{    ///<Control Register 0. Selects the serial clock rate, bus type, and data size.
        ...
        namespace DssValC{
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v4BitTransfer> v4BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v5BitTransfer> v5BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v6BitTransfer> v6BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v7BitTransfer> v7BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v8BitTransfer> v8BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v9BitTransfer> v9BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v10BitTransfer> v10BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v11BitTransfer> v11BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v12BitTransfer> v12BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v13BitTransfer> v13BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v14BitTransfer> v14BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v15BitTransfer> v15BitTransfer{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::dss)::Type,DssVal::v16BitTransfer> v16BitTransfer{};
        }
        ///Frame Format.
        enum class FrfVal {
            spi=0x00000000,     ///<SPI
        ...
        namespace FrfValC{
            constexpr Register::FieldValue<decltype(Spi1Cr0::frf)::Type,FrfVal::spi> spi{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::frf)::Type,FrfVal::ti> ti{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::frf)::Type,FrfVal::microwire> microwire{};
        }
        ...
        namespace CpolValC{
            constexpr Register::FieldValue<decltype(Spi1Cr0::cpol)::Type,CpolVal::low> low{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::cpol)::Type,CpolVal::high> high{};
        }
        ...
        namespace CphaValC{
            constexpr Register::FieldValue<decltype(Spi1Cr0::cpha)::Type,CphaVal::firstclock> firstclock{};
            constexpr Register::FieldValue<decltype(Spi1Cr0::cpha)::Type,CphaVal::secondclock> secondclock{};
        }
    ...
    namespace Spi1Cr1{    ///<Control Register 1. Selects master/slave and other modes.
        using Addr = Register::Address<0x40058004,0xfffffff0,0x00000000,unsigned>;
        ///Loop Back Mode.
        enum class LbmVal {
            normal=0x00000000,     ///<During normal operation.
            loopback=0x00000001,     ///<Serial input is taken from the serial output (MOSI or MISO) rather than the serial input pin (MISO or MOSI respectively).
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,LbmVal> lbm{}; 
        namespace LbmValC{
            constexpr Register::FieldValue<decltype(Spi1Cr1::lbm)::Type,LbmVal::normal> normal{};
            constexpr Register::FieldValue<decltype(Spi1Cr1::lbm)::Type,LbmVal::loopback> loopback{};
        }
        ///SPI Enable.
        enum class SseVal {
            disable=0x00000000,     ///<The SPI controller is disabled.
            enable=0x00000001,     ///<The SPI controller will interact with other devices on the serial bus. Software should write the appropriate control information to the other SPI/SSP registers and interrupt controller registers, before setting this bit.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,SseVal> sse{}; 
        namespace SseValC{
            constexpr Register::FieldValue<decltype(Spi1Cr1::sse)::Type,SseVal::disable> disable{};
            constexpr Register::FieldValue<decltype(Spi1Cr1::sse)::Type,SseVal::enable> enable{};
        }
        ...
        namespace MsValC{
            constexpr Register::FieldValue<decltype(Spi1Cr1::ms)::Type,MsVal::master> master{};
            constexpr Register::FieldValue<decltype(Spi1Cr1::ms)::Type,MsVal::slave> slave{};
        }
    ...
    namespace Spi1Dr{    ///<Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO.
    ...
    namespace Spi1Sr{    ///<Status Register
        using Addr = Register::Address<0x4005800c,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Spi1Cpsr{    ///<Clock Prescale Register
        using Addr = Register::Address<0x40058010,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Spi1Imsc{    ///<Interrupt Mask Set and Clear Register
        using Addr = Register::Address<0x40058014,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Spi1Ris{    ///<Raw Interrupt Status Register
        using Addr = Register::Address<0x40058018,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Spi1Mis{    ///<Masked Interrupt Status Register
        using Addr = Register::Address<0x4005801c,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Spi1Icr{    ///<SSPICR Interrupt Clear Register
        using Addr = Register::Address<0x40058020,0xfffffffc,0x00000000,unsigned>;
