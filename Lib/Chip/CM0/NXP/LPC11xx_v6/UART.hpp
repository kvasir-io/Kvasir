...
namespace Kvasir {
//Product name title=UM10398 Chapter title=LPC111x/LPC11CxxUART Modification date=9/19/2011 Major revision=7 Minor revision=not available 
    namespace UartRbr{    ///<Receiver Buffer Register. Contains the next received character to be read. (DLAB=0)
        using Addr = Register::Address<0x40008000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartThr{    ///<Transmit Holding Register. The next character to be transmitted is written here. (DLAB=0)
        using Addr = Register::Address<0x40008000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartDll{    ///<Divisor Latch LSB. Least significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider. (DLAB=1)
        using Addr = Register::Address<0x40008000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartDlm{    ///<Divisor Latch MSB. Most significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider. (DLAB=1)
        using Addr = Register::Address<0x40008004,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartIer{    ///<Interrupt Enable Register. Contains individual interrupt enable bits for the 7 potential UART interrupts. (DLAB=0)
        using Addr = Register::Address<0x40008004,0xfffffcf8,0x00000000,unsigned>;
        ...
        namespace RbrieValC{
            constexpr Register::FieldValue<decltype(UartIer::rbrie)::Type,RbrieVal::disableTheRdaInte> disableTheRdaInte{};
            constexpr Register::FieldValue<decltype(UartIer::rbrie)::Type,RbrieVal::enableTheRdaInter> enableTheRdaInter{};
        }
        ...
        namespace ThreieValC{
            constexpr Register::FieldValue<decltype(UartIer::threie)::Type,ThreieVal::disableTheThreInt> disableTheThreInt{};
            constexpr Register::FieldValue<decltype(UartIer::threie)::Type,ThreieVal::enableTheThreInte> enableTheThreInte{};
        }
        ...
        namespace RxlieValC{
            constexpr Register::FieldValue<decltype(UartIer::rxlie)::Type,RxlieVal::disableTheRxLine> disableTheRxLine{};
            constexpr Register::FieldValue<decltype(UartIer::rxlie)::Type,RxlieVal::enableTheRxLineS> enableTheRxLineS{};
        }
        ...
        namespace AbeointenValC{
            constexpr Register::FieldValue<decltype(UartIer::abeointen)::Type,AbeointenVal::disableEndOfAuto> disableEndOfAuto{};
            constexpr Register::FieldValue<decltype(UartIer::abeointen)::Type,AbeointenVal::enableEndOfAutoB> enableEndOfAutoB{};
        }
        ...
        namespace AbtointenValC{
            constexpr Register::FieldValue<decltype(UartIer::abtointen)::Type,AbtointenVal::disableAutoBaudTi> disableAutoBaudTi{};
            constexpr Register::FieldValue<decltype(UartIer::abtointen)::Type,AbtointenVal::enableAutoBaudTim> enableAutoBaudTim{};
        }
    }
    namespace UartIir{    ///<Interrupt ID Register. Identifies which interrupt(s) are pending.
        using Addr = Register::Address<0x40008008,0xfffffc30,0x00000000,unsigned>;
        ...
        namespace IntstatusValC{
            constexpr Register::FieldValue<decltype(UartIir::intstatus)::Type,IntstatusVal::pending> pending{};
            constexpr Register::FieldValue<decltype(UartIir::intstatus)::Type,IntstatusVal::noInterruptIsPend> noInterruptIsPend{};
        }
        ...
        namespace IntidValC{
            constexpr Register::FieldValue<decltype(UartIir::intid)::Type,IntidVal::v1ReceiveLineS> v1ReceiveLineS{};
            constexpr Register::FieldValue<decltype(UartIir::intid)::Type,IntidVal::v2aReceiveDataAv> v2aReceiveDataAv{};
            constexpr Register::FieldValue<decltype(UartIir::intid)::Type,IntidVal::v2bCharacterTime> v2bCharacterTime{};
            constexpr Register::FieldValue<decltype(UartIir::intid)::Type,IntidVal::v3ThreInterrupt> v3ThreInterrupt{};
            constexpr Register::FieldValue<decltype(UartIir::intid)::Type,IntidVal::v4ModemInterrup> v4ModemInterrup{};
        }
    ...
    namespace UartFcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        using Addr = Register::Address<0x40008008,0xffffff38,0x00000000,unsigned>;
        ///FIFO Enable
        ...
        namespace FifoenValC{
            constexpr Register::FieldValue<decltype(UartFcr::fifoen)::Type,FifoenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(UartFcr::fifoen)::Type,FifoenVal::enabled> enabled{};
        }
        ///RX FIFO Reset
        ...
        namespace RxfiforesValC{
            constexpr Register::FieldValue<decltype(UartFcr::rxfifores)::Type,RxfiforesVal::noImpactOnEither> noImpactOnEither{};
            constexpr Register::FieldValue<decltype(UartFcr::rxfifores)::Type,RxfiforesVal::clear> clear{};
        }
        ///TX FIFO Reset
        ...
        namespace TxfiforesValC{
            constexpr Register::FieldValue<decltype(UartFcr::txfifores)::Type,TxfiforesVal::noImpactOnEither> noImpactOnEither{};
            constexpr Register::FieldValue<decltype(UartFcr::txfifores)::Type,TxfiforesVal::clear> clear{};
        }
        ...
        namespace RxtlValC{
            constexpr Register::FieldValue<decltype(UartFcr::rxtl)::Type,RxtlVal::triggerLevel01C> triggerLevel01C{};
            constexpr Register::FieldValue<decltype(UartFcr::rxtl)::Type,RxtlVal::triggerLevel14C> triggerLevel14C{};
            constexpr Register::FieldValue<decltype(UartFcr::rxtl)::Type,RxtlVal::triggerLevel28C> triggerLevel28C{};
            constexpr Register::FieldValue<decltype(UartFcr::rxtl)::Type,RxtlVal::triggerLevel314> triggerLevel314{};
        }
    }
    namespace UartLcr{    ///<Line Control Register. Contains controls for frame formatting and break generation.
        using Addr = Register::Address<0x4000800c,0xffffff00,0x00000000,unsigned>;
        ///Word Length Select
        enum class WlsVal {
        ...
        namespace WlsValC{
            constexpr Register::FieldValue<decltype(UartLcr::wls)::Type,WlsVal::v5BitCharacterLeng> v5BitCharacterLeng{};
            constexpr Register::FieldValue<decltype(UartLcr::wls)::Type,WlsVal::v6BitCharacterLeng> v6BitCharacterLeng{};
            constexpr Register::FieldValue<decltype(UartLcr::wls)::Type,WlsVal::v7BitCharacterLeng> v7BitCharacterLeng{};
            constexpr Register::FieldValue<decltype(UartLcr::wls)::Type,WlsVal::v8BitCharacterLeng> v8BitCharacterLeng{};
        }
        ///Stop Bit Select
        enum class SbsVal {
        ...
        namespace SbsValC{
            constexpr Register::FieldValue<decltype(UartLcr::sbs)::Type,SbsVal::v1StopBit> v1StopBit{};
            constexpr Register::FieldValue<decltype(UartLcr::sbs)::Type,SbsVal::v2StopBits> v2StopBits{};
        }
        ///Parity Enable
        enum class PeVal {
        ...
        namespace PeValC{
            constexpr Register::FieldValue<decltype(UartLcr::pe)::Type,PeVal::disableParityGener> disableParityGener{};
            constexpr Register::FieldValue<decltype(UartLcr::pe)::Type,PeVal::enableParityGenera> enableParityGenera{};
        }
        ///Parity Select
        enum class PsVal {
        ...
        namespace PsValC{
            constexpr Register::FieldValue<decltype(UartLcr::ps)::Type,PsVal::oddParityNumberO> oddParityNumberO{};
            constexpr Register::FieldValue<decltype(UartLcr::ps)::Type,PsVal::evenParityNumber> evenParityNumber{};
            constexpr Register::FieldValue<decltype(UartLcr::ps)::Type,PsVal::forced1StickParit> forced1StickParit{};
            constexpr Register::FieldValue<decltype(UartLcr::ps)::Type,PsVal::forced0StickParit> forced0StickParit{};
        }
        ///Break Control
        enum class BcVal {
        ...
        namespace BcValC{
            constexpr Register::FieldValue<decltype(UartLcr::bc)::Type,BcVal::disableBreakTransm> disableBreakTransm{};
            constexpr Register::FieldValue<decltype(UartLcr::bc)::Type,BcVal::enableBreakTransmi> enableBreakTransmi{};
        }
        ...
        namespace DlabValC{
            constexpr Register::FieldValue<decltype(UartLcr::dlab)::Type,DlabVal::disableAccessToDi> disableAccessToDi{};
            constexpr Register::FieldValue<decltype(UartLcr::dlab)::Type,DlabVal::enableAccessToDiv> enableAccessToDiv{};
        }
    }
    namespace UartMcr{    ///<Modem control register
        using Addr = Register::Address<0x40008010,0xffffff2c,0x00000000,unsigned>;
        ...
        namespace RtsenValC{
            constexpr Register::FieldValue<decltype(UartMcr::rtsen)::Type,RtsenVal::disableAutoRtsFlo> disableAutoRtsFlo{};
            constexpr Register::FieldValue<decltype(UartMcr::rtsen)::Type,RtsenVal::enableAutoRtsFlow> enableAutoRtsFlow{};
        }
        ///CTS flow control
        enum class CtsenVal {
        ...
        namespace CtsenValC{
            constexpr Register::FieldValue<decltype(UartMcr::ctsen)::Type,CtsenVal::disableAutoCtsFlo> disableAutoCtsFlo{};
            constexpr Register::FieldValue<decltype(UartMcr::ctsen)::Type,CtsenVal::enableAutoCtsFlow> enableAutoCtsFlow{};
        }
    }
    namespace UartLsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
        using Addr = Register::Address<0x40008014,0xffffff00,0x00000000,unsigned>;
        ...
        namespace RdrValC{
            constexpr Register::FieldValue<decltype(UartLsr::rdr)::Type,RdrVal::empty> empty{};
            constexpr Register::FieldValue<decltype(UartLsr::rdr)::Type,RdrVal::valid> valid{};
        }
        ...
        namespace OeValC{
            constexpr Register::FieldValue<decltype(UartLsr::oe)::Type,OeVal::inactive> inactive{};
            constexpr Register::FieldValue<decltype(UartLsr::oe)::Type,OeVal::active> active{};
        }
        ...
        namespace PeValC{
            constexpr Register::FieldValue<decltype(UartLsr::pe)::Type,PeVal::inactive> inactive{};
            constexpr Register::FieldValue<decltype(UartLsr::pe)::Type,PeVal::active> active{};
        }
        ...
        namespace FeValC{
            constexpr Register::FieldValue<decltype(UartLsr::fe)::Type,FeVal::inactive> inactive{};
            constexpr Register::FieldValue<decltype(UartLsr::fe)::Type,FeVal::active> active{};
        }
        ...
        namespace BiValC{
            constexpr Register::FieldValue<decltype(UartLsr::bi)::Type,BiVal::inactive> inactive{};
            constexpr Register::FieldValue<decltype(UartLsr::bi)::Type,BiVal::active> active{};
        }
        ...
        namespace ThreValC{
            constexpr Register::FieldValue<decltype(UartLsr::thre)::Type,ThreVal::valid> valid{};
            constexpr Register::FieldValue<decltype(UartLsr::thre)::Type,ThreVal::empty> empty{};
        }
        ...
        namespace TemtValC{
            constexpr Register::FieldValue<decltype(UartLsr::temt)::Type,TemtVal::valid> valid{};
            constexpr Register::FieldValue<decltype(UartLsr::temt)::Type,TemtVal::empty> empty{};
        }
        ...
        namespace RxfeValC{
            constexpr Register::FieldValue<decltype(UartLsr::rxfe)::Type,RxfeVal::noerror> noerror{};
            constexpr Register::FieldValue<decltype(UartLsr::rxfe)::Type,RxfeVal::error> error{};
        }
    }
    namespace UartMsr{    ///<Modem status register
        using Addr = Register::Address<0x40008018,0xffffff00,0x00000000,unsigned>;
        ...
        namespace DctsValC{
            constexpr Register::FieldValue<decltype(UartMsr::dcts)::Type,DctsVal::noChangeDetectedO> noChangeDetectedO{};
            constexpr Register::FieldValue<decltype(UartMsr::dcts)::Type,DctsVal::stateChangeDetecte> stateChangeDetecte{};
        }
        ...
        namespace DdsrValC{
            constexpr Register::FieldValue<decltype(UartMsr::ddsr)::Type,DdsrVal::noChangeDetectedO> noChangeDetectedO{};
            constexpr Register::FieldValue<decltype(UartMsr::ddsr)::Type,DdsrVal::stateChangeDetecte> stateChangeDetecte{};
        }
        ...
        namespace TeriValC{
            constexpr Register::FieldValue<decltype(UartMsr::teri)::Type,TeriVal::noChangeDetectedO> noChangeDetectedO{};
            constexpr Register::FieldValue<decltype(UartMsr::teri)::Type,TeriVal::lowToHighTransiti> lowToHighTransiti{};
        }
        ...
        namespace DdcdValC{
            constexpr Register::FieldValue<decltype(UartMsr::ddcd)::Type,DdcdVal::noChangeDetectedO> noChangeDetectedO{};
            constexpr Register::FieldValue<decltype(UartMsr::ddcd)::Type,DdcdVal::stateChangeDetecte> stateChangeDetecte{};
        }
    ...
    namespace UartScr{    ///<Scratch Pad Register. Eight-bit temporary storage for software.
        using Addr = Register::Address<0x4000801c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartAcr{    ///<Auto-baud Control Register. Contains controls for the auto-baud feature.
        using Addr = Register::Address<0x40008020,0xfffffcf8,0x00000000,unsigned>;
        ...
        namespace StartValC{
            constexpr Register::FieldValue<decltype(UartAcr::start)::Type,StartVal::stop> stop{};
            constexpr Register::FieldValue<decltype(UartAcr::start)::Type,StartVal::start> start{};
        }
        ...
        namespace ModeValC{
            constexpr Register::FieldValue<decltype(UartAcr::mode)::Type,ModeVal::mode0> mode0{};
            constexpr Register::FieldValue<decltype(UartAcr::mode)::Type,ModeVal::mode1> mode1{};
        }
        ///Restart enable
        ...
        namespace AutorestartValC{
            constexpr Register::FieldValue<decltype(UartAcr::autorestart)::Type,AutorestartVal::noRestart> noRestart{};
            constexpr Register::FieldValue<decltype(UartAcr::autorestart)::Type,AutorestartVal::restartInCaseOfT> restartInCaseOfT{};
        }
        ...
        namespace AbeointclrValC{
            constexpr Register::FieldValue<decltype(UartAcr::abeointclr)::Type,AbeointclrVal::noimpact> noimpact{};
            constexpr Register::FieldValue<decltype(UartAcr::abeointclr)::Type,AbeointclrVal::clear> clear{};
        }
        ...
        namespace AbtointclrValC{
            constexpr Register::FieldValue<decltype(UartAcr::abtointclr)::Type,AbtointclrVal::noimpact> noimpact{};
            constexpr Register::FieldValue<decltype(UartAcr::abtointclr)::Type,AbtointclrVal::clear> clear{};
        }
    }
    namespace UartFdr{    ///<Fractional Divider Register. Generates a clock input for the baud rate divider.
        using Addr = Register::Address<0x40008028,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartTer{    ///<Transmit Enable Register. Turns off UART transmitter for use with software flow control.
        using Addr = Register::Address<0x40008030,0xffffff7f,0x00000000,unsigned>;
    ...
    namespace UartRs485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
        using Addr = Register::Address<0x4000804c,0xffffffc0,0x00000000,unsigned>;
        ///NMM enable.
        enum class NmmenVal {
        ...
        namespace NmmenValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::nmmen)::Type,NmmenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::nmmen)::Type,NmmenVal::enabled> enabled{};
        }
        ///Receiver enable.
        enum class RxdisVal {
        ...
        namespace RxdisValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::rxdis)::Type,RxdisVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::rxdis)::Type,RxdisVal::disabled> disabled{};
        }
        ///AAD enable.
        enum class AadenVal {
        ...
        namespace AadenValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::aaden)::Type,AadenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::aaden)::Type,AadenVal::enabled> enabled{};
        }
        ...
        namespace SelValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::sel)::Type,SelVal::rts> rts{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::sel)::Type,SelVal::dtr> dtr{};
        }
        ...
        namespace DctrlValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::dctrl)::Type,DctrlVal::disableAutoDirecti> disableAutoDirecti{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::dctrl)::Type,DctrlVal::enableAutoDirectio> enableAutoDirectio{};
        }
        ...
        namespace OinvValC{
            constexpr Register::FieldValue<decltype(UartRs485ctrl::oinv)::Type,OinvVal::low> low{};
            constexpr Register::FieldValue<decltype(UartRs485ctrl::oinv)::Type,OinvVal::high> high{};
        }
    }
    namespace UartRs485adrmatch{    ///<RS-485/EIA-485 address match. Contains the address match value for RS-485/EIA-485 mode.
        using Addr = Register::Address<0x40008050,0xffffff00,0x00000000,unsigned>;
    ...
    namespace UartRs485dly{    ///<RS-485/EIA-485 direction control delay.
        using Addr = Register::Address<0x40008054,0xffffff00,0x00000000,unsigned>;
