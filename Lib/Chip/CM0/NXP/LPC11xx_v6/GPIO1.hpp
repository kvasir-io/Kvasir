...
namespace Kvasir {
    namespace Gpio1Data{    ///<Port n data register for pins PIOn_0 to PIOn_11
        using Addr = Register::Address<0x50013ffc,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Dir{    ///<Data direction register for port n
        using Addr = Register::Address<0x50018000,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Is{    ///<Interrupt sense register for port n
        using Addr = Register::Address<0x50018004,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Ibe{    ///<Interrupt both edges register for port n
        using Addr = Register::Address<0x50018008,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Iev{    ///<Interrupt event register for port n
        using Addr = Register::Address<0x5001800c,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Ie{    ///<Interrupt mask register for port n
        using Addr = Register::Address<0x50018010,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Ris{    ///<Raw interrupt status register for port n
        using Addr = Register::Address<0x50018014,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Mis{    ///<Masked interrupt status register for port n
        using Addr = Register::Address<0x50018018,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Gpio1Ic{    ///<Interrupt clear register for port n
        using Addr = Register::Address<0x5001801c,0xfffff000,0x00000000,unsigned>;
