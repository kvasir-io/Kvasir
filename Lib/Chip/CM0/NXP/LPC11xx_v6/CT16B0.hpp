...
//Product name title=UM10398 Chapter title=LPC1100XL series: 16-bit counter/timer CT16B0/1 Modification date=2/22/2012 Major revision=8 Minor revision=not available 
    namespace Noneir{    ///<Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
        using Addr = Register::Address<0x4000c000,0xffffffc0,0,unsigned>;
...
interrupt every time MR matches the TC.
    ...
    namespace Noneccr{    ///<Capture Control Register (CCR). The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x4000c028,0xffffffc0,0,unsigned>;
    ...
    namespace Nonectcr{    ///<Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CisValC{
            ...
            constexpr Register::FieldValue<decltype(cis),CisVal::ct16bnCap1> ct16bnCap1{};
        }
    ...
    namespace Nonepwmc{    ///<PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT16B0_MAT[2:0].
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(pwmen1),Pwmen1Val::ct16bnMat1IsContr> ct16bnMat1IsContr{};
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(pwmen2),Pwmen2Val::matchChannel2OrP> matchChannel2OrP{};
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(pwmen3),Pwmen3Val::matchChannel3Matc> matchChannel3Matc{};
