...
//Product name title=UM10398 Chapter title=LPC1100XL series: 16-bit counter/timer CT16B0/1 Modification date=2/22/2012 Major revision=8 Minor revision=not available 
    namespace Ct16b0Ir{    ///<Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
        using Addr = Register::Address<0x4000c000,0xffffffc0,0x00000000,unsigned>;
    ...
    namespace Ct16b0Tcr{    ///<Timer Control Register (TCR). The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
        using Addr = Register::Address<0x4000c004,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Ct16b0Tc{    ///<Timer Counter (TC). The 16-bit TC is incremented every PR+1 cycles of PCLK. The TC is controlled through the TCR.
        using Addr = Register::Address<0x4000c008,0xffff0000,0x00000000,unsigned>;
        ///Timer counter value.
    ...
    namespace Ct16b0Pr{    ///<Prescale Register (PR). When the Prescale Counter (below) is equal to this value, the next clock increments the TC and clears the PC.
        using Addr = Register::Address<0x4000c00c,0xffff0000,0x00000000,unsigned>;
        ///Prescale max value.
    ...
    namespace Ct16b0Pc{    ///<Prescale Counter (PC). The 16-bit PC is a counter which is incremented to the value stored in PR. When the value in PR is reached, the TC is incremented and the PC is cleared. The PC is observable and controllable through the bus interface.
        using Addr = Register::Address<0x4000c010,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ct16b0Mcr{    ///<Match Control Register (MCR). The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
        using Addr = Register::Address<0x4000c014,0xfffff000,0x00000000,unsigned>;
        ...
        namespace Mr0iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0i)::Type,Mr0iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0i)::Type,Mr0iVal::disabled> disabled{};
        }
        ...
        namespace Mr0rValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0r)::Type,Mr0rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0r)::Type,Mr0rVal::disabled> disabled{};
        }
        ...
        namespace Mr0sValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0s)::Type,Mr0sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr0s)::Type,Mr0sVal::disabled> disabled{};
        }
        ...
        namespace Mr1iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1i)::Type,Mr1iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1i)::Type,Mr1iVal::disabled> disabled{};
        }
        ...
        namespace Mr1rValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1r)::Type,Mr1rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1r)::Type,Mr1rVal::disabled> disabled{};
        }
        ...
        namespace Mr1sValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1s)::Type,Mr1sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr1s)::Type,Mr1sVal::disabled> disabled{};
        }
        ...
        namespace Mr2iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2i)::Type,Mr2iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2i)::Type,Mr2iVal::disabled> disabled{};
        }
        ...
        namespace Mr2rValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2r)::Type,Mr2rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2r)::Type,Mr2rVal::disabled> disabled{};
        }
        ...
        namespace Mr2sValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2s)::Type,Mr2sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr2s)::Type,Mr2sVal::disabled> disabled{};
        }
        ...
        namespace Mr3iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3i)::Type,Mr3iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3i)::Type,Mr3iVal::disabled> disabled{};
        }
        ...
        namespace Mr3rValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3r)::Type,Mr3rVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3r)::Type,Mr3rVal::disabled> disabled{};
        }
        ...
        namespace Mr3sValC{
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3s)::Type,Mr3sVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Mcr::mr3s)::Type,Mr3sVal::disabled> disabled{};
        }
    }
    namespace Ct16b0Mr0{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x4000c018,0xffff0000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct16b0Mr1{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x4000c01c,0xffff0000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct16b0Mr2{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x4000c020,0xffff0000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct16b0Mr3{    ///<Match Register. MR can be enabled through theMCR to reset the TC, stop both the TC and PC, and/or generate aninterrupt every time MR matches the TC.
        using Addr = Register::Address<0x4000c024,0xffff0000,0x00000000,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> match{}; 
    }
    namespace Ct16b0Ccr{    ///<Capture Control Register (CCR). The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x4000c028,0xffffffc0,0x00000000,unsigned>;
        ...
        namespace Cap0reValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0re)::Type,Cap0reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0re)::Type,Cap0reVal::disabled> disabled{};
        }
        ...
        namespace Cap0feValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0fe)::Type,Cap0feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0fe)::Type,Cap0feVal::disabled> disabled{};
        }
        ...
        namespace Cap0iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0i)::Type,Cap0iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap0i)::Type,Cap0iVal::disabled> disabled{};
        }
        ...
        namespace Cap1reValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1re)::Type,Cap1reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1re)::Type,Cap1reVal::disabled> disabled{};
        }
        ...
        namespace Cap1feValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1fe)::Type,Cap1feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1fe)::Type,Cap1feVal::disabled> disabled{};
        }
        ...
        namespace Cap1iValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1i)::Type,Cap1iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(Ct16b0Ccr::cap1i)::Type,Cap1iVal::disabled> disabled{};
        }
    }
    namespace Ct16b0Cr0{    ///<Capture Register (CR). CR is loaded with the value of TC when there is an event on the CT16Bn_CAPm input.
        using Addr = Register::Address<0x4000c02c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ct16b0Cr1{    ///<Capture Register (CR). CR is loaded with the value of TC when there is an event on the CT16Bn_CAPm input.
        using Addr = Register::Address<0x4000c030,0xffff0000,0x00000000,unsigned>;
        ///Timer counter capture value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
    namespace Ct16b0Emr{    ///<External Match Register (EMR). The EMR controls the match function and the external match pins CT16B0_MAT[2:0].
        using Addr = Register::Address<0x4000c03c,0xfffff000,0x00000000,unsigned>;
        ...
        namespace Emc0ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc0)::Type,Emc0Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc0)::Type,Emc0Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc0)::Type,Emc0Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc0)::Type,Emc0Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc1ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc1)::Type,Emc1Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc1)::Type,Emc1Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc1)::Type,Emc1Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc1)::Type,Emc1Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc2ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc2)::Type,Emc2Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc2)::Type,Emc2Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc2)::Type,Emc2Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc2)::Type,Emc2Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
        ...
        namespace Emc3ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc3)::Type,Emc3Val::doNothing> doNothing{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc3)::Type,Emc3Val::clearTheCorrespond> clearTheCorrespond{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc3)::Type,Emc3Val::setTheCorrespondin> setTheCorrespondin{};
            constexpr Register::FieldValue<decltype(Ct16b0Emr::emc3)::Type,Emc3Val::toggleTheCorrespon> toggleTheCorrespon{};
        }
    }
    namespace Ct16b0Ctcr{    ///<Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        using Addr = Register::Address<0x4000c070,0xffffff00,0x00000000,unsigned>;
        ...
        namespace CtmValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::ctm)::Type,CtmVal::timerModeEveryRi> timerModeEveryRi{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs1> counterModeTcIs1{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs2> counterModeTcIs2{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::ctm)::Type,CtmVal::counterModeTcIs3> counterModeTcIs3{};
        }
        ...
        namespace CisValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::cis)::Type,CisVal::ct16bnCap0> ct16bnCap0{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::cis)::Type,CisVal::ct16bnCap1> ct16bnCap1{};
        }
        ...
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::selcc)::Type,SelccVal::risingEdgeOfCap0> risingEdgeOfCap0{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::selcc)::Type,SelccVal::fallingEdgeOfCap0> fallingEdgeOfCap0{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::selcc)::Type,SelccVal::risingEdgeOfCap1> risingEdgeOfCap1{};
            constexpr Register::FieldValue<decltype(Ct16b0Ctcr::selcc)::Type,SelccVal::fallingEdgeOfCap1> fallingEdgeOfCap1{};
        }
    }
    namespace Ct16b0Pwmc{    ///<PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT16B0_MAT[2:0].
        using Addr = Register::Address<0x4000c074,0xfffffff0,0x00000000,unsigned>;
        ///PWM channel0 enable
        ...
        namespace Pwmen0ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen0)::Type,Pwmen0Val::ct16bnMat0IsContr> ct16bnMat0IsContr{};
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen0)::Type,Pwmen0Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ///PWM channel1 enable
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen1)::Type,Pwmen1Val::ct16bnMat1IsContr> ct16bnMat1IsContr{};
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen1)::Type,Pwmen1Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ///PWM channel2 enable
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen2)::Type,Pwmen2Val::matchChannel2OrP> matchChannel2OrP{};
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen2)::Type,Pwmen2Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen3)::Type,Pwmen3Val::matchChannel3Matc> matchChannel3Matc{};
            constexpr Register::FieldValue<decltype(Ct16b0Pwmc::pwmen3)::Type,Pwmen3Val::pwmModeIsEnabled> pwmModeIsEnabled{};
        }
    }
}
