...
//I/O configuration  
    ...
    namespace Nonepio04{    ///<I/O configuration for pin PIO0_4/SCL
        ...
        enum class I2cmodeVal {
            standardFast=0x00000000,     ///<Standard mode/ Fast-mode I2C.
        ...
        namespace I2cmodeValC{
            constexpr Register::FieldValue<decltype(i2cmode),I2cmodeVal::standardFast> standardFast{};
    ...
    namespace Nonepio016{    ///<I/O configuration for pin PIO0_16/AD5/CT32B1_MAT3/ WAKEUP
        ...
        ///Selects pin function. This pin functions as WAKEUP pin if the LPC11Exx is in Deep power-down mode regardless of the value of FUNC. Values 0x3 to 0x7 are reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> func{}; 
        namespace FuncValC{
        }
        ///Selects function mode (on-chip pull-up/pull-down resistor control).
    ...
    namespace Nonepio16{    ///<I/O configuration for pin PIO1_6
        using Addr = Register::Address<0x40044078,0xfffffb80,0,unsigned>;
        ///Selects pin function. Values 0x2 to 0x7 are reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> func{}; 
        namespace FuncValC{
        }
    ...
    namespace Nonepio19{    ///<I/O configuration for pin PIO1_9
        using Addr = Register::Address<0x40044084,0xfffffb80,0,unsigned>;
        ///Selects pin function. Values 0x1 to 0x7 are reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> func{}; 
        namespace FuncValC{
        }
    ...
    namespace Nonepio112{    ///<I/O configuration for pin PIO1_12
        using Addr = Register::Address<0x40044090,0xfffffb80,0,unsigned>;
        ///Selects pin function. Values 0x1 to 0x7 are reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> func{}; 
        namespace FuncValC{
        }
    ...
    namespace Nonepio113{    ///<I/O configuration for pin PIO1_13/DTR/CT16B0_MAT0/TXD
    ...
    namespace Nonepio114{    ///<I/O configuration for pin PIO1_14/DSR/CT16B0_MAT1/RXD
