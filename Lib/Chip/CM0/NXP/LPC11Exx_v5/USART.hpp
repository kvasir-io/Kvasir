...
//USART 
    ...
    namespace UsartSyncctrl{    ///<Synchronous mode control register.
        ...
        namespace SsdisValC{
            constexpr Register::FieldValue<decltype(ssdis)::Type,SsdisVal::sendStartAndStop> sendStartAndStop{};
            constexpr Register::FieldValue<decltype(ssdis)::Type,SsdisVal::doNotSendStartStop> doNotSendStartStop{};
        }
