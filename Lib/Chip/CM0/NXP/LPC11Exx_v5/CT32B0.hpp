...
//32-bit counter/timers CT32B0
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CisValC{
            constexpr Register::FieldValue<decltype(cis)::Type,CisVal::ct32b0Cap0> ct32b0Cap0{};
            constexpr Register::FieldValue<decltype(cis)::Type,CisVal::ct32b0Cap1> ct32b0Cap1{};
        }
        ...
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::risingEdgeOfCt32b> risingEdgeOfCt32b{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::fallingEdgeOfCt32> fallingEdgeOfCt32{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::risingEdgeOfCt32b> risingEdgeOfCt32b{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::fallingEdgeOfCt32> fallingEdgeOfCt32{};
        }
    }
    namespace Nonepwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT32Bn_MAT[3:0].
        ...
        namespace Pwmen0ValC{
            constexpr Register::FieldValue<decltype(pwmen0)::Type,Pwmen0Val::ct32bnMat0IsContr> ct32bnMat0IsContr{};
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(pwmen1)::Type,Pwmen1Val::ct32bnMat01IsCont> ct32bnMat01IsCont{};
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(pwmen2)::Type,Pwmen2Val::ct32bnMat2IsContr> ct32bnMat2IsContr{};
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(pwmen3)::Type,Pwmen3Val::ct32bnMat3IsContr> ct32bnMat3IsContr{};
