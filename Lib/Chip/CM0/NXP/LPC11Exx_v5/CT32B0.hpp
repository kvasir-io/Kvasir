...
//32-bit counter/timers CT32B0
    namespace Noneir{    ///<Interrupt Register. The IR can be written to clear interrupts. The IR can be read to identify which of eight possible interrupt sources are pending.
        using Addr = Register::Address<0x40014000,0xffffffa0,0,unsigned>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> cr1int{}; 
    ...
    namespace Noneccr{    ///<Capture Control Register. The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x40014028,0xfffffe38,0,unsigned>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,Cap1reVal> cap1re{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,Cap1feVal> cap1fe{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,Cap1iVal> cap1i{}; 
        namespace Cap1iValC{
    ...
    namespace Nonecr0{    ///<Capture Register 0. CR0 is loaded with the value of TC when there is an event on the CT32B0_CAP0 input.
    ...
    namespace Nonecr1{    ///<Capture Register 1. CR1 is loaded with the value of TC when there is an event on the CT32B0_CAP1 input.
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CtmValC{
            ...
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeTcIs> counterModeTcIs{};
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeTcIs> counterModeTcIs{};
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeTcIs> counterModeTcIs{};
        }
        ...
        enum class CisVal {
            ct32b0Cap0=0x00000000,     ///<CT32B0_CAP0
            ct32b0Cap1=0x00000002,     ///<CT32B0_CAP1
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,CisVal> cis{}; 
        namespace CisValC{
            constexpr Register::FieldValue<decltype(cis),CisVal::ct32b0Cap0> ct32b0Cap0{};
            constexpr Register::FieldValue<decltype(cis),CisVal::ct32b0Cap1> ct32b0Cap1{};
        }
        ...
        enum class SelccVal {
            risingEdgeOfCt32b=0x00000000,     ///<Rising Edge of CT32B0_CAP0 clears the timer (if bit 4 is set)
            fallingEdgeOfCt32=0x00000001,     ///<Falling Edge of CT32B0_CAP0 clears the timer (if bit 4 is set)
            risingEdgeOfCt32b=0x00000004,     ///<Rising Edge of CT32B0_CAP1 clears the timer (if bit 4 is set)
            fallingEdgeOfCt32=0x00000005,     ///<Falling Edge of CT32B0_CAP1 clears the timer (if bit 4 is set)
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,SelccVal> selcc{}; 
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(selcc),SelccVal::risingEdgeOfCt32b> risingEdgeOfCt32b{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::fallingEdgeOfCt32> fallingEdgeOfCt32{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::risingEdgeOfCt32b> risingEdgeOfCt32b{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::fallingEdgeOfCt32> fallingEdgeOfCt32{};
        }
    }
    namespace Nonepwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT32Bn_MAT[3:0].
        ...
        namespace Pwmen0ValC{
            constexpr Register::FieldValue<decltype(pwmen0),Pwmen0Val::ct32bnMat0IsContr> ct32bnMat0IsContr{};
        ...
        enum class Pwmen1Val {
            ct32bnMat01IsCont=0x00000000,     ///<CT32Bn_MAT01 is controlled by EM1.
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(pwmen1),Pwmen1Val::ct32bnMat01IsCont> ct32bnMat01IsCont{};
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(pwmen2),Pwmen2Val::ct32bnMat2IsContr> ct32bnMat2IsContr{};
        ...
        enum class Pwmen3Val {
            ...
            pwmModeIsEnabled=0x00000001,     ///<PWM mode is enabled for CT132Bn_MAT3.
        };
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(pwmen3),Pwmen3Val::ct32bnMat3IsContr> ct32bnMat3IsContr{};
