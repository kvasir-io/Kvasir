...
//16-bit counter/timers CT16B0
    ...
    namespace Ct16b0Cr0{    ///<Capture Register 0. CR0 is loaded with the value of TC when there is an event on the CT16B0_CAP0 input.
    ...
    namespace Ct16b0Cr1{    ///<Capture Register 1. CR1 is loaded with the value of TC when there is an event on the CT16B0_CAP1 input.
    ...
    namespace Ct16b0Emr{    ///<External Match Register. The EMR controls the match function and the external match pins CT16B0_MAT[1:0] and CT16B1_MAT[1:0].
    ...
    namespace Ct16b0Ctcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CisValC{
            constexpr Register::FieldValue<decltype(cis)::Type,CisVal::ct16b0Cap0> ct16b0Cap0{};
            constexpr Register::FieldValue<decltype(cis)::Type,CisVal::ct16b0Cap1> ct16b0Cap1{};
        }
        ...
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::risingEdgeOfCt16b> risingEdgeOfCt16b{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::fallingEdgeOfCt16> fallingEdgeOfCt16{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::risingEdgeOfCt16b> risingEdgeOfCt16b{};
            constexpr Register::FieldValue<decltype(selcc)::Type,SelccVal::fallingEdgeOfCt16> fallingEdgeOfCt16{};
        }
        ///Reserved, user software should not write ones to reserved bits. The value read from a reserved bit is not defined.
    ...
    namespace Ct16b0Pwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT16B0_MAT[1:0] and CT16B1_MAT[1:0].
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(pwmen1)::Type,Pwmen1Val::ct16bnMat01IsCont> ct16bnMat01IsCont{};
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(pwmen2)::Type,Pwmen2Val::ct16bnMat2IsContr> ct16bnMat2IsContr{};
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(pwmen3)::Type,Pwmen3Val::ct16bnMat3IsContr> ct16bnMat3IsContr{};
    ...
    namespace Ct16b0Mr0{    ///<Match Register 0. MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr1{    ///<Match Register 0. MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr2{    ///<Match Register 0. MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr3{    ///<Match Register 0. MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
