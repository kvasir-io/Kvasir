...
namespace Kvasir {
//Rotary decoder.
    namespace QdecTasksStart{    ///<Start the quadrature decoder.
        using Addr = Register::Address<0x40012000,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecTasksStop{    ///<Stop the quadrature decoder.
        using Addr = Register::Address<0x40012004,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecTasksReadclracc{    ///<Transfers the content from ACC registers to ACCREAD registers, and clears the ACC registers.
        using Addr = Register::Address<0x40012008,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecEventsSamplerdy{    ///<A new sample is written to the sample register.
        using Addr = Register::Address<0x40012100,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecEventsReportrdy{    ///<REPORTPER number of samples accumulated in ACC register, and ACC register different than zero.
    ...
    namespace QdecShorts{    ///<Shortcuts for the QDEC.
        using Addr = Register::Address<0x40012200,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace QdecIntenset{    ///<Interrupt enable set register.
        using Addr = Register::Address<0x40012304,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace QdecIntenclr{    ///<Interrupt enable clear register.
        using Addr = Register::Address<0x40012308,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace QdecEnable{    ///<Enable the QDEC.
    ...
    namespace QdecSampleper{    ///<Sample period.
        using Addr = Register::Address<0x40012508,0xfffffff8,0x00000000,unsigned>;
        ///Sample period.
    ...
    namespace QdecReportper{    ///<Number of samples to generate an EVENT_REPORTRDY.
        using Addr = Register::Address<0x40012510,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace QdecAcc{    ///<Accumulated valid transitions register.
        using Addr = Register::Address<0x40012514,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecAccread{    ///<Snapshot of ACC register. Value generated by the TASKS_READCLEACC task.
        using Addr = Register::Address<0x40012518,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecPselled{    ///<Pin select for LED output.
        using Addr = Register::Address<0x4001251c,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecPsela{    ///<Pin select for phase A input.
        using Addr = Register::Address<0x40012520,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecPselb{    ///<Pin select for phase B input.
        using Addr = Register::Address<0x40012524,0xffffffff,0x00000000,unsigned>;
    }
    namespace QdecDbfen{    ///<Enable debouncer input filters.
    ...
    namespace QdecLedpre{    ///<Time LED is switched ON before the sample.
    ...
    namespace QdecAccdbl{    ///<Accumulated double (error) transitions register.
    ...
    namespace QdecAccdblread{    ///<Snapshot of ACCDBL register. Value generated by the TASKS_READCLEACC task.
    ...
    namespace QdecPower{    ///<Peripheral power control.
        using Addr = Register::Address<0x40012ffc,0xfffffffe,0x00000000,unsigned>;
