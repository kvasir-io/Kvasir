...
namespace Kvasir {
    ...
    namespace Noneenable{
        using Addr = Register::Address<0x40002500,0xfffffff8>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> ENABLE; 
    }
    namespace Nonepselrts{
        using Addr = Register::Address<0x40002508,0xffffffff>;
    }
    namespace Nonepseltxd{
        using Addr = Register::Address<0x4000250c,0xffffffff>;
    }
    namespace Nonepselcts{
        using Addr = Register::Address<0x40002510,0xffffffff>;
    }
    namespace Nonepselrxd{
        using Addr = Register::Address<0x40002514,0xffffffff>;
    }
    namespace Nonerxd{
    ...
    namespace Nonepower{
        using Addr = Register::Address<0x40002ffc,0xfffffffe>;
