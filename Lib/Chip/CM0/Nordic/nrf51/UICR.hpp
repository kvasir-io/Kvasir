...
//User Information Configuration.
    ...
    namespace Nonerbpconf{    ///<Readback protection configuration.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> pr0{}; 
        ///Readback protect all code in the device.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> pall{}; 
    }
    ...
    namespace Nonefwid{    ///<Firmware ID.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> fwid{}; 
    }
