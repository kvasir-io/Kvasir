...
namespace Kvasir {
//SSP controller
    namespace Ssp2Cr0{    ///<Control Register 0. Selects the serial clock rate, bus type, and data size.
        using Addr = Register::Address<0x400ac000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Cr1{    ///<Control Register 1. Selects master/slave and other modes.
        using Addr = Register::Address<0x400ac004,0x00000000,0x00000000,unsigned>;
        ///Loop Back Mode.
        enum class LbmVal {
    ...
    namespace Ssp2Dr{    ///<Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO.
        using Addr = Register::Address<0x400ac008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Sr{    ///<Status Register
    ...
    namespace Ssp2Cpsr{    ///<Clock Prescale Register
    ...
    namespace Ssp2Imsc{    ///<Interrupt Mask Set and Clear Register
        using Addr = Register::Address<0x400ac014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Ris{    ///<Raw Interrupt Status Register
        using Addr = Register::Address<0x400ac018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Mis{    ///<Masked Interrupt Status Register
        using Addr = Register::Address<0x400ac01c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Icr{    ///<SSPICR Interrupt Clear Register
        using Addr = Register::Address<0x400ac020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp2Dmacr{    ///<SSP0 DMA control register
        using Addr = Register::Address<0x400ac024,0x00000000,0x00000000,unsigned>;
