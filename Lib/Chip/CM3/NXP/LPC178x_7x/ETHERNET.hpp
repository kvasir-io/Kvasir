...
namespace Kvasir {
    namespace Nonemac1{
        using Addr = Register::Address<0x20084000,0xffff30e0>;
    ...
    namespace Nonemac2{
        using Addr = Register::Address<0x20084004,0xffff8c00>;
    ...
    namespace Noneipgt{
        using Addr = Register::Address<0x20084008,0xffffff80>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0)> BTOBINTEGAP; 
    }
    namespace Noneipgr{
        using Addr = Register::Address<0x2008400c,0xffff8080>;
    ...
    namespace Noneclrt{
        using Addr = Register::Address<0x20084010,0xffffc0f0>;
    ...
    namespace Nonemaxf{
        using Addr = Register::Address<0x20084014,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MAXFLEN; 
    }
    namespace Nonesupp{
        using Addr = Register::Address<0x20084018,0xfffffeff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SPEED; 
    }
    namespace Nonetest{
        using Addr = Register::Address<0x2008401c,0xfffffff8>;
    ...
    namespace Nonemcfg{
        using Addr = Register::Address<0x20084020,0xffff7fc0>;
    ...
    namespace Nonemcmd{
        using Addr = Register::Address<0x20084024,0xfffffffc>;
    ...
    namespace Nonemadr{
        using Addr = Register::Address<0x20084028,0xffffe0e0>;
    ...
    namespace Nonemwtd{
        using Addr = Register::Address<0x2008402c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> WRITEDATA; 
    }
    namespace Nonemrdd{
        using Addr = Register::Address<0x20084030,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> READDATA; 
    }
    namespace Nonemind{
        using Addr = Register::Address<0x20084034,0xfffffff0>;
    ...
    namespace Nonesa0{
        using Addr = Register::Address<0x20084040,0xffff0000>;
    ...
    namespace Nonesa1{
        using Addr = Register::Address<0x20084044,0xffff0000>;
    ...
    namespace Nonesa2{
        using Addr = Register::Address<0x20084048,0xffff0000>;
    ...
    namespace Nonecommand{
        using Addr = Register::Address<0x20084100,0xfffff804>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXENABLE; 
    ...
    namespace Nonestatus{
        using Addr = Register::Address<0x20084104,0xfffffffc>;
    ...
    namespace Nonetsv1{
        using Addr = Register::Address<0x2008415c,0xfff00000>;
    ...
    namespace Nonersv{
        using Addr = Register::Address<0x20084160,0x80000000>;
    ...
    namespace Noneflowcontrolcounter{
        using Addr = Register::Address<0x20084170,0x00000000>;
    ...
    namespace Noneflowcontrolstatus{
        using Addr = Register::Address<0x20084174,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MCC; 
    }
    namespace Nonerxfilterctrl{
        using Addr = Register::Address<0x20084200,0xffffcfc0>;
    ...
    namespace Nonerxfilterwolstatus{
        using Addr = Register::Address<0x20084204,0xfffffe40>;
    ...
    namespace Nonerxfilterwolclear{
        using Addr = Register::Address<0x20084208,0xfffffe40>;
    ...
    namespace Noneintenable{
        using Addr = Register::Address<0x20084fe4,0xffffcf00>;
    ...
    namespace Noneintclear{
        using Addr = Register::Address<0x20084fe8,0xffffcf00>;
    ...
    namespace Noneintset{
        using Addr = Register::Address<0x20084fec,0xffffcf00>;
    ...
    namespace Nonepowerdown{
        using Addr = Register::Address<0x20084ff4,0x7fffffff>;
