...
namespace Kvasir {
    namespace Noneir{
        using Addr = Register::Address<0x40014000,0xfffff8c0>;
    ...
    namespace Nonetcr{
        using Addr = Register::Address<0x40014004,0xffffffe4>;
    ...
    namespace Nonemcr{
        using Addr = Register::Address<0x40014014,0xffe00000>;
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x40014028,0xffffffc0>;
    ...
    namespace Nonecr0{
        using Addr = Register::Address<0x4001402c,0xffff8183>;
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x40014030,0xffff8183>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PWMSEL2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PWMSEL3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PWMSEL4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PWMSEL5; 
    ...
    namespace Nonemr4{
        using Addr = Register::Address<0x40014040,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> MATCH; 
    }
    namespace Nonemr5{
    ...
    namespace Nonemr6{
        using Addr = Register::Address<0x40014048,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> MATCH; 
    }
    namespace Nonepcr{
        using Addr = Register::Address<0x4001404c,0xffff8183>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PWMSEL2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PWMSEL3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PWMSEL4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PWMSEL5; 
    ...
    namespace Noneler{
        using Addr = Register::Address<0x40014050,0xffffff80>;
    ...
    namespace Nonectcr{
        using Addr = Register::Address<0x40014070,0xfffffff0>;
