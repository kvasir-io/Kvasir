...
//System and clock control
    ...
    namespace SysconPconp{    ///<Power Control for Peripherals
    ...
    namespace SysconPll1con{    ///<PLL0 Control register
    ...
    namespace SysconPll1cfg{    ///<PLL0 Configuration register
    ...
    namespace SysconPll1stat{    ///<PLL0 Status register
    ...
    namespace SysconPll1feed{    ///<PLL0 Feed register
