...
//16-bit counter/timers CT16B1
    namespace Noneir{    ///<Interrupt Register. The IR can be written to clear interrupts. The IR can be read to identify which of eight possible interrupt sources are pending.
        using Addr = Register::Address<0x40010000,0xffffffc0,0,unsigned>;
    ...
    namespace Nonetcr{    ///<Timer Control Register. The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
        using Addr = Register::Address<0x40010004,0xfffffffc,0,unsigned>;
        ///Counter enable.
        enum class CenVal {
    ...
    namespace Nonemcr{    ///<Match Control Register. The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
        using Addr = Register::Address<0x40010014,0xfffff000,0,unsigned>;
    ...
    namespace Nonemr2{    ///<Match Register 0. MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
        using Addr = Register::Address<0x40010020,0xffff0000,0,unsigned>;
        ///Timer counter match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> match{}; 
        namespace MatchValC{
        }
    ...
    namespace Noneccr{    ///<Capture Control Register. The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x40010028,0xffffffc0,0,unsigned>;
    ...
    namespace Nonecr1{    ///<Capture Register 1. CR1 is loaded with the value of TC when there is an event on the CT16B1_CAP1 input.
        using Addr = Register::Address<0x40010030,0xffff0000,0,unsigned>;
        ///Timer counter capture value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cap{}; 
        namespace CapValC{
        }
    ...
    namespace Noneemr{    ///<External Match Register. The EMR controls the match function and the external match pins CT16B0_MAT[1:0] and CT16B1_MAT[1:0].
        using Addr = Register::Address<0x4001003c,0xfffff000,0,unsigned>;
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        enum class CisVal {
            ct16b1Cap0=0x00000000,     ///<CT16B1_CAP0.
            ct16b1Cap1=0x00000001,     ///<CT16B1_CAP1.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,CisVal> cis{}; 
        namespace CisValC{
            constexpr Register::FieldValue<decltype(cis),CisVal::ct16b1Cap0> ct16b1Cap0{};
            constexpr Register::FieldValue<decltype(cis),CisVal::ct16b1Cap1> ct16b1Cap1{};
        }
        ...
        enum class SelccVal {
            risingEdgeOfCt16b=0x00000000,     ///<Rising Edge of CT16B1_CAP0 clears the timer (if bit 4 is set).
            fallingEdgeOfCt16=0x00000001,     ///<Falling Edge of CT16B1_CAP0 clears the timer (if bit 4 is set).
            risingEdgeOfCt16b=0x00000002,     ///<Rising Edge of CT16B1_CAP1 clears the timer (if bit 4 is set).
            fallingEdgeOfCt16=0x00000003,     ///<Falling Edge of CT16B1_CAP1 clears the timer (if bit 4 is set).
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,SelccVal> selcc{}; 
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(selcc),SelccVal::risingEdgeOfCt16b> risingEdgeOfCt16b{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::fallingEdgeOfCt16> fallingEdgeOfCt16{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::risingEdgeOfCt16b> risingEdgeOfCt16b{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::fallingEdgeOfCt16> fallingEdgeOfCt16{};
        }
    }
    namespace Nonepwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT16B0_MAT[1:0] and CT16B1_MAT[1:0].
        using Addr = Register::Address<0x40010074,0xfffffff0,0,unsigned>;
        ...
        namespace Pwmen0ValC{
            constexpr Register::FieldValue<decltype(pwmen0),Pwmen0Val::ct16bnMat0IsContr> ct16bnMat0IsContr{};
        ...
        namespace Pwmen1ValC{
            constexpr Register::FieldValue<decltype(pwmen1),Pwmen1Val::ct16bnMat01IsCont> ct16bnMat01IsCont{};
        ...
        namespace Pwmen2ValC{
            constexpr Register::FieldValue<decltype(pwmen2),Pwmen2Val::ct16bnMat2IsContr> ct16bnMat2IsContr{};
        ...
        namespace Pwmen3ValC{
            constexpr Register::FieldValue<decltype(pwmen3),Pwmen3Val::ct16bnMat3IsContr> ct16bnMat3IsContr{};
