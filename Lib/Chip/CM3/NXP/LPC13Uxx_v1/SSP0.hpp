...
//SSP/SPI
    ...
    namespace Nonecr1{    ///<Control Register 1. Selects master/slave and other modes.
        ...
        namespace LbmValC{
            constexpr Register::FieldValue<decltype(lbm),LbmVal::duringNormalOperat> duringNormalOperat{};
            constexpr Register::FieldValue<decltype(lbm),LbmVal::serialInputIsTake> serialInputIsTake{};
        }
        ///SPI Enable.
        enum class SseVal {
