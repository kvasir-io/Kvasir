...
//ADC
    namespace Nonecr{    ///<A/D Control Register. The CR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace LpwrmodeValC{
            constexpr Register::FieldValue<decltype(lpwrmode),LpwrmodeVal::disableTheLowPowe> disableTheLowPowe{};
            constexpr Register::FieldValue<decltype(lpwrmode),LpwrmodeVal::enableTheLowPower> enableTheLowPower{};
        }
        ...
        namespace Mode10bitValC{
            constexpr Register::FieldValue<decltype(mode10bit),Mode10bitVal::disableThe10BitC> disableThe10BitC{};
            constexpr Register::FieldValue<decltype(mode10bit),Mode10bitVal::enableThe10BitCo> enableThe10BitCo{};
        }
