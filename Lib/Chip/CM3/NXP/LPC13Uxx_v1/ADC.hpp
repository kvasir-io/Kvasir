...
//ADC
    namespace Nonecr{    ///<A/D Control Register. The CR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace lpwrmodeValC{
            constexpr MPL::Value<lpwrmodeVal,lpwrmodeVal::disableTheLowPowe> disableTheLowPowe{};
            constexpr MPL::Value<lpwrmodeVal,lpwrmodeVal::enableTheLowPower> enableTheLowPower{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,lpwrmodeVal> lpwrmode{}; 
        ...
        namespace mode10bitValC{
            constexpr MPL::Value<mode10bitVal,mode10bitVal::disableThe10BitC> disableThe10BitC{};
            constexpr MPL::Value<mode10bitVal,mode10bitVal::enableThe10BitCo> enableThe10BitCo{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,mode10bitVal> mode10bit{}; 
    ...
    namespace Nonegdr{    ///<A/D Global Data Register. Contains the result of the most recent A/D conversion.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,4),Register::ReadWriteAccess,unsigned> vVref{}; 
