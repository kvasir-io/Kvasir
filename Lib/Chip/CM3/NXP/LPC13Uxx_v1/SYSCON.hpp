...
//System control block 
    ...
    namespace SysconDeviceId{    ///<Device ID
        using Addr = Register::Address<0x400483f8,0x00000000,0x00000000,unsigned>;
    ...
    namespace SysconPintsel0{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel1{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel2{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel3{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel4{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel5{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel6{    ///<GPIO Pin Interrupt Select register
    ...
    namespace SysconPintsel7{    ///<GPIO Pin Interrupt Select register
