...
//USB2.0 device controller
    namespace Nonedevcmdstat{    ///<USB Device Command/Status register
        ...
        namespace IntonnakaoValC{
            constexpr Register::FieldValue<decltype(intonnakAo),IntonnakaoVal::acknow> acknow{};
            constexpr Register::FieldValue<decltype(intonnakAo),IntonnakaoVal::acknowNak> acknowNak{};
        }
        ...
        namespace IntonnakaiValC{
            constexpr Register::FieldValue<decltype(intonnakAi),IntonnakaiVal::acknow> acknow{};
            constexpr Register::FieldValue<decltype(intonnakAi),IntonnakaiVal::acknowNak> acknowNak{};
        }
        ...
        namespace IntonnakcoValC{
            constexpr Register::FieldValue<decltype(intonnakCo),IntonnakcoVal::acknow> acknow{};
            constexpr Register::FieldValue<decltype(intonnakCo),IntonnakcoVal::acknowNak> acknowNak{};
        }
        ...
        namespace IntonnakciValC{
            constexpr Register::FieldValue<decltype(intonnakCi),IntonnakciVal::acknow> acknow{};
            constexpr Register::FieldValue<decltype(intonnakCi),IntonnakciVal::acknowNak> acknowNak{};
        }
