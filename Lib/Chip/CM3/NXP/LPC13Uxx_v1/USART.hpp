...
//USART
    ...
    namespace Noners485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
        ...
        namespace NmmenValC{
            constexpr Register::FieldValue<decltype(nmmen),NmmenVal::rs485Eia485Norma> rs485Eia485Norma{};
            constexpr Register::FieldValue<decltype(nmmen),NmmenVal::rs485Eia485Norma> rs485Eia485Norma{};
        }
        ///Receiver enable.
        enum class RxdisVal {
    ...
    namespace Nonesyncctrl{    ///<Synchronous mode control register.
        ...
        namespace SsdisValC{
            constexpr Register::FieldValue<decltype(ssdis),SsdisVal::sendStartStop> sendStartStop{};
            constexpr Register::FieldValue<decltype(ssdis),SsdisVal::notSendStartStop> notSendStartStop{};
        }
