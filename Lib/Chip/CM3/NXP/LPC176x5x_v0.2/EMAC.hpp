...
namespace Kvasir {
//Ethernet
    namespace EmacMac1{    ///<MAC configuration register 1.
    ...
    namespace EmacMac2{    ///<MAC configuration register 2.
        using Addr = Register::Address<0x50000004,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacIpgt{    ///<Back-to-Back Inter-Packet-Gap register.
    ...
    namespace EmacIpgr{    ///<Non Back-to-Back Inter-Packet-Gap register.
    ...
    namespace EmacClrt{    ///<Collision window / Retry register.
        using Addr = Register::Address<0x50000010,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacMaxf{    ///<Maximum Frame register.
        using Addr = Register::Address<0x50000014,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacSupp{    ///<PHY Support register.
    ...
    namespace EmacTest{    ///<Test register.
        using Addr = Register::Address<0x5000001c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacMcfg{    ///<MII Mgmt Configuration register.
    ...
    namespace EmacMcmd{    ///<MII Mgmt Command register.
    ...
    namespace EmacMadr{    ///<MII Mgmt Address register.
    ...
    namespace EmacMwtd{    ///<MII Mgmt Write Data register.
        using Addr = Register::Address<0x5000002c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacMrdd{    ///<MII Mgmt Read Data register.
    ...
    namespace EmacMind{    ///<MII Mgmt Indicators register.
    ...
    namespace EmacSa0{    ///<Station Address 0 register.
        using Addr = Register::Address<0x50000040,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacSa1{    ///<Station Address 1 register.
        using Addr = Register::Address<0x50000044,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacSa2{    ///<Station Address 2 register.
        using Addr = Register::Address<0x50000048,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacCommand{    ///<Command register.
    ...
    namespace EmacStatus{    ///<Status register.
    ...
    namespace EmacRxdescriptor{    ///<Receive descriptor base address register.
    ...
    namespace EmacRxstatus{    ///<Receive status base address register.
    ...
    namespace EmacRxdescriptornumber{    ///<Receive number of descriptors register.
        using Addr = Register::Address<0x50000110,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRxproduceindex{    ///<Receive produce index register.
        using Addr = Register::Address<0x50000114,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRxconsumeindex{    ///<Receive consume index register.
        using Addr = Register::Address<0x50000118,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacTxdescriptor{    ///<Transmit descriptor base address register.
        using Addr = Register::Address<0x5000011c,0x00000000,0x00000000,unsigned>;
        ///Fixed to 00
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace EmacTxstatus{    ///<Transmit status base address register.
        using Addr = Register::Address<0x50000120,0x00000000,0x00000000,unsigned>;
        ///Fixed to 00
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace EmacTxdescriptornumber{    ///<Transmit number of descriptors register.
        using Addr = Register::Address<0x50000124,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacTxproduceindex{    ///<Transmit produce index register.
        using Addr = Register::Address<0x50000128,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacTxconsumeindex{    ///<Transmit consume index register.
        using Addr = Register::Address<0x5000012c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacTsv0{    ///<Transmit status vector 0 register.
        using Addr = Register::Address<0x50000158,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacTsv1{    ///<Transmit status vector 1 register.
        using Addr = Register::Address<0x5000015c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRsv{    ///<Receive status vector register.
        using Addr = Register::Address<0x50000160,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacFlowcontrolcounter{    ///<Flow control counter register.
        using Addr = Register::Address<0x50000170,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacFlowcontrolstatus{    ///<Flow control status register.
        using Addr = Register::Address<0x50000174,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRxfilterctrl{    ///<Receive filter control register.
        using Addr = Register::Address<0x50000200,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRxfilterwolstatus{    ///<Receive filter WoL status register.
        using Addr = Register::Address<0x50000204,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacRxfilterwolclear{    ///<Receive filter WoL clear register.
        using Addr = Register::Address<0x50000208,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacHashfilterl{    ///<Hash filter table LSBs register.
        using Addr = Register::Address<0x50000210,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacHashfilterh{    ///<Hash filter table MSBs register.
        using Addr = Register::Address<0x50000214,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacIntstatus{    ///<Interrupt status register.
        using Addr = Register::Address<0x50000fe0,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacIntenable{    ///<Interrupt enable register.
        using Addr = Register::Address<0x50000fe4,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacIntclear{    ///<Interrupt clear register.
        using Addr = Register::Address<0x50000fe8,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacIntset{    ///<Interrupt set register.
        using Addr = Register::Address<0x50000fec,0x00000000,0x00000000,unsigned>;
    ...
    namespace EmacPowerdown{    ///<Power-down register.
        using Addr = Register::Address<0x50000ff4,0x00000000,0x00000000,unsigned>;
        ///Unused
