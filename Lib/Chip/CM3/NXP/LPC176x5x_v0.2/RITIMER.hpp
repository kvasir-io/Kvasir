...
namespace Kvasir {
    namespace Nonecompval{
        using Addr = Register::Address<0x400b0000,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RICOMP; 
    }
    namespace Nonemask{
        using Addr = Register::Address<0x400b0004,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RIMASK; 
    }
    namespace Nonectrl{
        using Addr = Register::Address<0x400b0008,0xfffffff0>;
    ...
    namespace Nonecounter{
        using Addr = Register::Address<0x400b000c,0x00000000>;
