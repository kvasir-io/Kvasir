...
//Analog-to-Digital Converter (ADC) 
    namespace Nonecr{    ///<A/D Control Register. The ADCR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace BurstValC{
            constexpr Register::FieldValue<decltype(burst),BurstVal::burst> burst{};
            constexpr Register::FieldValue<decltype(burst),BurstVal::sw> sw{};
        }
        ///Power down mode
        enum class PdnVal {
        ...
        namespace PdnValC{
            constexpr Register::FieldValue<decltype(pdn),PdnVal::powered> powered{};
            constexpr Register::FieldValue<decltype(pdn),PdnVal::powerdown> powerdown{};
        }
        ...
        namespace StartValC{
            ...
            constexpr Register::FieldValue<decltype(start),StartVal::p210> p210{};
            constexpr Register::FieldValue<decltype(start),StartVal::p127> p127{};
            constexpr Register::FieldValue<decltype(start),StartVal::mat01> mat01{};
            constexpr Register::FieldValue<decltype(start),StartVal::mat03> mat03{};
            constexpr Register::FieldValue<decltype(start),StartVal::mat10> mat10{};
            constexpr Register::FieldValue<decltype(start),StartVal::mat11> mat11{};
        }
        ...
        namespace EdgeValC{
            constexpr Register::FieldValue<decltype(edge),EdgeVal::fallling> fallling{};
    ...
    namespace Noneinten{    ///<A/D Interrupt Enable Register. This register contains enable bits that allow the DONE flag of each A/D channel to be included or excluded from contributing to the generation of an A/D interrupt.
        ...
        namespace Adinten0ValC{
            constexpr Register::FieldValue<decltype(adinten0),Adinten0Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten0),Adinten0Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten1ValC{
            constexpr Register::FieldValue<decltype(adinten1),Adinten1Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten1),Adinten1Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten2ValC{
            constexpr Register::FieldValue<decltype(adinten2),Adinten2Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten2),Adinten2Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten3ValC{
            constexpr Register::FieldValue<decltype(adinten3),Adinten3Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten3),Adinten3Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten4ValC{
            constexpr Register::FieldValue<decltype(adinten4),Adinten4Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten4),Adinten4Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten5ValC{
            constexpr Register::FieldValue<decltype(adinten5),Adinten5Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten5),Adinten5Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten6ValC{
            constexpr Register::FieldValue<decltype(adinten6),Adinten6Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten6),Adinten6Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace Adinten7ValC{
            constexpr Register::FieldValue<decltype(adinten7),Adinten7Val::disable> disable{};
            constexpr Register::FieldValue<decltype(adinten7),Adinten7Val::enable> enable{};
        }
        ///Interrupt enable
        ...
        namespace AdgintenValC{
            constexpr Register::FieldValue<decltype(adginten),AdgintenVal::channels> channels{};
            constexpr Register::FieldValue<decltype(adginten),AdgintenVal::global> global{};
        }
    }
