...
//SPI 
    namespace Nonecr{    ///<SPI Control Register. This register controls the operation of the SPI.
        ...
        namespace BitenableValC{
            constexpr Register::FieldValue<decltype(bitenable),BitenableVal::theSpiControllerS> theSpiControllerS{};
        }
        ...
        namespace CphaValC{
            constexpr Register::FieldValue<decltype(cpha),CphaVal::firstEdge> firstEdge{};
            constexpr Register::FieldValue<decltype(cpha),CphaVal::secondEdge> secondEdge{};
        }
        ...
        namespace CpolValC{
            constexpr Register::FieldValue<decltype(cpol),CpolVal::sckIsActiveHigh> sckIsActiveHigh{};
            constexpr Register::FieldValue<decltype(cpol),CpolVal::sckIsActiveLow> sckIsActiveLow{};
        }
        ///Master mode select.
        enum class MstrVal {
        ...
        namespace MstrValC{
            constexpr Register::FieldValue<decltype(mstr),MstrVal::slave> slave{};
            constexpr Register::FieldValue<decltype(mstr),MstrVal::master> master{};
        }
        ...
        namespace LsbfValC{
            constexpr Register::FieldValue<decltype(lsbf),LsbfVal::msb> msb{};
            constexpr Register::FieldValue<decltype(lsbf),LsbfVal::lsb> lsb{};
        }
        ...
        namespace SpieValC{
            constexpr Register::FieldValue<decltype(spie),SpieVal::intblock> intblock{};
            constexpr Register::FieldValue<decltype(spie),SpieVal::hwint> hwint{};
        }
        ...
        namespace BitsValC{
            constexpr Register::FieldValue<decltype(bits),BitsVal::v8BitsPerTransfer> v8BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v9BitsPerTransfer> v9BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v10BitsPerTransfer> v10BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v11BitsPerTransfer> v11BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v12BitsPerTransfer> v12BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v13BitsPerTransfer> v13BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v14BitsPerTransfer> v14BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v15BitsPerTransfer> v15BitsPerTransfer{};
            constexpr Register::FieldValue<decltype(bits),BitsVal::v16BitsPerTransfer> v16BitsPerTransfer{};
        }
    }
