...
//System and clock control
    namespace Noneflashcfg{    ///<Flash Accelerator Configuration Register. Controls flash access timing.
        ...
        namespace flashtimValC{
            constexpr MPL::Value<flashtimVal,flashtimVal::v1clk> v1clk{};
            constexpr MPL::Value<flashtimVal,flashtimVal::v2clk> v2clk{};
            constexpr MPL::Value<flashtimVal,flashtimVal::v3clk> v3clk{};
            constexpr MPL::Value<flashtimVal,flashtimVal::v4clk> v4clk{};
            constexpr MPL::Value<flashtimVal,flashtimVal::v5clk> v5clk{};
            constexpr MPL::Value<flashtimVal,flashtimVal::v6clk> v6clk{};
        }
    ...
    namespace Nonepll0con{    ///<PLL0 Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> plle0{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pllc0{}; 
    }
    namespace Nonepll0cfg{    ///<PLL0 Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,0),Register::ReadWriteAccess,unsigned> msel0{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16),Register::ReadWriteAccess,unsigned> nsel0{}; 
    }
    namespace Nonepll0stat{    ///<PLL0 Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> plle0Stat{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> pllc0Stat{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> plock0{}; 
    }
    namespace Nonepll0feed{    ///<PLL0 Feed Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> pll0feed{}; 
    }
    namespace Nonepll1con{    ///<PLL1 Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> plle1{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pllc1{}; 
    }
    namespace Nonepll1cfg{    ///<PLL1 Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> msel1{}; 
        ///PLL1 Divider value. Supplies the value P in the PLL1 frequency calculations.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,5),Register::ReadWriteAccess,unsigned> psel1{}; 
    }
    namespace Nonepll1stat{    ///<PLL1 Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> plle1Stat{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> pllc1Stat{}; 
        ///Reflects the PLL1 Lock status. When zero, PLL1 is not locked. When one, PLL1 is locked onto the requested frequency.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> plock1{}; 
    }
    namespace Nonepll1feed{    ///<PLL1 Feed Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> pll1feed{}; 
    }
    ...
    namespace Nonepconp{    ///<Power Control for Peripherals Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> pcspi{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> pcrit{}; 
        ///Motor Control PWM
    ...
    namespace Nonecclkcfg{    ///<CPU Clock Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> cclksel{}; 
    }
    namespace Noneusbclkcfg{    ///<USB Clock Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> usbsel{}; 
    }
    namespace Noneclksrcsel{    ///<Clock Source Select Register
        ...
        enum class clksrcVal {
            ...
            reserved=0x00000003,     ///<Reserved, do not use this setting.
        };
        namespace clksrcValC{
            ...
            constexpr MPL::Value<clksrcVal,clksrcVal::selectsTheRtcOsci> selectsTheRtcOsci{};
            constexpr MPL::Value<clksrcVal,clksrcVal::reserved> reserved{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,clksrcVal> clksrc{}; 
    }
    ...
    namespace Noneextpolar{    ///<External Interrupt Polarity Register
        ...
        namespace extpolar0ValC{
            constexpr MPL::Value<extpolar0Val,extpolar0Val::fallingEdge> fallingEdge{};
            constexpr MPL::Value<extpolar0Val,extpolar0Val::risingEdge> risingEdge{};
        }
        ...
        namespace extpolar1ValC{
            constexpr MPL::Value<extpolar1Val,extpolar1Val::fallingEdge> fallingEdge{};
            constexpr MPL::Value<extpolar1Val,extpolar1Val::risingEdge> risingEdge{};
        }
        ...
        namespace extpolar2ValC{
            constexpr MPL::Value<extpolar2Val,extpolar2Val::fallingEdge> fallingEdge{};
            constexpr MPL::Value<extpolar2Val,extpolar2Val::risingEdge> risingEdge{};
        }
        ...
        namespace extpolar3ValC{
            constexpr MPL::Value<extpolar3Val,extpolar3Val::fallingEdge> fallingEdge{};
            constexpr MPL::Value<extpolar3Val,extpolar3Val::risingEdge> risingEdge{};
        }
    ...
    namespace Nonescs{    ///<System control and status
        ...
        namespace oscrangeValC{
            constexpr MPL::Value<oscrangeVal,oscrangeVal::low> low{};
            constexpr MPL::Value<oscrangeVal,oscrangeVal::high> high{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,oscrangeVal> oscrange{}; 
        ...
        namespace oscstatValC{
            constexpr MPL::Value<oscstatVal,oscstatVal::notReady> notReady{};
            constexpr MPL::Value<oscstatVal,oscstatVal::ready> ready{};
        }
    ...
    namespace Nonepclksel0{    ///<Peripheral Clock Selection register 0.
        ...
        namespace pclkWdtValC{
            constexpr MPL::Value<pclkWdtVal,pclkWdtVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkWdtVal,pclkWdtVal::cclk> cclk{};
            constexpr MPL::Value<pclkWdtVal,pclkWdtVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkWdtVal,pclkWdtVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,pclkWdtVal> pclkWdt{}; 
        ...
        namespace pclkTimer0ValC{
            constexpr MPL::Value<pclkTimer0Val,pclkTimer0Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkTimer0Val,pclkTimer0Val::cclk> cclk{};
            constexpr MPL::Value<pclkTimer0Val,pclkTimer0Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkTimer0Val,pclkTimer0Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,pclkTimer0Val> pclkTimer0{}; 
        ...
        namespace pclkTimer1ValC{
            constexpr MPL::Value<pclkTimer1Val,pclkTimer1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkTimer1Val,pclkTimer1Val::cclk> cclk{};
            constexpr MPL::Value<pclkTimer1Val,pclkTimer1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkTimer1Val,pclkTimer1Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,pclkTimer1Val> pclkTimer1{}; 
        ...
        namespace pclkUart0ValC{
            constexpr MPL::Value<pclkUart0Val,pclkUart0Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkUart0Val,pclkUart0Val::cclk> cclk{};
            constexpr MPL::Value<pclkUart0Val,pclkUart0Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkUart0Val,pclkUart0Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6),Register::ReadWriteAccess,pclkUart0Val> pclkUart0{}; 
        ...
        namespace pclkUart1ValC{
            constexpr MPL::Value<pclkUart1Val,pclkUart1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkUart1Val,pclkUart1Val::cclk> cclk{};
            constexpr MPL::Value<pclkUart1Val,pclkUart1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkUart1Val,pclkUart1Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,pclkUart1Val> pclkUart1{}; 
        ...
        namespace pclkPwm1ValC{
            constexpr MPL::Value<pclkPwm1Val,pclkPwm1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkPwm1Val,pclkPwm1Val::cclk> cclk{};
            constexpr MPL::Value<pclkPwm1Val,pclkPwm1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkPwm1Val,pclkPwm1Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12),Register::ReadWriteAccess,pclkPwm1Val> pclkPwm1{}; 
        ...
        namespace pclkI2c0ValC{
            constexpr MPL::Value<pclkI2c0Val,pclkI2c0Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkI2c0Val,pclkI2c0Val::cclk> cclk{};
            constexpr MPL::Value<pclkI2c0Val,pclkI2c0Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkI2c0Val,pclkI2c0Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,pclkI2c0Val> pclkI2c0{}; 
        ...
        namespace pclkSpiValC{
            constexpr MPL::Value<pclkSpiVal,pclkSpiVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkSpiVal,pclkSpiVal::cclk> cclk{};
            constexpr MPL::Value<pclkSpiVal,pclkSpiVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkSpiVal,pclkSpiVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,pclkSpiVal> pclkSpi{}; 
        ...
        namespace pclkSsp1ValC{
            constexpr MPL::Value<pclkSsp1Val,pclkSsp1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkSsp1Val,pclkSsp1Val::cclk> cclk{};
            constexpr MPL::Value<pclkSsp1Val,pclkSsp1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkSsp1Val,pclkSsp1Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,pclkSsp1Val> pclkSsp1{}; 
        ...
        namespace pclkDacValC{
            constexpr MPL::Value<pclkDacVal,pclkDacVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkDacVal,pclkDacVal::cclk> cclk{};
            constexpr MPL::Value<pclkDacVal,pclkDacVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkDacVal,pclkDacVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,pclkDacVal> pclkDac{}; 
        ...
        namespace pclkAdcValC{
            constexpr MPL::Value<pclkAdcVal,pclkAdcVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkAdcVal,pclkAdcVal::cclk> cclk{};
            constexpr MPL::Value<pclkAdcVal,pclkAdcVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkAdcVal,pclkAdcVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24),Register::ReadWriteAccess,pclkAdcVal> pclkAdc{}; 
        ...
        namespace pclkCan1ValC{
            constexpr MPL::Value<pclkCan1Val,pclkCan1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkCan1Val,pclkCan1Val::cclk> cclk{};
            constexpr MPL::Value<pclkCan1Val,pclkCan1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkCan1Val,pclkCan1Val::cclkDiv6> cclkDiv6{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26),Register::ReadWriteAccess,pclkCan1Val> pclkCan1{}; 
        ...
        namespace pclkCan2ValC{
            constexpr MPL::Value<pclkCan2Val,pclkCan2Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkCan2Val,pclkCan2Val::cclk> cclk{};
            constexpr MPL::Value<pclkCan2Val,pclkCan2Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkCan2Val,pclkCan2Val::cclkDiv6> cclkDiv6{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,28),Register::ReadWriteAccess,pclkCan2Val> pclkCan2{}; 
        ...
        namespace pclkAcfValC{
            constexpr MPL::Value<pclkAcfVal,pclkAcfVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkAcfVal,pclkAcfVal::cclk> cclk{};
            constexpr MPL::Value<pclkAcfVal,pclkAcfVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkAcfVal,pclkAcfVal::cclkDiv6> cclkDiv6{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,30),Register::ReadWriteAccess,pclkAcfVal> pclkAcf{}; 
    }
    namespace Nonepclksel1{    ///<Peripheral Clock Selection register 1.
        ...
        namespace pclkQeiValC{
            constexpr MPL::Value<pclkQeiVal,pclkQeiVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkQeiVal,pclkQeiVal::cclk> cclk{};
            constexpr MPL::Value<pclkQeiVal,pclkQeiVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkQeiVal,pclkQeiVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,pclkQeiVal> pclkQei{}; 
        ...
        namespace pclkGpiointValC{
            constexpr MPL::Value<pclkGpiointVal,pclkGpiointVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkGpiointVal,pclkGpiointVal::cclk> cclk{};
            constexpr MPL::Value<pclkGpiointVal,pclkGpiointVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkGpiointVal,pclkGpiointVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,pclkGpiointVal> pclkGpioint{}; 
        ...
        namespace pclkPcbValC{
            constexpr MPL::Value<pclkPcbVal,pclkPcbVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkPcbVal,pclkPcbVal::cclk> cclk{};
            constexpr MPL::Value<pclkPcbVal,pclkPcbVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkPcbVal,pclkPcbVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,pclkPcbVal> pclkPcb{}; 
        ...
        namespace pclkI2c1ValC{
            constexpr MPL::Value<pclkI2c1Val,pclkI2c1Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkI2c1Val,pclkI2c1Val::cclk> cclk{};
            constexpr MPL::Value<pclkI2c1Val,pclkI2c1Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkI2c1Val,pclkI2c1Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6),Register::ReadWriteAccess,pclkI2c1Val> pclkI2c1{}; 
        ...
        namespace pclkSsp0ValC{
            constexpr MPL::Value<pclkSsp0Val,pclkSsp0Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkSsp0Val,pclkSsp0Val::cclk> cclk{};
            constexpr MPL::Value<pclkSsp0Val,pclkSsp0Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkSsp0Val,pclkSsp0Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,pclkSsp0Val> pclkSsp0{}; 
        ...
        namespace pclkTimer2ValC{
            constexpr MPL::Value<pclkTimer2Val,pclkTimer2Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkTimer2Val,pclkTimer2Val::cclk> cclk{};
            constexpr MPL::Value<pclkTimer2Val,pclkTimer2Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkTimer2Val,pclkTimer2Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12),Register::ReadWriteAccess,pclkTimer2Val> pclkTimer2{}; 
        ...
        namespace pclkTimer3ValC{
            constexpr MPL::Value<pclkTimer3Val,pclkTimer3Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkTimer3Val,pclkTimer3Val::cclk> cclk{};
            constexpr MPL::Value<pclkTimer3Val,pclkTimer3Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkTimer3Val,pclkTimer3Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,pclkTimer3Val> pclkTimer3{}; 
        ...
        namespace pclkUart2ValC{
            constexpr MPL::Value<pclkUart2Val,pclkUart2Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkUart2Val,pclkUart2Val::cclk> cclk{};
            constexpr MPL::Value<pclkUart2Val,pclkUart2Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkUart2Val,pclkUart2Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,pclkUart2Val> pclkUart2{}; 
        ...
        namespace pclkUart3ValC{
            constexpr MPL::Value<pclkUart3Val,pclkUart3Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkUart3Val,pclkUart3Val::cclk> cclk{};
            constexpr MPL::Value<pclkUart3Val,pclkUart3Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkUart3Val,pclkUart3Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18),Register::ReadWriteAccess,pclkUart3Val> pclkUart3{}; 
        ...
        namespace pclkI2c2ValC{
            constexpr MPL::Value<pclkI2c2Val,pclkI2c2Val::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkI2c2Val,pclkI2c2Val::cclk> cclk{};
            constexpr MPL::Value<pclkI2c2Val,pclkI2c2Val::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkI2c2Val,pclkI2c2Val::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,pclkI2c2Val> pclkI2c2{}; 
        ...
        namespace pclkI2sValC{
            constexpr MPL::Value<pclkI2sVal,pclkI2sVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkI2sVal,pclkI2sVal::cclk> cclk{};
            constexpr MPL::Value<pclkI2sVal,pclkI2sVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkI2sVal,pclkI2sVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,pclkI2sVal> pclkI2s{}; 
        ...
        namespace pclkRitValC{
            constexpr MPL::Value<pclkRitVal,pclkRitVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkRitVal,pclkRitVal::cclk> cclk{};
            constexpr MPL::Value<pclkRitVal,pclkRitVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkRitVal,pclkRitVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26),Register::ReadWriteAccess,pclkRitVal> pclkRit{}; 
        ...
        namespace pclkSysconValC{
            constexpr MPL::Value<pclkSysconVal,pclkSysconVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkSysconVal,pclkSysconVal::cclk> cclk{};
            constexpr MPL::Value<pclkSysconVal,pclkSysconVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkSysconVal,pclkSysconVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,28),Register::ReadWriteAccess,pclkSysconVal> pclkSyscon{}; 
        ...
        namespace pclkMcValC{
            constexpr MPL::Value<pclkMcVal,pclkMcVal::cclkDiv4> cclkDiv4{};
            constexpr MPL::Value<pclkMcVal,pclkMcVal::cclk> cclk{};
            constexpr MPL::Value<pclkMcVal,pclkMcVal::cclkDiv2> cclkDiv2{};
            constexpr MPL::Value<pclkMcVal,pclkMcVal::cclkDiv8> cclkDiv8{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,30),Register::ReadWriteAccess,pclkMcVal> pclkMc{}; 
    }
    ...
    namespace Nonedmacreqsel{    ///<Selects between alternative requests on DMA channels 0 through 7 and 10 through 15
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> dmasel08{}; 
        ///Selects the DMA request for GPDMA input 9: 0 - uart0 rx 1 - Timer 0 match 1 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dmasel09{}; 
        ///Selects the DMA request for GPDMA input 10: 0 - uart1 tx  is selected. 1 - Timer 1 match 0 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> dmasel10{}; 
        ///Selects the DMA request for GPDMA input 11: 0 - uart1 rx  is selected. 1 - Timer 1 match 1 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> dmasel11{}; 
        ///Selects the DMA request for GPDMA input 12: 0 - uart2 tx  is selected. 1 - Timer 2 match 0 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> dmasel12{}; 
        ///Selects the DMA request for GPDMA input 13: 0 - uart2 rx  is selected. 1 - Timer 2 match 1 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> dmasel13{}; 
        ///Selects the DMA request for GPDMA input 14: 0 - uart3 tx  is selected. 1 - I2S channel 0 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> dmasel14{}; 
        ///Selects the DMA request for GPDMA input 15: 0 - uart3 rx is selected. 1 - I2S channel 1 is selected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> dmasel15{}; 
    }
    namespace Noneclkoutcfg{    ///<Clock Output Configuration Register
        ...
        namespace clkoutselValC{
            constexpr MPL::Value<clkoutselVal,clkoutselVal::selectsTheCpuCloc> selectsTheCpuCloc{};
            constexpr MPL::Value<clkoutselVal,clkoutselVal::selectsTheMainOsc> selectsTheMainOsc{};
            constexpr MPL::Value<clkoutselVal,clkoutselVal::selectsTheInternal> selectsTheInternal{};
            constexpr MPL::Value<clkoutselVal,clkoutselVal::selectsTheUsbCloc> selectsTheUsbCloc{};
            constexpr MPL::Value<clkoutselVal,clkoutselVal::selectsTheRtcOsci> selectsTheRtcOsci{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,clkoutselVal> clkoutsel{}; 
