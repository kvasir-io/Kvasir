...
//Motor Control PWM
    ...
    namespace McpwmCp{    ///<Communication Pattern register
        using Addr = Register::Address<0x400b8040,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmInten{    ///<Interrupt Enable read address
        using Addr = Register::Address<0x400b8050,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmIntenSet{    ///<Interrupt Enable set address
        using Addr = Register::Address<0x400b8054,0x00000100,0x00000000,unsigned>;
    ...
    namespace McpwmIntenClr{    ///<Interrupt Enable clear address
        using Addr = Register::Address<0x400b8058,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmIntf{    ///<Interrupt flags read address
        using Addr = Register::Address<0x400b8068,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmIntfSet{    ///<Interrupt flags set address
        using Addr = Register::Address<0x400b806c,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmCntcon{    ///<Count Control read address
        using Addr = Register::Address<0x400b805c,0x00000000,0x00000000,unsigned>;
        ...
        namespace Tc0mci0reValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci0Re)::Type,Tc0mci0reVal::rising> rising{};
        }
        ...
        namespace Tc0mci0feValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci0Fe)::Type,Tc0mci0feVal::falling> falling{};
        }
        ...
        namespace Tc0mci1reValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci1Re)::Type,Tc0mci1reVal::rising> rising{};
        }
        ...
        namespace Tc0mci1feValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci1Fe)::Type,Tc0mci1feVal::falling> falling{};
        }
        ...
        namespace Tc0mci2reValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci2Re)::Type,Tc0mci2reVal::rising> rising{};
        }
        ...
        namespace Tc0mci2feValC{
            ...
            constexpr Register::FieldValue<decltype(tc0mci2Fe)::Type,Tc0mci2feVal::fallling> fallling{};
        }
        ...
        namespace Tc1mci0reValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci0Re)::Type,Tc1mci0reVal::rising> rising{};
        }
        ...
        namespace Tc1mci0feValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci0Fe)::Type,Tc1mci0feVal::falling> falling{};
        }
        ...
        namespace Tc1mci1reValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci1Re)::Type,Tc1mci1reVal::rising> rising{};
        }
        ...
        namespace Tc1mci1feValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci1Fe)::Type,Tc1mci1feVal::falling> falling{};
        }
        ...
        namespace Tc1mci2reValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci2Re)::Type,Tc1mci2reVal::rising> rising{};
        }
        ...
        namespace Tc1mci2feValC{
            ...
            constexpr Register::FieldValue<decltype(tc1mci2Fe)::Type,Tc1mci2feVal::falling> falling{};
        }
        ...
        namespace Tc2mci0reValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci0Re)::Type,Tc2mci0reVal::rising> rising{};
        }
        ...
        namespace Tc2mci0feValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci0Fe)::Type,Tc2mci0feVal::falling> falling{};
        }
        ...
        namespace Tc2mci1reValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci1Re)::Type,Tc2mci1reVal::rising> rising{};
        }
        ...
        namespace Tc2mci1feValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci1Fe)::Type,Tc2mci1feVal::falling> falling{};
        }
        ...
        namespace Tc2mci2reValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci2Re)::Type,Tc2mci2reVal::risiing> risiing{};
        }
        ...
        namespace Tc2mci2feValC{
            ...
            constexpr Register::FieldValue<decltype(tc2mci2Fe)::Type,Tc2mci2feVal::falling> falling{};
        }
        ///Reserved.
    ...
    namespace McpwmCntconSet{    ///<Count Control set address
        using Addr = Register::Address<0x400b8060,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmCntconClr{    ///<Count Control clear address
        using Addr = Register::Address<0x400b8064,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmCap0{    ///<Capture register
        using Addr = Register::Address<0x400b8044,0x00000000,0x00000000,unsigned>;
    ...
    namespace McpwmCap1{    ///<Capture register
        using Addr = Register::Address<0x400b8048,0x00000000,0x00000000,unsigned>;
        ///Current TC value at a capture event.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
    namespace McpwmCap2{    ///<Capture register
        using Addr = Register::Address<0x400b804c,0x00000000,0x00000000,unsigned>;
        ///Current TC value at a capture event.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cap{}; 
    }
}
