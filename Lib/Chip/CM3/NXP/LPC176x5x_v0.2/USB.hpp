...
//USB device/host/OTG controller
    ...
    namespace Nonei2cSts{    ///<I2C Status
        ...
        namespace TdiValC{
            constexpr Register::FieldValue<decltype(tdi),TdiVal::notComplete> notComplete{};
            constexpr Register::FieldValue<decltype(tdi),TdiVal::complete> complete{};
        }
        ...
        namespace NaiValC{
            constexpr Register::FieldValue<decltype(nai),NaiVal::acknowledgeRcvd> acknowledgeRcvd{};
            constexpr Register::FieldValue<decltype(nai),NaiVal::noAcknowledgeRcvd> noAcknowledgeRcvd{};
        }
        ...
        namespace DrmiValC{
            constexpr Register::FieldValue<decltype(drmi),DrmiVal::busy> busy{};
            constexpr Register::FieldValue<decltype(drmi),DrmiVal::needData> needData{};
        }
        ...
        namespace DrsiValC{
            constexpr Register::FieldValue<decltype(drsi),DrsiVal::busy> busy{};
            constexpr Register::FieldValue<decltype(drsi),DrsiVal::needData> needData{};
        }
        ...
        namespace RfeValC{
            constexpr Register::FieldValue<decltype(rfe),RfeVal::data> data{};
            constexpr Register::FieldValue<decltype(rfe),RfeVal::empty> empty{};
        }
        ...
        namespace TfeValC{
            constexpr Register::FieldValue<decltype(tfe),TfeVal::validData> validData{};
            constexpr Register::FieldValue<decltype(tfe),TfeVal::empty> empty{};
        }
    }
    namespace Nonei2cCtl{    ///<I2C Control
        ...
        namespace SrstValC{
            constexpr Register::FieldValue<decltype(srst),SrstVal::noReset> noReset{};
            constexpr Register::FieldValue<decltype(srst),SrstVal::reset> reset{};
        }
    }
