...
//I2C bus interface
    ...
    namespace I2c1DataBuffer{    ///<Data buffer register. The contents of the 8 MSBs of the DAT shift register will be transferred to the DATA_BUFFER automatically after every nine bits (8 bits of data plus ACK or NACK) has been received on the bus.
        using Addr = Register::Address<0x4005c02c,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Mask0{    ///<I2C Slave address mask register
        using Addr = Register::Address<0x4005c030,0x00000000,0x00000000,unsigned>;
    ...
    namespace I2c1Mask1{    ///<I2C Slave address mask register
        using Addr = Register::Address<0x4005c034,0x00000000,0x00000000,unsigned>;
        ///Reserved. User software should not write ones to reserved bits. This bit reads always back as 0.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///Mask bits.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> mask{}; 
    ...
    namespace I2c1Mask2{    ///<I2C Slave address mask register
        using Addr = Register::Address<0x4005c038,0x00000000,0x00000000,unsigned>;
        ///Reserved. User software should not write ones to reserved bits. This bit reads always back as 0.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///Mask bits.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> mask{}; 
    ...
    namespace I2c1Mask3{    ///<I2C Slave address mask register
        using Addr = Register::Address<0x4005c03c,0x00000000,0x00000000,unsigned>;
        ///Reserved. User software should not write ones to reserved bits. This bit reads always back as 0.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///Mask bits.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> mask{}; 
