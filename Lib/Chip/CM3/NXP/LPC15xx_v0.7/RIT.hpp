...
//Repetitive Interrupt Timer (RIT)  
    ...
    namespace RitMask{    ///<Mask LSB register. This register holds the 32 LSB s of the mask value. A 1 written to any bit will force a compare on the corresponding bit of the counter and compare register.
