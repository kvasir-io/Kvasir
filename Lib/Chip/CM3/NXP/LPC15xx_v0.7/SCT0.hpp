...
//Large State Configurable Timers 0/1 (SCT0/1)
    ...
    namespace Nonedither{    ///<SCT dither condition register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dithmskL{}; 
        ///If bit n is one, the event n causes the dither engine to advance to the next element in the dither pattern at the start of the next counter cycle of the 16-bit high counter (event 0 = bit 0, event 1 = bit 1, event 15 = bit 15). If all bits are set to 0, the dither pattern automatically advances at the start of every new counter cycle.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dithmskH{}; 
    }
    ...
    namespace Noneoutput{    ///<SCT output register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> out{}; 
    }
    namespace Noneoutputdirctrl{    ///<SCT output counter direction control register
        ...
        namespace setclr6ValC{
            constexpr MPL::Value<setclr6Val,setclr6Val::setAndClearDoNot> setAndClearDoNot{};
            constexpr MPL::Value<setclr6Val,setclr6Val::setAndClearAreRe> setAndClearAreRe{};
            constexpr MPL::Value<setclr6Val,setclr6Val::setAndClearAreRe> setAndClearAreRe{};
        }
        ...
        namespace setclr7ValC{
            constexpr MPL::Value<setclr7Val,setclr7Val::setAndClearDoNot> setAndClearDoNot{};
            constexpr MPL::Value<setclr7Val,setclr7Val::setAndClearAreRe> setAndClearAreRe{};
            constexpr MPL::Value<setclr7Val,setclr7Val::setAndClearAreRe> setAndClearAreRe{};
        }
        ...
        namespace setclr8ValC{
            constexpr MPL::Value<setclr8Val,setclr8Val::setAndClearDoNot> setAndClearDoNot{};
            constexpr MPL::Value<setclr8Val,setclr8Val::setAndClearAreRe> setAndClearAreRe{};
            constexpr MPL::Value<setclr8Val,setclr8Val::setAndClearAreRe> setAndClearAreRe{};
        }
        ...
        namespace setclr9ValC{
            constexpr MPL::Value<setclr9Val,setclr9Val::setAndClearDoNot> setAndClearDoNot{};
            constexpr MPL::Value<setclr9Val,setclr9Val::setAndClearAreRe> setAndClearAreRe{};
            constexpr MPL::Value<setclr9Val,setclr9Val::setAndClearAreRe> setAndClearAreRe{};
        }
    ...
    namespace Noneconen{    ///<SCT conflict enable register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> ncen{}; 
    }
    namespace Noneconflag{    ///<SCT conflict flag register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> ncflag{}; 
    ...
    namespace Nonefracmat0{    ///<Fractional match registers 0 to 5 for SCT match value registers 0 to 5.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> fracmatL{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> fracmatH{}; 
    }
    ...
    namespace Nonefracmatrel0{    ///<Fractional match reload registers 0 to 5 for SCT match value registers 0 to 5.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> relfracL{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> relfracH{}; 
    }
    ...
    namespace Noneev0State{    ///<SCT event state register 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
    }
