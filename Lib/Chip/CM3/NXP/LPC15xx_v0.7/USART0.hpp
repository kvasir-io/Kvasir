...
namespace Kvasir {
    namespace Nonecfg{
        using Addr = Register::Address<0x40040000,0xff032502>;
    ...
    namespace Nonectl{
        using Addr = Register::Address<0x40040004,0xfffefcb9>;
    ...
    namespace Nonestat{
        using Addr = Register::Address<0x40040008,0xfffe0280>;
    ...
    namespace Noneintenset{
        using Addr = Register::Address<0x4004000c,0xfffe0692>;
    ...
    namespace Noneintenclr{
        using Addr = Register::Address<0x40040010,0xfffe0692>;
    ...
    namespace Nonerxdat{
        using Addr = Register::Address<0x40040014,0xfffffe00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0)> DATA; 
    }
    namespace Nonerxdatstat{
        using Addr = Register::Address<0x40040018,0xffff1e00>;
    ...
    namespace Nonetxdat{
        using Addr = Register::Address<0x4004001c,0xfffffe00>;
    ...
    namespace Noneintstat{
        using Addr = Register::Address<0x40040024,0xfffe0692>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TXIDLE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> DELTACTS; 
    ...
    namespace Noneosr{
        using Addr = Register::Address<0x40040028,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> OSRVAL; 
    }
    namespace Noneaddr{
        using Addr = Register::Address<0x4004002c,0xffffff00>;
