...
//Small State Configurable Timers 2/3 (SCT2/3) 
    namespace Sct2Config{    ///<SCT configuration register
        using Addr = Register::Address<0x1c020000,0x00000000,0x00000000,unsigned>;
        ///SCT operation
        enum class UnifyVal {
    ...
    namespace Sct2Ctrl{    ///<SCT control register
        using Addr = Register::Address<0x1c020004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Limit{    ///<SCT limit register
        using Addr = Register::Address<0x1c020008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Halt{    ///<SCT halt condition register
        using Addr = Register::Address<0x1c02000c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Stop{    ///<SCT stop condition register
        using Addr = Register::Address<0x1c020010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Start{    ///<SCT start condition register
        using Addr = Register::Address<0x1c020014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Count{    ///<SCT counter register
        using Addr = Register::Address<0x1c020040,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2State{    ///<SCT state register
        using Addr = Register::Address<0x1c020044,0x00000000,0x00000000,unsigned>;
        ///State variable.
    ...
    namespace Sct2Input{    ///<SCT input register
        using Addr = Register::Address<0x1c020048,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Regmode{    ///<SCT match/capture registers mode register
        using Addr = Register::Address<0x1c02004c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Output{    ///<SCT output register
        using Addr = Register::Address<0x1c020050,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Outputdirctrl{    ///<SCT output counter direction control register
        using Addr = Register::Address<0x1c020054,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Res{    ///<SCT conflict resolution register
        using Addr = Register::Address<0x1c020058,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Dmareq0{    ///<SCT DMA request 0 register
        using Addr = Register::Address<0x1c02005c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Dmareq1{    ///<SCT DMA request 1 register
        using Addr = Register::Address<0x1c020060,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Even{    ///<SCT event enable register
        using Addr = Register::Address<0x1c0200f0,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Evflag{    ///<SCT event flag register
        using Addr = Register::Address<0x1c0200f4,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Conen{    ///<SCT conflict enable register
        using Addr = Register::Address<0x1c0200f8,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Conflag{    ///<SCT conflict flag register
        using Addr = Register::Address<0x1c0200fc,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Match0{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020100,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Match1{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020104,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match2{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020108,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match3{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c02010c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match4{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020110,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match5{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020114,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match6{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020118,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Match7{    ///<SCT match value register of match channels 0 to 7; REGMOD0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c02011c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> matchnL{}; 
        ///When UNIFY = 0, read or write the 16-bit value to be  compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> matchnH{}; 
    }
    namespace Sct2Cap0{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020100,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Cap1{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020104,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap2{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020108,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap3{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c02010c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap4{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020110,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap5{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020114,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap6{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020118,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Cap7{    ///<SCT capture register of capture channel 0 to 7; REGMOD0 to REGMODE7 = 1
        using Addr = Register::Address<0x1c02011c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capnL{}; 
        ///When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured.
    ...
    namespace Sct2Matchrel0{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020200,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Matchrel1{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020204,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel2{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020208,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel3{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c02020c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel4{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020210,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel5{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020214,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel6{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c020218,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Matchrel7{    ///<SCT match reload value register 0 to 7; REGMOD0 = 0 to REGMODE7 = 0
        using Addr = Register::Address<0x1c02021c,0x00000000,0x00000000,unsigned>;
        ///When UNIFY = 0, read or write the 16-bit value to be loaded into the SCTMATCHn_L register. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reloadnL{}; 
        ///When UNIFY = 0, read or write the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be loaded into the MATCHn register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reloadnH{}; 
    }
    namespace Sct2Capctrl0{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020200,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Capctrl1{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020204,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl2{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020208,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl3{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c02020c,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl4{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020210,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl5{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020214,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl6{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c020218,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Capctrl7{    ///<SCT capture control register 0 to 7; REGMOD0 = 1 to REGMODE7 = 1
        using Addr = Register::Address<0x1c02021c,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or the CAPn (UNIFY = 1) register to be loaded (event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
        ///Reserved.
    ...
    namespace Sct2Ev0State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020300,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Ev1State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020308,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev2State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020310,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev3State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020318,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev4State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020320,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev5State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020328,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev6State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020330,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev7State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020338,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev8State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020340,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev9State{    ///<SCT event state register 0
        using Addr = Register::Address<0x1c020348,0x00000000,0x00000000,unsigned>;
        ///If bit m is one, event n (n= 0 to 9) happens in state m of the counter selected by the HEVENT bit (m = state number; state 0 = bit 0, state 1= bit 1,..., state 9 = bit 9).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Ev0Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c020304,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Ev1Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c02030c,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev2Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c020314,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev3Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c02031c,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev4Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c020324,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev5Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c02032c,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev6Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c020334,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev7Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c02033c,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev8Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c020344,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Ev9Ctrl{    ///<SCT event control register 0
        using Addr = Register::Address<0x1c02034c,0x00000000,0x00000000,unsigned>;
        ///Selects the Match register associated with this event (if any). A  match can occur only when the counter selected by the HEVENT  bit is running.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> matchsel{}; 
        ///Select L/H counter. Do not set this bit if UNIFY = 1.
        enum class HeventVal {
    ...
    namespace Sct2Out0Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020500,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Out1Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020508,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> set{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out2Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020510,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> set{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out3Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020518,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> set{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out4Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020520,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> set{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out5Set{    ///<SCT output 0 set register
        using Addr = Register::Address<0x1c020528,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to set output n (or clear it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> set{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out0Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c020504,0x00000000,0x00000000,unsigned>;
    ...
    namespace Sct2Out1Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c02050c,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> clr{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out2Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c020514,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> clr{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out3Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c02051c,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> clr{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out4Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c020524,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> clr{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Sct2Out5Clr{    ///<SCT output 0 clear register
        using Addr = Register::Address<0x1c02052c,0x00000000,0x00000000,unsigned>;
        ///A 1 in bit m selects event m to clear output n (or set it if SETCLRn = 0x1 or 0x2) event 0 = bit 0, event 1 = bit 1,..., event 9 = bit 9.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> clr{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,10),Register::ReadWriteAccess,unsigned> reserved{}; 
