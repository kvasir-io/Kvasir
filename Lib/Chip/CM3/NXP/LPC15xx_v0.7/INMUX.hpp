...
//Input multiplexing (INMUX) 
    namespace Nonesct0Inmux0{    ///<Pinmux register for SCT0 input 0
        ...
        namespace InpnValC{
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio02> pio02{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio03> pio03{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio017> pio017{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio030> pio030{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio16> pio16{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio17> pio17{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio112> pio112{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::pio113> pio113{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sct1Out4> sct1Out4{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sct2Out4> sct2Out4{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sct2Out5> sct2Out5{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::adc0ThcmpIrq> adc0ThcmpIrq{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::adc1ThcmpIrq> adc1ThcmpIrq{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::acmp0Out> acmp0Out{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::acmp1Out> acmp1Out{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::acmp2Out> acmp2Out{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::acmp3Out> acmp3Out{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sctipuAbort> sctipuAbort{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sctipuSample0> sctipuSample0{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sctipuSample1> sctipuSample1{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sctipuSample2> sctipuSample2{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::sctipuSample3> sctipuSample3{};
            constexpr Register::FieldValue<decltype(inpN),InpnVal::debugHalted> debugHalted{};
        }
    }
