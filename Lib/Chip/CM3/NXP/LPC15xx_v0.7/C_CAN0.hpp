...
//Controller Area Network C_CAN0 
    namespace Nonecntl{    ///<CAN control
        ...
        namespace initValC{
            ...
            constexpr MPL::Value<initVal,initVal::started> started{};
        }
        ...
        namespace cceValC{
            constexpr MPL::Value<cceVal,cceVal::noWriteAccess> noWriteAccess{};
            constexpr MPL::Value<cceVal,cceVal::writeAccess> writeAccess{};
        }
    ...
    namespace Noneec{    ///<Error counter
        ...
        namespace rpValC{
            constexpr MPL::Value<rpVal,rpVal::belowErrorLevel> belowErrorLevel{};
            constexpr MPL::Value<rpVal,rpVal::atErrorLevel> atErrorLevel{};
        }
