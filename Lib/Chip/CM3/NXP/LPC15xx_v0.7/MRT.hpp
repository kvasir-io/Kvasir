...
//Multi-Rate Timer (MRT) 
    namespace MrtIdleCh{    ///<Idle channel register. This register returns the number of the first idle channel.
        using Addr = Register::Address<0x400a00f4,0x00000000,0x00000000,unsigned>;
        ///Reserved.
    ...
    namespace MrtIrqFlag{    ///<Global interrupt flag register
        using Addr = Register::Address<0x400a00f8,0x00000000,0x00000000,unsigned>;
        ...
        namespace Gflag1ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag1)::Type,Gflag1Val::pendingInterrupt> pendingInterrupt{};
        }
        ...
        namespace Gflag2ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag2)::Type,Gflag2Val::pendingInterrupt> pendingInterrupt{};
        }
        ...
        namespace Gflag3ValC{
            ...
            constexpr Register::FieldValue<decltype(gflag3)::Type,Gflag3Val::pendingInterrupt> pendingInterrupt{};
        }
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,4),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace MrtIntval0{    ///<MRT0 Time interval value register. This value is loaded into the TIMER0 register.
    ...
    namespace MrtIntval1{    ///<MRT0 Time interval value register. This value is loaded into the TIMER0 register.
    ...
    namespace MrtIntval2{    ///<MRT0 Time interval value register. This value is loaded into the TIMER0 register.
    ...
    namespace MrtIntval3{    ///<MRT0 Time interval value register. This value is loaded into the TIMER0 register.
    ...
    namespace MrtTimer0{    ///<MRT0 Timer register. This register reads the value of the down-counter.
    ...
    namespace MrtTimer1{    ///<MRT0 Timer register. This register reads the value of the down-counter.
    ...
    namespace MrtTimer2{    ///<MRT0 Timer register. This register reads the value of the down-counter.
    ...
    namespace MrtTimer3{    ///<MRT0 Timer register. This register reads the value of the down-counter.
    ...
    namespace MrtCtrl0{    ///<MRT0 Control register. This register controls the MRT0 modes.
    ...
    namespace MrtCtrl1{    ///<MRT0 Control register. This register controls the MRT0 modes.
    ...
    namespace MrtCtrl2{    ///<MRT0 Control register. This register controls the MRT0 modes.
    ...
    namespace MrtCtrl3{    ///<MRT0 Control register. This register controls the MRT0 modes.
    ...
    namespace MrtStat0{    ///<MRT0 Status register.
    ...
    namespace MrtStat1{    ///<MRT0 Status register.
    ...
    namespace MrtStat2{    ///<MRT0 Status register.
    ...
    namespace MrtStat3{    ///<MRT0 Status register.
