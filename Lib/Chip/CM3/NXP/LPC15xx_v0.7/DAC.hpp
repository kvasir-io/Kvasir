...
//12-bit DAC Modification  
    namespace Noneval{    ///<D/A Converter Value Register. This register contains the digital value to be converted to analog.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,4),Register::ReadWriteAccess,unsigned> value{}; 
    }
    namespace Nonectrl{    ///<DAC Control register. This register contains bits to configure DAC operation and the interrupt/dma request flag.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> intDmaFlag{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,1),Register::ReadWriteAccess,unsigned> trigSrc{}; 
        ...
        namespace polarityValC{
            constexpr MPL::Value<polarityVal,polarityVal::rising> rising{};
            constexpr MPL::Value<polarityVal,polarityVal::falling> falling{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,polarityVal> polarity{}; 
        ...
        namespace syncBypassValC{
            constexpr MPL::Value<syncBypassVal,syncBypassVal::synchronize> synchronize{};
            constexpr MPL::Value<syncBypassVal,syncBypassVal::notSynchronize> notSynchronize{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,syncBypassVal> syncBypass{}; 
        ///Timer Enable
        ...
        namespace timerEnaValC{
            constexpr MPL::Value<timerEnaVal,timerEnaVal::disabled> disabled{};
            constexpr MPL::Value<timerEnaVal,timerEnaVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,timerEnaVal> timerEna{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,dblbufEnaVal> dblbufEna{}; 
        ///Shutoff Enable
        ...
        namespace shutoffEnaValC{
            constexpr MPL::Value<shutoffEnaVal,shutoffEnaVal::disabled> disabled{};
            constexpr MPL::Value<shutoffEnaVal,shutoffEnaVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,shutoffEnaVal> shutoffEna{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> shutoffFlag{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,10),Register::ReadWriteAccess,unsigned> bias{}; 
    }
    namespace Nonecntval{    ///<DAC Counter Value register. This register contains the reload value for the internal DAC DMA/Interrupt timer.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cntval{}; 
    }
}
