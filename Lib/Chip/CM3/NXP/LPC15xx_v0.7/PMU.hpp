...
//Power Management Unit (PMU)
    namespace Nonepcon{    ///<Power control register
        ...
        namespace SleepflagValC{
            ...
            constexpr Register::FieldValue<decltype(sleepflag),SleepflagVal::sleepDeepSleep> sleepDeepSleep{};
        }
    ...
    namespace Nonedpdctrl{    ///<Deep power-down control register
        ...
        namespace WakeuphysValC{
            constexpr Register::FieldValue<decltype(wakeuphys),WakeuphysVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(wakeuphys),WakeuphysVal::enabled> enabled{};
        }
        ...
        namespace WakepaddisableValC{
            constexpr Register::FieldValue<decltype(wakepadDisable),WakepaddisableVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(wakepadDisable),WakepaddisableVal::disabled> disabled{};
        }
