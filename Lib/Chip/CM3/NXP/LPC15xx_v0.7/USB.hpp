...
//USB device controller
    namespace Nonedevcmdstat{    ///<USB Device Command/Status register
        ...
        namespace PllonValC{
            constexpr Register::FieldValue<decltype(pllOn),PllonVal::usbNeedclkFunction> usbNeedclkFunction{};
            constexpr Register::FieldValue<decltype(pllOn),PllonVal::usbNeedclkAlways1> usbNeedclkAlways1{};
        }
        ///LPM Support.
        ...
        namespace LpmsupValC{
            constexpr Register::FieldValue<decltype(lpmSup),LpmsupVal::lpmNotSupported> lpmNotSupported{};
            constexpr Register::FieldValue<decltype(lpmSup),LpmsupVal::lpmSupported> lpmSupported{};
        }
        ...
        namespace IntonnakaoValC{
            constexpr Register::FieldValue<decltype(intonnakAo),IntonnakaoVal::onlyAcknowledgedPa> onlyAcknowledgedPa{};
            constexpr Register::FieldValue<decltype(intonnakAo),IntonnakaoVal::bothAcknowledgedAn> bothAcknowledgedAn{};
        }
        ...
        namespace IntonnakaiValC{
            constexpr Register::FieldValue<decltype(intonnakAi),IntonnakaiVal::onlyAcknowledgedPa> onlyAcknowledgedPa{};
            constexpr Register::FieldValue<decltype(intonnakAi),IntonnakaiVal::bothAcknowledgedAn> bothAcknowledgedAn{};
        }
        ...
        namespace IntonnakcoValC{
            constexpr Register::FieldValue<decltype(intonnakCo),IntonnakcoVal::onlyAcknowledgedPa> onlyAcknowledgedPa{};
            constexpr Register::FieldValue<decltype(intonnakCo),IntonnakcoVal::bothAcknowledgedAn> bothAcknowledgedAn{};
        }
        ...
        namespace IntonnakciValC{
            constexpr Register::FieldValue<decltype(intonnakCi),IntonnakciVal::onlyAcknowledgedPa> onlyAcknowledgedPa{};
            constexpr Register::FieldValue<decltype(intonnakCi),IntonnakciVal::bothAcknowledgedAn> bothAcknowledgedAn{};
        }
    ...
    namespace Noneinfo{    ///<USB Info register
        ...
        namespace ErrcodeValC{
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::noError> noError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::pidEncodingError> pidEncodingError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::pidUnknown> pidUnknown{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::packetUnexpected> packetUnexpected{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::tokenCrcError> tokenCrcError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::dataCrcError> dataCrcError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::timeOut> timeOut{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::babble> babble{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::truncatedEop> truncatedEop{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::sentReceivedNak> sentReceivedNak{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::sentStall> sentStall{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::overrun> overrun{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::sentEmptyPacket> sentEmptyPacket{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::bitstuffError> bitstuffError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::syncError> syncError{};
            constexpr Register::FieldValue<decltype(errCode),ErrcodeVal::wrongDataToggle> wrongDataToggle{};
        }
    }
