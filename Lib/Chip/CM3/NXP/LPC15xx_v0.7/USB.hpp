...
namespace Kvasir {
    namespace Nonedevcmdstat{
        using Addr = Register::Address<0x1c00c000,0xe8e40400>;
    ...
    namespace Noneinfo{
        using Addr = Register::Address<0x1c00c004,0xffff8000>;
    ...
    namespace Noneinten{
        using Addr = Register::Address<0x1c00c024,0x3ffffc00>;
    ...
    namespace Noneintsetstat{
        using Addr = Register::Address<0x1c00c028,0x3ffffc00>;
    ...
    namespace Noneintrouting{
        using Addr = Register::Address<0x1c00c02c,0x3ffffc00>;
    ...
    namespace Noneeptoggle{
        using Addr = Register::Address<0x1c00c034,0xfffffc00>;
