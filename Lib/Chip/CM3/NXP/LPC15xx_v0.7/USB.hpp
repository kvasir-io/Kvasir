...
//USB device controller
    namespace UsbDevcmdstat{    ///<USB Device Command/Status register
        using Addr = Register::Address<0x1c00c000,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbInfo{    ///<USB Info register
        using Addr = Register::Address<0x1c00c004,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbEpliststart{    ///<USB EP Command/Status List start address
        using Addr = Register::Address<0x1c00c008,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace UsbDatabufstart{    ///<USB Data buffer start address
        using Addr = Register::Address<0x1c00c00c,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace UsbLpm{    ///<Link Power Management register
        using Addr = Register::Address<0x1c00c010,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbEpskip{    ///<USB Endpoint skip
        using Addr = Register::Address<0x1c00c014,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbEpinuse{    ///<USB Endpoint Buffer in use
        using Addr = Register::Address<0x1c00c018,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbEpbufcfg{    ///<USB Endpoint Buffer Configuration register
        using Addr = Register::Address<0x1c00c01c,0x00000000,0x00000000,unsigned>;
        ///Reserved. Fixed to zero because the control endpoint zero is fixed to single-buffering for each physical endpoint.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace UsbIntstat{    ///<USB interrupt status register
        using Addr = Register::Address<0x1c00c020,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbInten{    ///<USB interrupt enable register
        using Addr = Register::Address<0x1c00c024,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbIntsetstat{    ///<USB set interrupt status register
        using Addr = Register::Address<0x1c00c028,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbIntrouting{    ///<USB interrupt routing register
        using Addr = Register::Address<0x1c00c02c,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbEptoggle{    ///<USB Endpoint toggle register
        using Addr = Register::Address<0x1c00c034,0x00000000,0x00000000,unsigned>;
