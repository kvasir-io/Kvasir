...
//12-bit ADC controller ADC0/1 
    namespace Nonectrl{    ///<A/D Control Register. Contains the clock divide value, enable bits for each sequence and the A/D power-down bit.
        ...
        namespace Mode10bitValC{
            constexpr Register::FieldValue<decltype(mode10bit),Mode10bitVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(mode10bit),Mode10bitVal::enabled> enabled{};
        }
    ...
    namespace Noneinsel{    ///<A/D Input Select Register: Selects between external pin and internal source for various channels
        ...
        namespace Ad0selValC{
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::adcn0Pin> adcn0Pin{};
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::coreVoltageRegulat> coreVoltageRegulat{};
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::internalVoltageRef> internalVoltageRef{};
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::temperatureSensor> temperatureSensor{};
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::vddadiv2> vddadiv2{};
            constexpr Register::FieldValue<decltype(ad0sel),Ad0selVal::noConnectionOrLoa> noConnectionOrLoa{};
        }
    }
