...
//Windowed Watchdog Timer (WWDT) 
    namespace Nonemod{    ///<Watchdog mode register. This register determines the basic mode and status of the Watchdog Timer.
        ...
        namespace WdprotectValC{
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::change> change{};
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::changeWCnt> changeWCnt{};
        }
    }
