...
// CAN controller acceptance filter 
    namespace Noneafmr{    ///<Acceptance Filter Register
        ...
        namespace EfcanValC{
            constexpr Register::FieldValue<decltype(efcan),EfcanVal::softwareMustReadA> softwareMustReadA{};
            constexpr Register::FieldValue<decltype(efcan),EfcanVal::theAcceptanceFilte> theAcceptanceFilte{};
        }
    }
