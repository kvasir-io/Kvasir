...
// CAN controller acceptance filter 
    namespace Noneafmr{    ///<Acceptance Filter Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> accoff{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> accbp{}; 
        ///FullCAN mode
        enum class efcanVal {
        ...
        namespace efcanValC{
            constexpr MPL::Value<efcanVal,efcanVal::softwareMustReadA> softwareMustReadA{};
            constexpr MPL::Value<efcanVal,efcanVal::theAcceptanceFilte> theAcceptanceFilte{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,efcanVal> efcan{}; 
    }
    namespace NonesffSa{    ///<Standard Frame Individual Start Address Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,2),Register::ReadWriteAccess,unsigned> sffSa{}; 
    }
    namespace NonesffGrpSa{    ///<Standard Frame Group Start Address Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,2),Register::ReadWriteAccess,unsigned> sffGrpSa{}; 
    }
    namespace NoneeffSa{    ///<Extended Frame Start Address Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,2),Register::ReadWriteAccess,unsigned> effSa{}; 
    }
    namespace NoneeffGrpSa{    ///<Extended Frame Group Start Address Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,2),Register::ReadWriteAccess,unsigned> effGrpSa{}; 
    }
    namespace Noneendoftable{    ///<End of AF Tables register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,2),Register::ReadWriteAccess,unsigned> endoftable{}; 
    }
    namespace Noneluterrad{    ///<LUT Error Address register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,2),Register::ReadWriteAccess,unsigned> luterrad{}; 
    }
    namespace Noneluterr{    ///<LUT Error Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> luterr{}; 
    }
    namespace Nonefcanie{    ///<FullCAN interrupt enable register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> fcanie{}; 
    }
    namespace Nonefcanic0{    ///<FullCAN interrupt and capture register0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> intpnd{}; 
    }
    namespace Nonefcanic1{    ///<FullCAN interrupt and capture register1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> intpnd32{}; 
    }
}
