...
namespace Kvasir {
//UART0/2/3  
    namespace Uart3Rbr{    ///<Receiver Buffer Register. Contains the next received character to be read (DLAB =0).
    ...
    namespace Uart3Thr{    ///<Transmit Holding Regiter. The next character to be transmitted is written here (DLAB =0).
        using Addr = Register::Address<0x4009c000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart3Dll{    ///<Divisor Latch LSB. Least significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB =1).
        using Addr = Register::Address<0x4009c000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart3Dlm{    ///<Divisor Latch MSB. Most significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB =1).
    ...
    namespace Uart3Ier{    ///<Interrupt Enable Register. Contains individual interrupt enable bits for the 7 potential UART interrupts (DLAB =0).
        using Addr = Register::Address<0x4009c004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart3Iir{    ///<Interrupt ID Register. Identifies which interrupt(s) are pending.
    ...
    namespace Uart3Fcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        using Addr = Register::Address<0x4009c008,0x00000000,0x00000000,unsigned>;
        ///FIFO Enable.
    ...
    namespace Uart3Lcr{    ///<Line Control Register. Contains controls for frame formatting and break generation.
    ...
    namespace Uart3Lsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
    ...
    namespace Uart3Scr{    ///<Scratch Pad Register. 8-bit temporary storage for software.
        using Addr = Register::Address<0x4009c01c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart3Acr{    ///<Auto-baud Control Register. Contains controls for the auto-baud feature.
    ...
    namespace Uart3Fdr{    ///<Fractional Divider Register. Generates a clock input for the baud rate divider.
    ...
    namespace Uart3Ter{    ///<Transmit Enable Register. Turns off UART transmitter for use with software flow control.
        using Addr = Register::Address<0x4009c030,0x00000000,0x00000000,unsigned>;
        ///Reserved. Read value is undefined, only zero should be written.
    ...
    namespace Uart3Rs485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
    ...
    namespace Uart3Rs485adrmatch{    ///<RS-485/EIA-485 address match. Contains the address match value for RS-485/EIA-485 mode.
    ...
    namespace Uart3Rs485dly{    ///<RS-485/EIA-485 direction control delay.
