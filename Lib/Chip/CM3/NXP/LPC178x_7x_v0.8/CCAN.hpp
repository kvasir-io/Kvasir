...
//Central CAN controller 
    namespace CcanTxsr{    ///<CAN Central Transmit Status Register
    ...
    namespace CcanRxsr{    ///<CAN Central Receive Status Register
    ...
    namespace CcanMsr{    ///<CAN Central Miscellaneous Register
