...
//Ethernet MAC 10/100
    namespace EmacNcr{    ///<Network Control Register
        using Addr = Register::Address<0x400b0000,0xfffff800,0,unsigned>;
        ///LoopBack
    ...
    namespace EmacNcfgr{    ///<Network Configuration Register
        using Addr = Register::Address<0x400b0004,0xfff00204,0,unsigned>;
        ///Speed
    ...
    namespace EmacNsr{    ///<Network Status Register
        using Addr = Register::Address<0x400b0008,0xfffffff9,0,unsigned>;
        ///None
    ...
    namespace EmacTsr{    ///<Transmit Status Register
        using Addr = Register::Address<0x400b0014,0xffffff80,0,unsigned>;
        ///Used Bit Read
    ...
    namespace EmacRbqp{    ///<Receive Buffer Queue Pointer Register
        using Addr = Register::Address<0x400b0018,0x00000003,0,unsigned>;
    ...
    namespace EmacTbqp{    ///<Transmit Buffer Queue Pointer Register
        using Addr = Register::Address<0x400b001c,0x00000003,0,unsigned>;
        ///Transmit buffer queue pointer address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,2),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacRsr{    ///<Receive Status Register
        using Addr = Register::Address<0x400b0020,0xfffffff8,0,unsigned>;
    ...
    namespace EmacIsr{    ///<Interrupt Status Register
        using Addr = Register::Address<0x400b0024,0xffffc300,0,unsigned>;
    ...
    namespace EmacIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x400b0028,0xffffc300,0,unsigned>;
    ...
    namespace EmacIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x400b002c,0xffffc300,0,unsigned>;
        ///Management Frame sent
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mfd{}; 
        ///Receive Complete
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rcomp{}; 
    ...
    namespace EmacImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x400b0030,0xffffc300,0,unsigned>;
        ///Management Frame sent
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mfd{}; 
        ///Receive Complete
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rcomp{}; 
    ...
    namespace EmacMan{    ///<Phy Maintenance Register
        using Addr = Register::Address<0x400b0034,0x00000000,0,unsigned>;
        ///None
    ...
    namespace EmacPtr{    ///<Pause Time Register
        using Addr = Register::Address<0x400b0038,0xffff0000,0,unsigned>;
        ///Pause Time
    ...
    namespace EmacPfr{    ///<Pause Frames Received Register
        using Addr = Register::Address<0x400b003c,0xffff0000,0,unsigned>;
    ...
    namespace EmacFto{    ///<Frames Transmitted Ok Register
        using Addr = Register::Address<0x400b0040,0xff000000,0,unsigned>;
    ...
    namespace EmacScf{    ///<Single Collision Frames Register
        using Addr = Register::Address<0x400b0044,0xffff0000,0,unsigned>;
    ...
    namespace EmacMcf{    ///<Multiple Collision Frames Register
        using Addr = Register::Address<0x400b0048,0xffff0000,0,unsigned>;
    ...
    namespace EmacFro{    ///<Frames Received Ok Register
        using Addr = Register::Address<0x400b004c,0xff000000,0,unsigned>;
        ///Frames Received OK
    ...
    namespace EmacFcse{    ///<Frame Check Sequence Errors Register
        using Addr = Register::Address<0x400b0050,0xffffff00,0,unsigned>;
    ...
    namespace EmacAle{    ///<Alignment Errors Register
        using Addr = Register::Address<0x400b0054,0xffffff00,0,unsigned>;
        ///Alignment Errors
    ...
    namespace EmacDtf{    ///<Deferred Transmission Frames Register
        using Addr = Register::Address<0x400b0058,0xffff0000,0,unsigned>;
    ...
    namespace EmacLcol{    ///<Late Collisions Register
        using Addr = Register::Address<0x400b005c,0xffffff00,0,unsigned>;
        ///Late Collisions
    ...
    namespace EmacEcol{    ///<Excessive Collisions Register
        using Addr = Register::Address<0x400b0060,0xffffff00,0,unsigned>;
    ...
    namespace EmacTund{    ///<Transmit Underrun Errors Register
        using Addr = Register::Address<0x400b0064,0xffffff00,0,unsigned>;
        ///Transmit Underruns
    ...
    namespace EmacCse{    ///<Carrier Sense Errors Register
        using Addr = Register::Address<0x400b0068,0xffffff00,0,unsigned>;
    ...
    namespace EmacRre{    ///<Receive Resource Errors Register
        using Addr = Register::Address<0x400b006c,0xffff0000,0,unsigned>;
    ...
    namespace EmacRov{    ///<Receive Overrun Errors Register
        using Addr = Register::Address<0x400b0070,0xffffff00,0,unsigned>;
        ///Receive Overrun
    ...
    namespace EmacRse{    ///<Receive Symbol Errors Register
        using Addr = Register::Address<0x400b0074,0xffffff00,0,unsigned>;
    ...
    namespace EmacEle{    ///<Excessive Length Errors Register
        using Addr = Register::Address<0x400b0078,0xffffff00,0,unsigned>;
    ...
    namespace EmacRja{    ///<Receive Jabbers Register
        using Addr = Register::Address<0x400b007c,0xffffff00,0,unsigned>;
        ///Receive Jabbers
    ...
    namespace EmacUsf{    ///<Undersize Frames Register
        using Addr = Register::Address<0x400b0080,0xffffff00,0,unsigned>;
        ///Undersize frames
    ...
    namespace EmacSte{    ///<SQE Test Errors Register
        using Addr = Register::Address<0x400b0084,0xffffff00,0,unsigned>;
        ///SQE test errors
    ...
    namespace EmacRle{    ///<Received Length Field Mismatch Register
        using Addr = Register::Address<0x400b0088,0xffffff00,0,unsigned>;
    ...
    namespace EmacHrt{    ///<Hash Register Top [63:32] Register
        using Addr = Register::Address<0x400b0094,0x00000000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa1b{    ///<Specific Address 1 Bottom Register
        using Addr = Register::Address<0x400b0098,0x00000000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa1t{    ///<Specific Address 1 Top Register
        using Addr = Register::Address<0x400b009c,0xffff0000,0,unsigned>;
        ///None
    ...
    namespace EmacSa2b{    ///<Specific Address 2 Bottom Register
        using Addr = Register::Address<0x400b00a0,0x00000000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa2t{    ///<Specific Address 2 Top Register
        using Addr = Register::Address<0x400b00a4,0xffff0000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa3b{    ///<Specific Address 3 Bottom Register
        using Addr = Register::Address<0x400b00a8,0x00000000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa3t{    ///<Specific Address 3 Top Register
        using Addr = Register::Address<0x400b00ac,0xffff0000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa4b{    ///<Specific Address 4 Bottom Register
        using Addr = Register::Address<0x400b00b0,0x00000000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa4t{    ///<Specific Address 4 Top Register
        using Addr = Register::Address<0x400b00b4,0xffff0000,0,unsigned>;
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacTid{    ///<Type ID Checking Register
        using Addr = Register::Address<0x400b00b8,0xffff0000,0,unsigned>;
        ///Type ID checking
    ...
    namespace EmacUsrio{    ///<User Input/Output Register
        using Addr = Register::Address<0x400b00c0,0xfffffffc,0,unsigned>;
        ///Reduce MII
