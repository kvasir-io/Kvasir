...
//AHB Bus Matrix
    ...
    namespace NonematrixMrcr{    ///<Master Remap Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> rcb4{}; 
        ///Remap Command Bit for AHB Master 5
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> rcb5{}; 
    }
