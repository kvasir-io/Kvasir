...
namespace Kvasir {
    namespace RTT_mr{
        using Addr = Register::Address<0x400e1230,0xfff80000>;
    ...
    namespace RTT_ar{
        using Addr = Register::Address<0x400e1234,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> ALMV; 
    }
    namespace RTT_vr{
        using Addr = Register::Address<0x400e1238,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> CRTV; 
    }
    namespace RTT_sr{
        using Addr = Register::Address<0x400e123c,0xfffffffc>;
