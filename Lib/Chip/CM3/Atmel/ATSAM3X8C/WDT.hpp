...
//Watchdog Timer
    namespace WdtCr{    ///<Control Register
        using Addr = Register::Address<0x400e1a50,0x00fffffe,0,unsigned>;
        ///Watchdog Restart
    ...
    namespace WdtMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1a54,0xc0000000,0,unsigned>;
    ...
    namespace WdtSr{    ///<Status Register
        using Addr = Register::Address<0x400e1a58,0xfffffffc,0,unsigned>;
        ///Watchdog Underflow
