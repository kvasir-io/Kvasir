...
//High Speed MultiMedia Card Interface
    ...
    namespace HsmciSr{    ///<Status Register
        ...
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> sdioirqforslota{}; 
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> sdioirqforslotb{}; 
    ...
    namespace HsmciDma{    ///<DMA Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,chksizeVal> chksize{}; 
