...
//Synchronous Serial Controller
    ...
    namespace SscSr{    ///<Status Register
        using Addr = Register::Address<0x40004040,0xfffcf0cc,0x00000000,unsigned>;
        ///Transmit Ready
    ...
    namespace SscIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40004044,0xfffff0cc,0x00000000,unsigned>;
    ...
    namespace SscIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40004048,0xfffff0cc,0x00000000,unsigned>;
    ...
    namespace SscImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4000404c,0xfffff0cc,0x00000000,unsigned>;
