...
//Supply Controller
    namespace SupcCr{    ///<Supply Controller Control Register
        using Addr = Register::Address<0x400e1a10,0x00fffff3,0,unsigned>;
    ...
    namespace SupcMr{    ///<Supply Controller Mode Register
        using Addr = Register::Address<0x400e1a18,0x00ef8fff,0,unsigned>;
    ...
    namespace SupcWuir{    ///<Supply Controller Wake Up Inputs Register
        using Addr = Register::Address<0x400e1a20,0x00000000,0,unsigned>;
    ...
    namespace SupcSr{    ///<Supply Controller Status Register
        using Addr = Register::Address<0x400e1a24,0x0000ef00,0,unsigned>;
        ///FWUP Wake Up Status
        enum class FwupsVal {
