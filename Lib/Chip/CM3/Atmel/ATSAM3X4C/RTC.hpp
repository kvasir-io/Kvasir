...
namespace Kvasir {
    namespace RTC_cr{
        using Addr = Register::Address<0x400e1a60,0xfffcfcfc>;
    ...
    namespace RTC_mr{
        using Addr = Register::Address<0x400e1a64,0xfffffffe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> HRMOD; 
    }
    namespace RTC_timr{
        using Addr = Register::Address<0x400e1a68,0xff808080>;
    ...
    namespace RTC_calr{
        using Addr = Register::Address<0x400e1a6c,0xc0000080>;
    ...
    namespace RTC_timalr{
        using Addr = Register::Address<0x400e1a70,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0)> SEC; 
    ...
    namespace RTC_calalr{
        using Addr = Register::Address<0x400e1a74,0x4060ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16)> MONTH; 
    ...
    namespace RTC_sr{
        using Addr = Register::Address<0x400e1a78,0xffffffe0>;
    ...
    namespace RTC_sccr{
        using Addr = Register::Address<0x400e1a7c,0xffffffe0>;
    ...
    namespace RTC_ier{
        using Addr = Register::Address<0x400e1a80,0xffffffe0>;
    ...
    namespace RTC_idr{
        using Addr = Register::Address<0x400e1a84,0xffffffe0>;
    ...
    namespace RTC_imr{
        using Addr = Register::Address<0x400e1a88,0xffffffe0>;
    ...
    namespace RTC_ver{
        using Addr = Register::Address<0x400e1a8c,0xfffffff0>;
    ...
    namespace RTC_wpmr{
        using Addr = Register::Address<0x400e1b44,0x000000fe>;
