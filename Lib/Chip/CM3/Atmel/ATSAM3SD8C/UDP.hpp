...
//USB Device Port
    ...
    namespace UdpIer{    ///<Interrupt Enable Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> ep6int{}; 
        namespace Ep6intValC{
        }
        ///Enable Endpoint 7 Interrupt
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> ep7int{}; 
        namespace Ep7intValC{
        }
