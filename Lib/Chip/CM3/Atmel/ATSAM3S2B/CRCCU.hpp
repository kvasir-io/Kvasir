...
//Cyclic Redundancy Check Calculation Unit
    namespace CrccuDscr{    ///<CRCCU Descriptor Base Register
        using Addr = Register::Address<0x40044000,0x000001ff,0x00000000,unsigned>;
    ...
    namespace CrccuDmaEn{    ///<CRCCU DMA Enable Register
        using Addr = Register::Address<0x40044008,0xfffffffe,0x00000000,unsigned>;
        ///DMA Enable Register
    ...
    namespace CrccuDmaDis{    ///<CRCCU DMA Disable Register
        using Addr = Register::Address<0x4004400c,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuDmaSr{    ///<CRCCU DMA Status Register
        using Addr = Register::Address<0x40044010,0xfffffffe,0x00000000,unsigned>;
        ///DMA Status Register
    ...
    namespace CrccuDmaIer{    ///<CRCCU DMA Interrupt Enable Register
        using Addr = Register::Address<0x40044014,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuDmaIdr{    ///<CRCCU DMA Interrupt Disable Register
        using Addr = Register::Address<0x40044018,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuDmaImr{    ///<CRCCU DMA Interrupt Mask Register
        using Addr = Register::Address<0x4004401c,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuDmaIsr{    ///<CRCCU DMA Interrupt Status Register
        using Addr = Register::Address<0x40044020,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuCr{    ///<CRCCU Control Register
        using Addr = Register::Address<0x40044034,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuMr{    ///<CRCCU Mode Register
        using Addr = Register::Address<0x40044038,0xffffff00,0x00000000,unsigned>;
        ///CRC Enable
    ...
    namespace CrccuIer{    ///<CRCCU Interrupt Enable Register
        using Addr = Register::Address<0x40044040,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuIdr{    ///<CRCCU Interrupt Disable Register
        using Addr = Register::Address<0x40044044,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuImr{    ///<CRCCU Interrupt Mask Register
        using Addr = Register::Address<0x40044048,0xfffffffe,0x00000000,unsigned>;
    ...
    namespace CrccuIsr{    ///<CRCCU Interrupt Status Register
        using Addr = Register::Address<0x4004404c,0xfffffffe,0x00000000,unsigned>;
