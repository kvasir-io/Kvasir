...
namespace Kvasir {
    namespace SUPC_cr{
        using Addr = Register::Address<0x400e1a10,0x00fffff3>;
    ...
    namespace SUPC_smmr{
        using Addr = Register::Address<0x400e1a14,0xffffc8f0>;
    ...
    namespace SUPC_mr{
        using Addr = Register::Address<0x400e1a18,0x00ef8fff>;
    ...
    namespace SUPC_wumr{
        using Addr = Register::Address<0x400e1a1c,0xffff88f0>;
    ...
    namespace SUPC_wuir{
        using Addr = Register::Address<0x400e1a20,0x00000000>;
    ...
    namespace SUPC_sr{
        using Addr = Register::Address<0x400e1a24,0x0000ef00>;
