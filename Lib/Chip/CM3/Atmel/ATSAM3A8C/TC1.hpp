...
//Timer Counter 1
    namespace Tc1Ccr0{    ///<Channel Control Register (channel = 0)
        using Addr = Register::Address<0x40084000,0xfffffff8,0,unsigned>;
    ...
    namespace Tc1Cmr0{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0x40084004,0xfff03800,0,unsigned>;
        ///Clock Selection
    ...
    namespace Tc1Cmr0WaveEq1{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0x40084004,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class TcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr0{    ///<Stepper Motor Mode Register (channel = 0)
        using Addr = Register::Address<0x40084008,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
    ...
    namespace Tc1Ra0{    ///<Register A (channel = 0)
        using Addr = Register::Address<0x40084014,0x00000000,0,unsigned>;
        ///Register A
    ...
    namespace Tc1Sr0{    ///<Status Register (channel = 0)
        using Addr = Register::Address<0x40084020,0xfff8ff00,0,unsigned>;
    ...
    namespace Tc1Ier0{    ///<Interrupt Enable Register (channel = 0)
        using Addr = Register::Address<0x40084024,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr0{    ///<Interrupt Disable Register (channel = 0)
        using Addr = Register::Address<0x40084028,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ccr1{    ///<Channel Control Register (channel = 1)
        using Addr = Register::Address<0x40084040,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc1Cmr1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0x40084044,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class TcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Cmr1WaveEq1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0x40084044,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class TcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr1{    ///<Stepper Motor Mode Register (channel = 1)
        using Addr = Register::Address<0x40084048,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc1Cv1{    ///<Counter Value (channel = 1)
        using Addr = Register::Address<0x40084050,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc1Ra1{    ///<Register A (channel = 1)
        using Addr = Register::Address<0x40084054,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc1Rb1{    ///<Register B (channel = 1)
        using Addr = Register::Address<0x40084058,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc1Rc1{    ///<Register C (channel = 1)
        using Addr = Register::Address<0x4008405c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc1Sr1{    ///<Status Register (channel = 1)
        using Addr = Register::Address<0x40084060,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ier1{    ///<Interrupt Enable Register (channel = 1)
        using Addr = Register::Address<0x40084064,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr1{    ///<Interrupt Disable Register (channel = 1)
        using Addr = Register::Address<0x40084068,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Imr1{    ///<Interrupt Mask Register (channel = 1)
        using Addr = Register::Address<0x4008406c,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ccr2{    ///<Channel Control Register (channel = 2)
        using Addr = Register::Address<0x40084080,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc1Cmr2{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0x40084084,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class TcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Cmr2WaveEq1{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0x40084084,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class TcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr2{    ///<Stepper Motor Mode Register (channel = 2)
        using Addr = Register::Address<0x40084088,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc1Cv2{    ///<Counter Value (channel = 2)
        using Addr = Register::Address<0x40084090,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc1Ra2{    ///<Register A (channel = 2)
        using Addr = Register::Address<0x40084094,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc1Rb2{    ///<Register B (channel = 2)
        using Addr = Register::Address<0x40084098,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc1Rc2{    ///<Register C (channel = 2)
        using Addr = Register::Address<0x4008409c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc1Sr2{    ///<Status Register (channel = 2)
        using Addr = Register::Address<0x400840a0,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ier2{    ///<Interrupt Enable Register (channel = 2)
        using Addr = Register::Address<0x400840a4,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr2{    ///<Interrupt Disable Register (channel = 2)
        using Addr = Register::Address<0x400840a8,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Imr2{    ///<Interrupt Mask Register (channel = 2)
        using Addr = Register::Address<0x400840ac,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Bcr{    ///<Block Control Register
        using Addr = Register::Address<0x400840c0,0xfffffffe,0,unsigned>;
        ///Synchro Command
    ...
    namespace Tc1Bmr{    ///<Block Mode Register
        using Addr = Register::Address<0x400840c4,0xfc0400c0,0,unsigned>;
    ...
    namespace Tc1Qier{    ///<QDEC Interrupt Enable Register
        using Addr = Register::Address<0x400840c8,0xfffffff8,0,unsigned>;
        ///InDeX
    ...
    namespace Tc1Qidr{    ///<QDEC Interrupt Disable Register
        using Addr = Register::Address<0x400840cc,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc1Qimr{    ///<QDEC Interrupt Mask Register
        using Addr = Register::Address<0x400840d0,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc1Qisr{    ///<QDEC Interrupt Status Register
        using Addr = Register::Address<0x400840d4,0xfffffef8,0,unsigned>;
        ///InDeX
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc1Fmr{    ///<Fault Mode Register
        using Addr = Register::Address<0x400840d8,0xfffffffc,0,unsigned>;
    ...
    namespace Tc1Wpmr{    ///<Write Protect Mode Register
        using Addr = Register::Address<0x400840e4,0x000000fe,0,unsigned>;
