...
//Reset Controller
    namespace RstcCr{    ///<Control Register
        using Addr = Register::Address<0x400e1400,0x00fffff2,0,unsigned>;
        ///Processor Reset
    ...
    namespace RstcSr{    ///<Status Register
        using Addr = Register::Address<0x400e1404,0xfffcf8fe,0,unsigned>;
        ///User Reset Status
    ...
    namespace RstcMr{    ///<Mode Register
        using Addr = Register::Address<0x400e1408,0x00fff0ee,0,unsigned>;
        ///User Reset Enable
