...
//Serial Peripheral Interface
    ...
    namespace SpiSr{    ///<Status Register
        using Addr = Register::Address<0x40008010,0xfffef800,0,unsigned>;
    ...
    namespace SpiIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40008014,0xfffff800,0,unsigned>;
    ...
    namespace SpiIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x40008018,0xfffff800,0,unsigned>;
    ...
    namespace SpiImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x4000801c,0xfffff800,0,unsigned>;
    ...
    namespace SpiRcr{    ///<Receive Counter Register
        using Addr = Register::Address<0x40008104,0xffff0000,0,unsigned>;
    ...
    namespace SpiTpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0x40008108,0x00000000,0,unsigned>;
    ...
    namespace SpiTcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0x4000810c,0xffff0000,0,unsigned>;
        ///Transmit Counter Register
    ...
    namespace SpiRncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0x40008114,0xffff0000,0,unsigned>;
    ...
    namespace SpiTnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0x40008118,0x00000000,0,unsigned>;
    ...
    namespace SpiTncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0x4000811c,0xffff0000,0,unsigned>;
    ...
    namespace SpiPtcr{    ///<Transfer Control Register
        using Addr = Register::Address<0x40008120,0xfffffcfc,0,unsigned>;
    ...
    namespace SpiPtsr{    ///<Transfer Status Register
        using Addr = Register::Address<0x40008124,0xfffffefe,0,unsigned>;
        ///Receiver Transfer Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxten{}; 
        ///Transmitter Transfer Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> txten{}; 
