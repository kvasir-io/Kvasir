...
namespace Kvasir {
    ...
    namespace TWI0_mmr{
        using Addr = Register::Address<0x40018004,0xff80ecff>;
    ...
    namespace TWI0_smr{
        using Addr = Register::Address<0x40018008,0xff80ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,16)> SADR; 
    }
    namespace TWI0_iadr{
        using Addr = Register::Address<0x4001800c,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,0)> IADR; 
    }
    namespace TWI0_cwgr{
        using Addr = Register::Address<0x40018010,0xfff80000>;
    ...
    namespace TWI0_sr{
        using Addr = Register::Address<0x40018020,0xffff0080>;
    ...
    namespace TWI0_ier{
        using Addr = Register::Address<0x40018024,0xffff0088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI0_idr{
        using Addr = Register::Address<0x40018028,0xffff0088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI0_imr{
        using Addr = Register::Address<0x4001802c,0xffff0088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI0_ptsr{
        using Addr = Register::Address<0x40018124,0xfffffefe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXTEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> TXTEN; 
    }
}
