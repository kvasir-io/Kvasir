...
//General Purpose Input/Output
    namespace GpiobPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x400ff001,0xffffff00,0,unsigned char>;
        ///Port Data Output
    ...
    namespace GpiobPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x400ff011,0xffffff00,0,unsigned char>;
        ///Port Data Input
    ...
    namespace GpiobPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x400ff015,0xffffff00,0,unsigned char>;
        ///Port Data Direction
    ...
    namespace GpiobGacr{    ///<GPIO Attribute Checker Register
        using Addr = Register::Address<0x400ff01d,0xffffff78,0,unsigned char>;
