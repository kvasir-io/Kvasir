...
//Serial Peripheral Interface
    namespace Spi1S{    ///<SPI Status Register
        using Addr = Register::Address<0x40076000,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Spi1Ci{    ///<SPI clear interrupt register
        using Addr = Register::Address<0x4007600a,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Spi1C3{    ///<SPI control register 3
        using Addr = Register::Address<0x4007600b,0xffffffc0,0x00000000,unsigned char>;
        ///FIFO mode enable
