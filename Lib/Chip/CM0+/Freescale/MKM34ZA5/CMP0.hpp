...
namespace Kvasir {
    namespace CMP0_cr0{
        using Addr = Register::Address<0x40072000,0xffffff8c>;
    ...
    namespace CMP0_cr1{
        using Addr = Register::Address<0x40072001,0xffffff00>;
    ...
    namespace CMP0_fpr{
        using Addr = Register::Address<0x40072002,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> FILT_PER; 
    }
    namespace CMP0_scr{
        using Addr = Register::Address<0x40072003,0xffffffa0>;
    ...
    namespace CMP0_daccr{
        using Addr = Register::Address<0x40072004,0xffffff00>;
    ...
    namespace CMP0_muxcr{
        using Addr = Register::Address<0x40072005,0xffffffc0>;
