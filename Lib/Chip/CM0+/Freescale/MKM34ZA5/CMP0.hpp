...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp0Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40072000,0xffffff8c,0x00000000,unsigned char>;
    ...
    namespace Cmp0Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40072001,0xffffff00,0x00000000,unsigned char>;
        ...
        enum class OpeVal {
            v0=0x00000000,     ///<CMPO is not available on the associated CMPO output pin.
            v1=0x00000001,     ///<CMPO is available on the associated CMPO output pin.
        };
    ...
    namespace Cmp0Fpr{    ///<CMP Filter Period Register
        using Addr = Register::Address<0x40072002,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Cmp0Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x40072003,0xffffffa0,0x00000000,unsigned char>;
    ...
    namespace Cmp0Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40072005,0xffffffc0,0x00000000,unsigned char>;
