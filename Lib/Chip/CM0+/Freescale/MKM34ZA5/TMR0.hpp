...
//Quad Timer
    namespace Tmr0Comp1{    ///<Timer Channel Compare Register 1
        using Addr = Register::Address<0x40057000,0xffff0000,0x00000000,unsigned>;
        ///Comparison Value 1
    ...
    namespace Tmr0Comp2{    ///<Timer Channel Compare Register 2
        using Addr = Register::Address<0x40057002,0xffff0000,0x00000000,unsigned>;
        ///Comparison Value 2
    ...
    namespace Tmr0Capt{    ///<Timer Channel Capture Register
        using Addr = Register::Address<0x40057004,0xffff0000,0x00000000,unsigned>;
        ///Capture Value
    ...
    namespace Tmr0Load{    ///<Timer Channel Load Register
        using Addr = Register::Address<0x40057006,0xffff0000,0x00000000,unsigned>;
        ///Timer Load Register
    ...
    namespace Tmr0Hold{    ///<Timer Channel Hold Register
        using Addr = Register::Address<0x40057008,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tmr0Cntr{    ///<Timer Channel Counter Register
        using Addr = Register::Address<0x4005700a,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr0Ctrl{    ///<Timer Channel Control Register
        using Addr = Register::Address<0x4005700c,0xffff0000,0x00000000,unsigned>;
        ///Output Mode
    ...
    namespace Tmr0Sctrl{    ///<Timer Channel Status and Control Register
        using Addr = Register::Address<0x4005700e,0xffff0000,0x00000000,unsigned>;
        ///Output Enable
        enum class OenVal {
    ...
    namespace Tmr0Cmpld1{    ///<Timer Channel Comparator Load Register 1
        using Addr = Register::Address<0x40057010,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr0Cmpld2{    ///<Timer Channel Comparator Load Register 2
        using Addr = Register::Address<0x40057012,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr0Csctrl{    ///<Timer Channel Comparator Status and Control Register
        using Addr = Register::Address<0x40057014,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tmr0Filt{    ///<Timer Channel Input Filter Register
        using Addr = Register::Address<0x40057016,0xfffff800,0x00000000,unsigned>;
    ...
    namespace Tmr0Enbl{    ///<Timer Channel Enable Register
        using Addr = Register::Address<0x4005701e,0xfffffff0,0x00000000,unsigned>;
