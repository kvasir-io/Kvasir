...
//Serial Communication Interface
    namespace Uart1Bdh{    ///<UART Baud Rate Registers: High
        using Addr = Register::Address<0x4006b000,0xffffffa0,0x00000000,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart1C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x4006b002,0xffffff40,0x00000000,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart1S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x4006b005,0xffffff82,0x00000000,unsigned char>;
