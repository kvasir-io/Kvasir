...
//General Purpose Input/Output
    namespace GpiofPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x400ff041,0xffffff00,0x00000000,unsigned char>;
        ///Port Data Output
    ...
    namespace GpiofPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x400ff051,0xffffff00,0x00000000,unsigned char>;
        ///Port Data Input
    ...
    namespace GpiofPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x400ff055,0xffffff00,0x00000000,unsigned char>;
        ///Port Data Direction
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> pdd{}; 
    }
    namespace GpiofGacr{    ///<GPIO Attribute Checker Register
        using Addr = Register::Address<0x400ff05d,0xffffff78,0x00000000,unsigned char>;
