...
//General Purpose Input/Output
    namespace GpiofPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x400ff041,0xffffff00,0,unsigned char>;
        ///Port Data Output
    ...
    namespace GpiofPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x400ff051,0xffffff00,0,unsigned char>;
        ///Port Data Input
    ...
    namespace GpiofPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x400ff055,0xffffff00,0,unsigned char>;
        ///Port Data Direction
    ...
    namespace GpiofGacr{    ///<GPIO Attribute Checker Register
        using Addr = Register::Address<0x400ff05d,0xffffff78,0,unsigned char>;
