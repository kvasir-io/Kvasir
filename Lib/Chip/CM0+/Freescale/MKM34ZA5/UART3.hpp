...
//Serial Communication Interface
    namespace Uart3Bdh{    ///<UART Baud Rate Registers: High
        using Addr = Register::Address<0x4006d000,0xffffffa0,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart3C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x4006d002,0xffffff40,0,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart3S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x4006d005,0xffffff82,0,unsigned char>;
    ...
    namespace Uart3C7816{    ///<UART 7816 Control Register
        using Addr = Register::Address<0x4006d018,0xffffffe0,0,unsigned char>;
    ...
    namespace Uart3Ie7816{    ///<UART 7816 Interrupt Enable Register
        using Addr = Register::Address<0x4006d019,0xffffff08,0,unsigned char>;
    ...
    namespace Uart3Is7816{    ///<UART 7816 Interrupt Status Register
        using Addr = Register::Address<0x4006d01a,0xffffff08,0,unsigned char>;
    ...
    namespace Uart3Wp7816t0{    ///<UART 7816 Wait Parameter Register
        using Addr = Register::Address<0x4006d01b,0xffffff00,0,unsigned char>;
    ...
    namespace Uart3Wn7816{    ///<UART 7816 Wait N Register
        using Addr = Register::Address<0x4006d01c,0xffffff00,0,unsigned char>;
        ///Guard Band N
    ...
    namespace Uart3Wf7816{    ///<UART 7816 Wait FD Register
        using Addr = Register::Address<0x4006d01d,0xffffff00,0,unsigned char>;
        ///FD Multiplier
    ...
    namespace Uart3Et7816{    ///<UART 7816 Error Threshold Register
        using Addr = Register::Address<0x4006d01e,0xffffff00,0,unsigned char>;
    ...
    namespace Uart3Tl7816{    ///<UART 7816 Transmit Length Register
        using Addr = Register::Address<0x4006d01f,0xffffff00,0,unsigned char>;
        ///Transmit Length
