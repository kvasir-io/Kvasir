...
namespace Kvasir {
    namespace TMR1_comp1{
        using Addr = Register::Address<0x40058000,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COMPARISON_1; 
    }
    namespace TMR1_comp2{
        using Addr = Register::Address<0x40058002,0xffff0000>;
    ...
    namespace TMR1_sctrl{
        using Addr = Register::Address<0x4005800e,0xffff0000>;
    ...
    namespace TMR1_cmpld1{
        using Addr = Register::Address<0x40058010,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COMPARATOR_LOAD_1; 
    }
    namespace TMR1_cmpld2{
        using Addr = Register::Address<0x40058012,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COMPARATOR_LOAD_2; 
    }
    namespace TMR1_csctrl{
        using Addr = Register::Address<0x40058014,0xffff0000>;
    ...
    namespace TMR1_filt{
        using Addr = Register::Address<0x40058016,0xfffff800>;
