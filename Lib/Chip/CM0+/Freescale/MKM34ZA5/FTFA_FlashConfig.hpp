...
//Flash configuration field
    ...
    namespace NvFopt{    ///<Non-volatile Flash Option Register
        ...
        namespace nmiEnValC{
            constexpr MPL::Value<nmiEnVal,nmiEnVal::v00> v00{};
            constexpr MPL::Value<nmiEnVal,nmiEnVal::v01> v01{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,nmiEnVal> nmiEn{}; 
        ///no description available
        ...
        namespace exeModeValC{
            constexpr MPL::Value<exeModeVal,exeModeVal::v00> v00{};
            constexpr MPL::Value<exeModeVal,exeModeVal::v01> v01{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,exeModeVal> exeMode{}; 
        ///no description available
        ...
        namespace clkSrcValC{
            constexpr MPL::Value<clkSrcVal,clkSrcVal::v00> v00{};
            constexpr MPL::Value<clkSrcVal,clkSrcVal::v01> v01{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,clkSrcVal> clkSrc{}; 
    }
}
