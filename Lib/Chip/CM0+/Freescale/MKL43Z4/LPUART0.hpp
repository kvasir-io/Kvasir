...
namespace Kvasir {
    namespace LPUART0_baud{
        using Addr = Register::Address<0x40054000,0x00500000>;
    ...
    namespace LPUART0_stat{
        using Addr = Register::Address<0x40054004,0x00003fff>;
    ...
    namespace LPUART0_ctrl{
        using Addr = Register::Address<0x40054008,0x00003800>;
    ...
    namespace LPUART0_data{
        using Addr = Register::Address<0x4005400c,0xffff0400>;
    ...
    namespace LPUART0_match{
        using Addr = Register::Address<0x40054010,0xfc00fc00>;
