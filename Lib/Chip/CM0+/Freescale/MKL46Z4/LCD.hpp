...
//Segment Liquid Crystal Display
    namespace LcdGcr{    ///<LCD General Control Register
        ...
        namespace FfrValC{
            constexpr Register::FieldValue<decltype(ffr)::Type,FfrVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ffr)::Type,FfrVal::v1> v1{};
        }
        ...
        namespace AltsourceValC{
            constexpr Register::FieldValue<decltype(altsource)::Type,AltsourceVal::v0> v0{};
            constexpr Register::FieldValue<decltype(altsource)::Type,AltsourceVal::v1> v1{};
        }
        ...
        namespace PadsafeValC{
            constexpr Register::FieldValue<decltype(padsafe)::Type,PadsafeVal::v0> v0{};
            constexpr Register::FieldValue<decltype(padsafe)::Type,PadsafeVal::v1> v1{};
        }
