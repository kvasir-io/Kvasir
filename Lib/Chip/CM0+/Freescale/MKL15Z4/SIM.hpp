...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xf0feff0f>;
    ...
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0xf8ebffff>;
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xff37e33f>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x507ffffc>;
