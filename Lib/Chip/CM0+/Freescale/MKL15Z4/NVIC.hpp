...
//Nested Vectored Interrupt Controller
    namespace NvicNvicIser{    ///<Interrupt Set Enable Register
        ...
        enum class Setena31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTD Pin detect interrupt disabled
            v1=0x00000001,     ///<write: enable PORTD Pin detect interrupt; read: PORTD Pin detect interrupt enabled
        };
    ...
    namespace NvicNvicIcer{    ///<Interrupt Clear Enable Register
        ...
        enum class Clrena31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTD Pin detect interrupt disabled
            v1=0x00000001,     ///<write: disable PORTD Pin detect interrupt; read: PORTD Pin detect interrupt enabled
        };
    ...
    namespace NvicNvicIspr{    ///<Interrupt Set Pending Register
        ...
        enum class Setpend31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTD Pin detect interrupt is not pending
            v1=0x00000001,     ///<write: changes the PORTD Pin detect interrupt state to pending; read: PORTD Pin detect interrupt is pending
        };
    ...
    namespace NvicNvicIcpr{    ///<Interrupt Clear Pending Register
        ...
        enum class Clrpend31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTD Pin detect interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the PORTD Pin detect interrupt; read: PORTD Pin detect interrupt is pending
        };
