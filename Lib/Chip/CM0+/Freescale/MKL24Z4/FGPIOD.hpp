...
//General Purpose Input/Output
    namespace FgpiodPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0xf80ff0c0,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace FgpiodPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0xf80ff0c4,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace FgpiodPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0xf80ff0c8,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace FgpiodPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0xf80ff0cc,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace FgpiodPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0xf80ff0d0,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace FgpiodPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0xf80ff0d4,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
