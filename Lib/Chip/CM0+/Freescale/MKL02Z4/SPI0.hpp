...
//Serial Peripheral Interface
    ...
    namespace Spi0C2{    ///<SPI control register 2
        using Addr = Register::Address<0x40076001,0xffffff64,0x00000000,unsigned char>;
        ///SPI pin control 0
        enum class Spc0Val {
    ...
    namespace Spi0Br{    ///<SPI baud rate register
        using Addr = Register::Address<0x40076002,0xffffff80,0x00000000,unsigned char>;
    ...
    namespace Spi0S{    ///<SPI status register
        using Addr = Register::Address<0x40076003,0xffffff0f,0x00000000,unsigned char>;
