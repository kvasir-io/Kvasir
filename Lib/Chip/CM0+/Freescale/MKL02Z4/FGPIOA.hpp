...
//General Purpose Input/Output
    namespace FgpioaPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0xf80ff000,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace FgpioaPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0xf80ff004,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace FgpioaPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0xf80ff008,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace FgpioaPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0xf80ff00c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace FgpioaPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0xf80ff010,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace FgpioaPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0xf80ff014,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
