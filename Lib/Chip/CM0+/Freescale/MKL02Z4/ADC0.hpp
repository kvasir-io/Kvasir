...
//Analog-to-Digital Converter
    namespace Adc0Cfg1{    ///<ADC Configuration Register 1
        ...
        enum class ModeVal {
            ...
            v11=0x00000003,     ///<Reserved. Do not set the bitfield to this value.
        };
    ...
    namespace Adc0Sc2{    ///<Status and Control Register 2
        using Addr = Register::Address<0x4003b020,0xffffff04,0x00000000,unsigned>;
    ...
    namespace Adc0Sc1a{    ///<ADC Status and Control Registers 1
        using Addr = Register::Address<0x4003b000,0xffffff20,0x00000000,unsigned>;
    ...
    namespace Adc0Sc1b{    ///<ADC Status and Control Registers 1
        using Addr = Register::Address<0x4003b004,0xffffff20,0x00000000,unsigned>;
        ///Input channel select
        enum class AdchVal {
            v00000=0x00000000,     ///<AD0 is selected as input.
            v00001=0x00000001,     ///<AD1 is selected as input.
