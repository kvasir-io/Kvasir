...
//Pin Control and Interrupts
    ...
    namespace PortaPcr0{    ///<Pin Control Register n
        ...
        enum class IsfVal {
            ...
            v1=0x00000001,     ///<Configured interrupt is detected. The flag remains set until a logic one is written to the flag. If the pin is configured for a level sensitive interrupt and the pin remains asserted, then the flag is set again immediately after it is cleared.
        };
