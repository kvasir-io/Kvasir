...
//Nested Vectored Interrupt Controller
    namespace NonenvicIser{    ///<Interrupt Set Enable Register
        ...
        enum class Setena7Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 23 interrupt disabled
            v1=0x00000001,     ///<write: enable Reserved iv 23 interrupt; read: Reserved iv 23 interrupt enabled
        };
        ...
        enum class Setena20Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 36 interrupt disabled
            v1=0x00000001,     ///<write: enable Reserved iv 36 interrupt; read: Reserved iv 36 interrupt enabled
        };
        ...
        enum class Setena21Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 37 interrupt disabled
            v1=0x00000001,     ///<write: enable Reserved iv 37 interrupt; read: Reserved iv 37 interrupt enabled
        };
    ...
    namespace NonenvicIcer{    ///<Interrupt Clear Enable Register
        ...
        enum class Clrena7Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 23 interrupt disabled
            v1=0x00000001,     ///<write: disable Reserved iv 23 interrupt; read: Reserved iv 23 interrupt enabled
        };
        ...
        enum class Clrena20Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 36 interrupt disabled
            v1=0x00000001,     ///<write: disable Reserved iv 36 interrupt; read: Reserved iv 36 interrupt enabled
        };
        ...
        enum class Clrena21Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 37 interrupt disabled
            v1=0x00000001,     ///<write: disable Reserved iv 37 interrupt; read: Reserved iv 37 interrupt enabled
        };
    ...
    namespace NonenvicIspr{    ///<Interrupt Set Pending Register
        ...
        enum class Setpend7Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 23 interrupt is not pending
            v1=0x00000001,     ///<write: changes the Reserved iv 23 interrupt state to pending; read: Reserved iv 23 interrupt is pending
        };
        ...
        enum class Setpend20Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 36 interrupt is not pending
            v1=0x00000001,     ///<write: changes the Reserved iv 36 interrupt state to pending; read: Reserved iv 36 interrupt is pending
        };
        ...
        enum class Setpend21Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 37 interrupt is not pending
            v1=0x00000001,     ///<write: changes the Reserved iv 37 interrupt state to pending; read: Reserved iv 37 interrupt is pending
        };
    ...
    namespace NonenvicIcpr{    ///<Interrupt Clear Pending Register
        ...
        enum class Clrpend7Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 23 interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the Reserved iv 23 interrupt; read: Reserved iv 23 interrupt is pending
        };
        ...
        enum class Clrpend20Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 36 interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the Reserved iv 36 interrupt; read: Reserved iv 36 interrupt is pending
        };
        ...
        enum class Clrpend21Val {
            v0=0x00000000,     ///<write: no effect; read: Reserved iv 37 interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the Reserved iv 37 interrupt; read: Reserved iv 37 interrupt is pending
        };
