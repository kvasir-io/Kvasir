...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp0Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40072000,0xffffff8c,0,unsigned char>;
    ...
    namespace Cmp0Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40072001,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp0Fpr{    ///<CMP Filter Period Register
        using Addr = Register::Address<0x40072002,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp0Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x40072003,0xffffffa0,0,unsigned char>;
    ...
    namespace Cmp0Daccr{    ///<DAC Control Register
        using Addr = Register::Address<0x40072004,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp0Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40072005,0xffffffc0,0,unsigned char>;
