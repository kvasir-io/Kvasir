...
//Analog-to-Digital Converter
    ...
    namespace AdcCfg1{    ///<ADC Configuration Register 1
        ...
        enum class ModeVal {
            ...
            v11=0x00000003,     ///<It is single-ended 16-bit conversion..
        };
    ...
    namespace AdcSc2{    ///<Status and Control Register 2
        ...
        enum class RefselVal {
            ...
            v10=0x00000002,     ///<Internal bandgap reference and associated ground reference (V BGH and V BGL ). Consult the Chip Configuration information for details specific to this MCU.
        };
