...
namespace Kvasir {
    ...
    namespace TMR0_sctrl{
        using Addr = Register::Address<0x4005700e,0xffff0000>;
    ...
    namespace TMR0_cmpld1{
        using Addr = Register::Address<0x40057010,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COMPARATOR_LOAD_1; 
    }
    namespace TMR0_cmpld2{
        using Addr = Register::Address<0x40057012,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COMPARATOR_LOAD_2; 
    }
    namespace TMR0_csctrl{
        using Addr = Register::Address<0x40057014,0xffff0000>;
    ...
    namespace TMR0_filt{
        using Addr = Register::Address<0x40057016,0xfffff800>;
    ...
    namespace TMR0_enbl{
        using Addr = Register::Address<0x4005701e,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> ENBL; 
    }
}
