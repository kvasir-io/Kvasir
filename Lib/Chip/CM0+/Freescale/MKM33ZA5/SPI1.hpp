...
namespace Kvasir {
    ...
    namespace SPI1_c2{
        using Addr = Register::Address<0x40076002,0xffffff00>;
    ...
    namespace SPI1_c1{
        using Addr = Register::Address<0x40076003,0xffffff00>;
    ...
    namespace SPI1_ml{
        using Addr = Register::Address<0x40076004,0xffffff00>;
    ...
    namespace SPI1_dl{
        using Addr = Register::Address<0x40076006,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI1_dh{
    ...
    namespace SPI1_ci{
        using Addr = Register::Address<0x4007600a,0xffffff00>;
    ...
    namespace SPI1_c3{
        using Addr = Register::Address<0x4007600b,0xffffffc0>;
