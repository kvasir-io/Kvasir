...
//General Purpose Input/Output
    namespace GpiocPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x400ff002,0xffffff00,0,unsigned char>;
        ///Port Data Output
    ...
    namespace GpiocPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x400ff012,0xffffff00,0,unsigned char>;
        ///Port Data Input
    ...
    namespace GpiocPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x400ff016,0xffffff00,0,unsigned char>;
        ///Port Data Direction
    ...
    namespace GpiocGacr{    ///<GPIO Attribute Checker Register
        using Addr = Register::Address<0x400ff01e,0xffffff78,0,unsigned char>;
