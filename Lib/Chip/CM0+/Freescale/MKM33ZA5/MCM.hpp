...
//Core Platform Miscellaneous Control Module
    ...
    namespace McmPlacr{    ///<Platform Control Register
        ...
        namespace DfcdaValC{
            constexpr Register::FieldValue<decltype(dfcda),DfcdaVal::v0> v0{};
            constexpr Register::FieldValue<decltype(dfcda),DfcdaVal::v1> v1{};
        }
        ...
        namespace DfcicValC{
            constexpr Register::FieldValue<decltype(dfcic),DfcicVal::v0> v0{};
            constexpr Register::FieldValue<decltype(dfcic),DfcicVal::v1> v1{};
        }
        ...
        namespace DfccValC{
            constexpr Register::FieldValue<decltype(dfcc),DfccVal::v0> v0{};
            constexpr Register::FieldValue<decltype(dfcc),DfccVal::v1> v1{};
        }
    ...
    namespace McmMatcr{    ///<Master Attribute Configuration Register
        ...
        namespace Atc0ValC{
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v00x> v00x{};
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v010> v010{};
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v011> v011{};
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v100> v100{};
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v101> v101{};
            constexpr Register::FieldValue<decltype(atc0),Atc0Val::v11x> v11x{};
        }
        ///Read-Only Master n
        enum class Ro0Val {
        ...
        namespace Atc2ValC{
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v00x> v00x{};
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v010> v010{};
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v011> v011{};
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v100> v100{};
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v101> v101{};
            constexpr Register::FieldValue<decltype(atc2),Atc2Val::v11x> v11x{};
        }
        ///Read-Only Master n
        enum class Ro2Val {
            v0=0x00000000,     ///<Writes to the ATCn are allowed.
