...
//Serial Communication Interface
    ...
    namespace Uart3C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x4006d002,0xffffff40,0x00000000,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart3S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x4006d005,0xffffff82,0x00000000,unsigned char>;
    ...
    namespace Uart3C5{    ///<UART Control Register 5
        using Addr = Register::Address<0x4006d00b,0xffffff5f,0x00000000,unsigned char>;
    ...
    namespace Uart3Ed{    ///<UART Extended Data Register
        using Addr = Register::Address<0x4006d00c,0xffffff3f,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace Uart3Modem{    ///<UART Modem Register
        using Addr = Register::Address<0x4006d00d,0xfffffff0,0x00000000,unsigned char>;
    ...
    namespace Uart3Cfifo{    ///<UART FIFO Control Register
        using Addr = Register::Address<0x4006d011,0xffffff38,0x00000000,unsigned char>;
    ...
    namespace Uart3Sfifo{    ///<UART FIFO Status Register
        using Addr = Register::Address<0x4006d012,0xffffff38,0x00000000,unsigned char>;
    ...
    namespace Uart3C7816{    ///<UART 7816 Control Register
        using Addr = Register::Address<0x4006d018,0xffffffe0,0x00000000,unsigned char>;
    ...
    namespace Uart3Ie7816{    ///<UART 7816 Interrupt Enable Register
        using Addr = Register::Address<0x4006d019,0xffffff08,0x00000000,unsigned char>;
    ...
    namespace Uart3Is7816{    ///<UART 7816 Interrupt Status Register
        using Addr = Register::Address<0x4006d01a,0xffffff08,0x00000000,unsigned char>;
    ...
    namespace Uart3Wp7816t0{    ///<UART 7816 Wait Parameter Register
        using Addr = Register::Address<0x4006d01b,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart3Wp7816t1{    ///<UART 7816 Wait Parameter Register
        using Addr = Register::Address<0x4006d01b,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart3Wn7816{    ///<UART 7816 Wait N Register
        using Addr = Register::Address<0x4006d01c,0xffffff00,0x00000000,unsigned char>;
        ///Guard Band N
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> gtn{}; 
    }
    namespace Uart3Wf7816{    ///<UART 7816 Wait FD Register
        using Addr = Register::Address<0x4006d01d,0xffffff00,0x00000000,unsigned char>;
        ///FD Multiplier
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> gtfd{}; 
    }
    namespace Uart3Et7816{    ///<UART 7816 Error Threshold Register
        using Addr = Register::Address<0x4006d01e,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart3Tl7816{    ///<UART 7816 Transmit Length Register
        using Addr = Register::Address<0x4006d01f,0xffffff00,0x00000000,unsigned char>;
        ///Transmit Length
