...
namespace Kvasir {
    namespace CMP1_cr0{
        using Addr = Register::Address<0x40072008,0xffffff8c>;
    ...
    namespace CMP1_cr1{
        using Addr = Register::Address<0x40072009,0xffffff00>;
    ...
    namespace CMP1_fpr{
        using Addr = Register::Address<0x4007200a,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> FILT_PER; 
    }
    namespace CMP1_scr{
        using Addr = Register::Address<0x4007200b,0xffffffa0>;
    ...
    namespace CMP1_daccr{
        using Addr = Register::Address<0x4007200c,0xffffff00>;
    ...
    namespace CMP1_muxcr{
        using Addr = Register::Address<0x4007200d,0xffffffc0>;
