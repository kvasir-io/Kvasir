...
//Nested Vectored Interrupt Controller
    namespace NonenvicIser{    ///<Interrupt Set Enable Register
        ...
        enum class setena29Val {
            v0=0x00000000,     ///<write: no effect; read: LCD interrupt disabled
            v1=0x00000001,     ///<write: enable LCD interrupt; read: LCD interrupt enabled
        };
    ...
    namespace NonenvicIcer{    ///<Interrupt Clear Enable Register
        ...
        enum class clrena29Val {
            v0=0x00000000,     ///<write: no effect; read: LCD interrupt disabled
            v1=0x00000001,     ///<write: disable LCD interrupt; read: LCD interrupt enabled
        };
    ...
    namespace NonenvicIspr{    ///<Interrupt Set Pending Register
        ...
        enum class setpend29Val {
            v0=0x00000000,     ///<write: no effect; read: LCD interrupt is not pending
            v1=0x00000001,     ///<write: changes the LCD interrupt state to pending; read: LCD interrupt is pending
        };
    ...
    namespace NonenvicIcpr{    ///<Interrupt Clear Pending Register
        ...
        enum class clrpend29Val {
            v0=0x00000000,     ///<write: no effect; read: LCD interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the LCD interrupt; read: LCD interrupt is pending
        };
