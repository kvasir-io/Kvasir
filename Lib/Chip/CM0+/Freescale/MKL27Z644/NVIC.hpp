...
//Nested Vectored Interrupt Controller
    namespace NonenvicIser{    ///<Interrupt Set Enable Register
        ...
        enum class Setena31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt disabled
            v1=0x00000001,     ///<write: enable PORTB,PORTC,PORTD,PORTE Pin detect interrupt; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt enabled
        };
    ...
    namespace NonenvicIcer{    ///<Interrupt Clear Enable Register
        ...
        enum class Clrena31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt disabled
            v1=0x00000001,     ///<write: disable PORTB,PORTC,PORTD,PORTE Pin detect interrupt; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt enabled
        };
    ...
    namespace NonenvicIspr{    ///<Interrupt Set Pending Register
        ...
        enum class Setpend31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt is not pending
            v1=0x00000001,     ///<write: changes the PORTB,PORTC,PORTD,PORTE Pin detect interrupt state to pending; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt is pending
        };
    ...
    namespace NonenvicIcpr{    ///<Interrupt Clear Pending Register
        ...
        enum class Clrpend31Val {
            v0=0x00000000,     ///<write: no effect; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the PORTB,PORTC,PORTD,PORTE Pin detect interrupt; read: PORTB,PORTC,PORTD,PORTE Pin detect interrupt is pending
        };
