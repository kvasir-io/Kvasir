...
//Power Management Controller
    ...
    namespace PmcRegsc{    ///<Regulator Status And Control register
        using Addr = Register::Address<0x4007d002,0xffffffa2,0,unsigned char>;
        ...
        namespace vlpoValC{
            constexpr MPL::Value<vlpoVal,vlpoVal::v0> v0{};
            constexpr MPL::Value<vlpoVal,vlpoVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,vlpoVal> vlpo{}; 
    }
}
