...
//Universal Serial Bus, OTG Capable Controller
    ...
    namespace Usb0KeepAliveCtrl{    ///<Keep Alive mode control
        ...
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> keepAliveEn{}; 
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ownOverrdEn{}; 
        ///no description available
        ...
        namespace stopAckDlyEnValC{
            constexpr MPL::Value<stopAckDlyEnVal,stopAckDlyEnVal::v0> v0{};
            constexpr MPL::Value<stopAckDlyEnVal,stopAckDlyEnVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,stopAckDlyEnVal> stopAckDlyEn{}; 
        ///no description available
        ...
        namespace ahbDlyEnValC{
            constexpr MPL::Value<ahbDlyEnVal,ahbDlyEnVal::v0> v0{};
            constexpr MPL::Value<ahbDlyEnVal,ahbDlyEnVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,ahbDlyEnVal> ahbDlyEn{}; 
        ///Wakeup Interrupt Enable.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wakeIntEn{}; 
        ///Wakeup Interrupt Status.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> wakeIntSts{}; 
    }
    namespace Usb0KeepAliveWkctrl{    ///<Keep Alive mode wakeup control
        ...
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> wakeOnThis{}; 
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> wakeEndpt{}; 
    }
