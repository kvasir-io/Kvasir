...
//Universal Serial Bus, OTG Capable Controller
    ...
    namespace Usb0Istat{    ///<Interrupt Status register
        using Addr = Register::Address<0x40072080,0xffffff40,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace Usb0KeepAliveCtrl{    ///<Keep Alive mode control
        using Addr = Register::Address<0x40072124,0xffffff60,0x00000000,unsigned char>;
        ///no description available
        ...
        namespace StopackdlyenValC{
            constexpr Register::FieldValue<decltype(stopAckDlyEn)::Type,StopackdlyenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(stopAckDlyEn)::Type,StopackdlyenVal::v1> v1{};
        }
        ///no description available
        ...
        namespace AhbdlyenValC{
            constexpr Register::FieldValue<decltype(ahbDlyEn)::Type,AhbdlyenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ahbDlyEn)::Type,AhbdlyenVal::v1> v1{};
        }
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> wakeIntSts{}; 
    }
    namespace Usb0KeepAliveWkctrl{    ///<Keep Alive mode wakeup control
        using Addr = Register::Address<0x40072128,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> wakeOnThis{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> wakeEndpt{}; 
    }
