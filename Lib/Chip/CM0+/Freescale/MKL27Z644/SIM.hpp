...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xc03bff0f>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22)> FLEXIOSRC; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,28)> LPUART1SRC; 
    }
    namespace SIM_sopt4{
    ...
    namespace SIM_sopt5{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> LPUART0TXSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> LPUART0RXSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> LPUART1TXSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> LPUART1RXSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> LPUART0ODE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> LPUART1ODE; 
    ...
    namespace SIM_sdid{
        using Addr = Register::Address<0x40048024,0x00000ff0>;
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xff23ef3f>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> CMP0; 
    ...
    namespace SIM_scgc5{
        using Addr = Register::Address<0x40048038,0x7fcfc1fe>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> LPUART1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31)> FLEXIO; 
    }
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0xd07bfffc>;
