...
namespace Kvasir {
    ...
    namespace MCG_c5{
        using Addr = Register::Address<0x40064004,0xffffff9f>;
    ...
    namespace MCG_c6{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> CHGPMP_BIAS; 
    ...
    namespace MCG_c7{
        using Addr = Register::Address<0x4006400c,0xffffff3e>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> OSCSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6)> PLL32KREFSEL; 
    }
    namespace MCG_c8{
        using Addr = Register::Address<0x4006400d,0xffffff0e>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> LOCS1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> COARSE_LOLIE; 
    ...
    namespace MCG_c9{
        using Addr = Register::Address<0x4006400e,0xffffff3f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> COARSE_LOCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> COARSE_LOLS; 
    }
}
