...
//Multipurpose Clock Generator module
    ...
    namespace McgC5{    ///<MCG Control 5 Register
        using Addr = Register::Address<0x40064004,0xffffff9f,0x00000000,unsigned char>;
        ///PLL Stop Enable
    ...
    namespace McgC6{    ///<MCG Control 6 Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> chgpmpBias{}; 
    ...
    namespace McgC7{    ///<MCG Control 7 Register
        using Addr = Register::Address<0x4006400c,0xffffff3e,0x00000000,unsigned char>;
        ...
        namespace Pll32krefselValC{
            constexpr Register::FieldValue<decltype(pll32krefsel)::Type,Pll32krefselVal::v00> v00{};
            constexpr Register::FieldValue<decltype(pll32krefsel)::Type,Pll32krefselVal::v01> v01{};
            constexpr Register::FieldValue<decltype(pll32krefsel)::Type,Pll32krefselVal::v10> v10{};
        }
    }
    namespace McgC8{    ///<MCG Control 8 Register
        using Addr = Register::Address<0x4006400d,0xffffff0e,0x00000000,unsigned char>;
        ...
        namespace CoarselolieValC{
            constexpr Register::FieldValue<decltype(coarseLolie)::Type,CoarselolieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(coarseLolie)::Type,CoarselolieVal::v1> v1{};
        }
    ...
    namespace McgC9{    ///<MCG Control 9 Register
        using Addr = Register::Address<0x4006400e,0xffffff3f,0x00000000,unsigned char>;
        ///Coarse Lock Status
        enum class CoarselockVal {
            v0=0x00000000,     ///<PLL is currently unlocked.
            v1=0x00000001,     ///<PLL is currently locked after first sample.
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,CoarselockVal> coarseLock{}; 
        namespace CoarselockValC{
            constexpr Register::FieldValue<decltype(coarseLock)::Type,CoarselockVal::v0> v0{};
            constexpr Register::FieldValue<decltype(coarseLock)::Type,CoarselockVal::v1> v1{};
        }
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,CoarselolsVal> coarseLols{}; 
        namespace CoarselolsValC{
            constexpr Register::FieldValue<decltype(coarseLols)::Type,CoarselolsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(coarseLols)::Type,CoarselolsVal::v1> v1{};
        }
    }
}
