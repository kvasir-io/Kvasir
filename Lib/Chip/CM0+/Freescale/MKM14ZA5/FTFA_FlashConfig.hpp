...
namespace Kvasir {
    ...
    namespace NV_fopt{
        using Addr = Register::Address<0x0000040d,0xffffffd2>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> LPBOOT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> NMI_EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> EXE_MODE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CLK_SRC; 
    }
}
