...
//Quad Timer
    namespace Tmr2Comp1{    ///<Timer Channel Compare Register 1
        using Addr = Register::Address<0x40059000,0xffff0000,0x00000000,unsigned>;
        ///Comparison Value 1
    ...
    namespace Tmr2Comp2{    ///<Timer Channel Compare Register 2
        using Addr = Register::Address<0x40059002,0xffff0000,0x00000000,unsigned>;
        ///Comparison Value 2
    ...
    namespace Tmr2Capt{    ///<Timer Channel Capture Register
        using Addr = Register::Address<0x40059004,0xffff0000,0x00000000,unsigned>;
        ///Capture Value
    ...
    namespace Tmr2Load{    ///<Timer Channel Load Register
        using Addr = Register::Address<0x40059006,0xffff0000,0x00000000,unsigned>;
        ///Timer Load Register
    ...
    namespace Tmr2Hold{    ///<Timer Channel Hold Register
        using Addr = Register::Address<0x40059008,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tmr2Cntr{    ///<Timer Channel Counter Register
        using Addr = Register::Address<0x4005900a,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr2Ctrl{    ///<Timer Channel Control Register
        using Addr = Register::Address<0x4005900c,0xffff0000,0x00000000,unsigned>;
        ///Output Mode
    ...
    namespace Tmr2Sctrl{    ///<Timer Channel Status and Control Register
        using Addr = Register::Address<0x4005900e,0xffff0000,0x00000000,unsigned>;
        ///Output Enable
        enum class OenVal {
    ...
    namespace Tmr2Cmpld1{    ///<Timer Channel Comparator Load Register 1
        using Addr = Register::Address<0x40059010,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr2Cmpld2{    ///<Timer Channel Comparator Load Register 2
        using Addr = Register::Address<0x40059012,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Tmr2Csctrl{    ///<Timer Channel Comparator Status and Control Register
        using Addr = Register::Address<0x40059014,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tmr2Filt{    ///<Timer Channel Input Filter Register
        using Addr = Register::Address<0x40059016,0xfffff800,0x00000000,unsigned>;
