...
namespace Kvasir {
    namespace I2C1_a1{
        using Addr = Register::Address<0x40068000,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> AD; 
    }
    namespace I2C1_f{
        using Addr = Register::Address<0x40068001,0xffffff00>;
    ...
    namespace I2C1_c1{
        using Addr = Register::Address<0x40068002,0xffffff00>;
    ...
    namespace I2C1_s{
        using Addr = Register::Address<0x40068003,0xffffff00>;
    ...
    namespace I2C1_d{
        using Addr = Register::Address<0x40068004,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> DATA; 
    }
    namespace I2C1_c2{
        using Addr = Register::Address<0x40068005,0xffffff00>;
    ...
    namespace I2C1_flt{
        using Addr = Register::Address<0x40068006,0xffffff00>;
    ...
    namespace I2C1_ra{
        using Addr = Register::Address<0x40068007,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> RAD; 
    }
    namespace I2C1_smb{
        using Addr = Register::Address<0x40068008,0xffffff00>;
    ...
    namespace I2C1_a2{
        using Addr = Register::Address<0x40068009,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> SAD; 
    }
    namespace I2C1_slth{
        using Addr = Register::Address<0x4006800a,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> SSLT; 
    }
    namespace I2C1_sltl{
        using Addr = Register::Address<0x4006800b,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> SSLT; 
    }
}
