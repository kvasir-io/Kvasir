...
//Inter-Integrated Circuit
    ...
    namespace I2c1F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x40068001,0xffffff00,0,unsigned char>;
        ///ClockRate
    ...
    namespace I2c1C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x40068002,0xffffff00,0,unsigned char>;
        ///DMA Enable
        enum class DmaenVal {
    ...
    namespace I2c1S{    ///<I2C Status register
        using Addr = Register::Address<0x40068003,0xffffff00,0,unsigned char>;
        ///Receive Acknowledge
        enum class RxakVal {
    ...
    namespace I2c1D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x40068004,0xffffff00,0,unsigned char>;
        ///Data
    ...
    namespace I2c1C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x40068005,0xffffff00,0,unsigned char>;
        ///Slave Address
    ...
    namespace I2c1Flt{    ///<I2C Programmable Input Glitch Filter Register
        using Addr = Register::Address<0x40068006,0xffffff00,0,unsigned char>;
    ...
    namespace I2c1Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x40068007,0xffffff01,0,unsigned char>;
        ///Range Slave Address
    ...
    namespace I2c1Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x40068008,0xffffff00,0,unsigned char>;
    ...
    namespace I2c1A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x40068009,0xffffff01,0,unsigned char>;
        ///SMBus Address
    ...
    namespace I2c1Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x4006800a,0xffffff00,0,unsigned char>;
        ///SSLT[15:8]
    ...
    namespace I2c1Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x4006800b,0xffffff00,0,unsigned char>;
        ///SSLT[7:0]
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
