...
namespace Kvasir {
    ...
    namespace SIM_sopt{
        using Addr = Register::Address<0x40048004,0x007000f1>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> ADHWT; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13)> RXDFE; 
    ...
    namespace SIM_pinsel{
        using Addr = Register::Address<0x40048008,0xffff000f>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> FTM2PS0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13)> FTM2PS1; 
    ...
    namespace SIM_scgc{
        using Addr = Register::Address<0x4004800c,0x1481cb1c>;
    ...
    namespace SIM_busdiv{
        using Addr = Register::Address<0x40048018,0xfffffffe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> BUSDIV; 
    }
}
