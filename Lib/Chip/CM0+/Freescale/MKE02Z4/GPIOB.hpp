...
//General Purpose Input/Output
    namespace GpiobPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x400ff040,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace GpiobPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x400ff044,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace GpiobPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x400ff048,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace GpiobPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x400ff04c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace GpiobPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x400ff050,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace GpiobPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x400ff054,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
    ...
    namespace GpiobPidr{    ///<Port Input Disable Register
        using Addr = Register::Address<0x400ff058,0x00000000,0x00000000,unsigned>;
        ///Port Input Disable
