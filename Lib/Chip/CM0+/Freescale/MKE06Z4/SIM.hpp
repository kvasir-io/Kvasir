...
//System Integration Module
    ...
    namespace SimSopt0{    ///<System Options Register 0
        using Addr = Register::Address<0x40048004,0x000020d1,0x00000000,unsigned>;
        ///NMI Pin Enable
        enum class NmieVal {
    ...
    namespace SimSopt1{    ///<System Options Register
        using Addr = Register::Address<0x40048008,0xffffffc4,0x00000000,unsigned>;
    ...
    namespace SimPinsel0{    ///<Pin Selection Register 0
        using Addr = Register::Address<0x4004800c,0x00fff008,0x00000000,unsigned>;
        ///IRQ Port Pin Select
        enum class IrqpsVal {
    ...
    namespace SimPinsel1{    ///<Pin Selection Register 1
        using Addr = Register::Address<0x40048010,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace SimScgc{    ///<System Clock Gating Control Register
        using Addr = Register::Address<0x40048014,0x14804b0c,0x00000000,unsigned>;
    ...
    namespace SimUuidmh{    ///<Universally Unique Identifier Middle High Register
        using Addr = Register::Address<0x40048020,0xffff0000,0x00000000,unsigned>;
        ///Universally Unique Identifier
    ...
    namespace SimClkdiv{    ///<Clock Divider Register
        using Addr = Register::Address<0x40048024,0xceefffff,0x00000000,unsigned>;
