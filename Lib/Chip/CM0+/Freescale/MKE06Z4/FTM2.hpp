...
//FlexTimer Module
    namespace Ftm2Sc{    ///<Status And Control
        using Addr = Register::Address<0x4003a000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm2Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4003a04c,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm2Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x4003a050,0xffffff00,0x00000000,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
    ...
    namespace Ftm2Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x4003a054,0xffffff00,0x00000000,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm2Sync{    ///<Synchronization
        using Addr = Register::Address<0x4003a058,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm2Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4003a05c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm2Outmask{    ///<Output Mask
        using Addr = Register::Address<0x4003a060,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm2Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x4003a064,0x80808080,0x00000000,unsigned>;
    ...
    namespace Ftm2Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x4003a068,0xffffff00,0x00000000,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm2Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4003a06c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm2Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x4003a070,0xffffff00,0x00000000,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm2Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x4003a074,0xffffff10,0x00000000,unsigned>;
    ...
    namespace Ftm2Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x4003a078,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ftm2Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4003a07c,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Ftm2Conf{    ///<Configuration
        using Addr = Register::Address<0x4003a084,0xfffff920,0x00000000,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm2Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x4003a088,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Ftm2Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4003a08c,0xffe0e04a,0x00000000,unsigned>;
    ...
    namespace Ftm2Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x4003a090,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Ftm2Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x4003a094,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ftm2Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x4003a098,0xfffffd00,0x00000000,unsigned>;
        ///Channel 0 Select
    ...
    namespace Ftm2C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a00c,0xffffff03,0x00000000,unsigned>;
    ...
    namespace Ftm2C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a014,0xffffff03,0x00000000,unsigned>;
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> elsa{}; 
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> elsb{}; 
    ...
    namespace Ftm2C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a01c,0xffffff03,0x00000000,unsigned>;
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> elsa{}; 
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> elsb{}; 
    ...
    namespace Ftm2C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a024,0xffffff03,0x00000000,unsigned>;
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> elsa{}; 
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> elsb{}; 
    ...
    namespace Ftm2C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a02c,0xffffff03,0x00000000,unsigned>;
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> elsa{}; 
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> elsb{}; 
    ...
    namespace Ftm2C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4003a034,0xffffff03,0x00000000,unsigned>;
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> elsa{}; 
        ///Edge or Level Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> elsb{}; 
    ...
    namespace Ftm2C2v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a020,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm2C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a028,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm2C4v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a030,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm2C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4003a038,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
}
