...
//General Purpose Input/Output
    namespace FgpiobPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0xf8000040,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace FgpiobPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0xf8000044,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace FgpiobPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0xf8000048,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace FgpiobPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0xf800004c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace FgpiobPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0xf8000050,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace FgpiobPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0xf8000054,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
    ...
    namespace FgpiobPidr{    ///<Port Input Disable Register
        using Addr = Register::Address<0xf8000058,0x00000000,0x00000000,unsigned>;
        ///Port Input Disable
