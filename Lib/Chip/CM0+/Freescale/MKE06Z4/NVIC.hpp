...
//Nested Vectored Interrupt Controller
    namespace NonenvicIser{    ///<Interrupt Set Enable Register
        ...
        enum class Setena30Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Rx interrupt disabled
            v1=0x00000001,     ///<write: enable Freescale's Scalable Controller Area Network Rx interrupt; read: Freescale's Scalable Controller Area Network Rx interrupt enabled
        };
        ...
        enum class Setena31Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Tx and error interrupt disabled
            v1=0x00000001,     ///<write: enable Freescale's Scalable Controller Area Network Tx and error interrupt; read: Freescale's Scalable Controller Area Network Tx and error interrupt enabled
        };
    ...
    namespace NonenvicIcer{    ///<Interrupt Clear Enable Register
        ...
        enum class Clrena30Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Rx interrupt disabled
            v1=0x00000001,     ///<write: disable Freescale's Scalable Controller Area Network Rx interrupt; read: Freescale's Scalable Controller Area Network Rx interrupt enabled
        };
        ...
        enum class Clrena31Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Tx and error interrupt disabled
            v1=0x00000001,     ///<write: disable Freescale's Scalable Controller Area Network Tx and error interrupt; read: Freescale's Scalable Controller Area Network Tx and error interrupt enabled
        };
    ...
    namespace NonenvicIspr{    ///<Interrupt Set Pending Register
        ...
        enum class Setpend30Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Rx interrupt is not pending
            v1=0x00000001,     ///<write: changes the Freescale's Scalable Controller Area Network Rx interrupt state to pending; read: Freescale's Scalable Controller Area Network Rx interrupt is pending
        };
        ...
        enum class Setpend31Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Tx and error interrupt is not pending
            v1=0x00000001,     ///<write: changes the Freescale's Scalable Controller Area Network Tx and error interrupt state to pending; read: Freescale's Scalable Controller Area Network Tx and error interrupt is pending
        };
    ...
    namespace NonenvicIcpr{    ///<Interrupt Clear Pending Register
        ...
        enum class Clrpend30Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Rx interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the Freescale's Scalable Controller Area Network Rx interrupt; read: Freescale's Scalable Controller Area Network Rx interrupt is pending
        };
        ...
        enum class Clrpend31Val {
            v0=0x00000000,     ///<write: no effect; read: Freescale's Scalable Controller Area Network Tx and error interrupt is not pending
            v1=0x00000001,     ///<write: removes pending state from the Freescale's Scalable Controller Area Network Tx and error interrupt; read: Freescale's Scalable Controller Area Network Tx and error interrupt is pending
        };
    ...
    namespace NonenvicIpr7{    ///<Interrupt Priority Register 7
        ...
        ///Priority of the Freescale's Scalable Controller Area Network Rx interrupt
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,unsigned> pri30{}; 
        namespace Pri30ValC{
        }
        ///Priority of the Freescale's Scalable Controller Area Network Tx and error interrupt
