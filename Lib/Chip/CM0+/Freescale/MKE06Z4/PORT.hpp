...
namespace Kvasir {
    ...
    namespace PORT_ioflt1{
        using Addr = Register::Address<0x40049004,0xffff000c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> FLTI; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> FLTIRQ; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6)> FLTFTM0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> FLTFTM1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10)> FLTPWT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12)> FLTI2C0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14)> FLTI2C1; 
    }
    namespace PORT_pue0{
        using Addr = Register::Address<0x40049008,0x00000000>;
    ...
    namespace PORT_pue1{
        using Addr = Register::Address<0x4004900c,0x00000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> PTGPE4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> PTGPE5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> PTGPE6; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> PTGPE7; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27)> PTHPE3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> PTHPE4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29)> PTHPE5; 
    ...
    namespace PORT_pue2{
        using Addr = Register::Address<0x40049010,0xffffff80>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PTIPE0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> PTIPE1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PTIPE2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PTIPE3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PTIPE4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PTIPE5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> PTIPE6; 
    }
