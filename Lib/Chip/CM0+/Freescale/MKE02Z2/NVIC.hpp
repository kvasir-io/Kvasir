...
//Nested Vectored Interrupt Controller
    ...
    namespace NvicNvicIpr0{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr1{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr2{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr3{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr4{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr5{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr6{    ///<Interrupt Priority Register n
    ...
    namespace NvicNvicIpr7{    ///<Interrupt Priority Register n
