...
//Inter-Integrated Circuit
    ...
    namespace I2c0S2{    ///<I2C Status register 2
        ...
        namespace EmptyValC{
            constexpr Register::FieldValue<decltype(empty),EmptyVal::v0> v0{};
            constexpr Register::FieldValue<decltype(empty),EmptyVal::v1> v1{};
        }
        ///Error flag
        enum class ErrorVal {
        ...
        namespace ErrorValC{
            constexpr Register::FieldValue<decltype(error),ErrorVal::v0> v0{};
            constexpr Register::FieldValue<decltype(error),ErrorVal::v1> v1{};
        }
    }
}
