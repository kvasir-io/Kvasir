...
//Inter-Integrated Circuit
    ...
    namespace I2c0S2{    ///<I2C Status register 2
        using Addr = Register::Address<0x4006600c,0xfffffffc,0,unsigned char>;
        ///Empty flag
        enum class emptyVal {
        ...
        namespace emptyValC{
            constexpr MPL::Value<emptyVal,emptyVal::v0> v0{};
            constexpr MPL::Value<emptyVal,emptyVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,emptyVal> empty{}; 
        ///Error flag
        enum class errorVal {
        ...
        namespace errorValC{
            constexpr MPL::Value<errorVal,errorVal::v0> v0{};
            constexpr MPL::Value<errorVal,errorVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,errorVal> error{}; 
    }
}
