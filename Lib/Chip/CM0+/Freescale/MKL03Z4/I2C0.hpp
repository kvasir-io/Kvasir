...
//Inter-Integrated Circuit
    ...
    namespace I2c0C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x40066002,0xffffff01,0x00000000,unsigned char>;
        ///Wakeup Enable
        enum class WuenVal {
    ...
    namespace I2c0S{    ///<I2C Status register 1
    ...
    namespace I2c0C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x40066005,0xffffff20,0x00000000,unsigned char>;
        ///Slave Address
    ...
    namespace I2c0S2{    ///<I2C Status register 2
        ...
        namespace ErrorValC{
            constexpr Register::FieldValue<decltype(error)::Type,ErrorVal::v0> v0{};
            constexpr Register::FieldValue<decltype(error)::Type,ErrorVal::v1> v1{};
        }
    }
}
