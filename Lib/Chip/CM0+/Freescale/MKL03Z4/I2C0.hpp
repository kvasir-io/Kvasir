...
namespace Kvasir {
    ...
    namespace I2C0_c1{
        using Addr = Register::Address<0x40066002,0xffffff01>;
    ...
    namespace I2C0_c2{
        using Addr = Register::Address<0x40066005,0xffffff20>;
    ...
    namespace I2C0_flt{
        using Addr = Register::Address<0x40066006,0xffffff00>;
    ...
    namespace I2C0_s2{
        using Addr = Register::Address<0x4006600c,0xfffffffc>;
