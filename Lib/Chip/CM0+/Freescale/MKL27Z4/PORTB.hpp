...
//Pin Control and Interrupts
    namespace PortbPcr0{    ///<Pin Control Register n
        ...
        namespace MuxValC{
            constexpr Register::FieldValue<decltype(mux),MuxVal::adc0Se8> adc0Se8{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::gpio> gpio{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::i2c0Scl> i2c0Scl{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::tpm1ch0> tpm1ch0{};
        }
    ...
    namespace PortbPcr1{    ///<Pin Control Register n
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,MuxVal> mux{}; 
        namespace MuxValC{
            constexpr Register::FieldValue<decltype(mux),MuxVal::adc0Se9> adc0Se9{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::gpio> gpio{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::i2c0Sda> i2c0Sda{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::tpm1ch1> tpm1ch1{};
        }
        ///Interrupt Configuration
        enum class IrqcVal {
            v0000=0x00000000,     ///<Interrupt/DMA request disabled.
    ...
    namespace PortbPcr18{    ///<Pin Control Register n
        ...
        namespace MuxValC{
            ...
            constexpr Register::FieldValue<decltype(mux),MuxVal::i2s0TxBclk> i2s0TxBclk{};
        }
        ///Interrupt Configuration
        enum class IrqcVal {
            v0000=0x00000000,     ///<Interrupt/DMA request disabled.
