...
//Power Management Controller
    namespace PmcLvdsc1{    ///<Low Voltage Detect Status And Control 1 register
        ...
        namespace LvdvValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdv)::Type,LvdvVal::v00> v00{};
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdv)::Type,LvdvVal::v01> v01{};
        }
        ...
        namespace LvdreValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdre)::Type,LvdreVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdre)::Type,LvdreVal::v1> v1{};
        }
        ...
        namespace LvdieValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdie)::Type,LvdieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdie)::Type,LvdieVal::v1> v1{};
        }
        ...
        namespace LvdfValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdf)::Type,LvdfVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcLvdsc1::lvdf)::Type,LvdfVal::v1> v1{};
        }
    }
    namespace PmcLvdsc2{    ///<Low Voltage Detect Status And Control 2 register
        ...
        namespace LvwvValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwv)::Type,LvwvVal::v00> v00{};
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwv)::Type,LvwvVal::v01> v01{};
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwv)::Type,LvwvVal::v10> v10{};
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwv)::Type,LvwvVal::v11> v11{};
        }
        ...
        namespace LvwieValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwie)::Type,LvwieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwie)::Type,LvwieVal::v1> v1{};
        }
        ...
        namespace LvwfValC{
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwf)::Type,LvwfVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcLvdsc2::lvwf)::Type,LvwfVal::v1> v1{};
        }
    }
    namespace PmcRegsc{    ///<Regulator Status And Control register
        ...
        namespace BgbeValC{
            constexpr Register::FieldValue<decltype(PmcRegsc::bgbe)::Type,BgbeVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcRegsc::bgbe)::Type,BgbeVal::v1> v1{};
        }
        ...
        namespace RegonsValC{
            constexpr Register::FieldValue<decltype(PmcRegsc::regons)::Type,RegonsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcRegsc::regons)::Type,RegonsVal::v1> v1{};
        }
        ...
        namespace AckisoValC{
            constexpr Register::FieldValue<decltype(PmcRegsc::ackiso)::Type,AckisoVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcRegsc::ackiso)::Type,AckisoVal::v1> v1{};
        }
        ...
        namespace BgenValC{
            constexpr Register::FieldValue<decltype(PmcRegsc::bgen)::Type,BgenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PmcRegsc::bgen)::Type,BgenVal::v1> v1{};
        }
    }
}
