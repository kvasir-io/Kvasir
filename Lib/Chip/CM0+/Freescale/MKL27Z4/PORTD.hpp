...
//Pin Control and Interrupts
    ...
    namespace PortdPcr4{    ///<Pin Control Register n
        ...
        namespace muxValC{
            ...
            constexpr MPL::Value<muxVal,muxVal::spi1Ss> spi1Ss{};
            constexpr MPL::Value<muxVal,muxVal::uart2Rx> uart2Rx{};
            constexpr MPL::Value<muxVal,muxVal::tpm0ch4> tpm0ch4{};
            constexpr MPL::Value<muxVal,muxVal::fxioD4> fxioD4{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,muxVal> mux{}; 
        ///Interrupt Configuration
        enum class irqcVal {
