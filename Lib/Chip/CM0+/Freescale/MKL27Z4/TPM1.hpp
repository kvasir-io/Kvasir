...
//Timer/PWM Module
    ...
    namespace Tpm1Status{    ///<Capture and Compare Status
        using Addr = Register::Address<0x40039050,0xfffffec0,0,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
            v0=0x00000000,     ///<No channel event has occurred.
            v1=0x00000001,     ///<A channel event has occurred.
    ...
    namespace Tpm1Pol{    ///<Channel Polarity
        using Addr = Register::Address<0x40039070,0xffffffc0,0,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Tpm1Conf{    ///<Configuration
        using Addr = Register::Address<0x40039084,0xf030fc1f,0,unsigned>;
        ///Doze Enable
        ...
        namespace GtbsyncValC{
            constexpr Register::FieldValue<decltype(gtbsync),GtbsyncVal::v0> v0{};
            constexpr Register::FieldValue<decltype(gtbsync),GtbsyncVal::v1> v1{};
        }
