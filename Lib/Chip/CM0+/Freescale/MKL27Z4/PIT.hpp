...
//Periodic Interrupt Timer
    namespace PitMcr{    ///<PIT Module Control Register
        using Addr = Register::Address<0x40037000,0xfffffffc,0x00000000,unsigned>;
        ///Freeze
        enum class FrzVal {
        ...
        namespace FrzValC{
            constexpr Register::FieldValue<decltype(PitMcr::frz)::Type,FrzVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitMcr::frz)::Type,FrzVal::v1> v1{};
        }
        ...
        namespace MdisValC{
            constexpr Register::FieldValue<decltype(PitMcr::mdis)::Type,MdisVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitMcr::mdis)::Type,MdisVal::v1> v1{};
        }
    }
    namespace PitLtmr64h{    ///<PIT Upper Lifetime Timer Register
        using Addr = Register::Address<0x400370e0,0x00000000,0x00000000,unsigned>;
        ///Life Timer value
    ...
    namespace PitLtmr64l{    ///<PIT Lower Lifetime Timer Register
        using Addr = Register::Address<0x400370e4,0x00000000,0x00000000,unsigned>;
        ///Life Timer value
    ...
    namespace PitLdval0{    ///<Timer Load Value Register
        using Addr = Register::Address<0x40037100,0x00000000,0x00000000,unsigned>;
        ///Timer Start Value
    ...
    namespace PitLdval1{    ///<Timer Load Value Register
        using Addr = Register::Address<0x40037110,0x00000000,0x00000000,unsigned>;
        ///Timer Start Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tsv{}; 
    }
    namespace PitCval0{    ///<Current Timer Value Register
        using Addr = Register::Address<0x40037104,0x00000000,0x00000000,unsigned>;
        ///Current Timer Value
    ...
    namespace PitCval1{    ///<Current Timer Value Register
        using Addr = Register::Address<0x40037114,0x00000000,0x00000000,unsigned>;
        ///Current Timer Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> tvl{}; 
    }
    namespace PitTctrl0{    ///<Timer Control Register
        using Addr = Register::Address<0x40037108,0xfffffff8,0x00000000,unsigned>;
        ///Timer Enable
        enum class TenVal {
        ...
        namespace TenValC{
            constexpr Register::FieldValue<decltype(PitTctrl0::ten)::Type,TenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl0::ten)::Type,TenVal::v1> v1{};
        }
        ...
        namespace TieValC{
            constexpr Register::FieldValue<decltype(PitTctrl0::tie)::Type,TieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl0::tie)::Type,TieVal::v1> v1{};
        }
        ///Chain Mode
        enum class ChnVal {
        ...
        namespace ChnValC{
            constexpr Register::FieldValue<decltype(PitTctrl0::chn)::Type,ChnVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl0::chn)::Type,ChnVal::v1> v1{};
        }
    }
    namespace PitTctrl1{    ///<Timer Control Register
        using Addr = Register::Address<0x40037118,0xfffffff8,0x00000000,unsigned>;
        ///Timer Enable
        enum class TenVal {
            v0=0x00000000,     ///<Timer n is disabled.
            v1=0x00000001,     ///<Timer n is enabled.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,TenVal> ten{}; 
        namespace TenValC{
            constexpr Register::FieldValue<decltype(PitTctrl1::ten)::Type,TenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl1::ten)::Type,TenVal::v1> v1{};
        }
        ///Timer Interrupt Enable
        enum class TieVal {
            v0=0x00000000,     ///<Interrupt requests from Timer n are disabled.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,TieVal> tie{}; 
        namespace TieValC{
            constexpr Register::FieldValue<decltype(PitTctrl1::tie)::Type,TieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl1::tie)::Type,TieVal::v1> v1{};
        }
        ///Chain Mode
        enum class ChnVal {
            v0=0x00000000,     ///<Timer is not chained.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,ChnVal> chn{}; 
        namespace ChnValC{
            constexpr Register::FieldValue<decltype(PitTctrl1::chn)::Type,ChnVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTctrl1::chn)::Type,ChnVal::v1> v1{};
        }
    }
    namespace PitTflg0{    ///<Timer Flag Register
        using Addr = Register::Address<0x4003710c,0xfffffffe,0x00000000,unsigned>;
        ...
        namespace TifValC{
            constexpr Register::FieldValue<decltype(PitTflg0::tif)::Type,TifVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTflg0::tif)::Type,TifVal::v1> v1{};
        }
    }
    namespace PitTflg1{    ///<Timer Flag Register
        using Addr = Register::Address<0x4003711c,0xfffffffe,0x00000000,unsigned>;
        ///Timer Interrupt Flag
        enum class TifVal {
            v0=0x00000000,     ///<Timeout has not yet occurred.
            v1=0x00000001,     ///<Timeout has occurred.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,TifVal> tif{}; 
        namespace TifValC{
            constexpr Register::FieldValue<decltype(PitTflg1::tif)::Type,TifVal::v0> v0{};
            constexpr Register::FieldValue<decltype(PitTflg1::tif)::Type,TifVal::v1> v1{};
        }
    }
}
