...
//Pin Control and Interrupts
    namespace PortePcr0{    ///<Pin Control Register n
        ...
        namespace MuxValC{
            ...
            constexpr Register::FieldValue<decltype(mux),MuxVal::spi1Miso> spi1Miso{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::lpuart1Tx> lpuart1Tx{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::rtcClkOut> rtcClkOut{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::cmp0Out> cmp0Out{};
    ...
    namespace PortePcr30{    ///<Pin Control Register n
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,MuxVal> mux{}; 
        namespace MuxValC{
            constexpr Register::FieldValue<decltype(mux),MuxVal::dac0OutAdc0Se23Cmp0In4> dac0OutAdc0Se23Cmp0In4{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::gpio> gpio{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::tpm0ch3> tpm0ch3{};
