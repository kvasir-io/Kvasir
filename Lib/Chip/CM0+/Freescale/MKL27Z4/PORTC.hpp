...
//Pin Control and Interrupts
    ...
    namespace PortcPcr1{    ///<Pin Control Register n
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,MuxVal> mux{}; 
        namespace MuxValC{
            constexpr Register::FieldValue<decltype(mux),MuxVal::adc0Se15> adc0Se15{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::gpio> gpio{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::i2c1Scl> i2c1Scl{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::tpm0ch0> tpm0ch0{};
            constexpr Register::FieldValue<decltype(mux),MuxVal::i2s0Txdo> i2s0Txdo{};
        }
        ///Interrupt Configuration
        enum class IrqcVal {
            v0000=0x00000000,     ///<Interrupt/DMA request disabled.
