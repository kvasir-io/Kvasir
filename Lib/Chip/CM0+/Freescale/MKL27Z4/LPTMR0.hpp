...
//Low Power Timer
    namespace Lptmr0Csr{    ///<Low Power Timer Control Status Register
        ...
        namespace TenValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::ten)::Type,TenVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::ten)::Type,TenVal::v1> v1{};
        }
        ///Timer Mode Select
        enum class TmsVal {
        ...
        namespace TmsValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tms)::Type,TmsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tms)::Type,TmsVal::v1> v1{};
        }
        ...
        namespace TfcValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tfc)::Type,TfcVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tfc)::Type,TfcVal::v1> v1{};
        }
        ///Timer Pin Polarity
        enum class TppVal {
        ...
        namespace TppValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tpp)::Type,TppVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tpp)::Type,TppVal::v1> v1{};
        }
        ///Timer Pin Select
        enum class TpsVal {
        ...
        namespace TpsValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tps)::Type,TpsVal::v00> v00{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tps)::Type,TpsVal::v01> v01{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tps)::Type,TpsVal::v10> v10{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tps)::Type,TpsVal::v11> v11{};
        }
        ...
        namespace TieValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tie)::Type,TieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tie)::Type,TieVal::v1> v1{};
        }
        ///Timer Compare Flag
        enum class TcfVal {
        ...
        namespace TcfValC{
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tcf)::Type,TcfVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Csr::tcf)::Type,TcfVal::v1> v1{};
        }
    }
    namespace Lptmr0Psr{    ///<Low Power Timer Prescale Register
        ...
        namespace PcsValC{
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pcs)::Type,PcsVal::v00> v00{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pcs)::Type,PcsVal::v01> v01{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pcs)::Type,PcsVal::v10> v10{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pcs)::Type,PcsVal::v11> v11{};
        }
        ///Prescaler Bypass
        enum class PbypVal {
        ...
        namespace PbypValC{
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pbyp)::Type,PbypVal::v0> v0{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::pbyp)::Type,PbypVal::v1> v1{};
        }
        ///Prescale Value
        ...
        namespace PrescaleValC{
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0000> v0000{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0001> v0001{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0010> v0010{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0011> v0011{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0100> v0100{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0101> v0101{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0110> v0110{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v0111> v0111{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1000> v1000{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1001> v1001{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1010> v1010{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1011> v1011{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1100> v1100{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1101> v1101{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1110> v1110{};
            constexpr Register::FieldValue<decltype(Lptmr0Psr::prescale)::Type,PrescaleVal::v1111> v1111{};
        }
    }
