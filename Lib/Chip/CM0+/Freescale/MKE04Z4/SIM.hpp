...
//System Integration Module
    ...
    namespace SimSopt{    ///<System Options Register
        ...
        namespace FtmicValC{
            constexpr Register::FieldValue<decltype(ftmic),FtmicVal::v00> v00{};
            constexpr Register::FieldValue<decltype(ftmic),FtmicVal::v01> v01{};
            constexpr Register::FieldValue<decltype(ftmic),FtmicVal::v10> v10{};
            constexpr Register::FieldValue<decltype(ftmic),FtmicVal::v11> v11{};
        }
    ...
    namespace SimPinsel{    ///<Pin Selection Register
        ...
        namespace Ftm0clkpsValC{
            constexpr Register::FieldValue<decltype(ftm0clkps),Ftm0clkpsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ftm0clkps),Ftm0clkpsVal::v1> v1{};
        }
        ...
        namespace Ftm2clkpsValC{
            constexpr Register::FieldValue<decltype(ftm2clkps),Ftm2clkpsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ftm2clkps),Ftm2clkpsVal::v1> v1{};
        }
        ///PWT TCLK Pin Select
        ...
        namespace PwtclkpsValC{
            constexpr Register::FieldValue<decltype(pwtclkps),PwtclkpsVal::v0> v0{};
            constexpr Register::FieldValue<decltype(pwtclkps),PwtclkpsVal::v1> v1{};
        }
    }
