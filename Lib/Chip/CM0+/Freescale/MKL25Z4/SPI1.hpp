...
//Serial Peripheral Interface
    ...
    namespace Spi1C2{    ///<SPI control register 2
        using Addr = Register::Address<0x40077001,0xffffff40,0x00000000,unsigned char>;
        ///SPI pin control 0
        enum class Spc0Val {
    ...
    namespace Spi1Br{    ///<SPI baud rate register
        using Addr = Register::Address<0x40077002,0xffffff80,0x00000000,unsigned char>;
    ...
    namespace Spi1S{    ///<SPI status register
        using Addr = Register::Address<0x40077003,0xffffff0f,0x00000000,unsigned char>;
