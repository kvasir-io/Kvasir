...
namespace Kvasir {
    namespace LPUART1_baud{
        using Addr = Register::Address<0x40055000,0x00500000>;
    ...
    namespace LPUART1_stat{
        using Addr = Register::Address<0x40055004,0x00003fff>;
    ...
    namespace LPUART1_ctrl{
        using Addr = Register::Address<0x40055008,0x00003800>;
    ...
    namespace LPUART1_data{
        using Addr = Register::Address<0x4005500c,0xffff0400>;
    ...
    namespace LPUART1_match{
        using Addr = Register::Address<0x40055010,0xfc00fc00>;
