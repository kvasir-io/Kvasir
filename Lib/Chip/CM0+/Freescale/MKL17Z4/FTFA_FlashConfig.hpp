...
namespace Kvasir {
    ...
    namespace NV_fopt{
        using Addr = Register::Address<0x0000040d,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> LPBOOT0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> BOOTPIN_OPT; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6)> BOOTSRC_SEL; 
    }
}
