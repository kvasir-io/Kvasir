...
namespace Kvasir {
    ...
    namespace ADC_sc4{
        using Addr = Register::Address<0x4003b00c,0xfffffe98>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> HTRGME; 
    }
    namespace ADC_r{
    ...
    namespace ADC_sc5{
        using Addr = Register::Address<0x4003b01c,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> HTRGMASKSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> HTRGMASKE; 
    }
}
