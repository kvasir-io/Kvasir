...
namespace Kvasir {
    namespace SPI1_s{
        using Addr = Register::Address<0x40077000,0xffffff00>;
    ...
    namespace SPI1_br{
        using Addr = Register::Address<0x40077001,0xffffff80>;
    ...
    namespace SPI1_c2{
        using Addr = Register::Address<0x40077002,0xffffff00>;
    ...
    namespace SPI1_c1{
        using Addr = Register::Address<0x40077003,0xffffff00>;
    ...
    namespace SPI1_ml{
        using Addr = Register::Address<0x40077004,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI1_mh{
        using Addr = Register::Address<0x40077005,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI1_dl{
        using Addr = Register::Address<0x40077006,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI1_dh{
        using Addr = Register::Address<0x40077007,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI1_ci{
        using Addr = Register::Address<0x4007700a,0xffffff00>;
    ...
    namespace SPI1_c3{
        using Addr = Register::Address<0x4007700b,0xffffffc0>;
