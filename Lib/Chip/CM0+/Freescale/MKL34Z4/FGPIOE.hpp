...
//General Purpose Input/Output
    namespace FgpioePdor{    ///<Port Data Output Register
        using Addr = Register::Address<0xf8000100,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace FgpioePsor{    ///<Port Set Output Register
        using Addr = Register::Address<0xf8000104,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace FgpioePcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0xf8000108,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace FgpioePtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0xf800010c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace FgpioePdir{    ///<Port Data Input Register
        using Addr = Register::Address<0xf8000110,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace FgpioePddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0xf8000114,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
