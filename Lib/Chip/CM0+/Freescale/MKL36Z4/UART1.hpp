...
//Universal Asynchronous Receiver/Transmitter (UART)
    ...
    namespace Uart1C1{    ///<UART Control Register 1
        ...
        enum class WakeVal {
            v0=0x00000000,     ///<Idle-line wake-up.
            v1=0x00000001,     ///<Address-mark wake-up.
        };
    ...
    namespace Uart1C2{    ///<UART Control Register 2
        ...
        enum class RwuVal {
            ...
            v1=0x00000001,     ///<UART receiver in standby waiting for wake-up condition.
        };
        ...
        enum class IlieVal {
            v0=0x00000000,     ///<Hardware interrupts from S1[IDLE] disabled; use polling.
            v1=0x00000001,     ///<Hardware interrupt requested when S1[IDLE] flag is 1.
        };
        ...
        enum class RieVal {
            v0=0x00000000,     ///<Hardware interrupts from S1[RDRF] disabled; use polling.
            v1=0x00000001,     ///<Hardware interrupt requested when S1[RDRF] flag is 1.
        };
    ...
    namespace Uart1S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x4006b005,0xffffff20,0x00000000,unsigned char>;
        ...
        enum class LbkdeVal {
            ...
            v1=0x00000001,     ///<Break detection is enabled (Break character is detected at length 11 bit times (if C1[M] = 0, BDH[SBNS] = 0) or 12 (if C1[M] = 1, BDH[SBNS] = 0 or C1[M] = 0, BDH[SBNS] = 1) or 13 (if C1[M] = 1, BDH[SBNS] = 1)).
        };
        ...
        enum class RwuidVal {
            v0=0x00000000,     ///<During receive standby state (RWU = 1), S1[IDLE] does not get set upon detection of an idle character.
            v1=0x00000001,     ///<During receive standby state (RWU = 1), S1[IDLE] gets set upon detection of an idle character.
        };
    ...
    namespace Uart1C4{    ///<UART Control Register 4
        using Addr = Register::Address<0x4006b008,0xffffff5f,0x00000000,unsigned char>;
