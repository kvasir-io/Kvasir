...
namespace Kvasir {
    namespace SIM_sopt1{
        using Addr = Register::Address<0x40047000,0xfff3ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18)> OSC32KSEL; 
    }
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xfcffff1f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,5)> CLKOUTSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24)> FTMFFCLKSEL; 
    }
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0xc0830070>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> FTM1FLT0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> FTM2FLT0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> FTM0TRG0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> FTM0TRG1SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> FTM0TRG2SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> FTM1TRG0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11)> FTM1TRG1SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> FTM1TRG2SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13)> FTM2TRG0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> FTM2TRG1SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> FTM2TRG2SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18)> FTM1ICH0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20)> FTM2ICH0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> FTM2ICH1SRC; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,28)> FTM2CLKSEL; 
    }
    namespace SIM_sopt5{
        using Addr = Register::Address<0x40048010,0xfffcff00>;
    ...
    namespace SIM_sopt7{
        using Addr = Register::Address<0x40048018,0xf0ff6060>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24)> ADC0ALTCLKSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26)> ADC1ALTCLKSRC; 
    }
    namespace SIM_sopt8{
        using Addr = Register::Address<0x4004801c,0xff00fef8>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> CARRIER_SELECT; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> FTM2OCH0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> FTM2OCH1SRC; 
    }
    namespace SIM_sdid{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,20)> SERIERID; 
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xfff7f3bd>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x60bbeffc>;
    ...
    namespace SIM_clkdiv1{
        using Addr = Register::Address<0x40048044,0x0ff80fff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,12)> OUTDIV5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> OUTDIV5EN; 
