...
//Serial Peripheral Interface
    namespace Spi0Mcr{    ///<Module Configuration Register
        using Addr = Register::Address<0x4002c000,0x02e000fe,0x00000000,unsigned>;
        ///Halt
        enum class HaltVal {
    ...
    namespace Spi0CtarSlave{    ///<Clock and Transfer Attributes Register (In Slave Mode)
        using Addr = Register::Address<0x4002c00c,0x81ffffff,0x00000000,unsigned>;
        ///Clock Phase
        enum class CphaVal {
    ...
    namespace Spi0Pushr{    ///<PUSH TX FIFO Register In Master Mode
        using Addr = Register::Address<0x4002c034,0x03e00000,0x00000000,unsigned>;
        ///Transmit Data
    ...
    namespace Spi0Srex{    ///<Status Register Extended
