...
//Micro Trace Buffer
    ...
    namespace MtbModectrl{    ///<Integration Mode Control Register
        ...
        ///MODECTRL
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> modectrl{}; 
    }
    namespace MtbTagset{    ///<Claim TAG Set Register
        using Addr = Register::Address<0xf0000fa0,0x00000000,0,unsigned>;
        ///TAGSET
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tagset{}; 
    }
    namespace MtbTagclear{    ///<Claim TAG Clear Register
        using Addr = Register::Address<0xf0000fa4,0x00000000,0,unsigned>;
        ///TAGCLEAR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tagclear{}; 
    }
    namespace MtbLockaccess{    ///<Lock Access Register
        using Addr = Register::Address<0xf0000fb0,0x00000000,0,unsigned>;
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> lockaccess{}; 
    }
    namespace MtbLockstat{    ///<Lock Status Register
        using Addr = Register::Address<0xf0000fb4,0x00000000,0,unsigned>;
        ///LOCKSTAT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> lockstat{}; 
    }
    namespace MtbAuthstat{    ///<Authentication Status Register
        using Addr = Register::Address<0xf0000fb8,0xfffffff0,0,unsigned>;
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> bit0{}; 
        ///BIT1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> bit1{}; 
        ///BIT2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> bit2{}; 
        ///BIT3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> bit3{}; 
    }
    namespace MtbDevicearch{    ///<Device Architecture Register
        using Addr = Register::Address<0xf0000fbc,0x00000000,0,unsigned>;
        ///DEVICEARCH
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> devicearch{}; 
    }
