...
//Inter-IC Sound / Synchronous Audio Interface
    ...
    namespace I2s0Tcr4{    ///<SAI Transmit Configuration 4 Register
        using Addr = Register::Address<0x4002f010,0xfffee0e4,0x00000000,unsigned>;
    ...
    namespace I2s0Tmr{    ///<SAI Transmit Mask Register
        ...
        namespace TwmValC{
            constexpr Register::FieldValue<decltype(twm)::Type,TwmVal::v0> v0{};
            constexpr Register::FieldValue<decltype(twm)::Type,TwmVal::v1> v1{};
        }
    }
    ...
    namespace I2s0Rcr4{    ///<SAI Receive Configuration 4 Register
        using Addr = Register::Address<0x4002f090,0xfffee0e4,0x00000000,unsigned>;
        ///Frame Sync Direction
        enum class FsdVal {
            v0=0x00000000,     ///<Frame Sync is generated externally in Slave mode.
            v1=0x00000001,     ///<Frame Sync is generated internally in Master mode.
    ...
    namespace I2s0Rmr{    ///<SAI Receive Mask Register
        ...
        namespace RwmValC{
            constexpr Register::FieldValue<decltype(rwm)::Type,RwmVal::v0> v0{};
            constexpr Register::FieldValue<decltype(rwm)::Type,RwmVal::v1> v1{};
        }
    }
