...
//System Control Registers
    ...
    namespace SystemcontrolIcsr{    ///<Interrupt Control and State Register
        using Addr = Register::Address<0xe000ed04,0x61bc0fc0,0x00000000,unsigned>;
        ///Active exception number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> vectactive{}; 
