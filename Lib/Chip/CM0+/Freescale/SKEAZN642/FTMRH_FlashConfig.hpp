...
namespace Kvasir {
    ...
    namespace NV_eeprot{
        using Addr = Register::Address<0x0000040c,0xffffff78>;
    ...
    namespace NV_fprot{
        using Addr = Register::Address<0x0000040d,0xffffff40>;
    ...
    namespace NV_fsec{
        using Addr = Register::Address<0x0000040e,0xffffff3c>;
    ...
    namespace NV_fopt{
        using Addr = Register::Address<0x0000040f,0xffffffff>;
    }
}
