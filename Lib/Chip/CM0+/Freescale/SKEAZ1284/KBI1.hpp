...
//Keyboard interrupts
    namespace Kbi1Pe{    ///<KBI Pin Enable Register
        using Addr = Register::Address<0x4007a000,0x00000000,0x00000000,unsigned>;
        ///KBI Pin Enables
    ...
    namespace Kbi1Es{    ///<KBI Edge Select Register
        using Addr = Register::Address<0x4007a004,0x00000000,0x00000000,unsigned>;
        ///KBI Edge Selects
    ...
    namespace Kbi1Sc{    ///<KBI Status and Control Register
        using Addr = Register::Address<0x4007a008,0xffffffc0,0x00000000,unsigned>;
        ///KBI Detection Mode
        enum class KbmodVal {
    ...
    namespace Kbi1Sp{    ///<KBI Source Pin Register
        using Addr = Register::Address<0x4007a00c,0x00000000,0x00000000,unsigned>;
        ///KBI Source Pin
