...
//Digital Analog Converter
    ...
    namespace DacCtrlb{    ///<Control B
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> eoen{}; 
        ///Internal Output Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ioen{}; 
        ///Left Adjusted Data
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> leftadj{}; 
        ///Voltage Pump Disable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> vpd{}; 
        ///Bypass DATABUF Write Protection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> bdwp{}; 
        ///Reference Selection
        ...
        namespace refselValC{
            ...
            constexpr MPL::Value<refselVal,refselVal::avcc> avcc{};
            constexpr MPL::Value<refselVal,refselVal::vrefp> vrefp{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6),Register::ReadWriteAccess,refselVal> refsel{}; 
    }
    ...
    namespace DacDatabuf{    ///<Data Buffer
        ...
        ///Data Buffer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> databuf{}; 
    }
    namespace DacEvctrl{    ///<Event Control
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> emptyeo{}; 
    }
    namespace DacIntenclr{    ///<Interrupt Enable Clear
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> underrun{}; 
        ///Data Buffer Empty Interrupt Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> empty{}; 
        ///Synchronization Ready Interrupt Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> syncrdy{}; 
    }
