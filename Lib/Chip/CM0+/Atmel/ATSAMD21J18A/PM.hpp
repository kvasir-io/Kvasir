...
namespace Kvasir {
    ...
    namespace PM_apbcmask{
        using Addr = Register::Address<0x40000420,0xff680000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> DAC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> I2S; 
