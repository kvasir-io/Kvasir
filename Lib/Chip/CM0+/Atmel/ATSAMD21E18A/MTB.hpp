...
//Cortex-M0+ Micro-Trace Buffer
    namespace MtbAuthstatus{    ///<MTB Authentication Status
        using Addr = Register::Address<0x41006fb8,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbBase{    ///<MTB Base
        using Addr = Register::Address<0x4100600c,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbCid0{    ///<CoreSight
        using Addr = Register::Address<0x41006ff0,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbCid1{    ///<CoreSight
        using Addr = Register::Address<0x41006ff4,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbCid2{    ///<CoreSight
        using Addr = Register::Address<0x41006ff8,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbCid3{    ///<CoreSight
        using Addr = Register::Address<0x41006ffc,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbClaimclr{    ///<MTB Claim Clear
        using Addr = Register::Address<0x41006fa4,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbClaimset{    ///<MTB Claim Set
        using Addr = Register::Address<0x41006fa0,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbDevarch{    ///<MTB Device Architecture
        using Addr = Register::Address<0x41006fbc,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbDevid{    ///<MTB Device Configuration
        using Addr = Register::Address<0x41006fc8,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbDevtype{    ///<MTB Device Type
        using Addr = Register::Address<0x41006fcc,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbFlow{    ///<MTB Flow
        using Addr = Register::Address<0x41006008,0x00000004,0x00000000,unsigned>;
        ///Auto Stop Tracing
    ...
    namespace MtbItctrl{    ///<MTB Integration Mode Control
        using Addr = Register::Address<0x41006f00,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbLockaccess{    ///<MTB Lock Access
        using Addr = Register::Address<0x41006fb0,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbLockstatus{    ///<MTB Lock Status
        using Addr = Register::Address<0x41006fb4,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbMaster{    ///<MTB Master
        using Addr = Register::Address<0x41006004,0x7ffffc00,0x00000000,unsigned>;
    ...
    namespace MtbPid0{    ///<CoreSight
        using Addr = Register::Address<0x41006fe0,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid1{    ///<CoreSight
        using Addr = Register::Address<0x41006fe4,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid2{    ///<CoreSight
        using Addr = Register::Address<0x41006fe8,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid3{    ///<CoreSight
        using Addr = Register::Address<0x41006fec,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid4{    ///<CoreSight
        using Addr = Register::Address<0x41006fd0,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid5{    ///<CoreSight
        using Addr = Register::Address<0x41006fd4,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid6{    ///<CoreSight
        using Addr = Register::Address<0x41006fd8,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPid7{    ///<CoreSight
        using Addr = Register::Address<0x41006fdc,0xffffffff,0x00000000,unsigned>;
    }
    namespace MtbPosition{    ///<MTB Position
        using Addr = Register::Address<0x41006000,0x00000003,0x00000000,unsigned>;
        ///Pointer Value Wraps
