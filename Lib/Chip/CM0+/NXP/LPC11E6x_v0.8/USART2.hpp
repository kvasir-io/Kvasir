...
//USART2
    ...
    namespace Usart2Rxdatstat{    ///<Receiver Data with Status register. Combines the last character received with the current USART receive status. Allows DMA or software to recover incoming data and status together.
        using Addr = Register::Address<0x40070018,0x00000000,0x00000000,unsigned>;
        ///The USART Receiver Data register contains the next received character. The number of bits that are relevant depends on the USART configuration settings.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rxdat{}; 
        ///Reserved, the value read from a reserved bit is not defined.
    ...
    namespace Usart2Brg{    ///<Baud Rate Generator register. 16-bit integer baud rate divisor value.
        using Addr = Register::Address<0x40070020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Intstat{    ///<Interrupt status register. Reflects interrupts that are currently enabled.
        using Addr = Register::Address<0x40070024,0x00000000,0x00000000,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Reserved. Read value is undefined, only zero should be written.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace Usart2Osr{    ///<Oversample selection register for asynchronous communication.
        using Addr = Register::Address<0x40070028,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart2Addr{    ///<Address register for automatic address matching.
        using Addr = Register::Address<0x4007002c,0x00000000,0x00000000,unsigned>;
