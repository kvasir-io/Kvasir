...
is HIGH if pinned out).
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace ctmValC{
            ...
            constexpr MPL::Value<ctmVal,ctmVal::counterModeRising> counterModeRising{};
            constexpr MPL::Value<ctmVal,ctmVal::counterModeFalling> counterModeFalling{};
            constexpr MPL::Value<ctmVal,ctmVal::counterModeDualEd> counterModeDualEd{};
        }
        ...
        namespace selccValC{
            ...
            constexpr MPL::Value<selccVal,selccVal::cap2falling> cap2falling{};
        }
