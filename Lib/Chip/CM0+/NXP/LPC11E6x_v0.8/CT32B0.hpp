...
//32-bit counter/timers CT32B0
    namespace Noneir{    ///<Interrupt Register. The IR can be written to clear interrupts. The IR can be read to identify which of eight possible interrupt sources are pending.
        using Addr = Register::Address<0x40014000,0xffffff80,0,unsigned>;
    ...
    namespace Nonetcr{    ///<Timer Control Register. The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
        ...
        namespace CrstValC{
            constexpr Register::FieldValue<decltype(crst),CrstVal::nop> nop{};
            constexpr Register::FieldValue<decltype(crst),CrstVal::reset> reset{};
        }
    }
    ...
    namespace Noneccr{    ///<Capture Control Register. The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        using Addr = Register::Address<0x40014028,0xfffffe00,0,unsigned>;
        ...
        namespace Cap1reValC{
            constexpr Register::FieldValue<decltype(cap1re),Cap1reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap1re),Cap1reVal::disabled> disabled{};
        }
        ...
        namespace Cap1feValC{
            constexpr Register::FieldValue<decltype(cap1fe),Cap1feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap1fe),Cap1feVal::disabled> disabled{};
        }
        ...
        namespace Cap1iValC{
            constexpr Register::FieldValue<decltype(cap1i),Cap1iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap1i),Cap1iVal::disabled> disabled{};
        }
        ...
        namespace Cap2reValC{
            constexpr Register::FieldValue<decltype(cap2re),Cap2reVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap2re),Cap2reVal::disabled> disabled{};
        }
        ...
        namespace Cap2feValC{
            constexpr Register::FieldValue<decltype(cap2fe),Cap2feVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap2fe),Cap2feVal::disabled> disabled{};
        }
        ...
        namespace Cap2iValC{
            constexpr Register::FieldValue<decltype(cap2i),Cap2iVal::enabled> enabled{};
            constexpr Register::FieldValue<decltype(cap2i),Cap2iVal::disabled> disabled{};
        }
    }
    ...
    namespace Noneemr{    ///<External Match Register. The EMR controls the match function and the external match pins CT32Bn_MAT[3:0].
        ...
        enum class Emc0Val {
            nop=0x00000000,     ///<Do Nothing.
            clear=0x00000001,     ///<Clear the corresponding
...
is HIGH if pinned out).
        ...
        namespace Emc0ValC{
            constexpr Register::FieldValue<decltype(emc0),Emc0Val::nop> nop{};
...
is HIGH if pinned out).
        ...
        namespace Emc1ValC{
            constexpr Register::FieldValue<decltype(emc1),Emc1Val::nop> nop{};
...
is HIGH if pinned out).
        ...
        namespace Emc2ValC{
            constexpr Register::FieldValue<decltype(emc2),Emc2Val::nop> nop{};
...
is HIGH if pinned out).
        ...
        namespace Emc3ValC{
            constexpr Register::FieldValue<decltype(emc3),Emc3Val::nop> nop{};
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CtmValC{
            ...
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeRising> counterModeRising{};
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeFalling> counterModeFalling{};
            constexpr Register::FieldValue<decltype(ctm),CtmVal::counterModeDualEd> counterModeDualEd{};
        }
        ...
        namespace CisValC{
            constexpr Register::FieldValue<decltype(cis),CisVal::captureChannel0> captureChannel0{};
            constexpr Register::FieldValue<decltype(cis),CisVal::captureChannel1> captureChannel1{};
            constexpr Register::FieldValue<decltype(cis),CisVal::captureChannel2> captureChannel2{};
        }
        ...
        enum class SelccVal {
            cap0rising=0x00000000,     ///<Rising Edge of the signal on capture channel 0 clears the timer (if bit 4 is set).
            cap0falling=0x00000001,     ///<Falling Edge of the signal on capture channel 0 clears the timer (if bit 4 is set).
            cap1rising=0x00000002,     ///<Rising Edge of the signal on capture channel 1 clears the timer (if bit 4 is set).
            cap1falling=0x00000003,     ///<Falling Edge of the signal on capture channel 1 clears the timer (if bit 4 is set).
            cap2rising=0x00000004,     ///<Rising Edge of the signal on capture channel 2 clears the timer (if bit 4 is set).
            cap2falling=0x00000005,     ///<Falling Edge of the signal on capture channel 2 clears the timer (if bit 4 is set).
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,SelccVal> selcc{}; 
        namespace SelccValC{
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap0rising> cap0rising{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap0falling> cap0falling{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap1rising> cap1rising{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap1falling> cap1falling{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap2rising> cap2rising{};
            constexpr Register::FieldValue<decltype(selcc),SelccVal::cap2falling> cap2falling{};
        }
    }
    namespace Nonepwmc{    ///<PWM Control Register. The PWMCON enables PWM mode for the external match pins CT32Bn_MAT[3:0].
        ...
        enum class Pwmen0Val {
            ...
            pwm=0x00000001,     ///<PWM mode is enabled for CT32Bn_MAT0.
        };
        ...
        enum class Pwmen1Val {
            em1=0x00000000,     ///<CT32Bn_MAT01 is controlled by EM1.
            pwm=0x00000001,     ///<PWM mode is enabled for CT32Bn_MAT1.
        };
        ...
        enum class Pwmen2Val {
            ...
            pwm=0x00000001,     ///<PWM mode is enabled for CT32Bn_MAT2.
        };
        ...
        enum class Pwmen3Val {
            ...
            pwm=0x00000001,     ///<PWM mode is enabled for CT132Bn_MAT3.
        };
