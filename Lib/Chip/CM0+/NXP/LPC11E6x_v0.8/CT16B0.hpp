...
namespace Kvasir {
    namespace Noneir{
        using Addr = Register::Address<0x4000c000,0xffffff80>;
    ...
    namespace Nonetc{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> TCVAL; 
    }
    namespace Nonepr{
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x4000c028,0xfffffe00>;
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x4000c030,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CAP; 
    }
    namespace Nonecr2{
