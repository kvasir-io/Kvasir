...
//16-bit counter/timers CT16B0
    ...
    namespace Ct16b0Mr0{    ///<Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr1{    ///<Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr2{    ///<Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Mr3{    ///<Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
    ...
    namespace Ct16b0Cr0{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CAP input.
    ...
    namespace Ct16b0Cr1{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CAP input.
    ...
    namespace Ct16b0Cr2{    ///<Capture Register. CR is loaded with the value of TC when there is an event on the CAP input.
