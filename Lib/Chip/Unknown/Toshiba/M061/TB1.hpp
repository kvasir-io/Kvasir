...
//16-bit Timer_Event Counter (TB)
    namespace Tb1En{    ///<TB Enable Register
        using Addr = Register::Address<0x440c4100,0xffffff3f,0x00000000,unsigned>;
        ///TBHALT
    ...
    namespace Tb1Run{    ///<TB RUN Register
        using Addr = Register::Address<0x440c4104,0xfffffffa,0x00000000,unsigned>;
        ///TBRUN
    ...
    namespace Tb1Cr{    ///<TB Control Register
        using Addr = Register::Address<0x440c4108,0xffffff50,0x00000000,unsigned>;
        ///CSSEL
    ...
    namespace Tb1Mod{    ///<TB Mode Register
        using Addr = Register::Address<0x440c410c,0xffffff80,0x00000000,unsigned>;
        ///TBCLK
    ...
    namespace Tb1Ffcr{    ///<TB Flip-Flop Control Register
        using Addr = Register::Address<0x440c4110,0xffffffc0,0x00000000,unsigned>;
        ///TBFF0C
    ...
    namespace Tb1St{    ///<TB Status Register
        using Addr = Register::Address<0x440c4114,0xfffffff8,0x00000000,unsigned>;
        ///INTTB0
    ...
    namespace Tb1Im{    ///<TB Interrupt Mask Register
        using Addr = Register::Address<0x440c4118,0xfffffff8,0x00000000,unsigned>;
        ///TBIM0
    ...
    namespace Tb1Uc{    ///<TB Read Capture Register
        using Addr = Register::Address<0x440c411c,0xffff0000,0x00000000,unsigned>;
        ///UC
    ...
    namespace Tb1Rg0{    ///<TB RG0 Timer Register
        using Addr = Register::Address<0x440c4120,0xffff0000,0x00000000,unsigned>;
        ///TBRG0
    ...
    namespace Tb1Rg1{    ///<TB RG1 Timer Register
        using Addr = Register::Address<0x440c4124,0xffff0000,0x00000000,unsigned>;
        ///TBRG1
    ...
    namespace Tb1Cp0{    ///<TB CP0 Capture Register
        using Addr = Register::Address<0x440c4128,0xffff0000,0x00000000,unsigned>;
        ///TBCP0
    ...
    namespace Tb1Cp1{    ///<TB CP1 Capture Register
        using Addr = Register::Address<0x440c412c,0xffff0000,0x00000000,unsigned>;
        ///TBCP1
