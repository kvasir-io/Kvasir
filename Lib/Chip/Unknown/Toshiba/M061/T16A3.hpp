...
namespace Kvasir {
//16-bit TimerA
    namespace T16a3En{    ///<Enable Register
        using Addr = Register::Address<0x40090000,0xfffffffc,0x00000000,unsigned>;
        ///I2T16A
    ...
    namespace T16a3Run{    ///<RUN Register
        using Addr = Register::Address<0x40090004,0xfffffffe,0x00000000,unsigned>;
        ///RUN
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> run{}; 
    }
    namespace T16a3Cr{    ///<Control Register
        using Addr = Register::Address<0x40090008,0xffffff4e,0x00000000,unsigned>;
        ///CLK
    ...
    namespace T16a3Rg{    ///<Timer Register
        using Addr = Register::Address<0x4009000c,0xffff0000,0x00000000,unsigned>;
        ///RG
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> rg{}; 
    }
    namespace T16a3Cp{    ///<Capture Register
        using Addr = Register::Address<0x40090010,0xffff0000,0x00000000,unsigned>;
        ///CP
