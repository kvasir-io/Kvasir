...
//16-bit Deita sigma AD converter
    ...
    namespace Nonecr1{    ///<DSAD Control Register 1
        ...
        ///MODEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> moden{}; 
        ///BIASEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> biasen{}; 
    }
    ...
    namespace Nonecr3{    ///<DSAD Control Register 3
        ...
        ///REPEAT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> repeat{}; 
        ///ADSYNC
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> adsync{}; 
    }
    namespace Nonecr4{    ///<DSAD Control Register 4
        using Addr = Register::Address<0x44067014,0xfffffff8,0,unsigned>;
        ///DSGAIN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> dsgain{}; 
    }
    namespace Noneadj{    ///<DSAD Adjust Register
        using Addr = Register::Address<0x44067018,0x0000fffe,0,unsigned>;
        ///ADJ
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> adj{}; 
        ///OFFSET
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> offset{}; 
    }
    ...
    namespace Noneres{    ///<DSAD Result Register
        ...
        ///ADRF
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> adrf{}; 
        ///ADOVR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> adovr{}; 
        ///ADR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,8),Register::ReadWriteAccess,unsigned> adr{}; 
    }
}
