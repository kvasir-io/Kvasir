...
//General Purpose Input_Output Port (PJ)
    ...
    namespace Nonefr1{    ///<PJ Function Register 1
        ...
        ///PJ4F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pj4f1{}; 
        ///PJ5F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> pj5f1{}; 
    }
    namespace Nonefr2{    ///<PJ Function Register 2
        using Addr = Register::Address<0x400c090c,0xffffffcb,0,unsigned>;
        ///PJ2F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pj2f2{}; 
        ///PJ4F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pj4f2{}; 
        ///PJ5F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> pj5f2{}; 
    }
