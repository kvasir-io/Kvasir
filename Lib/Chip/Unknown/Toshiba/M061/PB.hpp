...
//General Purpose Input_Output Port (PB)
    ...
    namespace Nonecr{    ///<PB Control Register
        ...
        ///PB7C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7c{}; 
    }
    namespace Nonefr1{    ///<PB Function Register 1
        ...
        ///PB7F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7f1{}; 
    }
    namespace Noneod{    ///<PB Open Drain Control Register
        ...
        ///PB7OD
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7od{}; 
    }
    namespace Nonepup{    ///<PB Pull-Up Control Register
        ...
        ///PB7UP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7up{}; 
    }
    namespace Nonepdn{    ///<PB Pull-Down Control Register
        ...
        ///PB7DN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7dn{}; 
    }
    namespace Noneie{    ///<PB Input Enable Control Register
        ...
        ///PB7IE
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pb7ie{}; 
    }
}
