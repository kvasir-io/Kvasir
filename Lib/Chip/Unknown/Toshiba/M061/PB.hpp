...
namespace Kvasir {
    ...
    namespace Nonefr1{
        using Addr = Register::Address<0x400c0108,0xffffff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PB7F1; 
    }
    namespace Noneod{
    ...
    namespace Nonepdn{
        using Addr = Register::Address<0x400c0130,0xffffff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PB7DN; 
    }
    namespace Noneie{
