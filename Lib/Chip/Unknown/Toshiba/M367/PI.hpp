...
namespace Kvasir {
    ...
    namespace Nonefr1{
        using Addr = Register::Address<0x400c0808,0xfffffff0>;
    ...
    namespace Nonefr2{
        using Addr = Register::Address<0x400c080c,0xfffffff7>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PI3F2; 
    }
    namespace Noneod{
