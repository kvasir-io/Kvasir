...
namespace Kvasir {
    namespace Noneintsts{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> INT_SETUP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> INT_STATUS_NAK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> INT_STATUS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> INT_RX_ZERO; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> INT_SOF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> INT_EP0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> INT_EP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> INT_NAK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> INT_SUSPEND_RESUME; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> INT_USB_RESET; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> INT_USB_RESET_END; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> INT_MW_SET_ADD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> INT_MW_END_ADD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> INT_MW_TIMEOUT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> INT_MW_AHBERR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> INT_MR_END_ADD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> INT_MR_EP_DSET; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> INT_MR_AHBERR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> INT_UDC2_REG_RD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> INT_DMAC_REG_RD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> INT_POWERDETECT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29)> INT_MW_RERROR; 
    }
    namespace Noneintenb{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> MW_TIMEOUT_EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> MW_AHBERR_EN; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> MR_AHBERR_EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> UDC2_REG_RD_EN; 
    ...
    namespace Noneudc2rdvl{
        using Addr = Register::Address<0x40008020,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> UDC2RDATA; 
    }
