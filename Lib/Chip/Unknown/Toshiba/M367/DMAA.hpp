...
//DMA Controller
    namespace Nonestatus{    ///<DMA Status Register
        ...
        ///MASTER_ENABLE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> masterEnable{}; 
        namespace MasterenableValC{
        }
    }
    ...
    namespace Nonealtctrlbaseptr{    ///<DMA Channel Alternate Control Data Base Pointer Register
        ...
        ///ALT_CTRL_BASE_PTR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> altCtrlBasePtr{}; 
        namespace AltctrlbaseptrValC{
        }
    }
    namespace Nonechnlswrequest{    ///<DMA Channel Software Request Register
        ...
        ///CHNL_SW_REQUEST
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlSwRequest{}; 
        namespace ChnlswrequestValC{
        }
    }
    ...
    namespace Nonechnluseburstclr{    ///<DMA Channel Useburst Clear Register
        ...
        ///CHNL_USEBURST_CLR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlUseburstClr{}; 
        namespace ChnluseburstclrValC{
        }
    }
    ...
    namespace Nonechnlreqmaskclr{    ///<DMA Channel Request Mask Clear Register
        ...
        ///CHNL_REQ_MASK_CLR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlReqMaskClr{}; 
        namespace ChnlreqmaskclrValC{
        }
    }
    ...
    namespace Nonechnlenableclr{    ///<DMA Channel Enable Clear Register
        ...
        ///CHNL_ENABLE_CLR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlEnableClr{}; 
        namespace ChnlenableclrValC{
        }
    }
    ...
    namespace Nonechnlprialtclr{    ///<DMA Channel Primary-Alternate Clear Register
        ...
        ///CHNL_PRI_ALT_CLR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlPriAltClr{}; 
        namespace ChnlprialtclrValC{
        }
    }
    ...
    namespace Nonechnlpriorityclr{    ///<DMA Channel Priority Clear Register
        ...
        ///CHNL_PRIORITY_CLR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> chnlPriorityClr{}; 
        namespace ChnlpriorityclrValC{
        }
    }
