...
//Clock Generator (CG)
    ...
    namespace Noneimcgd{    ///<CG Interrupt Mode Control Register D
        ...
        namespace IntusbwkupenValC{
        }
        ///EMSTUSBWKUP
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> emstusbwkup{}; 
        namespace EmstusbwkupValC{
        }
        ///EMCGUSBWKUP
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,4),Register::ReadWriteAccess,unsigned> emcgusbwkup{}; 
        namespace EmcgusbwkupValC{
        }
        ///INTDEN
