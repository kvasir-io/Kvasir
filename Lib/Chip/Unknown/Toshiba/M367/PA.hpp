...
namespace Kvasir {
    ...
    namespace Nonefr2{
        using Addr = Register::Address<0x400c000c,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PA0F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> PA1F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PA2F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PA3F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PA4F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PA5F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> PA6F2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PA7F2; 
    }
    namespace Nonefr3{
        using Addr = Register::Address<0x400c0010,0xffffff17>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PA3F3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PA5F3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> PA6F3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PA7F3; 
    }
    namespace Nonefr4{
        using Addr = Register::Address<0x400c0014,0xffffff7f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PA7F4; 
    }
    namespace Nonefr5{
        using Addr = Register::Address<0x400c0018,0xffffff7f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PA7F5; 
    }
    namespace Noneod{
