...
//General Purpose Input_Output Port (PK)
    namespace Nonedata{    ///<PK Data Register
        ...
        ///PK4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4{}; 
    }
    namespace Nonecr{    ///<PK Control Register
        ...
        ///PK4C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4c{}; 
    }
    namespace Nonefr1{    ///<PK Function Register 1
        using Addr = Register::Address<0x400c0a08,0xffffffe0,0,unsigned>;
        ///PK0F1
        ...
        ///PK2F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pk2f1{}; 
        ///PK3F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pk3f1{}; 
        ///PK4F1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4f1{}; 
    }
    namespace Nonefr2{    ///<PK Function Register 2
        ...
        ///PK2F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pk2f2{}; 
        ///PK3F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pk3f2{}; 
        ///PK4F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4f2{}; 
    }
    namespace Nonefr3{    ///<PK Function Register 3
        ...
        ///PK4F3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4f3{}; 
    }
    namespace Nonefr4{    ///<PK Function Register 4
        using Addr = Register::Address<0x400c0a14,0xfffffffd,0,unsigned>;
        ///PK1F4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pk1f4{}; 
    }
    namespace Noneod{    ///<PK Open Drain Control Register
        ...
        ///PK2OD
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pk2od{}; 
        ///PK3OD
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pk3od{}; 
        ///PK4OD
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4od{}; 
    }
    namespace Nonepup{    ///<PK Pull-Up Control Register
        ...
        ///PK4UP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4up{}; 
    }
    namespace Nonepdn{    ///<PK Pull-Down Control Register
        ...
        ///PK2DN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pk2dn{}; 
        ///PK3DN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pk3dn{}; 
        ///PK4DN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4dn{}; 
    }
    namespace Noneie{    ///<PK Input Enable Control Register
        ...
        ///PK4IE
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pk4ie{}; 
    }
}
