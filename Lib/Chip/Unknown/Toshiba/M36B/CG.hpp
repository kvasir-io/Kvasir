...
//Clock Generator (CG)
    ...
    namespace CgOsccr{    ///<Oscillation Control Register
        using Addr = Register::Address<0x400f3004,0x000038f0,0x00000000,unsigned>;
        ///WUEON
    ...
    namespace CgFsysmsk{    ///<Peripheral Clock Stop Register
        using Addr = Register::Address<0x400f3020,0x00000000,0x00000000,unsigned>;
        ///MSK0
    ...
    namespace CgImcgd{    ///<CG Interrupt Mode Control Register D
        ...
        ///EMSTC
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> emstc{}; 
        ///EMCGC
