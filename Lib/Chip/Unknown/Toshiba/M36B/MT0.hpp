...
//16-bit Multi-Purpose Timer (MPT-TMR_IGBT)
    ...
    namespace Noneigcr{    ///<IGBT Control Register
        ...
        ///IGCLSYNC
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> igclsync{}; 
        ///IGPRD
    ...
    namespace Noneigtrg{    ///<IGBT Trigger Register
        ...
        ///IGTRG
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> igtrg{}; 
    }
}
