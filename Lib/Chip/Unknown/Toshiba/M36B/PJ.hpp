...
//General Purpose Input_Output Port (PJ)
    ...
    namespace PjFr1{    ///<PJ Function Register 1
        using Addr = Register::Address<0x400c0908,0xfffffff0,0x00000000,unsigned>;
        ///PJ0F1
    ...
    namespace PjFr2{    ///<PJ Function Register 2
        using Addr = Register::Address<0x400c090c,0xfffffff7,0x00000000,unsigned>;
        ///PJ3F2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pj3f2{}; 
    }
