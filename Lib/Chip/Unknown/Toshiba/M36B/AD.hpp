...
//Analog-to-Digital Converter (AD)
    ...
    namespace Nonereg00{    ///<AD Conversion Result Register 00
        ...
        ///ADRF_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> adrfMir{}; 
        ///ADOVRF_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> adovrfMir{}; 
        ///ADR_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,20),Register::ReadWriteAccess,unsigned> adrMir{}; 
    }
    ...
    namespace Noneregsp{    ///<AD Conversion Result Register SP
        ...
        ///ADSPRF_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> adsprfMir{}; 
        ///ADOVRSPF_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> adovrspfMir{}; 
        ///ADSPR_MIR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,20),Register::ReadWriteAccess,unsigned> adsprMir{}; 
    }
}
