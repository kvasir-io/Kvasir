...
//Serial Bus Interface (SBI)
    ...
    namespace Sbi1Cr2A{    ///<SBI Control Register 2 (I2C Mode)
    ...
    namespace Sbi1Cr2B{    ///<SBI Control Register 2 (SIO Mode)
        using Addr = Register::Address<0x400e0110,0xfffffff3,0x00000000,unsigned>;
        ///SBIM
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,2),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> sbim{}; 
    }
    namespace Sbi1SrA{    ///<SBI Status Register (I2C Mode)
        using Addr = Register::Address<0x400e0110,0xffffff00,0x00000000,unsigned>;
        ///LRB
    ...
    namespace Sbi1SrB{    ///<SBI Status Register (SIO Mode)
        using Addr = Register::Address<0x400e0110,0xfffffff3,0x00000000,unsigned>;
        ///SEF
