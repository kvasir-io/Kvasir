...
//16-bit Multi-Purpose Timer (MPT-TMR_IGBT)
    ...
    namespace Mt1Igcr{    ///<IGBT Control Register
        using Addr = Register::Address<0x400c7130,0xfffff800,0x00000000,unsigned>;
        ///IGCLK
    ...
    namespace Mt1Igtrg{    ///<IGBT Trigger Register
        using Addr = Register::Address<0x400c7158,0xffff0000,0x00000000,unsigned>;
        ///IGTRG
