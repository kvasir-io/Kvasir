...
//Real Time Clock (RTC)
    ...
    namespace NonemonthrB{    ///<RTC Month Column Register
        ...
        ///MO0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mo0{}; 
    }
    ...
    namespace Nonerestr{    ///<RTC Reset Register
        ...
        ///RSTALM
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> rstalm{}; 
        ///RSTTMR
