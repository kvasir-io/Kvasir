...
//Analog-to-Digital Converter (AD)
    ...
    namespace Nonemod7{    ///<AD Mode Control Register 7
        ...
        ///INTADDMA
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> intaddma{}; 
        ///INTADHPDMA
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> intadhpdma{}; 
    }
    namespace Nonecmpcr0{    ///<AD Monitoring Setting Register 0
        using Addr = Register::Address<0x40050024,0xfffff060,0,unsigned>;
        ///REGS0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> regs0{}; 
        ///ADBIG0
        ...
        ///CMPCNT0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> cmpcnt0{}; 
    }
    namespace Nonecmpcr1{    ///<AD Monitoring Setting Register 1
        using Addr = Register::Address<0x40050028,0xfffff060,0,unsigned>;
        ///REGS1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> regs1{}; 
        ///ADBIG1
        ...
        ///CMPCNT1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> cmpcnt1{}; 
    }
    ...
    namespace Nonereg00{    ///<AD Conversion Result Register 00
        ...
        ///ADPOSWF
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> adposwf{}; 
    }
    ...
    namespace Noneregsp{    ///<AD Conversion Result Register SP
        ...
        ///ADRSP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> adrsp{}; 
        ///SPADRARF
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> spadrarf{}; 
        ///SPOVRA
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> spovra{}; 
    }
}
