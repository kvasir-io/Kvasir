...
//16-bit Timer_Event Counter (TB)
    namespace Tb6En{    ///<TB Enable Register
        using Addr = Register::Address<0x400c4600,0xffffff3f,0x00000000,unsigned>;
        ///TBHALT
    ...
    namespace Tb6Run{    ///<TB RUN Register
        using Addr = Register::Address<0x400c4604,0xfffffffa,0x00000000,unsigned>;
        ///TBRUN
    ...
    namespace Tb6Cr{    ///<TB Control Register
        using Addr = Register::Address<0x400c4608,0xffffff40,0x00000000,unsigned>;
        ///CSSEL
    ...
    namespace Tb6Mod{    ///<TB Mode Register
        using Addr = Register::Address<0x400c460c,0xffffff80,0x00000000,unsigned>;
        ///TBCLK
    ...
    namespace Tb6Ffcr{    ///<TB Flip-Flop Control Register
        using Addr = Register::Address<0x400c4610,0xffffffc0,0x00000000,unsigned>;
        ///TBFF0C
    ...
    namespace Tb6St{    ///<TB Status Register
        using Addr = Register::Address<0x400c4614,0xfffffff8,0x00000000,unsigned>;
        ///INTTB0
    ...
    namespace Tb6Im{    ///<TB Interrupt Mask Register
        using Addr = Register::Address<0x400c4618,0xfffffff8,0x00000000,unsigned>;
        ///TBIM0
    ...
    namespace Tb6Uc{    ///<TB Read Capture Register
        using Addr = Register::Address<0x400c461c,0xffff0000,0x00000000,unsigned>;
        ///UC
    ...
    namespace Tb6Rg0{    ///<TB RG0 Timer Register
        using Addr = Register::Address<0x400c4620,0xffff0000,0x00000000,unsigned>;
        ///TBRG0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg0{}; 
    }
    namespace Tb6Rg1{    ///<TB RG1 Timer Register
        using Addr = Register::Address<0x400c4624,0xffff0000,0x00000000,unsigned>;
        ///TBRG1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg1{}; 
    }
    namespace Tb6Cp0{    ///<TB CP0 Capture Register
        using Addr = Register::Address<0x400c4628,0xffff0000,0x00000000,unsigned>;
        ///TBCP0
    ...
    namespace Tb6Cp1{    ///<TB CP1 Capture Register
        using Addr = Register::Address<0x400c462c,0xffff0000,0x00000000,unsigned>;
        ///TBCP1
    ...
    namespace Tb6Dma{    ///<TB DMA Enable Register
        using Addr = Register::Address<0x400c4630,0xfffffff8,0x00000000,unsigned>;
        ///TBDMAEN0
