...
namespace Kvasir {
    ...
    namespace Nonecr{
        using Addr = Register::Address<0x400c4008,0xffffff40>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> FT0SEL; 
    ...
    namespace Nonedma{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TBDMAEN0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TBDMAEN1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TBDMAEN2; 
    }
}
