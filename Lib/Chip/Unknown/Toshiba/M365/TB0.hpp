...
//16-bit Timer_Event Counter (TB)
    ...
    namespace Tb0Cr{    ///<TB Control Register
        using Addr = Register::Address<0x400c4008,0xffffff40,0x00000000,unsigned>;
        ///CSSEL
    ...
    namespace Tb0Dma{    ///<TB DMA Enable Register
        using Addr = Register::Address<0x400c4030,0xfffffff8,0x00000000,unsigned>;
        ///TBDMAEN0
