...
//16-bit Timer_Event Counter (TB)
    ...
    namespace Nonecr{    ///<TB Control Register
        using Addr = Register::Address<0x400c4008,0xffffff40,0,unsigned>;
        ///CSSEL
        ...
        ///FT0SEL
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ft0sel{}; 
        ///TBSYNC
    ...
    namespace Noneuc{    ///<TB Read Capture Register
        ...
        ///UC
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> uc{}; 
    }
    ...
    namespace Nonedma{    ///<TB DMA Enable Register
        ...
        ///TBDMAEN0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> tbdmaen0{}; 
        ///TBDMAEN1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tbdmaen1{}; 
        ///TBDMAEN2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> tbdmaen2{}; 
    }
}
