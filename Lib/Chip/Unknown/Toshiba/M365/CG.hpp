...
//Clock Generator (CG)
    ...
    namespace Noneosccr{    ///<Oscillation Control Register
        ...
        ///HWUPSEL
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> hwupsel{}; 
        ///WUODR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,20),Register::ReadWriteAccess,unsigned> wuodr{}; 
    }
    ...
    namespace Noneusbctl{    ///<USB Clock and Reset Control register
        ...
        ///USBCLKEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> usbclken{}; 
        ///USBCLKSEL
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> usbclksel{}; 
    }
