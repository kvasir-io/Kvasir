...
//16-bit Timer_Event Counter (TB)
    namespace Tb7En{    ///<TB Enable Register
        using Addr = Register::Address<0x400c4700,0xffffff3f,0x00000000,unsigned>;
        ///TBHALT
    ...
    namespace Tb7Run{    ///<TB RUN Register
        using Addr = Register::Address<0x400c4704,0xfffffffa,0x00000000,unsigned>;
        ///TBRUN
    ...
    namespace Tb7Cr{    ///<TB Control Register
        using Addr = Register::Address<0x400c4708,0xffffff40,0x00000000,unsigned>;
        ///CSSEL
    ...
    namespace Tb7Mod{    ///<TB Mode Register
        using Addr = Register::Address<0x400c470c,0xffffff80,0x00000000,unsigned>;
        ///TBCLK
    ...
    namespace Tb7Ffcr{    ///<TB Flip-Flop Control Register
        using Addr = Register::Address<0x400c4710,0xffffffc0,0x00000000,unsigned>;
        ///TBFF0C
    ...
    namespace Tb7St{    ///<TB Status Register
        using Addr = Register::Address<0x400c4714,0xfffffff8,0x00000000,unsigned>;
        ///INTTB0
    ...
    namespace Tb7Im{    ///<TB Interrupt Mask Register
        using Addr = Register::Address<0x400c4718,0xfffffff8,0x00000000,unsigned>;
        ///TBIM0
    ...
    namespace Tb7Uc{    ///<TB Read Capture Register
        using Addr = Register::Address<0x400c471c,0xffff0000,0x00000000,unsigned>;
        ///UC
    ...
    namespace Tb7Rg0{    ///<TB RG0 Timer Register
        using Addr = Register::Address<0x400c4720,0xffff0000,0x00000000,unsigned>;
        ///TBRG0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg0{}; 
    }
    namespace Tb7Rg1{    ///<TB RG1 Timer Register
        using Addr = Register::Address<0x400c4724,0xffff0000,0x00000000,unsigned>;
        ///TBRG1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg1{}; 
    }
    namespace Tb7Cp0{    ///<TB CP0 Capture Register
        using Addr = Register::Address<0x400c4728,0xffff0000,0x00000000,unsigned>;
        ///TBCP0
    ...
    namespace Tb7Cp1{    ///<TB CP1 Capture Register
        using Addr = Register::Address<0x400c472c,0xffff0000,0x00000000,unsigned>;
        ///TBCP1
    ...
    namespace Tb7Dma{    ///<TB DMA Enable Register
        using Addr = Register::Address<0x400c4730,0xfffffff8,0x00000000,unsigned>;
        ///TBDMAEN0
