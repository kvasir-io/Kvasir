...
//16-bit Timer_Event Counter (TB)
    namespace Tb8En{    ///<TB Enable Register
        using Addr = Register::Address<0x400c4800,0xffffff3f,0x00000000,unsigned>;
        ///TBHALT
    ...
    namespace Tb8Run{    ///<TB RUN Register
        using Addr = Register::Address<0x400c4804,0xfffffffa,0x00000000,unsigned>;
        ///TBRUN
    ...
    namespace Tb8Cr{    ///<TB Control Register
        using Addr = Register::Address<0x400c4808,0xffffff40,0x00000000,unsigned>;
        ///CSSEL
    ...
    namespace Tb8Mod{    ///<TB Mode Register
        using Addr = Register::Address<0x400c480c,0xffffff80,0x00000000,unsigned>;
        ///TBCLK
    ...
    namespace Tb8Ffcr{    ///<TB Flip-Flop Control Register
        using Addr = Register::Address<0x400c4810,0xffffffc0,0x00000000,unsigned>;
        ///TBFF0C
    ...
    namespace Tb8St{    ///<TB Status Register
        using Addr = Register::Address<0x400c4814,0xfffffff8,0x00000000,unsigned>;
        ///INTTB0
    ...
    namespace Tb8Im{    ///<TB Interrupt Mask Register
        using Addr = Register::Address<0x400c4818,0xfffffff8,0x00000000,unsigned>;
        ///TBIM0
    ...
    namespace Tb8Uc{    ///<TB Read Capture Register
        using Addr = Register::Address<0x400c481c,0xffff0000,0x00000000,unsigned>;
        ///UC
    ...
    namespace Tb8Rg0{    ///<TB RG0 Timer Register
        using Addr = Register::Address<0x400c4820,0xffff0000,0x00000000,unsigned>;
        ///TBRG0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg0{}; 
    }
    namespace Tb8Rg1{    ///<TB RG1 Timer Register
        using Addr = Register::Address<0x400c4824,0xffff0000,0x00000000,unsigned>;
        ///TBRG1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tbrg1{}; 
    }
    namespace Tb8Cp0{    ///<TB CP0 Capture Register
        using Addr = Register::Address<0x400c4828,0xffff0000,0x00000000,unsigned>;
        ///TBCP0
    ...
    namespace Tb8Cp1{    ///<TB CP1 Capture Register
        using Addr = Register::Address<0x400c482c,0xffff0000,0x00000000,unsigned>;
        ///TBCP1
    ...
    namespace Tb8Dma{    ///<TB DMA Enable Register
        using Addr = Register::Address<0x400c4830,0xfffffff8,0x00000000,unsigned>;
        ///TBDMAEN0
