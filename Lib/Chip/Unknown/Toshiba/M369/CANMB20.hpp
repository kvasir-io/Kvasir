...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb20Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005280,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb20Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005288,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb20Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005290,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb20Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005298,0x00000000,0x00000000,unsigned>;
        ///D4
