...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb27Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005360,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb27Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005368,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb27Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005370,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb27Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005378,0x00000000,0x00000000,unsigned>;
        ///D4
