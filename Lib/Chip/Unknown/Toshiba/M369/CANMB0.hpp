...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb0Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb0Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005008,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb0Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb0Dh{    ///<CAN Mailbox Register
