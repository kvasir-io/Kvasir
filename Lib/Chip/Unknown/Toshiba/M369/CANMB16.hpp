...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb16Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb16Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005208,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb16Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb16Dh{    ///<CAN Mailbox Register
