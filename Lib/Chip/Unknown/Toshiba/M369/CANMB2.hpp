...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb2Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb2Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005048,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb2Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb2Dh{    ///<CAN Mailbox Register
