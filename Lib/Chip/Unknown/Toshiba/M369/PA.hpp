...
//General Purpose Input_Output Port (PA)
    ...
    namespace Nonefr2{    ///<PA Function Register 2
        using Addr = Register::Address<0x400c000c,0xffffff00,0,unsigned>;
        ///PA0F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> pa0f2{}; 
        ///PA1F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pa1f2{}; 
        ///PA2F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> pa2f2{}; 
        ///PA3F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pa3f2{}; 
        ///PA4F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pa4f2{}; 
        ///PA5F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> pa5f2{}; 
        ///PA6F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> pa6f2{}; 
        ///PA7F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pa7f2{}; 
    }
    namespace Nonefr3{    ///<PA Function Register 3
        using Addr = Register::Address<0x400c0010,0xffffff17,0,unsigned>;
        ///PA3F3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pa3f3{}; 
        ///PA5F3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> pa5f3{}; 
        ///PA6F3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> pa6f3{}; 
        ///PA7F3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pa7f3{}; 
    }
    namespace Nonefr4{    ///<PA Function Register 4
        using Addr = Register::Address<0x400c0014,0xffffff7f,0,unsigned>;
        ///PA7F4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pa7f4{}; 
    }
    namespace Nonefr5{    ///<PA Function Register 5
        using Addr = Register::Address<0x400c0018,0xffffff7f,0,unsigned>;
        ///PA7F5
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pa7f5{}; 
    }
