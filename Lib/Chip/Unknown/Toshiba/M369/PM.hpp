...
//General Purpose Input_Output Port (PM)
    namespace PmData{    ///<PM Data Register
        using Addr = Register::Address<0x400c0c00,0xfffffff0,0x00000000,unsigned>;
        ///PM0
    ...
    namespace PmCr{    ///<PM Control Register
        using Addr = Register::Address<0x400c0c04,0xfffffff0,0x00000000,unsigned>;
        ///PM0C
    ...
    namespace PmFr1{    ///<PM Function Register 1
        using Addr = Register::Address<0x400c0c08,0xfffffff8,0x00000000,unsigned>;
        ///PM0F1
    ...
    namespace PmFr2{    ///<PM Function Register 2
        using Addr = Register::Address<0x400c0c0c,0xfffffff0,0x00000000,unsigned>;
        ///PM0F1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> pm0f1{}; 
        ///PM1F1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pm1f1{}; 
    ...
    namespace PmOd{    ///<PM Open Drain Control Register
        using Addr = Register::Address<0x400c0c28,0xfffffff0,0x00000000,unsigned>;
        ///PM0OD
    ...
    namespace PmPup{    ///<PM Pull-Up Control Register
        using Addr = Register::Address<0x400c0c2c,0xfffffff0,0x00000000,unsigned>;
        ///PM0UP
    ...
    namespace PmPdn{    ///<PM Pull-Down Control Register
        using Addr = Register::Address<0x400c0c30,0xfffffff0,0x00000000,unsigned>;
        ///PI0DN
    ...
    namespace PmIe{    ///<PM Input Enable Control Register
        using Addr = Register::Address<0x400c0c38,0xfffffff0,0x00000000,unsigned>;
        ///PM0IE
