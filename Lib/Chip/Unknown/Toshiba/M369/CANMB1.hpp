...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb1Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb1Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005028,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb1Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb1Dh{    ///<CAN Mailbox Register
