...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb4Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb4Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005088,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb4Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005090,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb4Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005098,0x00000000,0x00000000,unsigned>;
        ///D4
