...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb17Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb17Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005228,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb17Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb17Dh{    ///<CAN Mailbox Register
