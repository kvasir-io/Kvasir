...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb11Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb11Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005168,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb11Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005170,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb11Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005178,0x00000000,0x00000000,unsigned>;
        ///D4
