...
namespace Kvasir {
//Encoder Input (ENC)
    namespace En1Tncr{    ///<Encoder Input Control Register
        using Addr = Register::Address<0x400f7100,0xfff80000,0x00000000,unsigned>;
        ///ENDEV
    ...
    namespace En1Reload{    ///<Encoder Counter Reload Register
        using Addr = Register::Address<0x400f7104,0xffff0000,0x00000000,unsigned>;
        ///RELOAD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> reload{}; 
    }
    namespace En1Int{    ///<Encoder Compare Register
        using Addr = Register::Address<0x400f7108,0xff000000,0x00000000,unsigned>;
        ///INT
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,0),Register::ReadWriteAccess,unsigned> int_{}; 
    }
    namespace En1Cnt{    ///<Encoder Counter Register
        using Addr = Register::Address<0x400f710c,0xff000000,0x00000000,unsigned>;
        ///CNT
