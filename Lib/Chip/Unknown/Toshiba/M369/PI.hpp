...
//General Purpose Input_Output Port (PI)
    namespace Nonedata{    ///<PI Data Register
        ...
        ///PI7
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7{}; 
    }
    namespace Nonecr{    ///<PI Control Register
        ...
        ///PI7C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7c{}; 
    }
    ...
    namespace Nonefr2{    ///<PI Function Register 2
        ...
        ///PI3F2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pi3f2{}; 
    }
    namespace Noneod{    ///<PI Open Drain Control Register
        ...
        ///PI7OD
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7od{}; 
    }
    namespace Nonepup{    ///<PI Pull-Up Control Register
        ...
        ///PI7UP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7up{}; 
    }
    namespace Nonepdn{    ///<PI Pull-Down Control Register
        ...
        ///PI7DN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7dn{}; 
    }
    namespace Noneie{    ///<PI Input Enable Control Register
        ...
        ///PI7IE
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> pi7ie{}; 
    }
}
