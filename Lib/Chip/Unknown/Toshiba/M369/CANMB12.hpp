...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb12Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005180,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb12Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005188,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb12Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005190,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb12Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005198,0x00000000,0x00000000,unsigned>;
        ///D4
