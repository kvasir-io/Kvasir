...
//ARM Prime Cell PL011
    ...
    namespace Uart5Rsr{    ///<Receive Status Register
    ...
    namespace Uart5Ecr{    ///<Error Clear Register
        using Addr = Register::Address<0x40049004,0xfffffff0,0x00000000,unsigned>;
        ///FE
    ...
    namespace Uart5Fr{    ///<Flag Register
    ...
    namespace Uart5Ilpr{    ///<IrDA Low-power Counter register
    ...
    namespace Uart5Ibdr{    ///<Integer Baud Rate Register
    ...
    namespace Uart5Fbdr{    ///<Fractional Baud Rate Register
    ...
    namespace Uart5LcrH{    ///<Line Control Register
    ...
    namespace Uart5Cr{    ///<Cntrol Register
    ...
    namespace Uart5Ifls{    ///<Interrupt FIFO Level Select Register
    ...
    namespace Uart5Imsc{    ///<Interrupt Mask set_Clear Register
    ...
    namespace Uart5Ris{    ///<Raw Interrupt Status Register
    ...
    namespace Uart5Mis{    ///<Masked Interrupt Status Register
    ...
    namespace Uart5Icr{    ///<Interrupt Clear Register
    ...
    namespace Uart5Dmacr{    ///<DMA Control Register
