...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb25Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005320,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb25Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005328,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb25Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005330,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb25Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005338,0x00000000,0x00000000,unsigned>;
        ///D4
