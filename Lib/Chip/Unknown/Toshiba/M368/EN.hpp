...
namespace Kvasir {
//Encoder Input (ENC)
    namespace EnTncr{    ///<Encoder Input Control Register
    ...
    namespace EnReload{    ///<Encoder Counter Reload Register
    ...
    namespace EnInt{    ///<Encoder Compare Register
    ...
    namespace EnCnt{    ///<Encoder Counter Register
