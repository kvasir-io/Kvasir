...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb3Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005060,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb3Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005068,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb3Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005070,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb3Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005078,0x00000000,0x00000000,unsigned>;
        ///D4
