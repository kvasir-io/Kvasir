...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb10Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb10Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005148,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb10Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005150,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb10Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005158,0x00000000,0x00000000,unsigned>;
        ///D4
