...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb15Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051e0,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb15Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051e8,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb15Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051f0,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb15Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051f8,0x00000000,0x00000000,unsigned>;
        ///D4
