...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb18Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb18Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005248,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb18Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb18Dh{    ///<CAN Mailbox Register
