...
//General Purpose Input_Output Port (PH)
    ...
    namespace PhFr2{    ///<PH Function Register 2
        using Addr = Register::Address<0x400c070c,0xfffffff0,0x00000000,unsigned>;
        ///PH0F2
    ...
    namespace PhFr5{    ///<PH Function Register 5
        using Addr = Register::Address<0x400c0718,0xfffffff0,0x00000000,unsigned>;
        ///PH0F5
    ...
    namespace PhIe{    ///<PH Input Enable Control Register
        using Addr = Register::Address<0x400c0738,0xfffffff0,0x00000000,unsigned>;
        ///PH0IE
