...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb19Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb19Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005268,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb19Dl{    ///<CAN Mailbox Register
    ...
    namespace Canmb19Dh{    ///<CAN Mailbox Register
