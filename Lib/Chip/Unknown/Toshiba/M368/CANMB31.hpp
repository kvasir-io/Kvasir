...
namespace Kvasir {
    namespace Noneid{
        using Addr = Register::Address<0x400053e0,0x00000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> LAME; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31)> IDE; 
    }
    namespace Nonetsvmcf{
        using Addr = Register::Address<0x400053e8,0x0000ffe0>;
    ...
    namespace Nonedl{
        using Addr = Register::Address<0x400053f0,0x00000000>;
    ...
    namespace Nonedh{
        using Addr = Register::Address<0x400053f8,0x00000000>;
