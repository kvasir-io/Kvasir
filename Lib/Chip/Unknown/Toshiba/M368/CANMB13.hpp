...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb13Id{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051a0,0x00000000,0x00000000,unsigned>;
        ///ID
    ...
    namespace Canmb13Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051a8,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb13Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051b0,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb13Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x400051b8,0x00000000,0x00000000,unsigned>;
        ///D4
