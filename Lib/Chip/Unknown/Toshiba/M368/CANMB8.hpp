...
//CAN Controller (TXCAN) Mailbox RAM
    namespace Canmb8Id{    ///<CAN Mailbox Register
    ...
    namespace Canmb8Tsvmcf{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005108,0x0000ffe0,0x00000000,unsigned>;
        ///DLC
    ...
    namespace Canmb8Dl{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005110,0x00000000,0x00000000,unsigned>;
        ///D0
    ...
    namespace Canmb8Dh{    ///<CAN Mailbox Register
        using Addr = Register::Address<0x40005118,0x00000000,0x00000000,unsigned>;
        ///D4
