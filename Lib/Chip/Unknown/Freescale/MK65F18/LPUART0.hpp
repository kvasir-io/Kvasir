...
namespace Kvasir {
    namespace LPUART0_baud{
        using Addr = Register::Address<0x400c4000,0x00500000>;
    ...
    namespace LPUART0_stat{
        using Addr = Register::Address<0x400c4004,0x00003fff>;
    ...
    namespace LPUART0_ctrl{
        using Addr = Register::Address<0x400c4008,0x00003800>;
    ...
    namespace LPUART0_data{
        using Addr = Register::Address<0x400c400c,0xffff0400>;
    ...
    namespace LPUART0_match{
        using Addr = Register::Address<0x400c4010,0xfc00fc00>;
    ...
    namespace LPUART0_modir{
        using Addr = Register::Address<0x400c4014,0xfff8ffc0>;
