...
//FlexTimer Module
    namespace Ftm3Sc{    ///<Status And Control
        using Addr = Register::Address<0x400b9000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Cnt{    ///<Counter
        using Addr = Register::Address<0x400b9004,0x00000000,0x00000000,unsigned>;
        ///Counter Value
    ...
    namespace Ftm3Mod{    ///<Modulo
        using Addr = Register::Address<0x400b9008,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm3Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x400b904c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm3Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x400b9050,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
    ...
    namespace Ftm3Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x400b9054,0x00000000,0x00000000,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm3Sync{    ///<Synchronization
        using Addr = Register::Address<0x400b9058,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x400b905c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Outmask{    ///<Output Mask
        using Addr = Register::Address<0x400b9060,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x400b9064,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x400b9068,0x00000000,0x00000000,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm3Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x400b906c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x400b9070,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm3Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x400b9074,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x400b9078,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x400b907c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x400b9080,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Conf{    ///<Configuration
        using Addr = Register::Address<0x400b9084,0x00000000,0x00000000,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm3Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x400b9088,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x400b908c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x400b9090,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x400b9094,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm3Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x400b9098,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Select
    ...
    namespace Ftm3C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b900c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm3C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b9014,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b901c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b9024,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b902c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b9034,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C6sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b903c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C7sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x400b9044,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9010,0x00000000,0x00000000,unsigned>;
        ///Channel Value
    ...
    namespace Ftm3C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9018,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C2v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9020,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9028,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C4v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9030,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9038,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C6v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9040,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm3C7v{    ///<Channel (n) Value
        using Addr = Register::Address<0x400b9048,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
