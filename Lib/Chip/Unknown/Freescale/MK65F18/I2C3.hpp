...
//Inter-Integrated Circuit
    namespace I2c3A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x400e7000,0xffffff01,0,unsigned char>;
        ///Address
    ...
    namespace I2c3F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x400e7001,0xffffff00,0,unsigned char>;
        ///ClockRate
    ...
    namespace I2c3C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x400e7002,0xffffff00,0,unsigned char>;
        ///DMA Enable
        enum class DmaenVal {
    ...
    namespace I2c3S{    ///<I2C Status register
        using Addr = Register::Address<0x400e7003,0xffffff00,0,unsigned char>;
        ///Receive Acknowledge
        enum class RxakVal {
    ...
    namespace I2c3D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x400e7004,0xffffff00,0,unsigned char>;
        ///Data
    ...
    namespace I2c3C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x400e7005,0xffffff00,0,unsigned char>;
        ///Slave Address
    ...
    namespace I2c3Flt{    ///<I2C Programmable Input Glitch Filter register
        using Addr = Register::Address<0x400e7006,0xffffff00,0,unsigned char>;
    ...
    namespace I2c3Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x400e7007,0xffffff01,0,unsigned char>;
        ///Range Slave Address
    ...
    namespace I2c3Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x400e7008,0xffffff00,0,unsigned char>;
    ...
    namespace I2c3A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x400e7009,0xffffff01,0,unsigned char>;
        ///SMBus Address
    ...
    namespace I2c3Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x400e700a,0xffffff00,0,unsigned char>;
    ...
    namespace I2c3Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x400e700b,0xffffff00,0,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
