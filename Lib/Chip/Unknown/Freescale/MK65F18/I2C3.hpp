...
namespace Kvasir {
    namespace I2C3_a1{
        using Addr = Register::Address<0x400e7000,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> AD; 
    }
    namespace I2C3_f{
        using Addr = Register::Address<0x400e7001,0xffffff00>;
    ...
    namespace I2C3_c1{
        using Addr = Register::Address<0x400e7002,0xffffff00>;
    ...
    namespace I2C3_s{
        using Addr = Register::Address<0x400e7003,0xffffff00>;
    ...
    namespace I2C3_d{
        using Addr = Register::Address<0x400e7004,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> DATA; 
    }
    namespace I2C3_c2{
        using Addr = Register::Address<0x400e7005,0xffffff00>;
    ...
    namespace I2C3_flt{
        using Addr = Register::Address<0x400e7006,0xffffff00>;
    ...
    namespace I2C3_ra{
        using Addr = Register::Address<0x400e7007,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> RAD; 
    }
    namespace I2C3_smb{
        using Addr = Register::Address<0x400e7008,0xffffff00>;
    ...
    namespace I2C3_a2{
        using Addr = Register::Address<0x400e7009,0xffffff01>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> SAD; 
    }
    namespace I2C3_slth{
        using Addr = Register::Address<0x400e700a,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> SSLT; 
    }
    namespace I2C3_sltl{
        using Addr = Register::Address<0x400e700b,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> SSLT; 
    }
}
