...
//Inter-Integrated Circuit
    namespace I2c2A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x400e6000,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace I2c2Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x400e6007,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///Range Slave Address
    ...
    namespace I2c2A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x400e6009,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///SMBus Address
