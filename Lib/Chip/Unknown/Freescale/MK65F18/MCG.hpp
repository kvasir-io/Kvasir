...
namespace Kvasir {
    ...
    namespace MCG_c5{
        using Addr = Register::Address<0x40064004,0xffffff98>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> PRDIV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PLLSTEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> PLLCLKEN; 
    }
    namespace MCG_c6{
        using Addr = Register::Address<0x40064005,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> VDIV; 
    ...
    namespace MCG_c9{
        using Addr = Register::Address<0x4006400e,0xffffffce>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> EXT_PLL_LOCS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PLL_LOCRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PLL_CME; 
    }
    namespace MCG_c11{
        using Addr = Register::Address<0x40064010,0xffffffef>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PLLCS; 
    }
    namespace MCG_s2{
        using Addr = Register::Address<0x40064012,0xffffffef>;
