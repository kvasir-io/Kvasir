...
//Inter-IC Sound / Synchronous Audio Interface
    ...
    namespace I2s0Tcr3{    ///<SAI Transmit Configuration 3 Register
        using Addr = Register::Address<0x4002f00c,0xfcfcffe0,0,unsigned>;
        ...
        enum class cfrVal {
            v0=0x00000000,     ///<No effect.
            v1=0x00000001,     ///<Transmit data channel N FIFO is reset.
        };
        namespace cfrValC{
            constexpr MPL::Value<cfrVal,cfrVal::v0> v0{};
            constexpr MPL::Value<cfrVal,cfrVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24),Register::ReadWriteAccess,cfrVal> cfr{}; 
    }
    namespace I2s0Tcr4{    ///<SAI Transmit Configuration 4 Register
        using Addr = Register::Address<0x4002f010,0xe0e0e0e0,0,unsigned>;
        ...
        namespace ondemValC{
            constexpr MPL::Value<ondemVal,ondemVal::v0> v0{};
            constexpr MPL::Value<ondemVal,ondemVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,ondemVal> ondem{}; 
        ///Frame Sync Early
        enum class fseVal {
        ...
        namespace fpackValC{
            constexpr MPL::Value<fpackVal,fpackVal::v00> v00{};
            constexpr MPL::Value<fpackVal,fpackVal::v01> v01{};
            constexpr MPL::Value<fpackVal,fpackVal::v10> v10{};
            constexpr MPL::Value<fpackVal,fpackVal::v11> v11{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24),Register::ReadWriteAccess,fpackVal> fpack{}; 
        ///FIFO Combine Mode
        enum class fcombVal {
        ...
        namespace fcombValC{
            constexpr MPL::Value<fcombVal,fcombVal::v00> v00{};
            constexpr MPL::Value<fcombVal,fcombVal::v01> v01{};
            constexpr MPL::Value<fcombVal,fcombVal::v10> v10{};
            constexpr MPL::Value<fcombVal,fcombVal::v11> v11{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26),Register::ReadWriteAccess,fcombVal> fcomb{}; 
        ...
        namespace fcontValC{
            constexpr MPL::Value<fcontVal,fcontVal::v0> v0{};
            constexpr MPL::Value<fcontVal,fcontVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,fcontVal> fcont{}; 
    }
    ...
    namespace I2s0Tfr0{    ///<SAI Transmit FIFO Register
        using Addr = Register::Address<0x4002f040,0x7ff0fff0,0,unsigned>;
        ///Read FIFO Pointer
        ...
        namespace wcpValC{
            constexpr MPL::Value<wcpVal,wcpVal::v0> v0{};
            constexpr MPL::Value<wcpVal,wcpVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,wcpVal> wcp{}; 
    }
    namespace I2s0Tfr1{    ///<SAI Transmit FIFO Register
        using Addr = Register::Address<0x4002f044,0x7ff0fff0,0,unsigned>;
        ///Read FIFO Pointer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> rfp{}; 
        ///Write FIFO Pointer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> wfp{}; 
    ...
    namespace I2s0Rcr3{    ///<SAI Receive Configuration 3 Register
        using Addr = Register::Address<0x4002f08c,0xfcfcffe0,0,unsigned>;
        ///Word Flag Configuration
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> wdfl{}; 
        ...
        enum class cfrVal {
            v0=0x00000000,     ///<No effect.
            v1=0x00000001,     ///<Receive data channel N FIFO is reset.
        };
        namespace cfrValC{
            constexpr MPL::Value<cfrVal,cfrVal::v0> v0{};
            constexpr MPL::Value<cfrVal,cfrVal::v1> v1{};
    ...
    namespace I2s0Rcr4{    ///<SAI Receive Configuration 4 Register
        using Addr = Register::Address<0x4002f090,0xe0e0e0e0,0,unsigned>;
        ///Frame Sync Direction
        enum class fsdVal {
            v0=0x00000000,     ///<Frame Sync is generated externally in Slave mode.
            v1=0x00000001,     ///<Frame Sync is generated internally in Master mode.
    ...
    namespace I2s0Rfr0{    ///<SAI Receive FIFO Register
        using Addr = Register::Address<0x4002f0c0,0xfff07ff0,0,unsigned>;
        ///Read FIFO Pointer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> rfp{}; 
        ...
        namespace rcpValC{
            constexpr MPL::Value<rcpVal,rcpVal::v0> v0{};
            constexpr MPL::Value<rcpVal,rcpVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,rcpVal> rcp{}; 
        ///Write FIFO Pointer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> wfp{}; 
    }
    namespace I2s0Rfr1{    ///<SAI Receive FIFO Register
        using Addr = Register::Address<0x4002f0c4,0xfff07ff0,0,unsigned>;
        ///Read FIFO Pointer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> rfp{}; 
        ///Receive Channel Pointer
        enum class rcpVal {
