...
//USB HS/FS/LS OTG Controller
    ...
    namespace UsbhsHwgeneral{    ///<General Hardware Parameters Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,PhywVal> phyw{}; 
        namespace PhywValC{
            constexpr Register::FieldValue<decltype(phyw),PhywVal::v01> v01{};
        }
        ///PHY Mode
        ...
        namespace SmValC{
            constexpr Register::FieldValue<decltype(sm),SmVal::v00> v00{};
        }
    }
    ...
    namespace UsbhsPortsc1{    ///<Port Status and Control Registers
        ...
        namespace PtsValC{
            constexpr Register::FieldValue<decltype(pts),PtsVal::v000> v000{};
        }
    }
    ...
    namespace UsbhsUsbmode{    ///<USB Mode Register
        ...
        namespace CmValC{
            ...
            constexpr Register::FieldValue<decltype(cm),CmVal::v01> v01{};
