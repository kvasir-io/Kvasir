...
namespace Kvasir {
    ...
    namespace SIM_usbphyctl{
        using Addr = Register::Address<0x40047008,0xff0ffcff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> USBVREGSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> USBVREGPD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,20)> USB3VOUTTRG; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> USBDISILIM; 
    }
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xc0c0ec0c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> USBSLSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> USBREGEN; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> RMIISRC; 
    ...
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0x0083eee0>;
    ...
    namespace SIM_sopt5{
        using Addr = Register::Address<0x40048010,0xfff0ff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16)> LPUART0TXSRC; 
    ...
    namespace SIM_sopt8{
        using Addr = Register::Address<0x4004801c,0x0000fff0>;
    ...
    namespace SIM_sopt9{
        using Addr = Register::Address<0x40048020,0xf9c3ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18)> TPM1CH0SRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20)> TPM2CH0SRC; 
    ...
    namespace SIM_scgc1{
        using Addr = Register::Address<0x40048028,0xfffffb3f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> I2C2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> I2C3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> UART4; 
    }
    namespace SIM_scgc2{
        using Addr = Register::Address<0x4004802c,0xffffc9ee>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> ENET; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> LPUART0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> TPM1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> TPM2; 
    ...
    namespace SIM_scgc3{
        using Addr = Register::Address<0x40048030,0xf4fdefe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RNGA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> USBHS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> USBHSPHY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> USBHSDCD; 
    ...
    namespace SIM_scgc5{
        using Addr = Register::Address<0x40048038,0xffffc1de>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x501b4dec>;
    ...
    namespace SIM_scgc7{
        using Addr = Register::Address<0x40048040,0xfffffff0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> SDRAMC; 
    }
    ...
    namespace SIM_clkdiv3{
        using Addr = Register::Address<0x40048064,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PLLFLLFRAC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,1)> PLLFLLDIV; 
    }
    namespace SIM_clkdiv4{
        using Addr = Register::Address<0x40048068,0xfffffff0>;
