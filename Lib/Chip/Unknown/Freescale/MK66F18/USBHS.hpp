...
//USB HS/FS/LS OTG Controller
    ...
    namespace UsbhsHwgeneral{    ///<General Hardware Parameters Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,4),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,PhywVal> phyw{}; 
        namespace PhywValC{
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,9),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,SmVal> sm{}; 
        namespace SmValC{
    ...
    namespace UsbhsUsbSbuscfg{    ///<System Bus Interface Configuration Register
        using Addr = Register::Address<0x400a1090,0x00000000,0x00000000,unsigned>;
        ///Burst mode
    ...
    namespace UsbhsHciversion{    ///<Host Controller Interface Version and Capability Registers Length Register
        using Addr = Register::Address<0x400a1100,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsHcsparams{    ///<Host Controller Structural Parameters Register
        using Addr = Register::Address<0x400a1104,0x00000000,0x00000000,unsigned>;
        ///Number of Ports
    ...
    namespace UsbhsHccparams{    ///<Host Controller Capability Parameters Register
        using Addr = Register::Address<0x400a1108,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsDciversion{    ///<Device Controller Interface Version
        using Addr = Register::Address<0x400a1122,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace UsbhsDccparams{    ///<Device Controller Capability Parameters
        using Addr = Register::Address<0x400a1124,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsUsbcmd{    ///<USB Command Register
        using Addr = Register::Address<0x400a1140,0x00000000,0x00000000,unsigned>;
        ///Run/Stop
    ...
    namespace UsbhsUsbsts{    ///<USB Status Register
        using Addr = Register::Address<0x400a1144,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsUsbintr{    ///<USB Interrupt Enable Register
        using Addr = Register::Address<0x400a1148,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsFrindex{    ///<Frame Index Register
        using Addr = Register::Address<0x400a114c,0x00000000,0x00000000,unsigned>;
        ///Frame Index
    ...
    namespace UsbhsDeviceaddr{    ///<Device Address Register
        using Addr = Register::Address<0x400a1154,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace UsbhsEplistaddr{    ///<Endpoint List Address Register
        using Addr = Register::Address<0x400a1158,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace UsbhsTtctrl{    ///<Host TT Asynchronous Buffer Control
        using Addr = Register::Address<0x400a115c,0x00000000,0x00000000,unsigned>;
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///TT Hub Address
    ...
    namespace UsbhsBurstsize{    ///<Master Interface Data Burst Size Register
        using Addr = Register::Address<0x400a1160,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsTxfilltuning{    ///<Transmit FIFO Tuning Control Register
        using Addr = Register::Address<0x400a1164,0x00000000,0x00000000,unsigned>;
        ///Scheduler Overhead
    ...
    namespace UsbhsEndptnak{    ///<Endpoint NAK Register
        using Addr = Register::Address<0x400a1178,0x00000000,0x00000000,unsigned>;
        ///RX Endpoint NAK
    ...
    namespace UsbhsEndptnaken{    ///<Endpoint NAK Enable Register
        using Addr = Register::Address<0x400a117c,0x00000000,0x00000000,unsigned>;
        ///RX Endpoint NAK
    ...
    namespace UsbhsConfigflag{    ///<Configure Flag Register
        using Addr = Register::Address<0x400a1180,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace UsbhsPortsc1{    ///<Port Status and Control Registers
        using Addr = Register::Address<0x400a1184,0x00000000,0x00000000,unsigned>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(25,25),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> pts2{}; 
        ///Port Speed
        enum class PspdVal {
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,30),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,PtsVal> pts{}; 
        namespace PtsValC{
    ...
    namespace UsbhsOtgsc{    ///<On-the-Go Status and Control Register
        using Addr = Register::Address<0x400a11a4,0x00000000,0x00000000,unsigned>;
        ///VBUS Discharge
    ...
    namespace UsbhsUsbmode{    ///<USB Mode Register
        using Addr = Register::Address<0x400a11a8,0x00000000,0x00000000,unsigned>;
        ///Controller Mode
        enum class CmVal {
    ...
    namespace UsbhsEpsetupsr{    ///<Endpoint Setup Status Register
        using Addr = Register::Address<0x400a11ac,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsEpprime{    ///<Endpoint Initialization Register
        using Addr = Register::Address<0x400a11b0,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsEpflush{    ///<Endpoint Flush Register
        using Addr = Register::Address<0x400a11b4,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsEpsr{    ///<Endpoint Status Register
        using Addr = Register::Address<0x400a11b8,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsEpcomplete{    ///<Endpoint Complete Register
        using Addr = Register::Address<0x400a11bc,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsEpcr0{    ///<Endpoint Control Register 0
        using Addr = Register::Address<0x400a11c0,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
    ...
    namespace UsbhsUsbgenctrl{    ///<USB General Control Register
        using Addr = Register::Address<0x400a1200,0x00000000,0x00000000,unsigned>;
    ...
    namespace UsbhsGptimer0ld{    ///<General Purpose Timer n Load Register
        using Addr = Register::Address<0x400a1080,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace UsbhsGptimer1ld{    ///<General Purpose Timer n Load Register
        using Addr = Register::Address<0x400a1088,0x00000000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,0),Register::ReadWriteAccess,unsigned> gptld{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,24),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace UsbhsGptimer0ctl{    ///<General Purpose Timer n Control Register
        using Addr = Register::Address<0x400a1084,0x00000000,0x00000000,unsigned>;
        ///Timer Count
    ...
    namespace UsbhsGptimer1ctl{    ///<General Purpose Timer n Control Register
        using Addr = Register::Address<0x400a108c,0x00000000,0x00000000,unsigned>;
        ///Timer Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> gptcnt{}; 
        ///Timer Mode
        enum class ModeVal {
    ...
    namespace UsbhsEpcr1{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11c4,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr2{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11c8,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr3{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11cc,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr4{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11d0,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr5{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11d4,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr6{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11d8,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
    ...
    namespace UsbhsEpcr7{    ///<Endpoint Control Register n
        using Addr = Register::Address<0x400a11dc,0x00000000,0x00000000,unsigned>;
        ///RX endpoint Stall
        enum class RxsVal {
            v0=0x00000000,     ///<Endpoint OK
            v1=0x00000001,     ///<Endpoint stalled
