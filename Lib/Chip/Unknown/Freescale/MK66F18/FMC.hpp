...
//Flash Memory Controller-greg
    ...
    namespace FmcPfb01cr{    ///<Flash Bank 0-1 Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rfu{}; 
        ...
        namespace b0mwValC{
            ...
            constexpr MPL::Value<b0mwVal,b0mwVal::v11> v11{};
        }
    ...
    namespace FmcPfb23cr{    ///<Flash Bank 2-3 Control Register
        ...
        namespace b1mwValC{
            ...
            constexpr MPL::Value<b1mwVal,b1mwVal::v10> v10{};
            constexpr MPL::Value<b1mwVal,b1mwVal::v11> v11{};
        }
    ...
    namespace FmcTagvdw0s0{    ///<Cache Tag Storage
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,6),Register::ReadWriteAccess,unsigned> tag{}; 
    }
