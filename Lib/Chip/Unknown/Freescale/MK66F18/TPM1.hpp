...
//Timer/PWM Module
    namespace Tpm1Sc{    ///<Status and Control
        ...
        namespace CmodValC{
            ...
            constexpr Register::FieldValue<decltype(cmod),CmodVal::v11> v11{};
        }
    ...
    namespace Tpm1Combine{    ///<Combine Channel Register
        ...
        namespace Comswap0ValC{
            constexpr Register::FieldValue<decltype(comswap0),Comswap0Val::v0> v0{};
            constexpr Register::FieldValue<decltype(comswap0),Comswap0Val::v1> v1{};
        }
    }
