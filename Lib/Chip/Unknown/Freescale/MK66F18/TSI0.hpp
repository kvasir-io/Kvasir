...
//Touch sense input
    namespace Tsi0Gencs{    ///<TSI General Control and Status Register
        ...
        namespace eosdmeoValC{
            constexpr MPL::Value<eosdmeoVal,eosdmeoVal::v0> v0{};
            constexpr MPL::Value<eosdmeoVal,eosdmeoVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,eosdmeoVal> eosdmeo{}; 
        ///CURSW
        enum class curswVal {
