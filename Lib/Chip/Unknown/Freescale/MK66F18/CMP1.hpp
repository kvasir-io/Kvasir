...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    ...
    namespace Cmp1Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40073009,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp1Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x4007300b,0xffffffa0,0,unsigned char>;
    ...
    namespace Cmp1Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x4007300d,0xffffff40,0,unsigned char>;
        ...
        namespace pstmValC{
            constexpr MPL::Value<pstmVal,pstmVal::v0> v0{};
            constexpr MPL::Value<pstmVal,pstmVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,pstmVal> pstm{}; 
    }
}
