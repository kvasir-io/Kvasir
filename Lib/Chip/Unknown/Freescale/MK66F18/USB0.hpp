...
//Universal Serial Bus, OTG Capable Controller
    ...
    namespace Usb0Istat{    ///<Interrupt Status register
        ...
        namespace AttachValC{
            constexpr Register::FieldValue<decltype(attach),AttachVal::v0> v0{};
            constexpr Register::FieldValue<decltype(attach),AttachVal::v1> v1{};
        }
        ///Stall Interrupt
    ...
    namespace Usb0Endpt0{    ///<Endpoint Control register
        ...
        namespace HostwohubValC{
            constexpr Register::FieldValue<decltype(hostwohub),HostwohubVal::v0> v0{};
            constexpr Register::FieldValue<decltype(hostwohub),HostwohubVal::v1> v1{};
        }
    }
