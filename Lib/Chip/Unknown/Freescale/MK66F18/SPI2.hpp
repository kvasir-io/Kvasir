...
namespace Kvasir {
    namespace SPI2_mcr{
        using Addr = Register::Address<0x400ac000,0x00c000fe>;
    ...
    namespace SPI2_tcr{
        using Addr = Register::Address<0x400ac008,0x0000ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> SPI_TCNT; 
    }
    namespace SPI2_ctar_slave{
        using Addr = Register::Address<0x400ac00c,0x01ffffff>;
    ...
    namespace SPI2_ctar0{
        using Addr = Register::Address<0x400ac00c,0x00000000>;
    ...
    namespace SPI2_ctar1{
        using Addr = Register::Address<0x400ac010,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> BR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,4)> DT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8)> ASC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12)> CSSCK; 
    ...
    namespace SPI2_sr{
        using Addr = Register::Address<0x400ac02c,0x25f50000>;
    ...
    namespace SPI2_rser{
        using Addr = Register::Address<0x400ac030,0x64f4ffff>;
    ...
    namespace SPI2_pushr{
        using Addr = Register::Address<0x400ac034,0x03c00000>;
    ...
    namespace SPI2_pushr_slave{
        using Addr = Register::Address<0x400ac034,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> TXDATA; 
    }
    namespace SPI2_popr{
        using Addr = Register::Address<0x400ac038,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RXDATA; 
    }
    namespace SPI2_txfr0{
        using Addr = Register::Address<0x400ac03c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> TXDATA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> TXCMD_TXDATA; 
    }
    namespace SPI2_txfr1{
        using Addr = Register::Address<0x400ac040,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> TXDATA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> TXCMD_TXDATA; 
    }
    namespace SPI2_txfr2{
        using Addr = Register::Address<0x400ac044,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> TXDATA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> TXCMD_TXDATA; 
    }
    namespace SPI2_txfr3{
        using Addr = Register::Address<0x400ac048,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> TXDATA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> TXCMD_TXDATA; 
    }
    namespace SPI2_rxfr0{
        using Addr = Register::Address<0x400ac07c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RXDATA; 
    }
    namespace SPI2_rxfr1{
        using Addr = Register::Address<0x400ac080,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RXDATA; 
    }
    namespace SPI2_rxfr2{
        using Addr = Register::Address<0x400ac084,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RXDATA; 
    }
    namespace SPI2_rxfr3{
        using Addr = Register::Address<0x400ac088,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RXDATA; 
    }
}
