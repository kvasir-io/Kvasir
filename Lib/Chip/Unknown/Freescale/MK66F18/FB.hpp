...
//FlexBus external bus interface
    namespace FbCspmcr{    ///<Chip Select port Multiplexing Control Register
        using Addr = Register::Address<0x4000c060,0x00000000,0x00000000,unsigned>;
    ...
    namespace FbCsmr5{    ///<Chip Select Mask Register
        using Addr = Register::Address<0x4000c040,0x00000000,0x00000000,unsigned>;
        ///Valid
        enum class VVal {
            v0=0x00000000,     ///<Chip-select is invalid.
            v1=0x00000001,     ///<Chip-select is valid.
    ...
    namespace FbCscr5{    ///<Chip Select Control Register
        using Addr = Register::Address<0x4000c044,0x00000000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///Burst-Write Enable
        enum class BstwVal {
