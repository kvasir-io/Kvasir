...
namespace Kvasir {
    ...
    namespace I2S0_tcr3{
        using Addr = Register::Address<0x4002f00c,0xfcfcffe0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24)> CFR; 
    }
    namespace I2S0_tcr4{
        using Addr = Register::Address<0x4002f010,0xe0e0e0e0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26)> FCOMB; 
    ...
    namespace I2S0_tdr1{
        using Addr = Register::Address<0x4002f024,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> TDR; 
    }
    namespace I2S0_tfr0{
        using Addr = Register::Address<0x4002f040,0x7ff0fff0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31)> WCP; 
    }
    namespace I2S0_tfr1{
        using Addr = Register::Address<0x4002f044,0x7ff0fff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> RFP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16)> WFP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31)> WCP; 
    }
    namespace I2S0_tmr{
        using Addr = Register::Address<0x4002f060,0x00000000>;
    ...
    namespace I2S0_rcr3{
        using Addr = Register::Address<0x4002f08c,0xfcfcffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> WDFL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16)> RCE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,24)> CFR; 
    }
    namespace I2S0_rcr4{
        using Addr = Register::Address<0x4002f090,0xe0e0e0e0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> FSD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> FSP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ONDEM; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> FSE; 
    ...
    namespace I2S0_rdr1{
        using Addr = Register::Address<0x4002f0a4,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> RDR; 
    }
    namespace I2S0_rfr0{
        using Addr = Register::Address<0x4002f0c0,0xfff07ff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> RFP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> RCP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16)> WFP; 
    }
    namespace I2S0_rfr1{
        using Addr = Register::Address<0x4002f0c4,0xfff07ff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> RFP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> RCP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16)> WFP; 
    }
    namespace I2S0_rmr{
        using Addr = Register::Address<0x4002f0e0,0x00000000>;
