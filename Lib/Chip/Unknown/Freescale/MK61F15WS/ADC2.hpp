...
//Analog-to-Digital Converter
    ...
    namespace Adc2Sc1b{    ///<ADC status and control registers 1
        using Addr = Register::Address<0x4003c004,0xffffff00,0,unsigned>;
        ///Input channel select
        enum class adchVal {
            v00000=0x00000000,     ///<When DIFF=0, DADP0 is selected as input; when DIFF=1, DAD0 is selected as input.
            v00001=0x00000001,     ///<When DIFF=0, DADP1 is selected as input; when DIFF=1, DAD1 is selected as input.
    ...
    namespace Adc2Cfg1{    ///<ADC configuration register 1
        using Addr = Register::Address<0x4003c008,0xffffff00,0,unsigned>;
        ///Input clock select
    ...
    namespace Adc2Cfg2{    ///<Configuration register 2
        using Addr = Register::Address<0x4003c00c,0xffffffe0,0,unsigned>;
    ...
    namespace Adc2Ra{    ///<ADC data result register
        using Addr = Register::Address<0x4003c010,0xffff0000,0,unsigned>;
        ///Data result
    ...
    namespace Adc2Rb{    ///<ADC data result register
        using Addr = Register::Address<0x4003c014,0xffff0000,0,unsigned>;
        ///Data result
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> d{}; 
    }
    namespace Adc2Cv1{    ///<Compare value registers
        using Addr = Register::Address<0x4003c018,0xffff0000,0,unsigned>;
        ///Compare value
    ...
    namespace Adc2Cv2{    ///<Compare value registers
        using Addr = Register::Address<0x4003c01c,0xffff0000,0,unsigned>;
        ///Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Adc2Sc2{    ///<Status and control register 2
        using Addr = Register::Address<0x4003c020,0xffffff00,0,unsigned>;
    ...
    namespace Adc2Sc3{    ///<Status and control register 3
        using Addr = Register::Address<0x4003c024,0xffffff30,0,unsigned>;
    ...
    namespace Adc2Ofs{    ///<ADC offset correction register
        using Addr = Register::Address<0x4003c028,0xffff0000,0,unsigned>;
    ...
    namespace Adc2Pg{    ///<ADC plus-side gain register
        using Addr = Register::Address<0x4003c02c,0xffff0000,0,unsigned>;
        ///Plus-side gain
    ...
    namespace Adc2Mg{    ///<ADC minus-side gain register
        using Addr = Register::Address<0x4003c030,0xffff0000,0,unsigned>;
        ///Minus-side gain
    ...
    namespace Adc2Clpd{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c034,0xffffffc0,0,unsigned>;
    ...
    namespace Adc2Clps{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c038,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clp4{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c03c,0xfffffc00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clp3{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c040,0xfffffe00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clp2{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c044,0xffffff00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clp1{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c048,0xffffff80,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clp0{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x4003c04c,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Pga{    ///<ADC PGA register
        using Addr = Register::Address<0x4003c050,0xff40bfff,0,unsigned>;
    ...
    namespace Adc2Clmd{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c054,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clms{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c058,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clm4{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c05c,0xfffffc00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clm3{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c060,0xfffffe00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clm2{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c064,0xffffff00,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clm1{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c068,0xffffff80,0,unsigned>;
        ///no description available
    ...
    namespace Adc2Clm0{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x4003c06c,0xffffffc0,0,unsigned>;
        ///no description available
