...
//Analog-to-Digital Converter
    namespace Adc3Sc1a{    ///<ADC status and control registers 1
        using Addr = Register::Address<0x400bc000,0xffffff00,0,unsigned>;
        ...
        namespace adchValC{
            ...
            constexpr MPL::Value<adchVal,adchVal::v11000> v11000{};
            constexpr MPL::Value<adchVal,adchVal::v11001> v11001{};
            constexpr MPL::Value<adchVal,adchVal::v11010> v11010{};
            constexpr MPL::Value<adchVal,adchVal::v11011> v11011{};
            constexpr MPL::Value<adchVal,adchVal::v11100> v11100{};
    ...
    namespace Adc3Sc1b{    ///<ADC status and control registers 1
        using Addr = Register::Address<0x400bc004,0xffffff00,0,unsigned>;
        ///Input channel select
        enum class adchVal {
            v00000=0x00000000,     ///<When DIFF=0, DADP0 is selected as input; when DIFF=1, DAD0 is selected as input.
            v00001=0x00000001,     ///<When DIFF=0, DADP1 is selected as input; when DIFF=1, DAD1 is selected as input.
    ...
    namespace Adc3Cfg1{    ///<ADC configuration register 1
        using Addr = Register::Address<0x400bc008,0xffffff00,0,unsigned>;
        ///Input clock select
    ...
    namespace Adc3Cfg2{    ///<Configuration register 2
        using Addr = Register::Address<0x400bc00c,0xffffffe0,0,unsigned>;
    ...
    namespace Adc3Ra{    ///<ADC data result register
        using Addr = Register::Address<0x400bc010,0xffff0000,0,unsigned>;
        ///Data result
    ...
    namespace Adc3Rb{    ///<ADC data result register
        using Addr = Register::Address<0x400bc014,0xffff0000,0,unsigned>;
        ///Data result
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> d{}; 
    }
    namespace Adc3Cv1{    ///<Compare value registers
        using Addr = Register::Address<0x400bc018,0xffff0000,0,unsigned>;
        ///Compare value
    ...
    namespace Adc3Cv2{    ///<Compare value registers
        using Addr = Register::Address<0x400bc01c,0xffff0000,0,unsigned>;
        ///Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Adc3Sc2{    ///<Status and control register 2
        using Addr = Register::Address<0x400bc020,0xffffff00,0,unsigned>;
        ...
        namespace refselValC{
            ...
            constexpr MPL::Value<refselVal,refselVal::v10> v10{};
    ...
    namespace Adc3Sc3{    ///<Status and control register 3
        using Addr = Register::Address<0x400bc024,0xffffff30,0,unsigned>;
    ...
    namespace Adc3Ofs{    ///<ADC offset correction register
        using Addr = Register::Address<0x400bc028,0xffff0000,0,unsigned>;
    ...
    namespace Adc3Pg{    ///<ADC plus-side gain register
        using Addr = Register::Address<0x400bc02c,0xffff0000,0,unsigned>;
        ///Plus-side gain
    ...
    namespace Adc3Mg{    ///<ADC minus-side gain register
        using Addr = Register::Address<0x400bc030,0xffff0000,0,unsigned>;
        ///Minus-side gain
    ...
    namespace Adc3Clpd{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc034,0xffffffc0,0,unsigned>;
    ...
    namespace Adc3Clps{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc038,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp4{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc03c,0xfffffc00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp3{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc040,0xfffffe00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp2{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc044,0xffffff00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp1{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc048,0xffffff80,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp0{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc04c,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Pga{    ///<ADC PGA register
        using Addr = Register::Address<0x400bc050,0xff40bfff,0,unsigned>;
        ...
        namespace pgaofsmValC{
            constexpr MPL::Value<pgaofsmVal,pgaofsmVal::v0> v0{};
            constexpr MPL::Value<pgaofsmVal,pgaofsmVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,pgaofsmVal> pgaofsm{}; 
        ///PGA gain setting
        enum class pgagVal {
            v0000=0x00000000,     ///<1
            v0001=0x00000001,     ///<2
        ...
        namespace pgagValC{
            constexpr MPL::Value<pgagVal,pgagVal::v0000> v0000{};
            constexpr MPL::Value<pgagVal,pgagVal::v0001> v0001{};
            constexpr MPL::Value<pgagVal,pgagVal::v0010> v0010{};
            constexpr MPL::Value<pgagVal,pgagVal::v0011> v0011{};
            constexpr MPL::Value<pgagVal,pgagVal::v0100> v0100{};
            constexpr MPL::Value<pgagVal,pgagVal::v0101> v0101{};
            constexpr MPL::Value<pgagVal,pgagVal::v0110> v0110{};
            constexpr MPL::Value<pgagVal,pgagVal::v0111> v0111{};
            constexpr MPL::Value<pgagVal,pgagVal::v1000> v1000{};
            constexpr MPL::Value<pgagVal,pgagVal::v1001> v1001{};
            constexpr MPL::Value<pgagVal,pgagVal::v1010> v1010{};
            constexpr MPL::Value<pgagVal,pgagVal::v1011> v1011{};
            constexpr MPL::Value<pgagVal,pgagVal::v1100> v1100{};
            constexpr MPL::Value<pgagVal,pgagVal::v1101> v1101{};
            constexpr MPL::Value<pgagVal,pgagVal::v1110> v1110{};
            constexpr MPL::Value<pgagVal,pgagVal::v1111> v1111{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,pgagVal> pgag{}; 
        ...
        namespace pgalpbValC{
            constexpr MPL::Value<pgalpbVal,pgalpbVal::v0> v0{};
            constexpr MPL::Value<pgalpbVal,pgalpbVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,pgalpbVal> pgalpb{}; 
        ...
        namespace pgachpbValC{
            constexpr MPL::Value<pgachpbVal,pgachpbVal::v0> v0{};
            constexpr MPL::Value<pgachpbVal,pgachpbVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,pgachpbVal> pgachpb{}; 
        ///PGA enable
        enum class pgaenVal {
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,pgaenVal> pgaen{}; 
    }
    namespace Adc3Clmd{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc054,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clms{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc058,0xffffffc0,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm4{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc05c,0xfffffc00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm3{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc060,0xfffffe00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm2{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc064,0xffffff00,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm1{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc068,0xffffff80,0,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm0{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc06c,0xffffffc0,0,unsigned>;
        ///no description available
