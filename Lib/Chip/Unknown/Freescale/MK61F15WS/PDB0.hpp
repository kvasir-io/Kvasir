...
namespace Kvasir {
    ...
    namespace PDB0_ch2c1{
        using Addr = Register::Address<0x40036060,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> TOS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> BB; 
    }
    namespace PDB0_ch3c1{
        using Addr = Register::Address<0x40036088,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> TOS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> BB; 
    }
    ...
    namespace PDB0_ch2s{
        using Addr = Register::Address<0x40036064,0xff00ff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> ERR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> CF; 
    }
    namespace PDB0_ch3s{
        using Addr = Register::Address<0x4003608c,0xff00ff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> ERR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> CF; 
    }
    ...
    namespace PDB0_ch2dly0{
        using Addr = Register::Address<0x40036068,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    namespace PDB0_ch3dly0{
        using Addr = Register::Address<0x40036090,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    ...
    namespace PDB0_ch2dly1{
        using Addr = Register::Address<0x4003606c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    namespace PDB0_ch3dly1{
        using Addr = Register::Address<0x40036094,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    namespace PDB0_dacintc0{
    ...
    namespace PDB0_dacintc1{
        using Addr = Register::Address<0x40036158,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TOE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> EXT; 
    }
    namespace PDB0_dacint0{
        using Addr = Register::Address<0x40036154,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INT; 
    }
    namespace PDB0_dacint1{
        using Addr = Register::Address<0x4003615c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INT; 
    }
    namespace PDB0_poen{
    ...
    namespace PDB0_po3dly{
        using Addr = Register::Address<0x400361a0,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> DLY1; 
    }
}
