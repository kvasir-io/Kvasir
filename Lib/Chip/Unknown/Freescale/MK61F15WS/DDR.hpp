...
//DRAM Controller
    namespace DdrCr00{    ///<DDR Control Register 0
        ...
        namespace ddrclsValC{
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0000> v0000{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0001> v0001{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0010> v0010{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0011> v0011{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0100> v0100{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0101> v0101{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v0110> v0110{};
            constexpr MPL::Value<ddrclsVal,ddrclsVal::v1111> v1111{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,ddrclsVal> ddrcls{}; 
        ///Version
    ...
    namespace DdrCr01{    ///<DDR Control Register 1
        ...
        namespace maxcolValC{
            constexpr MPL::Value<maxcolVal,maxcolVal::v0000> v0000{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v0001> v0001{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v1011> v1011{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v1100> v1100{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v1101> v1101{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v1110> v1110{};
            constexpr MPL::Value<maxcolVal,maxcolVal::v1111> v1111{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,maxcolVal> maxcol{}; 
        ///Chip Select Maximum
        enum class csmaxVal {
            v00=0x00000000,     ///<Zero
            v01=0x00000001,     ///<One
        ...
        namespace csmaxValC{
            ...
            constexpr MPL::Value<csmaxVal,csmaxVal::v11> v11{};
        }
    ...
    namespace DdrCr03{    ///<DDR Control Register 3
        ...
        namespace latlinValC{
            constexpr MPL::Value<latlinVal,latlinVal::v0000> v0000{};
            constexpr MPL::Value<latlinVal,latlinVal::v0001> v0001{};
            constexpr MPL::Value<latlinVal,latlinVal::v0010> v0010{};
            constexpr MPL::Value<latlinVal,latlinVal::v0011> v0011{};
            constexpr MPL::Value<latlinVal,latlinVal::v1111> v1111{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,latlinVal> latlin{}; 
        ///Latency Gate
    ...
    namespace DdrCr09{    ///<DDR Control Register 9
        ...
        namespace bstlenValC{
            constexpr MPL::Value<bstlenVal,bstlenVal::v000> v000{};
            constexpr MPL::Value<bstlenVal,bstlenVal::v001> v001{};
            constexpr MPL::Value<bstlenVal,bstlenVal::v010> v010{};
            constexpr MPL::Value<bstlenVal,bstlenVal::v011> v011{};
            constexpr MPL::Value<bstlenVal,bstlenVal::v100> v100{};
            constexpr MPL::Value<bstlenVal,bstlenVal::v111> v111{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,24),Register::ReadWriteAccess,bstlenVal> bstlen{}; 
    }
    ...
    namespace DdrCr20{    ///<DDR Control Register 20
        ...
        namespace lpreValC{
            ...
            constexpr MPL::Value<lpreVal,lpreVal::v10> v10{};
            constexpr MPL::Value<lpreVal,lpreVal::v11> v11{};
        }
