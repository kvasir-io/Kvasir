...
//Secured Digital Host Controller
    ...
    namespace SdhcProctl{    ///<Protocol Control Register
        ...
        namespace dtwValC{
            ...
            constexpr MPL::Value<dtwVal,dtwVal::v11> v11{};
        }
        ...
        namespace emodeValC{
            ...
            constexpr MPL::Value<emodeVal,emodeVal::v11> v11{};
        }
        ...
        namespace dmasValC{
            ...
            constexpr MPL::Value<dmasVal,dmasVal::v11> v11{};
        }
    ...
    namespace SdhcHtcapblt{    ///<Host Controller Capabilities
        ...
        namespace vs30ValC{
            constexpr MPL::Value<vs30Val,vs30Val::v0> v0{};
            constexpr MPL::Value<vs30Val,vs30Val::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,vs30Val> vs30{}; 
        ...
        namespace vs18ValC{
            constexpr MPL::Value<vs18Val,vs18Val::v0> v0{};
            constexpr MPL::Value<vs18Val,vs18Val::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,vs18Val> vs18{}; 
    }
    namespace SdhcWml{    ///<Watermark Level Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,24),Register::ReadWriteAccess,unsigned> wrbrstlen{}; 
    }
    ...
    namespace SdhcMmcboot{    ///<MMC Boot Register
        ...
        namespace dtocvackValC{
            ...
            constexpr MPL::Value<dtocvackVal,dtocvackVal::v1111> v1111{};
        }
