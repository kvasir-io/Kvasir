...
//Secured Digital Host Controller
    ...
    namespace SdhcProctl{    ///<Protocol Control Register
        ...
        namespace DtwValC{
            ...
            constexpr Register::FieldValue<decltype(dtw)::Type,DtwVal::v11> v11{};
        }
        }
        ...
        namespace EmodeValC{
            ...
            constexpr Register::FieldValue<decltype(emode)::Type,EmodeVal::v11> v11{};
        }
        }
    ...
    namespace SdhcMmcboot{    ///<MMC Boot Register
        ...
        namespace DtocvackValC{
            ...
            constexpr Register::FieldValue<decltype(dtocvack)::Type,DtocvackVal::v1111> v1111{};
        }
        }
