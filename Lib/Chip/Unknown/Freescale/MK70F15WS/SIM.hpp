...
namespace Kvasir {
    namespace SIM_sopt1{
        using Addr = Register::Address<0x40047000,0x1ff70fff>;
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0x03082403>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2)> USBHSRC; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> LCDC_CLKSEL; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> USBF_CLKSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20)> TIMESRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22)> USBFSRC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26)> LCDCSRC; 
    ...
    namespace SIM_scgc3{
        using Addr = Register::Address<0x40048030,0xe4bd2eee>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> DDR; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> LCDC; 
    ...
    namespace SIM_scgc4{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> USBFS; 
    ...
    namespace SIM_scgc5{
        using Addr = Register::Address<0x40048038,0xffff81d0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> DRYICE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> DRYICESECREG; 
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0xc40b4fe9>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> USBHS; 
    ...
    namespace SIM_clkdiv2{
        using Addr = Register::Address<0x40048048,0xfffff0f0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> USBFSFRAC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,1)> USBFSDIV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> USBHSFRAC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,9)> USBHSDIV; 
    }
    namespace SIM_fcfg1{
    ...
    namespace SIM_clkdiv3{
        using Addr = Register::Address<0x40048064,0xf00000ff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> LCDCFRAC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16)> LCDCDIV; 
    }
    ...
    namespace SIM_mcr{
        using Addr = Register::Address<0x4004806c,0x1ffefc10>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DDRSREN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> DDRS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> DDRPEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> DDRDQSDIS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,5)> DDRCFG; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> RCRRSTEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> RCRRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> LCDSTART; 
