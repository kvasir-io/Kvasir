...
//Programmable Delay Block
    ...
    namespace Pdb0Poen{    ///<Pulse-Out n Enable Register
        using Addr = Register::Address<0x40036190,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb0Ch3c1{    ///<Channel n Control Register 1
        using Addr = Register::Address<0x40036088,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Pre-Trigger Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> en{}; 
        ///PDB Channel Pre-Trigger Output Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> tos{}; 
    ...
    namespace Pdb0Ch3s{    ///<Channel n Status Register
        using Addr = Register::Address<0x4003608c,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Sequence Error Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> err{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Pdb0Ch3dly0{    ///<Channel n Delay 0 Register
        using Addr = Register::Address<0x40036090,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Pdb0Ch3dly1{    ///<Channel n Delay 1 Register
        using Addr = Register::Address<0x40036094,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Pdb0Dacintc0{    ///<DAC Interval Trigger n Control Register
        using Addr = Register::Address<0x40036150,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb0Dacintc1{    ///<DAC Interval Trigger n Control Register
        using Addr = Register::Address<0x40036158,0x00000000,0x00000000,unsigned>;
        ///DAC Interval Trigger Enable
        enum class ToeVal {
            v0=0x00000000,     ///<DAC interval trigger disabled.
            v1=0x00000001,     ///<DAC interval trigger enabled.
    ...
    namespace Pdb0Dacint0{    ///<DAC Interval n Register
        using Addr = Register::Address<0x40036154,0x00000000,0x00000000,unsigned>;
        ///DAC Interval
    ...
    namespace Pdb0Dacint1{    ///<DAC Interval n Register
        using Addr = Register::Address<0x4003615c,0x00000000,0x00000000,unsigned>;
        ///DAC Interval
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> int_{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
