...
//Analog-to-Digital Converter
    namespace Adc3Sc1a{    ///<ADC status and control registers 1
        ...
        namespace AdchValC{
            ...
            constexpr Register::FieldValue<decltype(adch),AdchVal::v11000> v11000{};
            constexpr Register::FieldValue<decltype(adch),AdchVal::v11001> v11001{};
            ...
            constexpr Register::FieldValue<decltype(adch),AdchVal::v11100> v11100{};
    ...
    namespace Adc3Sc2{    ///<Status and control register 2
        ...
        namespace RefselValC{
            ...
            constexpr Register::FieldValue<decltype(refsel),RefselVal::v10> v10{};
    ...
    namespace Adc3Pga{    ///<ADC PGA register
        ...
        namespace PgaofsmValC{
            constexpr Register::FieldValue<decltype(pgaofsm),PgaofsmVal::v0> v0{};
            constexpr Register::FieldValue<decltype(pgaofsm),PgaofsmVal::v1> v1{};
        }
        ///PGA gain setting
        enum class PgagVal {
            v0000=0x00000000,     ///<1
        ...
        namespace PgagValC{
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0000> v0000{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0001> v0001{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0010> v0010{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0011> v0011{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0100> v0100{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0101> v0101{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0110> v0110{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v0111> v0111{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1000> v1000{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1001> v1001{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1010> v1010{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1011> v1011{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1100> v1100{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1101> v1101{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1110> v1110{};
            constexpr Register::FieldValue<decltype(pgag),PgagVal::v1111> v1111{};
        }
        ...
        namespace PgalpbValC{
            constexpr Register::FieldValue<decltype(pgalpb),PgalpbVal::v0> v0{};
            constexpr Register::FieldValue<decltype(pgalpb),PgalpbVal::v1> v1{};
        }
        ...
        namespace PgachpbValC{
            constexpr Register::FieldValue<decltype(pgachpb),PgachpbVal::v0> v0{};
            constexpr Register::FieldValue<decltype(pgachpb),PgachpbVal::v1> v1{};
        }
        ///PGA enable
        enum class PgaenVal {
