...
//FlexTimer Module
    ...
    namespace Ftm2Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x400b8054,0x00000000,0x00000000,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm2Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x400b8078,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x400b807c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Qdctrl{    ///<Quadrature Decoder Control and Status
        using Addr = Register::Address<0x400b8080,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Conf{    ///<Configuration
        using Addr = Register::Address<0x400b8084,0x00000000,0x00000000,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm2Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x400b8088,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x400b808c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x400b8090,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x400b8094,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x400b8098,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Select
