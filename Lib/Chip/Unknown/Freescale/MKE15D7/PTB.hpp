...
//General Purpose Input/Output
    namespace PtbPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x4007f040,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace PtbPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x4007f044,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace PtbPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x4007f048,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace PtbPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x4007f04c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace PtbPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x4007f050,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace PtbPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x4007f054,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
