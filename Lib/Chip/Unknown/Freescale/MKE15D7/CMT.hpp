...
//Carrier Modulator Transmitter
    namespace CmtCgh1{    ///<CMT Carrier Generator High Data Register 1
        using Addr = Register::Address<0x40042000,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtCgl1{    ///<CMT Carrier Generator Low Data Register 1
        using Addr = Register::Address<0x40042001,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtCgh2{    ///<CMT Carrier Generator High Data Register 2
        using Addr = Register::Address<0x40042002,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtCgl2{    ///<CMT Carrier Generator Low Data Register 2
        using Addr = Register::Address<0x40042003,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtOc{    ///<CMT Output Control Register
        using Addr = Register::Address<0x40042004,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtMsc{    ///<CMT Modulator Status and Control Register
        using Addr = Register::Address<0x40042005,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtCmd1{    ///<CMT Modulator Data Register Mark High
        using Addr = Register::Address<0x40042006,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace CmtCmd2{    ///<CMT Modulator Data Register Mark Low
        using Addr = Register::Address<0x40042007,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> mb{}; 
    }
    namespace CmtCmd3{    ///<CMT Modulator Data Register Space High
        using Addr = Register::Address<0x40042008,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace CmtCmd4{    ///<CMT Modulator Data Register Space Low
        using Addr = Register::Address<0x40042009,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sb{}; 
    }
    namespace CmtPps{    ///<CMT Primary Prescaler Register
        using Addr = Register::Address<0x4004200a,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CmtDma{    ///<CMT Direct Memory Access Register
        using Addr = Register::Address<0x4004200b,0xffffff00,0x00000000,unsigned char>;
        ///DMA Enable
        enum class DmaVal {
