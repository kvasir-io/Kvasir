...
//FlexTimer Module
    namespace Ftm3Sc{    ///<Status And Control
        using Addr = Register::Address<0x4002c000,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Cnt{    ///<Counter
        using Addr = Register::Address<0x4002c004,0xffff0000,0,unsigned>;
        ///Counter Value
    ...
    namespace Ftm3Mod{    ///<Modulo
        using Addr = Register::Address<0x4002c008,0xffff0000,0,unsigned>;
    ...
    namespace Ftm3C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c00c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm3C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c014,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c01c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c024,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c02c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002c034,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c010,0xffff0000,0,unsigned>;
        ///Channel Value
    ...
    namespace Ftm3C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c018,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm3C2v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c020,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm3C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c028,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm3C4v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c030,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm3C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x4002c038,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm3Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4002c04c,0xffff0000,0,unsigned>;
        ///no description available
    ...
    namespace Ftm3Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x4002c050,0xffffff00,0,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
            v0=0x00000000,     ///<No channel event has occurred.
            v1=0x00000001,     ///<A channel event has occurred.
    ...
    namespace Ftm3Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x4002c054,0xffffff00,0,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm3Sync{    ///<Synchronization
        using Addr = Register::Address<0x4002c058,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4002c05c,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Outmask{    ///<Output Mask
        using Addr = Register::Address<0x4002c060,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x4002c064,0x80808080,0,unsigned>;
    ...
    namespace Ftm3Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x4002c068,0xffffff00,0,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm3Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4002c06c,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x4002c070,0xffffff00,0,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm3Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x4002c074,0xffffff10,0,unsigned>;
    ...
    namespace Ftm3Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x4002c078,0xffff0000,0,unsigned>;
    ...
    namespace Ftm3Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x4002c080,0xffffff00,0,unsigned>;
    ...
    namespace Ftm3Conf{    ///<Configuration
        using Addr = Register::Address<0x4002c084,0xfffff920,0,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm3Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x4002c088,0xfffffff0,0,unsigned>;
    ...
    namespace Ftm3Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4002c08c,0xffe0e04a,0,unsigned>;
    ...
    namespace Ftm3Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x4002c090,0xfffffff0,0,unsigned>;
    ...
    namespace Ftm3Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x4002c098,0xfffffd00,0,unsigned>;
        ///Channel 0 Select
