...
//Analog-to-digital converter
    namespace Adc0Sc1{    ///<Status and Control Register 1
        using Addr = Register::Address<0x4003b000,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc0Sc2{    ///<Status and Control Register 2
        using Addr = Register::Address<0x4003b002,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc0Sc3{    ///<Status and Control Register 3
        using Addr = Register::Address<0x4003b004,0xffff0000,0x00000000,unsigned>;
        ///Input Clock Select
    ...
    namespace Adc0Sc4{    ///<Status and Control Register 4
        using Addr = Register::Address<0x4003b006,0xffff0000,0x00000000,unsigned>;
        ///no description available
        enum class AfdepVal {
    ...
    namespace Adc0R{    ///<Conversion Result Register
        using Addr = Register::Address<0x4003b008,0xffff0000,0x00000000,unsigned>;
        ///Conversion Result
    ...
    namespace Adc0Cva{    ///<Compare Value Register A
        using Addr = Register::Address<0x4003b00a,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc0Cvb{    ///<Compare Value Register B
        using Addr = Register::Address<0x4003b00c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc0Apctl{    ///<Pin Control Register
        using Addr = Register::Address<0x4003b00e,0xffff0000,0x00000000,unsigned>;
        ///ADC Pin Control 0
        enum class Adpc0Val {
