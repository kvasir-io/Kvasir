...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    namespace Cmp3Cr0{    ///<CMP Control Register 0
        using Addr = Register::Address<0x40053000,0xffffff8e,0,unsigned char>;
    ...
    namespace Cmp3Cr1{    ///<CMP Control Register 1
        using Addr = Register::Address<0x40053001,0xffffff20,0,unsigned char>;
    ...
    namespace Cmp3Fpr{    ///<CMP Filter Period Register
        using Addr = Register::Address<0x40053002,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp3Scr{    ///<CMP Status and Control Register
        using Addr = Register::Address<0x40053003,0xffffffa0,0,unsigned char>;
    ...
    namespace Cmp3Daccr{    ///<DAC Control Register
        using Addr = Register::Address<0x40053004,0xffffff00,0,unsigned char>;
    ...
    namespace Cmp3Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x40053005,0xffffffcc,0,unsigned char>;
    ...
    namespace Cmp3Muxpe{    ///<MUX Pin Enable Register
        using Addr = Register::Address<0x40053006,0xfffffff8,0,unsigned char>;
