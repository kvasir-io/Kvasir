...
//General Purpose Input/Output
    namespace GpiodPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x4007f0c0,0x00000000,0,unsigned>;
        ///Port Data Output
    ...
    namespace GpiodPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x4007f0c4,0x00000000,0,unsigned>;
        ///Port Set Output
    ...
    namespace GpiodPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x4007f0c8,0x00000000,0,unsigned>;
        ///Port Clear Output
    ...
    namespace GpiodPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x4007f0cc,0x00000000,0,unsigned>;
        ///Port Toggle Output
    ...
    namespace GpiodPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x4007f0d0,0x00000000,0,unsigned>;
        ///Port Data Input
    ...
    namespace GpiodPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x4007f0d4,0x00000000,0,unsigned>;
        ///Port Data Direction
