...
//Cyclic Redundancy Check
    ...
    namespace CrcCrcl{    ///<CRC_CRCL register.
        using Addr = Register::Address<0x40024000,0xffff0000,0x00000000,unsigned>;
    ...
    namespace CrcCrch{    ///<CRC_CRCH register.
        using Addr = Register::Address<0x40024002,0xffff0000,0x00000000,unsigned>;
    ...
    namespace CrcGpolyl{    ///<CRC_GPOLYL register.
        using Addr = Register::Address<0x40024004,0xffff0000,0x00000000,unsigned>;
    ...
    namespace CrcGpolyh{    ///<CRC_GPOLYH register.
        using Addr = Register::Address<0x40024006,0xffff0000,0x00000000,unsigned>;
    ...
    namespace CrcGpolyhl{    ///<CRC_GPOLYHL register.
        using Addr = Register::Address<0x40024006,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CrcGpolyhu{    ///<CRC_GPOLYHU register.
        using Addr = Register::Address<0x40024007,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace CrcCtrlhu{    ///<CRC_CTRLHU register.
        using Addr = Register::Address<0x4002400b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        enum class TcrcVal {
            v0=0x00000000,     ///<16-bit CRC protocol.
            v1=0x00000001,     ///<32-bit CRC protocol.
