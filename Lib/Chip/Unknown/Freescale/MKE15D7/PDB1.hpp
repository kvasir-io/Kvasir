...
namespace Kvasir {
    namespace PDB1_sc{
        using Addr = Register::Address<0x40026000,0xfff00010>;
    ...
    namespace PDB1_chs{
        using Addr = Register::Address<0x40026014,0xff00ff00>;
    ...
    namespace PDB1_chdly1{
        using Addr = Register::Address<0x4002601c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    ...
    namespace PDB1_chdly3{
        using Addr = Register::Address<0x40026024,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DLY; 
    }
    namespace PDB1_poen{
        using Addr = Register::Address<0x40026190,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> POEN; 
    }
    namespace PDB1_podly{
        using Addr = Register::Address<0x40026194,0x00000000>;
