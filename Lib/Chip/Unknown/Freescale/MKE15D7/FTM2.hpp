...
namespace Kvasir {
    namespace FTM2_sc{
        using Addr = Register::Address<0x4002b000,0xffffff00>;
    ...
    namespace FTM2_cnt{
        using Addr = Register::Address<0x4002b004,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COUNT; 
    }
    namespace FTM2_mod{
        using Addr = Register::Address<0x4002b008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MOD; 
    }
    namespace FTM2_c0sc{
        using Addr = Register::Address<0x4002b00c,0xffffff02>;
    ...
    namespace FTM2_c1sc{
        using Addr = Register::Address<0x4002b014,0xffffff02>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DMA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ELSA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> ELSB; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> MSA; 
    ...
    namespace FTM2_c0v{
        using Addr = Register::Address<0x4002b010,0xffff0000>;
    ...
    namespace FTM2_cntin{
        using Addr = Register::Address<0x4002b04c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INIT; 
    }
    namespace FTM2_status{
        using Addr = Register::Address<0x4002b050,0xffffff00>;
    ...
    namespace FTM2_sync{
        using Addr = Register::Address<0x4002b058,0xffffff00>;
    ...
    namespace FTM2_outinit{
        using Addr = Register::Address<0x4002b05c,0xffffff00>;
    ...
    namespace FTM2_outmask{
        using Addr = Register::Address<0x4002b060,0xffffff00>;
    ...
    namespace FTM2_combine{
        using Addr = Register::Address<0x4002b064,0x80808080>;
    ...
    namespace FTM2_deadtime{
        using Addr = Register::Address<0x4002b068,0xffffff00>;
    ...
    namespace FTM2_exttrig{
        using Addr = Register::Address<0x4002b06c,0xffffff00>;
    ...
    namespace FTM2_pol{
        using Addr = Register::Address<0x4002b070,0xffffff00>;
    ...
    namespace FTM2_fms{
        using Addr = Register::Address<0x4002b074,0xffffff10>;
    ...
    namespace FTM2_filter{
        using Addr = Register::Address<0x4002b078,0xffff0000>;
    ...
    namespace FTM2_fltctrl{
        using Addr = Register::Address<0x4002b07c,0xfffff000>;
    ...
    namespace FTM2_qdctrl{
        using Addr = Register::Address<0x4002b080,0xffffff00>;
    ...
    namespace FTM2_conf{
        using Addr = Register::Address<0x4002b084,0xfffff920>;
    ...
    namespace FTM2_fltpol{
        using Addr = Register::Address<0x4002b088,0xfffffff0>;
    ...
    namespace FTM2_synconf{
        using Addr = Register::Address<0x4002b08c,0xffe0e04a>;
    ...
    namespace FTM2_invctrl{
        using Addr = Register::Address<0x4002b090,0xfffffff0>;
    ...
    namespace FTM2_swoctrl{
        using Addr = Register::Address<0x4002b094,0xffff0000>;
    ...
    namespace FTM2_pwmload{
        using Addr = Register::Address<0x4002b098,0xfffffd00>;
