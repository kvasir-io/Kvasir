...
namespace Kvasir {
    namespace ADC2_sc1{
        using Addr = Register::Address<0x4003d000,0xffffff00>;
    ...
    namespace ADC2_sc2{
        using Addr = Register::Address<0x4003d002,0xffffff03>;
    ...
    namespace ADC2_sc3{
        using Addr = Register::Address<0x4003d004,0xffffff00>;
    ...
    namespace ADC2_sc4{
        using Addr = Register::Address<0x4003d006,0xffffff18>;
    ...
    namespace ADC2_cva{
        using Addr = Register::Address<0x4003d00a,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VA; 
    }
    namespace ADC2_cvb{
        using Addr = Register::Address<0x4003d00c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VB; 
    }
    namespace ADC2_apctl{
        using Addr = Register::Address<0x4003d00e,0xfffff000>;
