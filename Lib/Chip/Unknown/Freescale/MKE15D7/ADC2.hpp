...
//Analog-to-digital converter
    namespace Adc2Sc1{    ///<Status and Control Register 1
        using Addr = Register::Address<0x4003d000,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc2Sc2{    ///<Status and Control Register 2
        using Addr = Register::Address<0x4003d002,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc2Sc4{    ///<Status and Control Register 4
        using Addr = Register::Address<0x4003d006,0xffff0000,0x00000000,unsigned>;
        ///no description available
        enum class AfdepVal {
    ...
    namespace Adc2Cva{    ///<Compare Value Register A
        using Addr = Register::Address<0x4003d00a,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc2Cvb{    ///<Compare Value Register B
        using Addr = Register::Address<0x4003d00c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc2Apctl{    ///<Pin Control Register
        using Addr = Register::Address<0x4003d00e,0xffff0000,0x00000000,unsigned>;
        ///ADC Pin Control 0
        enum class Adpc0Val {
