...
//Serial Peripheral Interface
    namespace Spi1C1{    ///<SPI control register 1
        using Addr = Register::Address<0x4004f000,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Spi1C2{    ///<SPI control register 2
        using Addr = Register::Address<0x4004f001,0xffffff00,0x00000000,unsigned char>;
        ///SPI pin control 0
        enum class Spc0Val {
    ...
    namespace Spi1Br{    ///<SPI baud rate register
        using Addr = Register::Address<0x4004f002,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Spi1S{    ///<SPI status register
        using Addr = Register::Address<0x4004f003,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Spi1Dh{    ///<SPI data register high
        using Addr = Register::Address<0x4004f004,0xffffff00,0x00000000,unsigned char>;
        ///Data (high byte)
    ...
    namespace Spi1Dl{    ///<SPI data register low
        using Addr = Register::Address<0x4004f005,0xffffff00,0x00000000,unsigned char>;
        ///Data (low byte)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bits{}; 
    }
    namespace Spi1Mh{    ///<SPI match register high
        using Addr = Register::Address<0x4004f006,0xffffff00,0x00000000,unsigned char>;
        ///Hardware compare value (high byte)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bits{}; 
    }
    namespace Spi1Ml{    ///<SPI match register low
        using Addr = Register::Address<0x4004f007,0xffffff00,0x00000000,unsigned char>;
        ///Hardware compare value (low byte)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bits{}; 
    }
    namespace Spi1C3{    ///<SPI control register 3
        using Addr = Register::Address<0x4004f008,0xffffff00,0x00000000,unsigned char>;
        ///FIFO mode enable
    ...
    namespace Spi1Ci{    ///<SPI clear interrupt register
        using Addr = Register::Address<0x4004f009,0xffffff00,0x00000000,unsigned char>;
