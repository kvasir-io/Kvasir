...
//General Purpose Input/Output
    namespace PtcPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x4007f080,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace PtcPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x4007f084,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace PtcPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x4007f088,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace PtcPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x4007f08c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace PtcPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x4007f090,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace PtcPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x4007f094,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
