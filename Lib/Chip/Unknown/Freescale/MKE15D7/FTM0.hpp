...
//FlexTimer Module
    namespace Ftm0Sc{    ///<Status And Control
        using Addr = Register::Address<0x40029000,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Cnt{    ///<Counter
        using Addr = Register::Address<0x40029004,0xffff0000,0,unsigned>;
        ///Counter Value
    ...
    namespace Ftm0Mod{    ///<Modulo
        using Addr = Register::Address<0x40029008,0xffff0000,0,unsigned>;
    ...
    namespace Ftm0C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002900c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm0C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029014,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002901c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029024,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002902c,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029034,0xffffff02,0,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029010,0xffff0000,0,unsigned>;
        ///Channel Value
    ...
    namespace Ftm0C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029018,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm0C2v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029020,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm0C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029028,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm0C4v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029030,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm0C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029038,0xffff0000,0,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        namespace ValValC{
        }
    ...
    namespace Ftm0Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4002904c,0xffff0000,0,unsigned>;
        ///no description available
    ...
    namespace Ftm0Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x40029050,0xffffff00,0,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
            v0=0x00000000,     ///<No channel event has occurred.
            v1=0x00000001,     ///<A channel event has occurred.
    ...
    namespace Ftm0Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x40029054,0xffffff00,0,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm0Sync{    ///<Synchronization
        using Addr = Register::Address<0x40029058,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4002905c,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Outmask{    ///<Output Mask
        using Addr = Register::Address<0x40029060,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x40029064,0x80808080,0,unsigned>;
    ...
    namespace Ftm0Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x40029068,0xffffff00,0,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm0Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4002906c,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x40029070,0xffffff00,0,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm0Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x40029074,0xffffff10,0,unsigned>;
    ...
    namespace Ftm0Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x40029078,0xffff0000,0,unsigned>;
    ...
    namespace Ftm0Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4002907c,0xfffff000,0,unsigned>;
    ...
    namespace Ftm0Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x40029080,0xffffff00,0,unsigned>;
    ...
    namespace Ftm0Conf{    ///<Configuration
        using Addr = Register::Address<0x40029084,0xfffff920,0,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm0Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x40029088,0xfffffff0,0,unsigned>;
    ...
    namespace Ftm0Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4002908c,0xffe0e04a,0,unsigned>;
    ...
    namespace Ftm0Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x40029090,0xfffffff0,0,unsigned>;
    ...
    namespace Ftm0Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x40029094,0xffff0000,0,unsigned>;
    ...
    namespace Ftm0Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x40029098,0xfffffd00,0,unsigned>;
        ///Channel 0 Select
