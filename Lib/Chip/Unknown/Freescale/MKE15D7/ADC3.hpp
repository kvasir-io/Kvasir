...
namespace Kvasir {
    namespace ADC3_sc1{
        using Addr = Register::Address<0x4003e000,0xffffff00>;
    ...
    namespace ADC3_sc2{
        using Addr = Register::Address<0x4003e002,0xffffff03>;
    ...
    namespace ADC3_sc3{
        using Addr = Register::Address<0x4003e004,0xffffff00>;
    ...
    namespace ADC3_sc4{
        using Addr = Register::Address<0x4003e006,0xffffff18>;
    ...
    namespace ADC3_r{
        using Addr = Register::Address<0x4003e008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> ADR; 
    }
    namespace ADC3_cva{
        using Addr = Register::Address<0x4003e00a,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VA; 
    }
    namespace ADC3_cvb{
        using Addr = Register::Address<0x4003e00c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VB; 
    }
    namespace ADC3_apctl{
        using Addr = Register::Address<0x4003e00e,0xfffff000>;
