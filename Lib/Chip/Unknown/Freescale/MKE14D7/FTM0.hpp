...
//FlexTimer Module
    ...
    namespace Ftm0Sync{    ///<Synchronization
        using Addr = Register::Address<0x40029058,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4002905c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Outmask{    ///<Output Mask
        using Addr = Register::Address<0x40029060,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x40029064,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x40029068,0x00000000,0x00000000,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm0Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4002906c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x40029070,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm0Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x40029074,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x40029078,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4002907c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x40029080,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Conf{    ///<Configuration
        using Addr = Register::Address<0x40029084,0x00000000,0x00000000,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm0Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x40029088,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4002908c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x40029090,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x40029094,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm0Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x40029098,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Select
    ...
    namespace Ftm0C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029014,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002901c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029024,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002902c,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40029034,0x00000000,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm0C1v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029018,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm0C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029028,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Ftm0C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40029038,0x00000000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
