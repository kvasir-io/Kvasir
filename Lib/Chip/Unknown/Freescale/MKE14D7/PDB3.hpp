...
//Programmable Delay Block
    namespace Pdb3Sc{    ///<Status and Control Register
        using Addr = Register::Address<0x40028000,0xfff00010,0,unsigned>;
        ///Load OK
    ...
    namespace Pdb3Mod{    ///<Modulus Register
        using Addr = Register::Address<0x40028004,0xffff0000,0,unsigned>;
        ///PDB Modulus
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> mod{}; 
    }
    namespace Pdb3Cnt{    ///<Counter Register
        using Addr = Register::Address<0x40028008,0xffff0000,0,unsigned>;
        ///PDB Counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Pdb3Idly{    ///<Interrupt Delay Register
        using Addr = Register::Address<0x4002800c,0xffff0000,0,unsigned>;
        ///PDB Interrupt Delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> idly{}; 
    }
    namespace Pdb3Chc1{    ///<Channel n Control Register 1
    ...
    namespace Pdb3Chs{    ///<Channel n Status Register
        using Addr = Register::Address<0x40028014,0xff00ff00,0,unsigned>;
    ...
    namespace Pdb3Chdly0{    ///<Channel n Delay 0 Register
        using Addr = Register::Address<0x40028018,0xffff0000,0,unsigned>;
        ///PDB Channel Delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb3Chdly1{    ///<Channel n Delay 1 Register
        using Addr = Register::Address<0x4002801c,0xffff0000,0,unsigned>;
        ///PDB Channel Delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb3Chdly2{    ///<Channel n Delay 2 Register
        using Addr = Register::Address<0x40028020,0xffff0000,0,unsigned>;
        ///PDB Channel Delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb3Chdly3{    ///<Channel n Delay 3 Register
        using Addr = Register::Address<0x40028024,0xffff0000,0,unsigned>;
        ///PDB Channel Delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb3Poen{    ///<Pulse-Out n Enable Register
        using Addr = Register::Address<0x40028190,0xffffff00,0,unsigned>;
    ...
    namespace Pdb3Podly{    ///<Pulse-Out n Delay Register
