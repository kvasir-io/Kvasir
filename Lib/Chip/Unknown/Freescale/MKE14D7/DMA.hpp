...
//Enhanced direct memory access controller
    ...
    namespace DmaErq{    ///<Enable Request Register
        using Addr = Register::Address<0x4000800c,0xffffc000,0,unsigned>;
    ...
    namespace DmaEei{    ///<Enable Error Interrupt Register
        using Addr = Register::Address<0x40008014,0xffffc000,0,unsigned>;
    ...
    namespace DmaInt{    ///<Interrupt Request Register
        using Addr = Register::Address<0x40008024,0xffffc000,0,unsigned>;
        ///Interrupt Request 0
        enum class Int0Val {
    ...
    namespace DmaErr{    ///<Error Register
        using Addr = Register::Address<0x4000802c,0xffffc000,0,unsigned>;
        ///Error In Channel 0
        enum class Err0Val {
    ...
    namespace DmaHrs{    ///<Hardware Request Status Register
        using Addr = Register::Address<0x40008034,0xffffc000,0,unsigned>;
