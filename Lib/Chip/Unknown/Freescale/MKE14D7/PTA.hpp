...
//General Purpose Input/Output
    ...
    namespace PtaPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x4007f004,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace PtaPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x4007f008,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace PtaPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x4007f00c,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace PtaPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x4007f010,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace PtaPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x4007f014,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
