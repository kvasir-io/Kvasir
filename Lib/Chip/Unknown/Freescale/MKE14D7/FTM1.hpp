...
namespace Kvasir {
    namespace FTM1_sc{
        using Addr = Register::Address<0x4002a000,0xffffff00>;
    ...
    namespace FTM1_cnt{
        using Addr = Register::Address<0x4002a004,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COUNT; 
    }
    namespace FTM1_mod{
        using Addr = Register::Address<0x4002a008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MOD; 
    }
    namespace FTM1_c0sc{
        using Addr = Register::Address<0x4002a00c,0xffffff02>;
    ...
    namespace FTM1_c1sc{
        using Addr = Register::Address<0x4002a014,0xffffff02>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DMA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ELSA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> ELSB; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> MSA; 
    ...
    namespace FTM1_c0v{
        using Addr = Register::Address<0x4002a010,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VAL; 
    }
    namespace FTM1_c1v{
        using Addr = Register::Address<0x4002a018,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> VAL; 
    }
    namespace FTM1_cntin{
        using Addr = Register::Address<0x4002a04c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INIT; 
    }
    namespace FTM1_status{
    ...
    namespace FTM1_mode{
        using Addr = Register::Address<0x4002a054,0xffffff00>;
    ...
    namespace FTM1_sync{
        using Addr = Register::Address<0x4002a058,0xffffff00>;
    ...
    namespace FTM1_outinit{
        using Addr = Register::Address<0x4002a05c,0xffffff00>;
    ...
    namespace FTM1_outmask{
        using Addr = Register::Address<0x4002a060,0xffffff00>;
    ...
    namespace FTM1_combine{
        using Addr = Register::Address<0x4002a064,0x80808080>;
    ...
    namespace FTM1_deadtime{
        using Addr = Register::Address<0x4002a068,0xffffff00>;
    ...
    namespace FTM1_exttrig{
        using Addr = Register::Address<0x4002a06c,0xffffff00>;
    ...
    namespace FTM1_pol{
        using Addr = Register::Address<0x4002a070,0xffffff00>;
    ...
    namespace FTM1_fms{
        using Addr = Register::Address<0x4002a074,0xffffff10>;
    ...
    namespace FTM1_filter{
        using Addr = Register::Address<0x4002a078,0xffff0000>;
    ...
    namespace FTM1_fltctrl{
        using Addr = Register::Address<0x4002a07c,0xfffff000>;
    ...
    namespace FTM1_qdctrl{
        using Addr = Register::Address<0x4002a080,0xffffff00>;
    ...
    namespace FTM1_conf{
        using Addr = Register::Address<0x4002a084,0xfffff920>;
    ...
    namespace FTM1_fltpol{
        using Addr = Register::Address<0x4002a088,0xfffffff0>;
    ...
    namespace FTM1_synconf{
        using Addr = Register::Address<0x4002a08c,0xffe0e04a>;
    ...
    namespace FTM1_invctrl{
        using Addr = Register::Address<0x4002a090,0xfffffff0>;
    ...
    namespace FTM1_swoctrl{
        using Addr = Register::Address<0x4002a094,0xffff0000>;
    ...
    namespace FTM1_pwmload{
        using Addr = Register::Address<0x4002a098,0xfffffd00>;
