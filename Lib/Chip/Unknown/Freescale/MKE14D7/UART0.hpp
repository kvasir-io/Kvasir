...
//Serial Communication Interface
    namespace Uart0Bdh{    ///<UART Baud Rate Registers: High
        using Addr = Register::Address<0x40049000,0xffffff00,0x00000000,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart0Bdl{    ///<UART Baud Rate Registers: Low
        using Addr = Register::Address<0x40049001,0xffffff00,0x00000000,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart0C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x40049002,0xffffff00,0x00000000,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart0C2{    ///<UART Control Register 2
        using Addr = Register::Address<0x40049003,0xffffff00,0x00000000,unsigned char>;
        ///Send Break
        enum class SbkVal {
    ...
    namespace Uart0S1{    ///<UART Status Register 1
        using Addr = Register::Address<0x40049004,0xffffff00,0x00000000,unsigned char>;
        ///Parity Error Flag
        enum class PfVal {
    ...
    namespace Uart0S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x40049005,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0C3{    ///<UART Control Register 3
        using Addr = Register::Address<0x40049006,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0D{    ///<UART Data Register
        using Addr = Register::Address<0x40049007,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace Uart0Ma1{    ///<UART Match Address Registers 1
        using Addr = Register::Address<0x40049008,0xffffff00,0x00000000,unsigned char>;
        ///Match Address
    ...
    namespace Uart0Ma2{    ///<UART Match Address Registers 2
        using Addr = Register::Address<0x40049009,0xffffff00,0x00000000,unsigned char>;
        ///Match Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ma{}; 
    }
    namespace Uart0C4{    ///<UART Control Register 4
        using Addr = Register::Address<0x4004900a,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0C5{    ///<UART Control Register 5
        using Addr = Register::Address<0x4004900b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace Uart0Ed{    ///<UART Extended Data Register
        using Addr = Register::Address<0x4004900c,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace Uart0Modem{    ///<UART Modem Register
        using Addr = Register::Address<0x4004900d,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0Ir{    ///<UART Infrared Register
        using Addr = Register::Address<0x4004900e,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0Pfifo{    ///<UART FIFO Parameters
        using Addr = Register::Address<0x40049010,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0Cfifo{    ///<UART FIFO Control Register
        using Addr = Register::Address<0x40049011,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0Sfifo{    ///<UART FIFO Status Register
        using Addr = Register::Address<0x40049012,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Uart0Twfifo{    ///<UART FIFO Transmit Watermark
        using Addr = Register::Address<0x40049013,0xffffff00,0x00000000,unsigned char>;
        ///Transmit Watermark
    ...
    namespace Uart0Tcfifo{    ///<UART FIFO Transmit Count
        using Addr = Register::Address<0x40049014,0xffffff00,0x00000000,unsigned char>;
        ///Transmit Counter
    ...
    namespace Uart0Rwfifo{    ///<UART FIFO Receive Watermark
        using Addr = Register::Address<0x40049015,0xffffff00,0x00000000,unsigned char>;
        ///Receive Watermark
    ...
    namespace Uart0Rcfifo{    ///<UART FIFO Receive Count
        using Addr = Register::Address<0x40049016,0xffffff00,0x00000000,unsigned char>;
        ///Receive Counter
