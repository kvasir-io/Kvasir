...
namespace Kvasir {
    namespace UART3_bdh{
        using Addr = Register::Address<0x4004c000,0xffffff20>;
    ...
    namespace UART3_bdl{
        using Addr = Register::Address<0x4004c001,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> SBR; 
    }
    namespace UART3_c1{
        using Addr = Register::Address<0x4004c002,0xffffff00>;
    ...
    namespace UART3_c2{
        using Addr = Register::Address<0x4004c003,0xffffff00>;
    ...
    namespace UART3_s2{
        using Addr = Register::Address<0x4004c005,0xffffff00>;
    ...
    namespace UART3_c3{
        using Addr = Register::Address<0x4004c006,0xffffff00>;
    ...
    namespace UART3_d{
        using Addr = Register::Address<0x4004c007,0xffffff00>;
    ...
    namespace UART3_ma2{
        using Addr = Register::Address<0x4004c009,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> MA; 
    }
    namespace UART3_c4{
        using Addr = Register::Address<0x4004c00a,0xffffff00>;
    ...
    namespace UART3_c5{
        using Addr = Register::Address<0x4004c00b,0xffffff07>;
    ...
    namespace UART3_modem{
        using Addr = Register::Address<0x4004c00d,0xfffffff0>;
    ...
    namespace UART3_ir{
        using Addr = Register::Address<0x4004c00e,0xfffffff8>;
