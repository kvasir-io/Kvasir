...
//Programmable Delay Block
    namespace Pdb2Sc{    ///<Status and Control Register
        using Addr = Register::Address<0x40027000,0x00000000,0x00000000,unsigned>;
        ///Load OK
    ...
    namespace Pdb2Mod{    ///<Modulus Register
        using Addr = Register::Address<0x40027004,0x00000000,0x00000000,unsigned>;
        ///PDB Modulus
    ...
    namespace Pdb2Cnt{    ///<Counter Register
        using Addr = Register::Address<0x40027008,0x00000000,0x00000000,unsigned>;
        ///PDB Counter
    ...
    namespace Pdb2Idly{    ///<Interrupt Delay Register
        using Addr = Register::Address<0x4002700c,0x00000000,0x00000000,unsigned>;
        ///PDB Interrupt Delay
    ...
    namespace Pdb2Chc1{    ///<Channel n Control Register 1
        using Addr = Register::Address<0x40027010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb2Chs{    ///<Channel n Status Register
        using Addr = Register::Address<0x40027014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb2Chdly0{    ///<Channel n Delay 0 Register
        using Addr = Register::Address<0x40027018,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Delay
    ...
    namespace Pdb2Chdly1{    ///<Channel n Delay 1 Register
        using Addr = Register::Address<0x4002701c,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Pdb2Chdly3{    ///<Channel n Delay 3 Register
        using Addr = Register::Address<0x40027024,0x00000000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
    ...
    namespace Pdb2Poen{    ///<Pulse-Out n Enable Register
        using Addr = Register::Address<0x40027190,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb2Podly{    ///<Pulse-Out n Delay Register
        using Addr = Register::Address<0x40027194,0x00000000,0x00000000,unsigned>;
