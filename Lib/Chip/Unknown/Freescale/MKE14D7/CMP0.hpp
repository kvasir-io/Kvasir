...
namespace Kvasir {
    namespace CMP0_cr0{
        using Addr = Register::Address<0x40050000,0xffffff8e>;
    ...
    namespace CMP0_cr1{
        using Addr = Register::Address<0x40050001,0xffffff20>;
    ...
    namespace CMP0_fpr{
        using Addr = Register::Address<0x40050002,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> FILT_PER; 
    }
    namespace CMP0_scr{
        using Addr = Register::Address<0x40050003,0xffffffa0>;
    ...
    namespace CMP0_muxcr{
        using Addr = Register::Address<0x40050005,0xffffffcc>;
    ...
    namespace CMP0_muxpe{
        using Addr = Register::Address<0x40050006,0xfffffff8>;
