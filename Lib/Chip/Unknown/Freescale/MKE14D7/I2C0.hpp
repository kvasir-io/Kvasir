...
//Inter-Integrated Circuit
    namespace I2c0A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x40047000,0xffffff01,0,unsigned char>;
        ///Address
    ...
    namespace I2c0F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x40047001,0xffffff00,0,unsigned char>;
        ///ClockRate
    ...
    namespace I2c0C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x40047002,0xffffff00,0,unsigned char>;
        ///DMA Enable
        enum class dmaenVal {
    ...
    namespace I2c0S{    ///<I2C Status register
        using Addr = Register::Address<0x40047003,0xffffff00,0,unsigned char>;
        ///Receive Acknowledge
        enum class rxakVal {
    ...
    namespace I2c0D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x40047004,0xffffff00,0,unsigned char>;
        ///Data
    ...
    namespace I2c0C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x40047005,0xffffff00,0,unsigned char>;
        ///Slave Address
    ...
    namespace I2c0Flt{    ///<I2C Programmable Input Glitch Filter register
        using Addr = Register::Address<0x40047006,0xffffff00,0,unsigned char>;
    ...
    namespace I2c0Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x40047007,0xffffff01,0,unsigned char>;
        ///Range Slave Address
    ...
    namespace I2c0Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x40047008,0xffffff00,0,unsigned char>;
    ...
    namespace I2c0A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x40047009,0xffffff01,0,unsigned char>;
        ///SMBus Address
    ...
    namespace I2c0Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x4004700a,0xffffff00,0,unsigned char>;
        ///no description available
    ...
    namespace I2c0Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x4004700b,0xffffff00,0,unsigned char>;
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
