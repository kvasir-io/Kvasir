...
namespace Kvasir {
    namespace WDOG_stctrlh{
        using Addr = Register::Address<0x4003a000,0xffff8200>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> STNDBYEN; 
    ...
    namespace WDOG_stctrll{
        using Addr = Register::Address<0x4003a002,0xffff7fff>;
    ...
    namespace WDOG_tovall{
        using Addr = Register::Address<0x4003a006,0xffff0000>;
