...
//Inter-Integrated Circuit
    namespace I2c1A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x40048000,0xffffff01,0,unsigned char>;
        ///Address
    ...
    namespace I2c1F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x40048001,0xffffff00,0,unsigned char>;
        ///ClockRate
    ...
    namespace I2c1C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x40048002,0xffffff00,0,unsigned char>;
        ///DMA Enable
        enum class dmaenVal {
    ...
    namespace I2c1S{    ///<I2C Status register
        using Addr = Register::Address<0x40048003,0xffffff00,0,unsigned char>;
        ///Receive Acknowledge
        enum class rxakVal {
    ...
    namespace I2c1D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x40048004,0xffffff00,0,unsigned char>;
        ///Data
    ...
    namespace I2c1C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x40048005,0xffffff00,0,unsigned char>;
        ///Slave Address
    ...
    namespace I2c1Flt{    ///<I2C Programmable Input Glitch Filter register
        using Addr = Register::Address<0x40048006,0xffffff00,0,unsigned char>;
        ///I2C Programmable Filter Factor
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> flt{}; 
        ...
        namespace stopieValC{
            constexpr MPL::Value<stopieVal,stopieVal::v0> v0{};
            constexpr MPL::Value<stopieVal,stopieVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,stopieVal> stopie{}; 
    ...
    namespace I2c1Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x40048007,0xffffff01,0,unsigned char>;
        ///Range Slave Address
    ...
    namespace I2c1Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x40048008,0xffffff00,0,unsigned char>;
    ...
    namespace I2c1A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x40048009,0xffffff01,0,unsigned char>;
        ///SMBus Address
    ...
    namespace I2c1Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x4004800a,0xffffff00,0,unsigned char>;
        ///no description available
    ...
    namespace I2c1Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x4004800b,0xffffff00,0,unsigned char>;
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
