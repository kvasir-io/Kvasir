...
//Inter-Integrated Circuit
    namespace I2c1A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x40048000,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace I2c1F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x40048001,0xffffff00,0x00000000,unsigned char>;
        ///ClockRate
    ...
    namespace I2c1C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x40048002,0xffffff00,0x00000000,unsigned char>;
        ///DMA Enable
        enum class DmaenVal {
    ...
    namespace I2c1S{    ///<I2C Status register
        using Addr = Register::Address<0x40048003,0xffffff00,0x00000000,unsigned char>;
        ///Receive Acknowledge
        enum class RxakVal {
    ...
    namespace I2c1D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x40048004,0xffffff00,0x00000000,unsigned char>;
        ///Data
    ...
    namespace I2c1C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x40048005,0xffffff00,0x00000000,unsigned char>;
        ///Slave Address
    ...
    namespace I2c1Flt{    ///<I2C Programmable Input Glitch Filter register
        using Addr = Register::Address<0x40048006,0xffffff00,0x00000000,unsigned char>;
        ...
        enum class StopieVal {
            v0=0x00000000,     ///<Stop detection interrupt is disabled
            v1=0x00000001,     ///<Stop detection interrupt is enabled
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,StopieVal> stopie{}; 
        namespace StopieValC{
            constexpr Register::FieldValue<decltype(stopie)::Type,StopieVal::v0> v0{};
            constexpr Register::FieldValue<decltype(stopie)::Type,StopieVal::v1> v1{};
        }
    ...
    namespace I2c1Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x40048007,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///Range Slave Address
    ...
    namespace I2c1Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x40048008,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace I2c1A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x40048009,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> reserved{}; 
        ///SMBus Address
    ...
    namespace I2c1Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x4004800a,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace I2c1Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x4004800b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
