...
namespace Kvasir {
    namespace SPI0_c1{
        using Addr = Register::Address<0x4004e000,0xffffff00>;
    ...
    namespace SPI0_c2{
        using Addr = Register::Address<0x4004e001,0xffffff00>;
    ...
    namespace SPI0_br{
        using Addr = Register::Address<0x4004e002,0xffffff80>;
    ...
    namespace SPI0_s{
        using Addr = Register::Address<0x4004e003,0xffffff00>;
    ...
    namespace SPI0_dh{
        using Addr = Register::Address<0x4004e004,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI0_dl{
        using Addr = Register::Address<0x4004e005,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI0_mh{
        using Addr = Register::Address<0x4004e006,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI0_ml{
        using Addr = Register::Address<0x4004e007,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> Bits; 
    }
    namespace SPI0_c3{
        using Addr = Register::Address<0x4004e008,0xffffffc0>;
    ...
    namespace SPI0_ci{
        using Addr = Register::Address<0x4004e009,0xffffff00>;
