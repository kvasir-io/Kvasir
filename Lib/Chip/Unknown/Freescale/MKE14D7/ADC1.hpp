...
//Analog-to-digital converter
    ...
    namespace Adc1Sc2{    ///<Status and Control Register 2
        using Addr = Register::Address<0x4003c002,0xffffff03,0,unsigned>;
        ///Result FIFO full
        enum class FfullVal {
    ...
    namespace Adc1Sc4{    ///<Status and Control Register 4
        using Addr = Register::Address<0x4003c006,0xffffff18,0,unsigned>;
    ...
    namespace Adc1R{    ///<Conversion Result Register
        using Addr = Register::Address<0x4003c008,0xffff0000,0,unsigned>;
        ///Conversion Result
    ...
    namespace Adc1Cva{    ///<Compare Value Register A
        using Addr = Register::Address<0x4003c00a,0xffff0000,0,unsigned>;
    ...
    namespace Adc1Apctl{    ///<Pin Control Register
        using Addr = Register::Address<0x4003c00e,0xfffff000,0,unsigned>;
        ///ADC Pin Control 0
        enum class Adpc0Val {
