...
//Serial Communication Interface
    namespace Uart1Bdh{    ///<UART Baud Rate Registers: High
        using Addr = Register::Address<0x4004a000,0xffffff20,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart1Bdl{    ///<UART Baud Rate Registers: Low
        using Addr = Register::Address<0x4004a001,0xffffff00,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart1C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x4004a002,0xffffff00,0,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart1C2{    ///<UART Control Register 2
        using Addr = Register::Address<0x4004a003,0xffffff00,0,unsigned char>;
        ///Send Break
        enum class SbkVal {
    ...
    namespace Uart1S1{    ///<UART Status Register 1
        using Addr = Register::Address<0x4004a004,0xffffff00,0,unsigned char>;
        ///Parity Error Flag
        enum class PfVal {
    ...
    namespace Uart1S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x4004a005,0xffffff00,0,unsigned char>;
    ...
    namespace Uart1C3{    ///<UART Control Register 3
        using Addr = Register::Address<0x4004a006,0xffffff00,0,unsigned char>;
    ...
    namespace Uart1D{    ///<UART Data Register
        using Addr = Register::Address<0x4004a007,0xffffff00,0,unsigned char>;
    ...
    namespace Uart1Ma1{    ///<UART Match Address Registers 1
        using Addr = Register::Address<0x4004a008,0xffffff00,0,unsigned char>;
        ///Match Address
    ...
    namespace Uart1Ma2{    ///<UART Match Address Registers 2
        using Addr = Register::Address<0x4004a009,0xffffff00,0,unsigned char>;
        ///Match Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ma{}; 
        namespace MaValC{
        }
    ...
    namespace Uart1C4{    ///<UART Control Register 4
        using Addr = Register::Address<0x4004a00a,0xffffff00,0,unsigned char>;
    ...
    namespace Uart1C5{    ///<UART Control Register 5
        using Addr = Register::Address<0x4004a00b,0xffffff07,0,unsigned char>;
    ...
    namespace Uart1Modem{    ///<UART Modem Register
        using Addr = Register::Address<0x4004a00d,0xfffffff0,0,unsigned char>;
    ...
    namespace Uart1Ir{    ///<UART Infrared Register
        using Addr = Register::Address<0x4004a00e,0xfffffff8,0,unsigned char>;
