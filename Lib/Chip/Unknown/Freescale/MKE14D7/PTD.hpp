...
//General Purpose Input/Output
    namespace PtdPdor{    ///<Port Data Output Register
        using Addr = Register::Address<0x4007f0c0,0x00000000,0x00000000,unsigned>;
        ///Port Data Output
    ...
    namespace PtdPsor{    ///<Port Set Output Register
        using Addr = Register::Address<0x4007f0c4,0x00000000,0x00000000,unsigned>;
        ///Port Set Output
    ...
    namespace PtdPcor{    ///<Port Clear Output Register
        using Addr = Register::Address<0x4007f0c8,0x00000000,0x00000000,unsigned>;
        ///Port Clear Output
    ...
    namespace PtdPtor{    ///<Port Toggle Output Register
        using Addr = Register::Address<0x4007f0cc,0x00000000,0x00000000,unsigned>;
        ///Port Toggle Output
    ...
    namespace PtdPdir{    ///<Port Data Input Register
        using Addr = Register::Address<0x4007f0d0,0x00000000,0x00000000,unsigned>;
        ///Port Data Input
    ...
    namespace PtdPddr{    ///<Port Data Direction Register
        using Addr = Register::Address<0x4007f0d4,0x00000000,0x00000000,unsigned>;
        ///Port Data Direction
