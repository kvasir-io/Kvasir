...
//FlexTimer Module
    namespace Ftm2Sc{    ///<Status And Control
        using Addr = Register::Address<0x4002b000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Cnt{    ///<Counter
        using Addr = Register::Address<0x4002b004,0x00000000,0x00000000,unsigned>;
        ///Counter Value
    ...
    namespace Ftm2Mod{    ///<Modulo
        using Addr = Register::Address<0x4002b008,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm2Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4002b04c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm2Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x4002b054,0x00000000,0x00000000,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm2Sync{    ///<Synchronization
        using Addr = Register::Address<0x4002b058,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4002b05c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Outmask{    ///<Output Mask
        using Addr = Register::Address<0x4002b060,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x4002b064,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x4002b068,0x00000000,0x00000000,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm2Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4002b06c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x4002b070,0x00000000,0x00000000,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm2Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x4002b074,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x4002b078,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ftm2Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4002b07c,0x00000000,0x00000000,unsigned>;
