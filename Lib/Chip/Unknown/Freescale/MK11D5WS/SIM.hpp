...
namespace Kvasir {
    ...
    namespace SIM_scgc5{
        using Addr = Register::Address<0x40048038,0xffffc1f2>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> SECREG; 
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x503b4dfc>;
