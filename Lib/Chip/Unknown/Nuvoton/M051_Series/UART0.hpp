...
By reading this register, the UART will return an 8-bit data received from Rx pin (LSB first).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> 8Bitreceiveddata{}; 
        namespace 8bitreceiveddataValC{
        }
    }
...
By writing to this register, the UART will send out an 8-bit data through the Tx pin (LSB first).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> 8Bittransmitteddata{}; 
        namespace 8bittransmitteddataValC{
        }
    }
...
Note: This field is used for RS-485 mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> rs485AddDet{}; 
        namespace Rs485adddetValC{
        }
        ///Parity Error Flag
...
The low byte of the baud rate divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> brdLowbyte{}; 
        namespace BrdlowbyteValC{
        }
        ///Baud Rate Divider 
The high byte of the baud rate divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> brdHighbyte{}; 
        namespace BrdhighbyteValC{
        }
        ///Divider X
...
0: Disable IrDA loop back mode
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> lb{}; 
        namespace LbValC{
        }
        ///INV_Tx
