...
Bit1 = 0
Bit0: BOD_INT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> intSrc{}; 
    }
...
Bit1: PWM1_INT
Bit0: PWM0_INT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> intSrc{}; 
    }
...
The NMI_SEL bit[4:0] used to select the NMI interrupt source
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> nmiSel{}; 
    }
...
Set MCU_IRQ[n] "0": no any effect
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> mcuIrq{}; 
    }
}
