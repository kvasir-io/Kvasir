...
//Registers group
    namespace NonespiCntrl{    ///<Control and Status Register
        using Addr = Register::Address<0x40030000,0xff600000,0,unsigned>;
        ///Go and Busy Status
...
fsclk = fpclk / ((DIVIDER2+1)*2)
    ...
    namespace NonespiSsr{    ///<Slave Select Register
        using Addr = Register::Address<0x40030008,0xffffffc2,0,unsigned>;
...
If AUTOSS bit is set, writing 1 to this bit will select the SPISSx line to be automatically driven to active state for the duration of the transmit/receive, and will be driven to inactive state for the rest of the time. (The active level of SPISSx0/1 is specified in SS_LVL).
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> ssr{}; 
