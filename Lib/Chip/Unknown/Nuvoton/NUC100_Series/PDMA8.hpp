...
namespace Kvasir {
//Registers group
    namespace Pdma8PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008800,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008804,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008808,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000880c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008810,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008814,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008818,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000881c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008820,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008824,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma8PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008880,0x00000000,0x00000000,unsigned>;
