...
0 = Disable external 32.768 kHz Crystal
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> xtl32kEn{}; 
...
1 = Enable RTC Clock
0 = Disable RTC Clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rtcEn{}; 
        ///Timer0 Clock Enable
...
0 = Disable I2C0 Clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> i2c0En{}; 
        ///I2C1 Clock Enable. 
1 = Enable I2C1 Clock
0 = Disable I2C1 Clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> i2c1En{}; 
        ///SPI0 Clock Enable. 
1 = Enable SPI0 Clock
...
0 = Disable UART2 clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> uart2En{}; 
        ///PWM_01 Clock Enable.
...
0 = Disable CAN0 clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> can0En{}; 
        ///USB 2.0 FS Device Controller Clock Enable
1 = Enable USB clock
0 = Disable USB clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> usbdEn{}; 
...
1 = Enable I2S Clock
0 = Disable I2S Clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> i2sEn{}; 
        ///Analog Comparator Clock Enable.
1 = Enable the Analog Comparator Clock
0 = Disable the Analog Comparator Clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> acmpEn{}; 
        ///PS2 Clock Enable.
1 = Enable PS2 clock
0 = Disable PS2 clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> ps2En{}; 
    }
...
This is read only bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> xtl32kStb{}; 
...
01 = Clock source from PLL clock.
1x = Clock source from internal 22.1184 MHz oscillator clock.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26),Register::ReadWriteAccess,unsigned> canS{}; 
...
The USB clock frequency = (PLL frequency ) / (USB_N + 1)
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> usbN{}; 
...
Which CAN_N = 16 * CAN_N_H + CAN_N_L
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> canNL{}; 
...
The CAN clock frequency = (CAN clock source frequency ) / (CAN_N + 1)
Which CAN_N = 16 * CAN_N_H + CAN_N_L
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,24),Register::ReadWriteAccess,unsigned> canNH{}; 
    }
...
10 = Clock source from HCLK.
11 = Clock source from internal 22.1184 MHz oscillator clock.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> i2sS{}; 
