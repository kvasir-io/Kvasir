...
namespace Kvasir {
//Registers group
    namespace Pdma4PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008400,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008404,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008408,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000840c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008410,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008414,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008418,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000841c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008420,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008424,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma4PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008480,0x00000000,0x00000000,unsigned>;
