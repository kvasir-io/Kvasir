...
namespace Kvasir {
//Registers group
    namespace ScsSystCsr{    ///<SysTick Control and Status
    ...
    namespace ScsSystRvr{    ///<SysTick Reload value
    ...
    namespace ScsSystCvr{    ///<SysTick Current value
    ...
    namespace ScsCpuid{    ///<CPUID Register
        using Addr = Register::Address<0xe000ed00,0x00f00000,0x00000000,unsigned>;
        ///Reads as 0x0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> revesion{}; 
        ///Reads as 0xC20
    ...
    namespace ScsIcsr{    ///<Interrupt Control State Register
        ...
        ///0 = Thread modeValue > 1 = the exception number for the current executing exception.This is a read only bit.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(25,25),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::modify>,unsigned> pendstclr{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,27),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::modify>,unsigned> pendsvclr{}; 
