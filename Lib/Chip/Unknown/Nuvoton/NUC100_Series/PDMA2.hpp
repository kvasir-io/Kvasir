...
namespace Kvasir {
//Registers group
    namespace Pdma2PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008200,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
    ...
    namespace Pdma2PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
    ...
    namespace Pdma2PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000820c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008210,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaCsarx{    ///<PDMA Current Source Address Register CHx
    ...
    namespace Pdma2PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
    ...
    namespace Pdma2PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000821c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008220,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008224,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma2PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
