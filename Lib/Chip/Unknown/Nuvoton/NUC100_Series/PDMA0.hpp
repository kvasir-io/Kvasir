...
namespace Kvasir {
//Registers group
    namespace Pdma0PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008000,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000800c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008010,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000801c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008020,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008024,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma0PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008080,0x00000000,0x00000000,unsigned>;
