...
0: EBI function is disabled
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> exten{}; 
        ///EBI data width 16 bit
This bit defines if the data bus is 8-bit or 16-bit. 
1: EBI data width is 16 bit
0: EBI data width is 8 bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> extbw16{}; 
...
Notice: Default value of output clock is HCLK/1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,unsigned> mclkdiv{}; 
        ///Expand Time of ALE
The ALE width (tALE) to latch the address can be controlled by ExttALE.
tALE = (ExttALE+1)*MCLK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> exttale{}; 
    }
    namespace Noneextime{    ///<External Bus Interface Timing Control Register
        using Addr = Register::Address<0x50010004,0xf0ff0807,0,unsigned>;
        ///EBI Data Access Time
ExttACC define data access time (tACC).
tACC = (ExttACC+1)*MCLK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,3),Register::ReadWriteAccess,unsigned> exttacc{}; 
        ///EBI Data Access Hold Time
ExttAHD define data access hold time (tAHD).
tAHD = (ExttAHD+1)*MCLK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,unsigned> exttahd{}; 
...
Idle state cycle = (ExtIW2X)*MCLK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> extiw2x{}; 
...
Idle state cycle = (ExtIR2R)*MCLK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> extir2r{}; 
    }
}
