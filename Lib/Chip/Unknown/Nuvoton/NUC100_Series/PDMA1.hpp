...
namespace Kvasir {
//Registers group
    namespace Pdma1PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008100,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
    ...
    namespace Pdma1PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
    ...
    namespace Pdma1PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000810c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008110,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaCsarx{    ///<PDMA Current Source Address Register CHx
    ...
    namespace Pdma1PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008118,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000811c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008120,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008124,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma1PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008180,0x00000000,0x00000000,unsigned>;
