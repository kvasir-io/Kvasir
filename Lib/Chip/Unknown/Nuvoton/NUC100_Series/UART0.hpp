...
0 = Mask off INT_RDA
1 = Enable INT_RDA
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rdaIen{}; 
        namespace RdaienValC{
        }
        ///Transmit Holding Register Empty Interrupt Enable
0 = Mask off INT_THRE
1 = Enable INT_THRE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> threIen{}; 
        namespace ThreienValC{
        }
        ///Receive Line Status Interrupt Enable
0 = Mask off INT_RLS
1 = Enable INT_RLS
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> rlsIen{}; 
        namespace RlsienValC{
        }
        ///Modem Status Interrupt Enable
0 = Mask off INT_MODEM
1 = Enable INT_MODEM
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> modemIen{}; 
        namespace ModemienValC{
        }
        ///Rx Time out Interrupt Enable
0 = Mask off INT_TOUT
1 = Enable INT_TOUT.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> rtoIen{}; 
        namespace RtoienValC{
        }
        ///Buffer Error Interrupt Enable
0 = Mask off INT_Buf_ERR
1 = Enable INT_Buf_ERR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> bufErrIen{}; 
        namespace BuferrienValC{
        }
...
1 = Enable wake up function, when the system is in deep sleep mode, an external /CTS change will wake up CPU from deep sleep mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> wakeEn{}; 
...
Note: This field is used for LIN function mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> linRxBrkIen{}; 
        namespace LinrxbrkienValC{
        }
        ///Time-Out Counter Enable
1 = Enable Time-out counter.
0 = Disable Time-out counter.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> timeOutEn{}; 
...
When RTS auto-flow is enabled, if the number of bytes in the Rx FIFO equals the UA_FCR[RTS_Tri_Lev], the UART will de-assert RTS signal.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> autoRtsEn{}; 
        namespace AutortsenValC{
        }
...
When CTS auto-flow is enabled, the UART will send data to external device when CTS input assert (UART will not send data to device until CTS is asserted).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> autoCtsEn{}; 
        namespace AutoctsenValC{
        }
        ///TX DMA Enable 
1 = Enable TX DMA.
0 = Disable TX DMA.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> dmaTxEn{}; 
        namespace DmatxenValC{
        }
        ///Time-Out Counter Enable
1 = Enable RX DMA.
0 = Disable RX DMA.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> dmaRxEn{}; 
        namespace DmarxenValC{
        }
    }
...
others	62/14 (High Speed/Normal Speed)	
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> rfitl{}; 
        namespace RfitlValC{
        }
...
Note: This field is used for RS-485 Normal Multi-drop mode. It should be programmed before UA_ALT_CSR [RS-485_NMM] is programmed.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> rxDis{}; 
        namespace RxdisValC{
        }
...
0110	62/14 (High Speed/Normal Speed)	
others	62/14 (High Speed/Normal Speed)	
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> rtsTriLev{}; 
        namespace RtstrilevValC{
        }
    }
...
1= high level triggered
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> levRts{}; 
        namespace LevrtsValC{
        }
        ///RTS Pin State (not available in UART2 channel)
This bit is the output pin status of RTS.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> rtsSt{}; 
        namespace RtsstValC{
        }
    }
...
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> dctsf{}; 
        namespace DctsfValC{
        }
        ///CTS Pin Status (not available in UART2 channel)
This bit is the pin status of CTS. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ctsSt{}; 
        namespace CtsstValC{
        }
...
0= low level triggered
1= high level triggered
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> levCts{}; 
        namespace LevctsValC{
        }
    }
...
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxOverIf{}; 
        namespace RxoverifValC{
        }
...
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> rs485AddDetf{}; 
        namespace Rs485adddetfValC{
        }
        ///Parity Error Flag
This bit is set to logic 1 whenever the received character does not have a valid "parity bit", and is reset whenever the CPU writes 1 to this bit.
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> pef{}; 
        namespace PefValC{
        }
        ///Framing Error Flag
...
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> fef{}; 
        namespace FefValC{
        }
...
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> bif{}; 
        namespace BifValC{
        }
...
This field indicates the Rx FIFO Buffer Pointer. When UART receives one byte from external device, Rx_Pointer increases one. When one byte of Rx FIFO is read by CPU, Rx_Pointer decreases one.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,8),Register::ReadWriteAccess,unsigned> rxPointer{}; 
        namespace RxpointerValC{
        }
...
When the last byte of Rx FIFO has been read by CPU, hardware sets this bit high. It will be cleared when UART receives any new data.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> rxEmpty{}; 
...
This bit is set when RX_POINTER is equal to 64/16(UART0/UART1), otherwise is cleared by hardware.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> rxFull{}; 
        namespace RxfullValC{
        }
...
This field indicates the Tx FIFO Buffer Pointer. When CPU write one byte into UA_THR, Tx_Pointer increases one. When one byte of Tx FIFO is transferred to Transmitter Shift Register, Tx_Pointer decreases one.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,16),Register::ReadWriteAccess,unsigned> txPointer{}; 
        namespace TxpointerValC{
        }
...
When the last byte of Tx FIFO has been transferred to Transmitter Shift Register, hardware sets this bit high. It will be cleared when writing data into THR (Tx FIFO not empty).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> txEmpty{}; 
...
This bit is set when Tx_Point is equal to 64/16(UART0/UART1), otherwise is cleared by hardware.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> txFull{}; 
        namespace TxfullValC{
        }
        ///Tx Overflow Error Interrupt Flag (Read Only)
If Tx FIFO(UA_THR) is full, an additional write to UA_THR will cause this bit to logic 1. 
NOTE: This bit is read only, but can be cleared by writing '1' to it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> txOverIf{}; 
        namespace TxoverifValC{
        }
...
NOTE: This bit is read only. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> teFlag{}; 
        namespace TeflagValC{
        }
    }
...
NOTE: This bit is read only and it will be cleared when the number of unread bytes of Rx FIFO drops below the threshold level (RFITL).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rdaIf{}; 
        namespace RdaifValC{
        }
...
NOTE: This bit is read only and it will be cleared when writing data into THR (TX FIFO not empty).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> threIf{}; 
        namespace ThreifValC{
        }
...
NOTE: When in RS-485 function mode, this field include "receiver detect any address byte received address byte character (bit9 = 1') bit. "
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> rlsIf{}; 
        namespace RlsifValC{
        }
...
NOTE: This bit is read only and reset to 0 when bit DCTSF is cleared by a write 1 on DCTSF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> modemIf{}; 
        namespace ModemifValC{
        }
...
NOTE: This bit is read only and user can read UA_RBR (Rx is in active) to clear it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> toutIf{}; 
        namespace ToutifValC{
        }
...
NOTE: This bit is cleared when both TX_OVER_IF and RX_OVER_IF are cleared. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> bufErrIf{}; 
        namespace BuferrifValC{
        }
...
NOTE: This bit is read only and user can write 1 to clear it.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> linRxBreakIf{}; 
        namespace LinrxbreakifValC{
        }
...
0 = No RDA interrupt is generated .
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> rdaInt{}; 
        namespace RdaintValC{
        }
...
0 = No THRE interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> threInt{}; 
        namespace ThreintValC{
        }
...
0 = No RLS interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> rlsInt{}; 
        namespace RlsintValC{
        }
...
0 = No Modem interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> modemInt{}; 
        namespace ModemintValC{
        }
...
0 = No Tout interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> toutInt{}; 
        namespace ToutintValC{
        }
...
0 = No buffer error interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> bufErrInt{}; 
        namespace BuferrintValC{
        }
...
0 = No LIN RX Break interrupt is generated.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> linRxBreakInt{}; 
        namespace LinrxbreakintValC{
        }
...
This field is use to programming the transfer delay time between the last stop bit and next start bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> dly{}; 
        namespace DlyValC{
        }
    }
...
0: Enable IrDA receiver
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txSelect{}; 
        namespace TxselectValC{
        }
        ///INV_TX
1= Inverse TX output signal
0= No inversion
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> invTx{}; 
        namespace InvtxValC{
        }
        ///INV_RX
1= Inverse RX input signal
0= No inversion
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> invRx{}; 
        namespace InvrxValC{
        }
    }
...
NOTE: This break field length is UA_LIN_BKFL + 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> uaLinBkfl{}; 
        namespace UalinbkflValC{
        }
        ///LIN RX Enable
1 = Enable LIN RX mode.
0 = Disable LIN RX mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> linRxEn{}; 
        namespace LinrxenValC{
        }
...
NOTE: When TX break field transfer operation finish, this will be cleared automatically.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> linTxEn{}; 
        namespace LintxenValC{
        }
...
Note: It can't be active with RS485_AAD operation mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> rs485Nmm{}; 
        namespace Rs485nmmValC{
        }
...
Note: It can't be active with RS485_NMM operation mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> rs485Aad{}; 
        namespace Rs485aadValC{
        }
...
Note: It can be active with RS-485_AAD or RS485_NMM operation mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> rs485Aud{}; 
        namespace Rs485audValC{
        }
...
Note: This field is used for RS485 any operation mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> rs485AddEn{}; 
        namespace Rs485addenValC{
        }
        ///Address match value register (Low Density Only)
This field contains the RS-485 address match values.
Note: This field is used for RS-485 auto address detection mode.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,24),Register::ReadWriteAccess,unsigned> addrMatch{}; 
        namespace AddrmatchValC{
        }
    }
...
11 = Enable RS-485 Function (Low Density Only)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> funSel{}; 
        namespace FunselValC{
        }
    }
}
