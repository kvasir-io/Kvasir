...
Write 1 to clear.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> ispff{}; 
        namespace IspffValC{
        }
        ///Flash Program Time
...
0 = ISP is operation is finished
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> ispgo{}; 
        namespace IspgoValC{
        }
    }
...
For 128kB flash memory device, the data flash size is defined by user configuration, register content is loaded from Config1 when chip power on but for 64/32kB device, it is fixed at 0x01_f000 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> dfbadr{}; 
        namespace DfbadrValC{
        }
    }
