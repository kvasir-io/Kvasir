...
//Registers group
    namespace Noneispcon{    ///<ISP Control Register
        using Addr = Register::Address<0x5000c000,0xffff888c,0,unsigned>;
        ///ISP Enable
...
Page Erase	1	0	0	0	1	0	
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> fctrl{}; 
        ///ISP Command 
ISP command table is showed below:
Operation Mode	FOEN	FCEN	FCTRL[3:0]	
Read	0	0	0	0	0	0	
Program	1	0	0	0	0	1	
Page Erase	1	0	0	0	1	0	
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> fcen{}; 
        ///ISP Command 
ISP command table is showed below:
Operation Mode	FOEN	FCEN	FCTRL[3:0]	
Read	0	0	0	0	0	0	
Program	1	0	0	0	0	1	
Page Erase	1	0	0	0	1	0	
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> foen{}; 
    }
...
0 = ISP is operation is finished
    ...
    namespace Nonedfbadr{    ///<Data Flash Base Address Register
...
For 128kB flash memory device, the data flash size is defined by user configuration, register content is loaded from Config1 when chip power on but for 64/32kB device, it is fixed at 0x01_f000 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> dfbadr{}; 
    }
    namespace Nonefatcon{    ///<Flash Access Time Control Register
        using Addr = Register::Address<0x5000c018,0xfffffff0,0,unsigned>;
