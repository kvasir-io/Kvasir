...
1 = Clear FIFO 
0 = Not active
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> clrfifo{}; 
        namespace ClrfifoValC{
        }
...
For host to device communication, after acknowledge bit is sent, the received data is copied from receive shift register to PS2RXDATA register. CPU must read this register before next byte reception complete, otherwise the data will be overwritten and RXOVF bit in PS2STATUS[6] will be set to 1.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ps2rxdata{}; 
        namespace Ps2rxdataValC{
        }
    }
...
This bit reflects the status of the PS2CLK line after synchronizing.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> ps2clk{}; 
        namespace Ps2clkValC{
        }
        ///DATA Pin State
This bit reflects the status of the PS2DATA line after synchronizing and sampling.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ps2data{}; 
        namespace Ps2dataValC{
        }
        ///Frame Error
...
Write 1 to clear this bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> framerr{}; 
        namespace FramerrValC{
        }
        ///Received Parity
This bit reflects the parity bit for the last received data byte (odd parity).
Read only bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> rxparity{}; 
        namespace RxparityValC{
        }
        ///Receive Busy
...
Read only bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> rxbusy{}; 
        namespace RxbusyValC{
        }
        ///Transmit Busy
...
Read only bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> txbusy{}; 
        namespace TxbusyValC{
        }
        ///RX Buffer Overwrite
1 = Data in PS2RXDATA register is overwritten by new coming data.
0 = No overwrite
Write 1 to clear this bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> rxovf{}; 
        namespace RxovfValC{
        }
        ///TX FIFO Empty
...
Read only bit.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> txempty{}; 
...
0111	TXDATA1[31:24]	1111	TXDATA3[31:24]	
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> byteidx{}; 
        namespace ByteidxValC{
        }
    }
...
Write 1 to clear this bit to 0.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxint{}; 
        namespace RxintValC{
        }
        ///Transmit Interrupt 
...
0 = No interrupt
Write 1 to clear this bit to 0.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txint{}; 
        namespace TxintValC{
        }
    }
}
