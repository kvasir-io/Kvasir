...
namespace Kvasir {
//Registers group
    namespace Pdma5PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008500,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008504,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008508,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000850c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008510,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008514,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008518,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000851c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008520,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008524,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma5PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008580,0x00000000,0x00000000,unsigned>;
