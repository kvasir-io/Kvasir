...
namespace Kvasir {
//Registers group
    namespace I2c0I2con{    ///<I2C Control Register
    ...
    namespace I2c0I2caddr0{    ///<I2C Slave Address Register0
    ...
    namespace I2c0I2cdat{    ///<I2C Data Register
    ...
    namespace I2c0I2cstatus{    ///<I2C Status Register
    ...
    namespace I2c0I2clk{    ///<I2C Clock Divided Register
    ...
    namespace I2c0I2ctoc{    ///<I2C Time-Out Control Register
    ...
    namespace I2c0I2caddr1{    ///<I2C Slave address Register1
    ...
    namespace I2c0I2caddr2{    ///<I2C Slave address Register2
    ...
    namespace I2c0I2caddr3{    ///<I2C Slave address Register3
    ...
    namespace I2c0I2cadm0{    ///<I2C Slave Address Mask Register0
    ...
    namespace I2c0I2cadm1{    ///<I2C Slave Address Mask Register1
        using Addr = Register::Address<0x40020028,0xffffff01,0x00000000,unsigned>;
        ///I2C Address Mask register1 = Mask enable (the received corresponding address bit is don't care.)0 = Mask disable (the received corresponding register bit should be exact the same as address register.) I2C bus controllers support multiple address recognition with four address mask reg. When the bit in the address mask register is set to one, it means the received corresponding address bit is don't-care. If the bit is set to zero, that means the received corresponding register bit should be exact the same as address register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> i2cadm{}; 
    }
    namespace I2c0I2cadm2{    ///<I2C Slave Address Mask Register2
        using Addr = Register::Address<0x4002002c,0xffffff01,0x00000000,unsigned>;
        ///I2C Address Mask register1 = Mask enable (the received corresponding address bit is don't care.)0 = Mask disable (the received corresponding register bit should be exact the same as address register.) I2C bus controllers support multiple address recognition with four address mask reg. When the bit in the address mask register is set to one, it means the received corresponding address bit is don't-care. If the bit is set to zero, that means the received corresponding register bit should be exact the same as address register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> i2cadm{}; 
    }
    namespace I2c0I2cadm3{    ///<I2C Slave Address Mask Register3
