...
namespace Kvasir {
//Registers group
    namespace NonespiCntrl{    ///<Control and Status Register
        using Addr = Register::Address<0x40030000,0xff200000,0,unsigned>;
        ///Go and Busy Status
...
NOTE: All registers should be set before writing 1 to this GO_BUSY bit. The transfer result will be unpredictable if software changes related settings when GO_BUSY bit is 1.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> goBusy{}; 
...
0 = The received data input signal is latched at the rising edge of SPICLK.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxNeg{}; 
...
0 = The transmitted data output signal is changed at the rising edge of SPICLK.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> txNeg{}; 
        ///Transmit Bit Length
...
TX_BIT_LEN = 0x00 .. 32 bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,3),Register::ReadWriteAccess,unsigned> txBitLen{}; 
...
10 = Reserved.
11 = Reserved.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> txNum{}; 
        ///LSB First
...
0 = The MSB is transmitted/received first (which bit in SPI_TX0/1 and SPI_RX0/1 register that is depends on the TX_BIT_LEN field).
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> lsb{}; 
        ///Clock Polarity
1 = SPICLK idle high.
0 = SPICLK idle low.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> clkp{}; 
...
SP_CYCLE = 0xf ... 17 SPICLK clock cycle
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> spCycle{}; 
        ///Interrupt Flag
...
NOTE: This bit can be cleared by writing 1 to itself.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> if_{}; 
        ///Interrupt Enable
1 = Enable MICROWIRE/SPI Interrupt.
0 = Disable MICROWIRE/SPI Interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> ie{}; 
        ///SLAVE Mode Indication
1 = Slave mode.
0 = Master mode.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> slave{}; 
        ///Reorder Mode Select
...
Byte reorder function is only available if TX_BIT_LEN is defined as 16, 24 and 32.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,19),Register::ReadWriteAccess,unsigned> reorder{}; 
...
Note that when enable TWOB, the setting of TX_NUM must be programmed as 0x00.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> twob{}; 
...
Note that when enable this VARCLK_EN bit, the setting of TX_BIT_LEN must be programmed as 0x10 (16 bits mode)
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> varclkEn{}; 
    }
    namespace NonespiDivider{    ///<Clock Divider Register
...
In slave mode, the period of SPI clock driven by a master shall equal or over 5 times the period of PCLK. In other words, the maximum frequency of SPI clock is the fifth of the frequency of slave's PCLK.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> divider{}; 
...
fsclk = fpclk / ((DIVIDER2+1)*2)
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> divider2{}; 
    }
    namespace NonespiSsr{    ///<Slave Select Register
        using Addr = Register::Address<0x40030008,0xffffffc0,0,unsigned>;
...
2. SPISSx0 is also defined as device/slave select input signal in slave mode. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> ssr{}; 
...
0 = The slave select signal SPISSx0/1 is active at low-level/falling-edge..
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> ssLvl{}; 
...
0 = If this bit is cleared, slave select signals are asserted and de-asserted by setting and clearing related bits in SSR[1:0] register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> autoss{}; 
...
0: The input slave select signal is edge-trigger. This is default value.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ssLtrig{}; 
        ///Level Trigger Flag
...
Note: This bit is READ only
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> ltrigFlag{}; 
    }
    namespace NonespiRx0{    ///<Data Receive Register 0
...
NOTE: The Data Receive Registers are read only registers.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rx{}; 
    }
    namespace NonespiRx1{    ///<Data Receive Register 1
        using Addr = Register::Address<0x40030014,0x00000000,0,unsigned>;
        ///Data Receive Register
The Data Receive Registers hold the value of received data of the last executed transfer. The number of valid bits depend on the transmit bit length field in the SPI_CNTRL register. For example, if TX_BIT_LEN is set to 0x08 and TX_NUM is set to 0x0, bit RX0[7:0] holds the received data.
NOTE: The Data Receive Registers are read only registers.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rx{}; 
    }
    namespace NonespiTx0{    ///<Data Transmit Register 0
...
For example, if TX_BIT_LEN is set to 0x08 and the TX_NUM is set to 0x0, the bit TX0[7:0] will be transmitted in next transfer. If TX_BIT_LEN is set to 0x00 and TX_NUM is set to 0x1, the core will perform two successive 32-bit transmit/receive using the same setting (the order is TX0[31:0], TX1[31:0]).
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tx{}; 
    }
    namespace NonespiTx1{    ///<Data Transmit Register 1
        using Addr = Register::Address<0x40030024,0x00000000,0,unsigned>;
        ///Data Transmit Register
The Data Transmit Registers hold the data to be transmitted in the next transfer. The number of valid bits depend on the transmit bit length field in the CNTRL register. 
For example, if TX_BIT_LEN is set to 0x08 and the TX_NUM is set to 0x0, the bit TX0[7:0] will be transmitted in next transfer. If TX_BIT_LEN is set to 0x00 and TX_NUM is set to 0x1, the core will perform two successive 32-bit transmit/receive using the same setting (the order is TX0[31:0], TX1[31:0]).
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tx{}; 
    }
    namespace NonespiVarclk{    ///<Variable Clock Pattern Register
        using Addr = Register::Address<0x40030034,0x00000000,0,unsigned>;
...
The value in this field is the frequency patterns of the SPI clock. If the bit patterns of VARCLK are 0, the output frequency of SPICLK is according the value of DIVIDER. If the bit patterns of VARCLK are 1, the output frequency of SPICLK is according the value of DIVIDER2. Refer to register SPI_DIVIDER.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> varclk{}; 
    }
    namespace NonespiDma{    ///<SPI DMA control register
        using Addr = Register::Address<0x40030038,0xfffffffc,0,unsigned>;
        ///Transmit DMA start
...
Hardware will clear this bit automatically after DMA transfer done.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txDmaGo{}; 
        ///Receive DMA start
Set this bit to 1 will start the receive DMA process. SPI module will issue request to DMA module automatically. 
Hardware will clear this bit automatically after DMA transfer done.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDmaGo{}; 
    }
}
