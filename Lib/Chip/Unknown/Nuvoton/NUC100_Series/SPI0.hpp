...
//Registers group
    namespace Spi0SpiCntrl{    ///<Control and Status Register
        using Addr = Register::Address<0x40030000,0xff210000,0x00000000,unsigned>;
    ...
    namespace Spi0SpiSsr{    ///<Slave Select Register
        using Addr = Register::Address<0x40030008,0xffffffc0,0x00000000,unsigned>;
    ...
    namespace Spi0SpiDma{    ///<SPI DMA control register
        using Addr = Register::Address<0x40030038,0xfffffffc,0x00000000,unsigned>;
