...
namespace Kvasir {
    namespace Nonespi_cntrl{
        using Addr = Register::Address<0x40030000,0xff200000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> TWOB; 
    ...
    namespace Nonespi_ssr{
        using Addr = Register::Address<0x40030008,0xffffffc0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> SSR; 
    ...
    namespace Nonespi_dma{
        using Addr = Register::Address<0x40030038,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TX_DMA_GO; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RX_DMA_GO; 
    }
}
