...
namespace Kvasir {
//Registers group
    namespace Pdma6PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008600,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008604,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008608,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000860c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008610,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008614,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008618,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000861c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008620,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008624,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma6PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008680,0x00000000,0x00000000,unsigned>;
