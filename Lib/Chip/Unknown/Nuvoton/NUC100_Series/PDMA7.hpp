...
namespace Kvasir {
//Registers group
    namespace Pdma7PdmaCsrx{    ///<PDMA Control and Status Register CHx
        using Addr = Register::Address<0x50008700,0xff67ff00,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaSarx{    ///<PDMA Transfer Source Address Register CHx
        using Addr = Register::Address<0x50008704,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaDarx{    ///<PDMA Transfer Destination Address Register CHx
        using Addr = Register::Address<0x50008708,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaBcrx{    ///<PDMA Transfer Byte Count Register CHx
        using Addr = Register::Address<0x5000870c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaPointx{    ///<PDMA Internal Buffer Pointer Register CHx
        using Addr = Register::Address<0x50008710,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaCsarx{    ///<PDMA Current Source Address Register CHx
        using Addr = Register::Address<0x50008714,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaCdarx{    ///<PDMA Current Destination Address Register CHx
        using Addr = Register::Address<0x50008718,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaCbcrx{    ///<PDMA Current Byte Count Register CHx
        using Addr = Register::Address<0x5000871c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaIerx{    ///<PDMA Interrupt Enable Control Register CHx
        using Addr = Register::Address<0x50008720,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaIsrx{    ///<PDMA Interrupt Status Register CHx
        using Addr = Register::Address<0x50008724,0xffffffff,0x00000000,unsigned>;
    ...
    namespace Pdma7PdmaSbuf0Cx{    ///<PDMA Shared Buffer FIFO 0 Register CHx
        using Addr = Register::Address<0x50008780,0x00000000,0x00000000,unsigned>;
