...
//Registers group
    namespace NoneusbInten{    ///<Interrupt Enable Flag
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> busIe{}; 
        ///1/0: Enable/disable USB event interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> usbIe{}; 
        ///1/0: Enable/disable Floating detect Interrupt
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> fldetIe{}; 
        ///1/0: Enable/disable Wakeup Interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> wakeupIe{}; 
        ///1/0: Enable/Disable USB wakeup function
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> wakeupEn{}; 
...
0 = The NAK status doesn't be updated into the endpoint status register when it was set to 0. It also disable the interrupt event when device responds NAK after receiving IN token
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> innakEn{}; 
    }
...
0 = No any BUS event is occurred
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> busSts{}; 
...
0 = No any USB event is occurred
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> usbSts{}; 
...
0 = There is not attached/detached event in the USB
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> fldetSts{}; 
        ///1 = Wakeup event occurred, cleared by write 1 to USB_INTSTS[3]
0 = No Wakeup event is occurred
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> wakeupSts{}; 
...
0 = No event occurred in endpoint 0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> epevt0{}; 
...
0 = No event occurred in endpoint 1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> epevt1{}; 
...
0 = No event occurred in endpoint 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> epevt2{}; 
...
0 = No event occurred in endpoint 3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> epevt3{}; 
...
0 = No event occurred in endpoint 4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> epevt4{}; 
...
0 = No event occurred in endpoint 5
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> epevt5{}; 
        ///1 = Setup event occurred, cleared by write 1 to USB_INTSTS[31]
0 = No Setup event
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> setup{}; 
    }
...
0 = No overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> overrun{}; 
...
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,unsigned> epsts0{}; 
        ///These bits are used to indicate the current status of this endpoint
000 = In ACK
001 = In NAK
010 = Out Packet Data0 ACK
...
011 = Setup ACK
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,11),Register::ReadWriteAccess,unsigned> epsts1{}; 
        ///These bits are used to indicate the current status of this endpoint
000 = In ACK
001 = In NAK
010 = Out Packet Data0 ACK
...
011 = Setup ACK
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,14),Register::ReadWriteAccess,unsigned> epsts2{}; 
        ///These bits are used to indicate the current status of this endpoint
000 = In ACK
001 = In NAK
010 = Out Packet Data0 ACK
...
011 = Setup ACK
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,17),Register::ReadWriteAccess,unsigned> epsts3{}; 
        ///These bits are used to indicate the current status of this endpoint
000 = In ACK
001 = In NAK
010 = Out Packet Data0 ACK
...
011 = Setup ACK
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,20),Register::ReadWriteAccess,unsigned> epsts4{}; 
        ///These bits are used to indicate the current status of this endpoint
000 = In ACK
001 = In NAK
010 = Out Packet Data0 ACK
...
011 = Setup ACK
111 = Isochronous transfer end
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,23),Register::ReadWriteAccess,unsigned> epsts5{}; 
    }
...
0: Bus no suspend.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> suspend{}; 
...
0: Disable PHY transceiver function.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> phyEn{}; 
        ///1: Force USB bus to K state, used for remote wake-up.
0: Release the USB bus from K state.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> rwakeup{}; 
        ///1: Enable USB controller.
0: Disable USB controller.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> usbEn{}; 
        ///Pull-up resistor on USB_DP enable bit
1: Enable
0: Disable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> dppuEn{}; 
        ///1: Turn-on related circuit of PHY transceiver
0: power-down related circuit of PHY transceiver
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> pwrdn{}; 
...
0: Word Mode. The size of the transfer from CPU to USB SRAM can be Word. only
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> bytem{}; 
    }
...
0: The controller didn't attached into the USB host
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> fldet{}; 
    }
...
Note: It is used for Setup token only.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg{}; 
    }
...
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg0{}; 
    }
...
Note that once MXPLD is written, the data packets will be transmitted/received immediately after IN/OUT token arrived.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> mxpld{}; 
    }
...
0: No Isochronous endpoint
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> isoch{}; 
        ///00 = Endpoint is disabled
01 = OUT endpoint
10 = IN endpoint
11 = Undefined
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,5),Register::ReadWriteAccess,unsigned> state{}; 
        ///1 = DATA1 PID
0 = DATA0 PID
It is used to specify the DATA0 or DATA1 PID in the following IN token transaction. H/W will toggle automatically in IN token base on the bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> dsqSync{}; 
...
0 = Disable the device to clear the STALL handshake in setup stage
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> cstall{}; 
    }
...
This bit is write 1 only and it is always 0 when it was read back.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clrrdy{}; 
        ///1 = Set the device to respond STALL automatically
0 = Disable the device to response STALL
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> sstall{}; 
    }
...
Where the USB_SRAM address = 0x40060100h.
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg1{}; 
    }
...
Where the USB_SRAM address = 0x40060100h.
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg2{}; 
    }
...
Where the USB_SRAM address = 0x40060100h.
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg3{}; 
    }
...
Where the USB_SRAM address = 0x40060100h.
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg4{}; 
    }
...
Where the USB_SRAM address = 0x40060100h.
Refer to section 5.4.4.7 for the endpoint SRAM structure and its description.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,3),Register::ReadWriteAccess,unsigned> bufseg5{}; 
    }
...
0 = None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> drvse0{}; 
    }
...
0 = The USB PDMA write data from memory to USB buffer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> pdmaRw{}; 
...
This bit will be automatically cleared after PDMA transfer done
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> pdmaEn{}; 
    }
}
