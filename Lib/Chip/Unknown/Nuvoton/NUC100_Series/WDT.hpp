...
NOTE: This bit will auto clear after few clock cycle
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> wtr{}; 
...
1 = Enable Watchdog timer reset function
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> wtre{}; 
...
NOTE: This bit is cleared by writing 1 to this bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> wtrf{}; 
...
NOTE: This bit is cleared by writing 1 to this bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> wtif{}; 
...
Note: CHIP can wakeup by WDT only if WDT clock source select RC10K.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wtwke{}; 
...
1 : CPU wake up from sleep or power-down mode by Watchdog timeout.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> wtwkf{}; 
...
1 = Enable the Watchdog timer interrupt
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> wtie{}; 
...
1 = Enable the Watchdog timer
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> wte{}; 
...
111	2^18 * WDT_CLK	(2^18 + 1024) * WDT_CLK	21.84 ms ~ 21.93 ms	
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,unsigned> wtis{}; 
    }
}
