...
//Serial audio interface
    namespace Sai2Bcr1{    ///<BConfiguration register 1
        using Addr = Register::Address<0x40015c24,0xff04c010,0x00000000,unsigned>;
    ...
    namespace Sai2Bfrcr{    ///<BFRCR
        using Addr = Register::Address<0x40015c2c,0xfff88000,0x00000000,unsigned>;
    ...
    namespace Sai2Bslotr{    ///<BSlot register
        using Addr = Register::Address<0x40015c30,0x0000f020,0x00000000,unsigned>;
        ///Slot enable
    ...
    namespace Sai2Bim{    ///<BInterrupt mask register2
        using Addr = Register::Address<0x40015c34,0xffffff80,0x00000000,unsigned>;
    ...
    namespace Sai2Bsr{    ///<BStatus register
        using Addr = Register::Address<0x40015c38,0xfff8ff80,0x00000000,unsigned>;
    ...
    namespace Sai2Bclrfr{    ///<BClear flag register
        using Addr = Register::Address<0x40015c3c,0xffffff88,0x00000000,unsigned>;
    ...
    namespace Sai2Bdr{    ///<BData register
        using Addr = Register::Address<0x40015c40,0x00000000,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Sai2Acr1{    ///<AConfiguration register 1
        using Addr = Register::Address<0x40015c04,0xff04c010,0x00000000,unsigned>;
        ///Master clock divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,20),Register::ReadWriteAccess,unsigned> mcjdiv{}; 
        ///No divider
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> nodiv{}; 
    ...
    namespace Sai2Acr2{    ///<AConfiguration register 2
        using Addr = Register::Address<0x40015c08,0xffff0000,0x00000000,unsigned>;
        ///Companding mode
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> comp{}; 
        ///Complement bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> cpl{}; 
    ...
    namespace Sai2Afrcr{    ///<AFRCR
        using Addr = Register::Address<0x40015c0c,0xfff88000,0x00000000,unsigned>;
        ///Frame synchronization              offset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> fsoff{}; 
        ///Frame synchronization              polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> fspol{}; 
    ...
    namespace Sai2Aslotr{    ///<ASlot register
        using Addr = Register::Address<0x40015c10,0x0000f020,0x00000000,unsigned>;
        ///Slot enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> sloten{}; 
        ///Number of slots in an audio              frame
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> nbslot{}; 
    ...
    namespace Sai2Aim{    ///<AInterrupt mask register2
        using Addr = Register::Address<0x40015c14,0xffffff80,0x00000000,unsigned>;
        ///Late frame synchronization detection              interrupt enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> lfsdet{}; 
        ///Anticipated frame synchronization              detection interrupt enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> afsdetie{}; 
    ...
    namespace Sai2Asr{    ///<AStatus register
        using Addr = Register::Address<0x40015c18,0xfff8ff80,0x00000000,unsigned>;
        ///FIFO level threshold
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> flvl{}; 
        ///Late frame synchronization              detection
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> lfsdet{}; 
    ...
    namespace Sai2Aclrfr{    ///<AClear flag register
        using Addr = Register::Address<0x40015c1c,0xffffff88,0x00000000,unsigned>;
        ///Clear late frame synchronization              detection flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> lfsdet{}; 
        ///Clear anticipated frame synchronization              detection flag.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> cafsdet{}; 
    ...
    namespace Sai2Adr{    ///<AData register
        using Addr = Register::Address<0x40015c20,0x00000000,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Sai2Gcr{    ///<Global configuration register
        using Addr = Register::Address<0x40015c00,0xffffffcc,0x00000000,unsigned>;
