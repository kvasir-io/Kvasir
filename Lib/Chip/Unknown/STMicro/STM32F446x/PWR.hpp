...
//Power control
    namespace Nonecr{    ///<power control register
        ...
        ///Low-Power Regulator Low Voltage in
              deepsleep
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> lplvds{}; 
        ///Main regulator low voltage in deepsleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> mrlvds{}; 
        ///ADCDC1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> adcdc1{}; 
        ///Regulator voltage scaling output
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> vos{}; 
        ///Over-drive enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> oden{}; 
        ///Over-drive switching
              enabled
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> odswen{}; 
        ///Under-drive enable in stop
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18),Register::ReadWriteAccess,unsigned> uden{}; 
        ///Flash Memory Stop while System
              Run
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> fmssr{}; 
        ///Flash Interface Stop while System
              Run
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> fissr{}; 
    }
    namespace Nonecsr{    ///<power control/status register
        ...
        ///Enable WKUP2 pin
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> ewup2{}; 
        ///Enable WKUP pin
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> odrdy{}; 
        ///Over-drive mode switching
              ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> odswrdy{}; 
        ///Under-drive ready flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18),Register::ReadWriteAccess,unsigned> udrdy{}; 
    }
}
