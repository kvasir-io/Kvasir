...
//HDMI-CEC controller
    namespace CecCr{    ///<control register
        using Addr = Register::Address<0x40006c00,0xfffffff8,0x00000000,unsigned>;
        ///Tx End Of Message
    ...
    namespace CecCfgr{    ///<configuration register
        using Addr = Register::Address<0x40006c04,0x0000fe00,0x00000000,unsigned>;
        ///Signal Free Time
    ...
    namespace CecTxdr{    ///<Tx data register
        using Addr = Register::Address<0x40006c08,0xffffff00,0x00000000,unsigned>;
        ///Tx Data register
    ...
    namespace CecRxdr{    ///<Rx Data Register
        using Addr = Register::Address<0x40006c0c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace CecIsr{    ///<Interrupt and Status Register
        using Addr = Register::Address<0x40006c10,0xffffe000,0x00000000,unsigned>;
    ...
    namespace CecIer{    ///<interrupt enable register
        using Addr = Register::Address<0x40006c14,0xffffe000,0x00000000,unsigned>;
