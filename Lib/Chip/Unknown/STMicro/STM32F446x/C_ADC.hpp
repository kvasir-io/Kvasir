...
namespace Kvasir {
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x40012304,0xff3c10e0>;
    ...
    namespace Nonecdr{
        using Addr = Register::Address<0x40012308,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> DATA2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DATA1; 
    }
}
