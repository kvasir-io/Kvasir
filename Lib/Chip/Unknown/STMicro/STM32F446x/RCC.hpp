...
//Reset and clock control
    ...
    namespace RccAhb1rstr{    ///<AHB1 peripheral reset register
        using Addr = Register::Address<0x40023810,0xdf9fef00,0x00000000,unsigned>;
    ...
    namespace RccAhb2rstr{    ///<AHB2 peripheral reset register
        using Addr = Register::Address<0x40023814,0xffffff7e,0x00000000,unsigned>;
    ...
    namespace RccAhb3rstr{    ///<AHB3 peripheral reset register
        using Addr = Register::Address<0x40023818,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register
        using Addr = Register::Address<0x40023820,0xc8003600,0x00000000,unsigned>;
        ///TIM2 reset
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register
        using Addr = Register::Address<0x40023824,0xff3886cc,0x00000000,unsigned>;
        ///TIM1 reset
    ...
    namespace RccAhb1enr{    ///<AHB1 peripheral clock register
        using Addr = Register::Address<0x40023830,0x9f9bef00,0x00000000,unsigned>;
    ...
    namespace RccAhb2enr{    ///<AHB2 peripheral clock enable          register
        using Addr = Register::Address<0x40023834,0xffffff7e,0x00000000,unsigned>;
    ...
    namespace RccAhb3enr{    ///<AHB3 peripheral clock enable          register
        using Addr = Register::Address<0x40023838,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable          register
        using Addr = Register::Address<0x40023840,0xc0003600,0x00000000,unsigned>;
        ///TIM2 clock enable
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable          register
        using Addr = Register::Address<0x40023844,0xff3880cc,0x00000000,unsigned>;
        ///TIM1 clock enable
    ...
    namespace RccAhb1lpenr{    ///<AHB1 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023850,0x9f986f00,0x00000000,unsigned>;
    ...
    namespace RccAhb2lpenr{    ///<AHB2 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023854,0xffffff7e,0x00000000,unsigned>;
    ...
    namespace RccAhb3lpenr{    ///<AHB3 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023858,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace RccApb1lpenr{    ///<APB1 peripheral clock enable in low power          mode register
        using Addr = Register::Address<0x40023860,0xc0003600,0x00000000,unsigned>;
    ...
    namespace RccApb2lpenr{    ///<APB2 peripheral clock enabled in low power          mode register
        using Addr = Register::Address<0x40023864,0xff3880cc,0x00000000,unsigned>;
    ...
    namespace RccBdcr{    ///<Backup domain control register
        using Addr = Register::Address<0x40023870,0xfffe7cf0,0x00000000,unsigned>;
    ...
    namespace RccPlli2scfgr{    ///<PLLI2S configuration register
        using Addr = Register::Address<0x40023884,0x80fc8000,0x00000000,unsigned>;
    ...
    namespace RccPllsaicfgr{    ///<PLL configuration register
        using Addr = Register::Address<0x40023888,0xf0fc8000,0x00000000,unsigned>;
    ...
    namespace RccDckcfgr{    ///<Dedicated Clock Configuration          Register
        using Addr = Register::Address<0x4002388c,0xe00fe0e0,0x00000000,unsigned>;
    ...
    namespace RccCkgatenr{    ///<clocks gated enable register
        using Addr = Register::Address<0x40023890,0xffffff80,0x00000000,unsigned>;
    ...
    namespace RccDckcfgr2{    ///<dedicated clocks configuration register          2
        using Addr = Register::Address<0x40023894,0xc33fffff,0x00000000,unsigned>;
