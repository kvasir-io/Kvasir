...
namespace Kvasir {
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x40020004,0xffff0000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x40020010,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x40020014,0xffff0000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4002001c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x40020020,0x00000000>;
