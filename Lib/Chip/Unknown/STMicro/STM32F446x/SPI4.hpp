...
//Serial peripheral interface
    namespace Spi4Cr1{    ///<control register 1
        using Addr = Register::Address<0x40013400,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Spi4Cr2{    ///<control register 2
        using Addr = Register::Address<0x40013404,0xffffff08,0x00000000,unsigned>;
    ...
    namespace Spi4Sr{    ///<status register
        using Addr = Register::Address<0x40013408,0xfffffe00,0x00000000,unsigned>;
    ...
    namespace Spi4Dr{    ///<data register
        using Addr = Register::Address<0x4001340c,0xffff0000,0x00000000,unsigned>;
        ///Data register
    ...
    namespace Spi4Crcpr{    ///<CRC polynomial register
        using Addr = Register::Address<0x40013410,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Spi4Rxcrcr{    ///<RX CRC register
        using Addr = Register::Address<0x40013414,0xffff0000,0x00000000,unsigned>;
        ///Rx CRC register
    ...
    namespace Spi4I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001341c,0xfffff040,0x00000000,unsigned>;
        ///I2S mode selection
    ...
    namespace Spi4I2spr{    ///<I2S prescaler register
        using Addr = Register::Address<0x40013420,0xfffffc00,0x00000000,unsigned>;
