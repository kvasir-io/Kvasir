...
namespace Kvasir {
    ...
    namespace Nonegcr{
        using Addr = Register::Address<0x40015800,0xffffffcc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> SYNCIN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> SYNCOUT; 
    }
}
