...
//Debug support
    ...
    namespace NonedbgmcuApb1Fz{    ///<Debug MCU APB1 Freeze registe
        using Addr = Register::Address<0xe0042008,0xf81fe200,0,unsigned>;
        ///DBG_TIM2_STOP
        ...
        ///DBG_TIM14_STOP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> dbgTim14Stop{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> dbgJ2c1SmbusTimeout{}; 
        ///DBG_J2C2_SMBUS_TIMEOUT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> dbgJ2c2SmbusTimeout{}; 
        ///DBG_J2C3SMBUS_TIMEOUT
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> dbgJ2c3smbusTimeout{}; 
        ///SMBUS timeout mode stopped when Core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> dbgI2cfmpSmbusTimeout{}; 
        ///DBG_CAN1_STOP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> dbgCan1Stop{}; 
        ///DBG_CAN2_STOP
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> dbgCan2Stop{}; 
    }
    namespace NonedbgmcuApb2Fz{    ///<Debug MCU APB2 Freeze registe
        ...
        ///TIM8 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dbgTim8Stop{}; 
