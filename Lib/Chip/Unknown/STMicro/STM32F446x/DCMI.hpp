...
//Digital camera interface
    namespace Nonecr{    ///<control register 1
        ...
        ///Byte Select mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,unsigned> bsm{}; 
        ///Odd/Even Byte Select
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> oebs{}; 
        ///Line Select mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> lsm{}; 
        ///Odd/Even Line Select
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> oels{}; 
