...
namespace Kvasir {
    namespace Nonecr{
        using Addr = Register::Address<0x40026000,0xffffe000>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40026004,0xfffffff8>;
    ...
    namespace Nonedinr{
        using Addr = Register::Address<0x40026008,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> AES_DINR; 
    }
    namespace Nonedoutr{
        using Addr = Register::Address<0x4002600c,0x00000000>;
    ...
    namespace Nonekeyr2{
        using Addr = Register::Address<0x40026018,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> AES_KEYR2; 
    }
    namespace Nonekeyr3{
        using Addr = Register::Address<0x4002601c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> AES_KEYR3; 
    }
    namespace Noneivr0{
        using Addr = Register::Address<0x40026020,0x00000000>;
    ...
    namespace Noneivr3{
        using Addr = Register::Address<0x4002602c,0x00000000>;
