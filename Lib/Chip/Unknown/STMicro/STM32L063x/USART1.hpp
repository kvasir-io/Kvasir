...
//Universal synchronous asynchronous receiver
    ...
    namespace Nonecr2{    ///<Control register 2
        ...
        ///Auto baud rate mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> abrmod1{}; 
        ///ABRMOD0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> abrmod0{}; 
