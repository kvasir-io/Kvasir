...
//Inter-integrated circuit
    ...
    namespace Nonecr2{    ///<Control register 2
        ...
        ///Slave address bit (master
              mode)
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> sadd{}; 
    }
    namespace Noneoar1{    ///<Own address register 1
        using Addr = Register::Address<0x40005408,0xffff7800,0,unsigned>;
        ///Interface address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> oa1{}; 
