...
//Cyclic redundancy check calculation
    ...
    namespace Nonecr{    ///<Control register
        ...
        ///Polynomial size
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,3),Register::ReadWriteAccess,unsigned> polysize{}; 
        ///RESET bit
    ...
    namespace Noneinit{    ///<Initial CRC value
        ...
        ///Programmable initial CRC
              value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> crcInit{}; 
    }
    namespace Nonepol{    ///<polynomial
        using Addr = Register::Address<0x40023014,0x00000000,0,unsigned>;
        ///Programmable polynomial
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> polynomialcoefficients{}; 
    }
}
