...
//Analog to digital converter
    ...
    namespace Nonesmpr1{    ///<sample time register 1
        using Addr = Register::Address<0x4001240c,0xf8000000,0,unsigned>;
    ...
    namespace Nonedr{    ///<regular data register
        ...
        ///ADC2 data
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> adc2data{}; 
    }
}
