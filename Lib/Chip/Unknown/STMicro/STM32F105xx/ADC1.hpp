...
namespace Kvasir {
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x40012404,0xff300000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16)> DUALMOD; 
    ...
    namespace Nonesmpr1{
        using Addr = Register::Address<0x4001240c,0xf8000000>;
    ...
    namespace Nonedr{
        using Addr = Register::Address<0x4001244c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DATA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> ADC2DATA; 
    }
}
