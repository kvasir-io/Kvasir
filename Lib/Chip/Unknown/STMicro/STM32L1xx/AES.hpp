...
namespace Kvasir {
    ...
    namespace Nonedinr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> DINR; 
    }
    namespace Nonedoutr{
        using Addr = Register::Address<0x5006000c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> DOUTR; 
    }
    namespace Nonekeyr0{
        using Addr = Register::Address<0x50060010,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> KEYR0; 
    }
    namespace Nonekeyr1{
        using Addr = Register::Address<0x50060014,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> KEYR1; 
    }
    namespace Nonekeyr2{
        using Addr = Register::Address<0x50060018,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> KEYR2; 
    }
    namespace Nonekeyr3{
        using Addr = Register::Address<0x5006001c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> KEYR3; 
    }
    namespace Noneivr0{
        using Addr = Register::Address<0x50060020,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> IVR0; 
    }
    namespace Noneivr1{
        using Addr = Register::Address<0x50060024,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> IVR1; 
    }
    namespace Noneivr2{
        using Addr = Register::Address<0x50060028,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> IVR2; 
    }
    namespace Noneivr3{
        using Addr = Register::Address<0x5006002c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> IVR3; 
    }
}
