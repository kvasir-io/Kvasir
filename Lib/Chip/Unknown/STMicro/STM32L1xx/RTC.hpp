...
namespace Kvasir {
    ...
    namespace Nonetsssr{
        using Addr = Register::Address<0x40002838,0xffff1e00>;
    ...
    namespace Nonecalr{
        using Addr = Register::Address<0x4000283c,0xfffb0000>;
    ...
    namespace Nonetafcr{
        using Addr = Register::Address<0x40002840,0xf0ff8000>;
    ...
    namespace Nonealrmbssr{
        using Addr = Register::Address<0x40002848,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> BKP; 
    }
    namespace Nonebk0r{
        using Addr = Register::Address<0x4000289c,0xffffffff>;
    }
}
