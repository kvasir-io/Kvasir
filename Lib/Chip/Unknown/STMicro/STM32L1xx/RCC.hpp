...
namespace Kvasir {
    ...
    namespace Noneahbrstr{
        using Addr = Register::Address<0x40023810,0xbcff6f00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> FSMCRST; 
    ...
    namespace Noneapb2rstr{
        using Addr = Register::Address<0x40023814,0xffffa5e2>;
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40023818,0x4f0135c0>;
    ...
    namespace Noneahbenr{
        using Addr = Register::Address<0x4002381c,0xbcff6f00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> FSMCEN; 
    ...
    namespace Noneapb2enr{
        using Addr = Register::Address<0x40023820,0xffffa5e2>;
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x40023824,0x4f0135c0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> USART5EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> USART4EN; 
    ...
    namespace Noneapb2lpenr{
        using Addr = Register::Address<0x4002382c,0xffffa5e2>;
