...
namespace Kvasir {
    namespace Noneicr{
        using Addr = Register::Address<0x40007c08,0xffc00000>;
    ...
    namespace Noneascr1{
        using Addr = Register::Address<0x40007c0c,0x00020000>;
    ...
    namespace Noneascr2{
        using Addr = Register::Address<0x40007c10,0xc000f000>;
    ...
    namespace Nonehyscr3{
        using Addr = Register::Address<0x40007c1c,0x00000000>;
