...
//General-purpose timers
    ...
    namespace Tim3Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000408,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim3Ccmr1Output{    ///<capture/compare mode register          1
        using Addr = Register::Address<0x40000418,0xffff0200,0x00000000,unsigned>;
    ...
    namespace Tim3Ccmr2Output{    ///<capture/compare mode register          2
        using Addr = Register::Address<0x4000041c,0xffff0200,0x00000000,unsigned>;
