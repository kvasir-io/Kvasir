...
//Reset and clock control
    ...
    namespace Noneahbenr{    ///<AHB peripheral clock enable
        ...
        ///DMA1 clock enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> dmaen{}; 
        ///FLITF clock enable
    ...
    namespace Noneahblpenr{    ///<AHB peripheral clock enable in low power
        ...
        ///DMA1 clock enable during Sleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> dmalpen{}; 
