...
//General-purpose I/Os
    ...
    namespace GpioaOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020004,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpioaIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020010,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpioaOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40020014,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpioaLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002001c,0xfffe0000,0x00000000,unsigned>;
