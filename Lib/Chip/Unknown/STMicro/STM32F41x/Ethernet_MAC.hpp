...
namespace Kvasir {
    ...
    namespace Nonemacffr{
        using Addr = Register::Address<0x40028004,0x7ffffc00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> RAM; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> SAIF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SAF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> HPF; 
    ...
    namespace Nonemacdbgr{
        using Addr = Register::Address<0x40028034,0xffffffc0>;
