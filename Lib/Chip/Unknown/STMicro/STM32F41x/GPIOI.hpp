...
namespace Kvasir {
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x40022004,0xffff0000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x40022010,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x40022014,0xffff0000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4002201c,0xfffe0000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x40022024,0x00000000>;
