...
//General-purpose-timers
    namespace Tim10Cr1{    ///<control register 1
        using Addr = Register::Address<0x40014400,0xfffffc78,0x00000000,unsigned>;
        ///Clock division
    ...
    namespace Tim10Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001440c,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim10Sr{    ///<status register
        using Addr = Register::Address<0x40014410,0xfffffdfc,0x00000000,unsigned>;
    ...
    namespace Tim10Egr{    ///<event generation register
        using Addr = Register::Address<0x40014414,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim10Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40014418,0xffffff80,0x00000000,unsigned>;
    ...
    namespace Tim10Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40014420,0xfffffff4,0x00000000,unsigned>;
    ...
    namespace Tim10Cnt{    ///<counter
        using Addr = Register::Address<0x40014424,0xffff0000,0x00000000,unsigned>;
        ///counter value
