...
//Inter-integrated circuit
    namespace I2c3Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40007800,0xff000000,0x00000000,unsigned>;
        ///Peripheral enable
    ...
    namespace I2c3Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40007804,0xf8000000,0x00000000,unsigned>;
    ...
    namespace I2c3Oar1{    ///<Own address register 1
        using Addr = Register::Address<0x40007808,0xffff7800,0x00000000,unsigned>;
        ///Interface address
    ...
    namespace I2c3Oar2{    ///<Own address register 2
        using Addr = Register::Address<0x4000780c,0xffff7801,0x00000000,unsigned>;
        ///Interface address
    ...
    namespace I2c3Timingr{    ///<Timing register
        using Addr = Register::Address<0x40007810,0x0f000000,0x00000000,unsigned>;
    ...
    namespace I2c3Timeoutr{    ///<Status register 1
        using Addr = Register::Address<0x40007814,0x70006000,0x00000000,unsigned>;
        ///Bus timeout A
    ...
    namespace I2c3Isr{    ///<Interrupt and Status register
        using Addr = Register::Address<0x40007818,0xff004000,0x00000000,unsigned>;
    ...
    namespace I2c3Icr{    ///<Interrupt clear register
        using Addr = Register::Address<0x4000781c,0xffffc0c7,0x00000000,unsigned>;
        ///Alert flag clear
    ...
    namespace I2c3Pecr{    ///<PEC register
        using Addr = Register::Address<0x40007820,0xffffff00,0x00000000,unsigned>;
    ...
    namespace I2c3Rxdr{    ///<Receive data register
        using Addr = Register::Address<0x40007824,0xffffff00,0x00000000,unsigned>;
        ///8-bit receive data
    ...
    namespace I2c3Txdr{    ///<Transmit data register
        using Addr = Register::Address<0x40007828,0xffffff00,0x00000000,unsigned>;
        ///8-bit transmit data
