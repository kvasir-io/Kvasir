...
//Reset and clock control
    ...
    namespace Nonecfgr{    ///<Clock configuration register           (RCC_CFGR)
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> mcof{}; 
    ...
    namespace Noneahbenr{    ///<AHB Peripheral Clock enable register           (RCC_AHBENR)
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> adc34en{}; 
    }
    ...
    namespace Noneahbrstr{    ///<AHB peripheral reset register
        ...
        ///ADC3 and ADC4 reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> adc34rst{}; 
    }
    namespace Nonecfgr2{    ///<Clock configuration register 2
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,9),Register::ReadWriteAccess,unsigned> adc34pres{}; 
    }
    namespace Nonecfgr3{    ///<Clock configuration register 3
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> tim8sw{}; 
        ///UART4 clock source               selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,unsigned> uart4sw{}; 
        ///UART5 clock source               selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,unsigned> uart5sw{}; 
    }
}
