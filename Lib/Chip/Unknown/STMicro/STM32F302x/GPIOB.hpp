...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x48000400,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x48000404,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x48000408,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4800040c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x48000410,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x48000414,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x48000418,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4800041c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x48000420,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x48000424,0x00000000>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x48000428,0xffff0000>;
