...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x40020800,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x40020804,0xffff0000>;
    ...
    namespace Noneospeeder{
        using Addr = Register::Address<0x40020808,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4002080c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x40020810,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x40020814,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x40020818,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4002081c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x40020820,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x40020824,0x00000000>;
