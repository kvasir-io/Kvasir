...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40005400,0xffff4004>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40005404,0xffffe0c0>;
    ...
    namespace Noneoar1{
        using Addr = Register::Address<0x40005408,0xffff7c00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADDMODE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> ADD_8_9; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> ADD_1_7; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> ADD_0; 
    }
    namespace Noneoar2{
        using Addr = Register::Address<0x4000540c,0xffffff00>;
    ...
    namespace Nonedr{
        using Addr = Register::Address<0x40005410,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> DR; 
    }
    namespace Nonesr1{
        using Addr = Register::Address<0x40005414,0xffff2020>;
    ...
    namespace Nonesr2{
        using Addr = Register::Address<0x40005418,0xffff0008>;
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x4000541c,0xffff3000>;
    ...
    namespace Nonetrise{
        using Addr = Register::Address<0x40005420,0xffffffc0>;
