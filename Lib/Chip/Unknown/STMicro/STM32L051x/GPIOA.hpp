...
namespace Kvasir {
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x50000004,0xffff0000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x5000000c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x50000010,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x50000018,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x5000001c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x50000020,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x50000024,0x00000000>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x50000028,0xffff0000>;
