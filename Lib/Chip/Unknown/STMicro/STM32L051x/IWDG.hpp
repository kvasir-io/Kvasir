...
//Independent watchdog
    ...
    namespace Nonesr{    ///<Status register
        ...
        ///Watchdog counter window value
              update
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> wvu{}; 
    ...
    namespace Nonewinr{    ///<Window register
        ...
        ///Watchdog counter window
              value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> win{}; 
    }
}
