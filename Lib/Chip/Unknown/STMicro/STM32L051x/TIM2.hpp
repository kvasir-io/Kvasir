...
namespace Kvasir {
    ...
    namespace Noneor{
        using Addr = Register::Address<0x40000050,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> ETR_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,3)> TI4_RMP; 
    }
}
