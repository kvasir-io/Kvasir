...
//General-purpose-timers
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000000c,0xffff80a0,0,unsigned>;
    ...
    namespace Noneor{    ///<TIM2 option register
        using Addr = Register::Address<0x40000050,0xffffffe0,0,unsigned>;
        ///Timer2 ETR remap
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> etrRmp{}; 
        ///Internal trigger
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,3),Register::ReadWriteAccess,unsigned> ti4Rmp{}; 
    }
}
