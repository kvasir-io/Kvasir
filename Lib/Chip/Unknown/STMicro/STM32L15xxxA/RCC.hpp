...
//Reset and clock control
    ...
    namespace Nonecir{    ///<Clock interrupt register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> lsecssc{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> lsecssie{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> lsecssf{}; 
    ...
    namespace Nonecsr{    ///<Control/status register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> lsecssd{}; 
        ///CSS on LSE enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> lsecsson{}; 
