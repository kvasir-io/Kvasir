...
//System configuration controller
    ...
    namespace Nonepmc{    ///<peripheral mode configuration           register
        using Addr = Register::Address<0x40010004,0xfffffffe,0,unsigned>;
        ///USB pull-up
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> usbPu{}; 
    }
