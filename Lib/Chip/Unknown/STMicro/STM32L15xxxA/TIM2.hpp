...
//General-purpose timers
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000008,0xffff0000,0,unsigned>;
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register           1
        using Addr = Register::Address<0x40000018,0xffff0200,0,unsigned>;
    ...
    namespace Noneccmr2Output{    ///<capture/compare mode register           2
        using Addr = Register::Address<0x4000001c,0xffff0200,0,unsigned>;
