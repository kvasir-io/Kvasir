...
//Inter-integrated circuit
    ...
    namespace Noneoar1{    ///<OAR1
        ...
        ///Interface address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> add89{}; 
        ///Interface address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> add17{}; 
        ///Interface address
