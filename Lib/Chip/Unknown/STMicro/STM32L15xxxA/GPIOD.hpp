...
//General-purpose I/Os
    namespace GpiodModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40020c00,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiodOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020c04,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiodOspeeder{    ///<GPIO port output speed           register
        using Addr = Register::Address<0x40020c08,0x00000000,0x00000000,unsigned>;
        ///OSPEEDR15
    ...
    namespace GpiodPupdr{    ///<GPIO port pull-up/pull-down           register
        using Addr = Register::Address<0x40020c0c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiodIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020c10,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiodOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40020c14,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiodBsrr{    ///<GPIO port bit set/reset           register
        using Addr = Register::Address<0x40020c18,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiodLckr{    ///<GPIO port configuration lock           register
        using Addr = Register::Address<0x40020c1c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiodAfrl{    ///<AFRL
        using Addr = Register::Address<0x40020c20,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiodAfrh{    ///<GPIO alternate function high           register
        using Addr = Register::Address<0x40020c24,0x00000000,0x00000000,unsigned>;
