...
//General-purpose I/Os
    namespace GpiohModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021400,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021404,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiohOspeeder{    ///<GPIO port output speed           register
        using Addr = Register::Address<0x40021408,0x00000000,0x00000000,unsigned>;
        ///OSPEEDR15
    ...
    namespace GpiohPupdr{    ///<GPIO port pull-up/pull-down           register
        using Addr = Register::Address<0x4002140c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiohIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021410,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiohOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021414,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiohBsrr{    ///<GPIO port bit set/reset           register
        using Addr = Register::Address<0x40021418,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohLckr{    ///<GPIO port configuration lock           register
        using Addr = Register::Address<0x4002141c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiohAfrl{    ///<AFRL
        using Addr = Register::Address<0x40021420,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohAfrh{    ///<GPIO alternate function high           register
        using Addr = Register::Address<0x40021424,0x00000000,0x00000000,unsigned>;
