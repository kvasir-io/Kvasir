...
//General-purpose timers
    namespace Tim10Cr1{    ///<control register 1
        using Addr = Register::Address<0x40010c00,0xfffffc78,0x00000000,unsigned>;
        ///Clock division
    ...
    namespace Tim10Dier{    ///<Interrupt enable register
        using Addr = Register::Address<0x40010c0c,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim10Sr{    ///<status register
        using Addr = Register::Address<0x40010c10,0xfffffdfc,0x00000000,unsigned>;
    ...
    namespace Tim10Egr{    ///<event generation register
        using Addr = Register::Address<0x40010c14,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim10Ccmr1Output{    ///<capture/compare mode register
        using Addr = Register::Address<0x40010c18,0xffffff80,0x00000000,unsigned>;
    ...
    namespace Tim10Ccmr1Input{    ///<capture/compare mode register 1 (input           mode)
        using Addr = Register::Address<0x40010c18,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Tim10Ccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40010c20,0xfffffff4,0x00000000,unsigned>;
    ...
    namespace Tim10Cnt{    ///<counter
        using Addr = Register::Address<0x40010c24,0xffff0000,0x00000000,unsigned>;
        ///TIM10 counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim10Psc{    ///<prescaler
        using Addr = Register::Address<0x40010c28,0xffff0000,0x00000000,unsigned>;
        ///TIM9 prescaler
    ...
    namespace Tim10Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40010c2c,0xffff0000,0x00000000,unsigned>;
        ///Auto-reload value
    ...
    namespace Tim10Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40010c34,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim10Or{    ///<option register
        using Addr = Register::Address<0x40010c50,0xfffffffc,0x00000000,unsigned>;
