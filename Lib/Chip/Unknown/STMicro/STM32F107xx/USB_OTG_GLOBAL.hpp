...
//USB on the go full speed
    ...
    namespace NonefsGusbcfg{    ///<OTG_FS USB configuration register
          (OTG_FS_GUSBCFG)
        using Addr = Register::Address<0x5000000c,0x1fffc078,0,unsigned>;
        ...
        ///Full Speed serial transceiver
              select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> physel{}; 
        ///SRP-capable
    ...
    namespace NonefsGrxstsrHost{    ///<OTG_FS Receive status debug read(Host
          mode)
        using Addr = Register::Address<0x5000001c,0xfe000000,0,unsigned>;
        ///Endpoint number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> epnum{}; 
