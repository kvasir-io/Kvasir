...
//EXTI
    namespace Noneimr{    ///<Interrupt mask register
          (EXTI_IMR)
        using Addr = Register::Address<0x40010400,0xfff00000,0,unsigned>;
    ...
    namespace Noneemr{    ///<Event mask register (EXTI_EMR)
        using Addr = Register::Address<0x40010404,0xfff00000,0,unsigned>;
    ...
    namespace Nonertsr{    ///<Rising Trigger selection register
          (EXTI_RTSR)
        using Addr = Register::Address<0x40010408,0xfff00000,0,unsigned>;
    ...
    namespace Noneftsr{    ///<Falling Trigger selection register
          (EXTI_FTSR)
        using Addr = Register::Address<0x4001040c,0xfff00000,0,unsigned>;
    ...
    namespace Noneswier{    ///<Software interrupt event register
          (EXTI_SWIER)
        using Addr = Register::Address<0x40010410,0xfff00000,0,unsigned>;
    ...
    namespace Nonepr{    ///<Pending register (EXTI_PR)
        using Addr = Register::Address<0x40010414,0xfff00000,0,unsigned>;
        ///Pending bit 0
