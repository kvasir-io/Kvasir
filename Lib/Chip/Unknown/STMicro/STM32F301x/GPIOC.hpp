...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x48000800,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x48000804,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x48000808,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4800080c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x48000810,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x48000814,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x48000818,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4800081c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x48000820,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x48000824,0x00000000>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x48000828,0xffff0000>;
