...
//Digital-to-analog converter
    ...
    namespace Nonedhr12r1{    ///<channel1 12-bit right-aligned data holding           register
    ...
    namespace Nonedhr12l1{    ///<channel1 12-bit left aligned data holding           register
    ...
    namespace Nonedhr8r1{    ///<channel1 8-bit right aligned data holding           register
    ...
    namespace Nonedhr12r2{    ///<channel2 12-bit right aligned data holding           register
    ...
    namespace Nonedhr12l2{    ///<channel2 12-bit left aligned data holding           register
    ...
    namespace Nonedhr8r2{    ///<channel2 8-bit right-aligned data holding           register
    ...
    namespace Nonedhr12rd{    ///<Dual DAC 12-bit right-aligned data holding           register
    ...
    namespace Nonedhr12ld{    ///<DUAL DAC 12-bit left aligned data holding           register
    ...
    namespace Nonedhr8rd{    ///<DUAL DAC 8-bit right aligned data holding           register
