...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x48000000,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x48000004,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x48000008,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4800000c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x48000010,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x48000014,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x48000018,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4800001c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x48000020,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x48000024,0x00000000>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x48000028,0xffff0000>;
