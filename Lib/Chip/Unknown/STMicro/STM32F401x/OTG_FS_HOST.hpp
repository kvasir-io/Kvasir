...
//USB on the go full speed
    namespace NonefsHcfg{    ///<OTG_FS host configuration register           (OTG_FS_HCFG)
    ...
    namespace Nonehfir{    ///<OTG_FS Host frame interval           register
    ...
    namespace NonefsHfnum{    ///<OTG_FS host frame number/frame time           remaining register (OTG_FS_HFNUM)
    ...
    namespace NonefsHptxsts{    ///<OTG_FS_Host periodic transmit FIFO/queue           status register (OTG_FS_HPTXSTS)
    ...
    namespace Nonehaint{    ///<OTG_FS Host all channels interrupt           register
    ...
    namespace Nonehaintmsk{    ///<OTG_FS host all channels interrupt mask           register
    ...
    namespace NonefsHprt{    ///<OTG_FS host port control and status register           (OTG_FS_HPRT)
    ...
    namespace NonefsHcchar0{    ///<OTG_FS host channel-0 characteristics           register (OTG_FS_HCCHAR0)
    ...
    namespace NonefsHcchar1{    ///<OTG_FS host channel-1 characteristics           register (OTG_FS_HCCHAR1)
    ...
    namespace NonefsHcchar2{    ///<OTG_FS host channel-2 characteristics           register (OTG_FS_HCCHAR2)
    ...
    namespace NonefsHcchar3{    ///<OTG_FS host channel-3 characteristics           register (OTG_FS_HCCHAR3)
    ...
    namespace NonefsHcchar4{    ///<OTG_FS host channel-4 characteristics           register (OTG_FS_HCCHAR4)
    ...
    namespace NonefsHcchar5{    ///<OTG_FS host channel-5 characteristics           register (OTG_FS_HCCHAR5)
    ...
    namespace NonefsHcchar6{    ///<OTG_FS host channel-6 characteristics           register (OTG_FS_HCCHAR6)
    ...
    namespace NonefsHcchar7{    ///<OTG_FS host channel-7 characteristics           register (OTG_FS_HCCHAR7)
    ...
    namespace NonefsHcint0{    ///<OTG_FS host channel-0 interrupt register           (OTG_FS_HCINT0)
    ...
    namespace NonefsHcint1{    ///<OTG_FS host channel-1 interrupt register           (OTG_FS_HCINT1)
    ...
    namespace NonefsHcint2{    ///<OTG_FS host channel-2 interrupt register           (OTG_FS_HCINT2)
    ...
    namespace NonefsHcint3{    ///<OTG_FS host channel-3 interrupt register           (OTG_FS_HCINT3)
    ...
    namespace NonefsHcint4{    ///<OTG_FS host channel-4 interrupt register           (OTG_FS_HCINT4)
    ...
    namespace NonefsHcint5{    ///<OTG_FS host channel-5 interrupt register           (OTG_FS_HCINT5)
    ...
    namespace NonefsHcint6{    ///<OTG_FS host channel-6 interrupt register           (OTG_FS_HCINT6)
    ...
    namespace NonefsHcint7{    ///<OTG_FS host channel-7 interrupt register           (OTG_FS_HCINT7)
    ...
    namespace NonefsHcintmsk0{    ///<OTG_FS host channel-0 mask register           (OTG_FS_HCINTMSK0)
    ...
    namespace NonefsHcintmsk1{    ///<OTG_FS host channel-1 mask register           (OTG_FS_HCINTMSK1)
    ...
    namespace NonefsHcintmsk2{    ///<OTG_FS host channel-2 mask register           (OTG_FS_HCINTMSK2)
    ...
    namespace NonefsHcintmsk3{    ///<OTG_FS host channel-3 mask register           (OTG_FS_HCINTMSK3)
    ...
    namespace NonefsHcintmsk4{    ///<OTG_FS host channel-4 mask register           (OTG_FS_HCINTMSK4)
    ...
    namespace NonefsHcintmsk5{    ///<OTG_FS host channel-5 mask register           (OTG_FS_HCINTMSK5)
    ...
    namespace NonefsHcintmsk6{    ///<OTG_FS host channel-6 mask register           (OTG_FS_HCINTMSK6)
    ...
    namespace NonefsHcintmsk7{    ///<OTG_FS host channel-7 mask register           (OTG_FS_HCINTMSK7)
    ...
    namespace NonefsHctsiz0{    ///<OTG_FS host channel-0 transfer size           register
    ...
    namespace NonefsHctsiz1{    ///<OTG_FS host channel-1 transfer size           register
    ...
    namespace NonefsHctsiz2{    ///<OTG_FS host channel-2 transfer size           register
    ...
    namespace NonefsHctsiz3{    ///<OTG_FS host channel-3 transfer size           register
    ...
    namespace NonefsHctsiz4{    ///<OTG_FS host channel-x transfer size           register
    ...
    namespace NonefsHctsiz5{    ///<OTG_FS host channel-5 transfer size           register
    ...
    namespace NonefsHctsiz6{    ///<OTG_FS host channel-6 transfer size           register
    ...
    namespace NonefsHctsiz7{    ///<OTG_FS host channel-7 transfer size           register
