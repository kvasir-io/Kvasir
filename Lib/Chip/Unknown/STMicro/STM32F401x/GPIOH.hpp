...
//General-purpose I/Os
    namespace GpiohModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40021c00,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40021c04,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiohOspeedr{    ///<GPIO port output speed           register
        using Addr = Register::Address<0x40021c08,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiohPupdr{    ///<GPIO port pull-up/pull-down           register
        using Addr = Register::Address<0x40021c0c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiohIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40021c10,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiohOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40021c14,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiohBsrr{    ///<GPIO port bit set/reset           register
        using Addr = Register::Address<0x40021c18,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohLckr{    ///<GPIO port configuration lock           register
        using Addr = Register::Address<0x40021c1c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiohAfrl{    ///<GPIO alternate function low           register
        using Addr = Register::Address<0x40021c20,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiohAfrh{    ///<GPIO alternate function high           register
        using Addr = Register::Address<0x40021c24,0x00000000,0x00000000,unsigned>;
