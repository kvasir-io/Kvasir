...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40014800,0xfffffc78>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x4001480c,0xfffffffc>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40014810,0xfffffdfc>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40014814,0xfffffffc>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40014818,0xffffff80>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40014820,0xfffffff4>;
    ...
    namespace Nonecnt{
        using Addr = Register::Address<0x40014824,0xffff0000>;
    ...
    namespace Noneor{
        using Addr = Register::Address<0x40014850,0xfffffffc>;
