...
//General purpose timers
    ...
    namespace Tim9Cr2{    ///<control register 2
        using Addr = Register::Address<0x40014004,0xffffff8f,0x00000000,unsigned>;
    ...
    namespace Tim9Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001400c,0xffffffb8,0x00000000,unsigned>;
    ...
    namespace Tim9Sr{    ///<status register
        using Addr = Register::Address<0x40014010,0xfffff9b8,0x00000000,unsigned>;
    ...
    namespace Tim9Egr{    ///<event generation register
        using Addr = Register::Address<0x40014014,0xffffffb8,0x00000000,unsigned>;
        ///Trigger generation
    ...
    namespace Tim9Ccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40014020,0xffffff44,0x00000000,unsigned>;
