...
//Universal synchronous asynchronous receiver       transmitter
    ...
    namespace Nonedr{    ///<Data register
        using Addr = Register::Address<0x40011404,0xfffffe00,0,unsigned>;
        ///Data value
    ...
    namespace Nonebrr{    ///<Baud rate register
        using Addr = Register::Address<0x40011408,0xffff0000,0,unsigned>;
    ...
    namespace Nonecr1{    ///<Control register 1
        using Addr = Register::Address<0x4001140c,0xffff4000,0,unsigned>;
        ///Oversampling mode
    ...
    namespace Nonecr2{    ///<Control register 2
        using Addr = Register::Address<0x40011410,0xffff8090,0,unsigned>;
        ///LIN mode enable
    ...
    namespace Nonecr3{    ///<Control register 3
        using Addr = Register::Address<0x40011414,0xfffff000,0,unsigned>;
