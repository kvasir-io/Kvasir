...
//General-purpose I/Os
    namespace GpiocModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x40020800,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiocOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40020804,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiocOspeedr{    ///<GPIO port output speed           register
        using Addr = Register::Address<0x40020808,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiocPupdr{    ///<GPIO port pull-up/pull-down           register
        using Addr = Register::Address<0x4002080c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =               0..15)
    ...
    namespace GpiocIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40020810,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiocOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40020814,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiocBsrr{    ///<GPIO port bit set/reset           register
        using Addr = Register::Address<0x40020818,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiocLckr{    ///<GPIO port configuration lock           register
        using Addr = Register::Address<0x4002081c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiocAfrl{    ///<GPIO alternate function low           register
        using Addr = Register::Address<0x40020820,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiocAfrh{    ///<GPIO alternate function high           register
        using Addr = Register::Address<0x40020824,0x00000000,0x00000000,unsigned>;
