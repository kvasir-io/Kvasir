...
//General purpose timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40000400,0xfffffc00,0,unsigned>;
        ///Clock division
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x40000404,0xffffff07,0,unsigned>;
        ///TI1 selection
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000408,0xffff0008,0,unsigned>;
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000040c,0xffffa0a0,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40000410,0xffffe1a0,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40000414,0xffffffa0,0,unsigned>;
        ///Trigger generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register 1 (output           mode)
        using Addr = Register::Address<0x40000418,0xffff0000,0,unsigned>;
        ///OC2CE
    ...
    namespace Noneccmr2Output{    ///<capture/compare mode register 2 (output           mode)
        using Addr = Register::Address<0x4000041c,0xffff0000,0,unsigned>;
        ///O24CE
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> o24ce{}; 
        ///OC4M
    ...
    namespace Noneccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40000420,0xffff4444,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        ...
        ///High counter value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> cntH{}; 
        ///Low counter value
    ...
    namespace Nonepsc{    ///<prescaler
        using Addr = Register::Address<0x40000428,0xffff0000,0,unsigned>;
        ///Prescaler value
    ...
    namespace Nonearr{    ///<auto-reload register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> arrH{}; 
        ///Low Auto-reload value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> arrL{}; 
    }
    namespace Noneccr1{    ///<capture/compare register 1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ccr1H{}; 
        ///Low Capture/Compare 1               value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1L{}; 
    }
    namespace Noneccr2{    ///<capture/compare register 2
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ccr2H{}; 
        ///Low Capture/Compare 2               value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2L{}; 
    }
    namespace Noneccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000043c,0x00000000,0,unsigned>;
        ///High Capture/Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ccr3H{}; 
        ///Low Capture/Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr3L{}; 
    }
    namespace Noneccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40000440,0x00000000,0,unsigned>;
        ///High Capture/Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> ccr4H{}; 
        ///Low Capture/Compare value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr4L{}; 
    }
    namespace Nonedcr{    ///<DMA control register
        using Addr = Register::Address<0x40000448,0xffffe0e0,0,unsigned>;
        ///DMA burst length
    ...
    namespace Nonedmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4000044c,0xffff0000,0,unsigned>;
