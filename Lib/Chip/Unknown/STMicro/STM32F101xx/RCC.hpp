...
namespace Kvasir {
    ...
    namespace Noneapb2rstr{
        using Addr = Register::Address<0x4002100c,0xffc7a802>;
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40021010,0xc7813600>;
    ...
    namespace Noneahbenr{
        using Addr = Register::Address<0x40021014,0xfffffea8>;
    ...
    namespace Noneapb2enr{
        using Addr = Register::Address<0x40021018,0xffc7ac02>;
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x4002101c,0xc7813600>;
