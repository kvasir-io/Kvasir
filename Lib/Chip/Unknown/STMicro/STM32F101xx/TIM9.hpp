...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40014c00,0xfffffc70>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40014c04,0xffffff8f>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4)> MMS; 
    }
    namespace Nonesmcr{
        using Addr = Register::Address<0x40014c08,0xffffff08>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x40014c0c,0xffffffb8>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40014c10,0xfffff9b8>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40014c14,0xffffffb8>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40014c18,0xffff8080>;
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x40014c18,0xffff0000>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40014c20,0xffffff44>;
