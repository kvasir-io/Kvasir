...
//General purpose timer
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40014c00,0xfffffc70,0,unsigned>;
        ///Clock division
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x40014c04,0xffffff8f,0,unsigned>;
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40014c08,0xffffff08,0,unsigned>;
        ///Master/Slave mode
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x40014c0c,0xffffffb8,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40014c10,0xfffff9b8,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40014c14,0xffffffb8,0,unsigned>;
        ///Trigger generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register 1 (output
          mode)
        using Addr = Register::Address<0x40014c18,0xffff8080,0,unsigned>;
    ...
    namespace Noneccmr1Input{    ///<capture/compare mode register 1 (input
          mode)
        using Addr = Register::Address<0x40014c18,0xffff0000,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x40014c20,0xffffff44,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x40014c24,0xffff0000,0,unsigned>;
        ///counter value
    ...
    namespace Nonepsc{    ///<prescaler
        using Addr = Register::Address<0x40014c28,0xffff0000,0,unsigned>;
        ///Prescaler value
    ...
    namespace Nonearr{    ///<auto-reload register
        using Addr = Register::Address<0x40014c2c,0xffff0000,0,unsigned>;
        ///Auto-reload value
    ...
    namespace Noneccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40014c34,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40014c38,0xffff0000,0,unsigned>;
