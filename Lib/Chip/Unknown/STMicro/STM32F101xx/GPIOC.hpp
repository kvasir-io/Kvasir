...
//General purpose I/O
    ...
    namespace GpiocIdr{    ///<Port input data register          (GPIOn_IDR)
        using Addr = Register::Address<0x40011008,0xffff0000,0x00000000,unsigned>;
        ///Port input data
    ...
    namespace GpiocOdr{    ///<Port output data register          (GPIOn_ODR)
        using Addr = Register::Address<0x4001100c,0xffff0000,0x00000000,unsigned>;
        ///Port output data
    ...
    namespace GpiocBrr{    ///<Port bit reset register          (GPIOn_BRR)
        using Addr = Register::Address<0x40011014,0xffff0000,0x00000000,unsigned>;
        ///Reset bit 0
    ...
    namespace GpiocLckr{    ///<Port configuration lock          register
        using Addr = Register::Address<0x40011018,0xfffe0000,0x00000000,unsigned>;
        ///Port A Lock bit 0
