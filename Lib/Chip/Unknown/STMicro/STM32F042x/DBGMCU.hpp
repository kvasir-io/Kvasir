...
//Debug support
    namespace Noneidcode{    ///<MCU Device ID Code Register
        ...
        ///Division Identifier
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> divId{}; 
        ///Revision Identifier
    ...
    namespace Noneapblfz{    ///<APB Low Freeze Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dbgTimer3Stop{}; 
    ...
    namespace Noneapbhfz{    ///<APB High Freeze Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> dbgTimer1Stop{}; 
        ///Debug Timer 15 stopped when Core is               halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> dbgTimer15Sto{}; 
        ///Debug Timer 16 stopped when Core is               halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> dbgTimer16Sto{}; 
        ///Debug Timer 17 stopped when Core is               halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> dbgTimer17Sto{}; 
    }
}
