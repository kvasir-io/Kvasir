...
namespace Kvasir {
    ...
    namespace Nonecfgr{
        using Addr = Register::Address<0x40021004,0x08c03800>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> ADCPRE; 
    ...
    namespace Nonecir{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> HSI48RDYIE; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> HSI48RDYC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> CSSC; 
    }
    namespace Noneapb2rstr{
        using Addr = Register::Address<0x4002100c,0xffb9a5fe>;
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40021010,0xa55db6fc>;
    ...
    namespace Noneahbenr{
        using Addr = Register::Address<0x40021014,0xfeb1ffaa>;
    ...
    namespace Noneapb2enr{
        using Addr = Register::Address<0x40021018,0xffb9a5fe>;
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x4002101c,0x855db6fc>;
    ...
    namespace Noneahbrstr{
        using Addr = Register::Address<0x40021028,0xfeb1ffff>;
    ...
    namespace Nonecfgr3{
        using Addr = Register::Address<0x40021030,0xfffcfe2c>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> USBSW; 
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40021034,0xfefc0000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> HSI48ON; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> HSI48RDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> HSI48CAL; 
    }
}
