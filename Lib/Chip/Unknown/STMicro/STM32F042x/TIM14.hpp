...
//General-purpose-timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40002000,0xfffffc78,0,unsigned>;
        ///Clock division
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000200c,0xfffffffc,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40002010,0xfffffdfc,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40002014,0xfffffffc,0,unsigned>;
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register (output           mode)
        using Addr = Register::Address<0x40002018,0xffffff80,0,unsigned>;
    ...
    namespace Noneccmr1Input{    ///<capture/compare mode register (input           mode)
    ...
    namespace Noneccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40002020,0xfffffff4,0,unsigned>;
    ...
    namespace Noneor{    ///<option register
        using Addr = Register::Address<0x40002050,0xfffffffc,0,unsigned>;
        ///Timer input 1 remap
