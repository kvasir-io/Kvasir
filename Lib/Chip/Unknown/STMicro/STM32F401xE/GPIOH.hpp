...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x40021c00,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x40021c04,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x40021c08,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x40021c0c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x40021c10,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x40021c14,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x40021c18,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x40021c1c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x40021c20,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x40021c24,0x00000000>;
