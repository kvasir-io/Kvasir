...
//System configuration controller
    namespace Nonecfgr1{    ///<configuration register 1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> adcDmaRmp{}; 
        ///USART1_TX DMA remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> usart1TxDmaRmp{}; 
        ///USART1_RX DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> usart1RxDmaRmp{}; 
        ...
        ///FM+ driving capability activation for
              I2C1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> i2c1FmPlus{}; 
        ///FM+ driving capability activation for
              I2C2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> i2c2FmPlus{}; 
        ///SPI2 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> spi2DmaRmp{}; 
        ///USART2 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> usart2DmaRmp{}; 
        ///USART3 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> usart3DmaRmp{}; 
        ///I2C1 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> i2c1DmaRmp{}; 
        ///TIM1 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> tim1DmaRmp{}; 
        ///TIM2 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> tim2DmaRmp{}; 
        ///TIM3 DMA request remapping
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> tim3DmaRmp{}; 
    }
