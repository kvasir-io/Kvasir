...
//Digital-to-analog converter
    namespace Nonecr{    ///<control register
        ...
        ///DAC channel1 trigger
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> tsel10{}; 
        ///DAC channel1 trigger
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> tsel11{}; 
        ///DAC channel1 trigger
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> tsel12{}; 
