...
//System configuration controller
    namespace SyscfgMemrm{    ///<memory remap register
        using Addr = Register::Address<0x40013800,0xfffffffc,0x00000000,unsigned>;
        ///MEM_MODE
    ...
    namespace SyscfgPmc{    ///<peripheral mode configuration          register
        using Addr = Register::Address<0x40013804,0xff7fffff,0x00000000,unsigned>;
    ...
    namespace SyscfgCmpcr{    ///<Compensation cell control          register
        using Addr = Register::Address<0x40013820,0xffffff7e,0x00000000,unsigned>;
        ///READY
