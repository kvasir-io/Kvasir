...
//Common ADC registers
    namespace Nonecsr{    ///<ADC Common status register
        ...
        ///Regular channel Start flag of ADC
              3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> strt3{}; 
        ///Injected channel Start flag of ADC
              3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> jstrt3{}; 
        ///Injected channel end of conversion of
              ADC 3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> jeoc3{}; 
        ///End of conversion of ADC 3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> eoc3{}; 
        ///Analog watchdog flag of ADC
              3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> awd3{}; 
        ///Overrun flag of ADC 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> ovr2{}; 
        ///Regular channel Start flag of ADC
              2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> strt2{}; 
        ///Injected channel Start flag of ADC
              2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> jstrt2{}; 
        ///Injected channel end of conversion of
              ADC 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> jeoc2{}; 
        ///End of conversion of ADC 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> eoc2{}; 
        ///Analog watchdog flag of ADC
              2
    ...
    namespace Noneccr{    ///<ADC common control register
        using Addr = Register::Address<0x40012304,0xff3c10e0,0,unsigned>;
        ...
        ///VBAT enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> vbate{}; 
        ///ADC prescaler
        ...
        ///Direct memory access mode for multi ADC
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> dma{}; 
        ///DMA disable selection for multi-ADC
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> dds{}; 
    ...
    namespace Nonecdr{    ///<ADC common regular data register for dual
          and triple modes
        using Addr = Register::Address<0x40012308,0x00000000,0,unsigned>;
        ///2nd data item of a pair of regular
              conversions
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> data2{}; 
        ///1st data item of a pair of regular
              conversions
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> data1{}; 
    }
}
