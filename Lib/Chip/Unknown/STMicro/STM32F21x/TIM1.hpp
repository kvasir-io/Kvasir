...
//Advanced-timers
    namespace Tim1Cr1{    ///<control register 1
        using Addr = Register::Address<0x40010000,0xfffffc00,0x00000000,unsigned>;
        ///Clock division
    ...
    namespace Tim1Cr2{    ///<control register 2
        using Addr = Register::Address<0x40010004,0xffff8002,0x00000000,unsigned>;
        ///Output Idle state 4
    ...
    namespace Tim1Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010008,0xffff0008,0x00000000,unsigned>;
    ...
    namespace Tim1Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001000c,0xffff8000,0x00000000,unsigned>;
    ...
    namespace Tim1Sr{    ///<status register
        using Addr = Register::Address<0x40010010,0xffffe100,0x00000000,unsigned>;
    ...
    namespace Tim1Egr{    ///<event generation register
        using Addr = Register::Address<0x40010014,0xffffff00,0x00000000,unsigned>;
        ///Break generation
    ...
    namespace Tim1Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40010020,0xffffc000,0x00000000,unsigned>;
    ...
    namespace Tim1Psc{    ///<prescaler
        using Addr = Register::Address<0x40010028,0xffff0000,0x00000000,unsigned>;
        ///Prescaler value
    ...
    namespace Tim1Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40010034,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim1Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40010038,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim1Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4001003c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim1Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40010040,0xffff0000,0x00000000,unsigned>;
        ///Capture/Compare value
    ...
    namespace Tim1Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40010048,0xffffe0e0,0x00000000,unsigned>;
        ///DMA burst length
    ...
    namespace Tim1Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40010044,0xffff0000,0x00000000,unsigned>;
        ///Main output enable
