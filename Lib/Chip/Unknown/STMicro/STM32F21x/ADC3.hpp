...
//Analog-to-digital converter
    namespace Adc3Sr{    ///<status register
        using Addr = Register::Address<0x40012200,0xffffffc0,0x00000000,unsigned>;
        ///Overrun
    ...
    namespace Adc3Cr1{    ///<control register 1
        using Addr = Register::Address<0x40012204,0xf83f0000,0x00000000,unsigned>;
    ...
    namespace Adc3Cr2{    ///<control register 2
        using Addr = Register::Address<0x40012208,0x8080f0fc,0x00000000,unsigned>;
    ...
    namespace Adc3Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x4001220c,0xf8000000,0x00000000,unsigned>;
    ...
    namespace Adc3Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x40012210,0xc0000000,0x00000000,unsigned>;
    ...
    namespace Adc3Jofr1{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012214,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Adc3Jofr2{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012218,0xfffff000,0x00000000,unsigned>;
        ///Data offset for injected channel              x
    ...
    namespace Adc3Jofr3{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x4001221c,0xfffff000,0x00000000,unsigned>;
        ///Data offset for injected channel              x
    ...
    namespace Adc3Jofr4{    ///<injected channel data offset register          x
        using Addr = Register::Address<0x40012220,0xfffff000,0x00000000,unsigned>;
        ///Data offset for injected channel              x
    ...
    namespace Adc3Htr{    ///<watchdog higher threshold          register
        using Addr = Register::Address<0x40012224,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Adc3Ltr{    ///<watchdog lower threshold          register
        using Addr = Register::Address<0x40012228,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Adc3Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x4001222c,0xff000000,0x00000000,unsigned>;
    ...
    namespace Adc3Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x40012230,0xc0000000,0x00000000,unsigned>;
    ...
    namespace Adc3Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x40012234,0xc0000000,0x00000000,unsigned>;
    ...
    namespace Adc3Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x40012238,0xffc00000,0x00000000,unsigned>;
    ...
    namespace Adc3Jdr1{    ///<injected data register x
        using Addr = Register::Address<0x4001223c,0xffff0000,0x00000000,unsigned>;
        ///Injected data
    ...
    namespace Adc3Jdr2{    ///<injected data register x
        using Addr = Register::Address<0x40012240,0xffff0000,0x00000000,unsigned>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc3Jdr3{    ///<injected data register x
        using Addr = Register::Address<0x40012244,0xffff0000,0x00000000,unsigned>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc3Jdr4{    ///<injected data register x
        using Addr = Register::Address<0x40012248,0xffff0000,0x00000000,unsigned>;
        ///Injected data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> jdata{}; 
    }
    namespace Adc3Dr{    ///<regular data register
        using Addr = Register::Address<0x4001224c,0xffff0000,0x00000000,unsigned>;
        ///Regular data
