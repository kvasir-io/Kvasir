...
namespace Kvasir {
    ...
    namespace Nonecr{
        using Addr = Register::Address<0x40002808,0xff080020>;
    ...
    namespace Noneisr{
        using Addr = Register::Address<0x4000280c,0xffffc008>;
    ...
    namespace Noneprer{
        using Addr = Register::Address<0x40002810,0xff80e000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,16)> PREDIV_A; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,0)> PREDIV_S; 
    }
    namespace Nonewutr{
    ...
    namespace Nonetafcr{
        using Addr = Register::Address<0x40002840,0xfff8fff8>;
