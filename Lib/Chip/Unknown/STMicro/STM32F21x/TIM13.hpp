...
//General-purpose-timers
    namespace Tim13Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001c00,0xfffffc78,0x00000000,unsigned>;
        ///Clock division
    ...
    namespace Tim13Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x40001c0c,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim13Sr{    ///<status register
        using Addr = Register::Address<0x40001c10,0xfffffdfc,0x00000000,unsigned>;
    ...
    namespace Tim13Egr{    ///<event generation register
        using Addr = Register::Address<0x40001c14,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Tim13Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40001c18,0xffffff80,0x00000000,unsigned>;
    ...
    namespace Tim13Ccmr1Input{    ///<capture/compare mode register (input          mode)
        using Addr = Register::Address<0x40001c18,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Tim13Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40001c20,0xfffffff4,0x00000000,unsigned>;
    ...
    namespace Tim13Cnt{    ///<counter
        using Addr = Register::Address<0x40001c24,0xffff0000,0x00000000,unsigned>;
        ///counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim13Psc{    ///<prescaler
        using Addr = Register::Address<0x40001c28,0xffff0000,0x00000000,unsigned>;
        ///Prescaler value
    ...
    namespace Tim13Arr{    ///<auto-reload register
        using Addr = Register::Address<0x40001c2c,0xffff0000,0x00000000,unsigned>;
        ///Auto-reload value
    ...
    namespace Tim13Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40001c34,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim13Or{    ///<option register
        using Addr = Register::Address<0x40001c50,0xfffffffc,0x00000000,unsigned>;
