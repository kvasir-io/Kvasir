...
//Memory Control registers
    ...
    namespace MemRamprotr4{    ///<Memory protection register4
        using Addr = Register::Address<0x4000500c,0x00000000,0x00000000,unsigned>;
        ///RAMPROT4
    ...
    namespace MemRamprotr5{    ///<Memory protection register5
        using Addr = Register::Address<0x40005010,0x00000000,0x00000000,unsigned>;
        ///RAMPROT5
    ...
    namespace MemRamprotr7{    ///<Memory protection register7
        using Addr = Register::Address<0x40005018,0x00000000,0x00000000,unsigned>;
        ///RAMPROT7
    ...
    namespace MemRamprotr8{    ///<Memory protection register8
        using Addr = Register::Address<0x4000501c,0x00000000,0x00000000,unsigned>;
        ///RAMPROT8
    ...
    namespace MemDmaprotr2{    ///<DMA protection register2
        using Addr = Register::Address<0x40005024,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace MemRamcr{    ///<Memory configuration register
        using Addr = Register::Address<0x40005028,0xfffffffb,0x00000000,unsigned>;
