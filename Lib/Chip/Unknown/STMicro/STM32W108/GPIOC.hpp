...
//General purpose I/Os
    namespace NonegpiocCrl{    ///<Port C configuration register
          (Low)
        using Addr = Register::Address<0x4000b800,0xffff0000,0,unsigned>;
        ///CNFMODE3
    ...
    namespace NonegpiocCrh{    ///<Port C configuration register
          (High)
        using Addr = Register::Address<0x4000b804,0xffff0000,0,unsigned>;
        ///CNFMODE7
    ...
    namespace NonegpiocIdr{    ///<Port C input data register
        using Addr = Register::Address<0x4000b808,0xffffff00,0,unsigned>;
        ///ID7
    ...
    namespace NonegpiocOdr{    ///<Port C output data register
        using Addr = Register::Address<0x4000b80c,0xffffff00,0,unsigned>;
        ///OD7
    ...
    namespace NonegpiocBsr{    ///<Port B bit set register
        using Addr = Register::Address<0x4000b810,0xffffff00,0,unsigned>;
        ///BS7
    ...
    namespace NonegpiocBrr{    ///<Port C output clear register
        using Addr = Register::Address<0x4000b814,0xffffff00,0,unsigned>;
        ///BR7
