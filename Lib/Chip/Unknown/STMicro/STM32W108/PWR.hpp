...
//Power control
    namespace PwrPwrDsleepcr1{    ///<PWR_DSLEEPCR1
        using Addr = Register::Address<0x40000004,0xfffffffd,0x00000000,unsigned>;
        ///PWR_CSYSPWRUPACKCR
    ...
    namespace PwrPwrDsleepcr2{    ///<PWR_DSLEEPCR2
        using Addr = Register::Address<0x40000014,0xfffffffe,0x00000000,unsigned>;
        ///MODE
    ...
    namespace PwrPwrVregcr{    ///<Voltage regulator Control          register
        using Addr = Register::Address<0x40000018,0xffff7468,0x00000000,unsigned>;
    ...
    namespace PwrPwrWakecr1{    ///<PWR_WAKECR1
        using Addr = Register::Address<0x40000020,0xfffffc00,0x00000000,unsigned>;
        ///WAKEEN
    ...
    namespace PwrPwrWakecr2{    ///<PWR_WAKECR2
        using Addr = Register::Address<0x40000024,0xffffffdf,0x00000000,unsigned>;
        ///COREWAKE
    ...
    namespace PwrPwrWakesr{    ///<PWR_WAKESR
        using Addr = Register::Address<0x40000028,0xfffffc00,0x00000000,unsigned>;
        ///GPIOPIN
    ...
    namespace PwrPwrCpwrupreqsr{    ///<PWR_CPWRUPREQSR
        using Addr = Register::Address<0x40000034,0xfffffffe,0x00000000,unsigned>;
        ///REQ
    ...
    namespace PwrPwrCsyspwrupreqsr{    ///<PWR_CSYSPWRUPREQSR
        using Addr = Register::Address<0x40000038,0xfffffffe,0x00000000,unsigned>;
        ///REQ
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> req{}; 
    }
    namespace PwrPwrCsyspwrupacksr{    ///<PWR_CSYSPWRUPACKSR
        using Addr = Register::Address<0x4000003c,0xfffffffe,0x00000000,unsigned>;
        ///ACK
    ...
    namespace PwrPwrCsyspwrupackcr{    ///<PWR_CSYSPWRUPACKCR
        using Addr = Register::Address<0x40000040,0xfffffffe,0x00000000,unsigned>;
        ///INHIBIT
    ...
    namespace PwrPwrWakepar{    ///<Wake GPIO Port A register
        using Addr = Register::Address<0x4000bc08,0xffffff00,0x00000000,unsigned>;
        ///PA0
    ...
    namespace PwrPwrWakepbr{    ///<Wake GPIO Port B register
        using Addr = Register::Address<0x4000bc0c,0xffffff00,0x00000000,unsigned>;
        ///PB0
    ...
    namespace PwrPwrWakepcr{    ///<Wake GPIO Port C register
        using Addr = Register::Address<0x4000bc10,0xffffff00,0x00000000,unsigned>;
        ///PC0
    ...
    namespace PwrPwrWakefiltr{    ///<Wake filter register
        using Addr = Register::Address<0x4000bc1c,0xfffffff0,0x00000000,unsigned>;
