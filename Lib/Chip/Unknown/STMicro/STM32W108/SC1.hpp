...
namespace Kvasir {
    namespace Nonesc1_isr{
        using Addr = Register::Address<0x4000a808,0xffff8000>;
    ...
    namespace Nonesc1_ier{
        using Addr = Register::Address<0x4000a848,0xffff8000>;
    ...
    namespace Nonesc1_icr{
        using Addr = Register::Address<0x4000a854,0xfffffff8>;
    ...
    namespace Nonesc1_dr{
        using Addr = Register::Address<0x4000c83c,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> DR; 
    }
    namespace Nonesc1_cr{
        using Addr = Register::Address<0x4000c854,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> MODE; 
    }
    namespace Nonesc1_crr1{
        using Addr = Register::Address<0x4000c860,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> LIN; 
    }
    namespace Nonesc1_crr2{
        using Addr = Register::Address<0x4000c864,0xfffffff0>;
