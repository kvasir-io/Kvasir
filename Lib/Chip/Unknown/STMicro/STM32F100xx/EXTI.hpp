...
//EXTI
    namespace ExtiImr{    ///<Interrupt mask register          (EXTI_IMR)
        using Addr = Register::Address<0x40010400,0xfffc0000,0x00000000,unsigned>;
    ...
    namespace ExtiEmr{    ///<Event mask register (EXTI_EMR)
        using Addr = Register::Address<0x40010404,0xfffc0000,0x00000000,unsigned>;
    ...
    namespace ExtiRtsr{    ///<Rising Trigger selection register          (EXTI_RTSR)
        using Addr = Register::Address<0x40010408,0xfffc0000,0x00000000,unsigned>;
    ...
    namespace ExtiFtsr{    ///<Falling Trigger selection register          (EXTI_FTSR)
        using Addr = Register::Address<0x4001040c,0xfffc0000,0x00000000,unsigned>;
    ...
    namespace ExtiSwier{    ///<Software interrupt event register          (EXTI_SWIER)
        using Addr = Register::Address<0x40010410,0xfffc0000,0x00000000,unsigned>;
    ...
    namespace ExtiPr{    ///<Pending register (EXTI_PR)
        using Addr = Register::Address<0x40010414,0xfffc0000,0x00000000,unsigned>;
        ///Pending bit 0
