...
namespace Kvasir {
    ...
    namespace Noneapb2rstr{
        using Addr = Register::Address<0x4002100c,0xfff8a402>;
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40021010,0x87813600>;
    ...
    namespace Noneapb2enr{
        using Addr = Register::Address<0x40021018,0xfff8a402>;
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x4002101c,0x87813600>;
