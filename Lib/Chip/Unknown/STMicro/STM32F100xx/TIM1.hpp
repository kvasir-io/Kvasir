...
namespace Kvasir {
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x40012c18,0xfff87000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,15)> IC2F; 
    ...
    namespace Noneccmr2_input{
        using Addr = Register::Address<0x40012c1c,0xfff87000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,15)> IC4F; 
