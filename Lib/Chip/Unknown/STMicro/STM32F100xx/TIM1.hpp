...
//Advanced timer
    ...
    namespace Noneccmr1Input{    ///<capture/compare mode register 1 (input
          mode)
        using Addr = Register::Address<0x40012c18,0xfff87000,0,unsigned>;
        ///Input capture 2 filter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,15),Register::ReadWriteAccess,unsigned> ic2f{}; 
    ...
    namespace Noneccmr2Input{    ///<capture/compare mode register 2 (input
          mode)
        using Addr = Register::Address<0x40012c1c,0xfff87000,0,unsigned>;
        ///Input capture 4 filter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,15),Register::ReadWriteAccess,unsigned> ic4f{}; 
