...
//USB on the go high speed
    ...
    namespace NoneotgHsHcchar0{    ///<OTG_HS host channel-0 characteristics
        ...
        ///Multi Count (MC) / Error Count
              (EC)
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,unsigned> mc{}; 
        ///Device address
    ...
    namespace NoneotgHsHcsplt0{    ///<OTG_HS host channel-0 split control
        ...
        ///Port address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0),Register::ReadWriteAccess,unsigned> prtaddr{}; 
        ///Hub address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,7),Register::ReadWriteAccess,unsigned> hubaddr{}; 
        ///XACTPOS
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> xactpos{}; 
        ///Do complete split
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> complsplt{}; 
        ///Split enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> spliten{}; 
    }
    ...
    namespace NoneotgHsHcint0{    ///<OTG_HS host channel-11 interrupt
        ...
        ///AHB error
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> ahberr{}; 
