...
//General-purpose-timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40010800,0xfffffc00,0,unsigned>;
        ///Counter enable
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40010808,0xffff0008,0,unsigned>;
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register (output
          mode)
        using Addr = Register::Address<0x40010818,0xffff8080,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x40010820,0xffffff44,0,unsigned>;
    ...
    namespace Noneor{    ///<TIM21 option register
        using Addr = Register::Address<0x40010850,0xffffffc0,0,unsigned>;
        ///Timer21 ETR remap
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> etrRmp{}; 
        ///Timer21 TI1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,2),Register::ReadWriteAccess,unsigned> ti1Rmp{}; 
        ///Timer21 TI2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> ti2Rmp{}; 
    }
}
