...
//General-purpose-timers
    namespace Tim22Cr1{    ///<control register 1
        using Addr = Register::Address<0x40011400,0xfffffc00,0x00000000,unsigned>;
        ///Counter enable
    ...
    namespace Tim22Cr2{    ///<control register 2
        using Addr = Register::Address<0x40011404,0xffffff8f,0x00000000,unsigned>;
    ...
    namespace Tim22Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40011408,0xffff0008,0x00000000,unsigned>;
    ...
    namespace Tim22Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001140c,0xffffffb8,0x00000000,unsigned>;
    ...
    namespace Tim22Sr{    ///<status register
        using Addr = Register::Address<0x40011410,0xfffff9b8,0x00000000,unsigned>;
    ...
    namespace Tim22Egr{    ///<event generation register
        using Addr = Register::Address<0x40011414,0xffffffb8,0x00000000,unsigned>;
        ///Trigger generation
    ...
    namespace Tim22Ccmr1Output{    ///<capture/compare mode register (output          mode)
        using Addr = Register::Address<0x40011418,0xffff8080,0x00000000,unsigned>;
    ...
    namespace Tim22Ccmr1Input{    ///<capture/compare mode register 1 (input          mode)
        using Addr = Register::Address<0x40011418,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim22Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40011420,0xffffff44,0x00000000,unsigned>;
    ...
    namespace Tim22Cnt{    ///<counter
        using Addr = Register::Address<0x40011424,0xffff0000,0x00000000,unsigned>;
        ///counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim22Psc{    ///<prescaler
        using Addr = Register::Address<0x40011428,0xffff0000,0x00000000,unsigned>;
        ///Prescaler value
    ...
    namespace Tim22Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4001142c,0xffff0000,0x00000000,unsigned>;
        ///Auto-reload value
    ...
    namespace Tim22Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40011434,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim22Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40011438,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim22Or{    ///<TIM22 option register
        using Addr = Register::Address<0x40011450,0xfffffff0,0x00000000,unsigned>;
        ///Timer22 ETR remap
