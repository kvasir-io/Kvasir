...
//General-purpose I/Os
    namespace GpiocModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x50000800,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiocOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x50000804,0xffff0000,0x00000000,unsigned>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocOspeedr{    ///<GPIO port output speed          register
        using Addr = Register::Address<0x50000808,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x5000080c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiocIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x50000810,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiocOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x50000814,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiocLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x5000081c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiocAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x50000820,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiocAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x50000824,0x00000000,0x00000000,unsigned>;
