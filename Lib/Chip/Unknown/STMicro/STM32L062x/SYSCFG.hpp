...
//System configuration controller
    namespace Nonecfgr1{    ///<SYSCFG configuration register
        ...
        ///Boot mode selected by the boot pins
              status bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> bootMode{}; 
    ...
    namespace Nonecfgr2{    ///<SYSCFG configuration register
        ...
        ///I2C2 Fm+ drive capability enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> i2c2Fmp{}; 
        ///I2C1 Fm+ drive capability enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> i2c1Fmp{}; 
        ///Fm+ drive capability on PB9 enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> i2cPb9Fmp{}; 
        ///Fm+ drive capability on PB8 enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> i2cPb8Fmp{}; 
        ///Fm+ drive capability on PB7 enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> i2cPb7Fmp{}; 
        ///Fm+ drive capability on PB6 enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> i2cPb6Fmp{}; 
        ///Configuration of internal VLCD rail
              connection to optional external
              capacitor
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,1),Register::ReadWriteAccess,unsigned> capa{}; 
        ///Firewall disable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> fwdisen{}; 
    }
    ...
    namespace Nonecfgr3{    ///<SYSCFG configuration register
        ...
        ///REF_CTRL lock bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> refLock{}; 
        ///VREFINT ready flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> vrefintRdyf{}; 
        ///VREFINT for comparator ready
              flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> vrefintCompRdyf{}; 
        ///VREFINT for ADC ready flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> vrefintAdcRdyf{}; 
        ///Sensor for ADC ready flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> sensorAdcRdyf{}; 
        ///VREFINT for 48 MHz RC oscillator ready
              flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> refRc48mhzRdyf{}; 
        ///VREFINT reference for 48 MHz RC
              oscillator enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> enrefRc48mhz{}; 
        ///VREFINT reference for comparator 2
              enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> enbufVrefintComp{}; 
        ///Sensor reference for ADC enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> enbufSensorAdc{}; 
        ///VREFINT reference for ADC enable
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> enbufBgapAdc{}; 
        ///BGAP_ADC connection bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> selVrefOut{}; 
        ///Vref Enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> enBgap{}; 
    }
}
