...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40005400,0xff002000>;
    ...
    namespace Nonecr2{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0)> SADD; 
    }
    namespace Noneoar1{
        using Addr = Register::Address<0x40005408,0xffff7800>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0)> OA1; 
