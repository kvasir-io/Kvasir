...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x40022800,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x40022804,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x40022808,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4002280c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x40022810,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x40022814,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x40022818,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4002281c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x40022820,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x40022824,0x00000000>;
