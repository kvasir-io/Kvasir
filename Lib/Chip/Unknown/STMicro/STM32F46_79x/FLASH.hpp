...
//FLASH
    ...
    namespace Nonesr{    ///<Status register
        ...
        ///Proprietary readout protection (PCROP)
              error
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> rderr{}; 
        ///Busy
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> bsy{}; 
    }
    namespace Nonecr{    ///<Control register
        using Addr = Register::Address<0x40023c10,0x7cfe7c00,0,unsigned>;
        ///Programming
        ...
        ///Sector number
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,3),Register::ReadWriteAccess,unsigned> snb{}; 
        ///Program size
        ...
        ///Mass Erase of sectors 12 to
              23
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> mer1{}; 
        ///Start
    ...
    namespace Noneoptcr{    ///<Flash option control register
        using Addr = Register::Address<0x40023c14,0x30000000,0,unsigned>;
        ///Option lock
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> bfb2{}; 
        ...
        ///Dual-bank on 1 Mbyte Flash memory
              devices
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> db1m{}; 
        ///Selection of protection mode for nWPRi
              bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> sprmod{}; 
    }
    namespace Noneoptcr1{    ///<Flash option control register
          1
        using Addr = Register::Address<0x40023c18,0xf000ffff,0,unsigned>;
        ///Not write protect
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16),Register::ReadWriteAccess,unsigned> nwrp{}; 
    }
}
