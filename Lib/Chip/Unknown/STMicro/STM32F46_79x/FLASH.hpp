...
namespace Kvasir {
    ...
    namespace Nonecr{
        using Addr = Register::Address<0x40023c10,0x7cfe7c00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,3)> SNB; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> PSIZE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> MER1; 
    ...
    namespace Noneoptcr{
        using Addr = Register::Address<0x40023c14,0x30000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> BFB2; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16)> nWRP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> DB1M; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31)> SPRMOD; 
    }
    namespace Noneoptcr1{
        using Addr = Register::Address<0x40023c18,0xf000ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16)> nWRP; 
    }
}
