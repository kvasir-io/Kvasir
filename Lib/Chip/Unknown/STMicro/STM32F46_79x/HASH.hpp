...
//Hash processor
    namespace Nonecr{    ///<control register
        ...
        ///Algorithm selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> algo0{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> mdmat{}; 
        ///Long key selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> lkey{}; 
        ///ALGO
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> algo1{}; 
    }
    ...
    namespace Nonecsr51{    ///<context swap registers
        ...
        ///CSR51
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> csr51{}; 
    }
    namespace Nonecsr52{    ///<context swap registers
        using Addr = Register::Address<0x500605c8,0x00000000,0,unsigned>;
        ///CSR52
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> csr52{}; 
    }
    namespace Nonecsr53{    ///<context swap registers
        using Addr = Register::Address<0x500605cc,0x00000000,0,unsigned>;
        ///CSR53
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> csr53{}; 
    }
    ...
    namespace NonehashHr5{    ///<read-only
        ...
        ///H5
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h5{}; 
    }
    namespace NonehashHr6{    ///<read-only
        using Addr = Register::Address<0x50060728,0x00000000,0,unsigned>;
        ///H6
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h6{}; 
    }
    namespace NonehashHr7{    ///<read-only
        using Addr = Register::Address<0x5006072c,0x00000000,0,unsigned>;
        ///H7
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> h7{}; 
    }
}
