...
//Reset and clock control
    namespace Nonecr{    ///<clock control register
        using Addr = Register::Address<0x40023800,0xc0f00004,0,unsigned>;
        ...
        ///PLLSAI enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> pllsaion{}; 
        ///PLLSAI clock ready flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> pllsairdy{}; 
    }
    namespace Nonepllcfgr{    ///<PLL configuration register
        using Addr = Register::Address<0x40023804,0x80bc8000,0,unsigned>;
        ///Division factor for the main PLL (PLL)
              and audio PLL (PLLI2S) input clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> pllm{}; 
        ///Main PLL (PLL) multiplication factor for
              VCO
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,6),Register::ReadWriteAccess,unsigned> plln{}; 
        ///Main PLL (PLL) division factor for main
              system clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,unsigned> pllp{}; 
        ...
        ///Main PLL (PLL) division factor for USB
              ...
              clocks
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> pllq{}; 
        ///Main PLL division factor for DSI
              clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,28),Register::ReadWriteAccess,unsigned> pllr{}; 
    }
    ...
    namespace Noneahb1rstr{    ///<AHB1 peripheral reset register
        ...
        ///DMA2D reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> dma2drst{}; 
        ///DMA2 reset
        ...
        ///IO port K reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> gpiokrst{}; 
        ///IO port J reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> gpiojrst{}; 
        ///IO port I reset
    ...
    namespace Noneapb2rstr{    ///<APB2 peripheral reset register
        using Addr = Register::Address<0x40023824,0xf38886cc,0,unsigned>;
        ///TIM1 reset
        ...
        ///LTDC reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> ltdcrst{}; 
        ///DSI host reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> dsirst{}; 
    }
    namespace Noneahb1enr{    ///<AHB1 peripheral clock register
        ...
        ///DMA2D clock enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> dma2den{}; 
        ///DMA2 clock enable
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> ccmdataramen{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> gpioken{}; 
        ///IO port J clock enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> gpiojen{}; 
    ...
    namespace Noneapb2enr{    ///<APB2 peripheral clock enable
          register
        using Addr = Register::Address<0x40023844,0xf38880cc,0,unsigned>;
        ///TIM1 clock enable
        ...
        ///LTDC clock enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> ltdcen{}; 
        ///DSI clocks enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> dsien{}; 
    }
    namespace Noneahb1lpenr{    ///<AHB1 peripheral clock enable in low power
        ...
        ///IO port J clock enable during Sleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> gpiojlpen{}; 
        ///IO port K clock enable during Sleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> gpioklpen{}; 
        ...
        ///DMA2D clock enable during Sleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> dma2dlpen{}; 
    ...
    namespace Noneapb2lpenr{    ///<APB2 peripheral clock enabled in low power
          mode register
        using Addr = Register::Address<0x40023864,0xf38880cc,0,unsigned>;
        ...
        ///LTDC clock enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> ltdclpen{}; 
        ///DSI clocks enable during Sleep
              mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> dsilpen{}; 
    }
    ...
    namespace Nonepllsaicfgr{    ///<PLL configuration register
        using Addr = Register::Address<0x40023888,0x80fc803f,0,unsigned>;
        ...
        ///PLLSAI division factor for LCD
              clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,28),Register::ReadWriteAccess,unsigned> pllsair{}; 
    }
    namespace Nonedckcfgr{    ///<Dedicated Clock Configuration
          Register
        using Addr = Register::Address<0x4002388c,0xc60ce0e0,0,unsigned>;
        ///PLLI2S division factor for SAIs
              clock
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> pllis2divq{}; 
        ...
        ///PLLSAIDIVR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,unsigned> pllsaidivr{}; 
        ///SAI1 clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,unsigned> sai1asrc{}; 
        ///SAI1-B clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,unsigned> sai1bsrc{}; 
        ...
        ///48 MHz clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> msel{}; 
        ///SDIO clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> sdmmcsel{}; 
        ///DSI clock source selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> dsisel{}; 
    }
}
