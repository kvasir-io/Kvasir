...
//General purpose timers
    ...
    namespace Noneor{    ///<TIM5 option register
        using Addr = Register::Address<0x40000050,0xfffff3ff,0,unsigned>;
        ///Timer Input 4 remap
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,unsigned> itr1Rmp{}; 
    }
}
