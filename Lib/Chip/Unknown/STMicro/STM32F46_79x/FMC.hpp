...
//Flexible memory controller
    ...
    namespace Nonesdcr1{    ///<SDRAM Control Register 1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> nb{}; 
        ///CAS latency
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,7),Register::ReadWriteAccess,unsigned> cas{}; 
        ///Write protection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> wp{}; 
        ///SDRAM clock configuration
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,unsigned> sdclk{}; 
        ///Burst read
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> rburst{}; 
        ///Read pipe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,13),Register::ReadWriteAccess,unsigned> rpipe{}; 
    }
    ...
    namespace Nonesdtr1{    ///<SDRAM Timing register 1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> txsr{}; 
        ///Self refresh time
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> tras{}; 
        ///Row cycle delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> trc{}; 
        ///Recovery delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> twr{}; 
        ///Row precharge delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,20),Register::ReadWriteAccess,unsigned> trp{}; 
        ///Row to column delay
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> trcd{}; 
    }
    ...
    namespace Nonesdcmr{    ///<SDRAM Command Mode register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> ctb2{}; 
        ///Command target bank 1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ctb1{}; 
        ///Number of Auto-refresh
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,5),Register::ReadWriteAccess,unsigned> nrfs{}; 
        ///Mode Register definition
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,9),Register::ReadWriteAccess,unsigned> mrd{}; 
    }
    namespace Nonesdrtr{    ///<SDRAM Refresh Timer register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cre{}; 
        ///Refresh Timer Count
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,1),Register::ReadWriteAccess,unsigned> count{}; 
        ///RES Interrupt Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> reie{}; 
    }
    namespace Nonesdsr{    ///<SDRAM Status register
        using Addr = Register::Address<0xa0000158,0xffffffc0,0,unsigned>;
        ///Refresh error flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> re{}; 
        ///Status Mode for Bank 1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,1),Register::ReadWriteAccess,unsigned> modes1{}; 
        ///Status Mode for Bank 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,3),Register::ReadWriteAccess,unsigned> modes2{}; 
        ///Busy status
