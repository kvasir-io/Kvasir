...
//Analog-to-Digital Converter
    namespace Adc3Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50000400,0xfffff800,0x00000000,unsigned>;
        ///JQOVF
    ...
    namespace Adc3Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50000404,0xfffff800,0x00000000,unsigned>;
        ///JQOVFIE
    ...
    namespace Adc3Cr{    ///<control register
        using Addr = Register::Address<0x50000408,0x0fffffc0,0x00000000,unsigned>;
        ///ADCAL
    ...
    namespace Adc3Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5000040c,0x80000004,0x00000000,unsigned>;
        ///AWDCH1CH
    ...
    namespace Adc3Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50000414,0xc0000007,0x00000000,unsigned>;
        ///SMP9
    ...
    namespace Adc3Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50000418,0xf8000000,0x00000000,unsigned>;
        ///SMP18
    ...
    namespace Adc3Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50000420,0xf000f000,0x00000000,unsigned>;
        ///HT1
    ...
    namespace Adc3Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50000424,0xff00ff00,0x00000000,unsigned>;
        ///HT2
    ...
    namespace Adc3Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50000428,0xff00ff00,0x00000000,unsigned>;
        ///HT3
    ...
    namespace Adc3Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50000430,0xe0820830,0x00000000,unsigned>;
        ///SQ4
    ...
    namespace Adc3Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50000434,0xe0820820,0x00000000,unsigned>;
        ///SQ9
    ...
    namespace Adc3Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50000438,0xe0820820,0x00000000,unsigned>;
        ///SQ14
    ...
    namespace Adc3Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5000043c,0xfffff820,0x00000000,unsigned>;
        ///SQ16
    ...
    namespace Adc3Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50000440,0xffff0000,0x00000000,unsigned>;
        ///regularDATA
    ...
    namespace Adc3Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5000044c,0x82082000,0x00000000,unsigned>;
        ///JSQ4
    ...
    namespace Adc3Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50000460,0x03fff000,0x00000000,unsigned>;
        ///OFFSET1_EN
    ...
    namespace Adc3Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50000464,0x03fff000,0x00000000,unsigned>;
        ///OFFSET2_EN
    ...
    namespace Adc3Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50000468,0x03fff000,0x00000000,unsigned>;
        ///OFFSET3_EN
    ...
    namespace Adc3Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5000046c,0x03fff000,0x00000000,unsigned>;
        ///OFFSET4_EN
    ...
    namespace Adc3Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50000480,0xffff0000,0x00000000,unsigned>;
        ///JDATA1
    ...
    namespace Adc3Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50000484,0xffff0000,0x00000000,unsigned>;
        ///JDATA2
    ...
    namespace Adc3Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50000488,0xffff0000,0x00000000,unsigned>;
        ///JDATA3
    ...
    namespace Adc3Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5000048c,0xffff0000,0x00000000,unsigned>;
        ///JDATA4
    ...
    namespace Adc3Awd2cr{    ///<Analog Watchdog 2 Configuration           Register
        using Addr = Register::Address<0x500004a0,0xfff80001,0x00000000,unsigned>;
        ///AWD2CH
    ...
    namespace Adc3Awd3cr{    ///<Analog Watchdog 3 Configuration           Register
        using Addr = Register::Address<0x500004a4,0xfff80001,0x00000000,unsigned>;
        ///AWD3CH
    ...
    namespace Adc3Difsel{    ///<Differential Mode Selection Register           2
        using Addr = Register::Address<0x500004b0,0xfff80001,0x00000000,unsigned>;
    ...
    namespace Adc3Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500004b4,0xff80ff80,0x00000000,unsigned>;
        ///CALFACT_D
