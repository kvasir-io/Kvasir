...
namespace Kvasir {
    ...
    namespace Nonedaddr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> ADD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> ADD1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ADD2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> ADD3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> ADD4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> ADD5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> ADD6; 
