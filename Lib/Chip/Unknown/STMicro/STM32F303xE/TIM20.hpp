...
//Advanced timer
    namespace Tim20Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015000,0xfffff400,0x00000000,unsigned>;
        ///Counter enable
    ...
    namespace Tim20Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015004,0xff0a8002,0x00000000,unsigned>;
    ...
    namespace Tim20Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40015008,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace Tim20Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001500c,0xffff8000,0x00000000,unsigned>;
    ...
    namespace Tim20Sr{    ///<status register
        using Addr = Register::Address<0x40015010,0xfffce000,0x00000000,unsigned>;
    ...
    namespace Tim20Egr{    ///<event generation register
        using Addr = Register::Address<0x40015014,0xfffffe00,0x00000000,unsigned>;
        ///Update generation
    ...
    namespace Tim20Ccmr1Output{    ///<capture/compare mode register (output           mode)
        using Addr = Register::Address<0x40015018,0xfefe0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccmr1Input{    ///<capture/compare mode register 1 (input           mode)
        using Addr = Register::Address<0x40015018,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccmr2Output{    ///<capture/compare mode register (output           mode)
        using Addr = Register::Address<0x4001501c,0xfefe0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccmr2Input{    ///<capture/compare mode register 2 (input           mode)
        using Addr = Register::Address<0x4001501c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccer{    ///<capture/compare enable           register
        using Addr = Register::Address<0x40015020,0xffcc4000,0x00000000,unsigned>;
    ...
    namespace Tim20Cnt{    ///<counter
        using Addr = Register::Address<0x40015024,0x7fff0000,0x00000000,unsigned>;
        ///counter value
    ...
    namespace Tim20Rcr{    ///<repetition counter register
        using Addr = Register::Address<0x40015030,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40015038,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4001503c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40015040,0xffff0000,0x00000000,unsigned>;
        ///Capture/Compare 3 value
    ...
    namespace Tim20Bdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40015044,0xfc000000,0x00000000,unsigned>;
    ...
    namespace Tim20Dcr{    ///<DMA control register
        using Addr = Register::Address<0x40015048,0xffffe0e0,0x00000000,unsigned>;
        ///DMA burst length
    ...
    namespace Tim20Dmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x4001504c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccmr3Output{    ///<capture/compare mode register 3 (output           mode)
        using Addr = Register::Address<0x40015054,0xfefe0303,0x00000000,unsigned>;
    ...
    namespace Tim20Ccr5{    ///<capture/compare register 5
        using Addr = Register::Address<0x40015058,0x1fff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Ccr6{    ///<capture/compare register 6
        using Addr = Register::Address<0x4001505c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Tim20Or{    ///<option registers
        using Addr = Register::Address<0x40015060,0xfffffff0,0x00000000,unsigned>;
