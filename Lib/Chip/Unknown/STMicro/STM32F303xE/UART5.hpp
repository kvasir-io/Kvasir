...
//Universal synchronous asynchronous receiver       transmitter
    namespace Uart5Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40005000,0xf0000000,0x00000000,unsigned>;
    ...
    namespace Uart5Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40005004,0x0000008f,0x00000000,unsigned>;
    ...
    namespace Uart5Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40005008,0xff810000,0x00000000,unsigned>;
    ...
    namespace Uart5Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4000500c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Uart5Gtpr{    ///<Guard time and prescaler           register
        using Addr = Register::Address<0x40005010,0xffff0000,0x00000000,unsigned>;
        ///Guard time value
    ...
    namespace Uart5Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40005014,0x00000000,0x00000000,unsigned>;
        ///Block Length
    ...
    namespace Uart5Rqr{    ///<Request register
        using Addr = Register::Address<0x40005018,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Uart5Isr{    ///<Interrupt & status           register
        using Addr = Register::Address<0x4000501c,0xff802000,0x00000000,unsigned>;
    ...
    namespace Uart5Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40005020,0xffede4a0,0x00000000,unsigned>;
    ...
    namespace Uart5Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40005024,0xfffffe00,0x00000000,unsigned>;
        ///Receive data value
    ...
    namespace Uart5Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40005028,0xfffffe00,0x00000000,unsigned>;
        ///Transmit data value
