...
namespace Kvasir {
    ...
    namespace Nonefltr{
        using Addr = Register::Address<0x40005c24,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> DNF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> ANOFF; 
    }
}
