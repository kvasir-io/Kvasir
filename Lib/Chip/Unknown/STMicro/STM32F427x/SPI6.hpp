...
//Serial peripheral interface
    namespace Spi6Cr1{    ///<control register 1
        using Addr = Register::Address<0x40015400,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Spi6Cr2{    ///<control register 2
        using Addr = Register::Address<0x40015404,0xffffff08,0x00000000,unsigned>;
    ...
    namespace Spi6Sr{    ///<status register
        using Addr = Register::Address<0x40015408,0xfffffe00,0x00000000,unsigned>;
    ...
    namespace Spi6Dr{    ///<data register
        using Addr = Register::Address<0x4001540c,0xffff0000,0x00000000,unsigned>;
        ///Data register
    ...
    namespace Spi6Crcpr{    ///<CRC polynomial register
        using Addr = Register::Address<0x40015410,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Spi6Rxcrcr{    ///<RX CRC register
        using Addr = Register::Address<0x40015414,0xffff0000,0x00000000,unsigned>;
        ///Rx CRC register
    ...
    namespace Spi6Txcrcr{    ///<TX CRC register
        using Addr = Register::Address<0x40015418,0xffff0000,0x00000000,unsigned>;
        ///Tx CRC register
    ...
    namespace Spi6I2scfgr{    ///<I2S configuration register
        using Addr = Register::Address<0x4001541c,0xfffff040,0x00000000,unsigned>;
        ///I2S mode selection
    ...
    namespace Spi6I2spr{    ///<I2S prescaler register
        using Addr = Register::Address<0x40015420,0xfffffc00,0x00000000,unsigned>;
