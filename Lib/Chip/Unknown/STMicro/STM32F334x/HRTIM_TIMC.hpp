...
//High Resolution Timer: TIMC
    namespace HrtimTimcTimccr{    ///<Timerx Control Register
        using Addr = Register::Address<0x40017580,0x00090380,0x00000000,unsigned>;
        ///Update Gating
    ...
    namespace HrtimTimcTimcisr{    ///<Timerx Interrupt Status          Register
        using Addr = Register::Address<0x40017584,0xfff08020,0x00000000,unsigned>;
        ///Output 2 State
    ...
    namespace HrtimTimcTimcicr{    ///<Timerx Interrupt Clear          Register
        using Addr = Register::Address<0x40017588,0xffff8020,0x00000000,unsigned>;
    ...
    namespace HrtimTimcTimcdier5{    ///<TIMxDIER5
        using Addr = Register::Address<0x4001758c,0x80208020,0x00000000,unsigned>;
        ///DLYPRTDE
    ...
    namespace HrtimTimcCntcr{    ///<Timerx Counter Register
        using Addr = Register::Address<0x40017590,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcPercr{    ///<Timerx Period Register
        using Addr = Register::Address<0x40017594,0xffff0000,0x00000000,unsigned>;
        ///Timerx Period value
    ...
    namespace HrtimTimcRepcr{    ///<Timerx Repetition Register
        using Addr = Register::Address<0x40017598,0xffffff00,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCmp1cr{    ///<Timerx Compare 1 Register
        using Addr = Register::Address<0x4001759c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCmp1ccr{    ///<Timerx Compare 1 Compound          Register
        using Addr = Register::Address<0x400175a0,0xff000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCmp2cr{    ///<Timerx Compare 2 Register
        using Addr = Register::Address<0x400175a4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCmp3cr{    ///<Timerx Compare 3 Register
        using Addr = Register::Address<0x400175a8,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCmp4cr{    ///<Timerx Compare 4 Register
        using Addr = Register::Address<0x400175ac,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCpt1cr{    ///<Timerx Capture 1 Register
        using Addr = Register::Address<0x400175b0,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcCpt2cr{    ///<Timerx Capture 2 Register
        using Addr = Register::Address<0x400175b4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcDtcr{    ///<Timerx Deadtime Register
        using Addr = Register::Address<0x400175b8,0x3c002000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcSetc1r{    ///<Timerx Output1 Set Register
        using Addr = Register::Address<0x400175bc,0x00000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimcRstc1r{    ///<Timerx Output1 Reset Register
        using Addr = Register::Address<0x400175c0,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimcSetc2r{    ///<Timerx Output2 Set Register
        using Addr = Register::Address<0x400175c4,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimcRstc2r{    ///<Timerx Output2 Reset Register
        using Addr = Register::Address<0x400175c8,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimcEefcr1{    ///<Timerx External Event Filtering Register          1
        using Addr = Register::Address<0x400175cc,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimcEefcr2{    ///<Timerx External Event Filtering Register          2
        using Addr = Register::Address<0x400175d0,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimcRstcr{    ///<TimerA Reset Register
        using Addr = Register::Address<0x400175d4,0x80000001,0x00000000,unsigned>;
        ///Timer E Compare 4
    ...
    namespace HrtimTimcChpcr{    ///<Timerx Chopper Register
        using Addr = Register::Address<0x400175d8,0xfffff800,0x00000000,unsigned>;
        ///STRTPW
    ...
    namespace HrtimTimcCpt1ccr{    ///<Timerx Capture 2 Control          Register
        using Addr = Register::Address<0x400175dc,0x00f00000,0x00000000,unsigned>;
        ///Timer E Compare 2
    ...
    namespace HrtimTimcCpt2ccr{    ///<CPT2xCR
        using Addr = Register::Address<0x400175e0,0x00f00000,0x00000000,unsigned>;
        ///Timer E Compare 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> tecmp2{}; 
        ///Timer E Compare 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> tecmp1{}; 
    ...
    namespace HrtimTimcOutcr{    ///<Timerx Output Register
        using Addr = Register::Address<0x400175e4,0xff01e001,0x00000000,unsigned>;
    ...
    namespace HrtimTimcFltcr{    ///<Timerx Fault Register
        using Addr = Register::Address<0x400175e8,0x7fffffe0,0x00000000,unsigned>;
        ///Fault sources Lock
