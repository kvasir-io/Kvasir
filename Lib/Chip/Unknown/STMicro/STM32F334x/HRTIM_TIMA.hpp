...
//High Resolution Timer: TIMA
    namespace HrtimTimaTimacr{    ///<Timerx Control Register
        using Addr = Register::Address<0x40017480,0x00090380,0x00000000,unsigned>;
        ///Update Gating
    ...
    namespace HrtimTimaTimaisr{    ///<Timerx Interrupt Status          Register
        using Addr = Register::Address<0x40017484,0xfff08020,0x00000000,unsigned>;
        ///Output 2 State
    ...
    namespace HrtimTimaTimaicr{    ///<Timerx Interrupt Clear          Register
        using Addr = Register::Address<0x40017488,0xffff8020,0x00000000,unsigned>;
    ...
    namespace HrtimTimaTimadier5{    ///<TIMxDIER5
        using Addr = Register::Address<0x4001748c,0x80208020,0x00000000,unsigned>;
        ///DLYPRTDE
    ...
    namespace HrtimTimaCntar{    ///<Timerx Counter Register
        using Addr = Register::Address<0x40017490,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaPerar{    ///<Timerx Period Register
        using Addr = Register::Address<0x40017494,0xffff0000,0x00000000,unsigned>;
        ///Timerx Period value
    ...
    namespace HrtimTimaRepar{    ///<Timerx Repetition Register
        using Addr = Register::Address<0x40017498,0xffffff00,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCmp1ar{    ///<Timerx Compare 1 Register
        using Addr = Register::Address<0x4001749c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCmp1car{    ///<Timerx Compare 1 Compound          Register
        using Addr = Register::Address<0x400174a0,0xff000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCmp2ar{    ///<Timerx Compare 2 Register
        using Addr = Register::Address<0x400174a4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCmp3ar{    ///<Timerx Compare 3 Register
        using Addr = Register::Address<0x400174a8,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCmp4ar{    ///<Timerx Compare 4 Register
        using Addr = Register::Address<0x400174ac,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCpt1ar{    ///<Timerx Capture 1 Register
        using Addr = Register::Address<0x400174b0,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaCpt2ar{    ///<Timerx Capture 2 Register
        using Addr = Register::Address<0x400174b4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaDtar{    ///<Timerx Deadtime Register
        using Addr = Register::Address<0x400174b8,0x3c002000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaSeta1r{    ///<Timerx Output1 Set Register
        using Addr = Register::Address<0x400174bc,0x00000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimaRsta1r{    ///<Timerx Output1 Reset Register
        using Addr = Register::Address<0x400174c0,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimaSeta2r{    ///<Timerx Output2 Set Register
        using Addr = Register::Address<0x400174c4,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimaRsta2r{    ///<Timerx Output2 Reset Register
        using Addr = Register::Address<0x400174c8,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimaEefar1{    ///<Timerx External Event Filtering Register          1
        using Addr = Register::Address<0x400174cc,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimaEefar2{    ///<Timerx External Event Filtering Register          2
        using Addr = Register::Address<0x400174d0,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimaRstar{    ///<TimerA Reset Register
        using Addr = Register::Address<0x400174d4,0x80000001,0x00000000,unsigned>;
        ///Timer E Compare 4
    ...
    namespace HrtimTimaChpar{    ///<Timerx Chopper Register
        using Addr = Register::Address<0x400174d8,0xfffff800,0x00000000,unsigned>;
        ///STRTPW
    ...
    namespace HrtimTimaCpt1acr{    ///<Timerx Capture 2 Control          Register
        using Addr = Register::Address<0x400174dc,0x0000f000,0x00000000,unsigned>;
        ///Timer E Compare 2
    ...
    namespace HrtimTimaCpt2acr{    ///<CPT2xCR
        using Addr = Register::Address<0x400174e0,0x0000f000,0x00000000,unsigned>;
        ///Timer E Compare 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> tecmp2{}; 
        ///Timer E Compare 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> tecmp1{}; 
    ...
    namespace HrtimTimaOutar{    ///<Timerx Output Register
        using Addr = Register::Address<0x400174e4,0xff01e001,0x00000000,unsigned>;
    ...
    namespace HrtimTimaFltar{    ///<Timerx Fault Register
        using Addr = Register::Address<0x400174e8,0x7fffffe0,0x00000000,unsigned>;
        ///Fault sources Lock
