...
//High Resolution Timer: TIME
    namespace HrtimTimeTimecr{    ///<Timerx Control Register
        using Addr = Register::Address<0x40017680,0x00090380,0x00000000,unsigned>;
        ///Update Gating
    ...
    namespace HrtimTimeTimeisr{    ///<Timerx Interrupt Status          Register
        using Addr = Register::Address<0x40017684,0xfff08020,0x00000000,unsigned>;
        ///Output 2 State
    ...
    namespace HrtimTimeTimeicr{    ///<Timerx Interrupt Clear          Register
        using Addr = Register::Address<0x40017688,0xffff8020,0x00000000,unsigned>;
    ...
    namespace HrtimTimeTimedier5{    ///<TIMxDIER5
        using Addr = Register::Address<0x4001768c,0x80208020,0x00000000,unsigned>;
        ///DLYPRTDE
    ...
    namespace HrtimTimeCnter{    ///<Timerx Counter Register
        using Addr = Register::Address<0x40017690,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimePerer{    ///<Timerx Period Register
        using Addr = Register::Address<0x40017694,0xffff0000,0x00000000,unsigned>;
        ///Timerx Period value
    ...
    namespace HrtimTimeReper{    ///<Timerx Repetition Register
        using Addr = Register::Address<0x40017698,0xffffff00,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCmp1er{    ///<Timerx Compare 1 Register
        using Addr = Register::Address<0x4001769c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCmp1cer{    ///<Timerx Compare 1 Compound          Register
        using Addr = Register::Address<0x400176a0,0xff000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCmp2er{    ///<Timerx Compare 2 Register
        using Addr = Register::Address<0x400176a4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCmp3er{    ///<Timerx Compare 3 Register
        using Addr = Register::Address<0x400176a8,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCmp4er{    ///<Timerx Compare 4 Register
        using Addr = Register::Address<0x400176ac,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCpt1er{    ///<Timerx Capture 1 Register
        using Addr = Register::Address<0x400176b0,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeCpt2er{    ///<Timerx Capture 2 Register
        using Addr = Register::Address<0x400176b4,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeDter{    ///<Timerx Deadtime Register
        using Addr = Register::Address<0x400176b8,0x3c002000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeSete1r{    ///<Timerx Output1 Set Register
        using Addr = Register::Address<0x400176bc,0x00000000,0x00000000,unsigned>;
    ...
    namespace HrtimTimeRste1r{    ///<Timerx Output1 Reset Register
        using Addr = Register::Address<0x400176c0,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimeSete2r{    ///<Timerx Output2 Set Register
        using Addr = Register::Address<0x400176c4,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimeRste2r{    ///<Timerx Output2 Reset Register
        using Addr = Register::Address<0x400176c8,0x00000000,0x00000000,unsigned>;
        ///UPDATE
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> update{}; 
        ///EXTEVNT10
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> extevnt10{}; 
    ...
    namespace HrtimTimeEefer1{    ///<Timerx External Event Filtering Register          1
        using Addr = Register::Address<0x400176cc,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimeEefer2{    ///<Timerx External Event Filtering Register          2
        using Addr = Register::Address<0x400176d0,0xe0820820,0x00000000,unsigned>;
    ...
    namespace HrtimTimeRster{    ///<TimerA Reset Register
        using Addr = Register::Address<0x400176d4,0x80000001,0x00000000,unsigned>;
        ///Timer D Compare 4
    ...
    namespace HrtimTimeChper{    ///<Timerx Chopper Register
        using Addr = Register::Address<0x400176d8,0xfffff800,0x00000000,unsigned>;
        ///STRTPW
    ...
    namespace HrtimTimeCpt1ecr{    ///<Timerx Capture 2 Control          Register
        using Addr = Register::Address<0x400176dc,0xf0000000,0x00000000,unsigned>;
        ///Timer D Compare 2
    ...
    namespace HrtimTimeCpt2ecr{    ///<CPT2xCR
        using Addr = Register::Address<0x400176e0,0xf0000000,0x00000000,unsigned>;
        ///Timer D Compare 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> tdcmp2{}; 
        ///Timer D Compare 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> tdcmp1{}; 
    ...
    namespace HrtimTimeOuter{    ///<Timerx Output Register
        using Addr = Register::Address<0x400176e4,0xff01e001,0x00000000,unsigned>;
    ...
    namespace HrtimTimeFlter{    ///<Timerx Fault Register
        using Addr = Register::Address<0x400176e8,0x7fffffe0,0x00000000,unsigned>;
        ///Fault sources Lock
