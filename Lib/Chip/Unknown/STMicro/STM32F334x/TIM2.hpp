...
//General purpose timer
    ...
    namespace Nonecnt{    ///<counter
        ...
        ///High counter value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,16),Register::ReadWriteAccess,unsigned> cnth{}; 
        ///if IUFREMAP=0 than CNT with read write
              access else UIFCPY with read only
              access
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> cntOrUifcpy{}; 
    }
