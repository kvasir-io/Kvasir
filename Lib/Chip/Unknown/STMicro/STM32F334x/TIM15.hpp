...
namespace Kvasir {
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40014004,0xfffff802>;
    ...
    namespace Nonesmcr{
        using Addr = Register::Address<0x40014008,0xfffeff08>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x4001400c,0xffff9818>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40014018,0xfefe8080>;
