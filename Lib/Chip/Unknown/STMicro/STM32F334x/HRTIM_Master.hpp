...
//High Resolution Timer: Master      Timers
    ...
    namespace HrtimMasterMisr{    ///<Master Timer Interrupt Status          Register
        using Addr = Register::Address<0x40017404,0xffffff80,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMicr{    ///<Master Timer Interrupt Clear          Register
        using Addr = Register::Address<0x40017408,0xffffff80,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMdier4{    ///<MDIER4
        using Addr = Register::Address<0x4001740c,0xff80ff80,0x00000000,unsigned>;
        ///MUPDDE
    ...
    namespace HrtimMasterMcntr{    ///<Master Timer Counter Register
        using Addr = Register::Address<0x40017410,0xffff0000,0x00000000,unsigned>;
        ///Counter value
    ...
    namespace HrtimMasterMper{    ///<Master Timer Period Register
        using Addr = Register::Address<0x40017414,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMrep{    ///<Master Timer Repetition          Register
        using Addr = Register::Address<0x40017418,0xffffff00,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMcmp1r{    ///<Master Timer Compare 1          Register
        using Addr = Register::Address<0x4001741c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMcmp2r{    ///<Master Timer Compare 2          Register
        using Addr = Register::Address<0x40017424,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMcmp3r{    ///<Master Timer Compare 3          Register
        using Addr = Register::Address<0x40017428,0xffff0000,0x00000000,unsigned>;
    ...
    namespace HrtimMasterMcmp4r{    ///<Master Timer Compare 4          Register
        using Addr = Register::Address<0x4001742c,0xffff0000,0x00000000,unsigned>;
