...
//Inter-integrated circuit
    ...
    namespace Nonefltr{    ///<I2C FLTR register
        using Addr = Register::Address<0x40005c24,0xffffffe0,0,unsigned>;
        ///Digital noise filter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> dnf{}; 
        ///Analog noise filter OFF
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> anoff{}; 
    }
}
