...
//General-purpose I/Os
    ...
    namespace GpioiOtyper{    ///<GPIO port output type register
        using Addr = Register::Address<0x40022004,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpioiIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x40022010,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpioiOdr{    ///<GPIO port output data register
        using Addr = Register::Address<0x40022014,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpioiLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x4002201c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpioiAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x40022024,0x00000000,0x00000000,unsigned>;
