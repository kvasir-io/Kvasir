...
//General-purpose-timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40014000,0xfffffc70,0,unsigned>;
        ///Clock division
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x40014004,0xffffff8f,0,unsigned>;
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40014008,0xffffff08,0,unsigned>;
        ///Master/Slave mode
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4001400c,0xffffffb8,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40014010,0xfffff9b8,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40014014,0xffffffb8,0,unsigned>;
        ///Trigger generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register 1 (output
          mode)
        using Addr = Register::Address<0x40014018,0xffff8080,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x40014020,0xffffff44,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x40014024,0xffff0000,0,unsigned>;
        ///counter value
