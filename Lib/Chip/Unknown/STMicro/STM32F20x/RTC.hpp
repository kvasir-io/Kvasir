...
//Real-time clock
    ...
    namespace Nonecr{    ///<control register
        ...
        ///Coarse digital calibration
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> dce{}; 
        ///Hour format
    ...
    namespace Noneprer{    ///<prescaler register
        ...
        ///Synchronous prescaler
              factor
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,0),Register::ReadWriteAccess,unsigned> predivS{}; 
    }
    ...
    namespace Nonecalibr{    ///<calibration register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> dcs{}; 
        ///Digital calibration
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> dc{}; 
    }
    ...
    namespace Nonetafcr{    ///<tamper and alternate function configuration
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> alarmouttype{}; 
        ///TIMESTAMP mapping
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> tsinsel{}; 
        ///TAMPER1 mapping
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> tamp1insel{}; 
