...
//System configuration controller
    ...
    namespace Nonecmpcr{    ///<Compensation cell control
          register
        using Addr = Register::Address<0x40013820,0xffffff7e,0,unsigned>;
        ///READY
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> ready{}; 
        namespace ReadyValC{
        }
        ///Compensation cell
              power-down
