...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40003400,0xffff0000>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40003404,0xffffff08>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40003408,0xfffffe00>;
    ...
    namespace Nonei2spr{
        using Addr = Register::Address<0x40003420,0xfffffc00>;
