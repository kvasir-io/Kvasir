...
//General-purpose I/Os
    namespace GpiobModer{    ///<GPIO port mode register
        using Addr = Register::Address<0x50000400,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiobPupdr{    ///<GPIO port pull-up/pull-down          register
        using Addr = Register::Address<0x5000040c,0x00000000,0x00000000,unsigned>;
        ///Port x configuration bits (y =              0..15)
    ...
    namespace GpiobIdr{    ///<GPIO port input data register
        using Addr = Register::Address<0x50000410,0xffff0000,0x00000000,unsigned>;
    ...
    namespace GpiobBsrr{    ///<GPIO port bit set/reset          register
        using Addr = Register::Address<0x50000418,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiobLckr{    ///<GPIO port configuration lock          register
        using Addr = Register::Address<0x5000041c,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace GpiobAfrl{    ///<GPIO alternate function low          register
        using Addr = Register::Address<0x50000420,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiobAfrh{    ///<GPIO alternate function high          register
        using Addr = Register::Address<0x50000424,0x00000000,0x00000000,unsigned>;
    ...
    namespace GpiobBrr{    ///<GPIO port bit reset register
        using Addr = Register::Address<0x50000428,0xffff0000,0x00000000,unsigned>;
        ///Port x Reset bit y (y= 0 ..              15)
