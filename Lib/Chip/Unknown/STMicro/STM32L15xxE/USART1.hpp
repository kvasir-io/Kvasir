...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart1Sr{    ///<Status register
        using Addr = Register::Address<0x40022800,0xfffffc00,0x00000000,unsigned>;
        ///CTS flag
    ...
    namespace Usart1Dr{    ///<Data register
        using Addr = Register::Address<0x40022804,0xfffffe00,0x00000000,unsigned>;
        ///Data value
    ...
    namespace Usart1Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40022808,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Usart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4002280c,0xffff4000,0x00000000,unsigned>;
        ///Oversampling mode
    ...
    namespace Usart1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40022810,0xffff8090,0x00000000,unsigned>;
        ///LIN mode enable
    ...
    namespace Usart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40022814,0xfffff000,0x00000000,unsigned>;
