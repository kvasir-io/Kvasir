...
//General-purpose timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x140000000,0xfffffc00,0,unsigned>;
        ///Clock division
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x140000004,0xffffff07,0,unsigned>;
        ///TI1 selection
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x140000008,0xffff0000,0,unsigned>;
    ...
    namespace Nonedier{    ///<Interrupt enable register
        using Addr = Register::Address<0x14000000c,0xffffa0a0,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x140000010,0xffffe1a0,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x140000014,0xffffffa0,0,unsigned>;
        ///Trigger generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register
          1
        using Addr = Register::Address<0x140000018,0xffff0200,0,unsigned>;
    ...
    namespace Noneccmr1Input{    ///<capture/compare mode register 1 (input
          mode)
        using Addr = Register::Address<0x140000018,0xffff0000,0,unsigned>;
    ...
    namespace Noneccmr2Output{    ///<capture/compare mode register
          2
        using Addr = Register::Address<0x14000001c,0xffff0200,0,unsigned>;
        ...
        ///Capture/Compare 4
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> cc4s{}; 
    ...
    namespace Noneccmr2Input{    ///<capture/compare mode register 2 (input
          mode)
        using Addr = Register::Address<0x14000001c,0xffff0000,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x140000020,0xffff4444,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x140000024,0xffff0000,0,unsigned>;
        ///TIM2 counter
    ...
    namespace Nonepsc{    ///<prescaler
        using Addr = Register::Address<0x140000028,0xffff0000,0,unsigned>;
        ///TIM2 prescaler
    ...
    namespace Nonearr{    ///<auto-reload register
        using Addr = Register::Address<0x14000002c,0xffff0000,0,unsigned>;
        ///Auto-reload value
    ...
    namespace Noneccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000034,0xffff0000,0,unsigned>;
        ///Capture/Compare 1 value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Noneccr2{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000038,0xffff0000,0,unsigned>;
        ///Capture/Compare 2 value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr2{}; 
    }
    namespace Noneccr3{    ///<capture/compare register 1
        using Addr = Register::Address<0x14000003c,0xffff0000,0,unsigned>;
        ///Capture/Compare 1 value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> ccr1{}; 
    }
    namespace Noneccr4{    ///<capture/compare register 1
        using Addr = Register::Address<0x140000040,0xffff0000,0,unsigned>;
    ...
    namespace Nonedcr{    ///<DMA control register
        using Addr = Register::Address<0x140000048,0xffffe0e0,0,unsigned>;
        ///DMA burst length
    ...
    namespace Nonedmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x14000004c,0xffff0000,0,unsigned>;
