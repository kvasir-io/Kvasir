...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x140000000,0xfffffc00>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x140000004,0xffffff07>;
    ...
    namespace Nonesmcr{
        using Addr = Register::Address<0x140000008,0xffff0000>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x14000000c,0xffffa0a0>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x140000010,0xffffe1a0>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x140000014,0xffffffa0>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x140000018,0xffff0200>;
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x140000018,0xffff0000>;
    ...
    namespace Noneccmr2_output{
        using Addr = Register::Address<0x14000001c,0xffff0200>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> CC4S; 
    ...
    namespace Noneccmr2_input{
        using Addr = Register::Address<0x14000001c,0xffff0000>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x140000020,0xffff4444>;
    ...
    namespace Nonedmar{
        using Addr = Register::Address<0x14000004c,0xffff0000>;
