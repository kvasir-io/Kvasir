...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x140020800,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x140020804,0xffff0000>;
    ...
    namespace Noneospeeder{
        using Addr = Register::Address<0x140020808,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x14002080c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x140020810,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x140020814,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x140020818,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x14002081c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x140020820,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x140020824,0x00000000>;
