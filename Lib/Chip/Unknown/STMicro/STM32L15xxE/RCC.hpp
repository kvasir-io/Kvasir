...
namespace Kvasir {
    ...
    namespace Nonecir{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> LSECSSC; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> LSECSSIE; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> LSECSSF; 
    ...
    namespace Noneahbrstr{
        using Addr = Register::Address<0x40023810,0xfcff6f00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> DMA2RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> DMA1RST; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> GPIOGRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> GPIOFRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> GPIOHRST; 
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40023818,0x4f1935c0>;
    ...
    namespace Noneahbenr{
        using Addr = Register::Address<0x4002381c,0xfcff6f00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> DMA2EN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> DMA1EN; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> GPIOPGEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> GPIOPFEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> GPIOPHEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> GPIOPEEN; 
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x40023824,0x4f1935c0>;
    ...
    namespace Noneahblpenr{
        using Addr = Register::Address<0x40023828,0xfcfe6f00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> DMA2LPEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> DMA1LPEN; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> GPIOGLPEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> GPIOFLPEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> GPIOHLPEN; 
    ...
    namespace Nonecsr{
        using Addr = Register::Address<0x40023834,0x003ce0fc>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> LSECSSD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11)> LSECSSON; 
