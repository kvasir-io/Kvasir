...
namespace Kvasir {
    namespace Nonesr{
        using Addr = Register::Address<0x40013800,0xfffffc00>;
    ...
    namespace Nonedr{
        using Addr = Register::Address<0x40013804,0xfffffe00>;
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x4001380c,0xffffc000>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40013810,0xffff8090>;
    ...
    namespace Nonecr3{
        using Addr = Register::Address<0x40013814,0xfffff800>;
    ...
    namespace Nonegtpr{
        using Addr = Register::Address<0x40013818,0xffff0000>;
