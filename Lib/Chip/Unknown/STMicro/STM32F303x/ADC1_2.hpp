...
namespace Kvasir {
    namespace Noneisr{
        using Addr = Register::Address<0x50000000,0xfffff800>;
    ...
    namespace Noneier{
        using Addr = Register::Address<0x50000004,0xfffff800>;
    ...
    namespace Nonecr{
        using Addr = Register::Address<0x50000008,0x0fffffc0>;
    ...
    namespace Nonecfgr{
        using Addr = Register::Address<0x5000000c,0x80000004>;
    ...
    namespace Nonesmpr1{
        using Addr = Register::Address<0x50000014,0xc0000007>;
    ...
    namespace Nonesmpr2{
        using Addr = Register::Address<0x50000018,0xf8000000>;
    ...
    namespace Nonetr1{
        using Addr = Register::Address<0x50000020,0xf000f000>;
    ...
    namespace Nonetr2{
        using Addr = Register::Address<0x50000024,0xff00ff00>;
    ...
    namespace Nonetr3{
        using Addr = Register::Address<0x50000028,0xff00ff00>;
    ...
    namespace Nonesqr1{
        using Addr = Register::Address<0x50000030,0xe0820830>;
    ...
    namespace Nonesqr2{
        using Addr = Register::Address<0x50000034,0xe0820820>;
    ...
    namespace Nonesqr3{
        using Addr = Register::Address<0x50000038,0xe0820820>;
    ...
    namespace Nonesqr4{
        using Addr = Register::Address<0x5000003c,0xfffff820>;
    ...
    namespace Nonejsqr{
        using Addr = Register::Address<0x5000004c,0x82082000>;
    ...
    namespace Noneofr1{
        using Addr = Register::Address<0x50000060,0x03fff000>;
    ...
    namespace Noneofr2{
        using Addr = Register::Address<0x50000064,0x03fff000>;
    ...
    namespace Noneofr3{
        using Addr = Register::Address<0x50000068,0x03fff000>;
    ...
    namespace Noneofr4{
        using Addr = Register::Address<0x5000006c,0x03fff000>;
    ...
    namespace Nonecalfact{
        using Addr = Register::Address<0x500000b4,0xff80ff80>;
    ...
    namespace Nonecsr{
        using Addr = Register::Address<0x50000300,0xf800f800>;
    ...
    namespace Noneccr{
        using Addr = Register::Address<0x50000308,0xfe3c10e0>;
    ...
    namespace Nonecdr{
        using Addr = Register::Address<0x5000030c,0x00000000>;
