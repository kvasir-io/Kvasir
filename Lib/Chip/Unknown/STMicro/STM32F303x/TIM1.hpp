...
//Advanced timer
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40012c00,0xfffff400,0,unsigned>;
        ///Counter enable
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x40012c04,0xff0a8002,0,unsigned>;
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40012c08,0xfffe0000,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40012c10,0xfffce000,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40012c14,0xfffffe00,0,unsigned>;
        ///Update generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register (output
          mode)
        using Addr = Register::Address<0x40012c18,0xfefe0000,0,unsigned>;
    ...
    namespace Noneccmr2Output{    ///<capture/compare mode register (output
          mode)
        using Addr = Register::Address<0x40012c1c,0xfefe0000,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x40012c20,0xffcc4000,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x40012c24,0x7fff0000,0,unsigned>;
        ///counter value
    ...
    namespace Nonercr{    ///<repetition counter register
        using Addr = Register::Address<0x40012c30,0xffff0000,0,unsigned>;
    ...
    namespace Nonebdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40012c44,0xfc000000,0,unsigned>;
    ...
    namespace Noneccmr3Output{    ///<capture/compare mode register 3 (output
          mode)
        using Addr = Register::Address<0x40012c54,0xfefe0303,0,unsigned>;
    ...
    namespace Noneor{    ///<option registers
        using Addr = Register::Address<0x40012c60,0xfffffff0,0,unsigned>;
        ///TIM1_ETR_ADC1 remapping
              capability
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> tim1EtrAdc1Rmp{}; 
        ///TIM1_ETR_ADC4 remapping
              capability
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> tim1EtrAdc4Rmp{}; 
    }
}
