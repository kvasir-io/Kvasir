...
//Controller area network
    ...
    namespace Nonerdt0r{    ///<receive FIFO mailbox data length control and
          time stamp register
    ...
    namespace Nonerdl0r{    ///<receive FIFO mailbox data low
          register
    ...
    namespace Noneri1r{    ///<receive FIFO mailbox identifier
          register
    ...
    namespace Nonerdt1r{    ///<receive FIFO mailbox data length control and
          time stamp register
    ...
    namespace Nonerdl1r{    ///<receive FIFO mailbox data low
          register
    ...
    namespace Nonerdh1r{    ///<receive FIFO mailbox data high
          register
