...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40012c00,0xfffff400>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40012c04,0xff0a8002>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> OIS5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> OIS6; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,20)> MMS2; 
    }
    namespace Nonesmcr{
        using Addr = Register::Address<0x40012c08,0xfffe0000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> SMS3; 
    }
    namespace Nonedier{
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40012c10,0xfffce000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> B2IF; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> C5IF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> C6IF; 
    }
    namespace Noneegr{
        using Addr = Register::Address<0x40012c14,0xfffffe00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> B2G; 
    }
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40012c18,0xfefe0000>;
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x40012c18,0xffff0000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2)> IC1PCS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> CC1S; 
    }
    namespace Noneccmr2_output{
        using Addr = Register::Address<0x40012c1c,0xfefe0000>;
    ...
    namespace Noneccmr2_input{
        using Addr = Register::Address<0x40012c1c,0xffff0000>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40012c20,0xffcc4000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> CC5E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> CC5P; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> CC6E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> CC6P; 
    }
    namespace Nonecnt{
        using Addr = Register::Address<0x40012c24,0x7fff0000>;
    ...
    namespace Nonepsc{
        using Addr = Register::Address<0x40012c28,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> PSC; 
    }
    namespace Nonearr{
        using Addr = Register::Address<0x40012c2c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> ARR; 
    }
    namespace Nonercr{
        using Addr = Register::Address<0x40012c30,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> REP; 
    }
    namespace Noneccr1{
        using Addr = Register::Address<0x40012c34,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CCR1; 
    }
    namespace Noneccr2{
        using Addr = Register::Address<0x40012c38,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CCR2; 
    }
    namespace Noneccr3{
        using Addr = Register::Address<0x40012c3c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CCR3; 
    }
    namespace Noneccr4{
        using Addr = Register::Address<0x40012c40,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CCR4; 
    }
    namespace Nonebdtr{
        using Addr = Register::Address<0x40012c44,0xfc000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,20)> BK2F; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> BK2E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> BK2P; 
    }
    namespace Nonedcr{
        using Addr = Register::Address<0x40012c48,0xffffe0e0>;
    ...
    namespace Nonedmar{
        using Addr = Register::Address<0x40012c4c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DMAB; 
    }
    namespace Noneccmr3_output{
        using Addr = Register::Address<0x40012c54,0xfefe0303>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> OC5M_3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> OC6M_3; 
    }
    namespace Noneccr5{
        using Addr = Register::Address<0x40012c58,0x1fff0000>;
    ...
    namespace Noneccr6{
        using Addr = Register::Address<0x40012c5c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CCR6; 
    }
    namespace Noneor{
        using Addr = Register::Address<0x40012c60,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> TIM1_ETR_ADC1_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2)> TIM1_ETR_ADC4_RMP; 
    }
}
