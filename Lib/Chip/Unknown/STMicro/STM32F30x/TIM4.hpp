...
//General purpose timer
    namespace Tim4Cr1{    ///<control register 1
        using Addr = Register::Address<0x40000800,0xfffff400,0x00000000,unsigned>;
        ///Counter enable
    ...
    namespace Tim4Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000808,0xfffe0000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccmr1Output{    ///<capture/compare mode register 1 (output          mode)
        using Addr = Register::Address<0x40000818,0xfefe0000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x4000081c,0xfefe0000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccer{    ///<capture/compare enable          register
        using Addr = Register::Address<0x40000820,0xffff4444,0x00000000,unsigned>;
    ...
    namespace Tim4Cnt{    ///<counter
        using Addr = Register::Address<0x40000824,0x00000000,0x00000000,unsigned>;
        ///Low counter value
    ...
    namespace Tim4Ccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000834,0x00000000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40000838,0x00000000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000083c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Tim4Ccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40000840,0x00000000,0x00000000,unsigned>;
        ///Low Capture/Compare value
