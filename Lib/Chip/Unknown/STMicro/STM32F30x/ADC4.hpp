...
//Analog-to-Digital Converter
    namespace Adc4Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50000500,0xfffff800,0x00000000,unsigned>;
        ///JQOVF
    ...
    namespace Adc4Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50000504,0xfffff800,0x00000000,unsigned>;
        ///JQOVFIE
    ...
    namespace Adc4Cr{    ///<control register
        using Addr = Register::Address<0x50000508,0x0fffffc0,0x00000000,unsigned>;
        ///ADCAL
    ...
    namespace Adc4Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5000050c,0x80000004,0x00000000,unsigned>;
        ///AWDCH1CH
    ...
    namespace Adc4Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50000514,0xc0000007,0x00000000,unsigned>;
        ///SMP9
    ...
    namespace Adc4Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50000518,0xf8000000,0x00000000,unsigned>;
        ///SMP18
    ...
    namespace Adc4Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50000520,0xf000f000,0x00000000,unsigned>;
        ///HT1
    ...
    namespace Adc4Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50000524,0xff00ff00,0x00000000,unsigned>;
        ///HT2
    ...
    namespace Adc4Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50000528,0xff00ff00,0x00000000,unsigned>;
        ///HT3
    ...
    namespace Adc4Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50000530,0xe0820830,0x00000000,unsigned>;
        ///SQ4
    ...
    namespace Adc4Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50000534,0xe0820820,0x00000000,unsigned>;
        ///SQ9
    ...
    namespace Adc4Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50000538,0xe0820820,0x00000000,unsigned>;
        ///SQ14
    ...
    namespace Adc4Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5000053c,0xfffff820,0x00000000,unsigned>;
        ///SQ16
    ...
    namespace Adc4Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50000540,0xffff0000,0x00000000,unsigned>;
        ///regularDATA
    ...
    namespace Adc4Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5000054c,0x82082000,0x00000000,unsigned>;
        ///JSQ4
    ...
    namespace Adc4Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50000560,0x03fff000,0x00000000,unsigned>;
        ///OFFSET1_EN
    ...
    namespace Adc4Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50000564,0x03fff000,0x00000000,unsigned>;
        ///OFFSET2_EN
    ...
    namespace Adc4Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50000568,0x03fff000,0x00000000,unsigned>;
        ///OFFSET3_EN
    ...
    namespace Adc4Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5000056c,0x03fff000,0x00000000,unsigned>;
        ///OFFSET4_EN
    ...
    namespace Adc4Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50000580,0xffff0000,0x00000000,unsigned>;
        ///JDATA1
    ...
    namespace Adc4Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50000584,0xffff0000,0x00000000,unsigned>;
        ///JDATA2
    ...
    namespace Adc4Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50000588,0xffff0000,0x00000000,unsigned>;
        ///JDATA3
    ...
    namespace Adc4Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5000058c,0xffff0000,0x00000000,unsigned>;
        ///JDATA4
    ...
    namespace Adc4Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500005a0,0xfff80001,0x00000000,unsigned>;
        ///AWD2CH
    ...
    namespace Adc4Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500005a4,0xfff80001,0x00000000,unsigned>;
        ///AWD3CH
    ...
    namespace Adc4Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500005b0,0xfff80001,0x00000000,unsigned>;
    ...
    namespace Adc4Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500005b4,0xff80ff80,0x00000000,unsigned>;
        ///CALFACT_D
