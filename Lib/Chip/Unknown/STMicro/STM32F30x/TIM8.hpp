...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40013400,0xfffff400>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40013404,0xff0a8002>;
    ...
    namespace Nonesmcr{
        using Addr = Register::Address<0x40013408,0xfffe0000>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40013410,0xfffce000>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40013414,0xfffffe00>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40013418,0xfefe0000>;
    ...
    namespace Noneccmr2_output{
        using Addr = Register::Address<0x4001341c,0xfefe0000>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40013420,0xffcc4000>;
    ...
    namespace Nonecnt{
        using Addr = Register::Address<0x40013424,0x7fff0000>;
    ...
    namespace Nonercr{
        using Addr = Register::Address<0x40013430,0xffff0000>;
    ...
    namespace Nonebdtr{
        using Addr = Register::Address<0x40013444,0xfc000000>;
    ...
    namespace Noneccmr3_output{
        using Addr = Register::Address<0x40013454,0xfefe0303>;
    ...
    namespace Noneor{
        using Addr = Register::Address<0x40013460,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> TIM8_ETR_ADC2_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2)> TIM8_ETR_ADC3_RMP; 
    }
}
