...
namespace Kvasir {
    namespace Nonecfgr1{
        using Addr = Register::Address<0x40010000,0x80c0e0fc>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> I2C1_FM_plus; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> I2C2_FM_plus; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> SPI2_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> USART2_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26)> USART3_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,27)> I2C1_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> TIM1_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29)> TIM2_DMA_RMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> TIM3_DMA_RMP; 
    }
