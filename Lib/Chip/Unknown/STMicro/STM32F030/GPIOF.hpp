...
namespace Kvasir {
    namespace Nonemoder{
        using Addr = Register::Address<0x48001400,0x00000000>;
    ...
    namespace Noneotyper{
        using Addr = Register::Address<0x48001404,0xffff0000>;
    ...
    namespace Noneospeedr{
        using Addr = Register::Address<0x48001408,0x00000000>;
    ...
    namespace Nonepupdr{
        using Addr = Register::Address<0x4800140c,0x00000000>;
    ...
    namespace Noneidr{
        using Addr = Register::Address<0x48001410,0xffff0000>;
    ...
    namespace Noneodr{
        using Addr = Register::Address<0x48001414,0xffff0000>;
    ...
    namespace Nonebsrr{
        using Addr = Register::Address<0x48001418,0x00000000>;
    ...
    namespace Nonelckr{
        using Addr = Register::Address<0x4800141c,0xfffe0000>;
    ...
    namespace Noneafrl{
        using Addr = Register::Address<0x48001420,0x00000000>;
    ...
    namespace Noneafrh{
        using Addr = Register::Address<0x48001424,0x00000000>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x48001428,0xffff0000>;
