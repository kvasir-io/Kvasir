...
//General-purpose-timers
    ...
    namespace Nonedier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000040c,0xffff80a0,0,unsigned>;
    ...
    namespace Nonedmar{    ///<DMA address for full transfer
        ...
        ///DMA register for burst
              accesses
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dmar{}; 
    }
}
