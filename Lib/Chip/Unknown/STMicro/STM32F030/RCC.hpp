...
//Reset and clock control
    ...
    namespace Nonecir{    ///<Clock interrupt register
        ...
        ///HSI48 Ready Interrupt
              Clear
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> hsi48rdyc{}; 
    ...
    namespace Noneapb1rstr{    ///<APB1 peripheral reset register
          (RCC_APB1RSTR)
        using Addr = Register::Address<0x40021010,0xef9db6ed,0,unsigned>;
        ///Timer 3 reset
    ...
    namespace Noneahbenr{    ///<AHB Peripheral Clock enable register
          (RCC_AHBENR)
        using Addr = Register::Address<0x40021014,0xffa1ffaa,0,unsigned>;
        ///DMA1 clock enable
    ...
    namespace Noneapb1enr{    ///<APB1 peripheral clock enable register
          (RCC_APB1ENR)
        using Addr = Register::Address<0x4002101c,0xef9db6ed,0,unsigned>;
    ...
    namespace Noneahbrstr{    ///<AHB peripheral reset register
        using Addr = Register::Address<0x40021028,0xffa1ffff,0,unsigned>;
        ///I/O port A reset
    ...
    namespace Nonecfgr3{    ///<Clock configuration register 3
        using Addr = Register::Address<0x40021030,0xfffcfeec,0,unsigned>;
        ///USART1 clock source
              selection
    ...
    namespace Nonecr2{    ///<Clock control register 2
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> hsi48rdy{}; 
        namespace Hsi48rdyValC{
        }
        ///HSI48 factory clock
              calibration
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> hsi48cal{}; 
