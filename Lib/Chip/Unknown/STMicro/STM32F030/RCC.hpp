...
namespace Kvasir {
    ...
    namespace Noneapb1rstr{
        using Addr = Register::Address<0x40021010,0xef9db6ed>;
    ...
    namespace Noneahbenr{
        using Addr = Register::Address<0x40021014,0xffa1ffaa>;
    ...
    namespace Noneapb1enr{
        using Addr = Register::Address<0x4002101c,0xef9db6ed>;
    ...
    namespace Noneahbrstr{
        using Addr = Register::Address<0x40021028,0xffa1ffff>;
    ...
    namespace Nonecfgr3{
        using Addr = Register::Address<0x40021030,0xfffcfeec>;
