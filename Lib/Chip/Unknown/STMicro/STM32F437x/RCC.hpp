...
namespace Kvasir {
    ...
    namespace Noneapb2rstr{
        using Addr = Register::Address<0x40023824,0xffc886cc>;
    ...
    namespace Noneapb2enr{
        using Addr = Register::Address<0x40023844,0xffc880cc>;
    ...
    namespace Noneahb1lpenr{
        using Addr = Register::Address<0x40023850,0x81906e00>;
    ...
    namespace Noneapb2lpenr{
        using Addr = Register::Address<0x40023864,0xffc880cc>;
