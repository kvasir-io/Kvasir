...
namespace Kvasir {
    ...
    namespace Nonecr{
        using Addr = Register::Address<0x40002808,0xff006687>;
    ...
    namespace Noneisr{
        using Addr = Register::Address<0x4000280c,0xfffe8606>;
    ...
    namespace Nonetafcr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> TAMP_PUDIS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,13)> TAMP_PRCH; 
