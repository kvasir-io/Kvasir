...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart6Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40011400,0xe0000000,0x00000000,unsigned>;
        ///USART enable
    ...
    namespace Usart6Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40011404,0x0000008f,0x00000000,unsigned>;
    ...
    namespace Usart6Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40011408,0xff810000,0x00000000,unsigned>;
    ...
    namespace Usart6Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4001140c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Usart6Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40011410,0xffff0000,0x00000000,unsigned>;
        ///Guard time value
    ...
    namespace Usart6Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40011414,0x00000000,0x00000000,unsigned>;
        ///Block Length
    ...
    namespace Usart6Rqr{    ///<Request register
        using Addr = Register::Address<0x40011418,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Usart6Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001141c,0xff802000,0x00000000,unsigned>;
    ...
    namespace Usart6Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40011420,0xffede4a0,0x00000000,unsigned>;
    ...
    namespace Usart6Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40011424,0xfffffe00,0x00000000,unsigned>;
        ///Receive data value
    ...
    namespace Usart6Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40011428,0xfffffe00,0x00000000,unsigned>;
        ///Transmit data value
