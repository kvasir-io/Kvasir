...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40012c00,0xfffffc00>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40012c04,0xffff8002>;
    ...
    namespace Nonesmcr{
        using Addr = Register::Address<0x40012c08,0xffff0008>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40012c10,0xffffe100>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40012c14,0xffffff00>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40012c20,0xffffc000>;
    ...
    namespace Nonecnt{
        using Addr = Register::Address<0x40012c24,0xffff0000>;
    ...
    namespace Nonercr{
        using Addr = Register::Address<0x40012c30,0xffffff00>;
    ...
    namespace Nonebdtr{
        using Addr = Register::Address<0x40012c44,0xffff0000>;
    ...
    namespace Noneor1{
        using Addr = Register::Address<0x40012c50,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> ETR_ADC1_RMP; 
    ...
    namespace Noneccmr3_output{
        using Addr = Register::Address<0x40012c54,0xfef80303>;
    ...
    namespace Noneor2{
        using Addr = Register::Address<0x40012c60,0xfffe30f8>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> BKDFBK0E; 
    ...
    namespace Noneor3{
        using Addr = Register::Address<0x40012c64,0xfffff0f8>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> BK2DFBK0E; 
