...
//Advanced-timers
    namespace Nonecr1{    ///<control register 1
        using Addr = Register::Address<0x40012c00,0xfffffc00,0,unsigned>;
        ///Clock division
    ...
    namespace Nonecr2{    ///<control register 2
        using Addr = Register::Address<0x40012c04,0xffff8002,0,unsigned>;
        ///Output Idle state 4
    ...
    namespace Nonesmcr{    ///<slave mode control register
        using Addr = Register::Address<0x40012c08,0xffff0008,0,unsigned>;
    ...
    namespace Nonesr{    ///<status register
        using Addr = Register::Address<0x40012c10,0xffffe100,0,unsigned>;
    ...
    namespace Noneegr{    ///<event generation register
        using Addr = Register::Address<0x40012c14,0xffffff00,0,unsigned>;
        ///Break generation
    ...
    namespace Noneccmr1Output{    ///<capture/compare mode register 1 (output
          mode)
        using Addr = Register::Address<0x40012c18,0xffff0000,0,unsigned>;
    ...
    namespace Noneccmr2Output{    ///<capture/compare mode register 2 (output
          mode)
        using Addr = Register::Address<0x40012c1c,0xffff0000,0,unsigned>;
    ...
    namespace Noneccer{    ///<capture/compare enable
          register
        using Addr = Register::Address<0x40012c20,0xffffc000,0,unsigned>;
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x40012c24,0xffff0000,0,unsigned>;
        ///counter value
    ...
    namespace Nonepsc{    ///<prescaler
        using Addr = Register::Address<0x40012c28,0xffff0000,0,unsigned>;
        ///Prescaler value
    ...
    namespace Nonearr{    ///<auto-reload register
        using Addr = Register::Address<0x40012c2c,0xffff0000,0,unsigned>;
        ///Auto-reload value
    ...
    namespace Nonercr{    ///<repetition counter register
        using Addr = Register::Address<0x40012c30,0xffffff00,0,unsigned>;
    ...
    namespace Noneccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40012c34,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40012c38,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x40012c3c,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40012c40,0xffff0000,0,unsigned>;
        ///Capture/Compare value
    ...
    namespace Nonebdtr{    ///<break and dead-time register
        using Addr = Register::Address<0x40012c44,0xffff0000,0,unsigned>;
        ///Main output enable
    ...
    namespace Nonedcr{    ///<DMA control register
        using Addr = Register::Address<0x40012c48,0xffffe0e0,0,unsigned>;
        ///DMA burst length
    ...
    namespace Nonedmar{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40012c4c,0xffff0000,0,unsigned>;
    ...
    namespace Noneor1{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40012c50,0xffffffe0,0,unsigned>;
        ///External trigger remap on ADC1 analog
              watchdog
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> etrAdc1Rmp{}; 
        ///External trigger remap on ADC3 analog
              watchdog
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> etrAdc3Rmp{}; 
        ///Input Capture 1 remap
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ti1Rmp{}; 
    }
    namespace Noneccmr3Output{    ///<capture/compare mode register 2 (output
          mode)
        using Addr = Register::Address<0x40012c54,0xfef80303,0,unsigned>;
        ///Output Compare 6 mode bit
              3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> oc6mBit3{}; 
        ///Output Compare 5 mode bit
              3
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> oc5mBit3{}; 
    ...
    namespace Noneccr5{    ///<capture/compare register 4
        using Addr = Register::Address<0x40012c58,0x1fff0000,0,unsigned>;
        ///Capture/Compare value
    ...
    namespace Noneccr6{    ///<capture/compare register 4
        using Addr = Register::Address<0x40012c5c,0xffff0000,0,unsigned>;
        ///Capture/Compare value
    ...
    namespace Noneor2{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40012c60,0xfffe30f8,0,unsigned>;
        ///BRK BKIN input enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> bkine{}; 
        ///BRK COMP1 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> bkcmp1e{}; 
        ///BRK COMP2 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> bkcmp2e{}; 
        ///BRK DFSDM_BREAK0 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bkdfbk0e{}; 
        ///BRK BKIN input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> bkinp{}; 
        ///BRK COMP1 input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> bkcmp1p{}; 
        ///BRK COMP2 input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> bkcmp2p{}; 
        ///ETR source selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,14),Register::ReadWriteAccess,unsigned> etrsel{}; 
    }
    namespace Noneor3{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40012c64,0xfffff0f8,0,unsigned>;
        ///BRK2 BKIN input enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> bk2ine{}; 
        ///BRK2 COMP1 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> bk2cmp1e{}; 
        ///BRK2 COMP2 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> bk2cmp2e{}; 
        ///BRK2 DFSDM_BREAK0 enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bk2dfbk0e{}; 
        ///BRK2 BKIN input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> bk2inp{}; 
        ///BRK2 COMP1 input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> bk2cmp1p{}; 
        ///BRK2 COMP2 input polarity
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> bk2cmp2p{}; 
    }
}
