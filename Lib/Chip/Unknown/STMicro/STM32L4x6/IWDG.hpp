...
namespace Kvasir {
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x4000300c,0xfffffff8>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> WVU; 
    ...
    namespace Nonewinr{
        using Addr = Register::Address<0x40003010,0xfffff000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> WIN; 
    }
}
