...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40014000,0xfffff470>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40014004,0xfffffcf2>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x4001400c,0xffff9c1c>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40014010,0xfffffd1c>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40014014,0xffffff1c>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40014018,0xfffeff80>;
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x40014018,0xffffff00>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40014020,0xfffffff0>;
    ...
    namespace Nonecnt{
        using Addr = Register::Address<0x40014024,0x7fff0000>;
    ...
    namespace Nonebdtr{
        using Addr = Register::Address<0x40014044,0xfff00000>;
