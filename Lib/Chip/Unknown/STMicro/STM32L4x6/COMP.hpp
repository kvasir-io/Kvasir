...
//Comparator
    namespace Nonecomp1Csr{    ///<Comparator 1 control and status
        ...
        ///Power Mode of the comparator
              1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> comp1Pwrmode{}; 
        ///Comparator 1 Input Minus connection
              configuration bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4),Register::ReadWriteAccess,unsigned> comp1Inmsel{}; 
        ///Comparator1 input plus selection
              bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> comp1Inpsel{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> comp1Brgen{}; 
        ///Voltage scaler enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> comp1Scalen{}; 
    ...
    namespace Nonecomp2Csr{    ///<Comparator 2 control and status
        ...
        ///Power Mode of the comparator
              2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> comp2Pwrmode{}; 
        ///Comparator 2 Input Minus connection
              configuration bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4),Register::ReadWriteAccess,unsigned> comp2Inmsel{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> comp2Winmode{}; 
        ...
        ///Scaler bridge enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> comp2Brgen{}; 
        ///Voltage scaler enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> comp2Scalen{}; 
