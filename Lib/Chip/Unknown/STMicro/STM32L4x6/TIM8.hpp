...
//Advanced-timers
    ...
    namespace Noneor1{    ///<DMA address for full transfer
        ...
        ///External trigger remap on ADC2 analog
              watchdog
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> etrAdc2Rmp{}; 
    ...
    namespace Noneor2{    ///<DMA address for full transfer
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bkdfbk2e{}; 
    ...
    namespace Noneor3{    ///<DMA address for full transfer
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> bk2dfbk3e{}; 
