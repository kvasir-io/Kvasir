...
//Advanced-timers
    ...
    namespace Tim8Or1{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40013450,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Tim8Ccmr3Output{    ///<capture/compare mode register 2 (output          mode)
        using Addr = Register::Address<0x40013454,0xfef80303,0x00000000,unsigned>;
    ...
    namespace Tim8Or2{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40013460,0xfffe30f8,0x00000000,unsigned>;
    ...
    namespace Tim8Or3{    ///<DMA address for full transfer
        using Addr = Register::Address<0x40013464,0xfffff0f8,0x00000000,unsigned>;
