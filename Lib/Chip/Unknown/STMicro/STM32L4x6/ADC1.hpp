...
//Analog-to-Digital Converter
    namespace Adc1Isr{    ///<interrupt and status register
        using Addr = Register::Address<0x50040000,0xfffff800,0x00000000,unsigned>;
        ///JQOVF
    ...
    namespace Adc1Ier{    ///<interrupt enable register
        using Addr = Register::Address<0x50040004,0xfffff800,0x00000000,unsigned>;
        ///JQOVFIE
    ...
    namespace Adc1Cr{    ///<control register
        using Addr = Register::Address<0x50040008,0x0fffffc0,0x00000000,unsigned>;
        ///ADCAL
    ...
    namespace Adc1Cfgr{    ///<configuration register
        using Addr = Register::Address<0x5004000c,0x80000004,0x00000000,unsigned>;
        ///AWDCH1CH
    ...
    namespace Adc1Cfgr2{    ///<configuration register
        using Addr = Register::Address<0x50040010,0xfffff800,0x00000000,unsigned>;
        ///EXTEN
    ...
    namespace Adc1Smpr1{    ///<sample time register 1
        using Addr = Register::Address<0x50040014,0xc0000007,0x00000000,unsigned>;
        ///SMP9
    ...
    namespace Adc1Smpr2{    ///<sample time register 2
        using Addr = Register::Address<0x50040018,0xf8000000,0x00000000,unsigned>;
        ///SMP18
    ...
    namespace Adc1Tr1{    ///<watchdog threshold register 1
        using Addr = Register::Address<0x50040020,0xf000f000,0x00000000,unsigned>;
        ///HT1
    ...
    namespace Adc1Tr2{    ///<watchdog threshold register
        using Addr = Register::Address<0x50040024,0xff00ff00,0x00000000,unsigned>;
        ///HT2
    ...
    namespace Adc1Tr3{    ///<watchdog threshold register 3
        using Addr = Register::Address<0x50040028,0xff00ff00,0x00000000,unsigned>;
        ///HT3
    ...
    namespace Adc1Sqr1{    ///<regular sequence register 1
        using Addr = Register::Address<0x50040030,0xe0820830,0x00000000,unsigned>;
        ///SQ4
    ...
    namespace Adc1Sqr2{    ///<regular sequence register 2
        using Addr = Register::Address<0x50040034,0xe0820820,0x00000000,unsigned>;
        ///SQ9
    ...
    namespace Adc1Sqr3{    ///<regular sequence register 3
        using Addr = Register::Address<0x50040038,0xe0820820,0x00000000,unsigned>;
        ///SQ14
    ...
    namespace Adc1Sqr4{    ///<regular sequence register 4
        using Addr = Register::Address<0x5004003c,0xfffff820,0x00000000,unsigned>;
        ///SQ16
    ...
    namespace Adc1Dr{    ///<regular Data Register
        using Addr = Register::Address<0x50040040,0xffff0000,0x00000000,unsigned>;
        ///regularDATA
    ...
    namespace Adc1Jsqr{    ///<injected sequence register
        using Addr = Register::Address<0x5004004c,0x82082000,0x00000000,unsigned>;
        ///JSQ4
    ...
    namespace Adc1Ofr1{    ///<offset register 1
        using Addr = Register::Address<0x50040060,0x03fff000,0x00000000,unsigned>;
        ///OFFSET1_EN
    ...
    namespace Adc1Ofr2{    ///<offset register 2
        using Addr = Register::Address<0x50040064,0x03fff000,0x00000000,unsigned>;
        ///OFFSET2_EN
    ...
    namespace Adc1Ofr3{    ///<offset register 3
        using Addr = Register::Address<0x50040068,0x03fff000,0x00000000,unsigned>;
        ///OFFSET3_EN
    ...
    namespace Adc1Ofr4{    ///<offset register 4
        using Addr = Register::Address<0x5004006c,0x03fff000,0x00000000,unsigned>;
        ///OFFSET4_EN
    ...
    namespace Adc1Jdr1{    ///<injected data register 1
        using Addr = Register::Address<0x50040080,0xffff0000,0x00000000,unsigned>;
        ///JDATA1
    ...
    namespace Adc1Jdr2{    ///<injected data register 2
        using Addr = Register::Address<0x50040084,0xffff0000,0x00000000,unsigned>;
        ///JDATA2
    ...
    namespace Adc1Jdr3{    ///<injected data register 3
        using Addr = Register::Address<0x50040088,0xffff0000,0x00000000,unsigned>;
        ///JDATA3
    ...
    namespace Adc1Jdr4{    ///<injected data register 4
        using Addr = Register::Address<0x5004008c,0xffff0000,0x00000000,unsigned>;
        ///JDATA4
    ...
    namespace Adc1Awd2cr{    ///<Analog Watchdog 2 Configuration          Register
        using Addr = Register::Address<0x500400a0,0xfff80001,0x00000000,unsigned>;
        ///AWD2CH
    ...
    namespace Adc1Awd3cr{    ///<Analog Watchdog 3 Configuration          Register
        using Addr = Register::Address<0x500400a4,0xfff80001,0x00000000,unsigned>;
        ///AWD3CH
    ...
    namespace Adc1Difsel{    ///<Differential Mode Selection Register          2
        using Addr = Register::Address<0x500400b0,0xfff80001,0x00000000,unsigned>;
    ...
    namespace Adc1Calfact{    ///<Calibration Factors
        using Addr = Register::Address<0x500400b4,0xff80ff80,0x00000000,unsigned>;
        ///CALFACT_D
