...
//Analog-to-Digital Converter
    ...
    namespace Nonecfgr2{    ///<configuration register
        ...
        ///EXTEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> rovsm{}; 
        ///EXTSEL
        ...
        ///DMACFG
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> jovse{}; 
        ///DMAEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rovse{}; 
    }
