...
//Single Wire Protocol Master      Interface
    namespace Swpmi1Cr{    ///<SWPMI Configuration/Control          register
        using Addr = Register::Address<0x40008800,0xfffffbc0,0x00000000,unsigned>;
    ...
    namespace Swpmi1Brr{    ///<SWPMI Bitrate register
        using Addr = Register::Address<0x40008804,0xffffffc0,0x00000000,unsigned>;
        ///Bitrate prescaler
    ...
    namespace Swpmi1Isr{    ///<SWPMI Interrupt and Status          register
        using Addr = Register::Address<0x4000880c,0xfffff800,0x00000000,unsigned>;
    ...
    namespace Swpmi1Icr{    ///<SWPMI Interrupt Flag Clear          register
        using Addr = Register::Address<0x40008810,0xfffffe60,0x00000000,unsigned>;
    ...
    namespace Swpmi1Ier{    ///<SWPMI Interrupt Enable          register
        using Addr = Register::Address<0x40008814,0xfffffe00,0x00000000,unsigned>;
    ...
    namespace Swpmi1Rfl{    ///<SWPMI Receive Frame Length          register
        using Addr = Register::Address<0x40008818,0xffffffe0,0x00000000,unsigned>;
