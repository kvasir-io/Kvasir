...
//Debug support
    namespace Noneidcode{    ///<MCU Device ID Code Register
        ...
        ///Device Identifier
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> devId{}; 
        ///Revision Identifier
    ...
    namespace Noneapb1Fzr1{    ///<APB Low Freeze Register 1
        ...
        ///I2C3 SMBUS timeout counter stopped when
              core is halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> dbgI2c3Stop{}; 
    ...
    namespace Noneapb1Fzr2{    ///<APB Low Freeze Register 2
        ...
        ///LPTIM2 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> dbgLptim2Stop{}; 
    }
    namespace Noneapb2Fzr{    ///<APB High Freeze Register
        ...
        ///TIM1 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> dbgTim1Stop{}; 
        ///TIM8 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> dbgTim8Stop{}; 
        ///TIM15 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> dbgTim15Stop{}; 
        ///TIM16 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> dbgTim16Stop{}; 
        ///TIM17 counter stopped when core is
              halted
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> dbgTim17Stop{}; 
    }
}
