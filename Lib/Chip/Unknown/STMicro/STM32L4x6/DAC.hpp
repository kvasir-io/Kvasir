...
//Digital-to-analog converter
    namespace DacCr{    ///<control register
        using Addr = Register::Address<0x40007400,0x80028002,0x00000000,unsigned>;
        ///DAC channel1 enable
    ...
    namespace DacSr{    ///<status register
        using Addr = Register::Address<0x40007434,0x1fff1fff,0x00000000,unsigned>;
    ...
    namespace DacCcr{    ///<calibration control register
        using Addr = Register::Address<0x40007438,0xffe0ffe0,0x00000000,unsigned>;
    ...
    namespace DacMcr{    ///<mode control register
        using Addr = Register::Address<0x4000743c,0xfff8fff8,0x00000000,unsigned>;
        ///DAC Channel 1 mode
    ...
    namespace DacShsr1{    ///<Sample and Hold sample time register          1
        using Addr = Register::Address<0x40007440,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace DacShsr2{    ///<Sample and Hold sample time register          2
        using Addr = Register::Address<0x40007444,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace DacShhr{    ///<Sample and Hold hold time          register
        using Addr = Register::Address<0x40007448,0xfc00fc00,0x00000000,unsigned>;
    ...
    namespace DacShrr{    ///<Sample and Hold refresh time          register
        using Addr = Register::Address<0x4000744c,0xff00ff00,0x00000000,unsigned>;
