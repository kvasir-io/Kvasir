...
//Digital-to-analog converter
    namespace Nonecr{    ///<control register
        ...
        ///DAC Channel 1 calibration
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> cen1{}; 
        ///DAC channel2 enable
        ...
        ///DAC Channel 2 calibration
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> cen2{}; 
    }
    ...
    namespace Nonesr{    ///<status register
        ...
        ///DAC Channel 1 calibration offset
              status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> calFlag1{}; 
        ///DAC Channel 1 busy writing sample time
              flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> bwst1{}; 
        ...
        ///DAC Channel 2 calibration offset
              status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> calFlag2{}; 
        ///DAC Channel 2 busy writing sample time
              flag
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> bwst2{}; 
    }
    namespace Noneccr{    ///<calibration control register
        ...
        ///DAC Channel 1 offset trimming
              value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> otrim1{}; 
        ///DAC Channel 2 offset trimming
              value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16),Register::ReadWriteAccess,unsigned> otrim2{}; 
    }
    namespace Nonemcr{    ///<mode control register
        using Addr = Register::Address<0x4000743c,0xfff8fff8,0,unsigned>;
        ///DAC Channel 1 mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> mode1{}; 
        ///DAC Channel 2 mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> mode2{}; 
    }
    namespace Noneshsr1{    ///<Sample and Hold sample time register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> tsample1{}; 
    }
    namespace Noneshsr2{    ///<Sample and Hold sample time register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> tsample2{}; 
    }
    namespace Noneshhr{    ///<Sample and Hold hold time
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> thold1{}; 
        ///DAC Channel 2 hold time
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,16),Register::ReadWriteAccess,unsigned> thold2{}; 
    }
    namespace Noneshrr{    ///<Sample and Hold refresh time
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> trefresh1{}; 
        ///DAC Channel 2 refresh Time
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16),Register::ReadWriteAccess,unsigned> trefresh2{}; 
    }
}
