...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40008000,0xec008000>;
    ...
    namespace Nonecr2{
        using Addr = Register::Address<0x40008004,0x00f047ef>;
    ...
    namespace Nonecr3{
        using Addr = Register::Address<0x40008008,0xff8f0836>;
    ...
    namespace Nonebrr{
        using Addr = Register::Address<0x4000800c,0xfff00000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,0)> BRR; 
    }
    namespace Nonerqr{
        using Addr = Register::Address<0x40008018,0xfffffff1>;
    ...
    namespace Noneisr{
        using Addr = Register::Address<0x4000801c,0xff80f900>;
    ...
    namespace Noneicr{
        using Addr = Register::Address<0x40008020,0xffedfda0>;
    ...
    namespace Nonerdr{
        using Addr = Register::Address<0x40008024,0xfffffe00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0)> RDR; 
    }
    namespace Nonetdr{
        using Addr = Register::Address<0x40008028,0xfffffe00>;
