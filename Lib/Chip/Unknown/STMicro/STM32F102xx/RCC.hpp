...
//Reset and clock control
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register          (RCC_APB2RSTR)
        using Addr = Register::Address<0x4002100c,0xffffadc2,0x00000000,unsigned>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register          (RCC_APB1RSTR)
        using Addr = Register::Address<0x40021010,0xe7ddf7fc,0x00000000,unsigned>;
        ///Timer 2 reset
    ...
    namespace RccAhbenr{    ///<AHB Peripheral Clock enable register          (RCC_AHBENR)
        using Addr = Register::Address<0x40021014,0xffffffa8,0x00000000,unsigned>;
        ///DMA1 clock enable
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable register          (RCC_APB2ENR)
        using Addr = Register::Address<0x40021018,0xffffadc2,0x00000000,unsigned>;
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable register          (RCC_APB1ENR)
        using Addr = Register::Address<0x4002101c,0xe7ddf7fc,0x00000000,unsigned>;
