...
namespace Kvasir {
    namespace Nonecr1{
        using Addr = Register::Address<0x40001c00,0xfffffc78>;
    ...
    namespace Nonedier{
        using Addr = Register::Address<0x40001c0c,0xfffffffc>;
    ...
    namespace Nonesr{
        using Addr = Register::Address<0x40001c10,0xfffffdfc>;
    ...
    namespace Noneegr{
        using Addr = Register::Address<0x40001c14,0xfffffffc>;
    ...
    namespace Noneccmr1_output{
        using Addr = Register::Address<0x40001c18,0xffffff80>;
    ...
    namespace Noneccmr1_input{
        using Addr = Register::Address<0x40001c18,0xffffff00>;
    ...
    namespace Noneccer{
        using Addr = Register::Address<0x40001c20,0xfffffff4>;
