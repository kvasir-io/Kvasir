...
//Reset and clock control
    ...
    namespace Nonecfgr{    ///<Clock configuration register
        ...
        ///USB prescaler
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> usbpre{}; 
        ///Microcontroller clock
              output
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,24),Register::ReadWriteAccess,unsigned> mco{}; 
        ///SDADC prescaler
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,27),Register::ReadWriteAccess,unsigned> sdpre{}; 
    }
    ...
    namespace Noneapb2rstr{    ///<APB2 peripheral reset register
        ...
        ///TIM19 timer reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> tim19rst{}; 
        ///SDADC1 (Sigma delta ADC 1)
              reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> sdad1rst{}; 
        ///SDADC2 (Sigma delta ADC 2)
              reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> sdad2rst{}; 
        ///SDADC3 (Sigma delta ADC 3)
              reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> sdad3rst{}; 
    }
    namespace Noneapb1rstr{    ///<APB1 peripheral reset register
        ...
        ///Timer 18 reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> tim18rst{}; 
        ...
        ///DAC3 reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> dac3rst{}; 
    ...
    namespace Noneahbenr{    ///<AHB Peripheral Clock enable register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> iopeen{}; 
    ...
    namespace Noneapb2enr{    ///<APB2 peripheral clock enable register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> tim19en{}; 
        ...
        ///SDADC1 (Sigma Delta ADC 1) clock
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> sdad1en{}; 
        ///SDADC2 (Sigma Delta ADC 2) clock
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> sdad2en{}; 
        ///SDADC3 (Sigma Delta ADC 3) clock
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> sdad3en{}; 
    }
    namespace Noneapb1enr{    ///<APB1 peripheral clock enable register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> tim18en{}; 
        ...
        ///DAC3 interface clock
              enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26),Register::ReadWriteAccess,unsigned> dac3en{}; 
    ...
    namespace Noneahbrstr{    ///<AHB peripheral reset register
        ...
        ///I/O port E reset
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> ioperst{}; 
        ///I/O port F reset
    ...
    namespace Nonecfgr3{    ///<Clock configuration register 3
        ...
        ///I2C2 clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> i2c2sw{}; 
        ...
        ///USART3 clock source
              selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18),Register::ReadWriteAccess,unsigned> usart3sw{}; 
    }
}
