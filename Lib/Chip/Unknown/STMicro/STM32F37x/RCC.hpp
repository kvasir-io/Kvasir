...
//Reset and clock control
    ...
    namespace RccCfgr{    ///<Clock configuration register          (RCC_CFGR)
        using Addr = Register::Address<0x40021004,0x00800000,0x00000000,unsigned>;
        ///System clock Switch
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register          (RCC_APB2RSTR)
        using Addr = Register::Address<0x4002100c,0xf8f0adfe,0x00000000,unsigned>;
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register          (RCC_APB1RSTR)
        using Addr = Register::Address<0x40021010,0x89193400,0x00000000,unsigned>;
        ///Timer 2 reset
    ...
    namespace RccAhbenr{    ///<AHB Peripheral Clock enable register          (RCC_AHBENR)
        using Addr = Register::Address<0x40021014,0xfe81ffa8,0x00000000,unsigned>;
        ///DMA1 clock enable
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable register          (RCC_APB2ENR)
        using Addr = Register::Address<0x40021018,0xf8b0a5fe,0x00000000,unsigned>;
        ///SYSCFG clock enable
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable register          (RCC_APB1ENR)
        using Addr = Register::Address<0x4002101c,0x89193400,0x00000000,unsigned>;
    ...
    namespace RccAhbrstr{    ///<AHB peripheral reset register
        using Addr = Register::Address<0x40021028,0xfe81ffff,0x00000000,unsigned>;
        ///I/O port A reset
    ...
    namespace RccCfgr3{    ///<Clock configuration register 3
        using Addr = Register::Address<0x40021030,0xfff0ff8c,0x00000000,unsigned>;
