...
//General purpose timer
    ...
    namespace Nonecnt{    ///<counter
        using Addr = Register::Address<0x40000424,0xffff0000,0,unsigned>;
        ///counter value
    ...
    namespace Nonearr{    ///<auto-reload register
        using Addr = Register::Address<0x4000042c,0xffff0000,0,unsigned>;
        ///Auto-reload value
    ...
    namespace Noneccr1{    ///<capture/compare register 1
        using Addr = Register::Address<0x40000434,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr2{    ///<capture/compare register 2
        using Addr = Register::Address<0x40000438,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr3{    ///<capture/compare register 3
        using Addr = Register::Address<0x4000043c,0xffff0000,0,unsigned>;
    ...
    namespace Noneccr4{    ///<capture/compare register 4
        using Addr = Register::Address<0x40000440,0xffff0000,0,unsigned>;
        ///Capture/Compare value
