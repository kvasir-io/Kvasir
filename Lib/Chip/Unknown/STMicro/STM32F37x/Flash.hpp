...
//Flash
    ...
    namespace Noneobr{    ///<Option byte register
        using Addr = Register::Address<0x4002201c,0x000008f8,0,unsigned>;
        ///Option byte error
        ...
        ///SRAM_PARITY_CHECK
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> sramParityCheck{}; 
        ///SDADC12_VDD_MONITOR
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> sdadc12VddMonitor{}; 
        ///Data0
