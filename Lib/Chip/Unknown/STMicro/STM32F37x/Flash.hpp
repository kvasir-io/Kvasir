...
namespace Kvasir {
    ...
    namespace Noneobr{
        using Addr = Register::Address<0x4002201c,0x000008f8>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> SRAM_PARITY_CHECK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> SDADC12_VDD_MONITOR; 
