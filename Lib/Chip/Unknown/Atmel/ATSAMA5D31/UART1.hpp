...
//Universal Asynchronous Receiver Transmitter 1
    namespace Uart1Cr{    ///<Control Register
        using Addr = Register::Address<0xf8028000,0xfffffe03,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Uart1Mr{    ///<Mode Register
        using Addr = Register::Address<0xf8028004,0xffff31ff,0,unsigned>;
        ///Parity Type
        enum class ParVal {
    ...
    namespace Uart1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf8028008,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf802800c,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf8028010,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart1Sr{    ///<Status Register
        using Addr = Register::Address<0xf8028014,0xfffffd1c,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Uart1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf8028018,0xffffff00,0,unsigned>;
        ///Received Character
    ...
    namespace Uart1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf802801c,0xffffff00,0,unsigned>;
    ...
    namespace Uart1Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xf8028020,0xffff0000,0,unsigned>;
        ///Clock Divisor
