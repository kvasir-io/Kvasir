...
//Ethernet MAC 10/100
    ...
    namespace EmacIsr{    ///<Interrupt Status Register
        using Addr = Register::Address<0xf802c024,0xffff8300,0,unsigned>;
        ...
        ///Wake On LAN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> wol{}; 
    }
    namespace EmacIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf802c028,0xffff8300,0,unsigned>;
    ...
    namespace EmacIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf802c02c,0xffff8300,0,unsigned>;
        ///Management Frame sent
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mfd{}; 
        ///Receive Complete
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rcomp{}; 
    ...
    namespace EmacImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf802c030,0xffff8300,0,unsigned>;
        ///Management Frame sent
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mfd{}; 
        ///Receive Complete
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rcomp{}; 
    ...
    namespace EmacWol{    ///<Wake on LAN Register
        using Addr = Register::Address<0xf802c0c4,0xfff00000,0,unsigned>;
