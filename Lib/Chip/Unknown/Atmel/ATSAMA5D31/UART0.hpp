...
//Universal Asynchronous Receiver Transmitter 0
    namespace Uart0Cr{    ///<Control Register
        using Addr = Register::Address<0xf0024000,0xfffffe03,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Uart0Mr{    ///<Mode Register
        using Addr = Register::Address<0xf0024004,0xffff31ff,0,unsigned>;
        ///Parity Type
        enum class ParVal {
    ...
    namespace Uart0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0024008,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf002400c,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf0024010,0xfffffd1c,0,unsigned>;
    ...
    namespace Uart0Sr{    ///<Status Register
        using Addr = Register::Address<0xf0024014,0xfffffd1c,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Uart0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf0024018,0xffffff00,0,unsigned>;
        ///Received Character
    ...
    namespace Uart0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf002401c,0xffffff00,0,unsigned>;
    ...
    namespace Uart0Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xf0024020,0xffff0000,0,unsigned>;
        ///Clock Divisor
