...
namespace Kvasir {
    namespace RTC_cr{
        using Addr = Register::Address<0xfffffeb0,0xfffcfcfc>;
    ...
    namespace RTC_mr{
        using Addr = Register::Address<0xfffffeb4,0xfffffffe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> HRMOD; 
    }
    namespace RTC_timr{
        using Addr = Register::Address<0xfffffeb8,0xff808080>;
    ...
    namespace RTC_calr{
        using Addr = Register::Address<0xfffffebc,0xc0000080>;
    ...
    namespace RTC_timalr{
        using Addr = Register::Address<0xfffffec0,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0)> SEC; 
    ...
    namespace RTC_calalr{
        using Addr = Register::Address<0xfffffec4,0x4060ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16)> MONTH; 
    ...
    namespace RTC_sr{
        using Addr = Register::Address<0xfffffec8,0xffffffe0>;
    ...
    namespace RTC_sccr{
        using Addr = Register::Address<0xfffffecc,0xffffffe0>;
    ...
    namespace RTC_ier{
        using Addr = Register::Address<0xfffffed0,0xffffffe0>;
    ...
    namespace RTC_idr{
        using Addr = Register::Address<0xfffffed4,0xffffffe0>;
    ...
    namespace RTC_imr{
        using Addr = Register::Address<0xfffffed8,0xffffffe0>;
    ...
    namespace RTC_ver{
        using Addr = Register::Address<0xfffffedc,0xfffffff0>;
