...
namespace Kvasir {
    namespace UART0_cr{
        using Addr = Register::Address<0xf8040000,0xfffffe03>;
    ...
    namespace UART0_mr{
        using Addr = Register::Address<0xf8040004,0xffff31ff>;
    ...
    namespace UART0_ier{
        using Addr = Register::Address<0xf8040008,0xfffffd1c>;
    ...
    namespace UART0_idr{
        using Addr = Register::Address<0xf804000c,0xfffffd1c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> OVRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> FRAME; 
    ...
    namespace UART0_imr{
        using Addr = Register::Address<0xf8040010,0xfffffd1c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> OVRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> FRAME; 
    ...
    namespace UART0_sr{
        using Addr = Register::Address<0xf8040014,0xfffffd1c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> OVRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> FRAME; 
