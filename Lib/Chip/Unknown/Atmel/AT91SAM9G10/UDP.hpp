...
namespace Kvasir {
    ...
    namespace UDP_csr0{
        using Addr = Register::Address<0xfffa402c,0xf8007000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> STALLSENTISOERROR; 
    ...
    namespace UDP_fdr0{
        using Addr = Register::Address<0xfffa404c,0xffffff00>;
    ...
    namespace UDP_txvc{
        using Addr = Register::Address<0xfffa4074,0xfffffeff>;
