...
//USB Device Port
    namespace UdpFrmNum{    ///<Frame Number Register
        using Addr = Register::Address<0xfffa4000,0xfffcf800,0x00000000,unsigned>;
    ...
    namespace UdpGlbStat{    ///<Global State Register
        using Addr = Register::Address<0xfffa4004,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace UdpFaddr{    ///<Function Address Register
        using Addr = Register::Address<0xfffa4008,0xfffffe80,0x00000000,unsigned>;
    ...
    namespace UdpIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffa4010,0xffffd4c0,0x00000000,unsigned>;
    ...
    namespace UdpIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffa4014,0xffffd4c0,0x00000000,unsigned>;
    ...
    namespace UdpImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffa4018,0xffffc4c0,0x00000000,unsigned>;
    ...
    namespace UdpIsr{    ///<Interrupt Status Register
        using Addr = Register::Address<0xfffa401c,0xffffc4c0,0x00000000,unsigned>;
    ...
    namespace UdpIcr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0xfffa4020,0xffffc4ff,0x00000000,unsigned>;
    ...
    namespace UdpRstEp{    ///<Reset Endpoint Register
        using Addr = Register::Address<0xfffa4028,0xffffffc0,0x00000000,unsigned>;
        ///Reset Endpoint 0
    ...
    namespace UdpTxvc{    ///<Transceiver Control Register
        using Addr = Register::Address<0xfffa4074,0xfffffeff,0x00000000,unsigned>;
        ///Transceiver Disable
    ...
    namespace UdpCsr0{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa402c,0xf8007000,0x00000000,unsigned>;
    ...
    namespace UdpCsr1{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4030,0xf8007000,0x00000000,unsigned>;
        ///Generates an IN Packet with Data Previously Written in the DPR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txcomp{}; 
        ///Receive Data Bank 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDataBk0{}; 
    ...
    namespace UdpCsr2{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4034,0xf8007000,0x00000000,unsigned>;
        ///Generates an IN Packet with Data Previously Written in the DPR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txcomp{}; 
        ///Receive Data Bank 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDataBk0{}; 
    ...
    namespace UdpCsr3{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4038,0xf8007000,0x00000000,unsigned>;
        ///Generates an IN Packet with Data Previously Written in the DPR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txcomp{}; 
        ///Receive Data Bank 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDataBk0{}; 
    ...
    namespace UdpCsr4{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa403c,0xf8007000,0x00000000,unsigned>;
        ///Generates an IN Packet with Data Previously Written in the DPR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txcomp{}; 
        ///Receive Data Bank 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDataBk0{}; 
    ...
    namespace UdpCsr5{    ///<Endpoint Control and Status Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4040,0xf8007000,0x00000000,unsigned>;
        ///Generates an IN Packet with Data Previously Written in the DPR
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> txcomp{}; 
        ///Receive Data Bank 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rxDataBk0{}; 
    ...
    namespace UdpFdr0{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa404c,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
    ...
    namespace UdpFdr1{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4050,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> fifoData{}; 
    }
    namespace UdpFdr2{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4054,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> fifoData{}; 
    }
    namespace UdpFdr3{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4058,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> fifoData{}; 
    }
    namespace UdpFdr4{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa405c,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> fifoData{}; 
    }
    namespace UdpFdr5{    ///<Endpoint FIFO Data Register (ept_num = 0)
        using Addr = Register::Address<0xfffa4060,0xffffff00,0x00000000,unsigned>;
        ///FIFO Data Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> fifoData{}; 
    }
}
