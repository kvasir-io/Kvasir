...
//USB Device Port
    ...
    namespace UdpCsr0{    ///<Endpoint Control and Status Register (ept_num = 0)
        ...
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> stallsentisoerror{}; 
        ...
        ///Endpoint Type
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8),Register::ReadWriteAccess,unsigned> eptype{}; 
        ///Data Toggle
