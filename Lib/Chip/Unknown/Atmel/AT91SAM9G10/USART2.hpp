...
//Universal Synchronous Asynchronous Receiver Transmitter 2
    namespace Usart2Cr{    ///<Control Register
        using Addr = Register::Address<0xfffb8000,0xfff30003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart2Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffb8008,0xfff7c000,0,unsigned>;
    ...
    namespace Usart2Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffb800c,0xfff7c000,0,unsigned>;
    ...
    namespace Usart2Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffb8010,0xfff7c000,0,unsigned>;
    ...
    namespace Usart2Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfffb8014,0xfe77c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
