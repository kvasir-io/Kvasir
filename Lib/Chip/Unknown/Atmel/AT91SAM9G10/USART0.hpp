...
//Universal Synchronous Asynchronous Receiver Transmitter 0
    namespace Usart0Cr{    ///<Control Register
        using Addr = Register::Address<0xfffb0000,0xfff30003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart0Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffb0004,0x08800000,0,unsigned>;
    ...
    namespace Usart0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffb0008,0xfff7c000,0,unsigned>;
    ...
    namespace Usart0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffb000c,0xfff7c000,0,unsigned>;
    ...
    namespace Usart0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffb0010,0xfff7c000,0,unsigned>;
    ...
    namespace Usart0Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfffb0014,0xfe77c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
        ...
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> rr{}; 
    }
    namespace Usart0Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfffb0018,0xffff7e00,0,unsigned>;
        ///Received Character
    ...
    namespace Usart0Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfffb001c,0xffff7e00,0,unsigned>;
    ...
    namespace Usart0Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfffb0020,0xfff80000,0,unsigned>;
        ///Clock Divider
    ...
    namespace Usart0Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfffb0024,0xffff0000,0,unsigned>;
        ///Time-out Value
    ...
    namespace Usart0Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfffb0028,0xffffff00,0,unsigned>;
        ///Timeguard Value
    ...
    namespace Usart0Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfffb0040,0xfffff800,0,unsigned>;
    ...
    namespace Usart0Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfffb0044,0xffffff00,0,unsigned>;
        ///Number of Errors
    ...
    namespace Usart0If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfffb004c,0xffffff00,0,unsigned>;
        ///IrDA Filter
    ...
    namespace Usart0Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfffb0050,0x8cf0ecf0,0,unsigned>;
    ...
    namespace Usart0Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffb0108,0x00000000,0,unsigned>;
    ...
    namespace Usart0Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffb010c,0xffff0000,0,unsigned>;
        ///Transmit Counter Register
    ...
    namespace Usart0Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffb0118,0x00000000,0,unsigned>;
    ...
    namespace Usart0Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffb011c,0xffff0000,0,unsigned>;
