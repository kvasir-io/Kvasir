...
//Debug Unit
    ...
    namespace DbguMr{    ///<Mode Register
        ...
        ///Parity Type
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,9),Register::ReadWriteAccess,unsigned> par{}; 
        ///Channel Mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> chmode{}; 
    }
    ...
    namespace DbguCidr{    ///<Chip ID Register
        ...
        ///Embedded Processor
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> eproc{}; 
        ///Nonvolatile Program Memory Size
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> nvpsiz{}; 
        ///None
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> nvpsiz2{}; 
        ///Internal SRAM Size
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> sramsiz{}; 
        ///Architecture Identifier
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,20),Register::ReadWriteAccess,unsigned> arch{}; 
        ///Nonvolatile Program Memory Type
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,28),Register::ReadWriteAccess,unsigned> nvptyp{}; 
        ///Extension Flag
