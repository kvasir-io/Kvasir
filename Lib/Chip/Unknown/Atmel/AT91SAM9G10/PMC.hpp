...
//Power Management Controller
    namespace NonepmcScer{    ///<System Clock Enable Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> pck3{}; 
        ///HClock 0 Output Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> hck0{}; 
        ///HClock 1 Output Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> hck1{}; 
    }
    ...
    namespace NonepmcIer{    ///<Interrupt Enable Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> pckrdy3{}; 
    }
    ...
    namespace NonepmcPllicpr{    ///<Charge Pump Current Register
        ...
        ///Charge pump current
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> icpplla{}; 
        ///Charge pump current
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> icppllb{}; 
    }
}
