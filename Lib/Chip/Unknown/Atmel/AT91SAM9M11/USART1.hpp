...
//Universal Synchronous Asynchronous Receiver Transmitter 1
    namespace Usart1Cr{    ///<Control Register
        using Addr = Register::Address<0xfff90000,0xfff30003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart1CrSpiMode{    ///<Control Register
        using Addr = Register::Address<0xfff90000,0xfff3fe03,0,unsigned>;
        ///Reset Receiver
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> rstrx{}; 
        namespace RstrxValC{
        }
    ...
    namespace Usart1Mr{    ///<Mode Register
        using Addr = Register::Address<0xfff90004,0x08800000,0,unsigned>;
    ...
    namespace Usart1MrSpiMode{    ///<Mode Register
        using Addr = Register::Address<0xfff90004,0xffeefe00,0,unsigned>;
        ///USART Mode of Operation
    ...
    namespace Usart1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff90008,0xfef7c000,0,unsigned>;
    ...
    namespace Usart1IerSpiMode{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff90008,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff9000c,0xfef7c000,0,unsigned>;
    ...
    namespace Usart1IdrSpiMode{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff9000c,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Disable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff90010,0xfef7c000,0,unsigned>;
    ...
    namespace Usart1ImrSpiMode{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff90010,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Mask
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfff90014,0xfe77c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1CsrSpiMode{    ///<Channel Status Register
        using Addr = Register::Address<0xfff90014,0xfffff9dc,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfff90018,0xffff7e00,0,unsigned>;
        ///Received Character
    ...
    namespace Usart1Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfff9001c,0xffff7e00,0,unsigned>;
    ...
    namespace Usart1Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfff90020,0xfff80000,0,unsigned>;
        ///Clock Divider
    ...
    namespace Usart1Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfff90024,0xffff0000,0,unsigned>;
        ///Time-out Value
    ...
    namespace Usart1Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfff90028,0xffffff00,0,unsigned>;
        ///Timeguard Value
    ...
    namespace Usart1Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfff90040,0xfffff800,0,unsigned>;
    ...
    namespace Usart1Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfff90044,0xffffff00,0,unsigned>;
        ///Number of Errors
    ...
    namespace Usart1If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfff9004c,0xffffff00,0,unsigned>;
        ///IrDA Filter
    ...
    namespace Usart1Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfff90050,0x8cf0ecf0,0,unsigned>;
    ...
    namespace Usart1Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfff90100,0x00000000,0,unsigned>;
    ...
    namespace Usart1Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfff90104,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfff90108,0x00000000,0,unsigned>;
    ...
    namespace Usart1Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfff9010c,0xffff0000,0,unsigned>;
        ///Transmit Counter Register
    ...
    namespace Usart1Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfff90110,0x00000000,0,unsigned>;
    ...
    namespace Usart1Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfff90114,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfff90118,0x00000000,0,unsigned>;
    ...
    namespace Usart1Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfff9011c,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfff90120,0xfffffcfc,0,unsigned>;
    ...
    namespace Usart1Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfff90124,0xfffffefe,0,unsigned>;
        ///Receiver Transfer Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxten{}; 
        namespace RxtenValC{
        }
