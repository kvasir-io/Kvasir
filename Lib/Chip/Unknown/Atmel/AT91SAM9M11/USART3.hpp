...
//Universal Synchronous Asynchronous Receiver Transmitter 3
    namespace Usart3Cr{    ///<Control Register
        using Addr = Register::Address<0xfff98000,0xfff30003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart3CrSpiMode{    ///<Control Register
        using Addr = Register::Address<0xfff98000,0xfff3fe03,0,unsigned>;
        ///Reset Receiver
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> rstrx{}; 
        ///Reset Transmitter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> rsttx{}; 
    ...
    namespace Usart3Mr{    ///<Mode Register
        using Addr = Register::Address<0xfff98004,0x08800000,0,unsigned>;
    ...
    namespace Usart3MrSpiMode{    ///<Mode Register
        using Addr = Register::Address<0xfff98004,0xffeefe00,0,unsigned>;
        ///USART Mode of Operation
    ...
    namespace Usart3Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff98008,0xfef7c000,0,unsigned>;
    ...
    namespace Usart3IerSpiMode{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfff98008,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///TXRDY Interrupt Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart3Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff9800c,0xfef7c000,0,unsigned>;
    ...
    namespace Usart3IdrSpiMode{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfff9800c,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Disable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///TXRDY Interrupt Disable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart3Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff98010,0xfef7c000,0,unsigned>;
    ...
    namespace Usart3ImrSpiMode{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfff98010,0xfffff9dc,0,unsigned>;
        ///RXRDY Interrupt Mask
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///TXRDY Interrupt Mask
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart3Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfff98014,0xfe77c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart3CsrSpiMode{    ///<Channel Status Register
        using Addr = Register::Address<0xfff98014,0xfffff9dc,0,unsigned>;
        ///Receiver Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart3Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfff98018,0xffff7e00,0,unsigned>;
        ///Received Character
    ...
    namespace Usart3Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfff9801c,0xffff7e00,0,unsigned>;
    ...
    namespace Usart3Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfff98020,0xfff80000,0,unsigned>;
        ///Clock Divider
    ...
    namespace Usart3Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfff98024,0xffff0000,0,unsigned>;
        ///Time-out Value
    ...
    namespace Usart3Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfff98028,0xffffff00,0,unsigned>;
        ///Timeguard Value
    ...
    namespace Usart3Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfff98040,0xfffff800,0,unsigned>;
    ...
    namespace Usart3Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfff98044,0xffffff00,0,unsigned>;
        ///Number of Errors
    ...
    namespace Usart3If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfff9804c,0xffffff00,0,unsigned>;
        ///IrDA Filter
    ...
    namespace Usart3Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfff98050,0x8cf0ecf0,0,unsigned>;
    ...
    namespace Usart3Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfff98100,0x00000000,0,unsigned>;
    ...
    namespace Usart3Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfff98104,0xffff0000,0,unsigned>;
    ...
    namespace Usart3Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfff98108,0x00000000,0,unsigned>;
    ...
    namespace Usart3Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfff9810c,0xffff0000,0,unsigned>;
        ///Transmit Counter Register
    ...
    namespace Usart3Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfff98110,0x00000000,0,unsigned>;
    ...
    namespace Usart3Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfff98114,0xffff0000,0,unsigned>;
    ...
    namespace Usart3Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfff98118,0x00000000,0,unsigned>;
    ...
    namespace Usart3Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfff9811c,0xffff0000,0,unsigned>;
    ...
    namespace Usart3Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfff98120,0xfffffcfc,0,unsigned>;
    ...
    namespace Usart3Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfff98124,0xfffffefe,0,unsigned>;
        ///Receiver Transfer Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxten{}; 
        ///Transmitter Transfer Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> txten{}; 
