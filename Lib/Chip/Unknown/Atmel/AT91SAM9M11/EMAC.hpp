...
//Ethernet MAC 10/100
    namespace EmacNcr{    ///<Network Control Register
        using Addr = Register::Address<0xfffbc000,0xfffff800,0x00000000,unsigned>;
        ///LoopBack
    ...
    namespace EmacNcfg{    ///<Network Configuration Register
        using Addr = Register::Address<0xfffbc004,0xfff00204,0x00000000,unsigned>;
        ///Speed
    ...
    namespace EmacNsr{    ///<Network Status Register
        using Addr = Register::Address<0xfffbc008,0xfffffff9,0x00000000,unsigned>;
        ///
    ...
    namespace EmacTsr{    ///<Transmit Status Register
        using Addr = Register::Address<0xfffbc014,0xffffff80,0x00000000,unsigned>;
        ///Used Bit Read
    ...
    namespace EmacRbqp{    ///<Receive Buffer Queue Pointer Register
        using Addr = Register::Address<0xfffbc018,0x00000003,0x00000000,unsigned>;
    ...
    namespace EmacTbqp{    ///<Transmit Buffer Queue Pointer Register
        using Addr = Register::Address<0xfffbc01c,0x00000003,0x00000000,unsigned>;
        ///Transmit buffer queue pointer address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,2),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacRsr{    ///<Receive Status Register
        using Addr = Register::Address<0xfffbc020,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace EmacIsr{    ///<Interrupt Status Register
        using Addr = Register::Address<0xfffbc024,0xffffc300,0x00000000,unsigned>;
    ...
    namespace EmacIer{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffbc028,0xffffc300,0x00000000,unsigned>;
    ...
    namespace EmacIdr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffbc02c,0xffffc300,0x00000000,unsigned>;
        ///Management Frame sent
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mfd{}; 
        ///Receive Complete
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rcomp{}; 
    ...
    namespace EmacImr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffbc030,0xffffc300,0x00000000,unsigned>;
        ///Management Frame sent
    ...
    namespace EmacMan{    ///<Phy Maintenance Register
        using Addr = Register::Address<0xfffbc034,0x00000000,0x00000000,unsigned>;
        ///
    ...
    namespace EmacFto{    ///<Frames Transmitted Ok Register
        using Addr = Register::Address<0xfffbc040,0xff000000,0x00000000,unsigned>;
    ...
    namespace EmacScf{    ///<Single Collision Frames Register
        using Addr = Register::Address<0xfffbc044,0xffff0000,0x00000000,unsigned>;
    ...
    namespace EmacMcf{    ///<Multiple Collision Frames Register
        using Addr = Register::Address<0xfffbc048,0xffff0000,0x00000000,unsigned>;
    ...
    namespace EmacFro{    ///<Frames Received Ok Register
        using Addr = Register::Address<0xfffbc04c,0xff000000,0x00000000,unsigned>;
        ///Frames Received OK
    ...
    namespace EmacFcse{    ///<Frame Check Sequence Errors Register
        using Addr = Register::Address<0xfffbc050,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacAle{    ///<Alignment Errors Register
        using Addr = Register::Address<0xfffbc054,0xffffff00,0x00000000,unsigned>;
        ///Alignment Errors
    ...
    namespace EmacDtf{    ///<Deferred Transmission Frames Register
        using Addr = Register::Address<0xfffbc058,0xffff0000,0x00000000,unsigned>;
    ...
    namespace EmacLcol{    ///<Late Collisions Register
        using Addr = Register::Address<0xfffbc05c,0xffffff00,0x00000000,unsigned>;
        ///Late Collisions
    ...
    namespace EmacEcol{    ///<Excessive Collisions Register
        using Addr = Register::Address<0xfffbc060,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacTund{    ///<Transmit Underrun Errors Register
        using Addr = Register::Address<0xfffbc064,0xffffff00,0x00000000,unsigned>;
        ///Transmit Underruns
    ...
    namespace EmacCse{    ///<Carrier Sense Errors Register
        using Addr = Register::Address<0xfffbc068,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacRre{    ///<Receive Resource Errors Register
        using Addr = Register::Address<0xfffbc06c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace EmacRov{    ///<Receive Overrun Errors Register
        using Addr = Register::Address<0xfffbc070,0xffffff00,0x00000000,unsigned>;
        ///Receive Overrun
    ...
    namespace EmacRse{    ///<Receive Symbol Errors Register
        using Addr = Register::Address<0xfffbc074,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacEle{    ///<Excessive Length Errors Register
        using Addr = Register::Address<0xfffbc078,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacRja{    ///<Receive Jabbers Register
        using Addr = Register::Address<0xfffbc07c,0xffffff00,0x00000000,unsigned>;
        ///Receive Jabbers
    ...
    namespace EmacUsf{    ///<Undersize Frames Register
        using Addr = Register::Address<0xfffbc080,0xffffff00,0x00000000,unsigned>;
        ///Undersize frames
    ...
    namespace EmacSte{    ///<SQE Test Errors Register
        using Addr = Register::Address<0xfffbc084,0xffffff00,0x00000000,unsigned>;
        ///SQE test errors
    ...
    namespace EmacRle{    ///<Received Length Field Mismatch Register
        using Addr = Register::Address<0xfffbc088,0xffffff00,0x00000000,unsigned>;
    ...
    namespace EmacHrb{    ///<Hash Register Bottom [31:0] Register
        using Addr = Register::Address<0xfffbc090,0x00000000,0x00000000,unsigned>;
        ///
    ...
    namespace EmacHrt{    ///<Hash Register Top [63:32] Register
        using Addr = Register::Address<0xfffbc094,0x00000000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa1b{    ///<Specific Address 1 Bottom Register
        using Addr = Register::Address<0xfffbc098,0x00000000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa1t{    ///<Specific Address 1 Top Register
        using Addr = Register::Address<0xfffbc09c,0xffff0000,0x00000000,unsigned>;
        ///
    ...
    namespace EmacSa2b{    ///<Specific Address 2 Bottom Register
        using Addr = Register::Address<0xfffbc0a0,0x00000000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa2t{    ///<Specific Address 2 Top Register
        using Addr = Register::Address<0xfffbc0a4,0xffff0000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa3b{    ///<Specific Address 3 Bottom Register
        using Addr = Register::Address<0xfffbc0a8,0x00000000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa3t{    ///<Specific Address 3 Top Register
        using Addr = Register::Address<0xfffbc0ac,0xffff0000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa4b{    ///<Specific Address 4 Bottom Register
        using Addr = Register::Address<0xfffbc0b0,0x00000000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacSa4t{    ///<Specific Address 4 Top Register
        using Addr = Register::Address<0xfffbc0b4,0xffff0000,0x00000000,unsigned>;
        ///
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> addr{}; 
    }
    namespace EmacTid{    ///<Type ID Checking Register
        using Addr = Register::Address<0xfffbc0b8,0xffff0000,0x00000000,unsigned>;
        ///Type ID checking
    ...
    namespace EmacUsrio{    ///<User Input/Output Register
        using Addr = Register::Address<0xfffbc0c0,0xfffffffc,0x00000000,unsigned>;
        ///
