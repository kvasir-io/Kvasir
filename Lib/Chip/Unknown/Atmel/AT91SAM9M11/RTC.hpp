...
namespace Kvasir {
    namespace RTC_cr{
        using Addr = Register::Address<0xfffffdb0,0xfffcfcfc>;
    ...
    namespace RTC_mr{
        using Addr = Register::Address<0xfffffdb4,0xfffffffe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> HRMOD; 
    }
    namespace RTC_timr{
        using Addr = Register::Address<0xfffffdb8,0xff808080>;
    ...
    namespace RTC_calr{
        using Addr = Register::Address<0xfffffdbc,0xc0000080>;
    ...
    namespace RTC_timalr{
        using Addr = Register::Address<0xfffffdc0,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0)> SEC; 
    ...
    namespace RTC_calalr{
        using Addr = Register::Address<0xfffffdc4,0x4060ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16)> MONTH; 
    ...
    namespace RTC_sr{
        using Addr = Register::Address<0xfffffdc8,0xffffffe0>;
    ...
    namespace RTC_sccr{
        using Addr = Register::Address<0xfffffdcc,0xffffffe0>;
    ...
    namespace RTC_ier{
        using Addr = Register::Address<0xfffffdd0,0xffffffe0>;
    ...
    namespace RTC_idr{
        using Addr = Register::Address<0xfffffdd4,0xffffffe0>;
    ...
    namespace RTC_imr{
        using Addr = Register::Address<0xfffffdd8,0xffffffe0>;
    ...
    namespace RTC_ver{
        using Addr = Register::Address<0xfffffddc,0xfffffff0>;
