...
namespace Kvasir {
    ...
    namespace MATRIX_mcfg10{
        using Addr = Register::Address<0xffffde28,0xfffffff8>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> ULBT; 
    }
    ...
    namespace MATRIX_prbs0{
        using Addr = Register::Address<0xffffde84,0xfffffccc>;
    ...
    namespace MATRIX_prbs1{
        using Addr = Register::Address<0xffffde8c,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs2{
        using Addr = Register::Address<0xffffde94,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs3{
        using Addr = Register::Address<0xffffde9c,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs4{
        using Addr = Register::Address<0xffffdea4,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs5{
        using Addr = Register::Address<0xffffdeac,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs6{
        using Addr = Register::Address<0xffffdeb4,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs7{
        using Addr = Register::Address<0xffffdebc,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs8{
        using Addr = Register::Address<0xffffdec4,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
    ...
    namespace MATRIX_prbs9{
        using Addr = Register::Address<0xffffdecc,0xfffffccc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> M8PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> M9PR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8)> M10PR; 
    }
