...
//Analog-to-Digital Converter
    ...
    namespace AdcXposr{    ///<Touchscreen X Position Register
        ...
        ///X Position
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> xpos{}; 
        ///Scale of XPOS
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,16),Register::ReadWriteAccess,unsigned> xscale{}; 
    }
    namespace AdcYposr{    ///<Touchscreen Y Position Register
        using Addr = Register::Address<0xf804c0b8,0xfc00fc00,0,unsigned>;
        ///Y Position
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> ypos{}; 
        ///Scale of YPOS
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,16),Register::ReadWriteAccess,unsigned> yscale{}; 
    }
    namespace AdcPressr{    ///<Touchscreen Pressure Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0),Register::ReadWriteAccess,unsigned> z1{}; 
        ///Data of Z2 Measurement
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,16),Register::ReadWriteAccess,unsigned> z2{}; 
    }
