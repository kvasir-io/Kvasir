...
namespace Kvasir {
    ...
    namespace SPI1_sr{
        using Addr = Register::Address<0xf0004010,0xfffefcf0>;
    ...
    namespace SPI1_ier{
        using Addr = Register::Address<0xf0004014,0xfffffcf0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RDRF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TDRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> MODF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> OVRES; 
    ...
    namespace SPI1_idr{
        using Addr = Register::Address<0xf0004018,0xfffffcf0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RDRF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TDRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> MODF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> OVRES; 
    ...
    namespace SPI1_imr{
        using Addr = Register::Address<0xf000401c,0xfffffcf0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RDRF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TDRE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> MODF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> OVRES; 
    ...
    namespace SPI1_wpmr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> SPIWPEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,8)> SPIWPKEY; 
    }
    namespace SPI1_wpsr{
        using Addr = Register::Address<0xf00040e8,0xffff00f8>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> SPIWPVS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> SPIWPVSRC; 
    }
}
