...
//Reset Controller
    namespace RstcCr{    ///<Control Register
        using Addr = Register::Address<0xfffffe00,0x00fffff2,0x00000000,unsigned>;
        ///Processor Reset
    ...
    namespace RstcSr{    ///<Status Register
        using Addr = Register::Address<0xfffffe04,0xfffcf8fe,0x00000000,unsigned>;
        ///User Reset Status
    ...
    namespace RstcMr{    ///<Mode Register
        using Addr = Register::Address<0xfffffe08,0x00fff0ff,0x00000000,unsigned>;
