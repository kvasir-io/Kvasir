...
//Analog-to-Digital Converter
    ...
    namespace AdcXposr{    ///<Touchscreen X Position Register
        using Addr = Register::Address<0xf804c0b4,0xfc00fc00,0x00000000,unsigned>;
        ///X Position
    ...
    namespace AdcYposr{    ///<Touchscreen Y Position Register
        using Addr = Register::Address<0xf804c0b8,0xfc00fc00,0x00000000,unsigned>;
        ///Y Position
    ...
    namespace AdcPressr{    ///<Touchscreen Pressure Register
        using Addr = Register::Address<0xf804c0bc,0xfc00fc00,0x00000000,unsigned>;
