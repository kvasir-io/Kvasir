...
//Ethernet MAC 10/100
    ...
    namespace EmacNcfg{    ///<Network Configuration Register
        ...
        ///MDC clock divider
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,unsigned> clk{}; 
        ///Retry test
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> rbof{}; 
