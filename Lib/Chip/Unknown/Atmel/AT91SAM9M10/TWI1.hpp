...
namespace Kvasir {
    namespace TWI1_cr{
        using Addr = Register::Address<0xfff88000,0xffffff00>;
    ...
    namespace TWI1_mmr{
        using Addr = Register::Address<0xfff88004,0xff80ecff>;
    ...
    namespace TWI1_smr{
        using Addr = Register::Address<0xfff88008,0xff80ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,16)> SADR; 
    }
    namespace TWI1_iadr{
        using Addr = Register::Address<0xfff8800c,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,0)> IADR; 
    }
    namespace TWI1_cwgr{
        using Addr = Register::Address<0xfff88010,0xfff80000>;
    ...
    namespace TWI1_sr{
        using Addr = Register::Address<0xfff88020,0xfffff080>;
    ...
    namespace TWI1_ier{
        using Addr = Register::Address<0xfff88024,0xfffff088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI1_idr{
        using Addr = Register::Address<0xfff88028,0xfffff088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI1_imr{
        using Addr = Register::Address<0xfff8802c,0xfffff088>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXCOMP; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SVACC; 
    ...
    namespace TWI1_rhr{
        using Addr = Register::Address<0xfff88030,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> RXDATA; 
    }
    namespace TWI1_thr{
        using Addr = Register::Address<0xfff88034,0xffffff00>;
