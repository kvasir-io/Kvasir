...
//Synchronous Serial Controller 1
    namespace Ssc1Cr{    ///<Control Register
        using Addr = Register::Address<0xf800c000,0xffff7cfc,0x00000000,unsigned>;
        ///Receive Enable
    ...
    namespace Ssc1Cmr{    ///<Clock Mode Register
        using Addr = Register::Address<0xf800c004,0xfffff000,0x00000000,unsigned>;
        ///Clock Divider
    ...
    namespace Ssc1Rcmr{    ///<Receive Clock Mode Register
        using Addr = Register::Address<0xf800c010,0x0000e000,0x00000000,unsigned>;
    ...
    namespace Ssc1Rfmr{    ///<Receive Frame Mode Register
        using Addr = Register::Address<0xf800c014,0x0e80f040,0x00000000,unsigned>;
        ///Data Length
    ...
    namespace Ssc1Tcmr{    ///<Transmit Clock Mode Register
        using Addr = Register::Address<0xf800c018,0x0000f000,0x00000000,unsigned>;
    ...
    namespace Ssc1Tfmr{    ///<Transmit Frame Mode Register
        using Addr = Register::Address<0xf800c01c,0x0e00f040,0x00000000,unsigned>;
        ///Data Length
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> datlen{}; 
        ///Data Default Value
    ...
    namespace Ssc1Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf800c020,0x00000000,0x00000000,unsigned>;
        ///Receive Data
    ...
    namespace Ssc1Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf800c024,0x00000000,0x00000000,unsigned>;
        ///Transmit Data
    ...
    namespace Ssc1Rshr{    ///<Receive Sync. Holding Register
        using Addr = Register::Address<0xf800c030,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ssc1Tshr{    ///<Transmit Sync. Holding Register
        using Addr = Register::Address<0xf800c034,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ssc1Rc0r{    ///<Receive Compare 0 Register
        using Addr = Register::Address<0xf800c038,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ssc1Rc1r{    ///<Receive Compare 1 Register
        using Addr = Register::Address<0xf800c03c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ssc1Sr{    ///<Status Register
        using Addr = Register::Address<0xf800c040,0xfffcf0cc,0x00000000,unsigned>;
        ///Transmit Ready
    ...
    namespace Ssc1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf800c044,0xfffff0cc,0x00000000,unsigned>;
    ...
    namespace Ssc1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf800c048,0xfffff0cc,0x00000000,unsigned>;
    ...
    namespace Ssc1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf800c04c,0xfffff0cc,0x00000000,unsigned>;
    ...
    namespace Ssc1Wpmr{    ///<Write Protect Mode Register
        using Addr = Register::Address<0xf800c0e4,0x000000fe,0x00000000,unsigned>;
    ...
    namespace Ssc1Wpsr{    ///<Write Protect Status Register
        using Addr = Register::Address<0xf800c0e8,0xffffffff,0x00000000,unsigned>;
    }
}
