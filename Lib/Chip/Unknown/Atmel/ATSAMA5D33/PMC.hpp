...
namespace Kvasir {
    namespace Nonepmc_scer{
        using Addr = Register::Address<0xfffffc00,0xfffff82b>;
    ...
    namespace Nonepmc_scdr{
        using Addr = Register::Address<0xfffffc04,0xfffff82a>;
    ...
    namespace Nonepmc_scsr{
        using Addr = Register::Address<0xfffffc08,0xfffff82a>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> DDRCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SMDCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> UHP; 
    ...
    namespace Nonepmc_pck2{
        using Addr = Register::Address<0xfffffc48,0xffffff88>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> CSS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4)> PRES; 
    }
    ...
    namespace Nonepmc_pcer1{
        using Addr = Register::Address<0xfffffd00,0x00000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20)> PID53; 
    ...
    namespace Nonepmc_pcdr1{
        using Addr = Register::Address<0xfffffd04,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PID32; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> PID33; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PID34; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PID35; 
    ...
    namespace Nonepmc_pcsr1{
        using Addr = Register::Address<0xfffffd08,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> PID32; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> PID33; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> PID34; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PID35; 
