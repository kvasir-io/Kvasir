...
//LCD Controller
    ...
    namespace LcdcLcdier{    ///<LCD Controller Interrupt Enable Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> heoie{}; 
        ///Hardware Cursor Interrupt Enable Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> hcrie{}; 
    }
    namespace LcdcLcdidr{    ///<LCD Controller Interrupt Disable Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> heoid{}; 
        ///Hardware Cursor Interrupt Disable Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> hcrid{}; 
    }
    namespace LcdcLcdimr{    ///<LCD Controller Interrupt Mask Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> heoim{}; 
        ///Hardware Cursor Interrupt Mask Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> hcrim{}; 
    }
    namespace LcdcLcdisr{    ///<LCD Controller Interrupt Status Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> heo{}; 
        ///Hardware Cursor Raw Interrupt Status Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> hcr{}; 
    }
