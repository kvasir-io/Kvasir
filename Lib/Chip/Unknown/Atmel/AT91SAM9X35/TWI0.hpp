...
//Two-wire Interface 0
    ...
    namespace Twi0Mmr{    ///<Master Mode Register
        using Addr = Register::Address<0xf8010004,0xff80ecff,0,unsigned>;
    ...
    namespace Twi0Smr{    ///<Slave Mode Register
        using Addr = Register::Address<0xf8010008,0xff80ffff,0,unsigned>;
        ///Slave Address
    ...
    namespace Twi0Iadr{    ///<Internal Address Register
        using Addr = Register::Address<0xf801000c,0xff000000,0,unsigned>;
        ///Internal Address
    ...
    namespace Twi0Cwgr{    ///<Clock Waveform Generator Register
        using Addr = Register::Address<0xf8010010,0xfff80000,0,unsigned>;
        ///Clock Low Divider
    ...
    namespace Twi0Sr{    ///<Status Register
        using Addr = Register::Address<0xf8010020,0xfffff080,0,unsigned>;
    ...
    namespace Twi0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf8010024,0xfffff088,0,unsigned>;
    ...
    namespace Twi0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf8010028,0xfffff088,0,unsigned>;
    ...
    namespace Twi0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf801002c,0xfffff088,0,unsigned>;
    ...
    namespace Twi0Rhr{    ///<Receive Holding Register
        using Addr = Register::Address<0xf8010030,0xffffff00,0,unsigned>;
    ...
    namespace Twi0Thr{    ///<Transmit Holding Register
        using Addr = Register::Address<0xf8010034,0xffffff00,0,unsigned>;
    ...
    namespace Twi0WprotStatus{    ///<Protection Status Register
        using Addr = Register::Address<0xf80100e8,0x000000fe,0,unsigned>;
