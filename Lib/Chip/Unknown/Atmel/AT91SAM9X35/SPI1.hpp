...
//Serial Peripheral Interface 1
    ...
    namespace Spi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0004014,0xfffffc70,0x00000000,unsigned>;
    ...
    namespace Spi1Csr0{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004030,0x00000004,0x00000000,unsigned>;
        ///Clock Polarity
    ...
    namespace Spi1Csr1{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004034,0x00000004,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr2{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004038,0x00000004,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr3{    ///<Chip Select Register
        using Addr = Register::Address<0xf000403c,0x00000004,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
