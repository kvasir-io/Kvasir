...
//Serial Peripheral Interface 1
    namespace Spi1Cr{    ///<Control Register
        using Addr = Register::Address<0xf0004000,0xfeffff7c,0x00000000,unsigned>;
        ///SPI Enable
    ...
    namespace Spi1Mr{    ///<Mode Register
        using Addr = Register::Address<0xf0004004,0x00f0ff48,0x00000000,unsigned>;
        ///Master/Slave Mode
    ...
    namespace Spi1Rdr{    ///<Receive Data Register
        using Addr = Register::Address<0xf0004008,0xfff00000,0x00000000,unsigned>;
        ///Receive Data
    ...
    namespace Spi1Tdr{    ///<Transmit Data Register
        using Addr = Register::Address<0xf000400c,0xfef00000,0x00000000,unsigned>;
        ///Transmit Data
    ...
    namespace Spi1Sr{    ///<Status Register
        using Addr = Register::Address<0xf0004010,0xfffefcf0,0x00000000,unsigned>;
    ...
    namespace Spi1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xf0004014,0xfffffcf0,0x00000000,unsigned>;
    ...
    namespace Spi1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xf0004018,0xfffffcf0,0x00000000,unsigned>;
    ...
    namespace Spi1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xf000401c,0xfffffcf0,0x00000000,unsigned>;
    ...
    namespace Spi1Wpmr{    ///<Write Protection Control Register
        using Addr = Register::Address<0xf00040e4,0x000000fe,0x00000000,unsigned>;
    ...
    namespace Spi1Wpsr{    ///<Write Protection Status Register
        using Addr = Register::Address<0xf00040e8,0xffff00f8,0x00000000,unsigned>;
    ...
    namespace Spi1Csr0{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004030,0x00000000,0x00000000,unsigned>;
        ///Clock Polarity
    ...
    namespace Spi1Csr1{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004034,0x00000000,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr2{    ///<Chip Select Register
        using Addr = Register::Address<0xf0004038,0x00000000,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
    ...
    namespace Spi1Csr3{    ///<Chip Select Register
        using Addr = Register::Address<0xf000403c,0x00000000,0x00000000,unsigned>;
        ///Clock Polarity
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cpol{}; 
        ///Clock Phase
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ncpha{}; 
