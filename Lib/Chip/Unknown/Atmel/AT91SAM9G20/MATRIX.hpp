...
//AHB Bus Matrix
    ...
    namespace NoneebiCsa{    ///<EBI Chip Select Assignment Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> vddiomsel{}; 
        ///I/O Slew Rate Selection
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> iosr{}; 
    }
}
