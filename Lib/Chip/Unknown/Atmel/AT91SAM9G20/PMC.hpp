...
//Power Management Controller
    ...
    namespace NonepmcSr{    ///<Status Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> oscSel{}; 
    ...
    namespace NonepmcPllicpr{    ///<PLL Charge Pump Current Register
        ...
        ///Charge Pump Current
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> icpllb{}; 
        namespace IcpllbValC{
        }
    }
}
