...
//Universal Synchronous Asynchronous Receiver Transmitter 1
    namespace Usart1Cr{    ///<Control Register
        using Addr = Register::Address<0xfffb4000,0xfff00003,0x00000000,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart1Mr{    ///<Mode Register
        using Addr = Register::Address<0xfffb4004,0x08800000,0x00000000,unsigned>;
        ///
    ...
    namespace Usart1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0xfffb4008,0xfef0c000,0x00000000,unsigned>;
    ...
    namespace Usart1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0xfffb400c,0xfef0c000,0x00000000,unsigned>;
    ...
    namespace Usart1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0xfffb4010,0xfef0c000,0x00000000,unsigned>;
    ...
    namespace Usart1Csr{    ///<Channel Status Register
        using Addr = Register::Address<0xfffb4014,0xfe00c000,0x00000000,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> txrdy{}; 
    ...
    namespace Usart1Rhr{    ///<Receiver Holding Register
        using Addr = Register::Address<0xfffb4018,0xffff7e00,0x00000000,unsigned>;
        ///Received Character
    ...
    namespace Usart1Thr{    ///<Transmitter Holding Register
        using Addr = Register::Address<0xfffb401c,0xffff7e00,0x00000000,unsigned>;
    ...
    namespace Usart1Brgr{    ///<Baud Rate Generator Register
        using Addr = Register::Address<0xfffb4020,0xfff80000,0x00000000,unsigned>;
        ///Clock Divider
    ...
    namespace Usart1Rtor{    ///<Receiver Time-out Register
        using Addr = Register::Address<0xfffb4024,0xffff0000,0x00000000,unsigned>;
        ///Time-out Value
    ...
    namespace Usart1Ttgr{    ///<Transmitter Timeguard Register
        using Addr = Register::Address<0xfffb4028,0xffffff00,0x00000000,unsigned>;
        ///Timeguard Value
    ...
    namespace Usart1Fidi{    ///<FI DI Ratio Register
        using Addr = Register::Address<0xfffb4040,0xfffff800,0x00000000,unsigned>;
    ...
    namespace Usart1Ner{    ///<Number of Errors Register
        using Addr = Register::Address<0xfffb4044,0xffffff00,0x00000000,unsigned>;
        ///Number of Errors
    ...
    namespace Usart1If{    ///<IrDA Filter Register
        using Addr = Register::Address<0xfffb404c,0xffffff00,0x00000000,unsigned>;
        ///IrDA Filter
    ...
    namespace Usart1Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0xfffb4050,0x8cf0ecf0,0x00000000,unsigned>;
    ...
    namespace Usart1Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0xfffb4100,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0xfffb4104,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Usart1Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0xfffb4108,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0xfffb410c,0xffff0000,0x00000000,unsigned>;
        ///Transmit Counter Register
    ...
    namespace Usart1Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0xfffb4110,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0xfffb4114,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Usart1Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0xfffb4118,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart1Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0xfffb411c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Usart1Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0xfffb4120,0xfffffcfc,0x00000000,unsigned>;
    ...
    namespace Usart1Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0xfffb4124,0xfffffefe,0x00000000,unsigned>;
        ///Receiver Transfer Enable
