...
//Watchdog Timer
    namespace WdtCr{    ///<Control Register
        using Addr = Register::Address<0xfffffd40,0x00fffffe,0,unsigned>;
        ///Watchdog Restart
    ...
    namespace WdtMr{    ///<Mode Register
        using Addr = Register::Address<0xfffffd44,0xc0000000,0,unsigned>;
    ...
    namespace WdtSr{    ///<Status Register
        using Addr = Register::Address<0xfffffd48,0xfffffffc,0,unsigned>;
        ///Watchdog Underflow
