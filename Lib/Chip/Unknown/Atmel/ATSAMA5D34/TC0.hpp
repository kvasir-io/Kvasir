...
//Timer Counter 0
    namespace Tc0Ccr0{    ///<Channel Control Register (channel = 0)
        using Addr = Register::Address<0xf0010000,0xfffffff8,0,unsigned>;
    ...
    namespace Tc0Cmr0{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0xf0010004,0xfff03800,0,unsigned>;
        ///Clock Selection
    ...
    namespace Tc0Cmr0WaveEq1{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0xf0010004,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc0Smmr0{    ///<Stepper Motor Mode Register (channel = 0)
        using Addr = Register::Address<0xf0010008,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
    ...
    namespace Tc0Rab0{    ///<Register AB (channel = 0)
        using Addr = Register::Address<0xf001000c,0x00000000,0,unsigned>;
        ///Register A or Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rab{}; 
    }
    namespace Tc0Cv0{    ///<Counter Value (channel = 0)
        using Addr = Register::Address<0xf0010010,0x00000000,0,unsigned>;
        ///Counter Value
    ...
    namespace Tc0Ra0{    ///<Register A (channel = 0)
        using Addr = Register::Address<0xf0010014,0x00000000,0,unsigned>;
        ///Register A
    ...
    namespace Tc0Rb0{    ///<Register B (channel = 0)
        using Addr = Register::Address<0xf0010018,0x00000000,0,unsigned>;
        ///Register B
    ...
    namespace Tc0Rc0{    ///<Register C (channel = 0)
        using Addr = Register::Address<0xf001001c,0x00000000,0,unsigned>;
        ///Register C
    ...
    namespace Tc0Sr0{    ///<Status Register (channel = 0)
        using Addr = Register::Address<0xf0010020,0xfff8ff00,0,unsigned>;
    ...
    namespace Tc0Ier0{    ///<Interrupt Enable Register (channel = 0)
        using Addr = Register::Address<0xf0010024,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Idr0{    ///<Interrupt Disable Register (channel = 0)
        using Addr = Register::Address<0xf0010028,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Imr0{    ///<Interrupt Mask Register (channel = 0)
        using Addr = Register::Address<0xf001002c,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Ccr1{    ///<Channel Control Register (channel = 1)
        using Addr = Register::Address<0xf0010040,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc0Cmr1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0xf0010044,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc0Cmr1WaveEq1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0xf0010044,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc0Smmr1{    ///<Stepper Motor Mode Register (channel = 1)
        using Addr = Register::Address<0xf0010048,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc0Rab1{    ///<Register AB (channel = 1)
        using Addr = Register::Address<0xf001004c,0x00000000,0,unsigned>;
        ///Register A or Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rab{}; 
    }
    namespace Tc0Cv1{    ///<Counter Value (channel = 1)
        using Addr = Register::Address<0xf0010050,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc0Ra1{    ///<Register A (channel = 1)
        using Addr = Register::Address<0xf0010054,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc0Rb1{    ///<Register B (channel = 1)
        using Addr = Register::Address<0xf0010058,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc0Rc1{    ///<Register C (channel = 1)
        using Addr = Register::Address<0xf001005c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc0Sr1{    ///<Status Register (channel = 1)
        using Addr = Register::Address<0xf0010060,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Ier1{    ///<Interrupt Enable Register (channel = 1)
        using Addr = Register::Address<0xf0010064,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Idr1{    ///<Interrupt Disable Register (channel = 1)
        using Addr = Register::Address<0xf0010068,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Imr1{    ///<Interrupt Mask Register (channel = 1)
        using Addr = Register::Address<0xf001006c,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Ccr2{    ///<Channel Control Register (channel = 2)
        using Addr = Register::Address<0xf0010080,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc0Cmr2{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0xf0010084,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc0Cmr2WaveEq1{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0xf0010084,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc0Smmr2{    ///<Stepper Motor Mode Register (channel = 2)
        using Addr = Register::Address<0xf0010088,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc0Rab2{    ///<Register AB (channel = 2)
        using Addr = Register::Address<0xf001008c,0x00000000,0,unsigned>;
        ///Register A or Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rab{}; 
    }
    namespace Tc0Cv2{    ///<Counter Value (channel = 2)
        using Addr = Register::Address<0xf0010090,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc0Ra2{    ///<Register A (channel = 2)
        using Addr = Register::Address<0xf0010094,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc0Rb2{    ///<Register B (channel = 2)
        using Addr = Register::Address<0xf0010098,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc0Rc2{    ///<Register C (channel = 2)
        using Addr = Register::Address<0xf001009c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc0Sr2{    ///<Status Register (channel = 2)
        using Addr = Register::Address<0xf00100a0,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Ier2{    ///<Interrupt Enable Register (channel = 2)
        using Addr = Register::Address<0xf00100a4,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Idr2{    ///<Interrupt Disable Register (channel = 2)
        using Addr = Register::Address<0xf00100a8,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Imr2{    ///<Interrupt Mask Register (channel = 2)
        using Addr = Register::Address<0xf00100ac,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc0Bcr{    ///<Block Control Register
        using Addr = Register::Address<0xf00100c0,0xfffffffe,0,unsigned>;
        ///Synchro Command
    ...
    namespace Tc0Bmr{    ///<Block Mode Register
        using Addr = Register::Address<0xf00100c4,0xfc0400c0,0,unsigned>;
    ...
    namespace Tc0Qier{    ///<QDEC Interrupt Enable Register
        using Addr = Register::Address<0xf00100c8,0xfffffff8,0,unsigned>;
        ///InDeX
    ...
    namespace Tc0Qidr{    ///<QDEC Interrupt Disable Register
        using Addr = Register::Address<0xf00100cc,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc0Qimr{    ///<QDEC Interrupt Mask Register
        using Addr = Register::Address<0xf00100d0,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc0Qisr{    ///<QDEC Interrupt Status Register
        using Addr = Register::Address<0xf00100d4,0xfffffef8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
