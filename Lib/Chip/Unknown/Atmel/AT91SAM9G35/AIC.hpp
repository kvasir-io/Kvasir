...
//Advanced Interrupt Controller
    ...
    namespace AicIsr{    ///<Interrupt Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> irqid{}; 
    }
    ...
    namespace AicWpmr{    ///<Write Protect Mode Register
        using Addr = Register::Address<0xfffff1e4,0x000000fe,0,unsigned>;
    ...
    namespace AicWpsr{    ///<Write Protect Status Register
        using Addr = Register::Address<0xfffff1e8,0xff0000fe,0,unsigned>;
