...
//DMA Controller 0
    ...
    namespace Dmac0Ctrla0{    ///<DMAC Channel Control A Register (ch_num = 0)
        ...
        namespace srcWidthValC{
            ...
            constexpr MPL::Value<srcWidthVal,srcWidthVal::dword> dword{};
        }
        ...
        namespace dstWidthValC{
            ...
            constexpr MPL::Value<dstWidthVal,dstWidthVal::dword> dword{};
        }
    ...
    namespace Dmac0Ctrlb0{    ///<DMAC Channel Control B Register (ch_num = 0)
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,21),Register::ReadWriteAccess,fcVal> fc{}; 
