...
//Timer Counter 1
    namespace Tc1Ccr0{    ///<Channel Control Register (channel = 0)
        using Addr = Register::Address<0xf8014000,0xfffffff8,0,unsigned>;
    ...
    namespace Tc1Cmr0{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0xf8014004,0xfff03800,0,unsigned>;
        ///Clock Selection
    ...
    namespace Tc1Cmr0WaveEq1{    ///<Channel Mode Register (channel = 0)
        using Addr = Register::Address<0xf8014004,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr0{    ///<Stepper Motor Mode Register (channel = 0)
        using Addr = Register::Address<0xf8014008,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
    ...
    namespace Tc1Rab0{    ///<Register AB (channel = 0)
        using Addr = Register::Address<0xf801400c,0x00000000,0,unsigned>;
    ...
    namespace Tc1Cv0{    ///<Counter Value (channel = 0)
        using Addr = Register::Address<0xf8014010,0x00000000,0,unsigned>;
        ///Counter Value
    ...
    namespace Tc1Ra0{    ///<Register A (channel = 0)
        using Addr = Register::Address<0xf8014014,0x00000000,0,unsigned>;
        ///Register A
    ...
    namespace Tc1Rb0{    ///<Register B (channel = 0)
        using Addr = Register::Address<0xf8014018,0x00000000,0,unsigned>;
        ///Register B
    ...
    namespace Tc1Rc0{    ///<Register C (channel = 0)
        using Addr = Register::Address<0xf801401c,0x00000000,0,unsigned>;
        ///Register C
    ...
    namespace Tc1Sr0{    ///<Status Register (channel = 0)
        using Addr = Register::Address<0xf8014020,0xfff8ff00,0,unsigned>;
    ...
    namespace Tc1Ier0{    ///<Interrupt Enable Register (channel = 0)
        using Addr = Register::Address<0xf8014024,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr0{    ///<Interrupt Disable Register (channel = 0)
        using Addr = Register::Address<0xf8014028,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Imr0{    ///<Interrupt Mask Register (channel = 0)
        using Addr = Register::Address<0xf801402c,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ccr1{    ///<Channel Control Register (channel = 1)
        using Addr = Register::Address<0xf8014040,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc1Cmr1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0xf8014044,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Cmr1WaveEq1{    ///<Channel Mode Register (channel = 1)
        using Addr = Register::Address<0xf8014044,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr1{    ///<Stepper Motor Mode Register (channel = 1)
        using Addr = Register::Address<0xf8014048,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc1Rab1{    ///<Register AB (channel = 1)
        using Addr = Register::Address<0xf801404c,0x00000000,0,unsigned>;
        ///Register A or Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rab{}; 
    }
    namespace Tc1Cv1{    ///<Counter Value (channel = 1)
        using Addr = Register::Address<0xf8014050,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc1Ra1{    ///<Register A (channel = 1)
        using Addr = Register::Address<0xf8014054,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc1Rb1{    ///<Register B (channel = 1)
        using Addr = Register::Address<0xf8014058,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc1Rc1{    ///<Register C (channel = 1)
        using Addr = Register::Address<0xf801405c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc1Sr1{    ///<Status Register (channel = 1)
        using Addr = Register::Address<0xf8014060,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ier1{    ///<Interrupt Enable Register (channel = 1)
        using Addr = Register::Address<0xf8014064,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr1{    ///<Interrupt Disable Register (channel = 1)
        using Addr = Register::Address<0xf8014068,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Imr1{    ///<Interrupt Mask Register (channel = 1)
        using Addr = Register::Address<0xf801406c,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ccr2{    ///<Channel Control Register (channel = 2)
        using Addr = Register::Address<0xf8014080,0xfffffff8,0,unsigned>;
        ///Counter Clock Enable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> clken{}; 
        ///Counter Clock Disable Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> clkdis{}; 
    ...
    namespace Tc1Cmr2{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0xf8014084,0xfff03800,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Cmr2WaveEq1{    ///<Channel Mode Register (channel = 2)
        using Addr = Register::Address<0xf8014084,0x00000000,0,unsigned>;
        ///Clock Selection
        enum class tcclksVal {
            timerClock1=0x00000000,     ///<Clock selected: TCLK1
            timerClock2=0x00000001,     ///<Clock selected: TCLK2
    ...
    namespace Tc1Smmr2{    ///<Stepper Motor Mode Register (channel = 2)
        using Addr = Register::Address<0xf8014088,0xfffffffc,0,unsigned>;
        ///Gray Count Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> gcen{}; 
        ///DOWN Count
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> down{}; 
    ...
    namespace Tc1Rab2{    ///<Register AB (channel = 2)
        using Addr = Register::Address<0xf801408c,0x00000000,0,unsigned>;
        ///Register A or Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rab{}; 
    }
    namespace Tc1Cv2{    ///<Counter Value (channel = 2)
        using Addr = Register::Address<0xf8014090,0x00000000,0,unsigned>;
        ///Counter Value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
    namespace Tc1Ra2{    ///<Register A (channel = 2)
        using Addr = Register::Address<0xf8014094,0x00000000,0,unsigned>;
        ///Register A
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> ra{}; 
    }
    namespace Tc1Rb2{    ///<Register B (channel = 2)
        using Addr = Register::Address<0xf8014098,0x00000000,0,unsigned>;
        ///Register B
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rb{}; 
    }
    namespace Tc1Rc2{    ///<Register C (channel = 2)
        using Addr = Register::Address<0xf801409c,0x00000000,0,unsigned>;
        ///Register C
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rc{}; 
    }
    namespace Tc1Sr2{    ///<Status Register (channel = 2)
        using Addr = Register::Address<0xf80140a0,0xfff8ff00,0,unsigned>;
        ///Counter Overflow Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun Status
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Ier2{    ///<Interrupt Enable Register (channel = 2)
        using Addr = Register::Address<0xf80140a4,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Idr2{    ///<Interrupt Disable Register (channel = 2)
        using Addr = Register::Address<0xf80140a8,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Imr2{    ///<Interrupt Mask Register (channel = 2)
        using Addr = Register::Address<0xf80140ac,0xffffff00,0,unsigned>;
        ///Counter Overflow
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> covfs{}; 
        ///Load Overrun
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lovrs{}; 
    ...
    namespace Tc1Bcr{    ///<Block Control Register
        using Addr = Register::Address<0xf80140c0,0xfffffffe,0,unsigned>;
        ///Synchro Command
    ...
    namespace Tc1Bmr{    ///<Block Mode Register
        using Addr = Register::Address<0xf80140c4,0xfc0400c0,0,unsigned>;
    ...
    namespace Tc1Qier{    ///<QDEC Interrupt Enable Register
        using Addr = Register::Address<0xf80140c8,0xfffffff8,0,unsigned>;
        ///InDeX
    ...
    namespace Tc1Qidr{    ///<QDEC Interrupt Disable Register
        using Addr = Register::Address<0xf80140cc,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc1Qimr{    ///<QDEC Interrupt Mask Register
        using Addr = Register::Address<0xf80140d0,0xfffffff8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
    ...
    namespace Tc1Qisr{    ///<QDEC Interrupt Status Register
        using Addr = Register::Address<0xf80140d4,0xfffffef8,0,unsigned>;
        ///InDeX
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> idx{}; 
        ///DIRection CHanGe
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> dirchg{}; 
