...
//Product name title=UM10430 Chapter title=LPC18xx Timer0/1/2/3 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    ...
    namespace Nonemcr{    ///<Match Control Register. The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
        ...
        namespace Mr0iValC{
            constexpr Register::FieldValue<decltype(mr0i),Mr0iVal::interruptIsGenerat> interruptIsGenerat{};
            constexpr Register::FieldValue<decltype(mr0i),Mr0iVal::interruptIsDisable> interruptIsDisable{};
        }
        ///Reset on MR0
        enum class Mr0rVal {
        ...
        namespace Mr0rValC{
            constexpr Register::FieldValue<decltype(mr0r),Mr0rVal::tcWillBeResetIf> tcWillBeResetIf{};
            constexpr Register::FieldValue<decltype(mr0r),Mr0rVal::featureDisabled> featureDisabled{};
        }
        ///Stop on MR0
        enum class Mr0sVal {
        ...
        namespace Mr0sValC{
            constexpr Register::FieldValue<decltype(mr0s),Mr0sVal::tcAndPcWillBeSt> tcAndPcWillBeSt{};
            constexpr Register::FieldValue<decltype(mr0s),Mr0sVal::featureDisabled> featureDisabled{};
        }
        ///Interrupt on MR1
        enum class Mr1iVal {
        ...
        namespace Mr1iValC{
            constexpr Register::FieldValue<decltype(mr1i),Mr1iVal::interruptIsGenerat> interruptIsGenerat{};
            constexpr Register::FieldValue<decltype(mr1i),Mr1iVal::interruptIsDisable> interruptIsDisable{};
        }
        ///Reset on MR1
        enum class Mr1rVal {
        ...
        namespace Mr1rValC{
            constexpr Register::FieldValue<decltype(mr1r),Mr1rVal::tcWillBeResetIf> tcWillBeResetIf{};
            constexpr Register::FieldValue<decltype(mr1r),Mr1rVal::featureDisabled> featureDisabled{};
        }
        ///Stop on MR1
        enum class Mr1sVal {
        ...
        namespace Mr1sValC{
            constexpr Register::FieldValue<decltype(mr1s),Mr1sVal::tcAndPcWillBeSt> tcAndPcWillBeSt{};
            constexpr Register::FieldValue<decltype(mr1s),Mr1sVal::featureDisabled> featureDisabled{};
        }
        ///Interrupt on MR2
        enum class Mr2iVal {
        ...
        namespace Mr2iValC{
            constexpr Register::FieldValue<decltype(mr2i),Mr2iVal::interruptIsGenerat> interruptIsGenerat{};
            constexpr Register::FieldValue<decltype(mr2i),Mr2iVal::interruptIsDisable> interruptIsDisable{};
        }
        ///Reset on MR2
        enum class Mr2rVal {
        ...
        namespace Mr2rValC{
            constexpr Register::FieldValue<decltype(mr2r),Mr2rVal::tcWillBeResetIf> tcWillBeResetIf{};
            constexpr Register::FieldValue<decltype(mr2r),Mr2rVal::featureDisabled> featureDisabled{};
        }
        ///Stop on MR2.
        enum class Mr2sVal {
        ...
        namespace Mr2sValC{
            constexpr Register::FieldValue<decltype(mr2s),Mr2sVal::tcAndPcWillBeSt> tcAndPcWillBeSt{};
            constexpr Register::FieldValue<decltype(mr2s),Mr2sVal::featureDisabled> featureDisabled{};
        }
        ///Interrupt on MR3
        enum class Mr3iVal {
        ...
        namespace Mr3iValC{
            constexpr Register::FieldValue<decltype(mr3i),Mr3iVal::interruptIsGenerat> interruptIsGenerat{};
            constexpr Register::FieldValue<decltype(mr3i),Mr3iVal::thisInterruptIsDi> thisInterruptIsDi{};
        }
        ///Reset on MR3
        enum class Mr3rVal {
        ...
        namespace Mr3rValC{
            constexpr Register::FieldValue<decltype(mr3r),Mr3rVal::tcWillBeResetIf> tcWillBeResetIf{};
            constexpr Register::FieldValue<decltype(mr3r),Mr3rVal::featureDisabled> featureDisabled{};
        }
        ///Stop on MR3
        enum class Mr3sVal {
        ...
        namespace Mr3sValC{
            constexpr Register::FieldValue<decltype(mr3s),Mr3sVal::tcAndPcWillBeSt> tcAndPcWillBeSt{};
            constexpr Register::FieldValue<decltype(mr3s),Mr3sVal::featureDisabled> featureDisabled{};
        }
    }
    ...
    namespace Noneccr{    ///<Capture Control Register. The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
        ...
        namespace Cap0reValC{
            constexpr Register::FieldValue<decltype(cap0re),Cap0reVal::aSequenceOf0Then> aSequenceOf0Then{};
            constexpr Register::FieldValue<decltype(cap0re),Cap0reVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap0feValC{
            constexpr Register::FieldValue<decltype(cap0fe),Cap0feVal::aSequenceOf1Then> aSequenceOf1Then{};
            constexpr Register::FieldValue<decltype(cap0fe),Cap0feVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap0iValC{
            constexpr Register::FieldValue<decltype(cap0i),Cap0iVal::aCr0LoadDueToA> aCr0LoadDueToA{};
            constexpr Register::FieldValue<decltype(cap0i),Cap0iVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap1reValC{
            constexpr Register::FieldValue<decltype(cap1re),Cap1reVal::aSequenceOf0Then> aSequenceOf0Then{};
            constexpr Register::FieldValue<decltype(cap1re),Cap1reVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap1feValC{
            constexpr Register::FieldValue<decltype(cap1fe),Cap1feVal::aSequenceOf1Then> aSequenceOf1Then{};
            constexpr Register::FieldValue<decltype(cap1fe),Cap1feVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap1iValC{
            constexpr Register::FieldValue<decltype(cap1i),Cap1iVal::aCr1LoadDueToA> aCr1LoadDueToA{};
            constexpr Register::FieldValue<decltype(cap1i),Cap1iVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap2reValC{
            constexpr Register::FieldValue<decltype(cap2re),Cap2reVal::aSequenceOf0Then> aSequenceOf0Then{};
            constexpr Register::FieldValue<decltype(cap2re),Cap2reVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap2feValC{
            constexpr Register::FieldValue<decltype(cap2fe),Cap2feVal::aSequenceOf1Then> aSequenceOf1Then{};
            constexpr Register::FieldValue<decltype(cap2fe),Cap2feVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap2iValC{
            constexpr Register::FieldValue<decltype(cap2i),Cap2iVal::aCr2LoadDueToA> aCr2LoadDueToA{};
            constexpr Register::FieldValue<decltype(cap2i),Cap2iVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap3reValC{
            constexpr Register::FieldValue<decltype(cap3re),Cap3reVal::aSequenceOf0Then> aSequenceOf0Then{};
            constexpr Register::FieldValue<decltype(cap3re),Cap3reVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap3feValC{
            constexpr Register::FieldValue<decltype(cap3fe),Cap3feVal::aSequenceOf1Then> aSequenceOf1Then{};
            constexpr Register::FieldValue<decltype(cap3fe),Cap3feVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
        ...
        namespace Cap3iValC{
            constexpr Register::FieldValue<decltype(cap3i),Cap3iVal::aCr3LoadDueToA> aCr3LoadDueToA{};
            constexpr Register::FieldValue<decltype(cap3i),Cap3iVal::thisFeatureIsDisa> thisFeatureIsDisa{};
        }
    }
    ...
    namespace Nonectcr{    ///<Count Control Register. The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
        ...
        namespace CtmodeValC{
            constexpr Register::FieldValue<decltype(ctmode),CtmodeVal::timerModeEveryRi> timerModeEveryRi{};
            constexpr Register::FieldValue<decltype(ctmode),CtmodeVal::counterModeTcIs> counterModeTcIs{};
            constexpr Register::FieldValue<decltype(ctmode),CtmodeVal::counterModeTcIs> counterModeTcIs{};
            constexpr Register::FieldValue<decltype(ctmode),CtmodeVal::counterModeTcIs> counterModeTcIs{};
        }
        ...
        namespace CinselValC{
            constexpr Register::FieldValue<decltype(cinsel),CinselVal::capn0ForTimern> capn0ForTimern{};
            constexpr Register::FieldValue<decltype(cinsel),CinselVal::capn1ForTimern> capn1ForTimern{};
            constexpr Register::FieldValue<decltype(cinsel),CinselVal::capn2ForTimern> capn2ForTimern{};
            constexpr Register::FieldValue<decltype(cinsel),CinselVal::capn3ForTimernNo> capn3ForTimernNo{};
        }
    }
}
