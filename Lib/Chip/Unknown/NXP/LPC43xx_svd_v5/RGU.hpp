...
namespace Kvasir {
    namespace Nonereset_ctrl0{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13)> M4_RST; 
    ...
    namespace Nonereset_ctrl1{
        using Addr = Register::Address<0x40053104,0xf8000800>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> M0APP_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> SGPIO_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26)> SPI_RST; 
    }
    namespace Nonereset_status0{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,26)> M4_RST; 
    }
    ...
    namespace Nonereset_status3{
        using Addr = Register::Address<0x4005311c,0xffc00000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,16)> M0APP_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,18)> SGPIO_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20)> SPI_RST; 
    }
    ...
    namespace Nonereset_active_status1{
        using Addr = Register::Address<0x40053154,0xf8000800>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TIMER0_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TIMER1_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TIMER2_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TIMER3_RST; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> CAN1_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> CAN0_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> MOAPP_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> SGPIO_RST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26)> SPI_RST; 
    }
