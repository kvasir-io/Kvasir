...
//Product name title=UM10430 Chapter title=LPC18xx I2S interface Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace I2s0Dao{    ///<I2S Digital Audio Output Register. Contains control bits for the I2S transmit channel.
    ...
    namespace I2s0Dai{    ///<I2S Digital Audio Input Register. Contains control bits for the I2S receive channel.
    ...
    namespace I2s0Txfifo{    ///<I2S Transmit FIFO. Access register for the 8 x 32-bit transmitter FIFO.
    ...
    namespace I2s0Rxfifo{    ///<I2S Receive FIFO. Access register for the 8 x 32-bit receiver FIFO.
    ...
    namespace I2s0State{    ///<I2S Status Feedback Register. Contains status information about the I2S interface.
    ...
    namespace I2s0Dma1{    ///<I2S DMA Configuration Register 1. Contains control information for DMA request 1.
    ...
    namespace I2s0Dma2{    ///<I2S DMA Configuration Register 2. Contains control information for DMA request 2.
    ...
    namespace I2s0Irq{    ///<I2S Interrupt Request Control Register. Contains bits that control how the I2S interrupt request is generated.
    ...
    namespace I2s0Txrate{    ///<I2S Transmit MCLK divider. This register determines the I2S TX MCLK rate by specifying the value to divide PCLK by in order to produce MCLK.
    ...
    namespace I2s0Rxrate{    ///<I2S Receive MCLK divider. This register determines the I2S RX MCLK rate by specifying the value to divide PCLK by in order to produce MCLK.
    ...
    namespace I2s0Txbitrate{    ///<I2S Transmit bit rate divider. This register determines the I2S transmit bit rate by specifying the value to divide TX_MCLK by in order to produce the transmit bit clock.
    ...
    namespace I2s0Rxbitrate{    ///<I2S Receive bit rate divider. This register determines the I2S receive bit rate by specifying the value to divide RX_MCLK by in order to produce the receive bit clock.
    ...
    namespace I2s0Txmode{    ///<I2S Transmit mode control.
    ...
    namespace I2s0Rxmode{    ///<I2S Receive mode control.
