...
//Product name title=UM10430 Chapter title=LPC18xx Real-Time Clock (RTC) Modification date=1/20/2011 Major revision=0 Minor revision=7 
    ...
    namespace Noneccr{    ///<Clock Control Register
        ...
        namespace clkenValC{
            constexpr MPL::Value<clkenVal,clkenVal::disabled> disabled{};
            constexpr MPL::Value<clkenVal,clkenVal::enabled> enabled{};
        }
        ...
        namespace ctcrstValC{
            ...
            constexpr MPL::Value<ctcrstVal,ctcrstVal::resetvalue> resetvalue{};
        }
        ...
        namespace ccalenValC{
            constexpr MPL::Value<ccalenVal,ccalenVal::enabled> enabled{};
            constexpr MPL::Value<ccalenVal,ccalenVal::disabled> disabled{};
        }
