...
namespace Kvasir {
//Product name title=UM10430 Chapter title=LPC18xx Ethernet Modification date=12/9/2011 Major revision=1.1 Minor revision=not available 
    namespace EthernetMacConfig{    ///<MAC configuration register
        ...
        ///Link Up/Down  Indicates whether the link is up or down during the transmission of configuration in SMII interface:  0 = Link down 1 = Link up
    ...
    namespace EthernetMacFrameFilter{    ///<MAC frame filter
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> dbf{}; 
        ...
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,10),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace EthernetMacHashtableHigh{    ///<Hash table high register
    ...
    namespace EthernetMacHashtableLow{    ///<Hash table low register
    ...
    namespace EthernetMacMiiAddr{    ///<MII address register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> w{}; 
        ///CSR clock range The CSR Clock Range selection determines the frequency of the MDC clock. The suggested range of CLK_M3_ETHERNET frequency applicable for each value below (when Bit[5] = 0) ensures that the MDC clock is approximately between the frequency range 1.0 MHz - 2.5 MHz.  When bit 5 is set, you can achieve MDC clock of frequency higher than the IEEE 802.3 specified frequency limit of 2.5 MHz and program a clock divider of lower value. For example, when CLK_M3_ETHERNET is of frequency 100 MHz and you program these bits as 1010, then the resultant MDC clock will be of 12.5 MHz which is outside the limit of IEEE 802.3 specified range. Program the values given below only if the interfacing chips supports faster MDC clocks.  See Table 462 for bit values.
    ...
    namespace EthernetMacMiiData{    ///<MII data register
    ...
    namespace EthernetMacVlanTag{    ///<VLAN tag register
    ...
    namespace EthernetMacDebug{    ///<Debug register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxidlestat{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,1),Register::ReadWriteAccess,unsigned> fifostat0{}; 
        ///Reserved
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> rxfifostat1{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,5),Register::ReadWriteAccess,unsigned> rxfifostat{}; 
        ///Reserved
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> rxfifolvl{}; 
        ///Reserved
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> txidlestat{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,17),Register::ReadWriteAccess,unsigned> txstat{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> pause{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,unsigned> txfifostat{}; 
        ///When high, it indicates that the MTL TxFIFO Write Controller is active and transferring data to the TxFIFO.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> txfifostat1{}; 
        ///Reserved
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> txfifolvl{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(25,25),Register::ReadWriteAccess,unsigned> txfifofull{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,26),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace EthernetMacRwakeFrflt{    ///<Remote wake-up frame filter
    ...
    namespace EthernetMacPmtCtrlStat{    ///<PMT control and status
    ...
    namespace EthernetMacIntr{    ///<Interrupt status register
        using Addr = Register::Address<0x40010038,0x00000000,0x00000000,unsigned>;
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace EthernetMacIntrMask{    ///<Interrupt mask register
        using Addr = Register::Address<0x4001003c,0xfffffff0,0x00000000,unsigned>;
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///PMT Interrupt Mask  This bit when set, will disable the assertion of the interrupt signal due to the setting of PMT Interrupt Status bit in Table 469.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> pmtmsk{}; 
    }
    namespace EthernetMacAddr0High{    ///<MAC address 0 high register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> a4732{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,16),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///Always 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> mo{}; 
    }
    namespace EthernetMacAddr0Low{    ///<MAC address 0 low register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> a310{}; 
    }
    namespace EthernetMacTimestpCtrl{    ///<Time stamp control register
        using Addr = Register::Address<0x40010700,0xfff80000,0x00000000,unsigned>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> tsena{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tscfupdt{}; 
        ///Time Stamp Initialize This register field can be read and written by the application (Read and Write), and is cleared to 0 by the Ethernet core (Self Clear).  When set, the system time is initialized (over-written) with the value specified in the Time Stamp High Update and Time Stamp Low Update registers. This register bit should be read zero before updating it. This bit is reset once the initialize is complete.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> tsinit{}; 
        ///Time Stamp Update  This register field can be read and written by the application (Read and Write), and is cleared to 0 by the Ethernet core (Self Clear).  When set, the system time is updated (added/subtracted) with the value specified in the Time Stamp High Update and Time Stamp Low Update registers. This register bit should be read zero before updating it. This bit is reset once the update is completed in hardware.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> tsupdt{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> tstrig{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> tsaddreg{}; 
        ///Reserved
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> tsenall{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> tsctrlssr{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> tsver2ena{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> tsipena{}; 
        ///Enable Time Stamp Snapshot for IPv6 frames  When set, the time stamp snapshot is taken for IPv6 frames.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> tsipv6ena{}; 
        ///Enable Time Stamp Snapshot for IPv4 frames  When set, the time stamp snapshot is taken for IPv4 frames.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> tsipv4ena{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> tsevntena{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> tsmstrena{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,16),Register::ReadWriteAccess,unsigned> tsclktype{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> tsenmacaddr{}; 
    }
    namespace EthernetSubsecondIncr{    ///<Sub-second increment register
        using Addr = Register::Address<0x40010704,0x00000000,0x00000000,unsigned>;
        ///Sub-second increment value. The value programmed in this register is accumulated with the contents of the sub-second register. For example, to achieve an accuracy of 20 ns, the value to be programmed is 20. (0x14 with a 50 MHz reference clock if 1 ns accuracy is selected.)
    ...
    namespace EthernetSeconds{    ///<System time seconds register
        using Addr = Register::Address<0x40010708,0x00000000,0x00000000,unsigned>;
        ///Time stamp second The value in this field indicates the current value in seconds of the System Time maintained by the core.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tss{}; 
    }
    namespace EthernetNanoseconds{    ///<System time nanoseconds register
        using Addr = Register::Address<0x4001070c,0x00000000,0x00000000,unsigned>;
        ///Time stamp sub seconds The value in this field has the sub second representation of time, with an accuracy of 0.46 nano-second. (When TSCTRLSSR in the MAC_TIMESTAMP_CTRL register is set, each bit represents 1 ns and the maximum value will be 0x3B9A_C9FF, after which it rolls-over to zero).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,0),Register::ReadWriteAccess,unsigned> tsss{}; 
        ///Positive or negative time This bit indicates positive or negative time value. If the bit is reset, it indicates that the time representation is positive, and if it is set, it indicates negative time value. (This bit represents the 32nd bit of the nanoseconds value when the Advance Time Stamp feature is enabled).
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> psnt{}; 
    }
    namespace EthernetSecondsupdate{    ///<System time seconds update register
        using Addr = Register::Address<0x40010710,0x00000000,0x00000000,unsigned>;
        ///Time stamp second The value in this field indicates the time, in seconds, to be initialized or added to the system time.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tss{}; 
    }
    namespace EthernetNanosecondsupdate{    ///<System time nanoseconds update register
        using Addr = Register::Address<0x40010714,0x00000000,0x00000000,unsigned>;
        ///Time stamp sub seconds The value in this field has the sub second representation of time, with an accuracy of 0.46 nano-second. (When TSCTRLSSR is set in the time stamp control register, each bit represents 1 ns and the programmed value should not exceed 0x3B9A_C9FF.)
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,0),Register::ReadWriteAccess,unsigned> tsss{}; 
    ...
    namespace EthernetAddend{    ///<Time stamp addend register
        using Addr = Register::Address<0x40010718,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetTargetseconds{    ///<Target time seconds register
        using Addr = Register::Address<0x4001071c,0x00000000,0x00000000,unsigned>;
        ///Target time seconds register This register stores the time in seconds. When the time stamp value matches or exceeds both Target Time Stamp registers, the MAC, if enabled, generates an interrupt.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tstr{}; 
    }
    namespace EthernetTargetnanoseconds{    ///<Target time nanoseconds register
        using Addr = Register::Address<0x40010720,0x00000000,0x00000000,unsigned>;
        ///Target time stamp low  This register stores the time in (signed) nanoseconds. When the value of the Time Stamp matches the Target time stamp registers (both), the MAC will generate an interrupt if enabled. (This value should not exceed 0x3B9A_C9FF when TSCTRLSSR is set in the time stamp control register.)
    ...
    namespace EthernetHighword{    ///<System time higher word seconds register
        using Addr = Register::Address<0x40010724,0x00000000,0x00000000,unsigned>;
        ///Time stamp higher word Contains the most significant 16-bits of the time stamp seconds value. The register is directly written to initialize the value. This register is incremented when there is an overflow from the 32-bits of the System Time - Seconds register.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tshwr{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace EthernetTimestampstat{    ///<Time stamp status register
        using Addr = Register::Address<0x40010728,0x00000000,0x00000000,unsigned>;
        ///Time stamp seconds overflow When set, indicates that the seconds value of the time stamp (when supporting version 2 format) has overflowed beyond 0xFFFF_FFFF.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> tssovf{}; 
        ///Time stamp target reached When set, indicates the value of system time is greater or equal to the value specified in the Target Time High and Low registers
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tstargt{}; 
        ///Auxiliary Time Stamp Trigger Snapshot  This bit is set high when the auxiliary snapshot is written to the FIFO.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> auxss{}; 
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,3),Register::ReadWriteAccess,unsigned> reserved{}; 
        ///Auxiliary Time Stamp Snapshot Trigger Missed  This bit is set when the Auxiliary time stamp snapshot FIFO is full and external trigger was set. This indicates that the latest snapshot was not stored in the FIFO.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> atsstm{}; 
        ///Auxiliary Time Stamp Number of Snapshots  These bits indicate the number of Snapshots available in the FIFO. A value of 4 (100) indicates that the Auxiliary Snapshot FIFO is full. These bits are cleared (to 000) when the Auxiliary snapshot FIFO clear bit is set.
    ...
    namespace EthernetPpsctrl{    ///<PPS control register
        using Addr = Register::Address<0x4001072c,0x00000000,0x00000000,unsigned>;
        ///Control the duration between 2-pulses of PPS signal output  This controls the duration between 2 pulses of the PPS output signal. By default the control is set to 1 second between pulses. The duration of the pulses for valid settings is mentioned below. 0000 = 1.0 sec (Binary and Digital Rollover)  0001 = 0.5 sec (Binary Rollover), 0.536 sec (Digital Rollover) 0010 = 0.25 sec (Binary Rollover), 0.26 sec (Digital Rollover)  0011 = 0.125 sec (Binary Rollover), 0.13 sec (Digital Rollover)  ... 1111 = 15.28 msec (Binary Rollover), 32.77 microsec (Digital Rollover)
    ...
    namespace EthernetAuxnanoseconds{    ///<Auxiliary time stamp nanoseconds register
        using Addr = Register::Address<0x40010730,0x00000000,0x00000000,unsigned>;
        ///Lower 32 bits (nano-seconds field) of the auxiliary time stamp.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> auxns{}; 
    }
    namespace EthernetAuxseconds{    ///<Auxiliary time stamp seconds register
        using Addr = Register::Address<0x40010734,0x00000000,0x00000000,unsigned>;
        ///Lower 32 bits of the Seconds field of the auxiliary time stamp .
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> auxs{}; 
    }
    namespace EthernetDmaBusMode{    ///<Bus Mode Register
        using Addr = Register::Address<0x40011000,0x00000000,0x00000000,unsigned>;
        ...
        ///Alternate descriptor size When set, the alternate descriptor (see Section 24.10.3) size is increased to 32 bytes (8 DWORDS). This is required when the Advanced Time-Stamp feature or Full IPC Offload Engine is enabled in the receiver.  When reset, the descriptor size reverts back to 4 DWORDs (16 bytes).
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> pbl8x{}; 
    ...
    namespace EthernetDmaTransPollDemand{    ///<Transmit poll demand register
        using Addr = Register::Address<0x40011004,0x00000000,0x00000000,unsigned>;
        ///Transmit poll demand This register field can be read by the application, and when a write operation is performed with any data value, an event is triggered.  When these bits are written with any value, the DMA reads the current descriptor pointed to by the Current Host Transmit Descriptor register (Section 24.6.40). If that descriptor is not available (owned by Host), transmission returns to the Suspend state and bit 2 in the DMA_STAT Register is asserted. If the descriptor is available, transmission resumes.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tpd{}; 
    }
    namespace EthernetDmaRecPollDemand{    ///<Receive poll demand register
        using Addr = Register::Address<0x40011008,0x00000000,0x00000000,unsigned>;
        ///Receive poll demand This register field can be read by the application, and when a write operation is performed with any data value, an event is triggered.  When these bits are written with any value, the DMA reads the current descriptor pointed to by the Current Host Receive Descriptor register (Section 24.6.41). If that descriptor is not available (owned by Host), reception returns to the Suspended state and bit 7 in the DMA_STAT Register is not asserted. If the descriptor is available, the Receive DMA returns to active state.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rpd{}; 
    }
    namespace EthernetDmaRecDesAddr{    ///<Receive descriptor list address register
        using Addr = Register::Address<0x4001100c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetDmaTransDesAddr{    ///<Transmit descriptor list address register
        using Addr = Register::Address<0x40011010,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetDmaStat{    ///<Status register
        using Addr = Register::Address<0x40011014,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetDmaOpMode{    ///<Operation mode register
        using Addr = Register::Address<0x40011018,0x00000000,0x00000000,unsigned>;
        ///Reserved
        ...
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,8),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace EthernetDmaIntEn{    ///<Interrupt enable register
        using Addr = Register::Address<0x4001101c,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetDmaMfrmBufof{    ///<Missed frame and buffer overflow register
        using Addr = Register::Address<0x40011020,0x00000000,0x00000000,unsigned>;
        ///Number of frames missed This register field can be read by the application (Read), can be set to 1 by the Ethernet core on a certain internal event (Self Set), and is automatically cleared to 0 on a register read. A register write of 0 has no effect on this field.  Indicates the number of frames missed by the controller due to the Host Receive Buffer being unavailable. This counter is incremented each time the DMA discards an incoming frame. The counter is cleared when this register is read with.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> fmc{}; 
        ///Overflow bit for missed frame counter This register field can be read by the application (Read), can be set to 1 by the Ethernet core on a certain internal event (Self Set), and is automatically cleared to 0 on a register read. A register write of 0 has no effect on this field.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> oc{}; 
        ///Number of frames missed by the application This register field can be read by the application (Read), can be set to 1 by the Ethernet core on a certain internal event (Self Set), and is automatically cleared to 0 on a register read. A register write of 0 has no effect on this field.  Indicates the number of frames missed by the application. This counter is incremented each time the MTL asserts the sideband signal mtl_rxoverflow_o. The counter is cleared when this register is read with .
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,17),Register::ReadWriteAccess,unsigned> fma{}; 
        ///Overflow bit for FIFO overflow counter This register field can be read by the application (Read), can be set to 1 by the Ethernet core on a certain internal event (Self Set), and is automatically cleared to 0 on a register read. A register write of 0 has no effect on this field.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,unsigned> of{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,29),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace EthernetDmaRecIntWdt{    ///<Receive interrupt watchdog timer register
        using Addr = Register::Address<0x40011024,0x00000000,0x00000000,unsigned>;
    ...
    namespace EthernetDmaCurhostTransDes{    ///<Current host transmit descriptor register
        using Addr = Register::Address<0x40011048,0x00000000,0x00000000,unsigned>;
        ///Host Transmit Descriptor Address Pointer  Cleared on Reset. Pointer updated by DMA during operation.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> htd{}; 
    }
    namespace EthernetDmaCurhostRecDes{    ///<Current host receive descriptor register
        using Addr = Register::Address<0x4001104c,0x00000000,0x00000000,unsigned>;
        ///Host Receive Descriptor Address Pointer  Cleared on Reset. Pointer updated by DMA during operation.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> hrd{}; 
    }
    namespace EthernetDmaCurhostTransBuf{    ///<Current host transmit buffer address register
        using Addr = Register::Address<0x40011050,0x00000000,0x00000000,unsigned>;
        ///Host Transmit Buffer Address Pointer  Cleared on Reset. Pointer updated by DMA during operation.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> htb{}; 
    }
    namespace EthernetDmaCurhostRecBuf{    ///<Current host receive buffer address register
        using Addr = Register::Address<0x40011054,0x00000000,0x00000000,unsigned>;
        ///Host Receive Buffer Address Pointer  Cleared on Reset. Pointer updated by DMA during operation.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> hrb{}; 
    }
}
