...
//Product name title=UM10430 Chapter title=LPC18xx Ethernet Modification date=12/9/2011 Major revision=1.1 Minor revision=not available 
    ...
    namespace NonemacTimestpCtrl{    ///<Time stamp control register
        ...
        namespace TsenmacaddrValC{
        }
    }
    namespace NonesubsecondIncr{    ///<Sub-second increment register
        using Addr = Register::Address<0x40010704,0xffffff00,0,unsigned>;
    ...
    namespace Noneseconds{    ///<System time seconds register
        using Addr = Register::Address<0x40010708,0x00000000,0,unsigned>;
    ...
    namespace Nonenanoseconds{    ///<System time nanoseconds register
        using Addr = Register::Address<0x4001070c,0x00000000,0,unsigned>;
    ...
    namespace Nonesecondsupdate{    ///<System time seconds update register
        using Addr = Register::Address<0x40010710,0x00000000,0,unsigned>;
        ///Time stamp second The value in this field indicates the time, in seconds, to be initialized or added to the system time.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> tss{}; 
        namespace TssValC{
        }
    }
    namespace Nonenanosecondsupdate{    ///<System time nanoseconds update register
        using Addr = Register::Address<0x40010714,0x00000000,0,unsigned>;
    ...
    namespace Noneaddend{    ///<Time stamp addend register
        using Addr = Register::Address<0x40010718,0x00000000,0,unsigned>;
    ...
    namespace Nonetargetseconds{    ///<Target time seconds register
        using Addr = Register::Address<0x4001071c,0x00000000,0,unsigned>;
    ...
    namespace Nonetargetnanoseconds{    ///<Target time nanoseconds register
        using Addr = Register::Address<0x40010720,0x80000000,0,unsigned>;
    ...
    namespace Nonehighword{    ///<System time higher word seconds register
        using Addr = Register::Address<0x40010724,0xffff0000,0,unsigned>;
    ...
    namespace Nonetimestampstat{    ///<Time stamp status register
        using Addr = Register::Address<0x40010728,0xf0fffff8,0,unsigned>;
    ...
    namespace Noneppsctrl{    ///<PPS control register
        using Addr = Register::Address<0x4001072c,0xfffffff0,0,unsigned>;
    ...
    namespace Noneauxnanoseconds{    ///<Auxiliary time stamp nanoseconds register
        using Addr = Register::Address<0x40010730,0x00000000,0,unsigned>;
    ...
    namespace Noneauxseconds{    ///<Auxiliary time stamp seconds register
        using Addr = Register::Address<0x40010734,0x00000000,0,unsigned>;
