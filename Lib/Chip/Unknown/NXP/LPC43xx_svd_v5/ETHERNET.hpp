...
//Product name title=UM10430 Chapter title=LPC18xx Ethernet Modification date=12/9/2011 Major revision=1.1 Minor revision=not available 
    ...
    namespace Nonenanoseconds{    ///<System time nanoseconds register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> psnt{}; 
    }
    ...
    namespace Nonetimestampstat{    ///<Time stamp status register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> tstargt{}; 
        ///Auxiliary Time Stamp Trigger Snapshot  This bit is set high when the auxiliary snapshot is written to the FIFO.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> auxss{}; 
    ...
    namespace Noneauxnanoseconds{    ///<Auxiliary time stamp nanoseconds register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> auxns{}; 
    }
    namespace Noneauxseconds{    ///<Auxiliary time stamp seconds register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> auxs{}; 
    }
