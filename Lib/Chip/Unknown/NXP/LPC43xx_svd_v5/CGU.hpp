...
//Product name title=UM10462 Chapter title=LPC18xx Clock Generation Unit (CGU) Modification date=6/1/2011 Major revision=0 Minor revision=1 
    ...
    namespace NoneidivcCtrl{    ///<Integer divider C control register
        using Addr = Register::Address<0x40050450,0xe0fff7c2,0,unsigned>;
        ///Integer divider power down
        enum class PdVal {
            idivEnabledDefaul=0x00000000,     ///<IDIV enabled (default)
            powerDown=0x00000001,     ///<power-down
    ...
    namespace NoneidivdCtrl{    ///<Integer divider D control register
        using Addr = Register::Address<0x40050454,0xe0fff7c2,0,unsigned>;
        ///Integer divider power down
        enum class PdVal {
            idivEnabledDefaul=0x00000000,     ///<IDIV enabled (default)
            powerDown=0x00000001,     ///<power-down
    ...
    namespace NonebasePeriphClk{    ///<Output stage 2 control register for base clock BASE_PERIPH_CLK
        using Addr = Register::Address<0x40050064,0xe0fff7fe,0,unsigned>;
        ///Output stage power down
        enum class PdVal {
            outputStageEnabled=0x00000000,     ///<Output stage enabled (default)
            powerDown=0x00000001,     ///<power-down
    ...
    namespace NonebaseSpiClk{    ///<Output stage BASE_SPI_CLK control register
        using Addr = Register::Address<0x40050074,0xe0fff7fe,0,unsigned>;
        ///Output stage power down
        enum class PdVal {
            outputStageEnabled=0x00000000,     ///<Output stage enabled (default)
            powerDown=0x00000001,     ///<power-down
