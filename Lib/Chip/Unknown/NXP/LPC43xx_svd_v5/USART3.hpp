...
//Product name title=UM10430 Chapter title=LPC18xx USART0_2_3 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace Usart3Rbr{    ///<Receiver Buffer Register. Contains the next received character to be read (DLAB = 0).
        using Addr = Register::Address<0x400c2000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Thr{    ///<Transmit Holding Register. The next character to be transmitted is written here (DLAB = 0).
        using Addr = Register::Address<0x400c2000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Dll{    ///<Divisor Latch LSB. Least significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB = 1).
        using Addr = Register::Address<0x400c2000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Dlm{    ///<Divisor Latch MSB. Most significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB = 1).
        using Addr = Register::Address<0x400c2004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Ier{    ///<Interrupt Enable Register. Contains individual interrupt enable bits for the 7 potential UART interrupts (DLAB = 0).
        using Addr = Register::Address<0x400c2004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Iir{    ///<Interrupt ID Register. Identifies which interrupt(s) are pending.
        using Addr = Register::Address<0x400c2008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Fcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        using Addr = Register::Address<0x400c2008,0x00000000,0x00000000,unsigned>;
        ///FIFO Enable.
    ...
    namespace Usart3Lcr{    ///<Line Control Register. Contains controls for frame formatting and break generation.
        using Addr = Register::Address<0x400c200c,0x00000000,0x00000000,unsigned>;
        ///Word Length Select.
        enum class WlsVal {
    ...
    namespace Usart3Lsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
        using Addr = Register::Address<0x400c2014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Scr{    ///<Scratch Pad Register. Eight-bit temporary storage for software.
        using Addr = Register::Address<0x400c201c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Acr{    ///<Auto-baud Control Register. Contains controls for the auto-baud feature.
        using Addr = Register::Address<0x400c2020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Icr{    ///<IrDA control register (UART3 only)
        using Addr = Register::Address<0x400c2024,0x00000000,0x00000000,unsigned>;
        ///IrDA mode enable.
    ...
    namespace Usart3Fdr{    ///<Fractional Divider Register. Generates a clock input for the baud rate divider.
        using Addr = Register::Address<0x400c2028,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Osr{    ///<Oversampling Register. Controls the degree of oversampling during each bit time.
        using Addr = Register::Address<0x400c202c,0x00000000,0x00000000,unsigned>;
        ///Reserved, user software should not write ones to reserved bits. The value read from a reserved bit is not defined.
    ...
    namespace Usart3Hden{    ///<Half-duplex enable Register
        using Addr = Register::Address<0x400c2040,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Scictrl{    ///<Smart card interface control register
        using Addr = Register::Address<0x400c2048,0x00000018,0x00000000,unsigned>;
    ...
    namespace Usart3Rs485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
        using Addr = Register::Address<0x400c204c,0x00000000,0x00000000,unsigned>;
        ///NMM enable.
        enum class NmmenVal {
    ...
    namespace Usart3Rs485adrmatch{    ///<RS-485/EIA-485 address match. Contains the address match value for RS-485/EIA-485 mode.
        using Addr = Register::Address<0x400c2050,0x00000000,0x00000000,unsigned>;
        ///Contains the address match value.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> adrmatch{}; 
        ///Reserved
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,8),Register::ReadWriteAccess,unsigned> reserved{}; 
    }
    namespace Usart3Rs485dly{    ///<RS-485/EIA-485 direction control delay.
        using Addr = Register::Address<0x400c2054,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Syncctrl{    ///<Synchronous mode control register.
        using Addr = Register::Address<0x400c2058,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usart3Ter{    ///<Transmit Enable Register. Turns off UART transmitter for use with software flow control.
        using Addr = Register::Address<0x400c205c,0x00000000,0x00000000,unsigned>;
