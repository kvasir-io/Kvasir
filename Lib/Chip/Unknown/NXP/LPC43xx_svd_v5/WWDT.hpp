...
//Product name title=UM10430 Chapter title=LPC18xx Windowed Watchdog timer (WWDT) Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace Nonemod{    ///<Watchdog mode register. This register contains the basic mode and status of the Watchdog Timer.
        ...
        namespace WdenValC{
            constexpr Register::FieldValue<decltype(wden),WdenVal::wwdtstopped> wwdtstopped{};
            constexpr Register::FieldValue<decltype(wden),WdenVal::wwdtrun> wwdtrun{};
        }
        ...
        namespace WdresetValC{
            constexpr Register::FieldValue<decltype(wdreset),WdresetVal::wwdtint> wwdtint{};
            constexpr Register::FieldValue<decltype(wdreset),WdresetVal::wwdtreset> wwdtreset{};
        }
        ...
        namespace WdprotectValC{
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::noLock> noLock{};
            constexpr Register::FieldValue<decltype(wdprotect),WdprotectVal::lock> lock{};
        }
    }
