...
//Product name title=UM10430 Chapter title=LPC18xx 10-bit ADC0/1 Modification date=1/18/2011 Major revision=0 Minor revision=7 
    namespace Nonecr{    ///<A/D Control Register. The AD0CR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace BurstValC{
            constexpr Register::FieldValue<decltype(burst),BurstVal::software> software{};
        ...
        namespace ClksValC{
            constexpr Register::FieldValue<decltype(clks),ClksVal::v11Clocks10Bits> v11Clocks10Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v10Clocks9Bits> v10Clocks9Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v9Clocks8Bits> v9Clocks8Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v8Clocks7Bits> v8Clocks7Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v7Clocks6Bits> v7Clocks6Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v6Clocks5Bits> v6Clocks5Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v5Clocks4Bits> v5Clocks4Bits{};
            constexpr Register::FieldValue<decltype(clks),ClksVal::v4Clocks3Bits> v4Clocks3Bits{};
        }
        ///Power mode
        enum class PdnVal {
        ...
        namespace PdnValC{
            ...
            constexpr Register::FieldValue<decltype(pdn),PdnVal::running> running{};
        }
        ...
        namespace StartValC{
            ...
            constexpr Register::FieldValue<decltype(start),StartVal::ctout15> ctout15{};
            constexpr Register::FieldValue<decltype(start),StartVal::ctout8> ctout8{};
            constexpr Register::FieldValue<decltype(start),StartVal::adctrig0> adctrig0{};
            constexpr Register::FieldValue<decltype(start),StartVal::adctrig1> adctrig1{};
            constexpr Register::FieldValue<decltype(start),StartVal::mcoa2> mcoa2{};
        }
