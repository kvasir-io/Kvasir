...
//Product name title=UM10430 Chapter title=LPC18xx SSP0/1 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace Nonecr0{    ///<Control Register 0. Selects the serial clock rate, bus type, and data size.
        using Addr = Register::Address<0x40083000,0xffff0000,0,unsigned>;
        ...
        namespace FrfValC{
            ...
            constexpr Register::FieldValue<decltype(frf),FrfVal::thisCombinationIs> thisCombinationIs{};
        }
        ...
        namespace CpolValC{
            constexpr Register::FieldValue<decltype(cpol),CpolVal::busLow> busLow{};
            constexpr Register::FieldValue<decltype(cpol),CpolVal::busHigh> busHigh{};
        }
    ...
    namespace Nonecr1{    ///<Control Register 1. Selects master/slave and other modes.
        using Addr = Register::Address<0x40083004,0xfffffff0,0,unsigned>;
        ///Loop Back Mode.
        enum class LbmVal {
        ...
        namespace LbmValC{
            constexpr Register::FieldValue<decltype(lbm),LbmVal::normal> normal{};
            constexpr Register::FieldValue<decltype(lbm),LbmVal::ouptu> ouptu{};
        }
        ///SSP Enable.
        enum class SseVal {
        ...
        namespace SseValC{
            constexpr Register::FieldValue<decltype(sse),SseVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(sse),SseVal::enabled> enabled{};
        }
        ...
        namespace MsValC{
            constexpr Register::FieldValue<decltype(ms),MsVal::master> master{};
            constexpr Register::FieldValue<decltype(ms),MsVal::slave> slave{};
        }
    ...
    namespace Nonedr{    ///<Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO.
        using Addr = Register::Address<0x40083008,0xffff0000,0,unsigned>;
    ...
    namespace Nonesr{    ///<Status Register
        using Addr = Register::Address<0x4008300c,0xffffffe0,0,unsigned>;
    ...
    namespace Nonecpsr{    ///<Clock Prescale Register
        using Addr = Register::Address<0x40083010,0xffffff00,0,unsigned>;
    ...
    namespace Noneimsc{    ///<Interrupt Mask Set and Clear Register
        using Addr = Register::Address<0x40083014,0xfffffff0,0,unsigned>;
    ...
    namespace Noneris{    ///<Raw Interrupt Status Register
        using Addr = Register::Address<0x40083018,0xfffffff0,0,unsigned>;
    ...
    namespace Nonemis{    ///<Masked Interrupt Status Register
        using Addr = Register::Address<0x4008301c,0xfffffff0,0,unsigned>;
    ...
    namespace Noneicr{    ///<SSPICR Interrupt Clear Register
        using Addr = Register::Address<0x40083020,0xfffffffc,0,unsigned>;
    ...
    namespace Nonedmacr{    ///<SSP0 DMA control register
        using Addr = Register::Address<0x40083024,0xfffffffc,0,unsigned>;
