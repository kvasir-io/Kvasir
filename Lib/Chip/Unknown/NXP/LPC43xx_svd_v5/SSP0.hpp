...
//Product name title=UM10430 Chapter title=LPC18xx SSP0/1 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace Ssp0Cr0{    ///<Control Register 0. Selects the serial clock rate, bus type, and data size.
        using Addr = Register::Address<0x40083000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Cr1{    ///<Control Register 1. Selects master/slave and other modes.
        using Addr = Register::Address<0x40083004,0x00000000,0x00000000,unsigned>;
        ///Loop Back Mode.
        enum class LbmVal {
    ...
    namespace Ssp0Dr{    ///<Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO.
        using Addr = Register::Address<0x40083008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Sr{    ///<Status Register
        using Addr = Register::Address<0x4008300c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Cpsr{    ///<Clock Prescale Register
        using Addr = Register::Address<0x40083010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Imsc{    ///<Interrupt Mask Set and Clear Register
        using Addr = Register::Address<0x40083014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Ris{    ///<Raw Interrupt Status Register
        using Addr = Register::Address<0x40083018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Mis{    ///<Masked Interrupt Status Register
        using Addr = Register::Address<0x4008301c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Icr{    ///<SSPICR Interrupt Clear Register
        using Addr = Register::Address<0x40083020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp0Dmacr{    ///<SSP0 DMA control register
        using Addr = Register::Address<0x40083024,0x00000000,0x00000000,unsigned>;
