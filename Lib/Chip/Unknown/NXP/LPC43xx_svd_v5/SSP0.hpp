...
namespace Kvasir {
    namespace Nonecr0{
        using Addr = Register::Address<0x40083000,0xffff0000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CPOL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> CPHA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> SCR; 
    }
    namespace Nonecr1{
        using Addr = Register::Address<0x40083004,0xfffffff0>;
    ...
    namespace Nonedr{
        using Addr = Register::Address<0x40083008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DATA; 
    }
    namespace Nonesr{
        using Addr = Register::Address<0x4008300c,0xffffffe0>;
    ...
    namespace Nonecpsr{
        using Addr = Register::Address<0x40083010,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> CPSDVSR; 
    }
    namespace Noneimsc{
        using Addr = Register::Address<0x40083014,0xfffffff0>;
    ...
    namespace Noneris{
        using Addr = Register::Address<0x40083018,0xfffffff0>;
    ...
    namespace Nonemis{
        using Addr = Register::Address<0x4008301c,0xfffffff0>;
    ...
    namespace Noneicr{
        using Addr = Register::Address<0x40083020,0xfffffffc>;
    ...
    namespace Nonedmacr{
        using Addr = Register::Address<0x40083024,0xfffffffc>;
