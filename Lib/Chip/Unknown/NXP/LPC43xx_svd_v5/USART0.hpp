...
//Product name title=UM10430 Chapter title=LPC18xx USART0_2_3 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    ...
    namespace Noneiir{    ///<Interrupt ID Register. Identifies which interrupt(s) are pending.
        ...
        namespace IntidValC{
            constexpr Register::FieldValue<decltype(intid),IntidVal::priority1Highest> priority1Highest{};
            constexpr Register::FieldValue<decltype(intid),IntidVal::priority2Receive> priority2Receive{};
            constexpr Register::FieldValue<decltype(intid),IntidVal::priority2Charact> priority2Charact{};
            constexpr Register::FieldValue<decltype(intid),IntidVal::priority3ThreIn> priority3ThreIn{};
            constexpr Register::FieldValue<decltype(intid),IntidVal::priority4Lowest> priority4Lowest{};
        }
        ///Copies of FCR bit  0.
    ...
    namespace Nonefcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        ...
        namespace FifoenValC{
            constexpr Register::FieldValue<decltype(fifoen),FifoenVal::uartFifosAreDisab> uartFifosAreDisab{};
    ...
    namespace Nonelsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
        ...
        namespace RxfeValC{
            constexpr Register::FieldValue<decltype(rxfe),RxfeVal::rbrContainsNoUart> rbrContainsNoUart{};
            constexpr Register::FieldValue<decltype(rxfe),RxfeVal::uartRbrContainsAt> uartRbrContainsAt{};
        }
        ...
        namespace TxerrValC{
            constexpr Register::FieldValue<decltype(txerr),TxerrVal::noErrorNormalDef> noErrorNormalDef{};
            constexpr Register::FieldValue<decltype(txerr),TxerrVal::aNackResponseIsR> aNackResponseIsR{};
        }
    }
    ...
    namespace Noneicr{    ///<IrDA control register (UART3 only)
        ...
        namespace IrdaenValC{
            constexpr Register::FieldValue<decltype(irdaen),IrdaenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(irdaen),IrdaenVal::enabled> enabled{};
        }
    ...
    namespace Nonesyncctrl{    ///<Synchronous mode control register.
        ...
        namespace TsbypassValC{
            constexpr Register::FieldValue<decltype(tsbypass),TsbypassVal::enum_> enum_{};
            constexpr Register::FieldValue<decltype(tsbypass),TsbypassVal::enum_> enum_{};
        }
        ...
        namespace SssdisValC{
            ...
            constexpr Register::FieldValue<decltype(sssdis),SssdisVal::doNotSendStartst> doNotSendStartst{};
        }
