...
//Product name title=UM10430 Chapter title=LPC18xx USB0 Host/Device/OTG controller Modification date=1/19/2011 Major revision=0 Minor revision=7 
    ...
    namespace NoneusbcmdD{    ///<USB command (device mode)
        ...
        namespace RsValC{
            ...
            constexpr Register::FieldValue<decltype(rs),RsVal::attach> attach{};
        }
    ...
    namespace NoneusbcmdH{    ///<USB command (host mode)
        ...
        namespace IaaValC{
            constexpr Register::FieldValue<decltype(iaa),IaaVal::theHostController> theHostController{};
            constexpr Register::FieldValue<decltype(iaa),IaaVal::softwareMustWrite> softwareMustWrite{};
        }
    ...
    namespace NoneusbstsD{    ///<USB status (device mode)
        ...
        namespace NakiValC{
            constexpr Register::FieldValue<decltype(naki),NakiVal::st> st{};
            constexpr Register::FieldValue<decltype(naki),NakiVal::clear> clear{};
        }
    }
    namespace NoneusbstsH{    ///<USB status (host mode)
        ...
        namespace HchValC{
            ...
            constexpr Register::FieldValue<decltype(hch),HchVal::halt> halt{};
        }
        ///Reclamation
        enum class RclVal {
    ...
    namespace Nonedeviceaddr{    ///<USB device address (device mode)
        ...
        namespace UsbadraValC{
            constexpr Register::FieldValue<decltype(usbadra),UsbadraVal::instantaneous> instantaneous{};
            constexpr Register::FieldValue<decltype(usbadra),UsbadraVal::delayed> delayed{};
        }
        ///USB device address
    ...
    namespace Noneportsc1D{    ///<Port 1 status/control (device mode)
        ...
        namespace HspValC{
            constexpr Register::FieldValue<decltype(hsp),HspVal::notHighsspeed> notHighsspeed{};
        ...
        namespace PhcdValC{
            constexpr Register::FieldValue<decltype(phcd),PhcdVal::enable> enable{};
            constexpr Register::FieldValue<decltype(phcd),PhcdVal::disable> disable{};
        }
    ...
    namespace Noneportsc1H{    ///<Port 1 status/control (host mode)
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,Pic10Val> pic10{}; 
        namespace Pic10ValC{
            constexpr Register::FieldValue<decltype(pic10),Pic10Val::portIndicatorsAre> portIndicatorsAre{};
            constexpr Register::FieldValue<decltype(pic10),Pic10Val::amber> amber{};
            constexpr Register::FieldValue<decltype(pic10),Pic10Val::green> green{};
            constexpr Register::FieldValue<decltype(pic10),Pic10Val::undefined> undefined{};
        }
        ...
        namespace WkcnValC{
            ...
            constexpr Register::FieldValue<decltype(wkcn),WkcnVal::writingThisBitTo> writingThisBitTo{};
        }
        ...
        namespace WkdcValC{
            ...
            constexpr Register::FieldValue<decltype(wkdc),WkdcVal::writingThisBitTo> writingThisBitTo{};
        }
        ...
        namespace WkocValC{
            constexpr Register::FieldValue<decltype(wkoc),WkocVal::disablesThePortTo> disablesThePortTo{};
            constexpr Register::FieldValue<decltype(wkoc),WkocVal::writingAOneToThi> writingAOneToThi{};
        }
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,PhcdVal> phcd{}; 
        namespace PhcdValC{
            constexpr Register::FieldValue<decltype(phcd),PhcdVal::writingA0Enables> writingA0Enables{};
            constexpr Register::FieldValue<decltype(phcd),PhcdVal::writingA1Disables> writingA1Disables{};
        }
        ///Port force full speed connect
        enum class PfscVal {
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,PfscVal> pfsc{}; 
        namespace PfscValC{
            constexpr Register::FieldValue<decltype(pfsc),PfscVal::portConnectsAtAny> portConnectsAtAny{};
            constexpr Register::FieldValue<decltype(pfsc),PfscVal::writingThisBitTo> writingThisBitTo{};
        }
    ...
    namespace Noneotgsc{    ///<OTG status and control
        ...
        namespace HaarValC{
            constexpr Register::FieldValue<decltype(haar),HaarVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(haar),HaarVal::enableAutomaticRes> enableAutomaticRes{};
        }
        ...
        namespace IdpuValC{
            constexpr Register::FieldValue<decltype(idpu),IdpuVal::pullUpOffTheId> pullUpOffTheId{};
            constexpr Register::FieldValue<decltype(idpu),IdpuVal::pullUpOn> pullUpOn{};
        }
        ...
        namespace HabaValC{
            constexpr Register::FieldValue<decltype(haba),HabaVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(haba),HabaVal::enableAutomaticBD> enableAutomaticBD{};
        }
        ///USB ID
        enum class IdVal {
        ...
        namespace IdValC{
            constexpr Register::FieldValue<decltype(id),IdVal::aDevice> aDevice{};
            constexpr Register::FieldValue<decltype(id),IdVal::bDevice> bDevice{};
        }
    ...
    namespace NoneusbmodeH{    ///<USB mode (host mode)
        ...
        namespace CmValC{
            constexpr Register::FieldValue<decltype(cm),CmVal::idle> idle{};
            constexpr Register::FieldValue<decltype(cm),CmVal::deviceController> deviceController{};
            constexpr Register::FieldValue<decltype(cm),CmVal::hostController> hostController{};
        }
    ...
    namespace Noneendptctrl1{    ///<Endpoint control 
        ...
        namespace Txt10ValC{
            constexpr Register::FieldValue<decltype(txt10),Txt10Val::control> control{};
            constexpr Register::FieldValue<decltype(txt10),Txt10Val::isochronous> isochronous{};
            constexpr Register::FieldValue<decltype(txt10),Txt10Val::bulk> bulk{};
            constexpr Register::FieldValue<decltype(txt10),Txt10Val::interrupt> interrupt{};
        }
