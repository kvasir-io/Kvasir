...
//Product name title=Falcon Chapter title=Global Input Multiplexer Array (GIMA) Modification date=3/25/2011 Major revision=0 Minor revision=4 
    namespace Nonecap00In{    ///<Timer 0 CAP0_0  capture input multiplexer
        ...
        namespace InvValC{
            constexpr Register::FieldValue<decltype(inv),InvVal::noinvert> noinvert{};
            constexpr Register::FieldValue<decltype(inv),InvVal::invert> invert{};
        }
        ...
        namespace EdgeValC{
            constexpr Register::FieldValue<decltype(edge),EdgeVal::noedge> noedge{};
            constexpr Register::FieldValue<decltype(edge),EdgeVal::risingedge> risingedge{};
        }
        ...
        namespace SynchValC{
            constexpr Register::FieldValue<decltype(synch),SynchVal::disable> disable{};
            constexpr Register::FieldValue<decltype(synch),SynchVal::enable> enable{};
        }
        ...
        namespace PulseValC{
            constexpr Register::FieldValue<decltype(pulse),PulseVal::disable> disable{};
            constexpr Register::FieldValue<decltype(pulse),PulseVal::enable> enable{};
        }
