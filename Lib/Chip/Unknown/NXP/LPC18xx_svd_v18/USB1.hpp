...
//Product name title=UM10430 Chapter title=LPC18xx USB1 Host/Device controller Modification date=1/19/2011 Major revision=0 Minor revision=7 
    namespace Usb1Caplength{    ///<Capability register length
        using Addr = Register::Address<0x40007100,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Hcsparams{    ///<Host controller structural parameters
        using Addr = Register::Address<0x40007104,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Hccparams{    ///<Host controller capability parameters
        using Addr = Register::Address<0x40007108,0x00000008,0x00000000,unsigned>;
    ...
    namespace Usb1Dciversion{    ///<Device interface version number
        using Addr = Register::Address<0x40007120,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1UsbcmdD{    ///<USB command (device mode)
        using Addr = Register::Address<0x40007140,0x00000000,0x00000000,unsigned>;
        ///Run/Stop
        enum class RsVal {
    ...
    namespace Usb1UsbcmdH{    ///<USB command (host mode)
        using Addr = Register::Address<0x40007140,0x00000000,0x00000000,unsigned>;
        ///Run/Stop
        enum class RsVal {
    ...
    namespace Usb1UsbstsD{    ///<USB status (device mode)
        using Addr = Register::Address<0x40007144,0x00000000,0x00000000,unsigned>;
        ///USB interrupt
        enum class UiVal {
    ...
    namespace Usb1UsbstsH{    ///<USB status (host mode)
        using Addr = Register::Address<0x40007144,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1UsbintrD{    ///<USB interrupt enable (device mode)
        using Addr = Register::Address<0x40007148,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1UsbintrH{    ///<USB interrupt enable (host mode)
        using Addr = Register::Address<0x40007148,0x00000000,0x00000000,unsigned>;
        ///USB interrupt enable When this bit is one, and the USBINT bit in the USBSTS register is one, the host/device controller will issue an interrupt at the next interrupt threshold. The interrupt is acknowledged by software clearing the USBINT bit in USBSTS.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> ue{}; 
        ///USB error interrupt enable When this bit is a one, and the USBERRINT bit in the USBSTS register is a one, the host/device controller will issue an interrupt at the next interrupt threshold. The interrupt is acknowledged by software clearing the USBERRINT bit in the USBSTS register.
    ...
    namespace Usb1FrindexD{    ///<USB frame index (device mode)
        using Addr = Register::Address<0x4000714c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1FrindexH{    ///<USB frame index (host mode)
        using Addr = Register::Address<0x4000714c,0x00000000,0x00000000,unsigned>;
        ///Current micro frame number
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,unsigned> frindex20{}; 
    ...
    namespace Usb1Deviceaddr{    ///<USB device address
        using Addr = Register::Address<0x40007154,0x00000000,0x00000000,unsigned>;
        ///reserved
    ...
    namespace Usb1Periodiclistbase{    ///<Frame list base address
        using Addr = Register::Address<0x40007154,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace Usb1Endpointlistaddr{    ///<Address of endpoint list in memory (device mode)
        using Addr = Register::Address<0x40007158,0x00000000,0x00000000,unsigned>;
        ///reserved
    ...
    namespace Usb1Asynclistaddr{    ///<Address of endpoint list in memory (host mode)
        using Addr = Register::Address<0x40007158,0x00000000,0x00000000,unsigned>;
        ///Reserved
    ...
    namespace Usb1Ttctrl{    ///<Asynchronous buffer status for embedded TT (host mode)
        using Addr = Register::Address<0x4000715c,0x00000000,0x00000000,unsigned>;
        ///Reserved.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,0),Register::ReadWriteAccess,unsigned> reserved{}; 
    ...
    namespace Usb1Burstsize{    ///<Programmable burst size
        using Addr = Register::Address<0x40007160,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Txfilltuning{    ///<Host transmit pre-buffer packet tuning (host mode)
        using Addr = Register::Address<0x40007164,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Ulpiviewport{    ///<ULPI viewport
        using Addr = Register::Address<0x40007170,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Binterval{    ///<Length of virtual frame
        using Addr = Register::Address<0x40007174,0x00000000,0x00000000,unsigned>;
        ///bInterval value
    ...
    namespace Usb1Endptnak{    ///<Endpoint NAK (device mode)
        using Addr = Register::Address<0x40007178,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptnaken{    ///<Endpoint NAK Enable (device mode)
        using Addr = Register::Address<0x4000717c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Portsc1D{    ///<Port 1 status/control (device mode)
        using Addr = Register::Address<0x40007184,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Portsc1H{    ///<Port 1 status/control (host mode)
        using Addr = Register::Address<0x40007184,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1UsbmodeD{    ///<USB mode (device mode)
        using Addr = Register::Address<0x400071a8,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1UsbmodeH{    ///<USB mode (host mode)
        using Addr = Register::Address<0x400071a8,0x00000000,0x00000000,unsigned>;
        ///Controller mode The controller defaults to an idle state and needs to be initialized to the desired operating mode after reset. This register can only be written once after reset. If it is necessary to switch modes, software must reset the controller by writing to the RESET bit in the USBCMD register before reprogramming this register.
        enum class Cm10Val {
            idle=0x00000000,     ///<Idle
    ...
    namespace Usb1Endptsetupstat{    ///<Endpoint setup status
        using Addr = Register::Address<0x400071ac,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptprime{    ///<Endpoint initialization
        using Addr = Register::Address<0x400071b0,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptflush{    ///<Endpoint de-initialization
        using Addr = Register::Address<0x400071b4,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptstat{    ///<Endpoint status
        using Addr = Register::Address<0x400071b8,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptcomplete{    ///<Endpoint complete
        using Addr = Register::Address<0x400071bc,0x00000000,0x00000000,unsigned>;
    ...
    namespace Usb1Endptctrl0{    ///<Endpoint control 0
        using Addr = Register::Address<0x400071c0,0x00000000,0x00000000,unsigned>;
        ///Rx endpoint stall
        enum class RxsVal {
    ...
    namespace Usb1Endptctrl1{    ///<Endpoint control 
        using Addr = Register::Address<0x400071c4,0x00000000,0x00000000,unsigned>;
        ///Rx endpoint stall
        enum class RxsVal {
    ...
    namespace Usb1Endptctrl2{    ///<Endpoint control 
        using Addr = Register::Address<0x400071c8,0x00000000,0x00000000,unsigned>;
        ///Rx endpoint stall
        enum class RxsVal {
            endpointOkThisBi=0x00000000,     ///<Endpoint ok. This bit will be cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control Endpoint and this bit will continue to be cleared by hardware until the associated ENDPTSETUPSTAT bit is cleared.
            endpointStalledSof=0x00000001,     ///<Endpoint stalled Software can write a one to this bit to force the endpoint to return a STALL handshake to the Host. It will continue returning STALL until the bit is cleared by software, or it will automatically be cleared upon receipt of a new SETUP request.[1]
    ...
    namespace Usb1Endptctrl3{    ///<Endpoint control 
        using Addr = Register::Address<0x400071cc,0x00000000,0x00000000,unsigned>;
        ///Rx endpoint stall
        enum class RxsVal {
            endpointOkThisBi=0x00000000,     ///<Endpoint ok. This bit will be cleared automatically upon receipt of a SETUP request if this Endpoint is configured as a Control Endpoint and this bit will continue to be cleared by hardware until the associated ENDPTSETUPSTAT bit is cleared.
            endpointStalledSof=0x00000001,     ///<Endpoint stalled Software can write a one to this bit to force the endpoint to return a STALL handshake to the Host. It will continue returning STALL until the bit is cleared by software, or it will automatically be cleared upon receipt of a new SETUP request.[1]
