...
namespace Kvasir {
//Product name title=UM10430 Chapter title=LPC18xx SSP0/1 Modification date=1/14/2011 Major revision=0 Minor revision=7 
    namespace Ssp1Cr0{    ///<Control Register 0. Selects the serial clock rate, bus type, and data size.
        using Addr = Register::Address<0x400c5000,0x00000000,0x00000000,unsigned>;
        ...
        namespace CpolValC{
            constexpr Register::FieldValue<decltype(cpol)::Type,CpolVal::busLow> busLow{};
            constexpr Register::FieldValue<decltype(cpol)::Type,CpolVal::busHigh> busHigh{};
        }
    ...
    namespace Ssp1Cr1{    ///<Control Register 1. Selects master/slave and other modes.
        using Addr = Register::Address<0x400c5004,0x00000000,0x00000000,unsigned>;
        ///Loop Back Mode.
        enum class LbmVal {
        ...
        namespace LbmValC{
            ...
            constexpr Register::FieldValue<decltype(lbm)::Type,LbmVal::ouptu> ouptu{};
        }
        ///SSP Enable.
        enum class SseVal {
    ...
    namespace Ssp1Dr{    ///<Data Register. Writes fill the transmit FIFO, and reads empty the receive FIFO.
        using Addr = Register::Address<0x400c5008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Sr{    ///<Status Register
        using Addr = Register::Address<0x400c500c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Cpsr{    ///<Clock Prescale Register
        using Addr = Register::Address<0x400c5010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Imsc{    ///<Interrupt Mask Set and Clear Register
        using Addr = Register::Address<0x400c5014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Ris{    ///<Raw Interrupt Status Register
        using Addr = Register::Address<0x400c5018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Mis{    ///<Masked Interrupt Status Register
        using Addr = Register::Address<0x400c501c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Icr{    ///<SSPICR Interrupt Clear Register
        using Addr = Register::Address<0x400c5020,0x00000000,0x00000000,unsigned>;
    ...
    namespace Ssp1Dmacr{    ///<SSP0 DMA control register
        using Addr = Register::Address<0x400c5024,0x00000000,0x00000000,unsigned>;
