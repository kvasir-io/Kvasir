...
namespace Kvasir {
    namespace Noneirctrm{
        using Addr = Register::Address<0x40043000,0xfffff000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> TRM; 
    }
    namespace Nonecreg0{
    ...
    namespace Nonepmucon{
        using Addr = Register::Address<0x40043008,0xffff7e00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0)> PWRCTRL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> DYNAMICPWRCTRL; 
    }
    namespace Nonem3memmap{
        using Addr = Register::Address<0x40043100,0x00000fff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,12)> M3MAP; 
    }
    namespace Nonecreg5{
        using Addr = Register::Address<0x40043118,0xffffffbf>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> M3TAPSEL; 
    }
