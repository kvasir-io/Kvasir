...
//Product name title=UM10430 Chapter title=LPC18xx Motor Control PWM (MOTOCONPWM) Modification date=1/14/2011 Major revision=0 Minor revision=7 
    ...
    namespace Nonecapcon{    ///<Capture Control read address
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> hnfcap0{}; 
        ///Hardware noise filter: if this bit is 1, channel 1 capture events are delayed as described in Section 24.8.4.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> hnfcap1{}; 
        ///Hardware noise filter: if this bit is 1, channel 2 capture events are delayed as described in Section 24.8.4.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> hnfcap2{}; 
    }
    namespace NonecapconSet{    ///<Capture Control set address
        ...
        ///Writing a one sets the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> hnfcap0Set{}; 
        ///Writing a one sets the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> hnfcap1Set{}; 
        ///Writing a one sets the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> hnfcap2Set{}; 
    }
    namespace NonecapconClr{    ///<Event Control clear address
        ...
        ///Writing a one clears the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> hnfcap0Clr{}; 
        ///Writing a one clears the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> hnfcap1Clr{}; 
        ///Writing a one clears the corresponding bits in the CAPCON register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> hnfcap2Clr{}; 
    }
    ...
    namespace Nonecntcon{    ///<Count Control read address
        ...
        namespace tc0mci0ReValC{
            ...
            constexpr MPL::Value<tc0mci0ReVal,tc0mci0ReVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc0mci0FeValC{
            ...
            constexpr MPL::Value<tc0mci0FeVal,tc0mci0FeVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc0mci1ReValC{
            ...
            constexpr MPL::Value<tc0mci1ReVal,tc0mci1ReVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc0mci1FeValC{
            ...
            constexpr MPL::Value<tc0mci1FeVal,tc0mci1FeVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc0mci2ReValC{
            ...
            constexpr MPL::Value<tc0mci2ReVal,tc0mci2ReVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc0mci2FeValC{
            ...
            constexpr MPL::Value<tc0mci2FeVal,tc0mci2FeVal::ifMode0Is1Count> ifMode0Is1Count{};
        }
        ...
        namespace tc1mci0ReValC{
            ...
            constexpr MPL::Value<tc1mci0ReVal,tc1mci0ReVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc1mci0FeValC{
            ...
            constexpr MPL::Value<tc1mci0FeVal,tc1mci0FeVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc1mci1ReValC{
            ...
            constexpr MPL::Value<tc1mci1ReVal,tc1mci1ReVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc1mci1FeValC{
            ...
            constexpr MPL::Value<tc1mci1FeVal,tc1mci1FeVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc1mci2ReValC{
            ...
            constexpr MPL::Value<tc1mci2ReVal,tc1mci2ReVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc1mci2FeValC{
            ...
            constexpr MPL::Value<tc1mci2FeVal,tc1mci2FeVal::ifMode1Is1Count> ifMode1Is1Count{};
        }
        ...
        namespace tc2mci0ReValC{
            ...
            constexpr MPL::Value<tc2mci0ReVal,tc2mci0ReVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
        ...
        namespace tc2mci0FeValC{
            ...
            constexpr MPL::Value<tc2mci0FeVal,tc2mci0FeVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
        ...
        namespace tc2mci1ReValC{
            ...
            constexpr MPL::Value<tc2mci1ReVal,tc2mci1ReVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
        ...
        namespace tc2mci1FeValC{
            ...
            constexpr MPL::Value<tc2mci1FeVal,tc2mci1FeVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
        ...
        namespace tc2mci2ReValC{
            ...
            constexpr MPL::Value<tc2mci2ReVal,tc2mci2ReVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
        ...
        namespace tc2mci2FeValC{
            ...
            constexpr MPL::Value<tc2mci2FeVal,tc2mci2FeVal::ifMode2Is1Count> ifMode2Is1Count{};
        }
