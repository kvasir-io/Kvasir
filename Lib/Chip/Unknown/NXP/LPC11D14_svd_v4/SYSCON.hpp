...
//System configuration
    ...
    namespace Nonepresetctrl{    ///<Peripheral reset control
        ...
        namespace ssp1RstNValC{
            constexpr MPL::Value<ssp1RstNVal,ssp1RstNVal::resetsTheSpi1Peri> resetsTheSpi1Peri{};
            constexpr MPL::Value<ssp1RstNVal,ssp1RstNVal::spi1ResetDeAssert> spi1ResetDeAssert{};
        }
        ...
        namespace canRstNValC{
            constexpr MPL::Value<canRstNVal,canRstNVal::resetsTheCCanPer> resetsTheCCanPer{};
            constexpr MPL::Value<canRstNVal,canRstNVal::cCanResetDeAsser> cCanResetDeAsser{};
        }
    ...
    namespace Nonepioporcap0{    ///<POR captured PIO status 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> cappio29{}; 
        ///Raw reset status input PIO2_n: PIO2_7 to PIO2_0
