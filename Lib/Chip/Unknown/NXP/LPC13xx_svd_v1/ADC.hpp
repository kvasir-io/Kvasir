...
Converter (ADC) Modification date=4/19/2011 Major revision=2 Minor revision=1 
    namespace Nonecr{    ///<A/D Control Register. The AD0CR register must be written to select the operating mode before A/D conversion can occur.
        ...
        namespace StartValC{
            ...
            constexpr Register::FieldValue<decltype(start),StartVal::now> now{};
            ...
            constexpr Register::FieldValue<decltype(start),StartVal::edgect32b0Mat0> edgect32b0Mat0{};
            constexpr Register::FieldValue<decltype(start),StartVal::edgect32b1Mat0> edgect32b1Mat0{};
            constexpr Register::FieldValue<decltype(start),StartVal::edgect16b0Mat0> edgect16b0Mat0{};
            constexpr Register::FieldValue<decltype(start),StartVal::edgect16b0Mat0> edgect16b0Mat0{};
        }
