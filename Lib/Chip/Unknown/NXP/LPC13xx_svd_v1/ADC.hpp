...
namespace Kvasir {
//Product name title=UM10375 Chapter title=LPC13xx Analog-to-DigitalConverter (ADC) Modification date=4/19/2011 Major revision=2 Minor revision=1 
    namespace AdcCr{    ///<A/D Control Register. The AD0CR register must be written to select the operating mode before A/D conversion can occur.
