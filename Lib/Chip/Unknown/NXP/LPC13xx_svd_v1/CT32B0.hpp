...
namespace Kvasir {
    namespace Nonebir{
        using Addr = Register::Address<0x40014000,0xffffffe0>;
    ...
    namespace Nonebtcr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> CRES; 
    }
    namespace Nonebtc{
    ...
    namespace Nonebccr{
        using Addr = Register::Address<0x40014028,0xfffffff8>;
