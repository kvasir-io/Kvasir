...
//Product name title=UM10375 Chapter title=LPC13xx GeneralPurpose I/O (GPIO) Modification date=4/20/2011 Major revision=2 Minor revision=1 
    namespace Gpio3Data{    ///<Port n data register for pins PIOn_0 to PIOn_11
        using Addr = Register::Address<0x50033ffc,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Dir{    ///<Data direction register for port n
        using Addr = Register::Address<0x50038000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Is{    ///<Interrupt sense register for port n
        using Addr = Register::Address<0x50038004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Ibe{    ///<Interrupt both edges register for port n
        using Addr = Register::Address<0x50038008,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Iev{    ///<Interrupt event register for port n
        using Addr = Register::Address<0x5003800c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Ie{    ///<Interrupt mask register for port n
        using Addr = Register::Address<0x50038010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Ris{    ///<Raw interrupt status register for port n
        using Addr = Register::Address<0x50038014,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Mis{    ///<Masked interrupt status register for port n
        using Addr = Register::Address<0x50038018,0x00000000,0x00000000,unsigned>;
    ...
    namespace Gpio3Ic{    ///<Interrupt clear register for port n
        using Addr = Register::Address<0x5003801c,0x00000000,0x00000000,unsigned>;
