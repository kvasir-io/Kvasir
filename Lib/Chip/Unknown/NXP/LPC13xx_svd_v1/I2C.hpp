...
//Product name title=UM10375 Chapter title=LPC13xx I2C-bus controller Modification date=4/19/2011 Major revision=2 Minor revision=1 
    ...
    namespace I2cMmctrl{    ///<Monitor mode control register.
        ...
        namespace MmenaValC{
            constexpr Register::FieldValue<decltype(mmEna)::Type,MmenaVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(mmEna)::Type,MmenaVal::enabled> enabled{};
        }
        ///SCL output enable.
        ...
        namespace MatchallValC{
            ...
            constexpr Register::FieldValue<decltype(matchAll)::Type,MatchallVal::anyint> anyint{};
        }
    ...
    namespace I2cAdr1{    ///<I2CSlave Address Register 1. Contains the 7-bit slave addressfor operation of the I2C interface inslave mode, and is not used in master mode. The least significantbit determines whether a slave responds to the General Call address.
    ...
    namespace I2cAdr2{    ///<I2CSlave Address Register 1. Contains the 7-bit slave addressfor operation of the I2C interface inslave mode, and is not used in master mode. The least significantbit determines whether a slave responds to the General Call address.
    ...
    namespace I2cAdr3{    ///<I2CSlave Address Register 1. Contains the 7-bit slave addressfor operation of the I2C interface inslave mode, and is not used in master mode. The least significantbit determines whether a slave responds to the General Call address.
    ...
    namespace I2cMask0{    ///<I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace I2cMask1{    ///<I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace I2cMask2{    ///<I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
    ...
    namespace I2cMask3{    ///<I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
