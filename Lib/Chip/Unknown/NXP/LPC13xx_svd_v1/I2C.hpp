...
//Product name title=UM10375 Chapter title=LPC13xx I2C-bus controller Modification date=4/19/2011 Major revision=2 Minor revision=1 
    ...
    namespace Nonemmctrl{    ///<Monitor mode control register.
        ...
        namespace MmenaValC{
            constexpr Register::FieldValue<decltype(mmEna),MmenaVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(mmEna),MmenaVal::enabled> enabled{};
        }
        ///SCL output enable.
        ...
        namespace MatchallValC{
            ...
            constexpr Register::FieldValue<decltype(matchAll),MatchallVal::anyint> anyint{};
        }
    }
