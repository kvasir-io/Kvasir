...
namespace Kvasir {
    namespace Nonecontrol{
        using Addr = Register::Address<0x4000a000,0x10000000>;
    ...
    namespace Noneconfig{
        using Addr = Register::Address<0x4000a010,0x400c00c0>;
    ...
    namespace Nonetimerrl{
        using Addr = Register::Address<0x4000a060,0x00000000>;
    ...
    namespace Nonesconfig{
        using Addr = Register::Address<0x4000a070,0xfff00000>;
