...
namespace Kvasir {
//None
    namespace Cmp1Control{    ///<Module Control
        using Addr = Register::Address<0x40020000,0x3fff9fff,0x00000000,unsigned>;
    ...
    namespace Cmp1Mode{    ///<Input and Module Mode
        using Addr = Register::Address<0x40020010,0xb0009000,0x00000000,unsigned>;
        ///Negative Input Select. 
        enum class NmuxVal {
            cmpnn0=0x00000000,     ///<Select CMPnN.0 (P2.12).
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (PB2.14).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (PB3.1).
            cmpnn3=0x00000003,     ///<Select CMPnN.3 (PB3.3).
            cmpnn4=0x00000004,     ///<Select CMPnN.4 (PB3.5).
            cmpnn5=0x00000005,     ///<Select CMPnN.5 (PB3.7).
            cmpnn6=0x00000006,     ///<Select CMPnN.6 (PB3.9).
            cmpnn7=0x00000007,     ///<Select CMPnN.7 (PB3.11).
        ...
        enum class PmuxVal {
            cmpnp0=0x00000000,     ///<Select CMPnP.0 (PB2.11).
            cmpnp1=0x00000001,     ///<Select CMPnP.1 (PB2.13).
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (PB3.0).
            cmpnp3=0x00000003,     ///<Select CMPnP.3 (PB3.2).
            cmpnp4=0x00000004,     ///<Select CMPnP.4 (PB3.4).
            cmpnp5=0x00000005,     ///<Select CMPnP.5 (PB3.6).
            cmpnp6=0x00000006,     ///<Select CMPnP.6 (PB3.8).
            cmpnp7=0x00000007,     ///<Select CMPnP.7 (PB3.10).
