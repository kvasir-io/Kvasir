...
namespace Kvasir {
//None
    namespace Spi2Data{    ///<Input/Output Data
        using Addr = Register::Address<0x40006000,0x00000000,0x00000000,unsigned>;
        ///Input/Output Data. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Spi2Control{    ///<Module Control
        using Addr = Register::Address<0x40006010,0xfe003c00,0x00000000,unsigned>;
    ...
    namespace Spi2Config{    ///<Module Configuration
        using Addr = Register::Address<0x40006020,0x1e000000,0x00000000,unsigned>;
    ...
    namespace Spi2Clkrate{    ///<Module Clock Rate Control
        using Addr = Register::Address<0x40006030,0xffff0000,0x00000000,unsigned>;
        ///Clock Divider. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> clkdiv{}; 
    }
    namespace Spi2Fstatus{    ///<FIFO Status
        using Addr = Register::Address<0x40006040,0xffff0000,0x00000000,unsigned>;
