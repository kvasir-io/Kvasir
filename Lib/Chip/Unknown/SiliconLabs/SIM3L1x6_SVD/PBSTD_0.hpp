...
namespace Kvasir {
    ...
    namespace Nonepbpgen{
        using Addr = Register::Address<0x4002a120,0xfffff000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> PBPGEN; 
    }
    namespace Nonepbpgphase{
        using Addr = Register::Address<0x4002a130,0xf000f000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> PBPGPH0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16)> PBPGPH1; 
    }
}
