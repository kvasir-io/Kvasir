...
namespace Kvasir {
    namespace Nonecontrol{
        using Addr = Register::Address<0x4004c000,0x00700000>;
    ...
    namespace Nonetimeout{
        using Addr = Register::Address<0x4004c010,0x00000000>;
    ...
    namespace Nonestateaddr{
        using Addr = Register::Address<0x4004c030,0x00000003>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,2)> STATEADDR; 
    }
    namespace Nonestate{
        using Addr = Register::Address<0x4004c040,0x00000000>;
