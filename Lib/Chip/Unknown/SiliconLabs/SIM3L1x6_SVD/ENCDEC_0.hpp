...
//None
    namespace Nonecontrol{    ///<Module Control
        ...
        ///Operation Mode. 
        enum class opmdVal {
            manchester=0x00000000,     ///<The operation selected by EDMD uses Manchester mode.
            v3outof6=0x00000001,     ///<The operation selected by EDMD uses Three-out-of-Six mode.
        };
        namespace opmdValC{
        ...
        ///Debug Mode. 
        enum class dbgmdVal {
            run=0x00000000,     ///<The ENCDEC module will continue to operate while the core is halted in debug mode.
            halt=0x00000001,     ///<A debug breakpoint will cause the ENCDEC module to halt.
        };
        namespace dbgmdValC{
    ...
    namespace Nonedataoutc{    ///<Data Output Complement
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> dataoutc{}; 
    }
}
