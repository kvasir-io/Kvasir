...
namespace Kvasir {
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x40005010,0xfe003c00>;
    ...
    namespace Noneconfig{
        using Addr = Register::Address<0x40005020,0x1e000000>;
    ...
    namespace Noneclkrate{
        using Addr = Register::Address<0x40005030,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CLKDIV; 
    }
    namespace Nonefstatus{
        using Addr = Register::Address<0x40005040,0xffff0000>;
    ...
    namespace Noneconfigmd{
        using Addr = Register::Address<0x40005050,0xf8000080>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> OPMD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> AUTONSS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> CTSEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> FLOWMD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> ABORT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> TXONREQ; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,8)> NSSCNT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> NSSDELAY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,24)> TFRCNT; 
    }
}
