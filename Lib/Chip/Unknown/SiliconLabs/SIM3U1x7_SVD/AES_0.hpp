...
namespace Kvasir {
    ...
    namespace Nonestatus{
        using Addr = Register::Address<0x40027100,0x3ffef888>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DURF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> DORF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> XORF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4)> DFIFOLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,8)> XFIFOLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> BUSYF; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> ERRI; 
