...
namespace Kvasir {
    namespace Noneconfig{
        using Addr = Register::Address<0x40003000,0x88808880>;
    ...
    namespace Nonemode{
        using Addr = Register::Address<0x40003010,0xb7f2ffff>;
    ...
    namespace Noneflowcn{
        using Addr = Register::Address<0x40003020,0xcf5cff1c>;
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x40003030,0x27020090>;
    ...
    namespace Noneipdelay{
        using Addr = Register::Address<0x40003040,0xff00ffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,16)> IPDELAY; 
    }
    namespace Nonebaudrate{
        using Addr = Register::Address<0x40003050,0x00000000>;
    ...
    namespace Nonefifocn{
        using Addr = Register::Address<0x40003060,0xf8c8f8c8>;
    ...
    namespace Nonedata{
        using Addr = Register::Address<0x40003070,0x00000000>;
