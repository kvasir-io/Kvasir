...
namespace Kvasir {
    namespace Nonecontrol{
        using Addr = Register::Address<0x40031000,0x1f8ec000>;
    ...
    namespace Nonedata{
        using Addr = Register::Address<0x40031010,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> DATA; 
    }
    namespace Nonebufstatus{
        using Addr = Register::Address<0x40031020,0xffffff88>;
    ...
    namespace Nonebuffer10{
        using Addr = Register::Address<0x40031030,0x00000000>;
    ...
    namespace Nonebuffer32{
        using Addr = Register::Address<0x40031040,0x00000000>;
    ...
    namespace Nonegainadj{
        using Addr = Register::Address<0x40031050,0xffffffe0>;
