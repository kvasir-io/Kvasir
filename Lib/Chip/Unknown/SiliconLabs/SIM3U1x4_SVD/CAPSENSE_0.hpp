...
//None
    ...
    namespace Nonemux{    ///<Mux Channel Select
        ...
        enum class CsmxVal {
            ...
            csn1=0x00000001,     ///<Select CSn.1 (PB0.3).
            csn2=0x00000002,     ///<Select CSn.2 (PB0.4).
            csn3=0x00000003,     ///<Select CSn.3 (PB0.6).
            csn4=0x00000004,     ///<Select CSn.4 (PB0.7).
            csn5=0x00000005,     ///<Select CSn.5 (RESERVED).
            csn6=0x00000006,     ///<Select CSn.6 (RESERVED).
            csn7=0x00000007,     ///<Select CSn.7 (PB0.0).
            csn8=0x00000008,     ///<Select CSn.8 (RESERVED).
            csn9=0x00000009,     ///<Select CSn.9 (RESERVED).
            csn10=0x0000000a,     ///<Select CSn.10 (PB0.12).
            csn11=0x0000000b,     ///<Select CSn.11 (PB0.13).
            csn12=0x0000000c,     ///<Select CSn.12 (PB0.14).
            csn13=0x0000000d,     ///<Select CSn.13 (PB0.15).
            csn14=0x0000000e,     ///<Select CSn.14 (PB1.0).
            csn15=0x0000000f,     ///<Select CSn.15 (PB1.1).
        };
