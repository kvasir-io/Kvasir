...
//None
    namespace Noneconfig{    ///<Module Configuration
        ...
        namespace spselValC{
            constexpr MPL::Value<spselVal,spselVal::phase0> phase0{};
            constexpr MPL::Value<spselVal,spselVal::phase1> phase1{};
            constexpr MPL::Value<spselVal,spselVal::phase2> phase2{};
            constexpr MPL::Value<spselVal,spselVal::phase3> phase3{};
            constexpr MPL::Value<spselVal,spselVal::phase4> phase4{};
            constexpr MPL::Value<spselVal,spselVal::phase5> phase5{};
            constexpr MPL::Value<spselVal,spselVal::phase6> phase6{};
            constexpr MPL::Value<spselVal,spselVal::phase7> phase7{};
            constexpr MPL::Value<spselVal,spselVal::phase8> phase8{};
            constexpr MPL::Value<spselVal,spselVal::phase9> phase9{};
            constexpr MPL::Value<spselVal,spselVal::phase10> phase10{};
            constexpr MPL::Value<spselVal,spselVal::phase11> phase11{};
            constexpr MPL::Value<spselVal,spselVal::phase12> phase12{};
            constexpr MPL::Value<spselVal,spselVal::phase13> phase13{};
            constexpr MPL::Value<spselVal,spselVal::phase14> phase14{};
            constexpr MPL::Value<spselVal,spselVal::phase15> phase15{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,spselVal> spsel{}; 
        ...
        namespace spenValC{
            constexpr MPL::Value<spenVal,spenVal::disabled> disabled{};
            constexpr MPL::Value<spenVal,spenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,spenVal> spen{}; 
        ...
        namespace ssgenValC{
            constexpr MPL::Value<ssgenVal,ssgenVal::disabled> disabled{};
            constexpr MPL::Value<ssgenVal,ssgenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,ssgenVal> ssgen{}; 
        ///Output Packing Mode. 
        ...
        namespace simcenValC{
            constexpr MPL::Value<simcenVal,simcenVal::disabled> disabled{};
            constexpr MPL::Value<simcenVal,simcenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,simcenVal> simcen{}; 
        ...
        namespace intlvenValC{
            constexpr MPL::Value<intlvenVal,intlvenVal::disabled> disabled{};
            constexpr MPL::Value<intlvenVal,intlvenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,intlvenVal> intlven{}; 
        ///Scan Mode Enable. 
