...
namespace Kvasir {
//None
    namespace Saradc1Config{    ///<Module Configuration
        using Addr = Register::Address<0x4001b000,0x80002800,0x00000000,unsigned>;
    ...
    namespace Saradc1Control{    ///<Measurement Control
        using Addr = Register::Address<0x4001b010,0x30100000,0x00000000,unsigned>;
    ...
    namespace Saradc1Sq7654{    ///<Channel Sequencer Time Slots 4-7 Setup
        using Addr = Register::Address<0x4001b020,0x80808080,0x00000000,unsigned>;
    ...
    namespace Saradc1Sq3210{    ///<Channel Sequencer Time Slots 0-3 Setup
        using Addr = Register::Address<0x4001b030,0x80808080,0x00000000,unsigned>;
    ...
    namespace Saradc1Char32{    ///<Conversion Characteristic 2 and 3 Setup
        using Addr = Register::Address<0x4001b040,0xfe00fe00,0x00000000,unsigned>;
    ...
    namespace Saradc1Char10{    ///<Conversion Characteristic 0 and 1 Setup
        using Addr = Register::Address<0x4001b050,0xfe00fe00,0x00000000,unsigned>;
    ...
    namespace Saradc1Data{    ///<Output Data Word
        using Addr = Register::Address<0x4001b060,0x00000000,0x00000000,unsigned>;
        ///Output Data Word. 
    ...
    namespace Saradc1Wclimits{    ///<Window Comparator Limits
        using Addr = Register::Address<0x4001b070,0x00000000,0x00000000,unsigned>;
    ...
    namespace Saradc1Acc{    ///<Accumulator Initial Value
        using Addr = Register::Address<0x4001b080,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Saradc1Status{    ///<Module Status
        using Addr = Register::Address<0x4001b090,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Saradc1Fifostatus{    ///<FIFO Status
        using Addr = Register::Address<0x4001b0a0,0xffffffc0,0x00000000,unsigned>;
        ///FIFO Level. 
