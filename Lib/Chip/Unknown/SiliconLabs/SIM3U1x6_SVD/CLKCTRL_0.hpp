...
//None
    namespace Nonecontrol{    ///<Module Control
        ...
        namespace ahbselValC{
            ...
            constexpr MPL::Value<ahbselVal,ahbselVal::usb0osc> usb0osc{};
    ...
    namespace Noneahbclkg{    ///<AHB Clock Gate
        ...
        namespace usb0bcenValC{
            constexpr MPL::Value<usb0bcenVal,usb0bcenVal::disabled> disabled{};
            constexpr MPL::Value<usb0bcenVal,usb0bcenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,usb0bcenVal> usb0bcen{}; 
    }
    namespace Noneapbclkg0{    ///<APB Clock Gate 0
        ...
        namespace usb0cenValC{
            constexpr MPL::Value<usb0cenVal,usb0cenVal::disabled> disabled{};
            constexpr MPL::Value<usb0cenVal,usb0cenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,usb0cenVal> usb0cen{}; 
    ...
    namespace Nonepm3cn{    ///<Power Mode 3 Clock Control
        ...
        namespace pm3cselValC{
            ...
            constexpr MPL::Value<pm3cselVal,pm3cselVal::usb0osc> usb0osc{};
