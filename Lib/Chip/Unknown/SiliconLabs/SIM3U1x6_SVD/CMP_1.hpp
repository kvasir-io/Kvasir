...
//None
    ...
    namespace Cmp1Mode{    ///<Input and Module Mode
        ...
        enum class NmuxVal {
            cmpnn0=0x00000000,     ///<Select CMPnN.0 (PB2.2).
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (PB3.1).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (PB3.3).
            cmpnn3=0x00000003,     ///<Select CMPnN.3 (PB3.5).
            cmpnn4=0x00000004,     ///<Select CMPnN.4 (PB3.7).
            cmpnn5=0x00000005,     ///<Select CMPnN.5 (PB3.9).
        ...
        enum class PmuxVal {
            cmpnp0=0x00000000,     ///<Select CMPnP.0 (PB2.3).
            cmpnp1=0x00000001,     ///<Select CMPnP.1 (PB3.0).
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (PB3.2).
            cmpnp3=0x00000003,     ///<Select CMPnP.3 (PB3.4).
            cmpnp4=0x00000004,     ///<Select CMPnP.4 (PB3.6).
            cmpnp5=0x00000005,     ///<Select CMPnP.5 (PB3.8).
