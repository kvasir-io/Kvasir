...
namespace Kvasir {
    namespace Nonereseten{
        using Addr = Register::Address<0x4002d060,0xfffff00b>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> USB0REN; 
    ...
    namespace Noneresetflag{
        using Addr = Register::Address<0x4002d070,0xfffff000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> USB0RF; 
