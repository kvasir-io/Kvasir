...
//None
    namespace Nonedata{    ///<Input/Output Data
        using Addr = Register::Address<0x40006000,0x00000000,0,unsigned>;
        ///Input/Output Data. 
    ...
    namespace Nonecontrol{    ///<Module Control
        using Addr = Register::Address<0x40006010,0xfe003c00,0,unsigned>;
    ...
    namespace Noneconfig{    ///<Module Configuration
        using Addr = Register::Address<0x40006020,0x1e000000,0,unsigned>;
    ...
    namespace Noneclkrate{    ///<Module Clock Rate Control
        using Addr = Register::Address<0x40006030,0xffff0000,0,unsigned>;
        ///Clock Divider. 
    ...
    namespace Nonefstatus{    ///<FIFO Status
        using Addr = Register::Address<0x40006040,0xffff0000,0,unsigned>;
