...
//None
    namespace Nonecontrol{    ///<Module Control
        ...
        enum class EtrigVal {
            dacnt0=0x00000000,     ///<Select DACnT0 (PB3.0) as the IDAC external trigger source.
            dacnt1=0x00000001,     ///<Select DACnT1 (PB3.1) as the IDAC external trigger source.
            dacnt2=0x00000002,     ///<Select DACnT2 (PB3.2) as the IDAC external trigger source.
            dacnt3=0x00000003,     ///<Select DACnT3 (PB3.3) as the IDAC external trigger source.
