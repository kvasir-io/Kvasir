...
//None
    ...
    namespace Nonepboutmd{    ///<Output Mode
        using Addr = Register::Address<0x4002a360,0xffff0000,0,unsigned>;
        ///Output Mode. 
    ...
    namespace Nonepbdrv{    ///<Drive Strength
        using Addr = Register::Address<0x4002a370,0xfffe0000,0,unsigned>;
        ///Drive Strength. 
    ...
    namespace Nonepmen{    ///<Port Match Enable
        using Addr = Register::Address<0x4002a390,0xffff0000,0,unsigned>;
        ///Port Match Enable. 
    ...
    namespace Nonepblock{    ///<Lock Control
        using Addr = Register::Address<0x4002a3a0,0xffff0000,0,unsigned>;
        ///Port Bank Lock. 
