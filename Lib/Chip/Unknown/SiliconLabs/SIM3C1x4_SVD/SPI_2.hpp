...
namespace Kvasir {
    namespace Nonedata{
        using Addr = Register::Address<0x40006000,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> DATA; 
    }
    namespace Nonecontrol{
        using Addr = Register::Address<0x40006010,0xfe003c00>;
    ...
    namespace Noneconfig{
        using Addr = Register::Address<0x40006020,0x1e000000>;
    ...
    namespace Noneclkrate{
        using Addr = Register::Address<0x40006030,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> CLKDIV; 
    }
    namespace Nonefstatus{
        using Addr = Register::Address<0x40006040,0xffff0000>;
