...
namespace Kvasir {
//None
    namespace Timer1Config{    ///<High and Low Timer Configuration
        using Addr = Register::Address<0x40015000,0x0004080c,0x00000000,unsigned>;
        ///Low Clock Source. 
        enum class LclkVal {
        ...
        enum class LrunVal {
            ...
            start=0x00000001,     ///<The low timer runs if split mode is enabled (SPLITEN = 1) and (LMSTREN = 0 or MSTRUN = 1).
        };
        ...
        enum class HmstrenVal {
            disabled=0x00000000,     ///<MSTRUN does not need to be set for the high timer to run.
            enabled=0x00000001,     ///<MSTRUN must be set for the high timer to run.
        };
        ...
        enum class HmdVal {
            ...
            toggle=0x00000008,     ///<The high 16-bit timer or entire 32-bit timer is in Toggle Output Mode.
        ...
        enum class HrunVal {
            ...
            start=0x00000001,     ///<The high timer runs if HMSTREN = 0 or MSTRUN = 1. The full 32-bit timer runs if split mode is disabled and (HMSTREN = 0 or MSTRUN = 1).
        };
    ...
    namespace Timer1Clkdiv{    ///<Module Clock Divider Control
        using Addr = Register::Address<0x40015010,0xff00ff00,0x00000000,unsigned>;
    ...
    namespace Timer1Count{    ///<Timer Value
        using Addr = Register::Address<0x40015020,0x00000000,0x00000000,unsigned>;
        ///Low Timer Count. 
    ...
    namespace Timer1Capture{    ///<Timer Capture/Reload Value
        using Addr = Register::Address<0x40015030,0x00000000,0x00000000,unsigned>;
