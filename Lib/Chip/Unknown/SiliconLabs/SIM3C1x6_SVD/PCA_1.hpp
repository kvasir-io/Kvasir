...
namespace Kvasir {
    namespace Nonemode{
        using Addr = Register::Address<0x40010180,0xffffe000>;
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x40010190,0x001fffbe>;
    ...
    namespace Nonestatus{
        using Addr = Register::Address<0x400101a0,0xfffff33c>;
    ...
    namespace Nonecontrol_0{
        using Addr = Register::Address<0x40010010,0xfffff6f0>;
    ...
    namespace Noneccapv_1{
        using Addr = Register::Address<0x40010060,0xfffc0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0)> CCAPV; 
    }
    namespace Noneccapvupd_1{
        using Addr = Register::Address<0x40010070,0xfffc0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,0)> CCAPVUPD; 
    }
}
