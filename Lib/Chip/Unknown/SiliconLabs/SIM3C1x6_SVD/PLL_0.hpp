...
//None
    ...
    namespace Nonecontrol{    ///<Module Control
        ...
        namespace RefselValC{
            constexpr Register::FieldValue<decltype(refsel),RefselVal::rtc0osc> rtc0osc{};
            ...
            constexpr Register::FieldValue<decltype(refsel),RefselVal::usbosc0> usbosc0{};
        }
    ...
    namespace Nonecalconfig{    ///<Calibration Configuration
        ...
        namespace RangeValC{
            constexpr Register::FieldValue<decltype(range),RangeVal::range0> range0{};
            constexpr Register::FieldValue<decltype(range),RangeVal::range1> range1{};
            constexpr Register::FieldValue<decltype(range),RangeVal::range2> range2{};
            constexpr Register::FieldValue<decltype(range),RangeVal::range3> range3{};
            constexpr Register::FieldValue<decltype(range),RangeVal::range4> range4{};
        }
    }
}
