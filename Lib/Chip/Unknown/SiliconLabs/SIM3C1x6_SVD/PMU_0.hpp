...
//None
    namespace Nonecontrol{    ///<Module Control
        ...
        namespace PerilpenValC{
            constexpr Register::FieldValue<decltype(perilpen),PerilpenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(perilpen),PerilpenVal::enabled> enabled{};
        }
        ...
        namespace PinlpenValC{
            constexpr Register::FieldValue<decltype(pinlpen),PinlpenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(pinlpen),PinlpenVal::enabled> enabled{};
        }
    ...
    namespace Noneconfig{    ///<Module Configuration
        ...
        namespace Rtc0frenValC{
            constexpr Register::FieldValue<decltype(rtc0fren),Rtc0frenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(rtc0fren),Rtc0frenVal::enabled> enabled{};
        }
        ...
        namespace Rtc0arenValC{
            constexpr Register::FieldValue<decltype(rtc0aren),Rtc0arenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(rtc0aren),Rtc0arenVal::enabled> enabled{};
        }
        ...
        namespace PwakerenValC{
            constexpr Register::FieldValue<decltype(pwakeren),PwakerenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(pwakeren),PwakerenVal::enabled> enabled{};
        }
        ...
        namespace Lpt0renValC{
            constexpr Register::FieldValue<decltype(lpt0ren),Lpt0renVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(lpt0ren),Lpt0renVal::enabled> enabled{};
        }
    }
    namespace Nonestatus{    ///<Module Status
        ...
        namespace Pm9efValC{
            constexpr Register::FieldValue<decltype(pm9ef),Pm9efVal::notSet> notSet{};
            constexpr Register::FieldValue<decltype(pm9ef),Pm9efVal::set> set{};
        }
    ...
    namespace Nonewakeen{    ///<Wake Source Enable
        ...
        namespace Rtc0awenValC{
            constexpr Register::FieldValue<decltype(rtc0awen),Rtc0awenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(rtc0awen),Rtc0awenVal::enabled> enabled{};
        }
        ...
        namespace RstwenValC{
            constexpr Register::FieldValue<decltype(rstwen),RstwenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(rstwen),RstwenVal::enabled> enabled{};
        }
    }
    namespace Nonewakestatus{    ///<Wake Source Status
        ...
        namespace Rtc0awfValC{
            constexpr Register::FieldValue<decltype(rtc0awf),Rtc0awfVal::notSet> notSet{};
            constexpr Register::FieldValue<decltype(rtc0awf),Rtc0awfVal::set> set{};
        }
    ...
    namespace Nonepwen{    ///<Pin Wake Pin Enable
        ...
        enum class Pw0enVal {
            ...
            enabled=0x00000001,     ///<WAKE.0 (PB1.6) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.1 Enable. 
        enum class Pw1enVal {
            disabled=0x00000000,     ///<WAKE.1 (PB1.7) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.1 (PB1.7) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.2 Enable. 
        enum class Pw2enVal {
            disabled=0x00000000,     ///<WAKE.2 (PB1.8) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.2 (PB1.8) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.3 Enable. 
        enum class Pw3enVal {
            disabled=0x00000000,     ///<WAKE.3 (PB1.9) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.3 (PB1.9) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.4 Enable. 
        enum class Pw4enVal {
            disabled=0x00000000,     ///<WAKE.4 (PB1.10) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.4 (PB1.10) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.5 Enable. 
        enum class Pw5enVal {
            disabled=0x00000000,     ///<WAKE.5 (PB1.11) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.5 (PB1.11) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.6 Enable. 
        enum class Pw6enVal {
            disabled=0x00000000,     ///<WAKE.6 (PB1.12) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.6 (PB1.12) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.8 Enable. 
        enum class Pw8enVal {
            disabled=0x00000000,     ///<WAKE.8 (PB3.2) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.8 (PB3.2) is used in the Pin Wake comparison.
        };
        ...
        ///WAKE.9 Enable. 
        enum class Pw9enVal {
            disabled=0x00000000,     ///<WAKE.9 (PB3.3) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.9 (PB3.3) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw10enVal {
            disabled=0x00000000,     ///<WAKE.10 (PB3.4) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.10 (PB3.4) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw11enVal {
            disabled=0x00000000,     ///<WAKE.11 (PB3.5) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.11 (PB3.5) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw12enVal {
            disabled=0x00000000,     ///<WAKE.12 (PB3.6) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.12 (PB3.6) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw13enVal {
            disabled=0x00000000,     ///<WAKE.13 (PB3.7) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.13 (PB3.7) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw14enVal {
            disabled=0x00000000,     ///<WAKE.14 (PB3.8) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.14 (PB3.8) is used in the Pin Wake comparison.
        };
        ...
        enum class Pw15enVal {
            disabled=0x00000000,     ///<WAKE.15 (PB3.9) is not used in the Pin Wake comparison.
            enabled=0x00000001,     ///<WAKE.15 (PB3.9) is used in the Pin Wake comparison.
        };
    ...
    namespace Nonepwpol{    ///<Pin Wake Pin Polarity Select
        ...
        enum class Pw0polVal {
            ...
            high=0x00000001,     ///<The WAKE.0 (PB1.6) comparison value is logic high.
        };
        ...
        enum class Pw1polVal {
            low=0x00000000,     ///<The WAKE.1 (PB1.7) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.1 (PB1.7) comparison value is logic high.
        };
        ...
        enum class Pw2polVal {
            low=0x00000000,     ///<The WAKE.2 (PB1.8) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.2 (PB1.8) comparison value is logic high.
        };
        ...
        enum class Pw3polVal {
            low=0x00000000,     ///<The WAKE.3 (PB1.9) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.3 (PB1.9) comparison value is logic high.
        };
        ...
        enum class Pw4polVal {
            low=0x00000000,     ///<The WAKE.4 (PB1.10) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.4 (PB1.10) comparison value is logic high.
        };
        ...
        enum class Pw5polVal {
            low=0x00000000,     ///<The WAKE.5 (PB1.11) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.5 (PB1.11) comparison value is logic high.
        };
        ...
        enum class Pw6polVal {
            low=0x00000000,     ///<The WAKE.6 (PB1.12) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.6 (PB1.12) comparison value is logic high.
        };
        ...
        enum class Pw8polVal {
            low=0x00000000,     ///<The WAKE.8 (PB3.2) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.8 (PB3.2) comparison value is logic high.
        };
        ...
        enum class Pw9polVal {
            low=0x00000000,     ///<The WAKE.9 (PB3.3) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.9 (PB3.3) comparison value is logic high.
        };
        ...
        enum class Pw10polVal {
            low=0x00000000,     ///<The WAKE.10 (PB3.4) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.10 (PB3.4) comparison value is logic high.
        };
        ...
        enum class Pw11polVal {
            low=0x00000000,     ///<The WAKE.11 (PB3.5) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.11 (PB3.5) comparison value is logic high.
        };
        ...
        enum class Pw12polVal {
            low=0x00000000,     ///<The WAKE.12 (PB3.6) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.12 (PB3.6) comparison value is logic high.
        };
        ...
        enum class Pw13polVal {
            low=0x00000000,     ///<The WAKE.13 (PB3.7) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.13 (PB3.7) comparison value is logic high.
        };
        ...
        enum class Pw14polVal {
            low=0x00000000,     ///<The WAKE.14 (PB3.8) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.14 (PB3.8) comparison value is logic high.
        };
        ...
        enum class Pw15polVal {
            low=0x00000000,     ///<The WAKE.15 (PB3.9) comparison value is logic low.
            high=0x00000001,     ///<The WAKE.15 (PB3.9) comparison value is logic high.
        };
