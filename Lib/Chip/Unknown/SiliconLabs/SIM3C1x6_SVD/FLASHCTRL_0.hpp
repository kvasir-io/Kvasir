...
//None
    ...
    namespace Nonetcontrol{    ///<Flash Timing Control
        ...
        enum class FlrtmdVal {
            slow=0x00000000,     ///<Configure the Flash read controller for AHB clocks below 20 MHz.
            fast=0x00000001,     ///<Configure the Flash read controller for AHB clocks above 20 MHz.
        };
