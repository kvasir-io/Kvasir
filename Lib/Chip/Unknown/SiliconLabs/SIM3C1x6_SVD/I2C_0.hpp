...
//None
    namespace I2c0Control{    ///<Module Control
        using Addr = Register::Address<0x40009000,0x10000000,0x00000000,unsigned>;
        ///Busy Flag. 
        enum class BusyfVal {
    ...
    namespace I2c0Saddress{    ///<Slave Address
        using Addr = Register::Address<0x40009020,0xfffff801,0x00000000,unsigned>;
        ///Slave Address. 
    ...
    namespace I2c0Smask{    ///<Slave Address Mask
        using Addr = Register::Address<0x40009030,0xfffff801,0x00000000,unsigned>;
        ///Slave Address Mask. 
