...
namespace Kvasir {
    namespace Noneconfig{
        using Addr = Register::Address<0x40001000,0x88808880>;
    ...
    namespace Nonemode{
        using Addr = Register::Address<0x40001010,0xb7f2c0ff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> RTCCKMD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> RTCBDMD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> FORCECLK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11)> CLKBUSY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> RXCLKSW; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13)> TXCLKSW; 
    ...
    namespace Noneflowcn{
        using Addr = Register::Address<0x40001020,0xcffdeffd>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RX; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> TXOEN; 
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x40001030,0x27020090>;
    ...
    namespace Nonefifocn{
        using Addr = Register::Address<0x40001060,0xf8c8f8c8>;
    ...
    namespace Noneclkdiv{
        using Addr = Register::Address<0x40001080,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> CLKDIV; 
    }
}
