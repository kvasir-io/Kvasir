...
//None
    namespace Idac0Control{    ///<Module Control
        ...
        enum class OupdtVal {
            ...
            dacnt9=0x00000001,     ///<The IDAC output updates using the DACnT9 (Timer 0 High Overflow) trigger source.
        ...
        enum class EtrigVal {
            ...
            dacnt1=0x00000001,     ///<Select DACnT1 (RESERVED) as the IDAC external trigger source.
            dacnt2=0x00000002,     ///<Select DACnT2 (RESERVED) as the IDAC external trigger source.
            dacnt3=0x00000003,     ///<Select DACnT3 (RESERVED) as the IDAC external trigger source.
            dacnt4=0x00000004,     ///<Select DACnT4 (RESERVED) as the IDAC external trigger source.
            dacnt5=0x00000005,     ///<Select DACnT5 (RESERVED) as the IDAC external trigger source.
            dacnt6=0x00000006,     ///<Select DACnT6 (RESERVED) as the IDAC external trigger source.
            dacnt7=0x00000007,     ///<Select DACnT7 (RESERVED) as the IDAC external trigger source.
        };
        ...
        enum class DbgmdVal {
            ...
            halt=0x00000001,     ///<A debug breakpoint will cause the IDAC module to halt (ignore update triggers).
        };
