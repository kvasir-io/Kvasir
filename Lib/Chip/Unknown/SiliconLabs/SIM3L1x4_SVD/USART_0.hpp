...
namespace Kvasir {
    namespace Noneconfig{
        using Addr = Register::Address<0x40000000,0x08800880>;
    ...
    namespace Nonemode{
        using Addr = Register::Address<0x40000010,0x0712ffff>;
    ...
    namespace Noneflowcn{
        using Addr = Register::Address<0x40000020,0xcf58ef1c>;
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x40000030,0x27000090>;
    ...
    namespace Noneipdelay{
        using Addr = Register::Address<0x40000040,0xff00ffff>;
    ...
    namespace Nonefifocn{
        using Addr = Register::Address<0x40000060,0xf848f848>;
    ...
    namespace Nonedata{
        using Addr = Register::Address<0x40000070,0x00000000>;
