...
//None
    ...
    namespace Nonemode{    ///<Input and Module Mode
        ...
        enum class NmuxVal {
            ...
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (PB0.2).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (RESERVED).
            ...
            cmpnn7=0x00000007,     ///<Select CMPnN.7 (PB3.0).
        ...
        enum class PmuxVal {
            ...
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (RESERVED).
