...
//None
    ...
    namespace Nonepbpgen{    ///<Pulse Generator Pin Enable
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> pbpgen{}; 
    }
    namespace Nonepbpgphase{    ///<Pulse Generator Phase
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> pbpgph0{}; 
        ///Pulse Generator Phase 1. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,16),Register::ReadWriteAccess,unsigned> pbpgph1{}; 
    }
}
