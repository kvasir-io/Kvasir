...
//None
    ...
    namespace Cmp1Mode{    ///<Input and Module Mode
        ...
        enum class NmuxVal {
            cmpnn0=0x00000000,     ///<Select CMPnN.0 (PB0.2).
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (RESERVED).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (PB0.8).
            cmpnn3=0x00000003,     ///<Select CMPnN.3 (RESERVED).
            cmpnn4=0x00000004,     ///<Select CMPnN.4 (PB2.3).
            cmpnn5=0x00000005,     ///<Select CMPnN.5 (PB2.7).
            cmpnn6=0x00000006,     ///<Select CMPnN.6 (RESERVED).
            cmpnn7=0x00000007,     ///<Select CMPnN.7 (PB3.2).
        ...
        enum class PmuxVal {
            ...
            cmpnp1=0x00000001,     ///<Select CMPnP.1 (RESERVED).
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (PB0.7).
            cmpnp3=0x00000003,     ///<Select CMPnP.3 (RESERVED).
            cmpnp4=0x00000004,     ///<Select CMPnP.4 (PB2.2).
            cmpnp5=0x00000005,     ///<Select CMPnP.5 (PB2.6).
            cmpnp6=0x00000006,     ///<Select CMPnP.6 (RESERVED).
            cmpnp7=0x00000007,     ///<Select CMPnP.7 (PB3.1).
