...
//None
    ...
    namespace Dmactrl0Baseptr{    ///<Base Pointer
        using Addr = Register::Address<0x40036008,0x000001ff,0x00000000,unsigned>;
        ///Control Base Pointer. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,9),Register::ReadWriteAccess,unsigned> baseptr{}; 
    }
    ...
    namespace Dmactrl0Chstatus{    ///<Channel Status
        using Addr = Register::Address<0x40036010,0xfffffc00,0x00000000,unsigned>;
        ///Channel 0 Status. 
        enum class Ch0Val {
    ...
    namespace Dmactrl0Chswrcn{    ///<Channel Software Request Control
        using Addr = Register::Address<0x40036014,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chreqmset{    ///<Channel Request Mask Set
        using Addr = Register::Address<0x40036020,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chreqmclr{    ///<Channel Request Mask Clear
        using Addr = Register::Address<0x40036024,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chenset{    ///<Channel Enable Set
        using Addr = Register::Address<0x40036028,0xfffffc00,0x00000000,unsigned>;
        ///Channel 0 Enable. 
        enum class Ch0Val {
    ...
    namespace Dmactrl0Chenclr{    ///<Channel Enable Clear
        using Addr = Register::Address<0x4003602c,0xfffffc00,0x00000000,unsigned>;
        ///Channel 0 Disable. 
        enum class Ch0Val {
    ...
    namespace Dmactrl0Chaltset{    ///<Channel Alternate Select Set
        using Addr = Register::Address<0x40036030,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chaltclr{    ///<Channel Alternate Select Clear
        using Addr = Register::Address<0x40036034,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chhpset{    ///<Channel High Priority Set
        using Addr = Register::Address<0x40036038,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace Dmactrl0Chhpclr{    ///<Channel High Priority Clear
        using Addr = Register::Address<0x4003603c,0xfffffc00,0x00000000,unsigned>;
