...
namespace Kvasir {
//None
    namespace Timer2Config{    ///<High and Low Timer Configuration
        using Addr = Register::Address<0x40016000,0x0004080c,0x00000000,unsigned>;
        ///Low Clock Source. 
        enum class LclkVal {
    ...
    namespace Timer2Clkdiv{    ///<Module Clock Divider Control
        using Addr = Register::Address<0x40016010,0xff00ff00,0x00000000,unsigned>;
    ...
    namespace Timer2Count{    ///<Timer Value
        using Addr = Register::Address<0x40016020,0x00000000,0x00000000,unsigned>;
        ///Low Timer Count. 
    ...
    namespace Timer2Capture{    ///<Timer Capture/Reload Value
