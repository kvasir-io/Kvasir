...
namespace Kvasir {
    namespace Nonecontrol{
        using Addr = Register::Address<0x4004a000,0x00700000>;
    ...
    namespace Nonetimeout{
        using Addr = Register::Address<0x4004a010,0x00000000>;
