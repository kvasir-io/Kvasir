...
//None
    namespace Noneconfig{    ///<RTC Configuration
        ...
        namespace clkoenValC{
            constexpr MPL::Value<clkoenVal,clkoenVal::disabled> disabled{};
            constexpr MPL::Value<clkoenVal,clkoenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28),Register::ReadWriteAccess,clkoenVal> clkoen{}; 
    ...
    namespace Nonelfocontrol{    ///<LFOSC Control
        ...
        namespace lfooenValC{
            constexpr MPL::Value<lfooenVal,lfooenVal::disabled> disabled{};
            constexpr MPL::Value<lfooenVal,lfooenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,lfooenVal> lfooen{}; 
