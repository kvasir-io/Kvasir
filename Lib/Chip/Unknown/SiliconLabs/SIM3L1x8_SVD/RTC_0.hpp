...
namespace Kvasir {
    namespace Noneconfig{
        using Addr = Register::Address<0x40029000,0x08f8ff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> CLKOEN; 
    ...
    namespace Nonelfocontrol{
        using Addr = Register::Address<0x40029060,0x3fffffff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30)> LFOOEN; 
