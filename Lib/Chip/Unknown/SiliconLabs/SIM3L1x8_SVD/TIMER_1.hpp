...
//None
    namespace Noneconfig{    ///<High and Low Timer Configuration
        using Addr = Register::Address<0x40015000,0x0004080c,0,unsigned>;
        ///Low Clock Source. 
        enum class LclkVal {
    ...
    namespace Noneclkdiv{    ///<Module Clock Divider Control
        using Addr = Register::Address<0x40015010,0xff00ff00,0,unsigned>;
    ...
    namespace Nonecount{    ///<Timer Value
        using Addr = Register::Address<0x40015020,0x00000000,0,unsigned>;
        ///Low Timer Count. 
    ...
    namespace Nonecapture{    ///<Timer Capture/Reload Value
        using Addr = Register::Address<0x40015030,0x00000000,0,unsigned>;
