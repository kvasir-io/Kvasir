...
//None
    ...
    namespace Nonecontrol{    ///<Module Control
        ...
        namespace refselValC{
            constexpr MPL::Value<refselVal,refselVal::rtc0tclk> rtc0tclk{};
    ...
    namespace Nonecalconfig{    ///<Calibration Configuration
        ...
        ///DCO Range. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,16),Register::ReadWriteAccess,unsigned> range{}; 
    }
}
