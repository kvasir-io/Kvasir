...
//None
    namespace Idac0Control{    ///<Module Control
        ...
        enum class OupdtVal {
            dacnt8=0x00000000,     ///<The IDAC output updates using the <dict>DACnT8</dict> trigger source.
            dacnt9=0x00000001,     ///<The IDAC output updates using the <dict>DACnT9</dict> trigger source.
            dacnt10=0x00000002,     ///<The IDAC output updates using the <dict>DACnT10</dict> trigger source.
            dacnt11=0x00000003,     ///<The IDAC output updates using the <dict>DACnT11</dict> trigger source.
        ...
        enum class EtrigVal {
            dacnt0=0x00000000,     ///<Select <dict>DACnT0</dict> as the IDAC external trigger source.
            dacnt1=0x00000001,     ///<Select <dict>DACnT1</dict> as the IDAC external trigger source.
            dacnt2=0x00000002,     ///<Select <dict>DACnT2</dict> as the IDAC external trigger source.
            dacnt3=0x00000003,     ///<Select <dict>DACnT3</dict> as the IDAC external trigger source.
            dacnt4=0x00000004,     ///<Select <dict>DACnT4</dict> as the IDAC external trigger source.
            dacnt5=0x00000005,     ///<Select <dict>DACnT5</dict> as the IDAC external trigger source.
            dacnt6=0x00000006,     ///<Select <dict>DACnT6</dict> as the IDAC external trigger source.
            dacnt7=0x00000007,     ///<Select <dict>DACnT7</dict> as the IDAC external trigger source.
        };
