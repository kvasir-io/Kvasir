...
namespace Kvasir {
    namespace Nonemode{
        using Addr = Register::Address<0x4000e180,0xe4002000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14)> HDOSEL; 
    ...
    namespace Nonecontrol{
        using Addr = Register::Address<0x4000e190,0x001f8580>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> HALTIEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> NOUPD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> IDLEBEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> DBGMD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> HALTEN; 
    ...
    namespace Nonestatus{
        using Addr = Register::Address<0x4000e1a0,0xffff0000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> HALTI; 
