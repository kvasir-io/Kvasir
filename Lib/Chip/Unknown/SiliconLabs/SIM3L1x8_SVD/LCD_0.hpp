...
//None
    namespace Noneconfig{    ///<Configuration
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,18),Register::ReadWriteAccess,unsigned> biasbgr{}; 
        ...
        namespace cpsmdValC{
            constexpr MPL::Value<cpsmdVal,cpsmdVal::external> external{};
            constexpr MPL::Value<cpsmdVal,cpsmdVal::vlcd> vlcd{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,cpsmdVal> cpsmd{}; 
    }
    ...
    namespace Nonesegdata0{    ///<Segment Data 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> segdata0{}; 
    }
    namespace Nonesegdata1{    ///<Segment Data 1
        using Addr = Register::Address<0x4004d0b0,0x00000000,0,unsigned>;
        ///Segment LCDn.8 Control. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> segdata1{}; 
    }
    namespace Nonesegdata2{    ///<Segment Data 2
        using Addr = Register::Address<0x4004d0c0,0x00000000,0,unsigned>;
        ///Segment LCDn.16 Control. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> segdata2{}; 
    }
    namespace Nonesegdata3{    ///<Segment Data 3
        using Addr = Register::Address<0x4004d0d0,0x00000000,0,unsigned>;
        ///Segment LCDn.24 Control. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> segdata3{}; 
    }
    namespace Nonesegdata4{    ///<Segment Data 4
        using Addr = Register::Address<0x4004d0e0,0x00000000,0,unsigned>;
        ///Segment LCDn.32 Control. 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> segdata4{}; 
    }
}
