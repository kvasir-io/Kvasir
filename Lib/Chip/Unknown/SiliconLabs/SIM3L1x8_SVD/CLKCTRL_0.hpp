...
//None
    namespace Nonecontrol{    ///<Module Control
        ...
        namespace rtc0tclkenValC{
            constexpr MPL::Value<rtc0tclkenVal,rtc0tclkenVal::disabled> disabled{};
            constexpr MPL::Value<rtc0tclkenVal,rtc0tclkenVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,rtc0tclkenVal> rtc0tclken{}; 
    }
