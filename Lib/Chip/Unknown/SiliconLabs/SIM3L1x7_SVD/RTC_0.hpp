...
//None
    namespace Rtc0Config{    ///<RTC Configuration
        using Addr = Register::Address<0x40029000,0x08f8ff00,0x00000000,unsigned>;
        ...
        namespace ClkoenValC{
            constexpr Register::FieldValue<decltype(clkoen)::Type,ClkoenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(clkoen)::Type,ClkoenVal::enabled> enabled{};
        }
    ...
    namespace Rtc0Lfocontrol{    ///<LFOSC Control
        using Addr = Register::Address<0x40029060,0x3fffffff,0x00000000,unsigned>;
        ...
        namespace LfooenValC{
            constexpr Register::FieldValue<decltype(lfooen)::Type,LfooenVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(lfooen)::Type,LfooenVal::enabled> enabled{};
        }
