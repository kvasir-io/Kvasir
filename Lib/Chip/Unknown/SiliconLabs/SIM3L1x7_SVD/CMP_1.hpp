...
//None
    ...
    namespace Cmp1Mode{    ///<Input and Module Mode
        ...
        enum class NmuxVal {
            cmpnn0=0x00000000,     ///<Select CMPnN.0 (PB0.3).
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (PB0.11).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (PB1.3).
            cmpnn3=0x00000003,     ///<Select CMPnN.3 (PB1.11).
            cmpnn4=0x00000004,     ///<Select CMPnN.4 (RESERVED).
            cmpnn5=0x00000005,     ///<Select CMPnN.5 (PB2.7).
            cmpnn6=0x00000006,     ///<Select CMPnN.6 (PB3.7).
        ...
        enum class PmuxVal {
            cmpnp0=0x00000000,     ///<Select CMPnP.0 (PB0.2).
            cmpnp1=0x00000001,     ///<Select CMPnP.1 (PB0.10).
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (PB1.2).
            cmpnp3=0x00000003,     ///<Select CMPnP.3 (PB1.10).
            cmpnp4=0x00000004,     ///<Select CMPnP.4 (RESERVED).
            cmpnp5=0x00000005,     ///<Select CMPnP.5 (PB2.6).
            cmpnp6=0x00000006,     ///<Select CMPnP.6 (PB3.6).
