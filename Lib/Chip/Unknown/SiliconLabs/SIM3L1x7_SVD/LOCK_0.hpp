...
//None
    ...
    namespace Noneperiphlock0{    ///<Peripheral Lock Control 0
        ...
        namespace RstsrclValC{
            constexpr Register::FieldValue<decltype(rstsrcl),RstsrclVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(rstsrcl),RstsrclVal::locked> locked{};
        }
        ...
        namespace ClkctrlValC{
            constexpr Register::FieldValue<decltype(clkctrl),ClkctrlVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(clkctrl),ClkctrlVal::locked> locked{};
        }
        ...
        namespace LdolValC{
            constexpr Register::FieldValue<decltype(ldol),LdolVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(ldol),LdolVal::locked> locked{};
        }
        ...
        namespace PvtlValC{
            constexpr Register::FieldValue<decltype(pvtl),PvtlVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(pvtl),PvtlVal::locked> locked{};
        }
        ...
        namespace AcctrlValC{
            constexpr Register::FieldValue<decltype(acctrl),AcctrlVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(acctrl),AcctrlVal::locked> locked{};
        }
        ...
        namespace DtmlValC{
            constexpr Register::FieldValue<decltype(dtml),DtmlVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(dtml),DtmlVal::locked> locked{};
        }
        ///LCD Module Lock. 
        enum class LcdlVal {
        ...
        namespace LcdlValC{
            constexpr Register::FieldValue<decltype(lcdl),LcdlVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(lcdl),LcdlVal::locked> locked{};
        }
        ...
        namespace DcdclValC{
            constexpr Register::FieldValue<decltype(dcdcl),DcdclVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(dcdcl),DcdclVal::locked> locked{};
        }
    }
    namespace Noneperiphlock1{    ///<Peripheral Lock Control 1
        ...
        namespace EncdeclValC{
            constexpr Register::FieldValue<decltype(encdecl),EncdeclVal::unlocked> unlocked{};
            constexpr Register::FieldValue<decltype(encdecl),EncdeclVal::locked> locked{};
        }
    }
}
