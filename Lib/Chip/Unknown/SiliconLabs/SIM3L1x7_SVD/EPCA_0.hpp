...
//None
    namespace Nonemode{    ///<Module Operating Mode
        using Addr = Register::Address<0x4000e180,0xe400e000,0,unsigned>;
        ///Input Clock Divider. 
        ...
        enum class StdoselVal {
            ...
            oneDiff=0x00000001,     ///<Select the differential output from Channel 2 and non-differential outputs from Channels 0, 1, 2, and 3 for the standard PB pins.
            twoDiff=0x00000002,     ///<Select the differential outputs from Channels 1 and 2 and non-differential outputs from Channels 0 and 1 for the standard PB pins.
    ...
    namespace Nonecontrol{    ///<Module Control
        using Addr = Register::Address<0x4000e190,0x001f87a8,0,unsigned>;
        ...
        enum class StselVal {
            epcant0=0x00000000,     ///<Select input trigger 0, Comparator0 output.
            epcant1=0x00000001,     ///<Select input trigger 1, Comparator1 output.
            epcant2=0x00000002,     ///<Select input trigger 2, Timer 0 high overflow.
            epcant3=0x00000003,     ///<Select input trigger 3, Timer 1 high overflow.
        };
    ...
    namespace Nonestatus{    ///<Module Status
        using Addr = Register::Address<0x4000e1a0,0xffff0200,0,unsigned>;
