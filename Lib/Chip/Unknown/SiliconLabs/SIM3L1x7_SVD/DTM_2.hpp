...
namespace Kvasir {
//None
    namespace Dtm2Control{    ///<Module Control
        using Addr = Register::Address<0x4004c000,0x00700000,0x00000000,unsigned>;
    ...
    namespace Dtm2Timeout{    ///<Module Timeout
        using Addr = Register::Address<0x4004c010,0x00000000,0x00000000,unsigned>;
    ...
    namespace Dtm2Mstcount{    ///<Master Counter
        using Addr = Register::Address<0x4004c020,0xffff0000,0x00000000,unsigned>;
        ///Master Counter. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> mstcount{}; 
    }
    namespace Dtm2Stateaddr{    ///<State Address
        using Addr = Register::Address<0x4004c030,0x00000003,0x00000000,unsigned>;
        ///State Address. 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,2),Register::ReadWriteAccess,unsigned> stateaddr{}; 
    }
    namespace Dtm2State{    ///<Active DTM State
        using Addr = Register::Address<0x4004c040,0x00000000,0x00000000,unsigned>;
