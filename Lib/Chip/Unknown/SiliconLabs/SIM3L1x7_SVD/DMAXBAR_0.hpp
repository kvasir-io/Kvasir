...
//None
    namespace Nonedmaxbar0{    ///<Channel 0-7 Trigger Select
        ...
        enum class ch0selVal {
            ...
            unassigned=0x0000000f,     ///<Unassigned.
        };
        namespace ch0selValC{
            ...
            constexpr MPL::Value<ch0selVal,ch0selVal::unassigned> unassigned{};
        }
        ...
        namespace ch1selValC{
            ...
            constexpr MPL::Value<ch1selVal,ch1selVal::unassigned> unassigned{};
        }
        ...
        namespace ch2selValC{
            ...
            constexpr MPL::Value<ch2selVal,ch2selVal::unassigned> unassigned{};
        }
        ...
        namespace ch3selValC{
            ...
            constexpr MPL::Value<ch3selVal,ch3selVal::unassigned> unassigned{};
        }
        ...
        namespace ch4selValC{
            ...
            constexpr MPL::Value<ch4selVal,ch4selVal::unassigned> unassigned{};
        }
        ...
        namespace ch5selValC{
            ...
            constexpr MPL::Value<ch5selVal,ch5selVal::unassigned> unassigned{};
        }
        ...
        namespace ch6selValC{
            ...
            constexpr MPL::Value<ch6selVal,ch6selVal::unassigned> unassigned{};
        }
        ...
        namespace ch7selValC{
            ...
            constexpr MPL::Value<ch7selVal,ch7selVal::unassigned> unassigned{};
        }
    ...
    namespace Nonedmaxbar1{    ///<Channel 8-15 Trigger Select
        ...
        namespace ch8selValC{
            ...
            constexpr MPL::Value<ch8selVal,ch8selVal::unassigned> unassigned{};
        }
        ...
        namespace ch9selValC{
            ...
            constexpr MPL::Value<ch9selVal,ch9selVal::unassigned> unassigned{};
        }
