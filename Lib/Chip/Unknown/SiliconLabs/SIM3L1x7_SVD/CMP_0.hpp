...
//None
    ...
    namespace Nonemode{    ///<Input and Module Mode
        ...
        enum class NmuxVal {
            ...
            cmpnn1=0x00000001,     ///<Select CMPnN.1 (PB0.9).
            cmpnn2=0x00000002,     ///<Select CMPnN.2 (PB1.1).
            cmpnn3=0x00000003,     ///<Select CMPnN.3 (PB1.9).
            cmpnn4=0x00000004,     ///<Select CMPnN.4 (PB2.1).
            cmpnn5=0x00000005,     ///<Select CMPnN.5 (PB2.5).
            cmpnn6=0x00000006,     ///<Select CMPnN.6 (PB3.5).
            cmpnn7=0x00000007,     ///<Select CMPnN.7 (PB3.9).
        ...
        enum class PmuxVal {
            ...
            cmpnp1=0x00000001,     ///<Select CMPnP.1 (PB0.4).
            cmpnp2=0x00000002,     ///<Select CMPnP.2 (PB1.0).
            cmpnp3=0x00000003,     ///<Select CMPnP.3 (PB1.8).
            cmpnp4=0x00000004,     ///<Select CMPnP.4 (PB2.0).
            cmpnp5=0x00000005,     ///<Select CMPnP.5 (PB2.4).
            cmpnp6=0x00000006,     ///<Select CMPnP.6 (PB3.4).
            cmpnp7=0x00000007,     ///<Select CMPnP.7 (PB3.8).
