...
//Multi-function Serial Interface 0
    ...
    namespace Mfs15UartSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff02,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038f08,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace Mfs15CsioSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038f05,0xffffff70,0x00000000,unsigned char>;
        ///Received error flag clear bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        ///Overrun error flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ore{}; 
    ...
    namespace Mfs15CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038f04,0xffffff60,0x00000000,unsigned char>;
    ...
    namespace Mfs15I2cSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff03,0x00000000,unsigned char>;
        ///operation mode set bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        ///Wake-up control bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
