...
namespace Kvasir {
//Base Timer 0
    namespace Bt13PwmTmcr{    ///<Timer Control Register
    ...
    namespace Bt13PwmTmcr2{    ///<Timer Control Register 2
    ...
    namespace Bt13PwmStc{    ///< Status Control Register
    ...
    namespace Bt13PpgTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025651,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt13PpgStc{    ///<Status Control Register
    ...
    namespace Bt13PpgPrll{    ///<LOW Width Reload Register
        using Addr = Register::Address<0x40025640,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt13PpgPrlh{    ///<HIGH Width Reload Register
        using Addr = Register::Address<0x40025644,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt13PpgTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025648,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt13RtTmcr{    ///<Timer Control Register
    ...
    namespace Bt13RtTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025651,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt13RtStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025650,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit 
    ...
    namespace Bt13RtPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x40025640,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt13RtTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025648,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt13PwcTmcr{    ///<Timer Control Register
    ...
    namespace Bt13PwcTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025651,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt13PwcStc{    ///<Status Control Register
    ...
    namespace Bt13PwcDtbf{    ///<Data Buffer Register
        using Addr = Register::Address<0x40025644,0xffffffff,0x00000000,unsigned>;
    }
}
