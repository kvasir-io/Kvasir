...
namespace Kvasir {
    ...
    namespace Noneclk_sel{
        using Addr = Register::Address<0x4003a010,0xfffffefe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SEL_OUT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> SEL_IN; 
    }
