...
namespace Kvasir {
    ...
    namespace Nonehwintclr0{
        using Addr = Register::Address<0x40061050,0xffffffff>;
    }
    namespace Nonehwintclr1{
        using Addr = Register::Address<0x40061054,0xffffffff>;
    }
    namespace Nonehwintclr2{
        using Addr = Register::Address<0x40061058,0xffffffff>;
    }
    namespace Nonehwintclr3{
        using Addr = Register::Address<0x4006105c,0xffffffff>;
    }
    namespace Nonehwintclr4{
        using Addr = Register::Address<0x40061060,0xffffffff>;
    }
    namespace Nonehwintclr5{
        using Addr = Register::Address<0x40061064,0xffffffff>;
    }
    namespace Nonehwintclr6{
        using Addr = Register::Address<0x40061068,0xffffffff>;
    }
    namespace Nonehwintclr7{
        using Addr = Register::Address<0x4006106c,0xffffffff>;
    }
