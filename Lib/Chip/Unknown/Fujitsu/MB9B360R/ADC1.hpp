...
//ADC0 Registers
    ...
    namespace Adc1Adct{    ///<Frequency Division Ratio Setup Register
    ...
    namespace Adc1Wcmrcot{    ///<Range Comparison Threshold Excess Flag Register
    ...
    namespace Adc1Wcmrcif{    ///<Range Comparison Flag Register
    ...
    namespace Adc1Wcmpcr{    ///<Range Comparison Control Register
    ...
    namespace Adc1Wcmpsr{    ///<Range Comparison Channel Select Register
    ...
    namespace Adc1Wcmpdl{    ///<Lower Limit Threshold Setup Register
    ...
    namespace Adc1Wcmpdh{    ///<Upper Limit Setup Register
