...
namespace Kvasir {
    ...
    namespace Nonerck_ctl{
        using Addr = Register::Address<0x40035104,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> CECCKE; 
    ...
    namespace Nonewifsr{
        using Addr = Register::Address<0x40035808,0xfffffc00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> WCEC1I; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> WCEC0I; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> WUI5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> WUI4; 
    ...
    namespace Nonewier{
        using Addr = Register::Address<0x4003580c,0xfffffc04>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> WCEC1E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> WCEC0E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> WUI5E; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> WUI4E; 
    ...
    namespace Nonewilvr{
        using Addr = Register::Address<0x40035810,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> WUI5LV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> WUI4LV; 
