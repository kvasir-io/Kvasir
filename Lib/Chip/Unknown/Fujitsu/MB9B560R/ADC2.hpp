...
//ADC0 Registers
    ...
    namespace Adc2Adct{    ///<Frequency Division Ratio Setup Register
    ...
    namespace Adc2Wcmrcot{    ///<Range Comparison Threshold Excess Flag Register
    ...
    namespace Adc2Wcmrcif{    ///<Range Comparison Flag Register
    ...
    namespace Adc2Wcmpcr{    ///<Range Comparison Control Register
    ...
    namespace Adc2Wcmpsr{    ///<Range Comparison Channel Select Register
    ...
    namespace Adc2Wcmpdl{    ///<Lower Limit Threshold Setup Register
    ...
    namespace Adc2Wcmpdh{    ///<Upper Limit Setup Register
