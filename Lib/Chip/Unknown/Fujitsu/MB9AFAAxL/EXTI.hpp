...
//External Interrupt and NMI Control
    namespace ExtiEnir{    ///<Enable Interrupt Request Register
        using Addr = Register::Address<0x40030000,0xffff7f80,0x00000000,unsigned>;
        ///Bit15 of ENIR
    ...
    namespace ExtiEirr{    ///<External Interrupt Request Register
        using Addr = Register::Address<0x40030004,0xffff7f80,0x00000000,unsigned>;
        ///Bit15 of EIRR
    ...
    namespace ExtiEicl{    ///<External Interrupt Clear Register
        using Addr = Register::Address<0x40030008,0xffff7f80,0x00000000,unsigned>;
        ///Bit15 of EICL
    ...
    namespace ExtiElvr{    ///<External Interrupt Level Register
        using Addr = Register::Address<0x4003000c,0x3fffc000,0x00000000,unsigned>;
        ///Bit31 of ELVR
