...
namespace Kvasir {
    ...
    namespace Nonedfctrlr{
        using Addr = Register::Address<0x40000030,0x0000fffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16)> WKEY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> RME; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DFE; 
    }
    ...
    namespace Nonefgpdm1{
        using Addr = Register::Address<0x40000110,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> GPD1; 
    }
    namespace Nonefgpdm2{
        using Addr = Register::Address<0x40000114,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> GPD2; 
    }
    namespace Nonefgpdm3{
        using Addr = Register::Address<0x40000118,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> GPD3; 
    }
    namespace Nonefgpdm4{
        using Addr = Register::Address<0x4000011c,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> GPD4; 
    }
}
