...
//Flash Memory
    ...
    namespace Nonedfctrlr{    ///<Dual Flash mode Control Register
        ...
        ///Write Key
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> wkey{}; 
        ///Re-Map Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> rme{}; 
        ///Dual Flash mode Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> dfe{}; 
    }
    ...
    namespace Nonefgpdm1{    ///<Flash General Purpose Data Mirror Register1
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> gpd1{}; 
    }
    namespace Nonefgpdm2{    ///<Flash General Purpose Data Mirror Register2
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> gpd2{}; 
    }
    namespace Nonefgpdm3{    ///<Flash General Purpose Data Mirror Register3
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> gpd3{}; 
    }
    namespace Nonefgpdm4{    ///<Flash General Purpose Data Mirror Register4
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> gpd4{}; 
    }
}
