...
namespace Kvasir {
//Base Timer 0
    namespace Bt9PwmTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x4002544c,0xffff8080,0x00000000,unsigned>;
    ...
    namespace Bt9PwmTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025451,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt9PwmStc{    ///< Status Control Register
        using Addr = Register::Address<0x40025450,0xffffff88,0x00000000,unsigned char>;
    ...
    namespace Bt9PwmPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x40025440,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PwmPdut{    ///<PWM Duty Set Register
        using Addr = Register::Address<0x40025444,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PwmTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025448,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PpgTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x4002544c,0xffff8080,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
        ///Restart enable bit
    ...
    namespace Bt9PpgTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025451,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt9PpgStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025450,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> udie{}; 
    ...
    namespace Bt9PpgPrll{    ///<LOW Width Reload Register
        using Addr = Register::Address<0x40025440,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PpgPrlh{    ///<HIGH Width Reload Register
        using Addr = Register::Address<0x40025444,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PpgTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025448,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9RtTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x4002544c,0xffff8c00,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
        ///Trigger input edge selection bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> egs{}; 
    ...
    namespace Bt9RtTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025451,0xffffff7e,0x00000000,unsigned char>;
    ...
    namespace Bt9RtStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025450,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit 
    ...
    namespace Bt9RtPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x40025440,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9RtTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025448,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PwcTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x4002544c,0xffff8809,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
    ...
    namespace Bt9PwcTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025451,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt9PwcStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025450,0xffffff2a,0x00000000,unsigned char>;
        ///Error flag bit
    ...
    namespace Bt9PwcDtbf{    ///<Data Buffer Register
        using Addr = Register::Address<0x40025444,0xffffffff,0x00000000,unsigned>;
    }
}
