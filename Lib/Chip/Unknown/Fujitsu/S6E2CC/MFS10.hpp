...
//Multi-function Serial Interface 0
    namespace Mfs10UartScr{    ///<Serial Control Register
    ...
    namespace Mfs10UartSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038a00,0xffffff12,0x00000000,unsigned char>;
    ...
    namespace Mfs10UartSsr{    ///<Serial Status Register
    ...
    namespace Mfs10UartEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs10UartRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038a08,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10UartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038a08,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10UartBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs10UartFcr1{    ///<FIFO Control Register 1
    ...
    namespace Mfs10UartFcr0{    ///<FIFO Control Register 0
    ...
    namespace Mfs10CsioSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038a00,0xffffff10,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038a05,0xffffff60,0x00000000,unsigned char>;
        ///Received error flag clear bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs10CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038a04,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038a08,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10CsioTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038a08,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10CsioBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs10CsioFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038a15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs10CsioFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038a14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs10CsioFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038a18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038a19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioScstr0{    ///<Serial Chip Select Timing Register 0
        using Addr = Register::Address<0x40038a1c,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioScstr1{    ///<Serial Chip Select Timing Register 1
        using Addr = Register::Address<0x40038a1d,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
        using Addr = Register::Address<0x40038a20,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs10CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038a21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioSacsr{    ///<Serial Support Control Register
        using Addr = Register::Address<0x40038a24,0xffffc620,0x00000000,unsigned>;
    ...
    namespace Mfs10CsioStmr{    ///<Serial Timer Register
        using Addr = Register::Address<0x40038a28,0xffff0000,0x00000000,unsigned>;
        ///Timer Data bits
    ...
    namespace Mfs10CsioStmcr{    ///<Serial Timer Comparison Register
        using Addr = Register::Address<0x40038a2c,0xffff0000,0x00000000,unsigned>;
        ///Compare bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tc{}; 
    }
    namespace Mfs10CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038a30,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs10CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038a34,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038a35,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038a38,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10CsioTbyte0{    ///<Transfer Byte Register 0
        using Addr = Register::Address<0x40038a3c,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioTbyte1{    ///<Transfer Byte Register 1
        using Addr = Register::Address<0x40038a3d,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioTbyte2{    ///<Transfer Byte Register 2
        using Addr = Register::Address<0x40038a40,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioTbyte3{    ///<Transfer Byte Register 3
        using Addr = Register::Address<0x40038a41,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10LinScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038a01,0xffffff00,0x00000000,unsigned char>;
        ///Programmable clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> upcl{}; 
        ///Master/Slave function select bit 
    ...
    namespace Mfs10LinSmr{    ///<Serial Mode Register
    ...
    namespace Mfs10LinSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038a05,0xffffff40,0x00000000,unsigned char>;
        ///Received Error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs10LinEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs10LinRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038a08,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10LinTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038a08,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs10LinBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038a0c,0xffff0000,0x00000000,unsigned>;
        ///External clock select bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        ///Baud Rate Generator Registers 1
    ...
    namespace Mfs10LinFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038a15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs10LinFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038a14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs10LinFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038a18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10LinFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038a19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10I2cIbcr{    ///<I2C Bus Control Register
        using Addr = Register::Address<0x40038a01,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs10I2cSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038a00,0xffffff13,0x00000000,unsigned char>;
        ///operation mode set bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        ///Received interrupt enable bit
    ...
    namespace Mfs10I2cIbsr{    ///<I2C Bus Status Register
        using Addr = Register::Address<0x40038a04,0xffffff00,0x00000000,unsigned char>;
        ///First byte bit
    ...
    namespace Mfs10I2cSsr{    ///<Serial Status Register 
    ...
    namespace Mfs10I2cRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038a08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs10I2cTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038a08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs10I2cBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038a0c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
    ...
    namespace Mfs10I2cIsmk{    ///<7-bit Slave Address Mask Register
    ...
    namespace Mfs10I2cIsba{    ///<7-bit Slave Address Register
    ...
    namespace Mfs10I2cFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038a15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs10I2cFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038a14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs10I2cFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038a18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10I2cFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038a19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10I2cNfcr{    ///<Noise Filter Control Register
        using Addr = Register::Address<0x40038a1c,0xffffffe0,0x00000000,unsigned char>;
    ...
    namespace Mfs10I2cEibcr{    ///<Extension I2C Bus Control Register
