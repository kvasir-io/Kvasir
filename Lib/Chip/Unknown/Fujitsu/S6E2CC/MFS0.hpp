...
namespace Kvasir {
    ...
    namespace Nonecsio_scsfr0{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> CS1L; 
    }
    namespace Nonecsio_scsfr1{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> CS2L; 
    }
    namespace Nonecsio_scsfr2{
        using Addr = Register::Address<0x40038038,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> CS3CSLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CS3SCINV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CS3SPI; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> CS3L; 
    }
