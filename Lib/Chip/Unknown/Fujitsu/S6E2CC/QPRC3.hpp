...
//Quadrature Position/Revolution Counter 0
    namespace Qprc3Qpcr{    ///<QPRC Position Count Register
        using Addr = Register::Address<0x400260c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc3Qrcr{    ///<QPRC Revolution Count Register
        using Addr = Register::Address<0x400260c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc3Qpccr{    ///<QPRC Position Counter Compare Register
        using Addr = Register::Address<0x400260c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc3Qprcr{    ///<QPRC Position and Revolution Counter Compare Register
        using Addr = Register::Address<0x400260cc,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc3Qmpr{    ///<QPRC Maximum Position Register
        using Addr = Register::Address<0x400260d0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc3Qicrl{    ///<Low-Order Bytes of QPRC Interrupt Control Register
    ...
    namespace Qprc3Qicrh{    ///<High-Order Bytes of QPRC Interrupt Control Register
    ...
    namespace Qprc3Qcr{    ///<QPRC Control Register
    ...
    namespace Qprc3Qecr{    ///<QPRC Extension Control Register
        using Addr = Register::Address<0x400260dc,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Qprc3Qprcrr{    ///<Quad Counter Position Rotation Count Register
        using Addr = Register::Address<0x400260fc,0x00000000,0x00000000,unsigned>;
