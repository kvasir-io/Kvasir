...
//Multi-function Serial Interface 0
    namespace Mfs11UartScr{    ///<Serial Control Register
    ...
    namespace Mfs11UartSmr{    ///<Serial Mode Register
    ...
    namespace Mfs11UartSsr{    ///<Serial Status Register
    ...
    namespace Mfs11UartEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs11UartRdr{    ///<Received Data Register
    ...
    namespace Mfs11UartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038b08,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs11UartBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs11UartFcr1{    ///<FIFO Control Register 1
    ...
    namespace Mfs11UartFcr0{    ///<FIFO Control Register 0
    ...
    namespace Mfs11CsioSmr{    ///<Serial Mode Register
    ...
    namespace Mfs11CsioSsr{    ///<Serial Status Register
    ...
    namespace Mfs11CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038b04,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs11CsioRdr{    ///<Received Data Register
    ...
    namespace Mfs11CsioTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038b08,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs11CsioBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs11CsioFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038b15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs11CsioFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038b14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs11CsioFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038b18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11CsioFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038b19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11CsioScstr0{    ///<Serial Chip Select Timing Register 0
    ...
    namespace Mfs11CsioScstr1{    ///<Serial Chip Select Timing Register 1
    ...
    namespace Mfs11CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
    ...
    namespace Mfs11CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038b21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11CsioSacsr{    ///<Serial Support Control Register
    ...
    namespace Mfs11CsioStmr{    ///<Serial Timer Register
    ...
    namespace Mfs11CsioStmcr{    ///<Serial Timer Comparison Register
    ...
    namespace Mfs11CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038b30,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs11CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038b34,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs11CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038b35,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs11CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038b38,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs11LinSmr{    ///<Serial Mode Register
    ...
    namespace Mfs11LinSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038b05,0xffffff40,0x00000000,unsigned char>;
        ///Received Error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs11LinEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs11LinRdr{    ///<Received Data Register
    ...
    namespace Mfs11LinTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038b08,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs11LinBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038b0c,0xffff0000,0x00000000,unsigned>;
        ///External clock select bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        ///Baud Rate Generator Registers 1
    ...
    namespace Mfs11LinFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038b15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs11LinFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038b14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs11LinFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038b18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11LinFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038b19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11I2cIbcr{    ///<I2C Bus Control Register
        using Addr = Register::Address<0x40038b01,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs11I2cSmr{    ///<Serial Mode Register
    ...
    namespace Mfs11I2cIbsr{    ///<I2C Bus Status Register
        using Addr = Register::Address<0x40038b04,0xffffff00,0x00000000,unsigned char>;
        ///First byte bit
    ...
    namespace Mfs11I2cSsr{    ///<Serial Status Register 
    ...
    namespace Mfs11I2cRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038b08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs11I2cTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038b08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs11I2cBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038b0c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
    ...
    namespace Mfs11I2cIsmk{    ///<7-bit Slave Address Mask Register
    ...
    namespace Mfs11I2cIsba{    ///<7-bit Slave Address Register
    ...
    namespace Mfs11I2cFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038b15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs11I2cFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038b14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs11I2cFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038b18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11I2cFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038b19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs11I2cNfcr{    ///<Noise Filter Control Register
    ...
    namespace Mfs11I2cEibcr{    ///<Extension I2C Bus Control Register
