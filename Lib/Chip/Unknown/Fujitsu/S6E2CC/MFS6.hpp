...
//Multi-function Serial Interface 0
    namespace Mfs6UartScr{    ///<Serial Control Register
    ...
    namespace Mfs6UartSmr{    ///<Serial Mode Register
    ...
    namespace Mfs6UartSsr{    ///<Serial Status Register
    ...
    namespace Mfs6UartEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs6UartRdr{    ///<Received Data Register
    ...
    namespace Mfs6UartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038608,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs6UartBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs6UartFcr1{    ///<FIFO Control Register 1
    ...
    namespace Mfs6UartFcr0{    ///<FIFO Control Register 0
    ...
    namespace Mfs6CsioSmr{    ///<Serial Mode Register
    ...
    namespace Mfs6CsioSsr{    ///<Serial Status Register
    ...
    namespace Mfs6CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038604,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6CsioRdr{    ///<Received Data Register
    ...
    namespace Mfs6CsioTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038608,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs6CsioBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs6CsioFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038615,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs6CsioFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038614,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs6CsioFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038618,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6CsioFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038619,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6CsioScstr0{    ///<Serial Chip Select Timing Register 0
    ...
    namespace Mfs6CsioScstr1{    ///<Serial Chip Select Timing Register 1
    ...
    namespace Mfs6CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
    ...
    namespace Mfs6CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038621,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6CsioSacsr{    ///<Serial Support Control Register
    ...
    namespace Mfs6CsioStmr{    ///<Serial Timer Register
    ...
    namespace Mfs6CsioStmcr{    ///<Serial Timer Comparison Register
    ...
    namespace Mfs6CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038630,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs6CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038634,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038635,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038638,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6LinSmr{    ///<Serial Mode Register
    ...
    namespace Mfs6LinSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038605,0xffffff40,0x00000000,unsigned char>;
        ///Received Error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs6LinEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs6LinRdr{    ///<Received Data Register
    ...
    namespace Mfs6LinTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038608,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs6LinBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003860c,0xffff0000,0x00000000,unsigned>;
        ///External clock select bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        ///Baud Rate Generator Registers 1
    ...
    namespace Mfs6LinFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038615,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs6LinFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038614,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs6LinFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038618,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6LinFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038619,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6I2cIbcr{    ///<I2C Bus Control Register
        using Addr = Register::Address<0x40038601,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6I2cSmr{    ///<Serial Mode Register
    ...
    namespace Mfs6I2cIbsr{    ///<I2C Bus Status Register
        using Addr = Register::Address<0x40038604,0xffffff00,0x00000000,unsigned char>;
        ///First byte bit
    ...
    namespace Mfs6I2cSsr{    ///<Serial Status Register 
    ...
    namespace Mfs6I2cRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038608,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs6I2cTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038608,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs6I2cBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003860c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
    ...
    namespace Mfs6I2cIsmk{    ///<7-bit Slave Address Mask Register
    ...
    namespace Mfs6I2cIsba{    ///<7-bit Slave Address Register
    ...
    namespace Mfs6I2cFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038615,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs6I2cFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038614,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs6I2cFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038618,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6I2cFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038619,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs6I2cNfcr{    ///<Noise Filter Control Register
    ...
    namespace Mfs6I2cEibcr{    ///<Extension I2C Bus Control Register
