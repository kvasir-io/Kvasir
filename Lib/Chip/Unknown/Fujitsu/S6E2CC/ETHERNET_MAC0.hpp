...
//Ethernet-MAC 0
    ...
    namespace Nonerwffr{    ///<Remote Wake-up Frame Filter Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> rwffr{}; 
    }
    ...
    namespace Noneimr{    ///<Interrupt Mask Register
        ...
        ///LPI Interrupt Mask
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> lpiim{}; 
        ///Time Stamp Interrupt Mask
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> tsim{}; 
        ///PMT Interrupt Mask
    ...
    namespace Nonemar0h{    ///<MAC Address0 Register (High)
        ...
        ///MAC Address0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> a0{}; 
    }
    namespace Nonemar0l{    ///<MAC Address0 Register (Low)
        using Addr = Register::Address<0x40064044,0x00000000,0,unsigned>;
        ///MAC Address0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> a0{}; 
    }
    namespace Nonemar1h{    ///<MAC Address1 Register -High
        ...
        ///MAC Address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> a{}; 
    }
    namespace Nonemar1l{    ///<MAC Address1 Register -Low
        using Addr = Register::Address<0x4006404c,0x00000000,0,unsigned>;
        ///MAC Address
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> a{}; 
    }
    ...
    namespace Nonerdlar{    ///<Receive Descriptor List Address Register)
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,2),Register::ReadWriteAccess,unsigned> srl{}; 
    }
    namespace Nonetdlar{    ///< Transmit Descriptor List Address Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,2),Register::ReadWriteAccess,unsigned> stl{}; 
    }
