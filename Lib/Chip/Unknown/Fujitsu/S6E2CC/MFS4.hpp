...
//Multi-function Serial Interface 0
    ...
    namespace Mfs4CsioScstr0{    ///<Serial Chip Select Timing Register 0
    ...
    namespace Mfs4CsioScstr1{    ///<Serial Chip Select Timing Register 1
    ...
    namespace Mfs4CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
    ...
    namespace Mfs4CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038421,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs4CsioSacsr{    ///<Serial Support Control Register
    ...
    namespace Mfs4CsioStmr{    ///<Serial Timer Register
    ...
    namespace Mfs4CsioStmcr{    ///<Serial Timer Comparison Register
    ...
    namespace Mfs4CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038430,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs4CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038434,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs4CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038435,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs4CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038438,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs4I2cNfcr{    ///<Noise Filter Control Register
    ...
    namespace Mfs4I2cEibcr{    ///<Extension I2C Bus Control Register
