...
//Quadrature Position/Revolution Counter 0
    ...
    namespace Qprc2Qecr{    ///<QPRC Extension Control Register
        using Addr = Register::Address<0x4002609c,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Qprc2Qprcrr{    ///<Quad Counter Position Rotation Count Register
        using Addr = Register::Address<0x400260bc,0x00000000,0x00000000,unsigned>;
