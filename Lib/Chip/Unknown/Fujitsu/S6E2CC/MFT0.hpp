...
//Multifunction Timer 0
    ...
    namespace NoneocuOcsd10{    ///<OCU ch.0/1 Control Register D
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> ofex1{}; 
        ///extends the matching determination conditions of the connected FRT with the OCCP(0) register value
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> ofex0{}; 
        ///sets the linked transfer settings with the FRT interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> oebm1{}; 
        ///sets the linked transfer settings with the FRT interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> oebm0{}; 
        ///sets the linked transfer settings with the FRT interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> opbm1{}; 
        ///sets the linked transfer settings with the FRT interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> opbm0{}; 
    ...
    namespace NonewfgNzcl{    ///<NZCL Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> dhold{}; 
    ...
    namespace NoneadcmpAcsc0{    ///<ADCMP ch.0 Control Register C
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> apbm{}; 
    ...
    namespace NoneadcmpAcmc0{    ///<ADCMP ch.0 Mask Compare Value Storage Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> mpce{}; 
        ///specifies whether a comparison is performed with the FRT zero interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> mzce{}; 
        ///specifies the value to be compared with the FRT interrupt mask counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> amc{}; 
    }
    ...
    namespace NonefrtTcsd{    ///<ERROR!!!!!!!!!!!!!!!!!!!!
        ...
        ///ERROR!!!!!!!!!!!!!!!!!!!!
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ofmd2{}; 
        ///ERROR!!!!!!!!!!!!!!!!!!!!
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> ofmd1{}; 
    }
}
