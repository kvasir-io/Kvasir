...
//Multifunction Timer 0
    namespace Mft0FrtTccp0{    ///<FRT-ch.0 Cycle Setting Register
        using Addr = Register::Address<0x40020142,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcdt0{    ///<FRT-ch.0 Count Value Register
        using Addr = Register::Address<0x40020146,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsa0{    ///<FRT-ch.0 Control Register A
        using Addr = Register::Address<0x40020148,0xffff1c00,0x00000000,unsigned>;
    ...
    namespace Mft0FrtTcsc0{    ///<FRT-ch.0 Control Register C
        using Addr = Register::Address<0x4002014a,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mft0FrtTccp1{    ///<FRT-ch.1 Cycle Setting Register
        using Addr = Register::Address<0x4002014e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcdt1{    ///<FRT-ch.1 Count Value Register
        using Addr = Register::Address<0x40020152,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsa1{    ///<FRT-ch.1 Control Register A
        using Addr = Register::Address<0x40020154,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsc1{    ///<FRT-ch.1 Control Register C
        using Addr = Register::Address<0x40020156,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTccp2{    ///<FRT-ch.2 Cycle Setting Register
        using Addr = Register::Address<0x4002015a,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcdt2{    ///<FRT-ch.2 Count Value Register
        using Addr = Register::Address<0x4002015e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsa2{    ///<FRT-ch.2 Control Register A
        using Addr = Register::Address<0x40020160,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsc2{    ///<FRT-ch.2 Control Register C
        using Addr = Register::Address<0x40020162,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcal{    ///<FRT Simultaneous Start Control Register
        using Addr = Register::Address<0x40020164,0xfe00fe00,0x00000000,unsigned>;
    ...
    namespace Mft0OcuOccp0{    ///<OCU ch.0 Compare Value Store Register
        using Addr = Register::Address<0x40020102,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOccp1{    ///<OCU ch.1 Compare Value Store Register
        using Addr = Register::Address<0x40020106,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOccp2{    ///<OCU ch.2 Compare Value Store Register
        using Addr = Register::Address<0x4002010a,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOccp3{    ///<OCU ch.3 Compare Value Store Register
        using Addr = Register::Address<0x4002010e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOccp4{    ///<OCU ch.4 Compare Value Store Register
        using Addr = Register::Address<0x40020112,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOccp5{    ///<OCU ch.5 Compare Value Store Register
        using Addr = Register::Address<0x40020116,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsa10{    ///<OCU ch.0/1 Control Register A
        using Addr = Register::Address<0x40020118,0xffffff0c,0x00000000,unsigned char>;
    ...
    namespace Mft0OcuOcsb10{    ///<OCU ch.0/1 Control Register B
        using Addr = Register::Address<0x40020119,0xffffff6c,0x00000000,unsigned char>;
    ...
    namespace Mft0OcuOcsd10{    ///<OCU ch.0/1 Control Register D
        using Addr = Register::Address<0x4002011a,0xffffc000,0x00000000,unsigned>;
    ...
    namespace Mft0OcuOcsa32{    ///<OCU ch.2/3 Control Register A
        using Addr = Register::Address<0x4002011c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsb32{    ///<OCU ch.2/3 Control Register B
        using Addr = Register::Address<0x4002011d,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsd32{    ///<OCU ch.2/3 Control Register D
        using Addr = Register::Address<0x4002011e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsa54{    ///<OCU ch.4/5 Control Register A
        using Addr = Register::Address<0x40020120,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsb54{    ///<OCU ch.4/5 Control Register B
        using Addr = Register::Address<0x40020121,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsd54{    ///<OCU ch.4/5 Control Register D
        using Addr = Register::Address<0x40020122,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcsc{    ///<OCU Control Register C
        using Addr = Register::Address<0x40020124,0xffffc0ff,0x00000000,unsigned>;
    ...
    namespace Mft0OcuOcse0{    ///<OCU ch.0 Control Register E
        using Addr = Register::Address<0x40020128,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mft0OcuOcse1{    ///<OCU ch.1 Control Register E
        using Addr = Register::Address<0x4002012c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Mft0OcuOcse2{    ///<OCU ch.2 Control Register E
        using Addr = Register::Address<0x40020130,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcse3{    ///<OCU ch.3 Control Register E
        using Addr = Register::Address<0x40020134,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcse4{    ///<OCU ch.4 Control Register E
        using Addr = Register::Address<0x40020138,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcse5{    ///<OCU ch.5 Control Register E
        using Addr = Register::Address<0x4002013c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcfs10{    ///<OCU ch.0/1 Connecting FRT Select Register
        using Addr = Register::Address<0x40020168,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mft0OcuOcfs32{    ///<OCU ch.2/3 Connecting FRT Select Register
        using Addr = Register::Address<0x40020169,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0OcuOcfs54{    ///<OCU ch.4/5 Connecting FRT Select Register
        using Addr = Register::Address<0x4002016a,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftf10{    ///<Pulse Counter Value Register for WFG ch.0/1
        using Addr = Register::Address<0x4002018e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta10{    ///<WFG Timer Value Register for WFG ch.0/1
        using Addr = Register::Address<0x40020190,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftb10{    ///<WFG Timer Value Register for WFG ch.0/1
        using Addr = Register::Address<0x40020192,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftf32{    ///<Pulse Counter Value Register for WFG ch.2/3
        using Addr = Register::Address<0x40020196,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta32{    ///<WFG Timer Value Register for WFG ch.2/3
        using Addr = Register::Address<0x40020198,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftb32{    ///<WFG Timer Value Register for WFG ch.2/3
        using Addr = Register::Address<0x4002019a,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftf54{    ///<Pulse Counter Value Register for WFG ch.4/5
        using Addr = Register::Address<0x4002019e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta54{    ///<WFG Timer Value Register for WFG ch.4/5
        using Addr = Register::Address<0x400201a0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWftb54{    ///<WFG Timer Value Register for WFG ch.4/5
        using Addr = Register::Address<0x400201a2,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfsa10{    ///<WFG Control Register A for WFG ch.0/1
        using Addr = Register::Address<0x400201a4,0xffffc000,0x00000000,unsigned>;
    ...
    namespace Mft0WfgWfsa32{    ///<WFG Control Register A for WFG ch.2/3
        using Addr = Register::Address<0x400201a8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfsa54{    ///<WFG Control Register A for WFG ch.4/5
        using Addr = Register::Address<0x400201ac,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfir{    ///<WFG Interrupt Control Register
        using Addr = Register::Address<0x400201b0,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mft0WfgNzcl{    ///<NZCL Control Register
        using Addr = Register::Address<0x400201b4,0xffff8c40,0x00000000,unsigned>;
    ...
    namespace Mft0IcuIcfs10{    ///<ICU ch.0/1 Connecting FRT Select Register
        using Addr = Register::Address<0x4002016c,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mft0IcuIcfs32{    ///<ICU ch.2/3 Connecting FRT Select Register
        using Addr = Register::Address<0x4002016d,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIccp0{    ///<ICU-ch.0 Capture Value Store Register
        using Addr = Register::Address<0x40020176,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIccp1{    ///<ICU-ch.1 Capture Value Store Register
        using Addr = Register::Address<0x4002017a,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIccp2{    ///<ICU-ch.2 Capture Value Store Register
        using Addr = Register::Address<0x4002017e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIccp3{    ///<ICU-ch.3 Capture Value Store Register
        using Addr = Register::Address<0x40020182,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIcsa10{    ///<ICU ch.0/1 Control Register A
        using Addr = Register::Address<0x40020184,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mft0IcuIcsb10{    ///<ICU ch.0/1 Control Register B
        using Addr = Register::Address<0x40020185,0xfffffffc,0x00000000,unsigned char>;
    ...
    namespace Mft0IcuIcsa32{    ///<ICU ch.2/3 Control Register A
        using Addr = Register::Address<0x40020188,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0IcuIcsb32{    ///<ICU ch.2/3 Control Register B
        using Addr = Register::Address<0x40020189,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcfs10{    ///<ADCMP ch.0/1 Connecting FRT Select Register
        using Addr = Register::Address<0x40020170,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mft0AdcmpAcfs32{    ///<ADCMP ch.2/3 Connecting FRT Select Register
        using Addr = Register::Address<0x40020171,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcfs54{    ///<ADCMP ch.4/5 Connecting FRT Select Register
        using Addr = Register::Address<0x40020172,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp0{    ///<ADCMP ch.0 Compare Value Store Register
        using Addr = Register::Address<0x400201ba,0xffff0000,0x00000000,unsigned>;
        ///0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> acmp{}; 
    }
    namespace Mft0AdcmpAcmp1{    ///<ADCMP ch.1 Compare Value Store Register
        using Addr = Register::Address<0x400201be,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp2{    ///<ADCMP ch.2 Compare Value Store Register
        using Addr = Register::Address<0x400201c2,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp3{    ///<ADCMP ch.3 Compare Value Store Register
        using Addr = Register::Address<0x400201c6,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp4{    ///<ADCMP ch.4 Compare Value Store Register
        using Addr = Register::Address<0x400201ca,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp5{    ///<ADCMP ch.5 Compare Value Store Register
        using Addr = Register::Address<0x400201ce,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsa{    ///<ADCMP Control Register A
        using Addr = Register::Address<0x400201d0,0xffffc0c0,0x00000000,unsigned>;
    ...
    namespace Mft0AdcmpAcsc0{    ///<ADCMP ch.0 Control Register C
        using Addr = Register::Address<0x400201d4,0xffffffc0,0x00000000,unsigned char>;
    ...
    namespace Mft0AdcmpAcsd0{    ///<ADCMP ch.0 Control Register D
        using Addr = Register::Address<0x400201d5,0xffffff0c,0x00000000,unsigned char>;
    ...
    namespace Mft0AdcmpAcmc0{    ///<ADCMP ch.0 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201d6,0xffffff30,0x00000000,unsigned char>;
    ...
    namespace Mft0AdcmpAcsc1{    ///<ADCMP ch.1 Control Register C
        using Addr = Register::Address<0x400201d8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsd1{    ///<ADCMP ch.1 Control Register D
        using Addr = Register::Address<0x400201d9,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmc1{    ///<ADCMP ch.1 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201da,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsc2{    ///<ADCMP ch.2 Control Register C
        using Addr = Register::Address<0x400201dc,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsd2{    ///<ADCMP ch.2 Control Register D
        using Addr = Register::Address<0x400201dd,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmc2{    ///<ADCMP ch.2 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201de,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsc3{    ///<ADCMP ch.3 Control Register C
        using Addr = Register::Address<0x400201e0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsd3{    ///<ADCMP ch.3 Control Register D
        using Addr = Register::Address<0x400201e1,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmc3{    ///<ADCMP ch.3 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201e2,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsc4{    ///<ADCMP ch.4 Control Register C
        using Addr = Register::Address<0x400201e4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsd4{    ///<ADCMP ch.4 Control Register D
        using Addr = Register::Address<0x400201e5,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmc4{    ///<ADCMP ch.4 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201e6,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsc5{    ///<ADCMP ch.5 Control Register C
        using Addr = Register::Address<0x400201e8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcsd5{    ///<ADCMP ch.5 Control Register D
        using Addr = Register::Address<0x400201e9,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmc5{    ///<ADCMP ch.5 Mask Compare Value Storage Register
        using Addr = Register::Address<0x400201ea,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcsd{    ///<ERROR!!!!!!!!!!!!!!!!!!!!
        using Addr = Register::Address<0x400201ec,0xfffffffc,0x00000000,unsigned char>;
        ///ERROR!!!!!!!!!!!!!!!!!!!!
