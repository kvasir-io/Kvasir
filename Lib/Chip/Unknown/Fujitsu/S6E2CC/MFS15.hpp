...
//Multi-function Serial Interface 0
    namespace Mfs15UartScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038f01,0xffffff60,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff12,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038f05,0xffffff40,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038f04,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038f08,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15UartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038f08,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15UartBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038f0c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs15UartFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
    ...
    namespace Mfs15UartFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15UartFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038f01,0xffffff00,0x00000000,unsigned char>;
        ///Programmable clear bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> upcl{}; 
    ...
    namespace Mfs15CsioSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff10,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038f05,0xffffff60,0x00000000,unsigned char>;
        ///Received error flag clear bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs15CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038f04,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038f08,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15CsioTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038f08,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15CsioBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038f0c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bgr0{}; 
    }
    namespace Mfs15CsioFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs15CsioFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs15CsioFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioScstr0{    ///<Serial Chip Select Timing Register 0
        using Addr = Register::Address<0x40038f1c,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioScstr1{    ///<Serial Chip Select Timing Register 1
        using Addr = Register::Address<0x40038f1d,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
        using Addr = Register::Address<0x40038f20,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs15CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038f21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioSacsr{    ///<Serial Support Control Register
        using Addr = Register::Address<0x40038f24,0xffffc620,0x00000000,unsigned>;
    ...
    namespace Mfs15CsioStmr{    ///<Serial Timer Register
        using Addr = Register::Address<0x40038f28,0xffff0000,0x00000000,unsigned>;
        ///Timer Data bits
    ...
    namespace Mfs15CsioStmcr{    ///<Serial Timer Comparison Register
        using Addr = Register::Address<0x40038f2c,0xffff0000,0x00000000,unsigned>;
        ///Compare bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> tc{}; 
    }
    namespace Mfs15CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038f30,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs15CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038f34,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038f35,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038f38,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15CsioTbyte0{    ///<Transfer Byte Register 0
        using Addr = Register::Address<0x40038f3c,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioTbyte1{    ///<Transfer Byte Register 1
        using Addr = Register::Address<0x40038f3d,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioTbyte2{    ///<Transfer Byte Register 2
        using Addr = Register::Address<0x40038f40,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioTbyte3{    ///<Transfer Byte Register 3
        using Addr = Register::Address<0x40038f41,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15LinScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038f01,0xffffff00,0x00000000,unsigned char>;
        ///Programmable clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> upcl{}; 
        ///Master/Slave function select bit 
    ...
    namespace Mfs15LinSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff06,0x00000000,unsigned char>;
    ...
    namespace Mfs15LinSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038f05,0xffffff40,0x00000000,unsigned char>;
        ///Received Error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs15LinEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038f04,0xffffffa0,0x00000000,unsigned char>;
    ...
    namespace Mfs15LinRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15LinTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs15LinBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038f0c,0xffff0000,0x00000000,unsigned>;
        ///External clock select bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        ///Baud Rate Generator Registers 1
    ...
    namespace Mfs15LinFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs15LinFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs15LinFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15LinFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cIbcr{    ///<I2C Bus Control Register
        using Addr = Register::Address<0x40038f01,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15I2cSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038f00,0xffffff13,0x00000000,unsigned char>;
        ///operation mode set bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        ///Received interrupt enable bit
    ...
    namespace Mfs15I2cIbsr{    ///<I2C Bus Status Register
        using Addr = Register::Address<0x40038f04,0xffffff00,0x00000000,unsigned char>;
        ///First byte bit
    ...
    namespace Mfs15I2cSsr{    ///<Serial Status Register 
        using Addr = Register::Address<0x40038f05,0xffffff00,0x00000000,unsigned char>;
        ///Received error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs15I2cRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs15I2cTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs15I2cBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x40038f0c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
    ...
    namespace Mfs15I2cIsmk{    ///<7-bit Slave Address Mask Register
        using Addr = Register::Address<0x40038f11,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15I2cIsba{    ///<7-bit Slave Address Register
        using Addr = Register::Address<0x40038f10,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs15I2cFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs15I2cFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs15I2cFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cNfcr{    ///<Noise Filter Control Register
        using Addr = Register::Address<0x40038f1c,0xffffffe0,0x00000000,unsigned char>;
    ...
    namespace Mfs15I2cEibcr{    ///<Extension I2C Bus Control Register
        using Addr = Register::Address<0x40038f1d,0xffffffc0,0x00000000,unsigned char>;
        ///SDA status bit
