...
//Multi-function Serial Interface 0
    namespace Mfs8UartScr{    ///<Serial Control Register
    ...
    namespace Mfs8UartSmr{    ///<Serial Mode Register
    ...
    namespace Mfs8UartSsr{    ///<Serial Status Register
    ...
    namespace Mfs8UartEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs8UartRdr{    ///<Received Data Register
    ...
    namespace Mfs8UartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038808,0xfffffe00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs8UartBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs8UartFcr1{    ///<FIFO Control Register 1
    ...
    namespace Mfs8UartFcr0{    ///<FIFO Control Register 0
    ...
    namespace Mfs8CsioSmr{    ///<Serial Mode Register
    ...
    namespace Mfs8CsioSsr{    ///<Serial Status Register
    ...
    namespace Mfs8CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038804,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs8CsioRdr{    ///<Received Data Register
    ...
    namespace Mfs8CsioTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038808,0xffff0000,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs8CsioBgr{    ///<Baud Rate Generator Registers
    ...
    namespace Mfs8CsioFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038815,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs8CsioFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038814,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs8CsioFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038818,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8CsioFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038819,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8CsioScstr0{    ///<Serial Chip Select Timing Register 0
    ...
    namespace Mfs8CsioScstr1{    ///<Serial Chip Select Timing Register 1
    ...
    namespace Mfs8CsioScstr2{    ///<Serial Chip Select Timing Registers 2/3
    ...
    namespace Mfs8CsioScstr3{    ///<Serial Chip Select Timing Registers 3
        using Addr = Register::Address<0x40038821,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8CsioSacsr{    ///<Serial Support Control Register
    ...
    namespace Mfs8CsioStmr{    ///<Serial Timer Register
    ...
    namespace Mfs8CsioStmcr{    ///<Serial Timer Comparison Register
    ...
    namespace Mfs8CsioScscr{    ///<Serial Chip Select Control Status Register
        using Addr = Register::Address<0x40038830,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Mfs8CsioScsfr0{    ///<Serial Chip Select Format Register 0
        using Addr = Register::Address<0x40038834,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs8CsioScsfr1{    ///<Serial Chip Select Format Register 1
        using Addr = Register::Address<0x40038835,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs8CsioScsfr2{    ///<Serial Chip Select Format Register 2
        using Addr = Register::Address<0x40038838,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs8LinSmr{    ///<Serial Mode Register
    ...
    namespace Mfs8LinSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038805,0xffffff40,0x00000000,unsigned char>;
        ///Received Error flag clear bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Mfs8LinEscr{    ///<Extended Communication Control Register
    ...
    namespace Mfs8LinRdr{    ///<Received Data Register
    ...
    namespace Mfs8LinTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038808,0xffffff00,0x00000000,unsigned>;
        ///Data
    ...
    namespace Mfs8LinBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003880c,0xffff0000,0x00000000,unsigned>;
        ///External clock select bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        ///Baud Rate Generator Registers 1
    ...
    namespace Mfs8LinFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038815,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs8LinFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038814,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs8LinFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038818,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8LinFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038819,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8I2cIbcr{    ///<I2C Bus Control Register
        using Addr = Register::Address<0x40038801,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs8I2cSmr{    ///<Serial Mode Register
    ...
    namespace Mfs8I2cIbsr{    ///<I2C Bus Status Register
        using Addr = Register::Address<0x40038804,0xffffff00,0x00000000,unsigned char>;
        ///First byte bit
    ...
    namespace Mfs8I2cSsr{    ///<Serial Status Register 
    ...
    namespace Mfs8I2cRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038808,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs8I2cTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038808,0xffffff00,0x00000000,unsigned>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs8I2cBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003880c,0xffff8000,0x00000000,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
    ...
    namespace Mfs8I2cIsmk{    ///<7-bit Slave Address Mask Register
    ...
    namespace Mfs8I2cIsba{    ///<7-bit Slave Address Register
    ...
    namespace Mfs8I2cFcr1{    ///<FIFO Control Register 1
        using Addr = Register::Address<0x40038815,0xffffffe0,0x00000000,unsigned char>;
        ///Re-transmission data lost detect enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        ///Received FIFO idle detection enable bit 
    ...
    namespace Mfs8I2cFcr0{    ///<FIFO Control Register 0
        using Addr = Register::Address<0x40038814,0xffffff80,0x00000000,unsigned char>;
        ///FIFO re-transmit data lost flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        ///FIFO pointer reload bit 
    ...
    namespace Mfs8I2cFbyte1{    ///<FIFO Byte Register 1
        using Addr = Register::Address<0x40038818,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8I2cFbyte2{    ///<FIFO Byte Register 2
        using Addr = Register::Address<0x40038819,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs8I2cNfcr{    ///<Noise Filter Control Register
    ...
    namespace Mfs8I2cEibcr{    ///<Extension I2C Bus Control Register
