...
namespace Kvasir {
    ...
    namespace Nonecken2{
        using Addr = Register::Address<0x4003c120,0xececfe8c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> QSPICK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> CECCK1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> CECCK0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> PCRCCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> I2SCK1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> I2SCK0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SDCCK; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CANCK2; 
    ...
    namespace Nonemrst2{
        using Addr = Register::Address<0x4003c124,0xececfe8c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,28)> QSPIRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> CECRST1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24)> CECRST0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> PCRCRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> I2SRST1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> I2SRST0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SDCRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CANRST2; 
