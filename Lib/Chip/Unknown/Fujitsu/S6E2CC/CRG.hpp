...
//Clock Unit Registers
    namespace CrgScmCtl{    ///<System Clock Mode Control Register
        using Addr = Register::Address<0x40010000,0xffffff05,0x00000000,unsigned>;
    ...
    namespace CrgScmStr{    ///<System Clock Mode Status Register
        using Addr = Register::Address<0x40010004,0xffffff05,0x00000000,unsigned>;
    ...
    namespace CrgBscPsr{    ///<Base Clock Prescaler Register
        using Addr = Register::Address<0x40010010,0xfffffff8,0x00000000,unsigned>;
    ...
    namespace CrgApbc0Psr{    ///<APB0 Prescaler Register
        using Addr = Register::Address<0x40010014,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace CrgApbc1Psr{    ///<APB1 Prescaler Register
        using Addr = Register::Address<0x40010018,0xffffff6c,0x00000000,unsigned>;
    ...
    namespace CrgApbc2Psr{    ///<APB2 Prescaler Register
        using Addr = Register::Address<0x4001001c,0xffffff6c,0x00000000,unsigned>;
    ...
    namespace CrgSwcPsr{    ///<Software Watchdog Clock Prescaler Register
        using Addr = Register::Address<0x40010020,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace CrgTtcPsr{    ///<Trace Clock Prescaler Register
        using Addr = Register::Address<0x40010028,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace CrgCswTmr{    ///<Clock Stabilization Wait Time Register
        using Addr = Register::Address<0x40010030,0xffffff00,0x00000000,unsigned>;
    ...
    namespace CrgPswTmr{    ///<PLL Clock Stabilization Wait Time Setup Register
        using Addr = Register::Address<0x40010034,0xffffffe8,0x00000000,unsigned>;
    ...
    namespace CrgPllCtl1{    ///<PLL Control Register 1
        using Addr = Register::Address<0x40010038,0xffffff00,0x00000000,unsigned>;
    ...
    namespace CrgPllCtl2{    ///<PLL Control Register 2
        using Addr = Register::Address<0x4001003c,0xffffffc0,0x00000000,unsigned>;
    ...
    namespace CrgCsvStr{    ///<CSV status register
        using Addr = Register::Address<0x40010044,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace CrgDbwdtCtl{    ///<Debug Break Watchdog Timer Control Register
        using Addr = Register::Address<0x40010054,0xffffff5f,0x00000000,unsigned>;
    ...
    namespace CrgIntEnr{    ///< Interrupt Enable Register
        using Addr = Register::Address<0x40010060,0xffffffd8,0x00000000,unsigned>;
    ...
    namespace CrgIntStr{    ///<Interrupt Status Register
        using Addr = Register::Address<0x40010064,0xffffffd8,0x00000000,unsigned>;
    ...
    namespace CrgIntClr{    ///<Interrupt Clear Register
        using Addr = Register::Address<0x40010068,0xffffffd8,0x00000000,unsigned>;
