...
//Interrupts
    ...
    namespace Noneirq03mon{    ///<IRQ03 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> wave2int3{}; 
        ///WFG timer 32 interrupt request in MFT unit 2 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> wave2int2{}; 
        ///WFG timer 10 interrupt request in MFT unit 2 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> wave2int1{}; 
        ///DTIF (motor emergency stop) interrupt request in MFT unit 2 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> wave2int0{}; 
    ...
    namespace Noneirq05mon{    ///<IRQ05 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> extint23{}; 
        ///Interrupt request on external interrupt ch.30
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> extint22{}; 
        ///Interrupt request on external interrupt ch.29
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> extint21{}; 
        ///Interrupt request on external interrupt ch.28
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> extint20{}; 
        ///Interrupt request on external interrupt ch.27
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> extint19{}; 
        ///Interrupt request on external interrupt ch.26
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> extint18{}; 
        ///Interrupt request on external interrupt ch.25
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> extint17{}; 
        ///Interrupt request on external interrupt ch.24
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> extint16{}; 
    ...
    namespace Noneirq06mon{    ///<IRQ06 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> qud2int5{}; 
        ///Interrupt request detected RC out of range on QPRC ch.2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> qud2int4{}; 
        ///PC count invert interrupt request on QPRC ch.2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> qud2int3{}; 
        ///Overflow/underflow/zero index interrupt request on QPRC ch.2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> qud2int2{}; 
        ///PC and RC match interrupt request on QPRC ch.2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> qud2int1{}; 
        ///PC match interrupt request on QPRC ch.2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> qud2int0{}; 
    ...
    namespace Noneirq23mon{    ///<IRQ23 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> ppgint8{}; 
        ///Interrupt request on PPG ch.18
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> ppgint7{}; 
        ///Interrupt request on PPG ch.16
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> ppgint6{}; 
    ...
    namespace Noneirq28mon{    ///<IRQ28 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> frt2int5{}; 
        ///Zero detection interrupt request on the free run timer ch.1 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> frt2int4{}; 
        ///Zero detection interrupt request on the free run timer ch.0 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> frt2int3{}; 
        ///Peak value detection interrupt request on the free run timer ch.2 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> frt2int2{}; 
        ///Peak value detection interrupt request on the free run timer ch.1 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> frt2int1{}; 
        ///Peak value detection interrupt request on the free run timer ch.0 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> frt2int0{}; 
    ...
    namespace Noneirq29mon{    ///<IRQ29 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> icu2int3{}; 
        ///Interrupt request on the input capture ch.2 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> icu2int2{}; 
        ///Interrupt request on the input capture ch.1 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9),Register::ReadWriteAccess,unsigned> icu2int1{}; 
        ///Interrupt request on the input capture ch.0 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> icu2int0{}; 
    ...
    namespace Noneirq30mon{    ///<IRQ30 Batch Read Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> ocu2int5{}; 
        ///Interrupt request on the output compare ch.4 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> ocu2int4{}; 
        ///Interrupt request on the output compare ch.3 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ocu2int3{}; 
        ///Interrupt request on the output compare ch.2 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> ocu2int2{}; 
        ///Interrupt request on the output compare ch.1 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> ocu2int1{}; 
        ///Interrupt request on the output compare ch.0 in the MFT unit 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> ocu2int0{}; 
    ...
    namespace Noneirq32mon{    ///<IRQ32 Batch Read Register
        using Addr = Register::Address<0x40031094,0xfffffff0,0,unsigned>;
        ///LPI interrupt request of Ethernet MAC ch.0 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> mac0lpi{}; 
        ///PMI interrupt request of Ethernet MAC ch.0 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> mac0pmi{}; 
        ///SBD interrupt request of Ethernet MAC ch.0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> mac0sbd{}; 
        ///Interrupt request of CAN ch.0 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> can0int{}; 
    }
    namespace Noneirq33mon{    ///<IRQ33 Batch Read Register
        using Addr = Register::Address<0x40031098,0xfffffff0,0,unsigned>;
        ///LPI interrupt request of Ethernet MAC ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> mac1lpi{}; 
        ///PMI interrupt request of Ethernet MAC ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> mac1pmi{}; 
        ///SBD interrupt request of Ethernet MAC ch.1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> mac1sbd{}; 
        ///Interrupt request of CAN ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> can1int{}; 
    }
    ...
    namespace Noneirq36mon{    ///<IRQ36 Batch Read Register
        using Addr = Register::Address<0x400310a4,0xffffffe0,0,unsigned>;
        ///Endpoint 5 DRQ interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> usb1int4{}; 
        ///Endpoint 4 DRQ interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> usb1int3{}; 
        ///Endpoint 3 DRQ interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> usb1int2{}; 
        ///Endpoint 2 DRQ interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> usb1int1{}; 
        ///Endpoint 1 DRQ interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> usb1int0{}; 
    }
    namespace Noneirq37mon{    ///<IRQ37 Batch Read Register
        using Addr = Register::Address<0x400310a8,0xffffffc0,0,unsigned>;
        ///"Status (SOFIRQ, CMPIRO) interrupt request on the USB ch.1 "
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> usb1int5{}; 
        ///"Status (DIRQ, URIRQ, RWKIRQ, CNNIRQ) interrupt request on the USB ch.1 "
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> usb1int4{}; 
        ///Status (SPK) interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> usb1int3{}; 
        ///"Status (SUSP, SOF, BRST, CONF, WKUP) interrupt request on the USB ch.1 "
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> usb1int2{}; 
        ///Endpoint 0 DRQO interrupt request on the USB ch.1 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> usb1int1{}; 
        ///Endpoint 0 DRQI interrupt request on the USB ch.1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> usb1int0{}; 
    }
    ...
    namespace Nonedrqsel1{    ///<DMA Request Select Register 1
        using Addr = Register::Address<0x40031200,0xffffffe0,0,unsigned>;
        ///Interrupt signal of EP5 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> drqsel14{}; 
        ///Interrupt signal of EP4 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> drqsel13{}; 
        ///Interrupt signal of EP3 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> drqsel12{}; 
        ///Interrupt signal of EP2 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> drqsel11{}; 
        ///Interrupt signal of EP1 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> drqsel10{}; 
    }
    namespace Nonedqesel{    ///<DMA Request Extended Selection Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,28),Register::ReadWriteAccess,unsigned> esel31{}; 
        ///Connect USB-ch1 to IDREQ [30]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(27,24),Register::ReadWriteAccess,unsigned> esel30{}; 
        ///Connect USB-ch1 to IDREQ [27]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,20),Register::ReadWriteAccess,unsigned> esel27{}; 
        ///Connect USB-ch1 to IDREQ [26]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> esel26{}; 
        ///Connect USB-ch1 to IDREQ [25]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,12),Register::ReadWriteAccess,unsigned> esel25{}; 
        ///Connect USB-ch1 to IDREQ [24]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,8),Register::ReadWriteAccess,unsigned> esel24{}; 
        ///Connect USB-ch1 to IDREQ [11]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> esel11{}; 
        ///Connect USB-ch1 to IDREQ [10]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> esel10{}; 
    }
    namespace Noneoddpks1{    ///<USB ch.1 Odd Packet Size DMA Enable Register
        using Addr = Register::Address<0x4003120f,0xffffffe0,0,unsigned char>;
        ///"When the transfer destination address of the DMAC is USB.EP5DT, convert the bit width of the last transfer data to byte."
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> oddpks14{}; 
        ///"When the transfer destination address of the DMAC is USB.EP4DT, convert the bit width of the last transfer data to byte."
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> oddpks13{}; 
        ///"When the transfer destination address of the DMAC is USB.EP3DT, convert the bit width of the last transfer data to byte."
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> oddpks12{}; 
        ///"When the transfer destination address of the DMAC is USB.EP2DT, convert the bit width of the last transfer data to byte."
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> oddpks11{}; 
        ///"When the transfer destination address of the DMAC is USB.EP1DT, convert the bit width of the last transfer data to byte."
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> oddpks10{}; 
    }
}
