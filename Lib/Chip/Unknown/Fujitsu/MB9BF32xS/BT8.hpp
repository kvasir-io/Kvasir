...
namespace Kvasir {
//Base Timer 0
    namespace Bt8PwmTmcr{    ///<Timer Control Register
    ...
    namespace Bt8PwmTmcr2{    ///<Timer Control Register 2
    ...
    namespace Bt8PwmStc{    ///< Status Control Register
    ...
    namespace Bt8PpgTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025411,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt8PpgStc{    ///<Status Control Register
    ...
    namespace Bt8PpgPrll{    ///<LOW Width Reload Register
        using Addr = Register::Address<0x40025400,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt8PpgPrlh{    ///<HIGH Width Reload Register
        using Addr = Register::Address<0x40025404,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt8PpgTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025408,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt8RtTmcr{    ///<Timer Control Register
    ...
    namespace Bt8RtTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025411,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt8RtStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025410,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit 
    ...
    namespace Bt8RtPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x40025400,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt8RtTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025408,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt8PwcTmcr{    ///<Timer Control Register
    ...
    namespace Bt8PwcTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025411,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt8PwcStc{    ///<Status Control Register
    ...
    namespace Bt8PwcDtbf{    ///<Data Buffer Register
        using Addr = Register::Address<0x40025404,0xffffffff,0x00000000,unsigned>;
    }
}
