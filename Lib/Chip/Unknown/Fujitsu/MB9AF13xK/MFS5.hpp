...
//Multi-function Serial Interface 5
    namespace NoneuartScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038501,0xffffff60,0,unsigned char>;
    ...
    namespace NoneuartSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038500,0xffffff02,0,unsigned char>;
    ...
    namespace NoneuartSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038505,0xffffff40,0,unsigned char>;
    ...
    namespace NoneuartEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038504,0xffffff00,0,unsigned char>;
    ...
    namespace NoneuartRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038508,0xffffffff,0,unsigned>;
    }
    namespace NoneuartTdr{    ///<Transmit Data Register
        using Addr = Register::Address<0x40038508,0xffffffff,0,unsigned>;
    }
    namespace NoneuartBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003850c,0xffff0000,0,unsigned>;
    ...
    namespace NonecsioScr{    ///<Serial Control Register
        using Addr = Register::Address<0x40038501,0xffffff00,0,unsigned char>;
        ///Programmable clear bit 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> upcl{}; 
    ...
    namespace NonecsioSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038500,0xffffff00,0,unsigned char>;
    ...
    namespace NonecsioSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038505,0xffffff70,0,unsigned char>;
        ///Received error flag clear bit 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        ///Overrun error flag bit 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> ore{}; 
    ...
    namespace NonecsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038504,0xffffff60,0,unsigned char>;
    ...
    namespace NonecsioBgr{    ///<Baud Rate Generator Registers
        using Addr = Register::Address<0x4003850c,0xffff8000,0,unsigned>;
        ///Baud Rate Generator Registers 1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        ///Baud Rate Generator Registers 0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> bgr0{}; 
    ...
    namespace Nonei2cSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038500,0xffffff03,0,unsigned char>;
        ///operation mode set bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        ///Wake-up control bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
    ...
    namespace Nonei2cSsr{    ///<Serial Status Register 
        using Addr = Register::Address<0x40038505,0xffffff00,0,unsigned char>;
        ///Received error flag clear bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
    ...
    namespace Nonei2cIsmk{    ///<7-bit Slave Address Mask Register
        using Addr = Register::Address<0x40038511,0xffffff00,0,unsigned char>;
    ...
    namespace Nonei2cIsba{    ///<7-bit Slave Address Register
        using Addr = Register::Address<0x40038510,0xffffff00,0,unsigned char>;
