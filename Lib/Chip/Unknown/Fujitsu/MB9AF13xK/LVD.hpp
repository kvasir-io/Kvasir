...
//Low-voltage Detection
    namespace NonelvdCtl{    ///<Low-voltage Detection Voltage Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> lvdre{}; 
        ///Low-voltage detection reset voltage setting bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,10),Register::ReadWriteAccess,unsigned> svhr{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> lvdim{}; 
    }
    ...
    namespace NonelvdStr2{    ///<Low-voltage Detection Circuit Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> lvdrrdy{}; 
    }
}
