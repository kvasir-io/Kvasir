...
//General-purpose I/O ports
    ...
    namespace GpioPfr9{    ///<Port function setting register 9
        using Addr = Register::Address<0x40033024,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace GpioPfrb{    ///<Port function setting register B
        using Addr = Register::Address<0x4003302c,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace GpioEpfr09{    ///<Extended pin function setting register 09
        using Addr = Register::Address<0x40033624,0xfff00fc0,0x00000000,unsigned>;
