...
//Watch Counter
    ...
    namespace NoneclkSel{    ///<Clock Selection Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> selOut{}; 
        ///Input clock selection bit 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> selIn{}; 
    }
