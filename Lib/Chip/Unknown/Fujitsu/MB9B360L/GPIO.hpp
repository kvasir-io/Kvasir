...
//0
    namespace GpioPfr0{    ///<Port Function Setting Register 0
        using Addr = Register::Address<0x4006f000,0xffffffe0,0x00000000,unsigned>;
        ///Bit4 of PFR0
    ...
    namespace GpioPfr1{    ///<Port Function Setting Register 1
        using Addr = Register::Address<0x4006f004,0xfffffff0,0x00000000,unsigned>;
        ///Bit3 of PFR1
    ...
    namespace GpioPfr2{    ///<Port Function Setting Register 2
        using Addr = Register::Address<0x4006f008,0xffffff80,0x00000000,unsigned>;
        ///Bit6 of PFR2
    ...
    namespace GpioPfr3{    ///<Port Function Setting Register 3
        using Addr = Register::Address<0x4006f00c,0xffffffc0,0x00000000,unsigned>;
        ///Bit5 of PFR3
    ...
    namespace GpioPfr4{    ///<Port Function Setting Register 4
        using Addr = Register::Address<0x4006f010,0xfffffc3c,0x00000000,unsigned>;
        ///Bit9 of PFR4
    ...
    namespace GpioPfr5{    ///<Port Function Setting Register 5
        using Addr = Register::Address<0x4006f014,0xffffff00,0x00000000,unsigned>;
        ///Bit7 of PFR5
    ...
    namespace GpioPfr6{    ///<Port Function Setting Register 6
        using Addr = Register::Address<0x4006f018,0xffffff80,0x00000000,unsigned>;
        ///Bit6 of PFR6
    ...
    namespace GpioDdr0{    ///<Port input/output Direction Setting Register 0
        using Addr = Register::Address<0x4006f200,0xffffffe0,0x00000000,unsigned>;
        ///Bit4 of DDR0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> p04{}; 
        ///Bit3 of DDR0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> p03{}; 
    ...
    namespace GpioEpfr08{    ///<Extended Pin Function Setting Register 08
        using Addr = Register::Address<0x4006f620,0xffc0fc00,0x00000000,unsigned>;
    ...
    namespace GpioEpfr09{    ///<Extended Pin Function Setting Register 09
        using Addr = Register::Address<0x4006f624,0xf0f00fc0,0x00000000,unsigned>;
    ...
    namespace GpioEpfr10{    ///<Extended Pin Function Setting Register 10
        using Addr = Register::Address<0x4006f628,0xffffffff,0x00000000,unsigned>;
    }
    namespace GpioEpfr11{    ///<Extended Pin Function Setting Register 11
        using Addr = Register::Address<0x4006f62c,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace GpioEpfr14{    ///<Extended Pin Function Setting Register 14
        using Addr = Register::Address<0x4006f638,0xc003ffff,0x00000000,unsigned>;
    ...
    namespace GpioEpfr16{    ///<Extended Pin Function Setting Register 16
        using Addr = Register::Address<0x4006f640,0xcfffffff,0x00000000,unsigned>;
    ...
    namespace GpioEpfr17{    ///<Extended Pin Function Setting Register 17
        using Addr = Register::Address<0x4006f644,0xffffffff,0x00000000,unsigned>;
    }
    namespace GpioEpfr18{    ///<Extended Pin Function Setting Register 18
        using Addr = Register::Address<0x4006f648,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace GpioEpfr20{    ///<Extended Pin Function Setting Register 20
        using Addr = Register::Address<0x4006f650,0xffffffff,0x00000000,unsigned>;
    }
