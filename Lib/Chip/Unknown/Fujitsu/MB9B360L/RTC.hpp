...
//REAL-TIME CLOCK
    ...
    namespace Nonewttr0{    ///<Timer Setting Register 0
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> tm70{}; 
    }
    namespace Nonewttr1{    ///<Timer Setting Register 1
        using Addr = Register::Address<0x4003b150,0xffffff00,0,unsigned char>;
        ///Timer Setting Register
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> tm158{}; 
    }
    namespace Nonewttr2{    ///<Timer Setting Register 2
        using Addr = Register::Address<0x4003b154,0xfffffffc,0,unsigned char>;
        ///Timer Setting Register
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0),Register::ReadWriteAccess,unsigned> tm1716{}; 
    }
