...
//Interrupts
    ...
    namespace IntreqIrq05mon{    ///<IRQ05 Batch Read Register
        using Addr = Register::Address<0x40031028,0xffff0000,0x00000000,unsigned>;
    ...
    namespace IntreqIrq20mon{    ///<IRQ20 Batch Read Register
        using Addr = Register::Address<0x40031064,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace IntreqIrq22mon{    ///<IRQ22 Batch Read Register
        using Addr = Register::Address<0x4003106c,0xfffffff0,0x00000000,unsigned>;
