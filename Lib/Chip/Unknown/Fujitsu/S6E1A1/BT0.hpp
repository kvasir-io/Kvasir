...
namespace Kvasir {
    namespace Nonepwm_tmcr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,12)> CKS; 
    ...
    namespace Nonert_tmcr2{
        using Addr = Register::Address<0x40025011,0xffffff7e>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> GATE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> CKS3; 
    }
