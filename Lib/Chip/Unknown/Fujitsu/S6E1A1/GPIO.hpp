...
//I/O Port Registers
    ...
    namespace Noneepfr00{    ///<Extended Pin Function Setting Register 00
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> swden{}; 
    ...
    namespace Noneepfr02{    ///<Extended Pin Function Setting Register 02
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> igtrg0{}; 
    ...
    namespace Noneepfr21{    ///<Extended Pin Function Setting Register 21
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> qzin0s{}; 
        ///QPRC-ch.0 BIN Input Pin bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> qbin0s{}; 
        ///QPRC-ch.0 AIN Input Pin bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> qain0s{}; 
    }
    namespace Noneepfr22{    ///<Extended Pin Function Setting Register 22
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> scs31e{}; 
        ///SCS30 Input/Output Select bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12),Register::ReadWriteAccess,unsigned> scs30b{}; 
        ///SCS11 Output Select bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6),Register::ReadWriteAccess,unsigned> scs11e{}; 
        ///SCS10 Input/Output Select bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> scs10b{}; 
    }
