...
//Multifunction Timer 0
    ...
    namespace Mft0OcuOcsd10{    ///<OCU ch.0/1 Control Register D
        using Addr = Register::Address<0x4002011a,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mft0OcuOcsc{    ///<OCU Control Register C
        using Addr = Register::Address<0x40020125,0xffffffc0,0x00000000,unsigned char>;
        ///OCSC.MOD4 and OCSC.MOD5 determine the operation mode of OCU ch.4/ch.5 in combination with OCSB54.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> mod5{}; 
        ///OCSC.MOD4 and OCSC.MOD5 determine the operation mode of OCU ch.4/ch.5 in combination with OCSB54.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> mod4{}; 
        ///OCSC.MOD2 and OCSC.MOD3 determine the operation mode of OCU ch.2/ch.3 in combination with OCSB32.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> mod3{}; 
        ///OCSC.MOD2 and OCSC.MOD3 determine the operation mode of OCU ch.2/ch.3 in combination with OCSB32.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> mod2{}; 
        ///OCSC.MOD0 and OCSC.MOD1 determine the operation mode of OCU ch.0/ch.1 in combination with OCSB10.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> mod1{}; 
        ///OCSC.MOD0 and OCSC.MOD1 determine the operation mode of OCU ch.0/ch.1 in combination with OCSB10.CMOD
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> mod0{}; 
    }
    ...
    namespace Mft0WfgNzcl{    ///<NZCL Control Register
        using Addr = Register::Address<0x400201b4,0xffff8cc0,0x00000000,unsigned>;
    ...
    namespace Mft0AdcmpAcsc0{    ///<ADCMP ch.0 Control Register C
        using Addr = Register::Address<0x400201d4,0xffffffe0,0x00000000,unsigned char>;
