...
namespace Kvasir {
    ...
    namespace Noneocu_ocsd10{
        using Addr = Register::Address<0x4002011a,0xffffff00>;
    ...
    namespace Noneocu_ocsc{
        using Addr = Register::Address<0x40020125,0xffffffc0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> MOD5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> MOD4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> MOD3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> MOD2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> MOD1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> MOD0; 
    }
    ...
    namespace Nonewfg_nzcl{
        using Addr = Register::Address<0x400201b4,0xffff8cc0>;
    ...
    namespace Noneadcmp_acsc0{
        using Addr = Register::Address<0x400201d4,0xffffffe0>;
