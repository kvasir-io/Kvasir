...
//Clock Unit Registers
    namespace NonescmCtl{    ///<System Clock Mode Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> hcre{}; 
    }
    namespace NonescmStr{    ///<System Clock Mode Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> hcrdy{}; 
    }
