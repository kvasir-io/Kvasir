...
//Dual Timer
    ...
    namespace Nonetimer1control{    ///<Control Register
        ...
        ///Enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> timeren{}; 
        ///Mode bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> timermode{}; 
        ///Interrupt enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> intenable{}; 
        ///Prescale bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> timerpre{}; 
        ///Counter size bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> timersize{}; 
        ///One-shot mode bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> oneshot{}; 
    }
    ...
    namespace Nonetimer1ris{    ///<Interrupt Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> timer1ris{}; 
    }
    namespace Nonetimer1mis{    ///<Masked Interrupt Status Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> timer1mis{}; 
    }
