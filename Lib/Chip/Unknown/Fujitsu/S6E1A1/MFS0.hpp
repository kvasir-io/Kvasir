...
namespace Kvasir {
    ...
    namespace Nonecsio_escr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CSFE; 
    ...
    namespace Nonecsio_scscr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14)> SST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12)> SED; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10)> SCD; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> CSEN3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> CSEN2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> CSEN1; 
    ...
    namespace Nonecsio_scsfr0{
        using Addr = Register::Address<0x40038034,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> CS1CSLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CS1SCINV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CS1SPI; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> CS1BDS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> CS1L; 
    }
    namespace Nonecsio_scsfr1{
        using Addr = Register::Address<0x40038035,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> CS2CSLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CS2SCINV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CS2SPI; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> CS2BDS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> CS2L; 
    }
    namespace Nonecsio_scsfr2{
        using Addr = Register::Address<0x40038038,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> CS0CSLVL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> CS0SCINV; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CS0SPI; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> CS0BDS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> CS0L; 
    }
    ...
    namespace Nonelin_smr{
        using Addr = Register::Address<0x40038000,0xffffff16>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,5)> MD; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> SBL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> SOE; 
    }
