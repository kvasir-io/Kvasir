...
//Quadrature Position/Revolution Counter 0 Noise Filter
    namespace Qprc0NfNfctla{    ///<AIN Noise Control Register
        using Addr = Register::Address<0x40026100,0xffffffc8,0x00000000,unsigned>;
        ///Mask bit
    ...
    namespace Qprc0NfNfctlb{    ///<BIN Noise Control Register
        using Addr = Register::Address<0x40026104,0xffffffc8,0x00000000,unsigned>;
        ///Mask bit
    ...
    namespace Qprc0NfNfctlz{    ///<ZIN Noise Control Register
        using Addr = Register::Address<0x40026108,0xffffffc8,0x00000000,unsigned>;
        ///Mask bit
