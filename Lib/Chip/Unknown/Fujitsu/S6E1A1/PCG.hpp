...
namespace Kvasir {
    namespace Nonecken0{
        using Addr = Register::Address<0x4003c100,0xeef00000>;
    ...
    namespace Nonemrst0{
        using Addr = Register::Address<0x4003c104,0xfef00000>;
    ...
    namespace Nonecken2{
        using Addr = Register::Address<0x4003c120,0xffffffcf>;
    ...
    namespace Nonemrst2{
        using Addr = Register::Address<0x4003c124,0xffffffcf>;
