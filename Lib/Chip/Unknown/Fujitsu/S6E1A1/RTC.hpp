...
//REAL-TIME CLOCK
    ...
    namespace RtcWttr{    ///<Timer Setting Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,0),Register::ReadWriteAccess,unsigned> tm{}; 
    }
    ...
    namespace RtcWtcalprd{    ///<Frequency Correction Cycle Setting Register
