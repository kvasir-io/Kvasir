...
namespace Kvasir {
    ...
    namespace Nonelcdc_segen1{
        using Addr = Register::Address<0x4003200c,0x00000000>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> SEG16; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> SEG15; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14)> SEG14; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,9)> SEG09; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SEG08; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> SEG07; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> SEG06; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> SEG05; 
