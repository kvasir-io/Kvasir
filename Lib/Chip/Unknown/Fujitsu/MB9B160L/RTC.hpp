...
namespace Kvasir {
    ...
    namespace Nonewttr0{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> TM7_0; 
    }
    namespace Nonewttr1{
        using Addr = Register::Address<0x4003b150,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> TM15_8; 
    }
    namespace Nonewttr2{
        using Addr = Register::Address<0x4003b154,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> TM17_16; 
    }
