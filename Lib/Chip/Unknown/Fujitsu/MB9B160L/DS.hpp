...
//Low Power Consumption Mode
    ...
    namespace Nonewifsr{    ///<Deep Standby Return Cause Register 2
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> wui5{}; 
        ///WKUP pin input return bit 4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> wui4{}; 
    ...
    namespace Nonewier{    ///<Deep Standby Return Enable Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> wui5e{}; 
        ///WKUP pin input return enable bit 4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> wui4e{}; 
    ...
    namespace Nonewilvr{    ///<WKUP Pin Input Level Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wui5lv{}; 
        ///WKUP pin input level select bit 4
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> wui4lv{}; 
