...
//Interrupts
    ...
    namespace Noneirq003sel{    ///<Relocate Interrupt Selection Register (IRQ003)
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> selbit7{}; 
        ///Bit6 of the interrupt source is moved to bit6 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22),Register::ReadWriteAccess,unsigned> selbit6{}; 
        ///Bit5 of the interrupt source is moved to bit5 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,unsigned> selbit5{}; 
        ///Bit4 of the interrupt source is moved to bit4 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> selbit4{}; 
        ///Bit3 of the interrupt source is moved to bit3 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,unsigned> selbit3{}; 
        ///Bit2 of the interrupt source is moved to bit2 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> selbit2{}; 
        ///Bit1 of the interrupt source is moved to bit1 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> selbit1{}; 
        ///Bit0 of the interrupt source is moved to bit0 of the relocate interrupt.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> selbit0{}; 
    ...
    namespace Noneirq020mon{    ///<IRQ020 Batch Read Register
        using Addr = Register::Address<0x40031254,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq049mon{    ///<IRQ049 Batch Read Register
        using Addr = Register::Address<0x400312c8,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq070mon{    ///<IRQ070 Batch Read Register
        using Addr = Register::Address<0x4003131c,0xffffffff,0,unsigned>;
    }
    namespace Noneirq071mon{    ///<IRQ071 Batch Read Register
        using Addr = Register::Address<0x40031320,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq074mon{    ///<IRQ074 Batch Read Register
        using Addr = Register::Address<0x4003132c,0xffffffff,0,unsigned>;
    }
    namespace Noneirq075mon{    ///<IRQ075 Batch Read Register
        using Addr = Register::Address<0x40031330,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq096mon{    ///<IRQ096 Batch Read Register
        using Addr = Register::Address<0x40031384,0xffffffff,0,unsigned>;
    }
    namespace Noneirq097mon{    ///<IRQ097 Batch Read Register
        using Addr = Register::Address<0x40031388,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq103mon{    ///<IRQ103 Batch Read Register
        using Addr = Register::Address<0x400313a0,0xffffffff,0,unsigned>;
    }
    namespace Noneirq104mon{    ///<IRQ104 Batch Read Register
        using Addr = Register::Address<0x400313a4,0xffffffff,0,unsigned>;
    }
    namespace Noneirq105mon{    ///<IRQ105 Batch Read Register
        using Addr = Register::Address<0x400313a8,0xffffffff,0,unsigned>;
    }
    namespace Noneirq106mon{    ///<IRQ106 Batch Read Register
        using Addr = Register::Address<0x400313ac,0xffffffff,0,unsigned>;
    }
    namespace Noneirq107mon{    ///<IRQ107 Batch Read Register
        using Addr = Register::Address<0x400313b0,0xffffffff,0,unsigned>;
    }
    namespace Noneirq108mon{    ///<IRQ108 Batch Read Register
        using Addr = Register::Address<0x400313b4,0xffffffff,0,unsigned>;
    }
    namespace Noneirq109mon{    ///<IRQ109 Batch Read Register
        using Addr = Register::Address<0x400313b8,0xffffffff,0,unsigned>;
    }
    namespace Noneirq110mon{    ///<IRQ110 Batch Read Register
        using Addr = Register::Address<0x400313bc,0xffffffff,0,unsigned>;
    }
    namespace Noneirq111mon{    ///<IRQ111 Batch Read Register
        using Addr = Register::Address<0x400313c0,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq118mon{    ///<IRQ118 Batch Read Register
        using Addr = Register::Address<0x400313dc,0xffffffff,0,unsigned>;
    }
    ...
    namespace Noneirq120mon{    ///<IRQ120 Batch Read Register
        using Addr = Register::Address<0x400313e4,0xffffffff,0,unsigned>;
    }
    namespace Noneirq121mon{    ///<IRQ121 Batch Read Register
        using Addr = Register::Address<0x400313e8,0xffffffff,0,unsigned>;
    }
    namespace Noneirq122mon{    ///<IRQ122 Batch Read Register
        using Addr = Register::Address<0x400313ec,0xffffffff,0,unsigned>;
    }
    namespace Noneirq123mon{    ///<IRQ123 Batch Read Register
        using Addr = Register::Address<0x400313f0,0xffffffff,0,unsigned>;
    }
    namespace Noneirq124mon{    ///<IRQ124 Batch Read Register
        using Addr = Register::Address<0x400313f4,0xffffffff,0,unsigned>;
    }
    namespace Noneirq125mon{    ///<IRQ125 Batch Read Register
        using Addr = Register::Address<0x400313f8,0xffffffff,0,unsigned>;
    }
    namespace Noneirq126mon{    ///<IRQ126 Batch Read Register
        using Addr = Register::Address<0x400313fc,0xffffffff,0,unsigned>;
    }
    namespace Noneirq127mon{    ///<IRQ127 Batch Read Register
        using Addr = Register::Address<0x40031400,0xffffffff,0,unsigned>;
    }
}
