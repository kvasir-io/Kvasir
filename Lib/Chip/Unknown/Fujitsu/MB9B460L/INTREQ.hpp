...
//Interrupts
    ...
    namespace IntreqIrq020mon{    ///<IRQ020 Batch Read Register
        using Addr = Register::Address<0x40031254,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq049mon{    ///<IRQ049 Batch Read Register
        using Addr = Register::Address<0x400312c8,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq070mon{    ///<IRQ070 Batch Read Register
        using Addr = Register::Address<0x4003131c,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq071mon{    ///<IRQ071 Batch Read Register
        using Addr = Register::Address<0x40031320,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq074mon{    ///<IRQ074 Batch Read Register
        using Addr = Register::Address<0x4003132c,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq075mon{    ///<IRQ075 Batch Read Register
        using Addr = Register::Address<0x40031330,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq096mon{    ///<IRQ096 Batch Read Register
        using Addr = Register::Address<0x40031384,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq097mon{    ///<IRQ097 Batch Read Register
        using Addr = Register::Address<0x40031388,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq103mon{    ///<IRQ103 Batch Read Register
        using Addr = Register::Address<0x400313a0,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq104mon{    ///<IRQ104 Batch Read Register
        using Addr = Register::Address<0x400313a4,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq105mon{    ///<IRQ105 Batch Read Register
        using Addr = Register::Address<0x400313a8,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq106mon{    ///<IRQ106 Batch Read Register
        using Addr = Register::Address<0x400313ac,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq107mon{    ///<IRQ107 Batch Read Register
        using Addr = Register::Address<0x400313b0,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq108mon{    ///<IRQ108 Batch Read Register
        using Addr = Register::Address<0x400313b4,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq109mon{    ///<IRQ109 Batch Read Register
        using Addr = Register::Address<0x400313b8,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq110mon{    ///<IRQ110 Batch Read Register
        using Addr = Register::Address<0x400313bc,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq111mon{    ///<IRQ111 Batch Read Register
        using Addr = Register::Address<0x400313c0,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq114mon{    ///<IRQ114 Batch Read Register
    ...
    namespace IntreqIrq115mon{    ///<IRQ115 Batch Read Register
        using Addr = Register::Address<0x400313d0,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq116mon{    ///<IRQ116 Batch Read Register
        using Addr = Register::Address<0x400313d4,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq117mon{    ///<IRQ117 Batch Read Register
        using Addr = Register::Address<0x400313d8,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq118mon{    ///<IRQ118 Batch Read Register
        using Addr = Register::Address<0x400313dc,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq119mon{    ///<IRQ119 Batch Read Register
    ...
    namespace IntreqIrq120mon{    ///<IRQ120 Batch Read Register
        using Addr = Register::Address<0x400313e4,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq121mon{    ///<IRQ121 Batch Read Register
        using Addr = Register::Address<0x400313e8,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq122mon{    ///<IRQ122 Batch Read Register
        using Addr = Register::Address<0x400313ec,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq123mon{    ///<IRQ123 Batch Read Register
        using Addr = Register::Address<0x400313f0,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq124mon{    ///<IRQ124 Batch Read Register
        using Addr = Register::Address<0x400313f4,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq125mon{    ///<IRQ125 Batch Read Register
        using Addr = Register::Address<0x400313f8,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq126mon{    ///<IRQ126 Batch Read Register
        using Addr = Register::Address<0x400313fc,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq127mon{    ///<IRQ127 Batch Read Register
        using Addr = Register::Address<0x40031400,0xffffffff,0x00000000,unsigned>;
    }
}
