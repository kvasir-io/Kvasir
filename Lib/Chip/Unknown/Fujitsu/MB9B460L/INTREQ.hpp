...
namespace Kvasir {
    ...
    namespace Noneirq003sel{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23)> SELBIT7; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,22)> SELBIT6; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21)> SELBIT5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20)> SELBIT4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> SELBIT3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18)> SELBIT2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(17,17)> SELBIT1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> SELBIT0; 
    ...
    namespace Noneirq020mon{
        using Addr = Register::Address<0x40031254,0xffffffff>;
    }
    ...
    namespace Noneirq049mon{
        using Addr = Register::Address<0x400312c8,0xffffffff>;
    }
    ...
    namespace Noneirq059mon{
        using Addr = Register::Address<0x400312f0,0xfffffff0>;
    ...
    namespace Noneirq070mon{
        using Addr = Register::Address<0x4003131c,0xffffffff>;
    }
    namespace Noneirq071mon{
        using Addr = Register::Address<0x40031320,0xffffffff>;
    }
    ...
    namespace Noneirq074mon{
        using Addr = Register::Address<0x4003132c,0xffffffff>;
    }
    namespace Noneirq075mon{
        using Addr = Register::Address<0x40031330,0xffffffff>;
    }
    ...
    namespace Noneirq081mon{
        using Addr = Register::Address<0x40031348,0xfffffffe>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> CANINT; 
    }
    ...
    namespace Noneirq096mon{
        using Addr = Register::Address<0x40031384,0xffffffff>;
    }
    namespace Noneirq097mon{
        using Addr = Register::Address<0x40031388,0xffffffff>;
    }
    ...
    namespace Noneirq103mon{
        using Addr = Register::Address<0x400313a0,0xffffffff>;
    }
    namespace Noneirq104mon{
        using Addr = Register::Address<0x400313a4,0xffffffff>;
    }
    namespace Noneirq105mon{
        using Addr = Register::Address<0x400313a8,0xffffffff>;
    }
    namespace Noneirq106mon{
        using Addr = Register::Address<0x400313ac,0xffffffff>;
    }
    namespace Noneirq107mon{
        using Addr = Register::Address<0x400313b0,0xffffffff>;
    }
    namespace Noneirq108mon{
        using Addr = Register::Address<0x400313b4,0xffffffff>;
    }
    namespace Noneirq109mon{
        using Addr = Register::Address<0x400313b8,0xffffffff>;
    }
    namespace Noneirq110mon{
        using Addr = Register::Address<0x400313bc,0xffffffff>;
    }
    namespace Noneirq111mon{
        using Addr = Register::Address<0x400313c0,0xffffffff>;
    }
    namespace Noneirq112mon{
        using Addr = Register::Address<0x400313c4,0xffffffff>;
    }
    namespace Noneirq113mon{
        using Addr = Register::Address<0x400313c8,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> USB_DRQ_INT4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> USB_DRQ_INT3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> USB_DRQ_INT2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> USB_DRQ_INT1; 
    ...
    namespace Noneirq114mon{
        using Addr = Register::Address<0x400313cc,0xffffffc0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> USB_INT5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> USB_INT4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> USB_INT3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> USB_INT2; 
    ...
    namespace Noneirq115mon{
        using Addr = Register::Address<0x400313d0,0xffffffff>;
    }
    namespace Noneirq116mon{
        using Addr = Register::Address<0x400313d4,0xffffffff>;
    }
    namespace Noneirq117mon{
        using Addr = Register::Address<0x400313d8,0xffffffff>;
    }
    namespace Noneirq118mon{
        using Addr = Register::Address<0x400313dc,0xffffffff>;
    }
    ...
    namespace Noneirq120mon{
        using Addr = Register::Address<0x400313e4,0xffffffff>;
    }
    namespace Noneirq121mon{
        using Addr = Register::Address<0x400313e8,0xffffffff>;
    }
    namespace Noneirq122mon{
        using Addr = Register::Address<0x400313ec,0xffffffff>;
    }
    namespace Noneirq123mon{
        using Addr = Register::Address<0x400313f0,0xffffffff>;
    }
    namespace Noneirq124mon{
        using Addr = Register::Address<0x400313f4,0xffffffff>;
    }
    namespace Noneirq125mon{
        using Addr = Register::Address<0x400313f8,0xffffffff>;
    }
    namespace Noneirq126mon{
        using Addr = Register::Address<0x400313fc,0xffffffff>;
    }
    namespace Noneirq127mon{
        using Addr = Register::Address<0x40031400,0xffffffff>;
    }
}
