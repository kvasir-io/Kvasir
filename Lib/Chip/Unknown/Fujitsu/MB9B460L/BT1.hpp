...
namespace Kvasir {
//Base Timer 0
    namespace Bt1PwmTmcr{    ///<Timer Control Register
    ...
    namespace Bt1PwmTmcr2{    ///<Timer Control Register 2
    ...
    namespace Bt1PwmStc{    ///< Status Control Register
    ...
    namespace Bt1PpgTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025051,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt1PpgStc{    ///<Status Control Register
    ...
    namespace Bt1PpgPrll{    ///<LOW Width Reload Register
        using Addr = Register::Address<0x40025040,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt1PpgPrlh{    ///<HIGH Width Reload Register
        using Addr = Register::Address<0x40025044,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt1PpgTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025048,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt1RtTmcr{    ///<Timer Control Register
    ...
    namespace Bt1RtTmcr2{    ///<Timer Control Register 2
    ...
    namespace Bt1RtStc{    ///<Status Control Register
        using Addr = Register::Address<0x40025050,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit 
    ...
    namespace Bt1RtPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x40025040,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt1RtTmr{    ///<Timer Register
        using Addr = Register::Address<0x40025048,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt1PwcTmcr{    ///<Timer Control Register
    ...
    namespace Bt1PwcTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x40025051,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt1PwcStc{    ///<Status Control Register
    ...
    namespace Bt1PwcDtbf{    ///<Data Buffer Register
        using Addr = Register::Address<0x40025044,0xffffffff,0x00000000,unsigned>;
    }
}
