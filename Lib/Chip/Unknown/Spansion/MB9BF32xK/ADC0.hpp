...
namespace Kvasir {
    ...
    namespace Nonescfd{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> CS; 
    }
    namespace Nonescis3{
    ...
    namespace Nonepcfd{
        using Addr = Register::Address<0x4002701c,0x000fece0>;
    ...
    namespace Nonecmpcr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,5)> CMD; 
    ...
    namespace Noneadst1{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> ST; 
    }
    namespace Noneadst0{
