...
namespace Kvasir {
    namespace Noneenir{
        using Addr = Register::Address<0x40030000,0xff800f00>;
    ...
    namespace Noneeirr{
        using Addr = Register::Address<0x40030004,0xff800f00>;
    ...
    namespace Noneeicl{
        using Addr = Register::Address<0x40030008,0xff800f00>;
    ...
    namespace Noneelvr{
        using Addr = Register::Address<0x4003000c,0x00ff0000>;
    ...
    namespace Noneelvr1{
        using Addr = Register::Address<0x40030010,0xffffc000>;
