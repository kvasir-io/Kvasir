...
//Multi-function Serial Interface 0
    ...
    namespace Mfs6UartSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038600,0xffffff02,0x00000000,unsigned char>;
    ...
    namespace Mfs6UartRdr{    ///<Received Data Register
        using Addr = Register::Address<0x40038608,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace Mfs6CsioSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038600,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace Mfs6CsioSsr{    ///<Serial Status Register
        using Addr = Register::Address<0x40038605,0xffffff70,0x00000000,unsigned char>;
        ///Received error flag clear bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        ///Overrun error flag bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ore{}; 
    ...
    namespace Mfs6CsioEscr{    ///<Extended Communication Control Register
        using Addr = Register::Address<0x40038604,0xffffff60,0x00000000,unsigned char>;
    ...
    namespace Mfs6I2cSmr{    ///<Serial Mode Register
        using Addr = Register::Address<0x40038600,0xffffff03,0x00000000,unsigned char>;
        ///operation mode set bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        ///Wake-up control bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
