...
namespace Kvasir {
    namespace Noneenir{
        using Addr = Register::Address<0x40030000,0xff000200>;
    ...
    namespace Noneeirr{
        using Addr = Register::Address<0x40030004,0xff000200>;
    ...
    namespace Noneeicl{
        using Addr = Register::Address<0x40030008,0xff000200>;
    ...
    namespace Noneelvr{
        using Addr = Register::Address<0x4003000c,0x000c0000>;
