...
// peripheral MFS0 
    ...
    namespace Mfs7UartSmr{    ///< register UART_SMR 
        using Addr = Register::Address<0x40038700,0xffffff02,0x00000000,unsigned char>;
        /// bitfield MD 
    ...
    namespace Mfs7UartRdr{    ///< register UART_RDR 
        using Addr = Register::Address<0x40038708,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace Mfs7CsioSmr{    ///< register CSIO_SMR 
        using Addr = Register::Address<0x40038700,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MD 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        /// bitfield WUCR 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
    ...
    namespace Mfs7CsioSsr{    ///< register CSIO_SSR 
        using Addr = Register::Address<0x40038705,0xffffff70,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield ORE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ore{}; 
    ...
    namespace Mfs7CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038704,0xffffff60,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs7I2cSmr{    ///< register I2C_SMR 
        using Addr = Register::Address<0x40038700,0xffffff03,0x00000000,unsigned char>;
        /// bitfield MD 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        /// bitfield WUCR 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
