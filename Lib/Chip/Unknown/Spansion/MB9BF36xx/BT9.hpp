...
namespace Kvasir {
// peripheral BT0 
    namespace Bt9PwmTmcr{    ///< register PWM_TMCR 
    ...
    namespace Bt9PwmTmcr2{    ///< register PWM_TMCR2 
    ...
    namespace Bt9PwmStc{    ///< register PWM_STC 
    ...
    namespace Bt9PpgTmcr2{    ///< register PPG_TMCR2 
    ...
    namespace Bt9PpgStc{    ///< register PPG_STC 
    ...
    namespace Bt9PpgPrll{    ///< register PPG_PRLL 
        using Addr = Register::Address<0x40025440,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PpgPrlh{    ///< register PPG_PRLH 
        using Addr = Register::Address<0x40025444,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PpgTmr{    ///< register PPG_TMR 
        using Addr = Register::Address<0x40025448,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9RtTmcr{    ///< register RT_TMCR 
    ...
    namespace Bt9RtTmcr2{    ///< register RT_TMCR2 
    ...
    namespace Bt9RtStc{    ///< register RT_STC 
        using Addr = Register::Address<0x40025450,0xffffffaa,0x00000000,unsigned char>;
        /// bitfield TGIE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        /// bitfield UDIE 
    ...
    namespace Bt9RtPcsr{    ///< register RT_PCSR 
        using Addr = Register::Address<0x40025440,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9RtTmr{    ///< register RT_TMR 
        using Addr = Register::Address<0x40025448,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt9PwcTmcr{    ///< register PWC_TMCR 
    ...
    namespace Bt9PwcTmcr2{    ///< register PWC_TMCR2 
        using Addr = Register::Address<0x40025451,0xfffffffe,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt9PwcStc{    ///< register PWC_STC 
    ...
    namespace Bt9PwcDtbf{    ///< register PWC_DTBF 
        using Addr = Register::Address<0x40025444,0xffffffff,0x00000000,unsigned>;
    }
}
