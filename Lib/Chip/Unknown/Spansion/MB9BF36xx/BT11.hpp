...
namespace Kvasir {
// peripheral BT0 
    namespace Bt11PwmTmcr{    ///< register PWM_TMCR 
    ...
    namespace Bt11PwmTmcr2{    ///< register PWM_TMCR2 
    ...
    namespace Bt11PwmStc{    ///< register PWM_STC 
    ...
    namespace Bt11PpgTmcr2{    ///< register PPG_TMCR2 
    ...
    namespace Bt11PpgStc{    ///< register PPG_STC 
    ...
    namespace Bt11PpgPrll{    ///< register PPG_PRLL 
        using Addr = Register::Address<0x400254c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt11PpgPrlh{    ///< register PPG_PRLH 
        using Addr = Register::Address<0x400254c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt11PpgTmr{    ///< register PPG_TMR 
        using Addr = Register::Address<0x400254c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt11RtTmcr{    ///< register RT_TMCR 
    ...
    namespace Bt11RtTmcr2{    ///< register RT_TMCR2 
        using Addr = Register::Address<0x400254d1,0xffffff7e,0x00000000,unsigned char>;
        /// bitfield GATE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> gate{}; 
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt11RtStc{    ///< register RT_STC 
        using Addr = Register::Address<0x400254d0,0xffffffaa,0x00000000,unsigned char>;
        /// bitfield TGIE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        /// bitfield UDIE 
    ...
    namespace Bt11RtPcsr{    ///< register RT_PCSR 
        using Addr = Register::Address<0x400254c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt11RtTmr{    ///< register RT_TMR 
        using Addr = Register::Address<0x400254c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt11PwcTmcr{    ///< register PWC_TMCR 
    ...
    namespace Bt11PwcTmcr2{    ///< register PWC_TMCR2 
        using Addr = Register::Address<0x400254d1,0xfffffffe,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt11PwcStc{    ///< register PWC_STC 
    ...
    namespace Bt11PwcDtbf{    ///< register PWC_DTBF 
        using Addr = Register::Address<0x400254c4,0xffffffff,0x00000000,unsigned>;
    }
}
