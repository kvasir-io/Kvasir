...
//ADC0 Registers
    ...
    namespace Adc0Scfd{    ///<Scan Conversion FIFO Data Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cs{}; 
    }
    ...
    namespace Adc0Pcfd{    ///<Priority Conversion FIFO Data Register
        using Addr = Register::Address<0x4002701c,0x000fece0,0x00000000,unsigned>;
    ...
    namespace Adc0Cmpcr{    ///<A/D Comparison Control Register
        ...
        ///Comparison mode 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,5),Register::ReadWriteAccess,unsigned> cmd{}; 
        ///Comparison mode 0
    ...
    namespace Adc0Adst1{    ///<Sampling Time Setup Register 1
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> st{}; 
    }
    ...
    namespace Adc0Adct{    ///<Comparison Time Setup Register
        using Addr = Register::Address<0x40027034,0xfffffff8,0x00000000,unsigned char>;
    ...
    namespace Adc0Adcen{    ///<A/D Operation Enable Setup Register
        using Addr = Register::Address<0x4002703c,0xfffffffc,0x00000000,unsigned char>;
