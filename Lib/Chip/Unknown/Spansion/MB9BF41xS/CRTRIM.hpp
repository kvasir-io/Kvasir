...
//CR Trimming Registers
    ...
    namespace NonemcrFtrm{    ///<High-speed CR oscillation Frequency Trimming Register
        using Addr = Register::Address<0x4002e004,0xffffff00,0,unsigned>;
        ///Frequency trimming setup bits
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> trd{}; 
    }
