...
namespace Kvasir {
    namespace Noneenir{
        using Addr = Register::Address<0x40030000,0xffff7fb0>;
    ...
    namespace Noneeirr{
        using Addr = Register::Address<0x40030004,0xffff7fb0>;
    ...
    namespace Noneeicl{
        using Addr = Register::Address<0x40030008,0xffff7fb0>;
    ...
    namespace Noneelvr{
        using Addr = Register::Address<0x4003000c,0x3fffcf00>;
