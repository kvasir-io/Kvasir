...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs9UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs9UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs9UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs9UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs9UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs9UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038908,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs9UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs9UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs9UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs9CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs9CsioSsr{    ///< register CSIO_SSR 
    ...
    namespace Mfs9CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038904,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs9CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs9CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038908,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs9CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs9CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038915,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs9CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038914,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs9CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038918,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038919,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs9CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs9CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs9CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038921,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs9CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs9CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs9CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038930,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs9LinSmr{    ///< register LIN_SMR 
    ...
    namespace Mfs9LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038905,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs9LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs9LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs9LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038908,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs9LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x4003890c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs9LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038915,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs9LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038914,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs9LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038918,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038919,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038901,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs9I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs9I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038904,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs9I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs9I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038908,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs9I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038908,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs9I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x4003890c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs9I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs9I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs9I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038915,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs9I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038914,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs9I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038918,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038919,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs9I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs9I2cEibcr{    ///< register I2C_EIBCR 
