...
namespace Kvasir {
// peripheral BT0 
    namespace Bt3PwmTmcr{    ///< register PWM_TMCR 
    ...
    namespace Bt3PwmTmcr2{    ///< register PWM_TMCR2 
    ...
    namespace Bt3PwmStc{    ///< register PWM_STC 
    ...
    namespace Bt3PpgTmcr2{    ///< register PPG_TMCR2 
    ...
    namespace Bt3PpgStc{    ///< register PPG_STC 
    ...
    namespace Bt3PpgPrll{    ///< register PPG_PRLL 
        using Addr = Register::Address<0x400250c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PpgPrlh{    ///< register PPG_PRLH 
        using Addr = Register::Address<0x400250c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PpgTmr{    ///< register PPG_TMR 
        using Addr = Register::Address<0x400250c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3RtTmcr{    ///< register RT_TMCR 
    ...
    namespace Bt3RtTmcr2{    ///< register RT_TMCR2 
    ...
    namespace Bt3RtStc{    ///< register RT_STC 
        using Addr = Register::Address<0x400250d0,0xffffffaa,0x00000000,unsigned char>;
        /// bitfield TGIE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        /// bitfield UDIE 
    ...
    namespace Bt3RtPcsr{    ///< register RT_PCSR 
        using Addr = Register::Address<0x400250c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3RtTmr{    ///< register RT_TMR 
        using Addr = Register::Address<0x400250c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PwcTmcr{    ///< register PWC_TMCR 
    ...
    namespace Bt3PwcTmcr2{    ///< register PWC_TMCR2 
        using Addr = Register::Address<0x400250d1,0xfffffffe,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt3PwcStc{    ///< register PWC_STC 
    ...
    namespace Bt3PwcDtbf{    ///< register PWC_DTBF 
        using Addr = Register::Address<0x400250c4,0xffffffff,0x00000000,unsigned>;
    }
}
