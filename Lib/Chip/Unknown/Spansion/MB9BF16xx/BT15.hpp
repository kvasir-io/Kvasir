...
// peripheral BT0 
    ...
    namespace Bt15PwmTmcr2{    ///< register PWM_TMCR2 
    ...
    namespace Bt15PwmStc{    ///< register PWM_STC 
    ...
    namespace Bt15PpgTmcr2{    ///< register PPG_TMCR2 
        using Addr = Register::Address<0x400256d1,0xfffffffd,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt15PpgStc{    ///< register PPG_STC 
    ...
    namespace Bt15PpgPrll{    ///< register PPG_PRLL 
        using Addr = Register::Address<0x400256c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt15PpgPrlh{    ///< register PPG_PRLH 
        using Addr = Register::Address<0x400256c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt15PpgTmr{    ///< register PPG_TMR 
        using Addr = Register::Address<0x400256c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt15RtTmcr{    ///< register RT_TMCR 
    ...
    namespace Bt15RtTmcr2{    ///< register RT_TMCR2 
        using Addr = Register::Address<0x400256d1,0xffffff7e,0x00000000,unsigned char>;
        /// bitfield GATE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> gate{}; 
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt15RtStc{    ///< register RT_STC 
        using Addr = Register::Address<0x400256d0,0xffffffaa,0x00000000,unsigned char>;
        /// bitfield TGIE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        /// bitfield UDIE 
    ...
    namespace Bt15RtPcsr{    ///< register RT_PCSR 
        using Addr = Register::Address<0x400256c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt15RtTmr{    ///< register RT_TMR 
        using Addr = Register::Address<0x400256c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt15PwcTmcr{    ///< register PWC_TMCR 
    ...
    namespace Bt15PwcTmcr2{    ///< register PWC_TMCR2 
        using Addr = Register::Address<0x400256d1,0xfffffffe,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt15PwcStc{    ///< register PWC_STC 
    ...
    namespace Bt15PwcDtbf{    ///< register PWC_DTBF 
        using Addr = Register::Address<0x400256c4,0xffffffff,0x00000000,unsigned>;
    }
}
