...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs15UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs15UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs15UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs15UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs15UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs15UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038f08,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs15UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs15UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs15UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs15CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs15CsioSsr{    ///< register CSIO_SSR 
    ...
    namespace Mfs15CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038f04,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs15CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs15CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038f08,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs15CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs15CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs15CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs15CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs15CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs15CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs15CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038f21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs15CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs15CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs15CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038f30,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs15LinSmr{    ///< register LIN_SMR 
    ...
    namespace Mfs15LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038f05,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs15LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs15LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs15LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs15LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x40038f0c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs15LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs15LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs15LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038f01,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs15I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs15I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038f04,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs15I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs15I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs15I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038f08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs15I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x40038f0c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs15I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs15I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs15I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038f15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs15I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038f14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs15I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038f18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038f19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs15I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs15I2cEibcr{    ///< register I2C_EIBCR 
