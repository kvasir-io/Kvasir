...
namespace Kvasir {
//Base Timer 0
    namespace Bt3PwmTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x400250cc,0xffff8080,0x00000000,unsigned>;
    ...
    namespace Bt3PwmTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x400250d1,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt3PwmStc{    ///< Status Control Register
        using Addr = Register::Address<0x400250d0,0xffffff88,0x00000000,unsigned char>;
    ...
    namespace Bt3PwmPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x400250c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PwmPdut{    ///<PWM Duty Set Register
        using Addr = Register::Address<0x400250c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PwmTmr{    ///<Timer Register
        using Addr = Register::Address<0x400250c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PpgTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x400250cc,0xffff8080,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
        ///Restart enable bit
    ...
    namespace Bt3PpgTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x400250d1,0xfffffffd,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt3PpgStc{    ///<Status Control Register
        using Addr = Register::Address<0x400250d0,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> udie{}; 
    ...
    namespace Bt3PpgPrll{    ///<LOW Width Reload Register
        using Addr = Register::Address<0x400250c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PpgPrlh{    ///<HIGH Width Reload Register
        using Addr = Register::Address<0x400250c4,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PpgTmr{    ///<Timer Register
        using Addr = Register::Address<0x400250c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3RtTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x400250cc,0xffff8c00,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
        ///Trigger input edge selection bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> egs{}; 
    ...
    namespace Bt3RtTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x400250d1,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt3RtStc{    ///<Status Control Register
        using Addr = Register::Address<0x400250d0,0xffffffaa,0x00000000,unsigned char>;
        ///Trigger interrupt request enable bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        ///Underflow interrupt request enable bit 
    ...
    namespace Bt3RtPcsr{    ///<PWM Cycle Set Register
        using Addr = Register::Address<0x400250c0,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3RtTmr{    ///<Timer Register
        using Addr = Register::Address<0x400250c8,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt3PwcTmcr{    ///<Timer Control Register
        using Addr = Register::Address<0x400250cc,0xffff8809,0x00000000,unsigned>;
        ///Count clock selection bit 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,12),Register::ReadWriteAccess,unsigned> cks20{}; 
    ...
    namespace Bt3PwcTmcr2{    ///<Timer Control Register 2
        using Addr = Register::Address<0x400250d1,0xfffffffe,0x00000000,unsigned char>;
        ///Count clock selection bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt3PwcStc{    ///<Status Control Register
        using Addr = Register::Address<0x400250d0,0xffffff2a,0x00000000,unsigned char>;
        ///Error flag bit
    ...
    namespace Bt3PwcDtbf{    ///<Data Buffer Register
        using Addr = Register::Address<0x400250c4,0xffffffff,0x00000000,unsigned>;
    }
}
