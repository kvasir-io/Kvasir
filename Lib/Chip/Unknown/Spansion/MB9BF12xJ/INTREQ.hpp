...
// peripheral INTREQ 
    ...
    namespace IntreqIrq04mon{    ///< register IRQ04MON 
        using Addr = Register::Address<0x40031024,0xffffff33,0x00000000,unsigned>;
        /// bitfield EXTINT7 
    ...
    namespace IntreqIrq05mon{    ///< register IRQ05MON 
        using Addr = Register::Address<0x40031028,0xfffff3bf,0x00000000,unsigned>;
        /// bitfield EXTINT11 
    ...
    namespace IntreqIrq06mon{    ///< register IRQ06MON 
        using Addr = Register::Address<0x4003102c,0xffffc0fc,0x00000000,unsigned>;
        /// bitfield QUD1INT5 
    ...
    namespace IntreqIrq13mon{    ///< register IRQ13MON 
        using Addr = Register::Address<0x40031048,0xffffffff,0x00000000,unsigned>;
    }
    namespace IntreqIrq14mon{    ///< register IRQ14MON 
        using Addr = Register::Address<0x4003104c,0xffffffff,0x00000000,unsigned>;
    }
