...
// peripheral MFS0 
    ...
    namespace Mfs1UartSmr{    ///< register UART_SMR 
        using Addr = Register::Address<0x40038100,0xffffff02,0x00000000,unsigned char>;
        /// bitfield MD 
    ...
    namespace Mfs1UartRdr{    ///< register UART_RDR 
        using Addr = Register::Address<0x40038108,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace Mfs1CsioSmr{    ///< register CSIO_SMR 
        using Addr = Register::Address<0x40038100,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MD 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        /// bitfield WUCR 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
    ...
    namespace Mfs1CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038104,0xffffff60,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs1I2cSmr{    ///< register I2C_SMR 
        using Addr = Register::Address<0x40038100,0xffffff03,0x00000000,unsigned char>;
        /// bitfield MD 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        /// bitfield WUCR 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> wucr{}; 
