...
//ADC0 Registers
    ...
    namespace Adc2Pcfd{    ///<Priority Conversion FIFO Data Register
        using Addr = Register::Address<0x4002721c,0x000fece0,0x00000000,unsigned>;
    ...
    namespace Adc2Adct{    ///<Comparison Time Setup Register
        using Addr = Register::Address<0x40027234,0xfffffff8,0x00000000,unsigned char>;
    ...
    namespace Adc2Adcen{    ///<A/D Operation Enable Setup Register
        using Addr = Register::Address<0x4002723c,0xfffffffc,0x00000000,unsigned char>;
