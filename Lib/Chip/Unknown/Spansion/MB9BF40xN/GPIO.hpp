...
//General-purpose I/O ports
    ...
    namespace Noneepfr00{    ///<Extended pin function setting register 00
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> croute{}; 
    ...
    namespace Noneepfr10{    ///<Extended pin function setting register 10
        using Addr = Register::Address<0x40033628,0x00001c40,0,unsigned>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> testb{}; 
    ...
    namespace Nonespsr{    ///<Special port setting register
        using Addr = Register::Address<0x40033580,0xfffffffe,0,unsigned>;
