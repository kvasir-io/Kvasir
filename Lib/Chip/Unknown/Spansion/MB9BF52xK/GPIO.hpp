...
namespace Kvasir {
    ...
    namespace Nonepfr1{
        using Addr = Register::Address<0x40033004,0xffffffc8>;
    ...
    namespace Noneade{
        using Addr = Register::Address<0x40033500,0xfe0b8fc8>;
    ...
    namespace Noneepfr06{
        using Addr = Register::Address<0x40033618,0x0fff0f00>;
    ...
    namespace Noneepfr09{
        using Addr = Register::Address<0x40033624,0x0ff00fc0>;
    ...
    namespace Noneepfr15{
        using Addr = Register::Address<0x4003363c,0xfffff000>;
