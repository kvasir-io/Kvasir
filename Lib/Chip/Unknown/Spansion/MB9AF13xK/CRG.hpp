...
namespace Kvasir {
    ...
    namespace Nonettc_psr{
        using Addr = Register::Address<0x40010028,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,0)> TTC; 
    }
    ...
    namespace Nonerst_str{
        using Addr = Register::Address<0x4001000c,0xfffffe04>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> LVDH; 
