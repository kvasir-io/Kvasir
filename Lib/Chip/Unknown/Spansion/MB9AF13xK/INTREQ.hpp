...
//Interrupts
    ...
    namespace IntreqIrq04mon{    ///<IRQ04 Batch Read Register
        using Addr = Register::Address<0x40031024,0xffffffb0,0x00000000,unsigned>;
    ...
    namespace IntreqIrq10mon{    ///<IRQ10 Batch Read Register
        using Addr = Register::Address<0x4003103c,0xffffffff,0x00000000,unsigned>;
    }
    ...
    namespace IntreqIrq18mon{    ///<IRQ18 Batch Read Register
        using Addr = Register::Address<0x4003105c,0xffffffff,0x00000000,unsigned>;
    }
