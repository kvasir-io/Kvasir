...
// peripheral MFT0 
    ...
    namespace Mft0FrtTcsc0{    ///< register FRT_TCSC0 
        using Addr = Register::Address<0x4002014b,0xffff0000,0x00000000,unsigned>;
        /// bitfield MSPC 
    ...
    namespace Mft0FrtTcsc1{    ///< register FRT_TCSC1 
    ...
    namespace Mft0FrtTcsc2{    ///< register FRT_TCSC2 
        using Addr = Register::Address<0x40020162,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0FrtTcal{    ///< register FRT_TCAL 
    ...
    namespace Mft0OcuOcsd10{    ///< register OCU_OCSD10 
    ...
    namespace Mft0OcuOcsd32{    ///< register OCU_OCSD32 
    ...
    namespace Mft0OcuOcsd54{    ///< register OCU_OCSD54 
    ...
    namespace Mft0WfgWftf10{    ///< register WFG_WFTF10 
        using Addr = Register::Address<0x4002018e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta10{    ///< register WFG_WFTA10 
        using Addr = Register::Address<0x40020190,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mft0WfgWftb10{    ///< register WFG_WFTB10 
        using Addr = Register::Address<0x40020192,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mft0WfgWftf32{    ///< register WFG_WFTF32 
        using Addr = Register::Address<0x40020196,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta32{    ///< register WFG_WFTA32 
        using Addr = Register::Address<0x40020198,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mft0WfgWftb32{    ///< register WFG_WFTB32 
        using Addr = Register::Address<0x4002019a,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mft0WfgWftf54{    ///< register WFG_WFTF54 
        using Addr = Register::Address<0x4002019e,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0WfgWfta54{    ///< register WFG_WFTA54 
        using Addr = Register::Address<0x400201a0,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mft0WfgWftb54{    ///< register WFG_WFTB54 
        using Addr = Register::Address<0x400201a2,0xffffffff,0x00000000,unsigned char>;
    }
    ...
    namespace Mft0AdcmpAcfs10{    ///< register ADCMP_ACFS10 
    ...
    namespace Mft0AdcmpAcfs32{    ///< register ADCMP_ACFS32 
        using Addr = Register::Address<0x40020171,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcfs54{    ///< register ADCMP_ACFS54 
        using Addr = Register::Address<0x40020172,0xffffffff,0x00000000,unsigned>;
    }
    namespace Mft0AdcmpAcmp0{    ///< register ADCMP_ACMP0 
    ...
    namespace Mft0AdcmpAcsc0{    ///< register ADCMP_ACSC0 
    ...
    namespace Mft0AdcmpAcsd0{    ///< register ADCMP_ACSD0 
