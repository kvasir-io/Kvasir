...
namespace Kvasir {
    ...
    namespace Nonefrt_tcsc0{
        using Addr = Register::Address<0x4002014b,0xffff0000>;
    ...
    namespace Noneocu_ocse0{
        using Addr = Register::Address<0x40020128,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> OCSE; 
    }
    namespace Noneocu_ocse1{
        using Addr = Register::Address<0x4002012c,0xffff0000>;
