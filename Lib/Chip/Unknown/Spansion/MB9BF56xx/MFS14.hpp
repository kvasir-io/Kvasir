...
// peripheral MFS0 
    ...
    namespace Mfs14CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038e04,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs14CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs14CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs14CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs14CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038e21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs14CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs14CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs14CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs14CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038e30,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs14I2cNfcr{    ///< register I2C_NFCR 
