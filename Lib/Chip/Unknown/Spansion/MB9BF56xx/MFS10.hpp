...
// peripheral MFS0 
    ...
    namespace Mfs10CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038a04,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs10CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs10CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs10CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs10CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038a21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs10CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs10CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs10CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs10CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038a30,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs10I2cNfcr{    ///< register I2C_NFCR 
