...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs2UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs2UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs2UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs2UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs2UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs2UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038208,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs2UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs2UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs2UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs2CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs2CsioSsr{    ///< register CSIO_SSR 
    ...
    namespace Mfs2CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038204,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs2CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs2CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038208,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs2CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs2CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038215,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs2CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038214,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs2CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038218,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038219,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs2CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs2CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs2CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038221,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs2CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs2CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs2CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038230,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs2LinSmr{    ///< register LIN_SMR 
    ...
    namespace Mfs2LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038205,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs2LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs2LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs2LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038208,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs2LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x4003820c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs2LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038215,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs2LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038214,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs2LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038218,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038219,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038201,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs2I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs2I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038204,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs2I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs2I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038208,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs2I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038208,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs2I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x4003820c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs2I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs2I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs2I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038215,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs2I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038214,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs2I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038218,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038219,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs2I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs2I2cEibcr{    ///< register I2C_EIBCR 
