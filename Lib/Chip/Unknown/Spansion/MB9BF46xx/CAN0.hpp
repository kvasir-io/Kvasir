...
namespace Kvasir {
// peripheral CAN0 
    namespace Can0Ctrlr{    ///< register CTRLR 
    ...
    namespace Can0Statr{    ///< register STATR 
    ...
    namespace Can0Errcnt{    ///< register ERRCNT 
    ...
    namespace Can0Btr{    ///< register BTR 
    ...
    namespace Can0Intr{    ///< register INTR 
    ...
    namespace Can0Testr{    ///< register TESTR 
    ...
    namespace Can0Brper{    ///< register BRPER 
    ...
    namespace Can0If1creq{    ///< register IF1CREQ 
    ...
    namespace Can0If1cmsk{    ///< register IF1CMSK 
    ...
    namespace Can0If1msk1{    ///< register IF1MSK1 
    ...
    namespace Can0If1msk2{    ///< register IF1MSK2 
    ...
    namespace Can0If1arb1{    ///< register IF1ARB1 
    ...
    namespace Can0If1arb2{    ///< register IF1ARB2 
    ...
    namespace Can0If1mctr{    ///< register IF1MCTR 
    ...
    namespace Can0If1dta1L{    ///< register IF1DTA1_L 
    ...
    namespace Can0If1dta2L{    ///< register IF1DTA2_L 
    ...
    namespace Can0If1dtb1L{    ///< register IF1DTB1_L 
    ...
    namespace Can0If1dtb2L{    ///< register IF1DTB2_L 
    ...
    namespace Can0If1dta2B{    ///< register IF1DTA2_B 
    ...
    namespace Can0If1dta1B{    ///< register IF1DTA1_B 
    ...
    namespace Can0If1dtb2B{    ///< register IF1DTB2_B 
    ...
    namespace Can0If1dtb1B{    ///< register IF1DTB1_B 
    ...
    namespace Can0If2creq{    ///< register IF2CREQ 
    ...
    namespace Can0If2cmsk{    ///< register IF2CMSK 
    ...
    namespace Can0If2msk1{    ///< register IF2MSK1 
    ...
    namespace Can0If2msk2{    ///< register IF2MSK2 
    ...
    namespace Can0If2arb1{    ///< register IF2ARB1 
    ...
    namespace Can0If2arb2{    ///< register IF2ARB2 
    ...
    namespace Can0If2mctr{    ///< register IF2MCTR 
    ...
    namespace Can0If2dta1L{    ///< register IF2DTA1_L 
    ...
    namespace Can0If2dta2L{    ///< register IF2DTA2_L 
    ...
    namespace Can0If2dtb1L{    ///< register IF2DTB1_L 
    ...
    namespace Can0If2dtb2L{    ///< register IF2DTB2_L 
    ...
    namespace Can0If2dta2B{    ///< register IF2DTA2_B 
    ...
    namespace Can0If2dta1B{    ///< register IF2DTA1_B 
    ...
    namespace Can0If2dtb2B{    ///< register IF2DTB2_B 
    ...
    namespace Can0If2dtb1B{    ///< register IF2DTB1_B 
    ...
    namespace Can0Treqr1{    ///< register TREQR1 
    ...
    namespace Can0Treqr2{    ///< register TREQR2 
    ...
    namespace Can0Newdt1{    ///< register NEWDT1 
    ...
    namespace Can0Newdt2{    ///< register NEWDT2 
    ...
    namespace Can0Intpnd1{    ///< register INTPND1 
    ...
    namespace Can0Intpnd2{    ///< register INTPND2 
    ...
    namespace Can0Msgval1{    ///< register MSGVAL1 
    ...
    namespace Can0Msgval2{    ///< register MSGVAL2 
