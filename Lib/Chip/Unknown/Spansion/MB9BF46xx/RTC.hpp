...
namespace Kvasir {
    ...
    namespace Nonewttr1{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> TM15; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> TM14; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> TM13; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> TM12; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TM11; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TM10; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TM9; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TM8; 
    }
    namespace Nonewttr2{
        using Addr = Register::Address<0x4003b154,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> TM17; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TM16; 
    }
    ...
    namespace Noneccs{
        using Addr = Register::Address<0x4003b17c,0xffffffff>;
    }
    namespace Noneccb{
        using Addr = Register::Address<0x4003b180,0xffffffff>;
    }
    namespace Nonetrim{
        using Addr = Register::Address<0x4003b184,0xffffffff>;
    }
    namespace Noneboost{
    ...
    namespace Nonefdet{
        using Addr = Register::Address<0x4003b194,0xffffffff>;
    }
    ...
    namespace Nonevbpfr{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> SPSR1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> SPSR0; 
