...
// peripheral QPRC0 
    ...
    namespace Qprc2Qecr{    ///< register QECR 
    ...
    namespace Qprc2Qicrl{    ///< register QICRL 
    ...
    namespace Qprc2Qicrh{    ///< register QICRH 
