...
namespace Kvasir {
// peripheral BT0 
    namespace Bt4PwmTmcr{    ///< register PWM_TMCR 
    ...
    namespace Bt4PwmTmcr2{    ///< register PWM_TMCR2 
    ...
    namespace Bt4PwmStc{    ///< register PWM_STC 
    ...
    namespace Bt4PpgTmcr2{    ///< register PPG_TMCR2 
    ...
    namespace Bt4PpgStc{    ///< register PPG_STC 
    ...
    namespace Bt4PpgPrll{    ///< register PPG_PRLL 
        using Addr = Register::Address<0x40025200,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt4PpgPrlh{    ///< register PPG_PRLH 
        using Addr = Register::Address<0x40025204,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt4PpgTmr{    ///< register PPG_TMR 
        using Addr = Register::Address<0x40025208,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt4RtTmcr{    ///< register RT_TMCR 
    ...
    namespace Bt4RtTmcr2{    ///< register RT_TMCR2 
    ...
    namespace Bt4RtStc{    ///< register RT_STC 
        using Addr = Register::Address<0x40025210,0xffffffaa,0x00000000,unsigned char>;
        /// bitfield TGIE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> tgie{}; 
        /// bitfield UDIE 
    ...
    namespace Bt4RtPcsr{    ///< register RT_PCSR 
        using Addr = Register::Address<0x40025200,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt4RtTmr{    ///< register RT_TMR 
        using Addr = Register::Address<0x40025208,0xffffffff,0x00000000,unsigned>;
    }
    namespace Bt4PwcTmcr{    ///< register PWC_TMCR 
    ...
    namespace Bt4PwcTmcr2{    ///< register PWC_TMCR2 
        using Addr = Register::Address<0x40025211,0xfffffffe,0x00000000,unsigned char>;
        /// bitfield CKS3 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cks3{}; 
    }
    namespace Bt4PwcStc{    ///< register PWC_STC 
    ...
    namespace Bt4PwcDtbf{    ///< register PWC_DTBF 
        using Addr = Register::Address<0x40025204,0xffffffff,0x00000000,unsigned>;
    }
}
