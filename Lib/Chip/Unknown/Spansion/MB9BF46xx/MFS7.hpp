...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs7UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs7UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs7UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs7UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs7UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs7UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038708,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs7UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs7UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs7UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs7CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs7CsioSsr{    ///< register CSIO_SSR 
    ...
    namespace Mfs7CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038704,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs7CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs7CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038708,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs7CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs7CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038715,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs7CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038714,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs7CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038718,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038719,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs7CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs7CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs7CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038721,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs7CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs7CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs7CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038730,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs7LinSmr{    ///< register LIN_SMR 
    ...
    namespace Mfs7LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038705,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs7LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs7LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs7LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038708,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs7LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x4003870c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs7LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038715,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs7LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038714,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs7LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038718,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038719,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038701,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs7I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs7I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038704,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs7I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs7I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038708,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs7I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038708,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs7I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x4003870c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs7I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs7I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs7I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038715,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs7I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038714,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs7I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038718,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038719,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs7I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs7I2cEibcr{    ///< register I2C_EIBCR 
