...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs13UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs13UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs13UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs13UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs13UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs13UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038d08,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs13UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs13UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs13UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs13CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs13CsioSsr{    ///< register CSIO_SSR 
    ...
    namespace Mfs13CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038d04,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs13CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs13CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038d08,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs13CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs13CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038d15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs13CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038d14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs13CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038d18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038d19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs13CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs13CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs13CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038d21,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs13CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs13CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs13CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038d30,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs13LinSmr{    ///< register LIN_SMR 
    ...
    namespace Mfs13LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038d05,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs13LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs13LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs13LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038d08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs13LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x40038d0c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs13LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038d15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs13LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038d14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs13LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038d18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038d19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038d01,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs13I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs13I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038d04,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs13I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs13I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038d08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs13I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038d08,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs13I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x40038d0c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs13I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs13I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs13I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038d15,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs13I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038d14,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs13I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038d18,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038d19,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs13I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs13I2cEibcr{    ///< register I2C_EIBCR 
