...
namespace Kvasir {
// peripheral MFS0 
    namespace Mfs1UartScr{    ///< register UART_SCR 
    ...
    namespace Mfs1UartSmr{    ///< register UART_SMR 
    ...
    namespace Mfs1UartSsr{    ///< register UART_SSR 
    ...
    namespace Mfs1UartEscr{    ///< register UART_ESCR 
    ...
    namespace Mfs1UartRdr{    ///< register UART_RDR 
    ...
    namespace Mfs1UartTdr{    ///< register UART_TDR 
        using Addr = Register::Address<0x40038108,0xfffffe00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs1UartBgr{    ///< register UART_BGR 
    ...
    namespace Mfs1UartFcr1{    ///< register UART_FCR1 
    ...
    namespace Mfs1UartFcr0{    ///< register UART_FCR0 
    ...
    namespace Mfs1CsioSmr{    ///< register CSIO_SMR 
    ...
    namespace Mfs1CsioSsr{    ///< register CSIO_SSR 
        using Addr = Register::Address<0x40038105,0xffffff60,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield AWC 
    ...
    namespace Mfs1CsioEscr{    ///< register CSIO_ESCR 
        using Addr = Register::Address<0x40038104,0xffffff20,0x00000000,unsigned char>;
        /// bitfield SOP 
    ...
    namespace Mfs1CsioRdr{    ///< register CSIO_RDR 
    ...
    namespace Mfs1CsioTdr{    ///< register CSIO_TDR 
        using Addr = Register::Address<0x40038108,0xffff0000,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs1CsioBgr{    ///< register CSIO_BGR 
    ...
    namespace Mfs1CsioFcr1{    ///< register CSIO_FCR1 
        using Addr = Register::Address<0x40038115,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs1CsioFcr0{    ///< register CSIO_FCR0 
        using Addr = Register::Address<0x40038114,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs1CsioFbyte1{    ///< register CSIO_FBYTE1 
        using Addr = Register::Address<0x40038118,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1CsioFbyte2{    ///< register CSIO_FBYTE2 
        using Addr = Register::Address<0x40038119,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1CsioScstr0{    ///< register CSIO_SCSTR0 
    ...
    namespace Mfs1CsioScstr1{    ///< register CSIO_SCSTR1 
    ...
    namespace Mfs1CsioScstr2{    ///< register CSIO_SCSTR2 
    ...
    namespace Mfs1CsioScstr3{    ///< register CSIO_SCSTR3 
        using Addr = Register::Address<0x40038121,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1CsioSacsr{    ///< register CSIO_SACSR 
    ...
    namespace Mfs1CsioStmr{    ///< register CSIO_STMR 
    ...
    namespace Mfs1CsioStmcr{    ///< register CSIO_STMCR 
    ...
    namespace Mfs1CsioScscr{    ///< register CSIO_SCSCR 
        using Addr = Register::Address<0x40038130,0xfffffc1c,0x00000000,unsigned>;
        /// bitfield SCAM 
    ...
    namespace Mfs1LinSmr{    ///< register LIN_SMR 
        using Addr = Register::Address<0x40038100,0xffffff06,0x00000000,unsigned char>;
        /// bitfield MD 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,5),Register::ReadWriteAccess,unsigned> md{}; 
        /// bitfield WUCR 
    ...
    namespace Mfs1LinSsr{    ///< register LIN_SSR 
        using Addr = Register::Address<0x40038105,0xffffff40,0x00000000,unsigned char>;
        /// bitfield REC 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> rec{}; 
        /// bitfield LBD 
    ...
    namespace Mfs1LinEscr{    ///< register LIN_ESCR 
    ...
    namespace Mfs1LinRdr{    ///< register LIN_RDR 
    ...
    namespace Mfs1LinTdr{    ///< register LIN_TDR 
        using Addr = Register::Address<0x40038108,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
    ...
    namespace Mfs1LinBgr{    ///< register LIN_BGR 
        using Addr = Register::Address<0x4003810c,0xffff0000,0x00000000,unsigned>;
        /// bitfield EXT 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> ext{}; 
        /// bitfield BGR1 
    ...
    namespace Mfs1LinFcr1{    ///< register LIN_FCR1 
        using Addr = Register::Address<0x40038115,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs1LinFcr0{    ///< register LIN_FCR0 
        using Addr = Register::Address<0x40038114,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs1LinFbyte1{    ///< register LIN_FBYTE1 
        using Addr = Register::Address<0x40038118,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1LinFbyte2{    ///< register LIN_FBYTE2 
        using Addr = Register::Address<0x40038119,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1I2cIbcr{    ///< register I2C_IBCR 
        using Addr = Register::Address<0x40038101,0xffffff00,0x00000000,unsigned char>;
        /// bitfield MSS 
    ...
    namespace Mfs1I2cSmr{    ///< register I2C_SMR 
    ...
    namespace Mfs1I2cIbsr{    ///< register I2C_IBSR 
        using Addr = Register::Address<0x40038104,0xffffff00,0x00000000,unsigned char>;
        /// bitfield FBT 
    ...
    namespace Mfs1I2cSsr{    ///< register I2C_SSR 
    ...
    namespace Mfs1I2cRdr{    ///< register I2C_RDR 
        using Addr = Register::Address<0x40038108,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs1I2cTdr{    ///< register I2C_TDR 
        using Addr = Register::Address<0x40038108,0xffffff00,0x00000000,unsigned>;
        /// bitfield D 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Mfs1I2cBgr{    ///< register I2C_BGR 
        using Addr = Register::Address<0x4003810c,0xffff8000,0x00000000,unsigned>;
        /// bitfield BGR1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> bgr1{}; 
        /// bitfield BGR0 
    ...
    namespace Mfs1I2cIsmk{    ///< register I2C_ISMK 
    ...
    namespace Mfs1I2cIsba{    ///< register I2C_ISBA 
    ...
    namespace Mfs1I2cFcr1{    ///< register I2C_FCR1 
        using Addr = Register::Address<0x40038115,0xffffffe0,0x00000000,unsigned char>;
        /// bitfield FLSTE 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> flste{}; 
        /// bitfield FRIIE 
    ...
    namespace Mfs1I2cFcr0{    ///< register I2C_FCR0 
        using Addr = Register::Address<0x40038114,0xffffff80,0x00000000,unsigned char>;
        /// bitfield FLST 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> flst{}; 
        /// bitfield FLD 
    ...
    namespace Mfs1I2cFbyte1{    ///< register I2C_FBYTE1 
        using Addr = Register::Address<0x40038118,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1I2cFbyte2{    ///< register I2C_FBYTE2 
        using Addr = Register::Address<0x40038119,0xffffffff,0x00000000,unsigned char>;
    }
    namespace Mfs1I2cNfcr{    ///< register I2C_NFCR 
    ...
    namespace Mfs1I2cEibcr{    ///< register I2C_EIBCR 
