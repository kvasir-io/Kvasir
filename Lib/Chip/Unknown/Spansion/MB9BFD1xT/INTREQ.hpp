...
//Interrupts
    ...
    namespace IntreqIrq32mon{    ///<IRQ32 Batch Read Register
        using Addr = Register::Address<0x40031094,0xfffffff0,0x00000000,unsigned>;
        ///LPI interrupt request of Ethernet MAC ch.0 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac0lpi{}; 
        ///PMI interrupt request of Ethernet MAC ch.0 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac0pmi{}; 
        ///SBD interrupt request of Ethernet MAC ch.0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac0sbd{}; 
    ...
    namespace IntreqIrq33mon{    ///<IRQ33 Batch Read Register
        using Addr = Register::Address<0x40031098,0xfffffff0,0x00000000,unsigned>;
        ///LPI interrupt request of Ethernet MAC ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac1lpi{}; 
        ///PMI interrupt request of Ethernet MAC ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac1pmi{}; 
        ///SBD interrupt request of Ethernet MAC ch.1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> mac1sbd{}; 
    ...
    namespace IntreqIrq36mon{    ///<IRQ36 Batch Read Register
        using Addr = Register::Address<0x400310a4,0xffffffe0,0x00000000,unsigned>;
        ///Endpoint 5 DRQ interrupt request on the USB ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int4{}; 
        ///Endpoint 4 DRQ interrupt request on the USB ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int3{}; 
        ///Endpoint 3 DRQ interrupt request on the USB ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int2{}; 
        ///Endpoint 2 DRQ interrupt request on the USB ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int1{}; 
        ///Endpoint 1 DRQ interrupt request on the USB ch.1 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int0{}; 
    }
    namespace IntreqIrq37mon{    ///<IRQ37 Batch Read Register
        using Addr = Register::Address<0x400310a8,0xffffffc0,0x00000000,unsigned>;
        ///"Status (SOFIRQ, CMPIRO) interrupt request on the USB ch.1 "
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> usb1int5{}; 
    ...
    namespace IntreqDrqsel1{    ///<DMA Request Select Register 1
        using Addr = Register::Address<0x40031200,0xffffffe0,0x00000000,unsigned>;
        ///Interrupt signal of EP5 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> drqsel14{}; 
        ///Interrupt signal of EP4 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,unsigned> drqsel13{}; 
        ///Interrupt signal of EP3 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> drqsel12{}; 
        ///Interrupt signal of EP2 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector  
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> drqsel11{}; 
        ///Interrupt signal of EP1 DRQ of USB ch.1 is output to transfer request to DMAC through extended selector 
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> drqsel10{}; 
    }
    ...
    namespace IntreqOddpks1{    ///<USB ch.1 Odd Packet Size DMA Enable Register
        using Addr = Register::Address<0x4003120f,0xffffffe0,0x00000000,unsigned char>;
