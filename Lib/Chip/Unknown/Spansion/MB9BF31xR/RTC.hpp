...
//REAL-TIME CLOCK
    ...
    namespace Nonewtmor{    ///<Month Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> tmo{}; 
    ...
    namespace Nonealmor{    ///<Alarm Month Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> tamo{}; 
    ...
    namespace Nonewtcal{    ///<Frequency Correction Value Setting Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0),Register::ReadWriteAccess,unsigned> wtcal{}; 
    }
