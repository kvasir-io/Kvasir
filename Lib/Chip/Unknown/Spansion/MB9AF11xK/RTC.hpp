...
namespace Kvasir {
    ...
    namespace Nonewtmor{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> TMO; 
    ...
    namespace Nonealmor{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> TAMO; 
    ...
    namespace Nonewtcal{
        using Addr = Register::Address<0x4003b024,0xffffff80>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0)> WTCAL; 
    }
    namespace Nonewtcalen{
        using Addr = Register::Address<0x4003b025,0xfffffffe>;
