...
//USB/Ethernet Clock
    namespace Noneuccr{    ///<USB/Ethernet-PLL Clock Control Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> ecsel1{}; 
        ///Ethernet clock selection bit 0
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> ecsel0{}; 
        ///Ethernet clock output enable bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> ecen{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> ucsel1{}; 
        ///USB0 clock selection bit
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> ucsel0{}; 
    ...
    namespace Noneupcr6{    ///<USB/Ethernet-PLL Setting Register 6
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ubsr{}; 
    }
    namespace Noneupcr7{    ///<USB/Ethernet-PLL Setting Register 7
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> epllen{}; 
    }
