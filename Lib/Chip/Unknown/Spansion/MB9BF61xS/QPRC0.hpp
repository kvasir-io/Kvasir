...
//Quadrature Position/Revolution Counter 0
    ...
    namespace Qprc0Qcr{    ///<QPRC Control Register
    ...
    namespace Qprc0Qrcrr{    ///<Quad counter rotation count Register
        using Addr = Register::Address<0x4002603c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Qprc0Qpcrr{    ///<Quad counter position count Register
