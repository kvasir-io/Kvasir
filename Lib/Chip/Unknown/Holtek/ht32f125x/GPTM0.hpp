...
//GPTM0
    ...
    namespace Nonegptm0Ctr{    ///<GPTM0_CTR
        using Addr = Register::Address<0x4006e010,0xfffffffc,0,unsigned>;
        ///TME
    ...
    namespace Nonegptm0Ictr{    ///<GPTM0_ICTR
        using Addr = Register::Address<0x4006e074,0xfffffaf0,0,unsigned>;
        ///CH0CCIE
