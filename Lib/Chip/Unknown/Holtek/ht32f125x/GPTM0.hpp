...
//GPTM0
    ...
    namespace Gptm0Gptm0Ctr{    ///<GPTM0_CTR
        using Addr = Register::Address<0x4006e010,0x00000000,0x00000000,unsigned>;
        ///TME
    ...
    namespace Gptm0Gptm0Ictr{    ///<GPTM0_ICTR
        using Addr = Register::Address<0x4006e074,0x000002f0,0x00000000,unsigned>;
        ///CH0CCIE
