...
//CKCU
    ...
    namespace NoneckcuApbccr0{    ///<CKCU_APBCCR0
        ...
        ///I2CEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> i2cen{}; 
        ///SPIEN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,unsigned> spien{}; 
        ///UREN
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> uren{}; 
        ///AFIOEN
    ...
    namespace NoneckcuCkst{    ///<CKCU_CKST
        ...
        ///PLLST
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> pllst{}; 
        ///HSEST
    ...
    namespace NoneckcuMcudbgcr{    ///<CKCU_MCUDBGCR
        ...
        ///DBUSART
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,unsigned> dbusart{}; 
        ///DBSPI
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10),Register::ReadWriteAccess,unsigned> dbspi{}; 
        ///DBDSLP2
