...
//GPTM1
    ...
    namespace Gptm1Gptm1Ctr{    ///<GPTM1_CTR
        using Addr = Register::Address<0x4006f010,0x00000000,0x00000000,unsigned>;
        ///TME
    ...
    namespace Gptm1Gptm1Ictr{    ///<GPTM1_ICTR
        using Addr = Register::Address<0x4006f074,0x000002f0,0x00000000,unsigned>;
        ///CH0CCIE
