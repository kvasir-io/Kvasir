...
namespace Kvasir {
    namespace Nonegpioa_dircr{
        using Addr = Register::Address<0x4001a000,0xffff0000>;
    ...
    namespace Nonegpioa_iner{
        using Addr = Register::Address<0x4001a004,0xffff0000>;
    ...
    namespace Nonegpioa_pur{
        using Addr = Register::Address<0x4001a008,0xffff0000>;
    ...
    namespace Nonegpioa_pdr{
        using Addr = Register::Address<0x4001a00c,0xffff0000>;
    ...
    namespace Nonegpioa_odr{
        using Addr = Register::Address<0x4001a010,0xffff0000>;
    ...
    namespace Nonegpioa_drvr{
        using Addr = Register::Address<0x4001a014,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DV0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> DV1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> DV2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> DV3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> DV4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> DV5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> DV6; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> DV7; 
    }
    namespace Nonegpioa_lockr{
        using Addr = Register::Address<0x4001a018,0x00000000>;
    ...
    namespace Nonegpioa_dinr{
        using Addr = Register::Address<0x4001a01c,0xffff0000>;
    ...
    namespace Nonegpioa_doutr{
        using Addr = Register::Address<0x4001a020,0xffff0000>;
    ...
    namespace Nonegpioa_srr{
        using Addr = Register::Address<0x4001a024,0x00000000>;
    ...
    namespace Nonegpioa_rr{
        using Addr = Register::Address<0x4001a028,0xffff0000>;
