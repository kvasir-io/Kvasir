...
namespace Kvasir {
    ...
    namespace Noneadc_ofr0{
        using Addr = Register::Address<0x40010030,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE0; 
    }
    namespace Noneadc_ofr1{
        using Addr = Register::Address<0x40010034,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE1; 
    }
    namespace Noneadc_ofr2{
        using Addr = Register::Address<0x40010038,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE2; 
    }
    namespace Noneadc_ofr3{
        using Addr = Register::Address<0x4001003c,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF3; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE3; 
    }
    namespace Noneadc_ofr4{
        using Addr = Register::Address<0x40010040,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF4; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE4; 
    }
    namespace Noneadc_ofr5{
        using Addr = Register::Address<0x40010044,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF5; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE5; 
    }
    namespace Noneadc_ofr6{
        using Addr = Register::Address<0x40010048,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF6; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE6; 
    }
    namespace Noneadc_ofr7{
        using Addr = Register::Address<0x4001004c,0xffff7000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,0)> ADOF7; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> ADOFE7; 
    }
    ...
    namespace Noneadc_tcr{
        using Addr = Register::Address<0x40010100,0xfffffff0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> TM; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> BFTM; 
    }
    namespace Noneadc_tsr{
        using Addr = Register::Address<0x40010104,0xf8f0f0fe>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,16)> TMS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19)> BFTMS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,24)> TME; 
    }
    ...
    namespace Noneadc_dmar{
        using Addr = Register::Address<0x40010140,0xfffffff8>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> ADDMAS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> ADDMAG; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ADDMAC; 
    }
}
