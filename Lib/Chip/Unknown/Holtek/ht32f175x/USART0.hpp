...
namespace Kvasir {
    ...
    namespace Noneusart0_fcr{
        using Addr = Register::Address<0x4000000c,0xfffffc08>;
    ...
    namespace Noneusart0_modcr{
        using Addr = Register::Address<0x40000014,0xfffffff8>;
    ...
    namespace Noneusart0_lsr{
        using Addr = Register::Address<0x40000018,0xfffffe00>;
    ...
    namespace Noneusart0_mdr{
        using Addr = Register::Address<0x40000024,0xffffffc8>;
    ...
    namespace Noneusart0_irdacr{
        using Addr = Register::Address<0x40000028,0xffff00c0>;
    ...
    namespace Noneusart0_rs485cr{
        using Addr = Register::Address<0x4000002c,0xffff00f8>;
    ...
    namespace Noneusart0_fsr{
        using Addr = Register::Address<0x40000034,0xffffe0e0>;
