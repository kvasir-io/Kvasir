...
namespace Kvasir {
    ...
    namespace Nonefmc_cfcr{
        using Addr = Register::Address<0x40080200,0xfffe6f68>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> DCDB; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> CE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15)> FHLAEN; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16)> FZWPSEN; 
    }
