...
namespace Kvasir {
//WDT
    namespace WdtWdtCr{    ///<WDT_CR
        using Addr = Register::Address<0x40068000,0x0000fffe,0x00000000,unsigned>;
        ///WDTRS
