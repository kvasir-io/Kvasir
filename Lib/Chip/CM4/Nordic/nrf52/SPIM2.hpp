...
//Serial Peripheral Interface Master with EasyDMA 2
    namespace Spim2TasksStart{    ///<Start SPI transaction
        using Addr = Register::Address<0x40023010,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2TasksStop{    ///<Stop SPI transaction
        using Addr = Register::Address<0x40023014,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2TasksSuspend{    ///<Suspend SPI transaction
        using Addr = Register::Address<0x4002301c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2TasksResume{    ///<Resume SPI transaction
        using Addr = Register::Address<0x40023020,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2EventsStopped{    ///<SPI transaction has stopped
        using Addr = Register::Address<0x40023104,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2EventsEndrx{    ///<End of RXD buffer reached
        using Addr = Register::Address<0x40023110,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2EventsEnd{    ///<End of RXD buffer and TXD buffer reached
        using Addr = Register::Address<0x40023118,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2EventsEndtx{    ///<End of TXD buffer reached
        using Addr = Register::Address<0x40023120,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2EventsStarted{    ///<Transaction started
        using Addr = Register::Address<0x4002314c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Spim2Shorts{    ///<Shortcut register
        using Addr = Register::Address<0x40023200,0xfffdffff,0x00000000,unsigned>;
    ...
    namespace Spim2Intenset{    ///<Enable interrupt
        using Addr = Register::Address<0x40023304,0xfff7fead,0x00000000,unsigned>;
    ...
    namespace Spim2Intenclr{    ///<Disable interrupt
        using Addr = Register::Address<0x40023308,0xfff7fead,0x00000000,unsigned>;
    ...
    namespace Spim2Enable{    ///<Enable SPIM
    ...
    namespace Spim2Frequency{    ///<SPI frequency
    ...
    namespace Spim2Config{    ///<Configuration register
    ...
    namespace Spim2Orc{    ///<Over-read character. Character clocked out in case and over-read of the TXD buffer.
