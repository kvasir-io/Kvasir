...
//I2C compatible Two-Wire Master Interface with EasyDMA 1
    namespace Twim1TasksStartrx{    ///<Start TWI receive sequence
        using Addr = Register::Address<0x40004000,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1TasksStarttx{    ///<Start TWI transmit sequence
        using Addr = Register::Address<0x40004008,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1TasksStop{    ///<Stop TWI transaction
        using Addr = Register::Address<0x40004014,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1TasksSuspend{    ///<Suspend TWI transaction
        using Addr = Register::Address<0x4000401c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1TasksResume{    ///<Resume TWI transaction
        using Addr = Register::Address<0x40004020,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsStopped{    ///<TWI stopped
        using Addr = Register::Address<0x40004104,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsError{    ///<TWI error
        using Addr = Register::Address<0x40004124,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsRxstarted{    ///<Receive sequence started
        using Addr = Register::Address<0x4000414c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsTxstarted{    ///<Transmit sequence started
        using Addr = Register::Address<0x40004150,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsLastrx{    ///<Byte boundary, starting to receive the last byte
        using Addr = Register::Address<0x4000415c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1EventsLasttx{    ///<Byte boundary, starting to transmit the last byte
        using Addr = Register::Address<0x40004160,0xffffffff,0x00000000,unsigned>;
    }
    namespace Twim1Shorts{    ///<Shortcut register
        using Addr = Register::Address<0x40004200,0xffffe87f,0x00000000,unsigned>;
        ///Shortcut between EVENTS_LASTTX event and TASKS_STARTRX task
        enum class LasttxstartrxVal : unsigned {
        ...
        enum class LasttxsuspendVal : unsigned {
            disabled=0x00000000,     ///<Disable shortcut
            enabled=0x00000001,     ///<Enable shortcut
        };
        ...
        enum class LasttxstopVal : unsigned {
            disabled=0x00000000,     ///<Disable shortcut
            enabled=0x00000001,     ///<Enable shortcut
        };
        ...
        enum class LastrxstarttxVal : unsigned {
            disabled=0x00000000,     ///<Disable shortcut
            enabled=0x00000001,     ///<Enable shortcut
        };
        ...
        enum class LastrxstopVal : unsigned {
            disabled=0x00000000,     ///<Disable shortcut
            enabled=0x00000001,     ///<Enable shortcut
        };
    ...
    namespace Twim1Inten{    ///<Enable or disable interrupt
        using Addr = Register::Address<0x40004300,0xfe67fdfd,0x00000000,unsigned>;
    ...
    namespace Twim1Intenset{    ///<Enable interrupt
        using Addr = Register::Address<0x40004304,0xfe67fdfd,0x00000000,unsigned>;
    ...
    namespace Twim1Intenclr{    ///<Disable interrupt
        using Addr = Register::Address<0x40004308,0xfe67fdfd,0x00000000,unsigned>;
    ...
    namespace Twim1Errorsrc{    ///<Error source
        using Addr = Register::Address<0x400044c4,0xfffffff9,0x00000000,unsigned>;
        ///NACK received after sending the address (write '1' to clear)
        enum class AnackVal : unsigned {
    ...
    namespace Twim1Enable{    ///<Enable TWIM
    ...
    namespace Twim1Frequency{    ///<TWI frequency
    ...
    namespace Twim1Address{    ///<Address used in the TWI transfer
