...
//SPI Slave 1
    ...
    namespace Spis1TasksRelease{    ///<Release SPI semaphore, enabling the SPI slave to acquire it
    ...
    namespace Spis1Shorts{    ///<Shortcut register
    ...
    namespace Spis1Intenset{    ///<Enable interrupt
    ...
    namespace Spis1Intenclr{    ///<Disable interrupt
    ...
    namespace Spis1Semstat{    ///<Semaphore status register
    ...
    namespace Spis1Enable{    ///<Enable SPI slave
    ...
    namespace Spis1Def{    ///<Default character. Character clocked out in case of an ignored transaction.
