...
namespace Kvasir {
//Timer/Counter 4
    namespace Timer4TasksStart{    ///<Start Timer
        using Addr = Register::Address<0x4001b000,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksStop{    ///<Stop Timer
        using Addr = Register::Address<0x4001b004,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCount{    ///<Increment Timer (Counter mode only)
        using Addr = Register::Address<0x4001b008,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksClear{    ///<Clear time
        using Addr = Register::Address<0x4001b00c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksShutdown{    ///<Shut down timer
        using Addr = Register::Address<0x4001b010,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4Shorts{    ///<Shortcut register
        using Addr = Register::Address<0x4001b200,0xffffc0c0,0x00000000,unsigned>;
    ...
    namespace Timer4Intenset{    ///<Enable interrupt
        using Addr = Register::Address<0x4001b304,0xffc0ffff,0x00000000,unsigned>;
    ...
    namespace Timer4Intenclr{    ///<Disable interrupt
        using Addr = Register::Address<0x4001b308,0xffc0ffff,0x00000000,unsigned>;
    ...
    namespace Timer4Mode{    ///<Timer mode selection
        using Addr = Register::Address<0x4001b504,0xfffffffc,0x00000000,unsigned>;
        ///Timer mode
    ...
    namespace Timer4Bitmode{    ///<Configure the number of bits used by the TIMER
        using Addr = Register::Address<0x4001b508,0xfffffffc,0x00000000,unsigned>;
        ///Timer bit width
    ...
    namespace Timer4Prescaler{    ///<Timer prescaler register
        using Addr = Register::Address<0x4001b510,0xfffffff0,0x00000000,unsigned>;
        ///Prescaler value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> prescaler{}; 
    }
    namespace Timer4TasksCapture0{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b040,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCapture1{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b044,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCapture2{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b048,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCapture3{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b04c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCapture4{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b050,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4TasksCapture5{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4001b054,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare0{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b140,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare1{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b144,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare2{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b148,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare3{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b14c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare4{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b150,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4EventsCompare5{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4001b154,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer4Cc0{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b540,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4Cc1{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b544,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4Cc2{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b548,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4Cc3{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b54c,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4Cc4{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b550,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4Cc5{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4001b554,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer4TasksCapture0{    ///<Description collection[0]:  Capture Timer value to CC[0] register
