...
//Timer/Counter 2
    ...
    namespace Timer2TasksCount{    ///<Increment Timer (Counter mode only)
        using Addr = Register::Address<0x4000a008,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksClear{    ///<Clear time
        using Addr = Register::Address<0x4000a00c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksShutdown{    ///<Shut down timer
        using Addr = Register::Address<0x4000a010,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2Shorts{    ///<Shortcut register
        using Addr = Register::Address<0x4000a200,0xffffc0c0,0x00000000,unsigned>;
    ...
    namespace Timer2Intenset{    ///<Enable interrupt
        using Addr = Register::Address<0x4000a304,0xffc0ffff,0x00000000,unsigned>;
    ...
    namespace Timer2Intenclr{    ///<Disable interrupt
        using Addr = Register::Address<0x4000a308,0xffc0ffff,0x00000000,unsigned>;
    ...
    namespace Timer2Mode{    ///<Timer mode selection
        using Addr = Register::Address<0x4000a504,0xfffffffc,0x00000000,unsigned>;
        ///Timer mode
    ...
    namespace Timer2Bitmode{    ///<Configure the number of bits used by the TIMER
    ...
    namespace Timer2Prescaler{    ///<Timer prescaler register
    ...
    namespace Timer2TasksCapture0{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a040,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksCapture1{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a044,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksCapture2{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a048,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksCapture3{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a04c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksCapture4{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a050,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2TasksCapture5{    ///<Description collection[0]:  Capture Timer value to CC[0] register
        using Addr = Register::Address<0x4000a054,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare0{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a140,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare1{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a144,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare2{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a148,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare3{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a14c,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare4{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a150,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2EventsCompare5{    ///<Description collection[0]:  Compare event on CC[0] match
        using Addr = Register::Address<0x4000a154,0xffffffff,0x00000000,unsigned>;
    }
    namespace Timer2Cc0{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a540,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2Cc1{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a544,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2Cc2{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a548,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2Cc3{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a54c,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2Cc4{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a550,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2Cc5{    ///<Description collection[0]:  Capture/Compare register 0
        using Addr = Register::Address<0x4000a554,0x00000000,0x00000000,unsigned>;
        ///Capture/Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> cc{}; 
    }
    namespace Timer2TasksCapture0{    ///<Description collection[0]:  Capture Timer value to CC[0] register
