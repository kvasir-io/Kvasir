...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xcfc0e40f>;
    ...
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0x00c3eee8>;
    ...
    namespace SIM_scgc1{
        using Addr = Register::Address<0x40048028,0xfffff3bf>;
    ...
    namespace SIM_scgc3{
        using Addr = Register::Address<0x40048030,0xf4fdeffe>;
    ...
    namespace SIM_fcfg2{
        using Addr = Register::Address<0x40048050,0x8000ffff>;
