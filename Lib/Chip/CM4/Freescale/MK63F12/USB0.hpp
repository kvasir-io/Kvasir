...
namespace Kvasir {
    ...
    namespace USB0_addinfo{
        using Addr = Register::Address<0x4007200c,0xffffff06>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> IEHOST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,3)> IRQNUM; 
    }
    ...
    namespace USB0_clk_recover_irc_en{
        using Addr = Register::Address<0x40072144,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> REG_EN; 
