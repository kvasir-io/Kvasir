...
//Programmable Delay Block
    namespace Pdb1Sc{    ///<Status and Control register
        using Addr = Register::Address<0x40031000,0xfff00010,0x00000000,unsigned>;
        ///Load OK
    ...
    namespace Pdb1Mod{    ///<Modulus register
        using Addr = Register::Address<0x40031004,0xffff0000,0x00000000,unsigned>;
        ///PDB Modulus
    ...
    namespace Pdb1Cnt{    ///<Counter register
        using Addr = Register::Address<0x40031008,0xffff0000,0x00000000,unsigned>;
        ///PDB Counter
    ...
    namespace Pdb1Idly{    ///<Interrupt Delay register
        using Addr = Register::Address<0x4003100c,0xffff0000,0x00000000,unsigned>;
        ///PDB Interrupt Delay
    ...
    namespace Pdb1Chc1{    ///<Channel n Control register 1
        using Addr = Register::Address<0x40031010,0xff000000,0x00000000,unsigned>;
    ...
    namespace Pdb1Chs{    ///<Channel n Status register
        using Addr = Register::Address<0x40031014,0xff00ff00,0x00000000,unsigned>;
    ...
    namespace Pdb1Chdly0{    ///<Channel n Delay 0 register
        using Addr = Register::Address<0x40031018,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
    ...
    namespace Pdb1Chdly1{    ///<Channel n Delay 1 register
        using Addr = Register::Address<0x4003101c,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb1Chdly2{    ///<Channel n Delay 2 register
        using Addr = Register::Address<0x40031020,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb1Chdly3{    ///<Channel n Delay 3 register
        using Addr = Register::Address<0x40031024,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb1Dacintc{    ///<DAC Interval Trigger n Control register
        using Addr = Register::Address<0x40031150,0xfffffffc,0x00000000,unsigned>;
    ...
    namespace Pdb1Dacint{    ///<DAC Interval n register
        using Addr = Register::Address<0x40031154,0xffff0000,0x00000000,unsigned>;
        ///DAC Interval
    ...
    namespace Pdb1Poen{    ///<Pulse-Out n Enable register
        using Addr = Register::Address<0x40031190,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Pdb1Po0dly{    ///<Pulse-Out n Delay register
        using Addr = Register::Address<0x40031194,0x00000000,0x00000000,unsigned>;
    ...
    namespace Pdb1Po1dly{    ///<Pulse-Out n Delay register
        using Addr = Register::Address<0x40031198,0x00000000,0x00000000,unsigned>;
        ///PDB Pulse-Out Delay 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly2{}; 
        ///PDB Pulse-Out Delay 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dly1{}; 
    ...
    namespace Pdb1Po2dly{    ///<Pulse-Out n Delay register
        using Addr = Register::Address<0x4003119c,0x00000000,0x00000000,unsigned>;
        ///PDB Pulse-Out Delay 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly2{}; 
        ///PDB Pulse-Out Delay 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dly1{}; 
    ...
    namespace Pdb1Po3dly{    ///<Pulse-Out n Delay register
        using Addr = Register::Address<0x400311a0,0x00000000,0x00000000,unsigned>;
        ///PDB Pulse-Out Delay 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly2{}; 
        ///PDB Pulse-Out Delay 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dly1{}; 
