...
//Flash Memory Interface
    namespace FtflFstat{    ///<Flash Status Register
        ...
        enum class CcifVal {
            v0=0x00000000,     ///<FTFL command in progress
            v1=0x00000001,     ///<FTFL command has completed
        };
    ...
    namespace FtflFcnfg{    ///<Flash Configuration Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> eeerdy{}; 
        ...
        ///FTFL configuration
        enum class PflshVal {
            v1=0x00000001,     ///<FTFL configured for program flash only, without support for data flash and/or EEPROM
        };
