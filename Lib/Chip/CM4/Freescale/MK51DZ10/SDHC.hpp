...
namespace Kvasir {
    ...
    namespace SDHC_htcapblt{
        using Addr = Register::Address<0x400b1040,0xf808ffff>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(25,25)> VS30; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,26)> VS18; 
    }
    namespace SDHC_wml{
        using Addr = Register::Address<0x400b1044,0xe000ff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(28,24)> WRBRSTLEN; 
    }
    namespace SDHC_fevt{
