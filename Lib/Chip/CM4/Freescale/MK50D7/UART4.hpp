...
namespace Kvasir {
    namespace UART4_bdh{
        using Addr = Register::Address<0x400ea000,0xffffff20>;
    ...
    namespace UART4_c5{
        using Addr = Register::Address<0x400ea00b,0xffffff5f>;
    ...
    namespace UART4_cfifo{
        using Addr = Register::Address<0x400ea011,0xffffff3c>;
    ...
    namespace UART4_sfifo{
        using Addr = Register::Address<0x400ea012,0xffffff3c>;
