...
//Serial Communication Interface
    namespace Uart4Bdh{    ///<UART Baud Rate Registers: High
        using Addr = Register::Address<0x400ea000,0xffffff00,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart4Bdl{    ///<UART Baud Rate Registers: Low
        using Addr = Register::Address<0x400ea001,0xffffff00,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart4C1{    ///<UART Control Register 1
        using Addr = Register::Address<0x400ea002,0xffffff00,0,unsigned char>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Uart4C2{    ///<UART Control Register 2
        using Addr = Register::Address<0x400ea003,0xffffff00,0,unsigned char>;
        ///Send Break
        enum class SbkVal {
    ...
    namespace Uart4S1{    ///<UART Status Register 1
        using Addr = Register::Address<0x400ea004,0xffffff00,0,unsigned char>;
        ///Parity Error Flag
        enum class PfVal {
    ...
    namespace Uart4S2{    ///<UART Status Register 2
        using Addr = Register::Address<0x400ea005,0xffffff00,0,unsigned char>;
    ...
    namespace Uart4C3{    ///<UART Control Register 3
        using Addr = Register::Address<0x400ea006,0xffffff00,0,unsigned char>;
    ...
    namespace Uart4D{    ///<UART Data Register
        using Addr = Register::Address<0x400ea007,0xffffff00,0,unsigned char>;
    ...
    namespace Uart4Ma1{    ///<UART Match Address Registers 1
        using Addr = Register::Address<0x400ea008,0xffffff00,0,unsigned char>;
        ///Match Address
    ...
    namespace Uart4Ma2{    ///<UART Match Address Registers 2
        using Addr = Register::Address<0x400ea009,0xffffff00,0,unsigned char>;
        ///Match Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ma{}; 
        namespace MaValC{
        }
    ...
    namespace Uart4C4{    ///<UART Control Register 4
        using Addr = Register::Address<0x400ea00a,0xffffff00,0,unsigned char>;
    ...
    namespace Uart4C5{    ///<UART Control Register 5
        using Addr = Register::Address<0x400ea00b,0xffffff07,0,unsigned char>;
    ...
    namespace Uart4Ed{    ///<UART Extended Data Register
        using Addr = Register::Address<0x400ea00c,0xffffff3f,0,unsigned char>;
        ///no description available
    ...
    namespace Uart4Modem{    ///<UART Modem Register
        using Addr = Register::Address<0x400ea00d,0xfffffff0,0,unsigned char>;
    ...
    namespace Uart4Ir{    ///<UART Infrared Register
        using Addr = Register::Address<0x400ea00e,0xfffffff8,0,unsigned char>;
    ...
    namespace Uart4Pfifo{    ///<UART FIFO Parameters
        using Addr = Register::Address<0x400ea010,0xffffff00,0,unsigned char>;
    ...
    namespace Uart4Cfifo{    ///<UART FIFO Control Register
        using Addr = Register::Address<0x400ea011,0xffffff38,0,unsigned char>;
    ...
    namespace Uart4Sfifo{    ///<UART FIFO Status Register
        using Addr = Register::Address<0x400ea012,0xffffff38,0,unsigned char>;
    ...
    namespace Uart4Twfifo{    ///<UART FIFO Transmit Watermark
        using Addr = Register::Address<0x400ea013,0xffffff00,0,unsigned char>;
        ///Transmit Watermark
    ...
    namespace Uart4Tcfifo{    ///<UART FIFO Transmit Count
        using Addr = Register::Address<0x400ea014,0xffffff00,0,unsigned char>;
        ///Transmit Counter
    ...
    namespace Uart4Rwfifo{    ///<UART FIFO Receive Watermark
        using Addr = Register::Address<0x400ea015,0xffffff00,0,unsigned char>;
        ///Receive Watermark
    ...
    namespace Uart4Rcfifo{    ///<UART FIFO Receive Count
        using Addr = Register::Address<0x400ea016,0xffffff00,0,unsigned char>;
        ///Receive Counter
