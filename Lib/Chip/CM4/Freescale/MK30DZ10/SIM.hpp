...
//System Integration Module
    namespace SimSopt1{    ///<System Options Register 1
        using Addr = Register::Address<0x40047000,0xff770fff,0x00000000,unsigned>;
        ///RAM size
    ...
    namespace SimSopt2{    ///<System Options Register 2
        using Addr = Register::Address<0x40048004,0xccfee4fe,0x00000000,unsigned>;
        ///MCG clock select
    ...
    namespace SimClkdiv2{    ///<System Clock Divider Register 2
        using Addr = Register::Address<0x40048048,0x000f00ff,0x00000000,unsigned>;
