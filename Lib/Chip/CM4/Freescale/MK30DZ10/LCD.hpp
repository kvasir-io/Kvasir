...
//Segment Liquid Crystal Display
    namespace LcdGcr{    ///<LCD general control register
        using Addr = Register::Address<0x400be000,0x700c0c00,0x00000000,unsigned>;
        ///LCD duty select
        enum class DutyVal {
        ...
        ///LCD driver enable
        enum class LcdenVal {
            v0=0x00000000,     ///<All frontplane and backplane pins are disabled. The LCD controller system is also disabled, and all LCD waveform generation clocks are stopped. VLL3 is connected to VDD internally.
            v1=0x00000001,     ///<LCD controller driver system is enabled, and frontplane and backplane waveforms are generated. All LCD pins, LCD_Pn, enabled using the LCD pin enable register, output an LCD driver waveform.The backplane pins output an LCD driver backplane waveform based on the settings of DUTY[2:0]. Charge pump or resistor bias is enabled.
        };
        ...
        enum class LcdstpVal {
            ...
            v1=0x00000001,     ///<Disables the LCD driver, charge pump, resistor bias network, and voltage regulator when MCU goes into Stop mode.
        };
        ...
        enum class LcdwaitVal {
            ...
            v1=0x00000001,     ///<Disables the LCD driver, charge pump, resistor bias network, and voltage regulator when MCU goes into Wait mode.
        };
        ...
        enum class VsupplyVal {
            v00=0x00000000,     ///<Drive VLL2 internally from VDD.
            v01=0x00000001,     ///<Drive VLL3 internally from VDD.
            v11=0x00000003,     ///<Drive VLL3 externally from VDD or drive VLL1 internally from VIREG.
        };
        ...
        enum class HrefselVal {
            v0=0x00000000,     ///<Divide input, VIREG = 1.0 V for 3 V glass.
            v1=0x00000001,     ///<Do not divide the input, VIREG = 1.67 V for 5 V glass.
        };
    ...
    namespace LcdAr{    ///<LCD auxiliary register
        using Addr = Register::Address<0x400be004,0xffff7f10,0x00000000,unsigned>;
        ...
        enum class LcdifVal {
            ...
            v1=0x00000001,     ///<The start of LCD controller frame has occurred.
        };
    ...
    namespace LcdFdcr{    ///<LCD fault detect control register
        using Addr = Register::Address<0x400be008,0xffff8100,0x00000000,unsigned>;
        ///Fault detect pin ID
        ...
        enum class FdbpenVal {
            v0=0x00000000,     ///<Type of the selected pin under fault detect test is frontplane.
            v1=0x00000001,     ///<Type of the selected pin under fault detect test is backplane.
        };
    ...
    namespace LcdFdsr{    ///<LCD fault detect status register
        using Addr = Register::Address<0x400be00c,0xffff7f00,0x00000000,unsigned>;
    ...
    namespace LcdWf3to0{    ///<LCD waveform register
        using Addr = Register::Address<0x400be020,0x00000000,0x00000000,unsigned>;
    ...
    namespace LcdWf0{    ///<LCD Waveform Register 0.
        using Addr = Register::Address<0x400be020,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf1{    ///<LCD Waveform Register 1.
        using Addr = Register::Address<0x400be021,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf2{    ///<LCD Waveform Register 2.
        using Addr = Register::Address<0x400be022,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf3{    ///<LCD Waveform Register 3.
        using Addr = Register::Address<0x400be023,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf7to4{    ///<LCD waveform register
        using Addr = Register::Address<0x400be024,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf4{    ///<LCD Waveform Register 4.
        using Addr = Register::Address<0x400be024,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf5{    ///<LCD Waveform Register 5.
        using Addr = Register::Address<0x400be025,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf6{    ///<LCD Waveform Register 6.
        using Addr = Register::Address<0x400be026,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf7{    ///<LCD Waveform Register 7.
        using Addr = Register::Address<0x400be027,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf11to8{    ///<LCD waveform register
        using Addr = Register::Address<0x400be028,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf8{    ///<LCD Waveform Register 8.
        using Addr = Register::Address<0x400be028,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf9{    ///<LCD Waveform Register 9.
        using Addr = Register::Address<0x400be029,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf10{    ///<LCD Waveform Register 10.
        using Addr = Register::Address<0x400be02a,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf11{    ///<LCD Waveform Register 11.
        using Addr = Register::Address<0x400be02b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf15to12{    ///<LCD waveform register
        using Addr = Register::Address<0x400be02c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf12{    ///<LCD Waveform Register 12.
        using Addr = Register::Address<0x400be02c,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf13{    ///<LCD Waveform Register 13.
        using Addr = Register::Address<0x400be02d,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf14{    ///<LCD Waveform Register 14.
        using Addr = Register::Address<0x400be02e,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf15{    ///<LCD Waveform Register 15.
        using Addr = Register::Address<0x400be02f,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf19to16{    ///<LCD waveform register
        using Addr = Register::Address<0x400be030,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf16{    ///<LCD Waveform Register 16.
        using Addr = Register::Address<0x400be030,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf17{    ///<LCD Waveform Register 17.
        using Addr = Register::Address<0x400be031,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf18{    ///<LCD Waveform Register 18.
        using Addr = Register::Address<0x400be032,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf19{    ///<LCD Waveform Register 19.
        using Addr = Register::Address<0x400be033,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf23to20{    ///<LCD waveform register
        using Addr = Register::Address<0x400be034,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf20{    ///<LCD Waveform Register 20.
        using Addr = Register::Address<0x400be034,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf21{    ///<LCD Waveform Register 21.
        using Addr = Register::Address<0x400be035,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf22{    ///<LCD Waveform Register 22.
        using Addr = Register::Address<0x400be036,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf23{    ///<LCD Waveform Register 23.
        using Addr = Register::Address<0x400be037,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf27to24{    ///<LCD waveform register
        using Addr = Register::Address<0x400be038,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf24{    ///<LCD Waveform Register 24.
        using Addr = Register::Address<0x400be038,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf25{    ///<LCD Waveform Register 25.
        using Addr = Register::Address<0x400be039,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf26{    ///<LCD Waveform Register 26.
        using Addr = Register::Address<0x400be03a,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf27{    ///<LCD Waveform Register 27.
        using Addr = Register::Address<0x400be03b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf31to28{    ///<LCD waveform register
        using Addr = Register::Address<0x400be03c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf28{    ///<LCD Waveform Register 28.
        using Addr = Register::Address<0x400be03c,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf29{    ///<LCD Waveform Register 29.
        using Addr = Register::Address<0x400be03d,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf30{    ///<LCD Waveform Register 30.
        using Addr = Register::Address<0x400be03e,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf31{    ///<LCD Waveform Register 31.
        using Addr = Register::Address<0x400be03f,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf35to32{    ///<LCD waveform register
        using Addr = Register::Address<0x400be040,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf32{    ///<LCD Waveform Register 32.
        using Addr = Register::Address<0x400be040,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf33{    ///<LCD Waveform Register 33.
        using Addr = Register::Address<0x400be041,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf34{    ///<LCD Waveform Register 34.
        using Addr = Register::Address<0x400be042,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf35{    ///<LCD Waveform Register 35.
        using Addr = Register::Address<0x400be043,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf39to36{    ///<LCD waveform register
        using Addr = Register::Address<0x400be044,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf36{    ///<LCD Waveform Register 36.
        using Addr = Register::Address<0x400be044,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf37{    ///<LCD Waveform Register 37.
        using Addr = Register::Address<0x400be045,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf38{    ///<LCD Waveform Register 38.
        using Addr = Register::Address<0x400be046,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf39{    ///<LCD Waveform Register 39.
        using Addr = Register::Address<0x400be047,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf43to40{    ///<LCD waveform register
        using Addr = Register::Address<0x400be048,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf40{    ///<LCD Waveform Register 40.
        using Addr = Register::Address<0x400be048,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf41{    ///<LCD Waveform Register 41.
        using Addr = Register::Address<0x400be049,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf42{    ///<LCD Waveform Register 42.
        using Addr = Register::Address<0x400be04a,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf43{    ///<LCD Waveform Register 43.
        using Addr = Register::Address<0x400be04b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf47to44{    ///<LCD waveform register
        using Addr = Register::Address<0x400be04c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf44{    ///<LCD Waveform Register 44.
        using Addr = Register::Address<0x400be04c,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf45{    ///<LCD Waveform Register 45.
        using Addr = Register::Address<0x400be04d,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf46{    ///<LCD Waveform Register 46.
        using Addr = Register::Address<0x400be04e,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf47{    ///<LCD Waveform Register 47.
        using Addr = Register::Address<0x400be04f,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf51to48{    ///<LCD waveform register
        using Addr = Register::Address<0x400be050,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf48{    ///<LCD Waveform Register 48.
        using Addr = Register::Address<0x400be050,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf49{    ///<LCD Waveform Register 49.
        using Addr = Register::Address<0x400be051,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf50{    ///<LCD Waveform Register 50.
        using Addr = Register::Address<0x400be052,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf51{    ///<LCD Waveform Register 51.
        using Addr = Register::Address<0x400be053,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf55to52{    ///<LCD waveform register
        using Addr = Register::Address<0x400be054,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf52{    ///<LCD Waveform Register 52.
        using Addr = Register::Address<0x400be054,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf53{    ///<LCD Waveform Register 53.
        using Addr = Register::Address<0x400be055,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf54{    ///<LCD Waveform Register 54.
        using Addr = Register::Address<0x400be056,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf55{    ///<LCD Waveform Register 55.
        using Addr = Register::Address<0x400be057,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf59to56{    ///<LCD waveform register
        using Addr = Register::Address<0x400be058,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf56{    ///<LCD Waveform Register 56.
        using Addr = Register::Address<0x400be058,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf57{    ///<LCD Waveform Register 57.
        using Addr = Register::Address<0x400be059,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf58{    ///<LCD Waveform Register 58.
        using Addr = Register::Address<0x400be05a,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf59{    ///<LCD Waveform Register 59.
        using Addr = Register::Address<0x400be05b,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf63to60{    ///<LCD waveform register
        using Addr = Register::Address<0x400be05c,0x00000000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace LcdWf60{    ///<LCD Waveform Register 60.
        using Addr = Register::Address<0x400be05c,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf61{    ///<LCD Waveform Register 61.
        using Addr = Register::Address<0x400be05d,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf62{    ///<LCD Waveform Register 62.
        using Addr = Register::Address<0x400be05e,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdWf63{    ///<LCD Waveform Register 63.
        using Addr = Register::Address<0x400be05f,0xffffff00,0x00000000,unsigned char>;
        ///no description available
    ...
    namespace LcdPenl{    ///<LCD pin enable register
        using Addr = Register::Address<0x400be010,0x00000000,0x00000000,unsigned>;
        ///LCD pin enable
    ...
    namespace LcdPenh{    ///<LCD pin enable register
        using Addr = Register::Address<0x400be014,0x00000000,0x00000000,unsigned>;
        ///LCD pin enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> pen{}; 
    }
    namespace LcdBpenl{    ///<LCD backplane enable register
        using Addr = Register::Address<0x400be018,0x00000000,0x00000000,unsigned>;
        ///Backplane enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> bpen{}; 
    }
    namespace LcdBpenh{    ///<LCD backplane enable register
        using Addr = Register::Address<0x400be01c,0x00000000,0x00000000,unsigned>;
        ///Backplane enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> bpen{}; 
    }
}
