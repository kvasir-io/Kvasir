...
namespace Kvasir {
    ...
    namespace MCG_c2{
        using Addr = Register::Address<0x40064001,0xffffffc0>;
    ...
    namespace MCG_c5{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> PRDIV; 
    ...
    namespace MCG_s{
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> OSCINIT; 
    ...
    namespace MCG_atc{
        using Addr = Register::Address<0x40064008,0xffffff1f>;
