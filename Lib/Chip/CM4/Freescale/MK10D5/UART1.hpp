...
namespace Kvasir {
    namespace UART1_bdh{
        using Addr = Register::Address<0x4006b000,0xffffff20>;
    ...
    namespace UART1_ir{
        using Addr = Register::Address<0x4006b00e,0xfffffff8>;
    ...
    namespace UART1_cfifo{
        using Addr = Register::Address<0x4006b011,0xffffff3c>;
    ...
    namespace UART1_sfifo{
        using Addr = Register::Address<0x4006b012,0xffffff3c>;
