...
//Reset Control Module
    namespace RcmSrs0{    ///<System Reset Status Register 0
        ...
        namespace LolValC{
            constexpr Register::FieldValue<decltype(lol),LolVal::v0> v0{};
            constexpr Register::FieldValue<decltype(lol),LolVal::v1> v1{};
        }
        ///Watchdog
        enum class WdogVal {
    ...
    namespace RcmSrs1{    ///<System Reset Status Register 1
        using Addr = Register::Address<0x4007f001,0xffffffc0,0,unsigned char>;
    ...
    namespace RcmSsrs0{    ///<Sticky System Reset Status Register 0
        using Addr = Register::Address<0x4007f008,0xffffff10,0,unsigned char>;
        ...
        namespace SwakeupValC{
            constexpr Register::FieldValue<decltype(swakeup),SwakeupVal::v0> v0{};
            constexpr Register::FieldValue<decltype(swakeup),SwakeupVal::v1> v1{};
        }
        ...
        namespace SlvdValC{
            constexpr Register::FieldValue<decltype(slvd),SlvdVal::v0> v0{};
            constexpr Register::FieldValue<decltype(slvd),SlvdVal::v1> v1{};
        }
        ...
        namespace SlocValC{
            constexpr Register::FieldValue<decltype(sloc),SlocVal::v0> v0{};
            constexpr Register::FieldValue<decltype(sloc),SlocVal::v1> v1{};
        }
        ...
        namespace SlolValC{
            constexpr Register::FieldValue<decltype(slol),SlolVal::v0> v0{};
            constexpr Register::FieldValue<decltype(slol),SlolVal::v1> v1{};
        }
        ///Sticky Watchdog
        enum class SwdogVal {
            v0=0x00000000,     ///<Reset not caused by watchdog timeout
        ...
        namespace SwdogValC{
            constexpr Register::FieldValue<decltype(swdog),SwdogVal::v0> v0{};
            constexpr Register::FieldValue<decltype(swdog),SwdogVal::v1> v1{};
        }
        ...
        namespace SpinValC{
            constexpr Register::FieldValue<decltype(spin),SpinVal::v0> v0{};
            constexpr Register::FieldValue<decltype(spin),SpinVal::v1> v1{};
        }
        ...
        namespace SporValC{
            constexpr Register::FieldValue<decltype(spor),SporVal::v0> v0{};
            constexpr Register::FieldValue<decltype(spor),SporVal::v1> v1{};
        }
    }
    namespace RcmSsrs1{    ///<Sticky System Reset Status Register 1
        using Addr = Register::Address<0x4007f009,0xffffffc0,0,unsigned char>;
        ...
        namespace SjtagValC{
            constexpr Register::FieldValue<decltype(sjtag),SjtagVal::v0> v0{};
            constexpr Register::FieldValue<decltype(sjtag),SjtagVal::v1> v1{};
        }
        ///Sticky Core Lockup
        ...
        namespace SlockupValC{
            constexpr Register::FieldValue<decltype(slockup),SlockupVal::v0> v0{};
            constexpr Register::FieldValue<decltype(slockup),SlockupVal::v1> v1{};
        }
        ///Sticky Software
        enum class SswVal {
            v0=0x00000000,     ///<Reset not caused by software setting of SYSRESETREQ bit
        ...
        namespace SswValC{
            constexpr Register::FieldValue<decltype(ssw),SswVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ssw),SswVal::v1> v1{};
        }
        ...
        namespace SmdmapValC{
            constexpr Register::FieldValue<decltype(smdmAp),SmdmapVal::v0> v0{};
            constexpr Register::FieldValue<decltype(smdmAp),SmdmapVal::v1> v1{};
        }
        ///Sticky EzPort Reset
        enum class SezptVal {
            v0=0x00000000,     ///<Reset not caused by EzPort receiving the RESET command while the device is in EzPort mode
        ...
        namespace SezptValC{
            constexpr Register::FieldValue<decltype(sezpt),SezptVal::v0> v0{};
            constexpr Register::FieldValue<decltype(sezpt),SezptVal::v1> v1{};
        }
        ...
        namespace SsackerrValC{
            constexpr Register::FieldValue<decltype(ssackerr),SsackerrVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ssackerr),SsackerrVal::v1> v1{};
        }
    }
}
