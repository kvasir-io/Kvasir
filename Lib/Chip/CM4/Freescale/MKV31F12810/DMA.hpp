...
//Enhanced direct memory access controller
    namespace DmaCr{    ///<Control Register
        using Addr = Register::Address<0x40008000,0x7ffcff09,0,unsigned>;
        ///Enable Debug
        enum class edbgVal {
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,activeVal> active{}; 
    }
