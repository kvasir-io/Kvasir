...
namespace Kvasir {
    ...
    namespace FTM1_c0sc{
        using Addr = Register::Address<0x4003900c,0xffffff00>;
    ...
    namespace FTM1_c1sc{
        using Addr = Register::Address<0x40039014,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DMA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> ICRST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ELSA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> ELSB; 
    ...
    namespace FTM1_cntin{
        using Addr = Register::Address<0x4003904c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INIT; 
    }
    namespace FTM1_status{
        using Addr = Register::Address<0x40039050,0xffffff00>;
    ...
    namespace FTM1_mode{
        using Addr = Register::Address<0x40039054,0xffffff00>;
    ...
    namespace FTM1_sync{
        using Addr = Register::Address<0x40039058,0xffffff00>;
    ...
    namespace FTM1_outinit{
        using Addr = Register::Address<0x4003905c,0xffffff00>;
    ...
    namespace FTM1_outmask{
        using Addr = Register::Address<0x40039060,0xffffff00>;
    ...
    namespace FTM1_combine{
        using Addr = Register::Address<0x40039064,0x80808080>;
    ...
    namespace FTM1_deadtime{
        using Addr = Register::Address<0x40039068,0xffffff00>;
    ...
    namespace FTM1_exttrig{
        using Addr = Register::Address<0x4003906c,0xffffff00>;
    ...
    namespace FTM1_pol{
        using Addr = Register::Address<0x40039070,0xffffff00>;
    ...
    namespace FTM1_fms{
        using Addr = Register::Address<0x40039074,0xffffff10>;
    ...
    namespace FTM1_filter{
        using Addr = Register::Address<0x40039078,0xffff0000>;
    ...
    namespace FTM1_fltctrl{
        using Addr = Register::Address<0x4003907c,0xfffff000>;
    ...
    namespace FTM1_qdctrl{
        using Addr = Register::Address<0x40039080,0xffffff00>;
    ...
    namespace FTM1_conf{
        using Addr = Register::Address<0x40039084,0xfffff920>;
    ...
    namespace FTM1_fltpol{
        using Addr = Register::Address<0x40039088,0xfffffff0>;
    ...
    namespace FTM1_synconf{
        using Addr = Register::Address<0x4003908c,0xffe0e04a>;
    ...
    namespace FTM1_invctrl{
        using Addr = Register::Address<0x40039090,0xfffffff0>;
    ...
    namespace FTM1_swoctrl{
        using Addr = Register::Address<0x40039094,0xffff0000>;
    ...
    namespace FTM1_pwmload{
        using Addr = Register::Address<0x40039098,0xfffffd00>;
