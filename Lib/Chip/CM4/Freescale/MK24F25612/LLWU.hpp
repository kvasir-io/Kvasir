...
namespace Kvasir {
    ...
    namespace LLWU_filt1{
        using Addr = Register::Address<0x4007c008,0xffffff10>;
    ...
    namespace LLWU_filt2{
        using Addr = Register::Address<0x4007c009,0xffffff10>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0)> FILTSEL; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,5)> FILTE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> FILTF; 
    }
    namespace LLWU_rst{
        using Addr = Register::Address<0x4007c00a,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> RSTFILT; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> LLRSTE; 
    }
}
