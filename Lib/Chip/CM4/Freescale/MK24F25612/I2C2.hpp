...
//Inter-Integrated Circuit
    namespace I2c2A1{    ///<I2C Address Register 1
        using Addr = Register::Address<0x400e6000,0xffffff01,0x00000000,unsigned char>;
        ///Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> ad{}; 
    }
    namespace I2c2F{    ///<I2C Frequency Divider register
        using Addr = Register::Address<0x400e6001,0xffffff00,0x00000000,unsigned char>;
        ///ClockRate
    ...
    namespace I2c2C1{    ///<I2C Control Register 1
        using Addr = Register::Address<0x400e6002,0xffffff00,0x00000000,unsigned char>;
        ///DMA Enable
        enum class DmaenVal {
    ...
    namespace I2c2S{    ///<I2C Status register
        using Addr = Register::Address<0x400e6003,0xffffff00,0x00000000,unsigned char>;
        ///Receive Acknowledge
        enum class RxakVal {
    ...
    namespace I2c2D{    ///<I2C Data I/O register
        using Addr = Register::Address<0x400e6004,0xffffff00,0x00000000,unsigned char>;
        ///Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace I2c2C2{    ///<I2C Control Register 2
        using Addr = Register::Address<0x400e6005,0xffffff00,0x00000000,unsigned char>;
        ///Slave Address
    ...
    namespace I2c2Flt{    ///<I2C Programmable Input Glitch Filter register
        using Addr = Register::Address<0x400e6006,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace I2c2Ra{    ///<I2C Range Address register
        using Addr = Register::Address<0x400e6007,0xffffff01,0x00000000,unsigned char>;
        ///Range Slave Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> rad{}; 
    }
    namespace I2c2Smb{    ///<I2C SMBus Control and Status register
        using Addr = Register::Address<0x400e6008,0xffffff00,0x00000000,unsigned char>;
    ...
    namespace I2c2A2{    ///<I2C Address Register 2
        using Addr = Register::Address<0x400e6009,0xffffff01,0x00000000,unsigned char>;
        ///SMBus Address
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,1),Register::ReadWriteAccess,unsigned> sad{}; 
    }
    namespace I2c2Slth{    ///<I2C SCL Low Timeout Register High
        using Addr = Register::Address<0x400e600a,0xffffff00,0x00000000,unsigned char>;
        ///SSLT[15:8]
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
    namespace I2c2Sltl{    ///<I2C SCL Low Timeout Register Low
        using Addr = Register::Address<0x400e600b,0xffffff00,0x00000000,unsigned char>;
        ///SSLT[7:0]
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> sslt{}; 
    }
}
