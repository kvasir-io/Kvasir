...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xfffcef1f>;
    ...
    namespace SIM_sopt8{
        using Addr = Register::Address<0x4004801c,0xffc0fff8>;
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xffe7f3bd>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x703bef7c>;
