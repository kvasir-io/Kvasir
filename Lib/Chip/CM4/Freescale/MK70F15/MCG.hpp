...
namespace Kvasir {
    ...
    namespace MCG_c5{
        using Addr = Register::Address<0x40064004,0xffffff18>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> PRDIV0; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PLLREFSEL0; 
    }
    namespace MCG_c6{
    ...
    namespace MCG_c10{
        using Addr = Register::Address<0x4006400f,0xffffff43>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> EREFS1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> HGO1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4)> RANGE1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> LOCRE2; 
    }
    namespace MCG_c11{
        using Addr = Register::Address<0x40064010,0xffffff08>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0)> PRDIV1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PLLCS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> PLLSTEN1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> PLLCLKEN1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> PLLREFSEL1; 
    }
    namespace MCG_c12{
        using Addr = Register::Address<0x40064011,0xffffff40>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0)> VDIV1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> CME2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> LOLIE1; 
    }
    namespace MCG_s2{
        using Addr = Register::Address<0x40064012,0xffffff2c>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> LOCS2; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> OSCINIT1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> PLLCST; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> LOCK1; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7)> LOLS1; 
    }
}
