...
//General Purpose Operational Amplifier
    namespace Opamp1C0{    ///<Control Register 0
        using Addr = Register::Address<0x400f5800,0xffffff3c,0x00000000,unsigned char>;
        ///OPAMP Mode Select
        enum class ModeVal {
    ...
    namespace Opamp1C1{    ///<Control Register 1
        using Addr = Register::Address<0x400f5801,0xffffffe0,0x00000000,unsigned char>;
        ///Gains Selector
    ...
    namespace Opamp1C2{    ///<Control Register 2
        using Addr = Register::Address<0x400f5802,0xffffff88,0x00000000,unsigned char>;
