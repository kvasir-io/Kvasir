...
namespace Kvasir {
    namespace FTM2_sc{
        using Addr = Register::Address<0x400b8000,0xffffff00>;
    ...
    namespace FTM2_cnt{
        using Addr = Register::Address<0x400b8004,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> COUNT; 
    }
    namespace FTM2_mod{
        using Addr = Register::Address<0x400b8008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> MOD; 
    }
    namespace FTM2_c0sc{
        using Addr = Register::Address<0x400b800c,0xffffff02>;
    ...
    namespace FTM2_c1sc{
        using Addr = Register::Address<0x400b8014,0xffffff02>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> DMA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ELSA; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> ELSB; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> MSA; 
    ...
    namespace FTM2_c0v{
        using Addr = Register::Address<0x400b8010,0xffff0000>;
    ...
    namespace FTM2_cntin{
        using Addr = Register::Address<0x400b804c,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> INIT; 
    }
    namespace FTM2_status{
        using Addr = Register::Address<0x400b8050,0xffffff00>;
    ...
    namespace FTM2_mode{
        using Addr = Register::Address<0x400b8054,0xffffff00>;
    ...
    namespace FTM2_sync{
        using Addr = Register::Address<0x400b8058,0xffffff00>;
    ...
    namespace FTM2_outinit{
        using Addr = Register::Address<0x400b805c,0xffffff00>;
    ...
    namespace FTM2_outmask{
        using Addr = Register::Address<0x400b8060,0xffffff00>;
    ...
    namespace FTM2_combine{
        using Addr = Register::Address<0x400b8064,0x80808080>;
    ...
    namespace FTM2_deadtime{
        using Addr = Register::Address<0x400b8068,0xffffff00>;
    ...
    namespace FTM2_exttrig{
        using Addr = Register::Address<0x400b806c,0xffffff00>;
    ...
    namespace FTM2_pol{
        using Addr = Register::Address<0x400b8070,0xffffff00>;
    ...
    namespace FTM2_fms{
        using Addr = Register::Address<0x400b8074,0xffffff10>;
    ...
    namespace FTM2_filter{
        using Addr = Register::Address<0x400b8078,0xffff0000>;
    ...
    namespace FTM2_fltctrl{
        using Addr = Register::Address<0x400b807c,0xfffff000>;
    ...
    namespace FTM2_qdctrl{
        using Addr = Register::Address<0x400b8080,0xffffff00>;
    ...
    namespace FTM2_conf{
        using Addr = Register::Address<0x400b8084,0xfffff920>;
    ...
    namespace FTM2_fltpol{
        using Addr = Register::Address<0x400b8088,0xfffffff0>;
    ...
    namespace FTM2_synconf{
        using Addr = Register::Address<0x400b808c,0xffe0e04a>;
    ...
    namespace FTM2_invctrl{
        using Addr = Register::Address<0x400b8090,0xfffffff0>;
    ...
    namespace FTM2_swoctrl{
        using Addr = Register::Address<0x400b8094,0xffff0000>;
    ...
    namespace FTM2_pwmload{
        using Addr = Register::Address<0x400b8098,0xfffffd00>;
