...
//High-Speed Comparator (CMP), Voltage Reference (VREF) Digital-to-Analog Converter (DAC), and Analog Mux (ANMUX)
    ...
    namespace Cmp1Muxcr{    ///<MUX Control Register
        using Addr = Register::Address<0x4007300d,0xffffff80,0,unsigned char>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,pstmVal> pstm{}; 
    }
}
