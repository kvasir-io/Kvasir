...
//Programmable Delay Block
    ...
    namespace Pdb0Ch2c1{    ///<Channel n Control Register 1
        using Addr = Register::Address<0x40036060,0xff000000,0x00000000,unsigned>;
        ///PDB Channel Pre-Trigger Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> en{}; 
        ///PDB Channel Pre-Trigger Output Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> tos{}; 
    ...
    namespace Pdb0Ch3c1{    ///<Channel n Control Register 1
        using Addr = Register::Address<0x40036088,0xff000000,0x00000000,unsigned>;
        ///PDB Channel Pre-Trigger Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> en{}; 
        ///PDB Channel Pre-Trigger Output Select
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::ReadWriteAccess,unsigned> tos{}; 
    ...
    namespace Pdb0Ch2s{    ///<Channel n Status Register
        using Addr = Register::Address<0x40036064,0xff00ff00,0x00000000,unsigned>;
        ///PDB Channel Sequence Error Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> err{}; 
        ///PDB Channel Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,16),Register::ReadWriteAccess,unsigned> cf{}; 
    ...
    namespace Pdb0Ch3s{    ///<Channel n Status Register
        using Addr = Register::Address<0x4003608c,0xff00ff00,0x00000000,unsigned>;
        ///PDB Channel Sequence Error Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> err{}; 
        ///PDB Channel Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,16),Register::ReadWriteAccess,unsigned> cf{}; 
    ...
    namespace Pdb0Ch2dly0{    ///<Channel n Delay 0 Register
        using Addr = Register::Address<0x40036068,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb0Ch3dly0{    ///<Channel n Delay 0 Register
        using Addr = Register::Address<0x40036090,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    ...
    namespace Pdb0Ch2dly1{    ///<Channel n Delay 1 Register
        using Addr = Register::Address<0x4003606c,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    namespace Pdb0Ch3dly1{    ///<Channel n Delay 1 Register
        using Addr = Register::Address<0x40036094,0xffff0000,0x00000000,unsigned>;
        ///PDB Channel Delay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly{}; 
    }
    ...
    namespace Pdb0Dacintc1{    ///<DAC Interval Trigger n Control Register
        using Addr = Register::Address<0x40036158,0xfffffffc,0x00000000,unsigned>;
        ///DAC Interval Trigger Enable
        enum class ToeVal {
            v0=0x00000000,     ///<DAC interval trigger disabled.
            v1=0x00000001,     ///<DAC interval trigger enabled.
    ...
    namespace Pdb0Po2dly{    ///<Pulse-Out n Delay Register
        using Addr = Register::Address<0x4003619c,0x00000000,0x00000000,unsigned>;
        ///PDB Pulse-Out Delay 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly2{}; 
        ///PDB Pulse-Out Delay 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dly1{}; 
    ...
    namespace Pdb0Po3dly{    ///<Pulse-Out n Delay Register
        using Addr = Register::Address<0x400361a0,0x00000000,0x00000000,unsigned>;
        ///PDB Pulse-Out Delay 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> dly2{}; 
        ///PDB Pulse-Out Delay 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(31,16),Register::ReadWriteAccess,unsigned> dly1{}; 
