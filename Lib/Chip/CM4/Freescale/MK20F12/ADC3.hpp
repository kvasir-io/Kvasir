...
//Analog-to-Digital Converter
    namespace Adc3Cfg1{    ///<ADC configuration register 1
        using Addr = Register::Address<0x400bc008,0xffffff00,0x00000000,unsigned>;
        ///Input clock select
    ...
    namespace Adc3Cfg2{    ///<Configuration register 2
        using Addr = Register::Address<0x400bc00c,0xffffffe0,0x00000000,unsigned>;
    ...
    namespace Adc3Sc2{    ///<Status and control register 2
        using Addr = Register::Address<0x400bc020,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Adc3Sc3{    ///<Status and control register 3
        using Addr = Register::Address<0x400bc024,0xffffff30,0x00000000,unsigned>;
    ...
    namespace Adc3Ofs{    ///<ADC offset correction register
        using Addr = Register::Address<0x400bc028,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Adc3Pg{    ///<ADC plus-side gain register
        using Addr = Register::Address<0x400bc02c,0xffff0000,0x00000000,unsigned>;
        ///Plus-side gain
    ...
    namespace Adc3Mg{    ///<ADC minus-side gain register
        using Addr = Register::Address<0x400bc030,0xffff0000,0x00000000,unsigned>;
        ///Minus-side gain
    ...
    namespace Adc3Clpd{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc034,0xffffffc0,0x00000000,unsigned>;
    ...
    namespace Adc3Clps{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc038,0xffffffc0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp4{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc03c,0xfffffc00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp3{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc040,0xfffffe00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp2{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc044,0xffffff00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp1{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc048,0xffffff80,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clp0{    ///<ADC plus-side general calibration value register
        using Addr = Register::Address<0x400bc04c,0xffffffc0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Pga{    ///<ADC PGA register
        using Addr = Register::Address<0x400bc050,0xff40bfff,0x00000000,unsigned>;
    ...
    namespace Adc3Clmd{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc054,0xffffffc0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clms{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc058,0xffffffc0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm4{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc05c,0xfffffc00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm3{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc060,0xfffffe00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm2{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc064,0xffffff00,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm1{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc068,0xffffff80,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Clm0{    ///<ADC minus-side general calibration value register
        using Addr = Register::Address<0x400bc06c,0xffffffc0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Adc3Sc1a{    ///<ADC status and control registers 1
        using Addr = Register::Address<0x400bc000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Adc3Sc1b{    ///<ADC status and control registers 1
        using Addr = Register::Address<0x400bc004,0xffffff00,0x00000000,unsigned>;
        ///Input channel select
        enum class AdchVal {
            v00000=0x00000000,     ///<When DIFF=0, DADP0 is selected as input; when DIFF=1, DAD0 is selected as input.
            v00001=0x00000001,     ///<When DIFF=0, DADP1 is selected as input; when DIFF=1, DAD1 is selected as input.
    ...
    namespace Adc3Ra{    ///<ADC data result register
        using Addr = Register::Address<0x400bc010,0xffff0000,0x00000000,unsigned>;
        ///Data result
    ...
    namespace Adc3Rb{    ///<ADC data result register
        using Addr = Register::Address<0x400bc014,0xffff0000,0x00000000,unsigned>;
        ///Data result
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> d{}; 
    }
    namespace Adc3Cv1{    ///<Compare value registers
        using Addr = Register::Address<0x400bc018,0xffff0000,0x00000000,unsigned>;
        ///Compare value
    ...
    namespace Adc3Cv2{    ///<Compare value registers
        using Addr = Register::Address<0x400bc01c,0xffff0000,0x00000000,unsigned>;
        ///Compare value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cv{}; 
    }
}
