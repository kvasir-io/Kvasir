...
namespace Kvasir {
    namespace USBDCD_control{
        using Addr = Register::Address<0x40035000,0xfcfcfefe>;
    ...
    namespace USBDCD_clock{
        using Addr = Register::Address<0x40035004,0xfffff002>;
    ...
    namespace USBDCD_status{
        using Addr = Register::Address<0x40035008,0xff80ffff>;
    ...
    namespace USBDCD_timer0{
        using Addr = Register::Address<0x40035010,0xfc00f000>;
    ...
    namespace USBDCD_timer1{
        using Addr = Register::Address<0x40035014,0xfc00fc00>;
    ...
    namespace USBDCD_timer2_bc11{
        using Addr = Register::Address<0x40035018,0xfc00fff0>;
    ...
    namespace USBDCD_timer2_bc12{
        using Addr = Register::Address<0x40035018,0xfc00fc00>;
