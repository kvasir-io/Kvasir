...
namespace Kvasir {
    namespace AIPS0_mpra{
        using Addr = Register::Address<0x40000000,0x88888888>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> MPL7; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> MTW7; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> MTR7; 
