...
//Flex Controller Area Network module
    namespace Can0Mcr{    ///<Module Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,dmaVal> dma{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,dozeVal> doze{}; 
        ///Wake Up Source
    ...
    namespace Can0Esr1{    ///<Error and Status 1 register
        ...
        namespace boffdoneintValC{
            constexpr MPL::Value<boffdoneintVal,boffdoneintVal::v0> v0{};
            constexpr MPL::Value<boffdoneintVal,boffdoneintVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,19),Register::ReadWriteAccess,boffdoneintVal> boffdoneint{}; 
        ///Error Overrun bit
        ...
        namespace errovrValC{
            constexpr MPL::Value<errovrVal,errovrVal::v0> v0{};
            constexpr MPL::Value<errovrVal,errovrVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,errovrVal> errovr{}; 
    }
    namespace Can0Imask1{    ///<Interrupt Masks 1 register
        using Addr = Register::Address<0x40024028,0x00000000,0,unsigned>;
        ///Buffer MB i Mask
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> buf31to0m{}; 
    }
    namespace Can0Iflag1{    ///<Interrupt Flags 1 register
        ...
        namespace buf0iValC{
            constexpr MPL::Value<buf0iVal,buf0iVal::v0> v0{};
            constexpr MPL::Value<buf0iVal,buf0iVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,buf0iVal> buf0i{}; 
        ///Buffer MB i Interrupt Or "reserved"
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,1),Register::ReadWriteAccess,unsigned> buf4to1i{}; 
    ...
    namespace Can0Ctrl2{    ///<Control 2 register
        ...
        namespace boffdonemskValC{
            constexpr MPL::Value<boffdonemskVal,boffdonemskVal::v0> v0{};
            constexpr MPL::Value<boffdonemskVal,boffdonemskVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,boffdonemskVal> boffdonemsk{}; 
    }
    ...
    namespace Can0Cbt{    ///<CAN Bit Timing Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,0),Register::ReadWriteAccess,unsigned> epseg2{}; 
        ///Extended Phase Segment 1
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,5),Register::ReadWriteAccess,unsigned> epseg1{}; 
        ///Extended Propagation Segment
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,10),Register::ReadWriteAccess,unsigned> epropseg{}; 
        ///Extended Resync Jump Width
        constexpr Register::BitLocation<Addr,Register::maskFromRange(19,16),Register::ReadWriteAccess,unsigned> erjw{}; 
        ///Extended Prescaler Division Factor
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,21),Register::ReadWriteAccess,unsigned> epresdiv{}; 
        ...
        namespace btfValC{
            constexpr MPL::Value<btfVal,btfVal::v0> v0{};
            constexpr MPL::Value<btfVal,btfVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,btfVal> btf{}; 
    }
    namespace Can0Cs0{    ///<Message Buffer 0 CS Register
        ...
        ///Reserved
        constexpr Register::BitLocation<Addr,Register::maskFromRange(29,29),Register::ReadWriteAccess,unsigned> esi{}; 
        ///Reserved
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> brs{}; 
        ///Reserved
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> edl{}; 
    }
