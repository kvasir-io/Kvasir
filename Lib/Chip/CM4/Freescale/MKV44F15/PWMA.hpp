...
//Pulse Width Modulator with nano edge placement
    namespace PwmaOuten{    ///<Output Enable Register
        using Addr = Register::Address<0x40033180,0xfffff000,0x00000000,unsigned>;
    ...
    namespace PwmaMask{    ///<Mask Register
        using Addr = Register::Address<0x40033182,0xffff0000,0x00000000,unsigned>;
        ///PWM_X Masks
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,12),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> updateMask{}; 
    }
    namespace PwmaSwcout{    ///<Software Controlled Output Register
        using Addr = Register::Address<0x40033184,0xffffff00,0x00000000,unsigned>;
    ...
    namespace PwmaDtsrcsel{    ///<PWM Source Select Register
        using Addr = Register::Address<0x40033186,0xffff0000,0x00000000,unsigned>;
    ...
    namespace PwmaMctrl{    ///<Master Control Register
        using Addr = Register::Address<0x40033188,0xffff0000,0x00000000,unsigned>;
        ///Load Okay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> ldok{}; 
        ///Clear Load Okay
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cldok{}; 
        ///Run
    ...
    namespace PwmaMctrl2{    ///<Master Control 2 Register
        using Addr = Register::Address<0x4003318a,0xfffffffc,0x00000000,unsigned>;
        ///Monitor PLL State
    ...
    namespace PwmaFctrl{    ///<Fault Control Register
        using Addr = Register::Address<0x4003318c,0xffff0000,0x00000000,unsigned>;
    ...
    namespace PwmaFsts{    ///<Fault Status Register
        using Addr = Register::Address<0x4003318e,0xffff0000,0x00000000,unsigned>;
        ///Fault Flags
        ...
        ///Filtered Fault Pins
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ffpin{}; 
    ...
    namespace PwmaFfilt{    ///<Fault Filter Register
        using Addr = Register::Address<0x40033190,0xffff7800,0x00000000,unsigned>;
        ///Fault Filter Period
    ...
    namespace PwmaFtst{    ///<Fault Test Register
        using Addr = Register::Address<0x40033192,0xfffffffe,0x00000000,unsigned>;
        ///Fault Test
        enum class FtestVal {
    ...
    namespace PwmaFctrl2{    ///<Fault Control 2 Register
        using Addr = Register::Address<0x40033194,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace PwmaSm1cnt{    ///<Counter Register
        using Addr = Register::Address<0x40033060,0xffff0000,0x00000000,unsigned>;
        ///Counter Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cnt{}; 
    }
    namespace PwmaSm2cnt{    ///<Counter Register
        using Addr = Register::Address<0x400330c0,0xffff0000,0x00000000,unsigned>;
        ///Counter Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cnt{}; 
    }
    namespace PwmaSm3cnt{    ///<Counter Register
        using Addr = Register::Address<0x40033120,0xffff0000,0x00000000,unsigned>;
        ///Counter Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cnt{}; 
    }
    namespace PwmaSm0init{    ///<Initial Count Register
        using Addr = Register::Address<0x40033002,0xffff0000,0x00000000,unsigned>;
    ...
    namespace PwmaSm1init{    ///<Initial Count Register
        using Addr = Register::Address<0x40033062,0xffff0000,0x00000000,unsigned>;
        ///Initial Count Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> init{}; 
    }
    namespace PwmaSm2init{    ///<Initial Count Register
        using Addr = Register::Address<0x400330c2,0xffff0000,0x00000000,unsigned>;
        ///Initial Count Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> init{}; 
    }
    namespace PwmaSm3init{    ///<Initial Count Register
        using Addr = Register::Address<0x40033122,0xffff0000,0x00000000,unsigned>;
        ///Initial Count Register Bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> init{}; 
    }
    namespace PwmaSm0ctrl2{    ///<Control 2 Register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> force{}; 
    ...
    namespace PwmaSm1ctrl2{    ///<Control 2 Register
        using Addr = Register::Address<0x40033064,0xffff0000,0x00000000,unsigned>;
        ///Clock Source Select
        enum class ClkselVal {
            v00=0x00000000,     ///<The IPBus clock is used as the clock for the local prescaler and counter.
            v01=0x00000001,     ///<EXT_CLK is used as the clock for the local prescaler and counter.
    ...
    namespace PwmaSm2ctrl2{    ///<Control 2 Register
        using Addr = Register::Address<0x400330c4,0xffff0000,0x00000000,unsigned>;
        ///Clock Source Select
        enum class ClkselVal {
            v00=0x00000000,     ///<The IPBus clock is used as the clock for the local prescaler and counter.
            v01=0x00000001,     ///<EXT_CLK is used as the clock for the local prescaler and counter.
    ...
    namespace PwmaSm3ctrl2{    ///<Control 2 Register
        using Addr = Register::Address<0x40033124,0xffff0000,0x00000000,unsigned>;
        ///Clock Source Select
        enum class ClkselVal {
            v00=0x00000000,     ///<The IPBus clock is used as the clock for the local prescaler and counter.
            v01=0x00000001,     ///<EXT_CLK is used as the clock for the local prescaler and counter.
    ...
    namespace PwmaSm0ctrl{    ///<Control Register
        using Addr = Register::Address<0x40033006,0xffff0088,0x00000000,unsigned>;
        ...
        ///Deadtime
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(9,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> dt{}; 
        ///Full Cycle Reload
        enum class FullVal {
    ...
    namespace PwmaSm1ctrl{    ///<Control Register
        using Addr = Register::Address<0x40033066,0xffff0088,0x00000000,unsigned>;
        ///Double Switching Enable
        enum class DblenVal {
            v0=0x00000000,     ///<Double switching disabled.
            v1=0x00000001,     ///<Double switching enabled.
    ...
    namespace PwmaSm2ctrl{    ///<Control Register
        using Addr = Register::Address<0x400330c6,0xffff0088,0x00000000,unsigned>;
        ///Double Switching Enable
        enum class DblenVal {
            v0=0x00000000,     ///<Double switching disabled.
            v1=0x00000001,     ///<Double switching enabled.
    ...
    namespace PwmaSm3ctrl{    ///<Control Register
        using Addr = Register::Address<0x40033126,0xffff0088,0x00000000,unsigned>;
        ///Double Switching Enable
        enum class DblenVal {
            v0=0x00000000,     ///<Double switching disabled.
            v1=0x00000001,     ///<Double switching enabled.
    ...
    namespace PwmaSm0val0{    ///<Value Register 0
        using Addr = Register::Address<0x4003300a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 0
    ...
    namespace PwmaSm1val0{    ///<Value Register 0
        using Addr = Register::Address<0x4003306a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val0{}; 
    }
    namespace PwmaSm2val0{    ///<Value Register 0
        using Addr = Register::Address<0x400330ca,0xffff0000,0x00000000,unsigned>;
        ///Value Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val0{}; 
    }
    namespace PwmaSm3val0{    ///<Value Register 0
        using Addr = Register::Address<0x4003312a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val0{}; 
    }
    namespace PwmaSm0fracval1{    ///<Fractional Value Register 1
        using Addr = Register::Address<0x4003300c,0xffff07ff,0x00000000,unsigned>;
    ...
    namespace PwmaSm1fracval1{    ///<Fractional Value Register 1
        using Addr = Register::Address<0x4003306c,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 1 Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval1{}; 
    }
    namespace PwmaSm2fracval1{    ///<Fractional Value Register 1
        using Addr = Register::Address<0x400330cc,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 1 Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval1{}; 
    }
    namespace PwmaSm3fracval1{    ///<Fractional Value Register 1
        using Addr = Register::Address<0x4003312c,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 1 Register
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval1{}; 
    }
    namespace PwmaSm0val1{    ///<Value Register 1
        using Addr = Register::Address<0x4003300e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 1
    ...
    namespace PwmaSm1val1{    ///<Value Register 1
        using Addr = Register::Address<0x4003306e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val1{}; 
    }
    namespace PwmaSm2val1{    ///<Value Register 1
        using Addr = Register::Address<0x400330ce,0xffff0000,0x00000000,unsigned>;
        ///Value Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val1{}; 
    }
    namespace PwmaSm3val1{    ///<Value Register 1
        using Addr = Register::Address<0x4003312e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val1{}; 
    }
    namespace PwmaSm0fracval2{    ///<Fractional Value Register 2
        using Addr = Register::Address<0x40033010,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 2
    ...
    namespace PwmaSm1fracval2{    ///<Fractional Value Register 2
        using Addr = Register::Address<0x40033070,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval2{}; 
    }
    namespace PwmaSm2fracval2{    ///<Fractional Value Register 2
        using Addr = Register::Address<0x400330d0,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval2{}; 
    }
    namespace PwmaSm3fracval2{    ///<Fractional Value Register 2
        using Addr = Register::Address<0x40033130,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval2{}; 
    }
    namespace PwmaSm0val2{    ///<Value Register 2
        using Addr = Register::Address<0x40033012,0xffff0000,0x00000000,unsigned>;
        ///Value Register 2
    ...
    namespace PwmaSm1val2{    ///<Value Register 2
        using Addr = Register::Address<0x40033072,0xffff0000,0x00000000,unsigned>;
        ///Value Register 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val2{}; 
    }
    namespace PwmaSm2val2{    ///<Value Register 2
        using Addr = Register::Address<0x400330d2,0xffff0000,0x00000000,unsigned>;
        ///Value Register 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val2{}; 
    }
    namespace PwmaSm3val2{    ///<Value Register 2
        using Addr = Register::Address<0x40033132,0xffff0000,0x00000000,unsigned>;
        ///Value Register 2
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val2{}; 
    }
    namespace PwmaSm0fracval3{    ///<Fractional Value Register 3
        using Addr = Register::Address<0x40033014,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 3
    ...
    namespace PwmaSm1fracval3{    ///<Fractional Value Register 3
        using Addr = Register::Address<0x40033074,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval3{}; 
    }
    namespace PwmaSm2fracval3{    ///<Fractional Value Register 3
        using Addr = Register::Address<0x400330d4,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval3{}; 
    }
    namespace PwmaSm3fracval3{    ///<Fractional Value Register 3
        using Addr = Register::Address<0x40033134,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval3{}; 
    }
    namespace PwmaSm0val3{    ///<Value Register 3
        using Addr = Register::Address<0x40033016,0xffff0000,0x00000000,unsigned>;
        ///Value Register 3
    ...
    namespace PwmaSm1val3{    ///<Value Register 3
        using Addr = Register::Address<0x40033076,0xffff0000,0x00000000,unsigned>;
        ///Value Register 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val3{}; 
    }
    namespace PwmaSm2val3{    ///<Value Register 3
        using Addr = Register::Address<0x400330d6,0xffff0000,0x00000000,unsigned>;
        ///Value Register 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val3{}; 
    }
    namespace PwmaSm3val3{    ///<Value Register 3
        using Addr = Register::Address<0x40033136,0xffff0000,0x00000000,unsigned>;
        ///Value Register 3
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val3{}; 
    }
    namespace PwmaSm0fracval4{    ///<Fractional Value Register 4
        using Addr = Register::Address<0x40033018,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 4
    ...
    namespace PwmaSm1fracval4{    ///<Fractional Value Register 4
        using Addr = Register::Address<0x40033078,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval4{}; 
    }
    namespace PwmaSm2fracval4{    ///<Fractional Value Register 4
        using Addr = Register::Address<0x400330d8,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval4{}; 
    }
    namespace PwmaSm3fracval4{    ///<Fractional Value Register 4
        using Addr = Register::Address<0x40033138,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval4{}; 
    }
    namespace PwmaSm0val4{    ///<Value Register 4
        using Addr = Register::Address<0x4003301a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 4
    ...
    namespace PwmaSm1val4{    ///<Value Register 4
        using Addr = Register::Address<0x4003307a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val4{}; 
    }
    namespace PwmaSm2val4{    ///<Value Register 4
        using Addr = Register::Address<0x400330da,0xffff0000,0x00000000,unsigned>;
        ///Value Register 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val4{}; 
    }
    namespace PwmaSm3val4{    ///<Value Register 4
        using Addr = Register::Address<0x4003313a,0xffff0000,0x00000000,unsigned>;
        ///Value Register 4
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val4{}; 
    }
    namespace PwmaSm0fracval5{    ///<Fractional Value Register 5
        using Addr = Register::Address<0x4003301c,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 5
    ...
    namespace PwmaSm1fracval5{    ///<Fractional Value Register 5
        using Addr = Register::Address<0x4003307c,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval5{}; 
    }
    namespace PwmaSm2fracval5{    ///<Fractional Value Register 5
        using Addr = Register::Address<0x400330dc,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval5{}; 
    }
    namespace PwmaSm3fracval5{    ///<Fractional Value Register 5
        using Addr = Register::Address<0x4003313c,0xffff07ff,0x00000000,unsigned>;
        ///Fractional Value 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,11),Register::ReadWriteAccess,unsigned> fracval5{}; 
    }
    namespace PwmaSm0val5{    ///<Value Register 5
        using Addr = Register::Address<0x4003301e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 5
    ...
    namespace PwmaSm1val5{    ///<Value Register 5
        using Addr = Register::Address<0x4003307e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val5{}; 
    }
    namespace PwmaSm2val5{    ///<Value Register 5
        using Addr = Register::Address<0x400330de,0xffff0000,0x00000000,unsigned>;
        ///Value Register 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val5{}; 
    }
    namespace PwmaSm3val5{    ///<Value Register 5
        using Addr = Register::Address<0x4003313e,0xffff0000,0x00000000,unsigned>;
        ///Value Register 5
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val5{}; 
    }
    namespace PwmaSm0frctrl{    ///<Fractional Control Register
        using Addr = Register::Address<0x40033020,0xffff7ee9,0x00000000,unsigned>;
        ...
        ///Test Status Bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> test{}; 
    }
    namespace PwmaSm1frctrl{    ///<Fractional Control Register
        using Addr = Register::Address<0x40033080,0xffff7ee9,0x00000000,unsigned>;
        ///Fractional Cycle PWM Period Enable
        enum class Frac1enVal {
            v0=0x00000000,     ///<Disable fractional cycle length for the PWM period.
            v1=0x00000001,     ///<Enable fractional cycle length for the PWM period.
    ...
    namespace PwmaSm2frctrl{    ///<Fractional Control Register
        using Addr = Register::Address<0x400330e0,0xffff7ee9,0x00000000,unsigned>;
        ///Fractional Cycle PWM Period Enable
        enum class Frac1enVal {
            v0=0x00000000,     ///<Disable fractional cycle length for the PWM period.
            v1=0x00000001,     ///<Enable fractional cycle length for the PWM period.
    ...
    namespace PwmaSm3frctrl{    ///<Fractional Control Register
        using Addr = Register::Address<0x40033140,0xffff7ee9,0x00000000,unsigned>;
        ///Fractional Cycle PWM Period Enable
        enum class Frac1enVal {
            v0=0x00000000,     ///<Disable fractional cycle length for the PWM period.
            v1=0x00000001,     ///<Enable fractional cycle length for the PWM period.
    ...
    namespace PwmaSm0octrl{    ///<Output Control Register
        using Addr = Register::Address<0x40033022,0xffff18c0,0x00000000,unsigned>;
        ///PWM_X Fault State
        ...
        ///PWM_X Input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(13,13),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> pwmxIn{}; 
        ///PWM_B Input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> pwmbIn{}; 
        ///PWM_A Input
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> pwmaIn{}; 
    }
    namespace PwmaSm1octrl{    ///<Output Control Register
        using Addr = Register::Address<0x40033082,0xffff18c0,0x00000000,unsigned>;
        ///PWM_X Fault State
        enum class PwmxfsVal {
            v00=0x00000000,     ///<Output is forced to logic 0 state prior to consideration of output polarity control.
            v01=0x00000001,     ///<Output is forced to logic 1 state prior to consideration of output polarity control.
    ...
    namespace PwmaSm2octrl{    ///<Output Control Register
        using Addr = Register::Address<0x400330e2,0xffff18c0,0x00000000,unsigned>;
        ///PWM_X Fault State
        enum class PwmxfsVal {
            v00=0x00000000,     ///<Output is forced to logic 0 state prior to consideration of output polarity control.
            v01=0x00000001,     ///<Output is forced to logic 1 state prior to consideration of output polarity control.
    ...
    namespace PwmaSm3octrl{    ///<Output Control Register
        using Addr = Register::Address<0x40033142,0xffff18c0,0x00000000,unsigned>;
        ///PWM_X Fault State
        enum class PwmxfsVal {
            v00=0x00000000,     ///<Output is forced to logic 0 state prior to consideration of output polarity control.
            v01=0x00000001,     ///<Output is forced to logic 1 state prior to consideration of output polarity control.
    ...
    namespace PwmaSm0sts{    ///<Status Register
        using Addr = Register::Address<0x40033024,0xffff8000,0x00000000,unsigned>;
        ///Compare Flags
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,RufVal> ruf{}; 
        namespace RufValC{
    ...
    namespace PwmaSm1sts{    ///<Status Register
        using Addr = Register::Address<0x40033084,0xffff8000,0x00000000,unsigned>;
        ///Compare Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpf{}; 
        ///Capture Flag X0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> cfx0{}; 
    ...
    namespace PwmaSm2sts{    ///<Status Register
        using Addr = Register::Address<0x400330e4,0xffff8000,0x00000000,unsigned>;
        ///Compare Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpf{}; 
        ///Capture Flag X0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> cfx0{}; 
    ...
    namespace PwmaSm3sts{    ///<Status Register
        using Addr = Register::Address<0x40033144,0xffff8000,0x00000000,unsigned>;
        ///Compare Flags
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpf{}; 
        ///Capture Flag X0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> cfx0{}; 
    ...
    namespace PwmaSm0inten{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40033026,0xffffc000,0x00000000,unsigned>;
    ...
    namespace PwmaSm1inten{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40033086,0xffffc000,0x00000000,unsigned>;
        ///Compare Interrupt Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpie{}; 
        ///Capture X 0 Interrupt Enable
        enum class Cx0ieVal {
    ...
    namespace PwmaSm2inten{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x400330e6,0xffffc000,0x00000000,unsigned>;
        ///Compare Interrupt Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpie{}; 
        ///Capture X 0 Interrupt Enable
        enum class Cx0ieVal {
    ...
    namespace PwmaSm3inten{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40033146,0xffffc000,0x00000000,unsigned>;
        ///Compare Interrupt Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> cmpie{}; 
        ///Capture X 0 Interrupt Enable
        enum class Cx0ieVal {
    ...
    namespace PwmaSm0dmaen{    ///<DMA Enable Register
        using Addr = Register::Address<0x40033028,0xfffffc00,0x00000000,unsigned>;
    ...
    namespace PwmaSm1dmaen{    ///<DMA Enable Register
        using Addr = Register::Address<0x40033088,0xfffffc00,0x00000000,unsigned>;
        ///Capture X0 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cx0de{}; 
        ///Capture X1 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> cx1de{}; 
    ...
    namespace PwmaSm2dmaen{    ///<DMA Enable Register
        using Addr = Register::Address<0x400330e8,0xfffffc00,0x00000000,unsigned>;
        ///Capture X0 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cx0de{}; 
        ///Capture X1 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> cx1de{}; 
    ...
    namespace PwmaSm3dmaen{    ///<DMA Enable Register
        using Addr = Register::Address<0x40033148,0xfffffc00,0x00000000,unsigned>;
        ///Capture X0 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> cx0de{}; 
        ///Capture X1 FIFO DMA Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> cx1de{}; 
    ...
    namespace PwmaSm0tctrl{    ///<Output Trigger Control Register
        using Addr = Register::Address<0x4003302a,0xffff3fc0,0x00000000,unsigned>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,Pwbot1Val> pwbot1{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,15),Register::Access<Register::AccessType::writeOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,Pwaot0Val> pwaot0{}; 
    ...
    namespace PwmaSm1tctrl{    ///<Output Trigger Control Register
        using Addr = Register::Address<0x4003308a,0xffff3fc0,0x00000000,unsigned>;
        ///Output Trigger Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> outTrigEn{}; 
        ///Output Trigger 1 Source Select
        enum class Pwbot1Val {
    ...
    namespace PwmaSm2tctrl{    ///<Output Trigger Control Register
        using Addr = Register::Address<0x400330ea,0xffff3fc0,0x00000000,unsigned>;
        ///Output Trigger Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> outTrigEn{}; 
        ///Output Trigger 1 Source Select
        enum class Pwbot1Val {
    ...
    namespace PwmaSm3tctrl{    ///<Output Trigger Control Register
        using Addr = Register::Address<0x4003314a,0xffff3fc0,0x00000000,unsigned>;
        ///Output Trigger Enables
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,0),Register::ReadWriteAccess,unsigned> outTrigEn{}; 
        ///Output Trigger 1 Source Select
        enum class Pwbot1Val {
    ...
    namespace PwmaSm0dismap0{    ///<Fault Disable Mapping Register 0
        using Addr = Register::Address<0x4003302c,0xfffff000,0x00000000,unsigned>;
    ...
    namespace PwmaSm1dismap0{    ///<Fault Disable Mapping Register 0
        using Addr = Register::Address<0x4003308c,0xfffff000,0x00000000,unsigned>;
        ///PWM_A Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> dis0a{}; 
        ///PWM_B Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> dis0b{}; 
    ...
    namespace PwmaSm2dismap0{    ///<Fault Disable Mapping Register 0
        using Addr = Register::Address<0x400330ec,0xfffff000,0x00000000,unsigned>;
        ///PWM_A Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> dis0a{}; 
        ///PWM_B Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> dis0b{}; 
    ...
    namespace PwmaSm3dismap0{    ///<Fault Disable Mapping Register 0
        using Addr = Register::Address<0x4003314c,0xfffff000,0x00000000,unsigned>;
        ///PWM_A Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> dis0a{}; 
        ///PWM_B Fault Disable Mask 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,4),Register::ReadWriteAccess,unsigned> dis0b{}; 
    ...
    namespace PwmaSm0dtcnt0{    ///<Deadtime Count Register 0
        using Addr = Register::Address<0x40033030,0xfffff800,0x00000000,unsigned>;
    ...
    namespace PwmaSm1dtcnt0{    ///<Deadtime Count Register 0
        using Addr = Register::Address<0x40033090,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt0{}; 
    }
    namespace PwmaSm2dtcnt0{    ///<Deadtime Count Register 0
        using Addr = Register::Address<0x400330f0,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt0{}; 
    }
    namespace PwmaSm3dtcnt0{    ///<Deadtime Count Register 0
        using Addr = Register::Address<0x40033150,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt0{}; 
    }
    namespace PwmaSm0dtcnt1{    ///<Deadtime Count Register 1
        using Addr = Register::Address<0x40033032,0xfffff800,0x00000000,unsigned>;
    ...
    namespace PwmaSm1dtcnt1{    ///<Deadtime Count Register 1
        using Addr = Register::Address<0x40033092,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt1{}; 
    }
    namespace PwmaSm2dtcnt1{    ///<Deadtime Count Register 1
        using Addr = Register::Address<0x400330f2,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt1{}; 
    }
    namespace PwmaSm3dtcnt1{    ///<Deadtime Count Register 1
        using Addr = Register::Address<0x40033152,0xfffff800,0x00000000,unsigned>;
        ///Deadtime Count Register 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(10,0),Register::ReadWriteAccess,unsigned> dtcnt1{}; 
    }
    namespace PwmaSm0captctrla{    ///<Capture Control A Register
        using Addr = Register::Address<0x40033034,0xffff0000,0x00000000,unsigned>;
        ///Arm A
        enum class ArmaVal {
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,10),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ca0cnt{}; 
        ///Capture A1 FIFO Word Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,13),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> ca1cnt{}; 
    }
    namespace PwmaSm1captctrla{    ///<Capture Control A Register
        using Addr = Register::Address<0x40033094,0xffff0000,0x00000000,unsigned>;
        ///Arm A
        enum class ArmaVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLA[EDGAx] is enabled.
    ...
    namespace PwmaSm2captctrla{    ///<Capture Control A Register
        using Addr = Register::Address<0x400330f4,0xffff0000,0x00000000,unsigned>;
        ///Arm A
        enum class ArmaVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLA[EDGAx] is enabled.
    ...
    namespace PwmaSm3captctrla{    ///<Capture Control A Register
        using Addr = Register::Address<0x40033154,0xffff0000,0x00000000,unsigned>;
        ///Arm A
        enum class ArmaVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLA[EDGAx] is enabled.
    ...
    namespace PwmaSm0captcompa{    ///<Capture Compare A Register
        using Addr = Register::Address<0x40033036,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpa{}; 
        ///Edge Counter A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcnta{}; 
    }
    namespace PwmaSm1captcompa{    ///<Capture Compare A Register
        using Addr = Register::Address<0x40033096,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpa{}; 
        ///Edge Counter A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcnta{}; 
    ...
    namespace PwmaSm2captcompa{    ///<Capture Compare A Register
        using Addr = Register::Address<0x400330f6,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpa{}; 
        ///Edge Counter A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcnta{}; 
    ...
    namespace PwmaSm3captcompa{    ///<Capture Compare A Register
        using Addr = Register::Address<0x40033156,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpa{}; 
        ///Edge Counter A
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcnta{}; 
    ...
    namespace PwmaSm0captctrlb{    ///<Capture Control B Register
        using Addr = Register::Address<0x40033038,0xffff0000,0x00000000,unsigned>;
        ///Arm B
        enum class ArmbVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,10),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cb0cnt{}; 
        ///Capture B1 FIFO Word Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,13),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cb1cnt{}; 
    }
    namespace PwmaSm1captctrlb{    ///<Capture Control B Register
        using Addr = Register::Address<0x40033098,0xffff0000,0x00000000,unsigned>;
        ///Arm B
        enum class ArmbVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLB[EDGBx] is enabled.
    ...
    namespace PwmaSm2captctrlb{    ///<Capture Control B Register
        using Addr = Register::Address<0x400330f8,0xffff0000,0x00000000,unsigned>;
        ///Arm B
        enum class ArmbVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLB[EDGBx] is enabled.
    ...
    namespace PwmaSm3captctrlb{    ///<Capture Control B Register
        using Addr = Register::Address<0x40033158,0xffff0000,0x00000000,unsigned>;
        ///Arm B
        enum class ArmbVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLB[EDGBx] is enabled.
    ...
    namespace PwmaSm0captcompb{    ///<Capture Compare B Register
        using Addr = Register::Address<0x4003303a,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpb{}; 
        ///Edge Counter B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntb{}; 
    }
    namespace PwmaSm1captcompb{    ///<Capture Compare B Register
        using Addr = Register::Address<0x4003309a,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpb{}; 
        ///Edge Counter B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntb{}; 
    ...
    namespace PwmaSm2captcompb{    ///<Capture Compare B Register
        using Addr = Register::Address<0x400330fa,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpb{}; 
        ///Edge Counter B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntb{}; 
    ...
    namespace PwmaSm3captcompb{    ///<Capture Compare B Register
        using Addr = Register::Address<0x4003315a,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpb{}; 
        ///Edge Counter B
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntb{}; 
    ...
    namespace PwmaSm0captctrlx{    ///<Capture Control X Register
        using Addr = Register::Address<0x4003303c,0xffff0000,0x00000000,unsigned>;
        ///Arm X
        enum class ArmxVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,10),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cx0cnt{}; 
        ///Capture X1 FIFO Word Count
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,13),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cx1cnt{}; 
    }
    namespace PwmaSm1captctrlx{    ///<Capture Control X Register
        using Addr = Register::Address<0x4003309c,0xffff0000,0x00000000,unsigned>;
        ///Arm X
        enum class ArmxVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLX[EDGXx] is enabled.
    ...
    namespace PwmaSm2captctrlx{    ///<Capture Control X Register
        using Addr = Register::Address<0x400330fc,0xffff0000,0x00000000,unsigned>;
        ///Arm X
        enum class ArmxVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLX[EDGXx] is enabled.
    ...
    namespace PwmaSm3captctrlx{    ///<Capture Control X Register
        using Addr = Register::Address<0x4003315c,0xffff0000,0x00000000,unsigned>;
        ///Arm X
        enum class ArmxVal {
            v0=0x00000000,     ///<Input capture operation is disabled.
            v1=0x00000001,     ///<Input capture operation as specified by CAPTCTRLX[EDGXx] is enabled.
    ...
    namespace PwmaSm0captcompx{    ///<Capture Compare X Register
        using Addr = Register::Address<0x4003303e,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpx{}; 
        ///Edge Counter X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntx{}; 
    }
    namespace PwmaSm1captcompx{    ///<Capture Compare X Register
        using Addr = Register::Address<0x4003309e,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpx{}; 
        ///Edge Counter X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntx{}; 
    ...
    namespace PwmaSm2captcompx{    ///<Capture Compare X Register
        using Addr = Register::Address<0x400330fe,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpx{}; 
        ///Edge Counter X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntx{}; 
    ...
    namespace PwmaSm3captcompx{    ///<Capture Compare X Register
        using Addr = Register::Address<0x4003315e,0xffff0000,0x00000000,unsigned>;
        ///Edge Compare X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> edgcmpx{}; 
        ///Edge Counter X
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,8),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> edgcntx{}; 
    ...
    namespace PwmaSm0cval0{    ///<Capture Value 0 Register
        using Addr = Register::Address<0x40033040,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval0{}; 
    }
    namespace PwmaSm1cval0{    ///<Capture Value 0 Register
        using Addr = Register::Address<0x400330a0,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval0{}; 
    }
    namespace PwmaSm2cval0{    ///<Capture Value 0 Register
        using Addr = Register::Address<0x40033100,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval0{}; 
    }
    namespace PwmaSm3cval0{    ///<Capture Value 0 Register
        using Addr = Register::Address<0x40033160,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval0{}; 
    }
    namespace PwmaSm0cval0cyc{    ///<Capture Value 0 Cycle Register
        using Addr = Register::Address<0x40033042,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval0cyc{}; 
    }
    namespace PwmaSm1cval0cyc{    ///<Capture Value 0 Cycle Register
        using Addr = Register::Address<0x400330a2,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval0cyc{}; 
    }
    namespace PwmaSm2cval0cyc{    ///<Capture Value 0 Cycle Register
        using Addr = Register::Address<0x40033102,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval0cyc{}; 
    }
    namespace PwmaSm3cval0cyc{    ///<Capture Value 0 Cycle Register
        using Addr = Register::Address<0x40033162,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval0cyc{}; 
    }
    namespace PwmaSm0cval1{    ///<Capture Value 1 Register
        using Addr = Register::Address<0x40033044,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval1{}; 
    }
    namespace PwmaSm1cval1{    ///<Capture Value 1 Register
        using Addr = Register::Address<0x400330a4,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval1{}; 
    }
    namespace PwmaSm2cval1{    ///<Capture Value 1 Register
        using Addr = Register::Address<0x40033104,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval1{}; 
    }
    namespace PwmaSm3cval1{    ///<Capture Value 1 Register
        using Addr = Register::Address<0x40033164,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval1{}; 
    }
    namespace PwmaSm0cval1cyc{    ///<Capture Value 1 Cycle Register
        using Addr = Register::Address<0x40033046,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval1cyc{}; 
    }
    namespace PwmaSm1cval1cyc{    ///<Capture Value 1 Cycle Register
        using Addr = Register::Address<0x400330a6,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval1cyc{}; 
    }
    namespace PwmaSm2cval1cyc{    ///<Capture Value 1 Cycle Register
        using Addr = Register::Address<0x40033106,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval1cyc{}; 
    }
    namespace PwmaSm3cval1cyc{    ///<Capture Value 1 Cycle Register
        using Addr = Register::Address<0x40033166,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval1cyc{}; 
    }
    namespace PwmaSm0cval2{    ///<Capture Value 2 Register
        using Addr = Register::Address<0x40033048,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval2{}; 
    }
    namespace PwmaSm1cval2{    ///<Capture Value 2 Register
        using Addr = Register::Address<0x400330a8,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval2{}; 
    }
    namespace PwmaSm2cval2{    ///<Capture Value 2 Register
        using Addr = Register::Address<0x40033108,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval2{}; 
    }
    namespace PwmaSm3cval2{    ///<Capture Value 2 Register
        using Addr = Register::Address<0x40033168,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval2{}; 
    }
    namespace PwmaSm0cval2cyc{    ///<Capture Value 2 Cycle Register
        using Addr = Register::Address<0x4003304a,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval2cyc{}; 
    }
    namespace PwmaSm1cval2cyc{    ///<Capture Value 2 Cycle Register
        using Addr = Register::Address<0x400330aa,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval2cyc{}; 
    }
    namespace PwmaSm2cval2cyc{    ///<Capture Value 2 Cycle Register
        using Addr = Register::Address<0x4003310a,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval2cyc{}; 
    }
    namespace PwmaSm3cval2cyc{    ///<Capture Value 2 Cycle Register
        using Addr = Register::Address<0x4003316a,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval2cyc{}; 
    }
    namespace PwmaSm0cval3{    ///<Capture Value 3 Register
        using Addr = Register::Address<0x4003304c,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval3{}; 
    }
    namespace PwmaSm1cval3{    ///<Capture Value 3 Register
        using Addr = Register::Address<0x400330ac,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval3{}; 
    }
    namespace PwmaSm2cval3{    ///<Capture Value 3 Register
        using Addr = Register::Address<0x4003310c,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval3{}; 
    }
    namespace PwmaSm3cval3{    ///<Capture Value 3 Register
        using Addr = Register::Address<0x4003316c,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval3{}; 
    }
    namespace PwmaSm0cval3cyc{    ///<Capture Value 3 Cycle Register
        using Addr = Register::Address<0x4003304e,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval3cyc{}; 
    }
    namespace PwmaSm1cval3cyc{    ///<Capture Value 3 Cycle Register
        using Addr = Register::Address<0x400330ae,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval3cyc{}; 
    }
    namespace PwmaSm2cval3cyc{    ///<Capture Value 3 Cycle Register
        using Addr = Register::Address<0x4003310e,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval3cyc{}; 
    }
    namespace PwmaSm3cval3cyc{    ///<Capture Value 3 Cycle Register
        using Addr = Register::Address<0x4003316e,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval3cyc{}; 
    }
    namespace PwmaSm0cval4{    ///<Capture Value 4 Register
        using Addr = Register::Address<0x40033050,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval4{}; 
    }
    namespace PwmaSm1cval4{    ///<Capture Value 4 Register
        using Addr = Register::Address<0x400330b0,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval4{}; 
    }
    namespace PwmaSm2cval4{    ///<Capture Value 4 Register
        using Addr = Register::Address<0x40033110,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval4{}; 
    }
    namespace PwmaSm3cval4{    ///<Capture Value 4 Register
        using Addr = Register::Address<0x40033170,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval4{}; 
    }
    namespace PwmaSm0cval4cyc{    ///<Capture Value 4 Cycle Register
        using Addr = Register::Address<0x40033052,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval4cyc{}; 
    }
    namespace PwmaSm1cval4cyc{    ///<Capture Value 4 Cycle Register
        using Addr = Register::Address<0x400330b2,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval4cyc{}; 
    }
    namespace PwmaSm2cval4cyc{    ///<Capture Value 4 Cycle Register
        using Addr = Register::Address<0x40033112,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval4cyc{}; 
    }
    namespace PwmaSm3cval4cyc{    ///<Capture Value 4 Cycle Register
        using Addr = Register::Address<0x40033172,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval4cyc{}; 
    }
    namespace PwmaSm0cval5{    ///<Capture Value 5 Register
        using Addr = Register::Address<0x40033054,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval5{}; 
    }
    namespace PwmaSm1cval5{    ///<Capture Value 5 Register
        using Addr = Register::Address<0x400330b4,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval5{}; 
    }
    namespace PwmaSm2cval5{    ///<Capture Value 5 Register
        using Addr = Register::Address<0x40033114,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval5{}; 
    }
    namespace PwmaSm3cval5{    ///<Capture Value 5 Register
        using Addr = Register::Address<0x40033174,0xffff0000,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> captval5{}; 
    }
    namespace PwmaSm0cval5cyc{    ///<Capture Value 5 Cycle Register
        using Addr = Register::Address<0x40033056,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval5cyc{}; 
    }
    namespace PwmaSm1cval5cyc{    ///<Capture Value 5 Cycle Register
        using Addr = Register::Address<0x400330b6,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval5cyc{}; 
    }
    namespace PwmaSm2cval5cyc{    ///<Capture Value 5 Cycle Register
        using Addr = Register::Address<0x40033116,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval5cyc{}; 
    }
    namespace PwmaSm3cval5cyc{    ///<Capture Value 5 Cycle Register
        using Addr = Register::Address<0x40033176,0xfffffff0,0x00000000,unsigned>;
        ///no description available
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cval5cyc{}; 
    }
}
