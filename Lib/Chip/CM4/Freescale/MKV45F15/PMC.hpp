...
namespace Kvasir {
    ...
    namespace PMC_regsc{
        using Addr = Register::Address<0x4007d002,0xffffffe0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> BGBE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> BGBDS; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> BGEN; 
    }
}
