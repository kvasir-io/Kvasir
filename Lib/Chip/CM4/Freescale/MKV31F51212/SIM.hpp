...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xf3fcec1f>;
    ...
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0x0083eeec>;
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xffe7e33d>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0x703bc83c>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> DAC1; 
