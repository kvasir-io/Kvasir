...
//FlexTimer Module
    namespace Ftm3Sc{    ///<Status And Control
        using Addr = Register::Address<0x40026000,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Cnt{    ///<Counter
        using Addr = Register::Address<0x40026004,0xffff0000,0x00000000,unsigned>;
        ///Counter Value
    ...
    namespace Ftm3Mod{    ///<Modulo
        using Addr = Register::Address<0x40026008,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ftm3Cntin{    ///<Counter Initial Value
        using Addr = Register::Address<0x4002604c,0xffff0000,0x00000000,unsigned>;
        ///no description available
    ...
    namespace Ftm3Status{    ///<Capture And Compare Status
        using Addr = Register::Address<0x40026050,0xffffff00,0x00000000,unsigned>;
        ///Channel 0 Flag
        enum class Ch0fVal {
    ...
    namespace Ftm3Mode{    ///<Features Mode Selection
        using Addr = Register::Address<0x40026054,0xffffff00,0x00000000,unsigned>;
        ///FTM Enable
        enum class FtmenVal {
    ...
    namespace Ftm3Sync{    ///<Synchronization
        using Addr = Register::Address<0x40026058,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Outinit{    ///<Initial State For Channels Output
        using Addr = Register::Address<0x4002605c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Outmask{    ///<Output Mask
        using Addr = Register::Address<0x40026060,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Combine{    ///<Function For Linked Channels
        using Addr = Register::Address<0x40026064,0x80808080,0x00000000,unsigned>;
    ...
    namespace Ftm3Deadtime{    ///<Deadtime Insertion Control
        using Addr = Register::Address<0x40026068,0xffffff00,0x00000000,unsigned>;
        ///Deadtime Value
    ...
    namespace Ftm3Exttrig{    ///<FTM External Trigger
        using Addr = Register::Address<0x4002606c,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Pol{    ///<Channels Polarity
        using Addr = Register::Address<0x40026070,0xffffff00,0x00000000,unsigned>;
        ///Channel 0 Polarity
        enum class Pol0Val {
    ...
    namespace Ftm3Fms{    ///<Fault Mode Status
        using Addr = Register::Address<0x40026074,0xffffff10,0x00000000,unsigned>;
    ...
    namespace Ftm3Filter{    ///<Input Capture Filter Control
        using Addr = Register::Address<0x40026078,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ftm3Fltctrl{    ///<Fault Control
        using Addr = Register::Address<0x4002607c,0xfffff000,0x00000000,unsigned>;
    ...
    namespace Ftm3Qdctrl{    ///<Quadrature Decoder Control And Status
        using Addr = Register::Address<0x40026080,0xffffff00,0x00000000,unsigned>;
    ...
    namespace Ftm3Conf{    ///<Configuration
        using Addr = Register::Address<0x40026084,0xfffff920,0x00000000,unsigned>;
        ///TOF Frequency
    ...
    namespace Ftm3Fltpol{    ///<FTM Fault Input Polarity
        using Addr = Register::Address<0x40026088,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Ftm3Synconf{    ///<Synchronization Configuration
        using Addr = Register::Address<0x4002608c,0xffe0e04a,0x00000000,unsigned>;
    ...
    namespace Ftm3Invctrl{    ///<FTM Inverting Control
        using Addr = Register::Address<0x40026090,0xfffffff0,0x00000000,unsigned>;
    ...
    namespace Ftm3Swoctrl{    ///<FTM Software Output Control
        using Addr = Register::Address<0x40026094,0xffff0000,0x00000000,unsigned>;
    ...
    namespace Ftm3Pwmload{    ///<FTM PWM Load
        using Addr = Register::Address<0x40026098,0xfffffd00,0x00000000,unsigned>;
        ///Channel 0 Select
    ...
    namespace Ftm3C0sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002600c,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
    ...
    namespace Ftm3C1sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40026014,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C2sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002601c,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C3sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40026024,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C4sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002602c,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C5sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40026034,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C6sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x4002603c,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C7sc{    ///<Channel (n) Status And Control
        using Addr = Register::Address<0x40026044,0xffffff00,0x00000000,unsigned>;
        ///DMA Enable
        enum class DmaVal {
            v0=0x00000000,     ///<Disable DMA transfers.
            v1=0x00000001,     ///<Enable DMA transfers.
    ...
    namespace Ftm3C0v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40026010,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
    ...
    namespace Ftm3C3v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40026028,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm3C4v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40026030,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm3C5v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40026038,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
    namespace Ftm3C6v{    ///<Channel (n) Value
        using Addr = Register::Address<0x40026040,0xffff0000,0x00000000,unsigned>;
        ///Channel Value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> val{}; 
    }
