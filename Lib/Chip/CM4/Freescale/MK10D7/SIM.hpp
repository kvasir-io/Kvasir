...
namespace Kvasir {
    ...
    namespace SIM_sopt2{
        using Addr = Register::Address<0x40048004,0xfffee40f>;
    ...
    namespace SIM_sopt4{
        using Addr = Register::Address<0x4004800c,0xc8c3fee8>;
    ...
    namespace SIM_scgc1{
        using Addr = Register::Address<0x40048028,0xfffffbff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(10,10)> UART4; 
    }
    namespace SIM_scgc2{
        using Addr = Register::Address<0x4004802c,0xffffefff>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,12)> DAC0; 
    }
    namespace SIM_scgc3{
        using Addr = Register::Address<0x40048030,0xf6ffffff>;
    ...
    namespace SIM_scgc4{
        using Addr = Register::Address<0x40048034,0xffe7c339>;
    ...
    namespace SIM_scgc6{
        using Addr = Register::Address<0x4004803c,0xd43b4fec>;
    ...
    namespace SIM_clkdiv2{
        using Addr = Register::Address<0x40048048,0xffffffff>;
    }
    namespace SIM_fcfg1{
