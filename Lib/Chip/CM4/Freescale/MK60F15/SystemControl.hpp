...
//System Control Registers
    ...
    namespace ScbCpacr{    ///<Debug Fault Status Register
        ...
        namespace cp10ValC{
            constexpr MPL::Value<cp10Val,cp10Val::v00> v00{};
            constexpr MPL::Value<cp10Val,cp10Val::v01> v01{};
            constexpr MPL::Value<cp10Val,cp10Val::v10> v10{};
            constexpr MPL::Value<cp10Val,cp10Val::v11> v11{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,20),Register::ReadWriteAccess,cp10Val> cp10{}; 
        ...
        namespace cp11ValC{
            constexpr MPL::Value<cp11Val,cp11Val::v00> v00{};
            constexpr MPL::Value<cp11Val,cp11Val::v01> v01{};
            constexpr MPL::Value<cp11Val,cp11Val::v10> v10{};
            constexpr MPL::Value<cp11Val,cp11Val::v11> v11{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,22),Register::ReadWriteAccess,cp11Val> cp11{}; 
    }
}
