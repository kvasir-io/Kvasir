...
//Low-leakage wake-up module
    ...
    namespace LlwuCs{    ///<LLWU Control and Status Register
        ...
        namespace FltrValC{
            constexpr Register::FieldValue<decltype(fltr),FltrVal::v0> v0{};
            constexpr Register::FieldValue<decltype(fltr),FltrVal::v1> v1{};
        }
        ...
        namespace FltepValC{
            constexpr Register::FieldValue<decltype(fltep),FltepVal::v0> v0{};
            constexpr Register::FieldValue<decltype(fltep),FltepVal::v1> v1{};
        }
