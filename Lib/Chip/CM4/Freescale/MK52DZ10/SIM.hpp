...
//System Integration Module
    namespace SimSopt1{    ///<System Options Register 1
        using Addr = Register::Address<0x40047000,0x3f770fff,0,unsigned>;
        ///RAM size
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> ms{}; 
        namespace MsValC{
        }
        ...
        namespace UsbstbyValC{
            constexpr Register::FieldValue<decltype(usbstby),UsbstbyVal::v0> v0{};
            constexpr Register::FieldValue<decltype(usbstby),UsbstbyVal::v1> v1{};
        }
    ...
    namespace SimSopt2{    ///<System Options Register 2
        using Addr = Register::Address<0x40048004,0xcccae4fe,0,unsigned>;
        ///MCG clock select
        ...
        namespace McgclkselValC{
            constexpr Register::FieldValue<decltype(mcgclksel),McgclkselVal::v0> v0{};
            constexpr Register::FieldValue<decltype(mcgclksel),McgclkselVal::v1> v1{};
        }
        ...
        namespace I2ssrcValC{
            constexpr Register::FieldValue<decltype(i2ssrc),I2ssrcVal::v00> v00{};
            constexpr Register::FieldValue<decltype(i2ssrc),I2ssrcVal::v01> v01{};
            constexpr Register::FieldValue<decltype(i2ssrc),I2ssrcVal::v10> v10{};
            constexpr Register::FieldValue<decltype(i2ssrc),I2ssrcVal::v11> v11{};
        }
    ...
    namespace SimSopt5{    ///<System Options Register 5
        ...
        namespace UarttxsrcValC{
            constexpr Register::FieldValue<decltype(uarttxsrc),UarttxsrcVal::v00> v00{};
            constexpr Register::FieldValue<decltype(uarttxsrc),UarttxsrcVal::v01> v01{};
            constexpr Register::FieldValue<decltype(uarttxsrc),UarttxsrcVal::v10> v10{};
        }
    ...
    namespace SimSopt6{    ///<System Options Register 6
        ...
        namespace RstfltenValC{
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v000> v000{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v001> v001{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v010> v010{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v011> v011{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v100> v100{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v101> v101{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v110> v110{};
            constexpr Register::FieldValue<decltype(rstflten),RstfltenVal::v111> v111{};
        }
    }
    ...
    namespace SimScgc3{    ///<System Clock Gating Control Register 3
        using Addr = Register::Address<0x40048030,0xf6fdeffe,0,unsigned>;
        ...
        namespace RngbValC{
            constexpr Register::FieldValue<decltype(rngb),RngbVal::v0> v0{};
            constexpr Register::FieldValue<decltype(rngb),RngbVal::v1> v1{};
        }
    ...
    namespace SimClkdiv2{    ///<System Clock Divider Register 2
        using Addr = Register::Address<0x40048048,0x000f00f0,0,unsigned>;
    ...
    namespace SimFcfg2{    ///<Flash Configuration Register 2
        ...
        ///Max address block 1
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(21,16),Register::ReadWriteAccess,unsigned> maxaddr1{}; 
        ...
        ///Max address block 0
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(29,24),Register::ReadWriteAccess,unsigned> maxaddr0{}; 
