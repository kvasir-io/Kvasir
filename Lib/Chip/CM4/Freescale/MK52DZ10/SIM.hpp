...
//System Integration Module
    namespace SimSopt1{    ///<System Options Register 1
        ...
        namespace usbstbyValC{
            constexpr MPL::Value<usbstbyVal,usbstbyVal::v0> v0{};
            constexpr MPL::Value<usbstbyVal,usbstbyVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,usbstbyVal> usbstby{}; 
    ...
    namespace SimScgc1{    ///<System Clock Gating Control Register 1
        ...
        namespace opampValC{
            constexpr MPL::Value<opampVal,opampVal::v0> v0{};
            constexpr MPL::Value<opampVal,opampVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(21,21),Register::ReadWriteAccess,opampVal> opamp{}; 
        ...
        namespace triampValC{
            constexpr MPL::Value<triampVal,triampVal::v0> v0{};
            constexpr MPL::Value<triampVal,triampVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,triampVal> triamp{}; 
    }
    ...
    namespace SimScgc3{    ///<System Clock Gating Control Register 3
        ...
        namespace rngbValC{
            constexpr MPL::Value<rngbVal,rngbVal::v0> v0{};
            constexpr MPL::Value<rngbVal,rngbVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,rngbVal> rngb{}; 
