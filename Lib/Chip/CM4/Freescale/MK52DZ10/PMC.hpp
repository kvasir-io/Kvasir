...
namespace Kvasir {
    ...
    namespace PMC_regsc{
        using Addr = Register::Address<0x4007d002,0xffffffe2>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> VLPRS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> TRAMPO; 
    }
}
