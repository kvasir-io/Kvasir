...
namespace Kvasir {
    namespace SMC_pmprot{
        using Addr = Register::Address<0x4007e000,0xffffff5d>;
    ...
    namespace SMC_stopctrl{
        using Addr = Register::Address<0x4007e002,0xffffff00>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> RAM2PO; 
