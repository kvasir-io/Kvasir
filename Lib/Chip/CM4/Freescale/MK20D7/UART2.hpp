...
//Serial Communication Interface
    namespace Uart2Bdh{    ///<UART Baud Rate Registers:High
        using Addr = Register::Address<0x4006c000,0xffffff20,0,unsigned char>;
        ///UART Baud Rate Bits
    ...
    namespace Uart2Cfifo{    ///<UART FIFO Control Register
        using Addr = Register::Address<0x4006c011,0xffffff3c,0,unsigned char>;
    ...
    namespace Uart2Sfifo{    ///<UART FIFO Status Register
        using Addr = Register::Address<0x4006c012,0xffffff3c,0,unsigned char>;
