...
//Serial Peripheral Interface
    namespace Spi1Mcr{    ///<Module Configuration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16),Register::ReadWriteAccess,unsigned> pcsis{}; 
    ...
    namespace Spi1Pushr{    ///<PUSH TX FIFO Register In Master Mode
        using Addr = Register::Address<0x4002d034,0x03e00000,0,unsigned>;
        ///Transmit Data
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> txdata{}; 
        ///no description available
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,16),Register::ReadWriteAccess,unsigned> pcs{}; 
