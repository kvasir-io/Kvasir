...
//Reset Control Module
    ...
    namespace RcmSsrs0{    ///<Sticky System Reset Status Register 0
        ...
        namespace slocValC{
            constexpr MPL::Value<slocVal,slocVal::v0> v0{};
            constexpr MPL::Value<slocVal,slocVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,slocVal> sloc{}; 
        ...
        namespace slolValC{
            constexpr MPL::Value<slolVal,slolVal::v0> v0{};
            constexpr MPL::Value<slolVal,slolVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,slolVal> slol{}; 
        ///Sticky Watchdog
        enum class swdogVal {
            v0=0x00000000,     ///<Reset not caused by watchdog timeout
            v1=0x00000001,     ///<Reset caused by watchdog timeout
    ...
    namespace RcmSsrs1{    ///<Sticky System Reset Status Register 1
        ...
        namespace sjtagValC{
            constexpr MPL::Value<sjtagVal,sjtagVal::v0> v0{};
            constexpr MPL::Value<sjtagVal,sjtagVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,sjtagVal> sjtag{}; 
        ///Sticky Core Lockup
        ...
        namespace sezptValC{
            constexpr MPL::Value<sezptVal,sezptVal::v0> v0{};
            constexpr MPL::Value<sezptVal,sezptVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4),Register::ReadWriteAccess,sezptVal> sezpt{}; 
