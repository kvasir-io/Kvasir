...
//Universal Asynchronous Receiver/Transmitter
    namespace Lpuart0Baud{    ///<LPUART Baud Rate Register
        using Addr = Register::Address<0x4002a000,0x00500000,0x00000000,unsigned>;
    ...
    namespace Lpuart0Stat{    ///<LPUART Status Register
        using Addr = Register::Address<0x4002a004,0x00003fff,0x00000000,unsigned>;
        ///Match 2 Flag
        enum class Ma2fVal {
    ...
    namespace Lpuart0Ctrl{    ///<LPUART Control Register
        using Addr = Register::Address<0x4002a008,0x00003800,0x00000000,unsigned>;
        ///Parity Type
        enum class PtVal {
    ...
    namespace Lpuart0Data{    ///<LPUART Data Register
        using Addr = Register::Address<0x4002a00c,0xffff0400,0x00000000,unsigned>;
    ...
    namespace Lpuart0Match{    ///<LPUART Match Address Register
        using Addr = Register::Address<0x4002a010,0xfc00fc00,0x00000000,unsigned>;
        ///Match Address 1
    ...
    namespace Lpuart0Modir{    ///<LPUART Modem IrDA Register
        using Addr = Register::Address<0x4002a014,0xfff8ffc0,0x00000000,unsigned>;
