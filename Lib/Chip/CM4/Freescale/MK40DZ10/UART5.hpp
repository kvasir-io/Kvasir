...
namespace Kvasir {
    namespace UART5_bdh{
        using Addr = Register::Address<0x400eb000,0xffffff20>;
    ...
    namespace UART5_c5{
        using Addr = Register::Address<0x400eb00b,0xffffff5f>;
    ...
    namespace UART5_cfifo{
        using Addr = Register::Address<0x400eb011,0xffffff3c>;
    ...
    namespace UART5_sfifo{
        using Addr = Register::Address<0x400eb012,0xffffff3c>;
