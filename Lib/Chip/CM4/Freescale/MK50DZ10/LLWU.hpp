...
//Low-leakage wake-up module
    ...
    namespace LlwuCs{    ///<LLWU Control and Status Register
        using Addr = Register::Address<0x4007c008,0xffffff7c,0,unsigned char>;
        ...
        namespace fltrValC{
            constexpr MPL::Value<fltrVal,fltrVal::v0> v0{};
            constexpr MPL::Value<fltrVal,fltrVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,fltrVal> fltr{}; 
        ...
        namespace fltepValC{
            constexpr MPL::Value<fltepVal,fltepVal::v0> v0{};
            constexpr MPL::Value<fltepVal,fltepVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,fltepVal> fltep{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,ackisoVal> ackiso{}; 
    }
}
