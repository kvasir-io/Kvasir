...
//Flash configuration field
    ...
    namespace NvFopt{    ///<Non-volatile Flash Option Register
        ...
        namespace ezportDisValC{
            constexpr MPL::Value<ezportDisVal,ezportDisVal::v00> v00{};
            constexpr MPL::Value<ezportDisVal,ezportDisVal::v01> v01{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,ezportDisVal> ezportDis{}; 
    }
}
