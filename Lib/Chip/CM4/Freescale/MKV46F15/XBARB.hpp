...
//Crossbar Switch
    namespace XbarbSel0{    ///<Crossbar B Select Register 0
        using Addr = Register::Address<0x4005a000,0xffffe0e0,0x00000000,unsigned>;
    ...
    namespace XbarbSel1{    ///<Crossbar B Select Register 1
        using Addr = Register::Address<0x4005a002,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel2{    ///<Crossbar B Select Register 2
        using Addr = Register::Address<0x4005a004,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel3{    ///<Crossbar B Select Register 3
        using Addr = Register::Address<0x4005a006,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel4{    ///<Crossbar B Select Register 4
        using Addr = Register::Address<0x4005a008,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel5{    ///<Crossbar B Select Register 5
        using Addr = Register::Address<0x4005a00a,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel6{    ///<Crossbar B Select Register 6
        using Addr = Register::Address<0x4005a00c,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
    ...
    namespace XbarbSel7{    ///<Crossbar B Select Register 7
        using Addr = Register::Address<0x4005a00e,0xffffe0e0,0x00000000,unsigned>;
        ///no description available
