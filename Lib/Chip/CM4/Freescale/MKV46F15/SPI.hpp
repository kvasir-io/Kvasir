...
//Serial Peripheral Interface
    ...
    namespace SpiSrex{    ///<Status Register Extended
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,0),Register::ReadWriteAccess,unsigned> cmdnxtptr{}; 
        ///CMD FIFO Counter
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,4),Register::ReadWriteAccess,unsigned> cmdctr{}; 
        ///TX FIFO Counter[4]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> txctr4{}; 
        ///RX FIFO Counter[4]
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> rxctr4{}; 
    }
}
