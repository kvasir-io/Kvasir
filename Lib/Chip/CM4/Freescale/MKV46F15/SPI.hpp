...
//Serial Peripheral Interface
    namespace SpiMcr{    ///<Module Configuration Register
    ...
    namespace SpiTcr{    ///<Transfer Count Register
    ...
    namespace SpiCtarSlave{    ///<Clock and Transfer Attributes Register (In Slave Mode)
    ...
    namespace SpiRser{    ///<DMA/Interrupt Request Select and Enable Register
    ...
    namespace SpiPushr{    ///<PUSH TX FIFO Register In Master Mode
    ...
    namespace SpiPushrSlave{    ///<PUSH TX FIFO Register In Slave Mode
        using Addr = Register::Address<0x4002c034,0xffff0000,0x00000000,unsigned>;
        ///Transmit Data
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> txdata{}; 
    }
    namespace SpiPopr{    ///<POP RX FIFO Register
    ...
    namespace SpiSrex{    ///<Status Register Extended
        using Addr = Register::Address<0x4002c13c,0xffffb600,0x00000000,unsigned>;
        ///Command Next Pointer
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,0),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cmdnxtptr{}; 
        ///CMD FIFO Counter
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,4),Register::Access<Register::AccessType::readOnly,Register::ReadActionType::normal,Register::ModifiedWriteValueType::normal>,unsigned> cmdctr{}; 
        ///TX FIFO Counter[4]
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,11),Register::ReadWriteAccess,unsigned> txctr4{}; 
        ///RX FIFO Counter[4]
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(14,14),Register::ReadWriteAccess,unsigned> rxctr4{}; 
    }
    namespace SpiCtar0{    ///<Clock and Transfer Attributes Register (In Master Mode)
    ...
    namespace SpiCtar1{    ///<Clock and Transfer Attributes Register (In Master Mode)
    ...
    namespace SpiTxfr0{    ///<Transmit FIFO Registers
    ...
    namespace SpiTxfr1{    ///<Transmit FIFO Registers
    ...
    namespace SpiTxfr2{    ///<Transmit FIFO Registers
    ...
    namespace SpiTxfr3{    ///<Transmit FIFO Registers
