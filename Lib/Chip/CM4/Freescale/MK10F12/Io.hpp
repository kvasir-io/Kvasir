...
namespace Kvasir{
    namespace Io{
        ...
        template<int Pin>
        struct MakeAction<Action::Clear,PinLocation<5,Pin>> :
        ...
        template<int Pin>
        struct MakeAction<Action::Input,PinLocation<5,Pin>> :
        ...
        template<int Pin>
        struct MakeAction<Action::Output,PinLocation<5,Pin>> :
        ...
        template<int Pin>
        struct MakeAction<Action::Read,PinLocation<5,Pin>> :
        ...
        template<int Pin>
        struct MakeAction<Action::Set,PinLocation<5,Pin>> :
        ...
        template<int Pin>
        struct MakeAction<Action::Toggle,PinLocation<5,Pin>> :
