...
namespace Kvasir{
    namespace Io{
        ...
        struct MakeAction<Action::Output,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff154,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        struct MakeAction<Action::Input,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff154,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(0<<Pin)>>{};
        ...
        struct MakeAction<Action::Toggle,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff14c,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        struct MakeAction<Action::Clear,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff148,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        struct MakeAction<Action::Read,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff150,0x00000000>,(1<<Pin)>,Register::ReadAction>{};
        ...
        struct MakeAction<Action::Set,PinLocation<5,Pin>> :
            Register::Action<Register::BitLocation<Register::Address<0x400ff144,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
