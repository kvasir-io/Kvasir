...
namespace Kvasir{
    namespace Io{
        ...
        template<int Pin>
        struct MakeAction<Action::Clear,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff148,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        template<int Pin>
        struct MakeAction<Action::Input,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff154,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(0<<Pin)>>{};
        ...
        template<int Pin>
        struct MakeAction<Action::Output,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff154,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        template<int Pin>
        struct MakeAction<Action::Read,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff150,0x00000000>,(1<<Pin)>,Register::ReadAction>{};
        ...
        template<int Pin>
        struct MakeAction<Action::Set,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff144,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
        ...
        template<int Pin>
        struct MakeAction<Action::Toggle,Register::PinLocation<5,Pin>> :
            Register::Action<Register::FieldLocation<Register::Address<0x400ff14c,0x00000000>,(1<<Pin)>,Register::WriteLiteralAction<(1<<Pin)>>{};
