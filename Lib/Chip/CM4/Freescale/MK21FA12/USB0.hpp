...
//Universal Serial Bus, OTG Capable Controller
    ...
    namespace Usb0Istat{    ///<Interrupt Status register
        ...
        namespace attachValC{
            constexpr MPL::Value<attachVal,attachVal::v0> v0{};
            constexpr MPL::Value<attachVal,attachVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,attachVal> attach{}; 
        ///Stall Interrupt
    ...
    namespace Usb0Endpt0{    ///<Endpoint Control register
        ...
        namespace hostwohubValC{
            constexpr MPL::Value<hostwohubVal,hostwohubVal::v0> v0{};
            constexpr MPL::Value<hostwohubVal,hostwohubVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,hostwohubVal> hostwohub{}; 
    }
