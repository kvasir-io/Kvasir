...
//Flash Memory Interface
    ...
    namespace FtfeFcnfg{    ///<Flash Configuration Register
        ...
        enum class EeerdyVal {
            v0=0x00000000,     ///<For devices with FlexNVM: FlexRAM is not available for EEPROM operation For devices without FlexNVM: See RAMRDY for availability of programming acceleration RAM
        ...
        namespace EeerdyValC{
            constexpr Register::FieldValue<decltype(eeerdy),EeerdyVal::v0> v0{};
            constexpr Register::FieldValue<decltype(eeerdy),EeerdyVal::v1> v1{};
        }
        ///RAM Ready
        ...
        namespace RamrdyValC{
            constexpr Register::FieldValue<decltype(ramrdy),RamrdyVal::v0> v0{};
            constexpr Register::FieldValue<decltype(ramrdy),RamrdyVal::v1> v1{};
        }
        ///FTFE configuration
        enum class PflshVal {
            v0=0x00000000,     ///<For devices with FlexNVM: FTFE configuration supports two program flash blocks and two FlexNVM blocks For devices with program flash only: Reserved
        ...
        ///Swap
        enum class SwapVal {
            v0=0x00000000,     ///<For devices with FlexNVM: Program flash 0 block is located at relative address 0x0000 For devices with program flash only: Program flash 0 block is located at relative address 0x0000
            v1=0x00000001,     ///<For devices with FlexNVM: Reserved For devices with program flash only: Program flash 1 block is located at relative address 0x0000
        };
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(3,3),Register::ReadWriteAccess,SwapVal> swap{}; 
        namespace SwapValC{
            constexpr Register::FieldValue<decltype(swap),SwapVal::v0> v0{};
            constexpr Register::FieldValue<decltype(swap),SwapVal::v1> v1{};
        }
        ///Erase Suspend
