...
//FlexTimer Module
    ...
    namespace Ftm3C0sc{    ///<Channel (n) Status And Control
        ...
        namespace icrstValC{
            constexpr MPL::Value<icrstVal,icrstVal::v0> v0{};
            constexpr MPL::Value<icrstVal,icrstVal::v1> v1{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,icrstVal> icrst{}; 
