...
//State Configurable Timer/PWM 0 
    namespace Noneconfig{    ///<SCT configuration register
        ...
        namespace unifyValC{
            constexpr MPL::Value<unifyVal,unifyVal::dualCounter> dualCounter{};
            constexpr MPL::Value<unifyVal,unifyVal::unifiedCounter> unifiedCounter{};
        }
        ...
        namespace clkmodeValC{
            constexpr MPL::Value<clkmodeVal,clkmodeVal::systemClock> systemClock{};
            constexpr MPL::Value<clkmodeVal,clkmodeVal::prescaledSystemClo> prescaledSystemClo{};
            constexpr MPL::Value<clkmodeVal,clkmodeVal::sctInput> sctInput{};
            constexpr MPL::Value<clkmodeVal,clkmodeVal::prescaledSctInput> prescaledSctInput{};
        }
        ...
        namespace ckselValC{
            constexpr MPL::Value<ckselVal,ckselVal::input0RisingEdges> input0RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input0FallingEdge> input0FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input1RisingEdges> input1RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input1FallingEdge> input1FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input2RisingEdges> input2RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input2FallingEdge> input2FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input3RisingEdges> input3RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input3FallingEdge> input3FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input4RisingEdges> input4RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input4FallingEdge> input4FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input5RisingEdges> input5RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input5FallingEdge> input5FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input6RisingEdges> input6RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input6FallingEdge> input6FallingEdge{};
            constexpr MPL::Value<ckselVal,ckselVal::input7RisingEdges> input7RisingEdges{};
            constexpr MPL::Value<ckselVal,ckselVal::input7FallingEdge> input7FallingEdge{};
        }
        ...
        ///A 1 in this bit prevents the lower match registers from
								...
								set.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> noreloadL{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,9),Register::ReadWriteAccess,unsigned> insync{}; 
    ...
    namespace Nonectrl{    ///<SCT control register
        ...
        namespace bidirLValC{
            constexpr MPL::Value<bidirLVal,bidirLVal::unidirectional> unidirectional{};
            constexpr MPL::Value<bidirLVal,bidirLVal::bidirectional> bidirectional{};
        }
        ...
        namespace bidirHValC{
            constexpr MPL::Value<bidirHVal,bidirHVal::unidirectional> unidirectional{};
            constexpr MPL::Value<bidirHVal,bidirHVal::bidirectional> bidirectional{};
        }
    ...
    namespace Noneoutput{    ///<SCT output register
        ...
        ///Writing a 1 to bit n makes the corresponding output HIGH. 0
								...
								1, etc.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> out{}; 
    }
    namespace Noneoutputdirctrl{    ///<SCT output counter direction control register
        ...
        namespace setclr0ValC{
            ...
            constexpr MPL::Value<setclr0Val,setclr0Val::lReversed> lReversed{};
            constexpr MPL::Value<setclr0Val,setclr0Val::hReversed> hReversed{};
        }
        ...
        ///Set/clear operation on output 1. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,2),Register::ReadWriteAccess,unsigned> setclr1{}; 
        ///Set/clear operation on output 2. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,4),Register::ReadWriteAccess,unsigned> setclr2{}; 
        ///Set/clear operation on output 3. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,6),Register::ReadWriteAccess,unsigned> setclr3{}; 
        ///Set/clear operation on output 4. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,8),Register::ReadWriteAccess,unsigned> setclr4{}; 
        ///Set/clear operation on output 5. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(11,10),Register::ReadWriteAccess,unsigned> setclr5{}; 
        ///Set/clear operation on output 6. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,12),Register::ReadWriteAccess,unsigned> setclr6{}; 
        ///Set/clear operation on output 7. See description of bit
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,14),Register::ReadWriteAccess,unsigned> setclr7{}; 
    }
    namespace Noneres{    ///<SCT conflict resolution register
        ...
        namespace o0resValC{
            ...
            constexpr MPL::Value<o0resVal,o0resVal::set> set{};
            constexpr MPL::Value<o0resVal,o0resVal::clear> clear{};
        ...
        namespace o1resValC{
            ...
            constexpr MPL::Value<o1resVal,o1resVal::set> set{};
            constexpr MPL::Value<o1resVal,o1resVal::clear> clear{};
        ...
        namespace o2resValC{
            ...
            constexpr MPL::Value<o2resVal,o2resVal::set> set{};
            constexpr MPL::Value<o2resVal,o2resVal::clear> clear{};
        ...
        namespace o3resValC{
            ...
            constexpr MPL::Value<o3resVal,o3resVal::set> set{};
            constexpr MPL::Value<o3resVal,o3resVal::clear> clear{};
        ...
        namespace o4resValC{
            ...
            constexpr MPL::Value<o4resVal,o4resVal::set> set{};
            constexpr MPL::Value<o4resVal,o4resVal::clear> clear{};
        ...
        namespace o5resValC{
            ...
            constexpr MPL::Value<o5resVal,o5resVal::set> set{};
            constexpr MPL::Value<o5resVal,o5resVal::clear> clear{};
        ...
        namespace o6resValC{
            ...
            constexpr MPL::Value<o6resVal,o6resVal::set> set{};
            constexpr MPL::Value<o6resVal,o6resVal::clear> clear{};
        ...
        namespace o7resValC{
            ...
            constexpr MPL::Value<o7resVal,o7resVal::set> set{};
            constexpr MPL::Value<o7resVal,o7resVal::clear> clear{};
    ...
    namespace Noneconen{    ///<SCT conflict enable register
        ...
        ///The SCT requests an interrupt when bit n of this register
								...
								output 1 = bit 1, etc.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ncen{}; 
    }
    namespace Noneconflag{    ///<SCT conflict flag register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0),Register::ReadWriteAccess,unsigned> ncflag{}; 
    ...
    namespace Nonecapctrl0{    ///<SCT capture control register 0 to 12; REGMOD0 = 1 to REGMODE12 =
        ...
        ///If bit m is one, event m causes the CAPn_L (UNIFY = 0) or
								...
								SCT.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> capconnL{}; 
    ...
    namespace Noneev0State{    ///<SCT event state register 0
        ...
        ///If bit m is one, event n happens in state m of the counter
								...
								SCT.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(12,0),Register::ReadWriteAccess,unsigned> statemskn{}; 
    }
    ...
    namespace Noneev0Ctrl{    ///<SCT event control register 0
        ...
        namespace heventValC{
            constexpr MPL::Value<heventVal,heventVal::lCounter> lCounter{};
            constexpr MPL::Value<heventVal,heventVal::hCounter> hCounter{};
        }
        ...
        namespace outselValC{
            constexpr MPL::Value<outselVal,outselVal::input> input{};
            constexpr MPL::Value<outselVal,outselVal::output> output{};
        }
        ...
        namespace stateldValC{
            constexpr MPL::Value<stateldVal,stateldVal::add> add{};
            constexpr MPL::Value<stateldVal,stateldVal::load> load{};
        }
    ...
    namespace Noneout0Set{    ///<SCT output 0 set register
        ...
        ///A 1 in bit m selects event m to set output n (or clear it
								...
								number of bits = number of events in this SCT.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> set{}; 
    }
