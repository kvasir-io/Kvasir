...
namespace Kvasir {
    namespace Nonecfg{
        using Addr = Register::Address<0x40094000,0xffffffc0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(5,5)> HSCAPABLE; 
    }
    namespace Nonestat{
        using Addr = Register::Address<0x40094004,0xfcf000a0>;
    ...
    namespace Noneintenset{
        using Addr = Register::Address<0x40094008,0xfcf476ae>;
    ...
    namespace Noneintenclr{
        using Addr = Register::Address<0x4009400c,0xfcf476ae>;
    ...
    namespace Nonetimeout{
        using Addr = Register::Address<0x40094010,0xffff0000>;
    ...
    namespace Noneclkdiv{
        using Addr = Register::Address<0x40094014,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DIVVAL; 
    }
    namespace Noneintstat{
        using Addr = Register::Address<0x40094018,0xfcf476ae>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> MSTPENDING; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(4,4)> MSTARBLOSS; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6)> MSTSTSTPERR; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8)> SLVPENDING; 
    ...
    namespace Nonemstctl{
        using Addr = Register::Address<0x40094020,0xfffffff0>;
    ...
    namespace Nonemsttime{
        using Addr = Register::Address<0x40094024,0xffffff88>;
    ...
    namespace Noneslvctl{
        using Addr = Register::Address<0x40094040,0xfffffff4>;
    ...
    namespace Noneslvadr0{
        using Addr = Register::Address<0x40094048,0xffffff00>;
    ...
    namespace Noneslvadr2{
        using Addr = Register::Address<0x40094050,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> SADISABLE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> SLVADR; 
    }
    namespace Noneslvadr3{
        using Addr = Register::Address<0x40094054,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> SADISABLE; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,1)> SLVADR; 
    }
    namespace Noneslvqual0{
        using Addr = Register::Address<0x40094058,0xffffff00>;
    ...
    namespace Nonemonrxdat{
        using Addr = Register::Address<0x40094080,0xfffff800>;
