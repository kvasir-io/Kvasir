...
//Micro-tick timer
    namespace Nonectrl{    ///<Control register.
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(30,0),Register::ReadWriteAccess,unsigned> delayval{}; 
        ///Repeat delay. 0 = One-time delay. 1 = Delay repeats
								continuously.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,31),Register::ReadWriteAccess,unsigned> repeat{}; 
    }
    namespace Nonestat{    ///<Status register.
        ...
        ///Interrupt flag. 0 = No interrupt is pending. 1 = An
								...
								this flag.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> intr{}; 
        ///Active flag. 0 = The Micro-Tick Timer is stopped. 1 = The
								Micro-Tick Timer is currently active.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> active{}; 
    }
}
