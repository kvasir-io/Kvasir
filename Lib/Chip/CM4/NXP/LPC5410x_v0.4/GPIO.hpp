...
//General Purpose I/O 
    ...
    namespace Nonedir0{    ///<Direction registers port 0/1
        ...
        ///Selects pin direction for pin PIOm_n. Supported pins
								...
								output.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> dirp{}; 
    }
    ...
    namespace Nonemask0{    ///<Mask register port 0/1
        ...
        ///Controls which bits corresponding to PIOm_n are active in
								...
								affected.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> maskp{}; 
    }
    ...
    namespace Nonepin0{    ///<Port pin register port 0/1
        ...
        ///Reads pin states or loads output bits. Supported pins
								...
								bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> port{}; 
    }
    ...
    namespace Nonempin0{    ///<Masked port register port 0/1
        ...
        ///Masked port register. Supported pins depends on the
								...
								0.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> mportp{}; 
    }
    ...
    namespace Noneset0{    ///<Write: Set register for port 0/1 Read: output bits for port
        ...
        ///Read or set output bits. Supported pins depends on the
								...
								bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> setp{}; 
    }
    ...
    namespace Noneclr0{    ///<Clear port 0/1
        ...
        ///Clear output bits. Supported pins depends on the specific
								...
								bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> clrp{}; 
    }
    ...
    namespace Nonenot0{    ///<Toggle port 0/1
        ...
        ///Toggle output bits. Supported pins depends on the specific
								...
								bit.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0),Register::ReadWriteAccess,unsigned> notp{}; 
    }
