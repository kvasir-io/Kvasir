...
namespace Kvasir {
//USART0 
    namespace Nonecfg{    ///<USART Configuration register. Basic USART configuration settings
						that typically are not changed during operation.
        using Addr = Register::Address<0x40084000,0xff022402,0,unsigned>;
        ///USART Enable.
        enum class enableVal {
            disabled=0x00000000,     ///<Disabled. The USART is disabled and the internal
										...
										available.
            enabled=0x00000001,     ///<Enabled. The USART is enabled for
										operation.
        };
        ...
        enum class datalenVal {
            ...
            v9BitDataLength=0x00000002,     ///<9 bit data length. The 9th bit is commonly used for
        ...
        enum class parityselVal {
            ...
            evenParity=0x00000002,     ///<Even parity. Adds a bit to each character such that
										the number of 1s in a transmitted character is even, and the
										number of 1s in a received character is expected to be
										even.
            oddParity=0x00000003,     ///<Odd parity. Adds a bit to each character such that
        ...
        enum class stoplenVal {
            ...
            v2StopBits=0x00000001,     ///<2 stop bits. This setting should only be used for
        ...
        enum class mode32kVal {
            disabled=0x00000000,     ///<Disabled. USART uses standard
										clocking.
            enabled=0x00000001,     ///<Enabled. USART uses the 32 kHz clock from the RTC
										oscillator as the clock source to the BRG, and uses a
										special bit clocking scheme.
        };
        namespace mode32kValC{
            constexpr MPL::Value<mode32kVal,mode32kVal::disabled> disabled{};
            constexpr MPL::Value<mode32kVal,mode32kVal::enabled> enabled{};
        }
        ...
        enum class linmodeVal {
            disabled=0x00000000,     ///<Disabled. Break detect and generate is configured
										for normal operation.
            enabled=0x00000001,     ///<Enabled. Break detect and generate is configured
										for LIN bus operation.
        };
        namespace linmodeValC{
            constexpr MPL::Value<linmodeVal,linmodeVal::disabled> disabled{};
            constexpr MPL::Value<linmodeVal,linmodeVal::enabled> enabled{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,8),Register::ReadWriteAccess,linmodeVal> linmode{}; 
        ...
        enum class ctsenVal {
            noFlowControl=0x00000000,     ///<No flow control. The transmitter does not receive
										any automatic flow control signal.
            flowControlEnabled=0x00000001,     ///<Flow control enabled. The transmitter uses the CTS
        ...
        namespace syncenValC{
            constexpr MPL::Value<syncenVal,syncenVal::asynchronousMode> asynchronousMode{};
            constexpr MPL::Value<syncenVal,syncenVal::synchronousMode> synchronousMode{};
        }
        ...
        enum class clkpolVal {
            fallingEdge=0x00000000,     ///<Falling edge. Un_RXD is sampled on the falling edge
										of SCLK.
            risingEdge=0x00000001,     ///<Rising edge. Un_RXD is sampled on the rising edge
										of SCLK.
        };
        ...
        enum class syncmstVal {
            slave=0x00000000,     ///<Slave. When synchronous mode is enabled, the USART
										is a slave.
            master=0x00000001,     ///<Master. When synchronous mode is enabled, the USART
										is a master.
        };
        ...
        enum class loopVal {
            ...
            loopbackMode=0x00000001,     ///<Loopback mode. This provides a mechanism to perform
        ...
        enum class iomodeVal {
            standard=0x00000000,     ///<Standard. USART output and input operate in
										standard fashion.
            irda=0x00000001,     ///<IrDA. USART output and input operate in IrDA
										mode.
        };
        namespace iomodeValC{
            constexpr MPL::Value<iomodeVal,iomodeVal::standard> standard{};
            constexpr MPL::Value<iomodeVal,iomodeVal::irda> irda{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,iomodeVal> iomode{}; 
        ///Output Enable Turnaround time enable for RS-485
								operation.
        enum class oetaVal {
            disabled=0x00000000,     ///<Disabled. If selected by OESEL, the Output Enable
										signal deasserted at the end of the last stop bit of a
										transmission.
            enabled=0x00000001,     ///<Enabled. If selected by OESEL, the Output Enable
        ...
        namespace oetaValC{
            constexpr MPL::Value<oetaVal,oetaVal::disabled> disabled{};
            constexpr MPL::Value<oetaVal,oetaVal::enabled> enabled{};
        }
        ...
        enum class autoaddrVal {
            disabled=0x00000000,     ///<Disabled. When addressing is enabled by ADDRDET,
										address matching is done by software. This provides the
										possibility of versatile addressing (e.g. respond to more
										than one address).
            enabled=0x00000001,     ///<Enabled. When addressing is enabled by ADDRDET,
        ...
        enum class oeselVal {
            standard=0x00000000,     ///<Standard. The RTS signal is used as the standard
										flow control function.
            rs485=0x00000001,     ///<RS-485. The RTS signal configured to provide an
										output enable signal to control an RS-485
										transceiver.
        };
        namespace oeselValC{
            constexpr MPL::Value<oeselVal,oeselVal::standard> standard{};
            constexpr MPL::Value<oeselVal,oeselVal::rs485> rs485{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,oeselVal> oesel{}; 
        ///Output Enable Polarity.
        enum class oepolVal {
            low=0x00000000,     ///<Low. If selected by OESEL, the output enable is
										active low.
            high=0x00000001,     ///<High. If selected by OESEL, the output enable is
										active high.
        };
        namespace oepolValC{
    ...
    namespace Nonectl{    ///<USART Control register. USART control settings that are more likely
						to change during operation.
        using Addr = Register::Address<0x40084004,0xfffefcb9,0,unsigned>;
        ///Break Enable.
        enum class txbrkenVal {
            normalOperation=0x00000000,     ///<Normal operation.
            continuousBreak=0x00000001,     ///<Continuous break. Continuous break is sent
        ...
        namespace txbrkenValC{
            ...
            constexpr MPL::Value<txbrkenVal,txbrkenVal::continuousBreak> continuousBreak{};
        }
        ...
        enum class addrdetVal {
            disabled=0x00000000,     ///<Disabled. The USART presents all incoming
										data.
            enabled=0x00000001,     ///<Enabled. The USART receiver ignores incoming data
        ...
        ///Transmit Disable.
        enum class txdisVal {
            notDisabled=0x00000000,     ///<Not disabled. USART transmitter is not
										disabled.
            disabled=0x00000001,     ///<Disabled. USART transmitter is disabled after any
        ...
        ///Continuous Clock generation. By default, SCLK is only
								...
								mode.
        enum class ccVal {
            clockOnCharacter=0x00000000,     ///<Clock on character. In synchronous mode, SCLK
										cycles only when characters are being sent on Un_TXD or to
										complete a character that is being received.
            continuousClock=0x00000001,     ///<Continuous clock. SCLK runs continuously in
        ...
        enum class clrcconrxVal {
            ...
            autoClear=0x00000001,     ///<Auto-clear. The CC bit is automatically cleared
        ...
        enum class autobaudVal {
            disabled=0x00000000,     ///<Disabled. USART is in normal operating
										mode.
            enabled=0x00000001,     ///<Enabled. USART is in autobaud mode. This bit should
    ...
    namespace Nonestat{    ///<USART Status register. The complete status value can be read here.
						Writing ones clears some bits in the register. Some bits can be cleared by
						writing a 1 to them.
        using Addr = Register::Address<0x40084008,0xfffe0280,0,unsigned>;
    ...
    namespace Noneintenset{    ///<Interrupt Enable read and Set register. Contains an individual
        ...
        using Addr = Register::Address<0x4008400c,0xfffe0692,0,unsigned>;
    ...
    namespace Noneintenclr{    ///<Interrupt Enable Clear register. Allows clearing any combination of
						bits in the INTENSET register. Writing a 1 to any implemented bit position
						causes the corresponding bit to be cleared.
        using Addr = Register::Address<0x40084010,0xfffe0692,0,unsigned>;
        ...
        ///Writing 1 clears the corresponding bit in the INTENSET
								register.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,6),Register::ReadWriteAccess,unsigned> txdisclr{}; 
        ///Writing 1 clears the corresponding bit in the INTENSET
								register.
    ...
    namespace Nonerxdat{    ///<Receiver Data register. Contains the last character
						received.
        using Addr = Register::Address<0x40084014,0xfffffe00,0,unsigned>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> data{}; 
    }
    namespace Nonerxdatstat{    ///<Receiver Data with Status register. Combines the last character
						received with the current USART receive status. Allows DMA or software to
						recover incoming data and status together.
        using Addr = Register::Address<0x40084018,0xffff1e00,0,unsigned>;
        ///The USART Receiver Data register contains the next received
								character. The number of bits that are relevant depends on the USART
								configuration settings.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rxdata{}; 
    ...
    namespace Nonetxdat{    ///<Transmit Data register. Data to be transmitted is written
						here.
        using Addr = Register::Address<0x4008401c,0xfffffe00,0,unsigned>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> txdata{}; 
    }
    namespace Nonebrg{    ///<Baud Rate Generator register. 16-bit integer baud rate divisor
						value.
        using Addr = Register::Address<0x40084020,0xffff0000,0,unsigned>;
    ...
    namespace Noneintstat{    ///<Interrupt status register. Reflects interrupts that are currently
						enabled.
        using Addr = Register::Address<0x40084024,0xfffe0692,0,unsigned>;
        ///Receiver Ready flag.
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> aberrint{}; 
    }
    namespace Noneosr{    ///<Oversample selection register for asynchronous
						communication.
        using Addr = Register::Address<0x40084028,0xfffffff0,0,unsigned>;
    ...
    namespace Noneaddr{    ///<Address register for automatic address matching.
        using Addr = Register::Address<0x4008402c,0xffffff00,0,unsigned>;
