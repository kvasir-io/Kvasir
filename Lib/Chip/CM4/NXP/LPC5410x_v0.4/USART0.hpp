...
//USART0 
    namespace Nonecfg{    ///<USART Configuration register. Basic USART configuration settings
        ...
        namespace Mode32kValC{
            constexpr Register::FieldValue<decltype(mode32k),Mode32kVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(mode32k),Mode32kVal::enabled> enabled{};
        }
        ...
        namespace LinmodeValC{
            constexpr Register::FieldValue<decltype(linmode),LinmodeVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(linmode),LinmodeVal::enabled> enabled{};
        }
        ...
        namespace SyncenValC{
            constexpr Register::FieldValue<decltype(syncen),SyncenVal::asynchronousMode> asynchronousMode{};
            constexpr Register::FieldValue<decltype(syncen),SyncenVal::synchronousMode> synchronousMode{};
        }
        ...
        namespace IomodeValC{
            constexpr Register::FieldValue<decltype(iomode),IomodeVal::standard> standard{};
            constexpr Register::FieldValue<decltype(iomode),IomodeVal::irda> irda{};
        }
        ...
        namespace OetaValC{
            constexpr Register::FieldValue<decltype(oeta),OetaVal::disabled> disabled{};
            constexpr Register::FieldValue<decltype(oeta),OetaVal::enabled> enabled{};
        }
        ...
        namespace OeselValC{
            constexpr Register::FieldValue<decltype(oesel),OeselVal::standard> standard{};
            constexpr Register::FieldValue<decltype(oesel),OeselVal::rs485> rs485{};
        }
        ...
        namespace RxpolValC{
            constexpr Register::FieldValue<decltype(rxpol),RxpolVal::standard> standard{};
        ...
        namespace TxpolValC{
            constexpr Register::FieldValue<decltype(txpol),TxpolVal::standard> standard{};
    ...
    namespace Nonectl{    ///<USART Control register. USART control settings that are more likely
        ...
        namespace TxbrkenValC{
            ...
            constexpr Register::FieldValue<decltype(txbrken),TxbrkenVal::continuousBreak> continuousBreak{};
        }
