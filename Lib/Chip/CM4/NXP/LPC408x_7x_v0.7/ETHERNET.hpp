...
//Ethernet
    namespace Nonemac1{    ///<MAC configuration register 1.
        using Addr = Register::Address<0x20084000,0xffff30e0,0,unsigned>;
    ...
    namespace Nonemac2{    ///<MAC configuration register 2.
        using Addr = Register::Address<0x20084004,0xffff8c00,0,unsigned>;
    ...
    namespace Noneipgt{    ///<Back-to-Back Inter-Packet-Gap register.
        using Addr = Register::Address<0x20084008,0xffffff80,0,unsigned>;
    ...
    namespace Noneipgr{    ///<Non Back-to-Back Inter-Packet-Gap register.
        using Addr = Register::Address<0x2008400c,0xffff8080,0,unsigned>;
    ...
    namespace Noneclrt{    ///<Collision window / Retry register.
        using Addr = Register::Address<0x20084010,0xffffc0f0,0,unsigned>;
    ...
    namespace Nonemaxf{    ///<Maximum Frame register.
        using Addr = Register::Address<0x20084014,0xffff0000,0,unsigned>;
    ...
    namespace Nonesupp{    ///<PHY Support register.
        using Addr = Register::Address<0x20084018,0xfffffeff,0,unsigned>;
    ...
    namespace Nonetest{    ///<Test register.
        using Addr = Register::Address<0x2008401c,0xfffffff8,0,unsigned>;
    ...
    namespace Nonemcfg{    ///<MII Mgmt Configuration register.
        using Addr = Register::Address<0x20084020,0xffff7fc0,0,unsigned>;
    ...
    namespace Nonemcmd{    ///<MII Mgmt Command register.
        using Addr = Register::Address<0x20084024,0xfffffffc,0,unsigned>;
    ...
    namespace Nonemadr{    ///<MII Mgmt Address register.
        using Addr = Register::Address<0x20084028,0xffffe0e0,0,unsigned>;
    ...
    namespace Nonemwtd{    ///<MII Mgmt Write Data register.
        using Addr = Register::Address<0x2008402c,0xffff0000,0,unsigned>;
    ...
    namespace Nonemrdd{    ///<MII Mgmt Read Data register.
        using Addr = Register::Address<0x20084030,0xffff0000,0,unsigned>;
    ...
    namespace Nonemind{    ///<MII Mgmt Indicators register.
        using Addr = Register::Address<0x20084034,0xfffffff0,0,unsigned>;
    ...
    namespace Nonesa0{    ///<Station Address 0 register.
        using Addr = Register::Address<0x20084040,0xffff0000,0,unsigned>;
    ...
    namespace Nonesa1{    ///<Station Address 1 register.
        using Addr = Register::Address<0x20084044,0xffff0000,0,unsigned>;
    ...
    namespace Nonesa2{    ///<Station Address 2 register.
        using Addr = Register::Address<0x20084048,0xffff0000,0,unsigned>;
    ...
    namespace Nonecommand{    ///<Command register.
        using Addr = Register::Address<0x20084100,0xfffff804,0,unsigned>;
        ///Enable receive.
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxenable{}; 
        ///Enable transmit.
    ...
    namespace Nonestatus{    ///<Status register.
        using Addr = Register::Address<0x20084104,0xfffffffc,0,unsigned>;
    ...
    namespace Nonerxdescriptor{    ///<Receive descriptor base address register.
        using Addr = Register::Address<0x20084108,0x00000003,0,unsigned>;
    ...
    namespace Nonerxstatus{    ///<Receive status base address register.
        using Addr = Register::Address<0x2008410c,0x00000007,0,unsigned>;
    ...
    namespace Nonerxdescriptornumber{    ///<Receive number of descriptors register.
        using Addr = Register::Address<0x20084110,0xffff0000,0,unsigned>;
    ...
    namespace Nonerxproduceindex{    ///<Receive produce index register.
        using Addr = Register::Address<0x20084114,0xffff0000,0,unsigned>;
    ...
    namespace Nonerxconsumeindex{    ///<Receive consume index register.
        using Addr = Register::Address<0x20084118,0xffff0000,0,unsigned>;
    ...
    namespace Nonetxdescriptor{    ///<Transmit descriptor base address register.
        using Addr = Register::Address<0x2008411c,0x00000003,0,unsigned>;
    ...
    namespace Nonetxstatus{    ///<Transmit status base address register.
        using Addr = Register::Address<0x20084120,0x00000003,0,unsigned>;
    ...
    namespace Nonetxdescriptornumber{    ///<Transmit number of descriptors register.
        using Addr = Register::Address<0x20084124,0xffff0000,0,unsigned>;
    ...
    namespace Nonetxproduceindex{    ///<Transmit produce index register.
        using Addr = Register::Address<0x20084128,0xffff0000,0,unsigned>;
    ...
    namespace Nonetxconsumeindex{    ///<Transmit consume index register.
        using Addr = Register::Address<0x2008412c,0xffff0000,0,unsigned>;
    ...
    namespace Nonetsv0{    ///<Transmit status vector 0 register.
        using Addr = Register::Address<0x20084158,0x00000000,0,unsigned>;
    ...
    namespace Nonetsv1{    ///<Transmit status vector 1 register.
        using Addr = Register::Address<0x2008415c,0xfff00000,0,unsigned>;
    ...
    namespace Nonersv{    ///<Receive status vector register.
        using Addr = Register::Address<0x20084160,0x80000000,0,unsigned>;
    ...
    namespace Noneflowcontrolcounter{    ///<Flow control counter register.
        using Addr = Register::Address<0x20084170,0x00000000,0,unsigned>;
    ...
    namespace Noneflowcontrolstatus{    ///<Flow control status register.
        using Addr = Register::Address<0x20084174,0xffff0000,0,unsigned>;
    ...
    namespace Nonerxfilterctrl{    ///<Receive filter control register.
        using Addr = Register::Address<0x20084200,0xffffcfc0,0,unsigned>;
    ...
    namespace Nonerxfilterwolstatus{    ///<Receive filter WoL status register.
        using Addr = Register::Address<0x20084204,0xfffffe40,0,unsigned>;
    ...
    namespace Nonerxfilterwolclear{    ///<Receive filter WoL clear register.
        using Addr = Register::Address<0x20084208,0xfffffe40,0,unsigned>;
    ...
    namespace Nonehashfilterl{    ///<Hash filter table LSBs register.
        using Addr = Register::Address<0x20084210,0x00000000,0,unsigned>;
    ...
    namespace Nonehashfilterh{    ///<Hash filter table MSBs register.
        using Addr = Register::Address<0x20084214,0x00000000,0,unsigned>;
    ...
    namespace Noneintstatus{    ///<Interrupt status register.
        using Addr = Register::Address<0x20084fe0,0xffffcf00,0,unsigned>;
    ...
    namespace Noneintenable{    ///<Interrupt enable register.
        using Addr = Register::Address<0x20084fe4,0xffffcf00,0,unsigned>;
    ...
    namespace Noneintclear{    ///<Interrupt clear register.
        using Addr = Register::Address<0x20084fe8,0xffffcf00,0,unsigned>;
    ...
    namespace Noneintset{    ///<Interrupt set register.
        using Addr = Register::Address<0x20084fec,0xffffcf00,0,unsigned>;
    ...
    namespace Nonepowerdown{    ///<Power-down register.
        using Addr = Register::Address<0x20084ff4,0x7fffffff,0,unsigned>;
