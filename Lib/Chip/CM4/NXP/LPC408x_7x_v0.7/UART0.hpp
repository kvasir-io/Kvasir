...
//UART0/2/3 
    ...
    namespace Nonelsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
        ...
        namespace ThreValC{
            constexpr Register::FieldValue<decltype(thre),ThreVal::validdata> validdata{};
    ...
    namespace Noners485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
        ...
        namespace OinvValC{
            constexpr Register::FieldValue<decltype(oinv),OinvVal::dirlow> dirlow{};
            constexpr Register::FieldValue<decltype(oinv),OinvVal::dirhigh> dirhigh{};
        }
    }
