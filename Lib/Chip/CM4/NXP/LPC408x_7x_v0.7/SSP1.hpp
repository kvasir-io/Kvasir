...
namespace Kvasir {
    namespace Nonecr0{
        using Addr = Register::Address<0x40030000,0xffff0000>;
    ...
    namespace Nonecr1{
        using Addr = Register::Address<0x40030004,0xfffffff0>;
    ...
    namespace Nonedr{
        using Addr = Register::Address<0x40030008,0xffff0000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,0)> DATA; 
    }
    namespace Nonesr{
        using Addr = Register::Address<0x4003000c,0xffffffe0>;
    ...
    namespace Nonecpsr{
        using Addr = Register::Address<0x40030010,0xffffff00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,0)> CPSDVSR; 
    }
    namespace Noneimsc{
        using Addr = Register::Address<0x40030014,0xfffffff0>;
    ...
    namespace Noneris{
        using Addr = Register::Address<0x40030018,0xfffffff0>;
    ...
    namespace Nonemis{
        using Addr = Register::Address<0x4003001c,0xfffffff0>;
    ...
    namespace Noneicr{
        using Addr = Register::Address<0x40030020,0xfffffffc>;
    ...
    namespace Nonedmacr{
        using Addr = Register::Address<0x40030024,0xfffffffc>;
