...
namespace Kvasir {
//CAN controller  
    namespace Can2Mod{    ///<Controls the operating mode of the CAN Controller.
    ...
    namespace Can2Cmr{    ///<Command bits that affect the state of the CAN Controller
    ...
    namespace Can2Gsr{    ///<Global Controller Status and Error Counters. The error counters can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Icr{    ///<Interrupt status, Arbitration Lost Capture, Error Code Capture
    ...
    namespace Can2Ier{    ///<Interrupt Enable
    ...
    namespace Can2Btr{    ///<Bus Timing. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Ewl{    ///<Error Warning Limit. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Sr{    ///<Status Register
    ...
    namespace Can2Rfs{    ///<Receive frame status. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Rid{    ///<Received Identifier. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Rda{    ///<Received data bytes 1-4. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Rdb{    ///<Received data bytes 5-8. Can only be written when RM in CANMOD is 1.
    ...
    namespace Can2Tfi1{    ///<Transmit frame info (Tx Buffer )
    ...
    namespace Can2Tfi2{    ///<Transmit frame info (Tx Buffer )
    ...
    namespace Can2Tfi3{    ///<Transmit frame info (Tx Buffer )
    ...
    namespace Can2Tid1{    ///<TransmitIdentifier (Tx Buffer)
    ...
    namespace Can2Tid2{    ///<TransmitIdentifier (Tx Buffer)
    ...
    namespace Can2Tid3{    ///<TransmitIdentifier (Tx Buffer)
    ...
    namespace Can2Tda1{    ///<Transmitdata bytes 1-4 (Tx Buffer)
    ...
    namespace Can2Tda2{    ///<Transmitdata bytes 1-4 (Tx Buffer)
    ...
    namespace Can2Tda3{    ///<Transmitdata bytes 1-4 (Tx Buffer)
    ...
    namespace Can2Tdb1{    ///<Transmitdata bytes 5-8 (Tx Buffer )
    ...
    namespace Can2Tdb2{    ///<Transmitdata bytes 5-8 (Tx Buffer )
    ...
    namespace Can2Tdb3{    ///<Transmitdata bytes 5-8 (Tx Buffer )
