...
namespace Kvasir {
//UART0/2/3 
    namespace Uart2Rbr{    ///<Receiver Buffer Register. Contains the next received character to be read (DLAB =0).
    ...
    namespace Uart2Thr{    ///<Transmit Holding Regiter. The next character to be transmitted is written here (DLAB =0).
        using Addr = Register::Address<0x40098000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart2Dll{    ///<Divisor Latch LSB. Least significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB =1).
        using Addr = Register::Address<0x40098000,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart2Dlm{    ///<Divisor Latch MSB. Most significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider (DLAB =1).
    ...
    namespace Uart2Ier{    ///<Interrupt Enable Register. Contains individual interrupt enable bits for the 7 potential UART interrupts (DLAB =0).
        using Addr = Register::Address<0x40098004,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart2Iir{    ///<Interrupt ID Register. Identifies which interrupt(s) are pending.
    ...
    namespace Uart2Fcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        using Addr = Register::Address<0x40098008,0x00000000,0x00000000,unsigned>;
        ///FIFO Enable.
    ...
    namespace Uart2Lcr{    ///<Line Control Register. Contains controls for frame formatting and break generation.
    ...
    namespace Uart2Lsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
    ...
    namespace Uart2Scr{    ///<Scratch Pad Register. 8-bit temporary storage for software.
        using Addr = Register::Address<0x4009801c,0x00000000,0x00000000,unsigned>;
    ...
    namespace Uart2Acr{    ///<Auto-baud Control Register. Contains controls for the auto-baud feature.
    ...
    namespace Uart2Fdr{    ///<Fractional Divider Register. Generates a clock input for the baud rate divider.
    ...
    namespace Uart2Ter{    ///<Transmit Enable Register. Turns off UART transmitter for use with software flow control.
        using Addr = Register::Address<0x40098030,0x00000000,0x00000000,unsigned>;
        ///Reserved. Read value is undefined, only zero should be written.
    ...
    namespace Uart2Rs485ctrl{    ///<RS-485/EIA-485 Control. Contains controls to configure various aspects of RS-485/EIA-485 modes.
    ...
    namespace Uart2Rs485adrmatch{    ///<RS-485/EIA-485 address match. Contains the address match value for RS-485/EIA-485 mode.
    ...
    namespace Uart2Rs485dly{    ///<RS-485/EIA-485 direction control delay.
