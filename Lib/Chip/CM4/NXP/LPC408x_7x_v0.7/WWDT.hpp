...
namespace Kvasir {
    namespace Nonemod{
        using Addr = Register::Address<0x40000000,0xffffffe0>;
    ...
    namespace Nonetc{
        using Addr = Register::Address<0x40000004,0xff000000>;
    ...
    namespace Nonetv{
        using Addr = Register::Address<0x4000000c,0xff000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,0)> Count; 
    }
    namespace Nonewarnint{
        using Addr = Register::Address<0x40000014,0xfffffc00>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(9,0)> WARNINT; 
    }
    namespace Nonewindow{
        using Addr = Register::Address<0x40000018,0xff000000>;
