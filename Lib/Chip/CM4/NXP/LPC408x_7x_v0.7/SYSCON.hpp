...
// System and clock control 
    ...
    namespace Noneusbclksel{    ///<USB Clock Selection register
        ...
        namespace UsbselValC{
            constexpr Register::FieldValue<decltype(usbsel),UsbselVal::sysclk> sysclk{};
            constexpr Register::FieldValue<decltype(usbsel),UsbselVal::mainpllout> mainpllout{};
            constexpr Register::FieldValue<decltype(usbsel),UsbselVal::altplloout> altplloout{};
        }
    }
    ...
    namespace Nonespificlksel{    ///<SPIFI Clock Selection register
        ...
        namespace SpifiselValC{
            constexpr Register::FieldValue<decltype(spifisel),SpifiselVal::sysclk> sysclk{};
            constexpr Register::FieldValue<decltype(spifisel),SpifiselVal::mainpllout> mainpllout{};
            constexpr Register::FieldValue<decltype(spifisel),SpifiselVal::altpllout> altpllout{};
        }
    }
