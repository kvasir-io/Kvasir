...
namespace Kvasir {
    ...
    namespace Nonepconp1{
        using Addr = Register::Address<0x400fc0c8,0xfffffff7>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> PCCMP; 
    }
    ...
    namespace Nonerstcon1{
        using Addr = Register::Address<0x400fc1d0,0xfffffff0>;
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> RSTCMP; 
    }
