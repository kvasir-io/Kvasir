...
//I2C bus interface
    ...
    namespace Nonemmctrl{    ///<Monitor mode control register.
        ...
        namespace mmEnaValC{
            constexpr MPL::Value<mmEnaVal,mmEnaVal::monitorModeDisable> monitorModeDisable{};
            constexpr MPL::Value<mmEnaVal,mmEnaVal::theI2cModuleWill> theI2cModuleWill{};
        }
        ...
        namespace enaSclValC{
            constexpr MPL::Value<enaSclVal,enaSclVal::whenThisBitIsCle> whenThisBitIsCle{};
            constexpr MPL::Value<enaSclVal,enaSclVal::whenThisBitIsSet> whenThisBitIsSet{};
        }
        ...
        namespace matchAllValC{
            constexpr MPL::Value<matchAllVal,matchAllVal::whenThisBitIsCle> whenThisBitIsCle{};
            constexpr MPL::Value<matchAllVal,matchAllVal::whenThisBitIsSet> whenThisBitIsSet{};
        }
