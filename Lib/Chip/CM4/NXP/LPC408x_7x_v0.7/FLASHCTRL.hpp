...
//EEPROM/flash
    ...
    namespace Nonefmsstop{    ///<Signature stop-address register
        ...
        namespace SigstartValC{
            constexpr Register::FieldValue<decltype(sigStart),SigstartVal::stop> stop{};
            constexpr Register::FieldValue<decltype(sigStart),SigstartVal::start> start{};
        }
    }
    ...
    namespace Noneeeaddr{    ///<EEPROM address register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(11,0),Register::ReadWriteAccess,unsigned> addr{}; 
        namespace AddrValC{
        }
    }
