...
//UART4  
    ...
    namespace Nonefcr{    ///<FIFO Control Register. Controls UART FIFO usage and modes.
        ...
        namespace FifoenValC{
            constexpr Register::FieldValue<decltype(fifoen),FifoenVal::uartnFifosAreDisa> uartnFifosAreDisa{};
    ...
    namespace Nonelsr{    ///<Line Status Register. Contains flags for transmit and receive status, including line errors.
        ...
        namespace RdrValC{
            constexpr Register::FieldValue<decltype(rdr),RdrVal::theUartnReceiverF> theUartnReceiverF{};
            constexpr Register::FieldValue<decltype(rdr),RdrVal::theUartnReceiverF> theUartnReceiverF{};
        }
        ...
        namespace OeValC{
            constexpr Register::FieldValue<decltype(oe),OeVal::overrunErrorStatus> overrunErrorStatus{};
            constexpr Register::FieldValue<decltype(oe),OeVal::overrunErrorStatus> overrunErrorStatus{};
        }
        ...
        namespace PeValC{
            constexpr Register::FieldValue<decltype(pe),PeVal::parityErrorStatus> parityErrorStatus{};
            constexpr Register::FieldValue<decltype(pe),PeVal::parityErrorStatus> parityErrorStatus{};
        }
        ...
        namespace FeValC{
            constexpr Register::FieldValue<decltype(fe),FeVal::framingErrorStatus> framingErrorStatus{};
            constexpr Register::FieldValue<decltype(fe),FeVal::framingErrorStatus> framingErrorStatus{};
        }
        ...
        namespace BiValC{
            constexpr Register::FieldValue<decltype(bi),BiVal::breakInterruptStat> breakInterruptStat{};
            constexpr Register::FieldValue<decltype(bi),BiVal::breakInterruptStat> breakInterruptStat{};
        }
        ...
        namespace ThreValC{
            constexpr Register::FieldValue<decltype(thre),ThreVal::unthrContainsValid> unthrContainsValid{};
            constexpr Register::FieldValue<decltype(thre),ThreVal::unthrIsEmpty> unthrIsEmpty{};
        }
        ...
        namespace TemtValC{
            constexpr Register::FieldValue<decltype(temt),TemtVal::validData> validData{};
        ...
        namespace RxfeValC{
            constexpr Register::FieldValue<decltype(rxfe),RxfeVal::unrbrContainsNoUa> unrbrContainsNoUa{};
            constexpr Register::FieldValue<decltype(rxfe),RxfeVal::uartnRbrContainsA> uartnRbrContainsA{};
        }
    }
    ...
    namespace Noneacr{    ///<Auto-baud Control Register. Contains controls for the auto-baud feature.
        ...
        namespace AbeointclrValC{
            ...
            constexpr Register::FieldValue<decltype(abeointclr),AbeointclrVal::clearTheCorrespond> clearTheCorrespond{};
        }
        ...
        namespace AbtointclrValC{
            ...
            constexpr Register::FieldValue<decltype(abtointclr),AbtointclrVal::clearTheCorrespond> clearTheCorrespond{};
        }
    }
    namespace Noneicr{    ///<IrDA Control Register. Enables and configures the IrDA mode.
        ...
        namespace IrdaenValC{
            constexpr Register::FieldValue<decltype(irdaen),IrdaenVal::disabledIrdaMode> disabledIrdaMode{};
            constexpr Register::FieldValue<decltype(irdaen),IrdaenVal::enabledIrdaModeO> enabledIrdaModeO{};
        }
        ...
        namespace IrdainvValC{
            ...
            constexpr Register::FieldValue<decltype(irdainv),IrdainvVal::invertedThisHasN> invertedThisHasN{};
        }
        ...
        namespace PulsedivValC{
            ...
            constexpr Register::FieldValue<decltype(pulsediv),PulsedivVal::v256xtpclk> v256xtpclk{};
        }
    }
    ...
    namespace Nonescictrl{    ///<Smart Card Interface control register. Enables and configures the smartcard Interface feature.
        ...
        namespace NackdisValC{
            constexpr Register::FieldValue<decltype(nackdis),NackdisVal::aNackResponseIsE> aNackResponseIsE{};
            constexpr Register::FieldValue<decltype(nackdis),NackdisVal::aNackResponseIsI> aNackResponseIsI{};
        }
    ...
    namespace Nonesyncctrl{    ///<Synchronous mode control register.
        ...
        namespace FesValC{
            constexpr Register::FieldValue<decltype(fes),FesVal::rxdIsSampledOnTh> rxdIsSampledOnTh{};
            constexpr Register::FieldValue<decltype(fes),FesVal::rxdIsSampledOnTh> rxdIsSampledOnTh{};
        }
        ...
        namespace TsbypassValC{
            constexpr Register::FieldValue<decltype(tsbypass),TsbypassVal::theInputClockIsS> theInputClockIsS{};
            constexpr Register::FieldValue<decltype(tsbypass),TsbypassVal::theInputClockIsN> theInputClockIsN{};
        }
        ...
        namespace SssdisValC{
            constexpr Register::FieldValue<decltype(sssdis),SssdisVal::sendStartAndStop> sendStartAndStop{};
            constexpr Register::FieldValue<decltype(sssdis),SssdisVal::nostartstopbit> nostartstopbit{};
        }
