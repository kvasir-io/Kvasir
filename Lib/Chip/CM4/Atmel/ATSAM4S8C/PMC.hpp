...
//Power Management Controller
    ...
    namespace NonepmcPcer0{    ///<Peripheral Clock Enable Register 0
        using Addr = Register::Address<0x400e0410,0x00000003,0,unsigned>;
    ...
    namespace NonepmcPcdr0{    ///<Peripheral Clock Disable Register 0
        using Addr = Register::Address<0x400e0414,0x00000003,0,unsigned>;
    ...
    namespace NonepmcPcsr0{    ///<Peripheral Clock Status Register 0
        using Addr = Register::Address<0x400e0418,0x00000003,0,unsigned>;
    ...
    namespace NoneckgrMor{    ///<Main Oscillator Register
        using Addr = Register::Address<0x400e0420,0xfc000080,0,unsigned>;
        ...
        ///Wait Mode Command
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> waitmode{}; 
    ...
    namespace NoneckgrMcfr{    ///<Main Clock Frequency Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(20,20),Register::ReadWriteAccess,unsigned> rcmeas{}; 
    }
    ...
    namespace NoneckgrPllbr{    ///<PLLB Register
        ...
        ///PLLB Multiplier
        constexpr Register::BitLocation<Addr,Register::maskFromRange(26,16),Register::ReadWriteAccess,unsigned> mulb{}; 
    }
    namespace NonepmcMckr{    ///<Master Clock Register
        ...
        namespace cssValC{
            ...
            constexpr MPL::Value<cssVal,cssVal::pllbClk> pllbClk{};
        }
        ...
        ///PLLB Divisor by 2
        constexpr Register::BitLocation<Addr,Register::maskFromRange(13,13),Register::ReadWriteAccess,unsigned> pllbdiv2{}; 
    }
    ...
    namespace NonepmcPck0{    ///<Programmable Clock 0 Register
        ...
        namespace cssValC{
            ...
            constexpr MPL::Value<cssVal,cssVal::pllaClk> pllaClk{};
            constexpr MPL::Value<cssVal,cssVal::pllbClk> pllbClk{};
            constexpr MPL::Value<cssVal,cssVal::mck> mck{};
        }
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,0),Register::ReadWriteAccess,cssVal> css{}; 
        ///Programmable Clock Prescaler
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,4),Register::ReadWriteAccess,unsigned> pres{}; 
    }
    ...
    namespace NonepmcFsmr{    ///<Fast Startup Mode Register
        using Addr = Register::Address<0x400e0470,0xff980000,0,unsigned>;
        ...
        ///USB Alarm Enable
        constexpr Register::BitLocation<Addr,Register::maskFromRange(18,18),Register::ReadWriteAccess,unsigned> usbal{}; 
        ///Flash Low Power Mode
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,21),Register::ReadWriteAccess,unsigned> flpm{}; 
    }
    ...
    namespace NonepmcOcr{    ///<Oscillator Calibration Register
        ...
        constexpr Register::BitLocation<Addr,Register::maskFromRange(6,0),Register::ReadWriteAccess,unsigned> cal4{}; 
        ///Selection of RC Oscillator Calibration bits for 4 MHz
        constexpr Register::BitLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> sel4{}; 
        ///RC Oscillator Calibration bits for 8 MHz
        constexpr Register::BitLocation<Addr,Register::maskFromRange(14,8),Register::ReadWriteAccess,unsigned> cal8{}; 
        ///Selection of RC Oscillator Calibration bits for 8 MHz
        constexpr Register::BitLocation<Addr,Register::maskFromRange(15,15),Register::ReadWriteAccess,unsigned> sel8{}; 
        ///RC Oscillator Calibration bits for 12 MHz
        constexpr Register::BitLocation<Addr,Register::maskFromRange(22,16),Register::ReadWriteAccess,unsigned> cal12{}; 
        ///Selection of RC Oscillator Calibration bits for 12 MHz
        constexpr Register::BitLocation<Addr,Register::maskFromRange(23,23),Register::ReadWriteAccess,unsigned> sel12{}; 
    }
}
