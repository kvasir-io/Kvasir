...
namespace Kvasir {
    ...
    namespace DACC_mr{
        using Addr = Register::Address<0x4003c004,0xc0cc0080>;
    ...
    namespace DACC_chdr{
        using Addr = Register::Address<0x4003c014,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> CH0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> CH1; 
    }
    namespace DACC_chsr{
        using Addr = Register::Address<0x4003c018,0xfffffffc>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> CH0; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> CH1; 
    }
    namespace DACC_cdr{
        using Addr = Register::Address<0x4003c020,0x00000000>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(31,0)> DATA; 
    }
    namespace DACC_ier{
        using Addr = Register::Address<0x4003c024,0xfffffff0>;
    ...
    namespace DACC_idr{
        using Addr = Register::Address<0x4003c028,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> EOC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ENDTX; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TXBUFE; 
    ...
    namespace DACC_imr{
        using Addr = Register::Address<0x4003c02c,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> EOC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ENDTX; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TXBUFE; 
    ...
    namespace DACC_isr{
        using Addr = Register::Address<0x4003c030,0xfffffff0>;
        constexpr Register::BitLocation<Addr,Register::maskFromRange(0,0)> TXRDY; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(1,1)> EOC; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(2,2)> ENDTX; 
        constexpr Register::BitLocation<Addr,Register::maskFromRange(3,3)> TXBUFE; 
    ...
    namespace DACC_acr{
        using Addr = Register::Address<0x4003c094,0xfffffcf0>;
