...
//Universal Synchronous Asynchronous Receiver Transmitter 0
    namespace Usart0Cr{    ///<Control Register
        using Addr = Register::Address<0x40024000,0xfff00003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart0Mr{    ///<Mode Register
        using Addr = Register::Address<0x40024004,0x08000000,0,unsigned>;
    ...
    namespace Usart0Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40024008,0xfef0c000,0,unsigned>;
    ...
    namespace Usart0Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x4002400c,0xfef0c000,0,unsigned>;
    ...
    namespace Usart0Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x40024010,0xfef0c000,0,unsigned>;
    ...
    namespace Usart0Csr{    ///<Channel Status Register
        using Addr = Register::Address<0x40024014,0xfe00c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        ///Transmitter Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(1,1),Register::ReadWriteAccess,unsigned> txrdy{}; 
    ...
    namespace Usart0Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0x40024050,0x8cf0ecf0,0,unsigned>;
    ...
    namespace Usart0Version{    ///<Version Register
        using Addr = Register::Address<0x400240fc,0xfff8f000,0,unsigned>;
