...
//Chip Identifier
    namespace ChipidCidr{    ///<Chip ID Register
        ...
        namespace sramsizValC{
            ...
            constexpr MPL::Value<sramsizVal,sramsizVal::v192k> v192k{};
        ...
        namespace archValC{
            ...
            constexpr MPL::Value<archVal,archVal::cm4p> cm4p{};
            ...
            constexpr MPL::Value<archVal,archVal::sam4cxxc> sam4cxxc{};
            constexpr MPL::Value<archVal,archVal::sam4mxxc> sam4mxxc{};
            ...
            constexpr MPL::Value<archVal,archVal::sam4lxa> sam4lxa{};
            constexpr MPL::Value<archVal,archVal::sam4lxb> sam4lxb{};
            constexpr MPL::Value<archVal,archVal::sam4lxc> sam4lxc{};
