...
//Universal Synchronous Asynchronous Receiver Transmitter 1
    namespace Usart1Cr{    ///<Control Register
        using Addr = Register::Address<0x40028000,0xfff00003,0,unsigned>;
        ///Reset Receiver
    ...
    namespace Usart1Mr{    ///<Mode Register
        using Addr = Register::Address<0x40028004,0x08000000,0,unsigned>;
    ...
    namespace Usart1Ier{    ///<Interrupt Enable Register
        using Addr = Register::Address<0x40028008,0xfef0c000,0,unsigned>;
    ...
    namespace Usart1Idr{    ///<Interrupt Disable Register
        using Addr = Register::Address<0x4002800c,0xfef0c000,0,unsigned>;
    ...
    namespace Usart1Imr{    ///<Interrupt Mask Register
        using Addr = Register::Address<0x40028010,0xfef0c000,0,unsigned>;
    ...
    namespace Usart1Csr{    ///<Channel Status Register
        using Addr = Register::Address<0x40028014,0xfe00c000,0,unsigned>;
        ///Receiver Ready
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxrdy{}; 
        namespace RxrdyValC{
        }
    ...
    namespace Usart1Man{    ///<Manchester Encoder Decoder Register
        using Addr = Register::Address<0x40028050,0x8cf0ecf0,0,unsigned>;
    ...
    namespace Usart1Version{    ///<Version Register
        using Addr = Register::Address<0x400280fc,0xfff8f000,0,unsigned>;
    ...
    namespace Usart1Rpr{    ///<Receive Pointer Register
        using Addr = Register::Address<0x40028100,0x00000000,0,unsigned>;
    ...
    namespace Usart1Rcr{    ///<Receive Counter Register
        using Addr = Register::Address<0x40028104,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Tpr{    ///<Transmit Pointer Register
        using Addr = Register::Address<0x40028108,0x00000000,0,unsigned>;
    ...
    namespace Usart1Tcr{    ///<Transmit Counter Register
        using Addr = Register::Address<0x4002810c,0xffff0000,0,unsigned>;
        ///Transmit Counter Register
    ...
    namespace Usart1Rnpr{    ///<Receive Next Pointer Register
        using Addr = Register::Address<0x40028110,0x00000000,0,unsigned>;
    ...
    namespace Usart1Rncr{    ///<Receive Next Counter Register
        using Addr = Register::Address<0x40028114,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Tnpr{    ///<Transmit Next Pointer Register
        using Addr = Register::Address<0x40028118,0x00000000,0,unsigned>;
    ...
    namespace Usart1Tncr{    ///<Transmit Next Counter Register
        using Addr = Register::Address<0x4002811c,0xffff0000,0,unsigned>;
    ...
    namespace Usart1Ptcr{    ///<Transfer Control Register
        using Addr = Register::Address<0x40028120,0xfffffcfc,0,unsigned>;
    ...
    namespace Usart1Ptsr{    ///<Transfer Status Register
        using Addr = Register::Address<0x40028124,0xfffffefe,0,unsigned>;
        ///Receiver Transfer Enable
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(0,0),Register::ReadWriteAccess,unsigned> rxten{}; 
        namespace RxtenValC{
        }
