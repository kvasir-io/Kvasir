...
using ReadableTest = Register::Functional<Int<1>,Int<0xFFFFFFFF>,Register::Policy::ReadableP,Register::Policy::IntConversionP>;
using WriteableTest = Register::Functional<Int<1>,Int<0xFFFFFFFF>,Register::Policy::WriteableP,Register::Policy::IntConversionP>;
using PushableTest = Register::Functional<Int<1>,Int<0xFFFFFFFF>,Register::Policy::PushableP,Register::Policy::IntConversionP>;
using PopableTest = Register::Functional<Int<1>,Int<0xFFFFFFFF>,Register::Policy::PopableP,Register::Policy::IntConversionP>;
using ClearOnReadTest = Register::Functional<Int<1>,Int<0xFFFFFFFF>,Register::Policy::ClearOnReadP,Register::Policy::IntConversionP>;

enum class CAN1PinSelectOption {Port0Pin0=0};


//using CAN1PinSelect = Register::Functional<Int<1234>,Int<0x0000000F>,List<Register::Policy::ReadableP,Register::Policy::WriteableP>,Register::Policy::EnumConversionP<CAN1PinSelectOption>>;
//
