...
/*----------------------------------------------------------------------------
	...
	static const uint32_t CDC_COMMUNICATION_INTERFACE_CLASS = 0x02;
	...
	constexpr static unsigned int CDC_IDLE_SETTING = 1 << 0;
	constexpr static unsigned int CDC_DATA_MULTPLEXED_STATE = 1 << 1;


	// Control signal bitmap values for the SetControlLineState request
	// (usbcdc11.pdf, 6.2.14, Table 51)
	constexpr static unsigned int CDC_DTE_PRESENT = 1 << 0;
	constexpr static unsigned int CDC_ACTIVATE_CARRIER = 1 << 1;
	...
	constexpr static unsigned int CDC_SERIAL_STATE_OVERRUN = 1 << 6;  // receive data overrun error has occurred
	constexpr static unsigned int CDC_SERIAL_STATE_PARITY = 1 << 5;  // parity error has occurred
	constexpr static unsigned int CDC_SERIAL_STATE_FRAMING = 1 << 4;  // framing error has occurred
	constexpr static unsigned int CDC_SERIAL_STATE_RING = 1 << 3;  // state of ring signal detection
	constexpr static unsigned int CDC_SERIAL_STATE_BREAK = 1 << 2;  // state of break detection
	constexpr static unsigned int CDC_SERIAL_STATE_TX_CARRIER = 1 << 1;  // state of transmission carrier
	constexpr static unsigned int CDC_SERIAL_STATE_RX_CARRIER = 1 << 0;  // state of receiver carrier
